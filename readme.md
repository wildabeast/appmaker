...
For example, you might use the Prototype Tool to visually design your site, or the Blog Tool to create blog posts.
...
- pages/ Contains the pages that are edited by the Prototype Tool. Encoded in Space/Scraps
- timelines/ Stores diffs of pages generated by Prototype tool. Encoded in Space.
