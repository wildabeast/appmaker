(function(a,b){function c(g){var a=g.length,t=d.type(g);return d.isWindow(g)?!1:1===g.nodeType&&a?!0:"array"===t||"function"!==t&&(0===a||"number"==typeof a&&0<a&&a-1 in g)}function e(g,a,t,v){if(d.acceptData(g)){var c,h,Fb=d.expando,e="string"==typeof a,l=g.nodeType,f=l?d.cache:g,m=l?g[Fb]:g[Fb]&&Fb;if(m&&f[m]&&(v||f[m].data)||!e||t!==b)return m||(l?g[Fb]=m=Ca.pop()||d.guid++:m=Fb),f[m]||(f[m]={},l||(f[m].toJSON=d.noop)),("object"==typeof a||"function"==typeof a)&&(v?f[m]=d.extend(f[m],a):f[m].data=
d.extend(f[m].data,a)),c=f[m],v||(c.data||(c.data={}),c=c.data),t!==b&&(c[d.camelCase(a)]=t),e?(h=c[a],null==h&&(h=c[d.camelCase(a)])):h=c,h}}function f(g,a,t){if(d.acceptData(g)){var b,c,h,e=g.nodeType,l=e?d.cache:g,f=e?g[d.expando]:d.expando;if(l[f]){if(a&&(h=t?l[f]:l[f].data)){d.isArray(a)?a=a.concat(d.map(a,d.camelCase)):a in h?a=[a]:(a=d.camelCase(a),a=a in h?[a]:a.split(" "));b=0;for(c=a.length;c>b;b++)delete h[a[b]];if(!(t?s:d.isEmptyObject)(h))return}(t||(delete l[f].data,s(l[f])))&&(e?d.cleanData([g],
!0):d.support.deleteExpando||l!=l.window?delete l[f]:l[f]=null)}}}function n(g,a,t){if(t===b&&1===g.nodeType){var v="data-"+a.replace(wa,"-$1").toLowerCase();if(t=g.getAttribute(v),"string"==typeof t){try{t="true"===t?!0:"false"===t?!1:"null"===t?null:+t+""===t?+t:Ga.test(t)?d.parseJSON(t):t}catch(c){}d.data(g,a,t)}else t=b}return t}function s(g){for(var a in g)if(("data"!==a||!d.isEmptyObject(g[a]))&&"toJSON"!==a)return!1;return!0}function k(){return!0}function p(){return!1}function Q(g,a){do g=
g[a];while(g&&1!==g.nodeType);return g}function T(g,a,t){if(a=a||0,d.isFunction(a))return d.grep(g,function(g,b){return!!a.call(g,b,g)===t});if(a.nodeType)return d.grep(g,function(g){return g===a===t});if("string"==typeof a){var b=d.grep(g,function(g){return 1===g.nodeType});if(Uc.test(a))return d.filter(a,b,!t);a=d.filter(a,b)}return d.grep(g,function(g){return 0<=d.inArray(g,a)===t})}function W(g){var a=tc.split("|");g=g.createDocumentFragment();if(g.createElement)for(;a.length;)g.createElement(a.pop());
return g}function y(g){var a=g.getAttributeNode("type");return g.type=(a&&a.specified)+"/"+g.type,g}function B(g){var a=Vc.exec(g.type);return a?g.type=a[1]:g.removeAttribute("type"),g}function N(g,a){for(var t,b=0;null!=(t=g[b]);b++)d._data(t,"globalEval",!a||d._data(a[b],"globalEval"))}function X(g,a){if(1===a.nodeType&&d.hasData(g)){var t,b,c;b=d._data(g);var h=d._data(a,b),e=b.events;if(e)for(t in delete h.handle,h.events={},e){b=0;for(c=e[t].length;c>b;b++)d.event.add(a,t,e[t][b])}h.data&&(h.data=
d.extend({},h.data))}}function r(g,a){var t,v,c=0,h=typeof g.getElementsByTagName!==A?g.getElementsByTagName(a||"*"):typeof g.querySelectorAll!==A?g.querySelectorAll(a||"*"):b;if(!h){h=[];for(t=g.childNodes||g;null!=(v=t[c]);c++)!a||d.nodeName(v,a)?h.push(v):d.merge(h,r(v,a))}return a===b||a&&d.nodeName(g,a)?d.merge([g],h):h}function U(g){cc.test(g.type)&&(g.defaultChecked=g.checked)}function K(g,a){if(a in g)return a;for(var b=a.charAt(0).toUpperCase()+a.slice(1),d=a,c=uc.length;c--;)if(a=uc[c]+
b,a in g)return a;return d}function V(g,a){return g=a||g,"none"===d.css(g,"display")||!d.contains(g.ownerDocument,g)}function I(g,a){for(var b,v,c,h=[],e=0,l=g.length;l>e;e++)v=g[e],v.style&&(h[e]=d._data(v,"olddisplay"),b=v.style.display,a?(h[e]||"none"!==b||(v.style.display=""),""===v.style.display&&V(v)&&(h[e]=d._data(v,"olddisplay",ca(v.nodeName)))):h[e]||(c=V(v),(b&&"none"!==b||!c)&&d._data(v,"olddisplay",c?b:d.css(v,"display"))));for(e=0;l>e;e++)v=g[e],v.style&&(a&&"none"!==v.style.display&&
""!==v.style.display||(v.style.display=a?h[e]||"":"none"));return g}function j(g,a,b){return(g=Wc.exec(a))?Math.max(0,g[1]-(b||0))+(g[2]||"px"):a}function C(g,a,b,v,c){a=b===(v?"border":"content")?4:"width"===a?1:0;for(var h=0;4>a;a+=2)"margin"===b&&(h+=d.css(g,b+fb[a],!0,c)),v?("content"===b&&(h-=d.css(g,"padding"+fb[a],!0,c)),"margin"!==b&&(h-=d.css(g,"border"+fb[a]+"Width",!0,c))):(h+=d.css(g,"padding"+fb[a],!0,c),"padding"!==b&&(h+=d.css(g,"border"+fb[a]+"Width",!0,c)));return h}function R(g,
a,b){var v=!0,c="width"===a?g.offsetWidth:g.offsetHeight,h=gb(g),e=d.support.boxSizing&&"border-box"===d.css(g,"boxSizing",!1,h);if(0>=c||null==c){if(c=hb(g,a,h),(0>c||null==c)&&(c=g.style[a]),Pb.test(c))return c;v=e&&(d.support.boxSizingReliable||c===g.style[a]);c=parseFloat(c)||0}return c+C(g,a,b||(e?"border":"content"),v,h)+"px"}function ca(g){var a=F,b=vc[g];return b||(b=L(g,a),"none"!==b&&b||(Gb=(Gb||d("<iframe frameborder='0' width='0' height='0'/>").css("cssText","display:block !important")).appendTo(a.documentElement),
a=(Gb[0].contentWindow||Gb[0].contentDocument).document,a.write("<!doctype html><html><body>"),a.close(),b=L(g,a),Gb.detach()),vc[g]=b),b}function L(g,a){var b=d(a.createElement(g)).appendTo(a.body),v=d.css(b[0],"display");return b.remove(),v}function H(g,a,b,v){var c;if(d.isArray(a))d.each(a,function(a,z){b||Xc.test(g)?v(g,z):H(g+"["+("object"==typeof z?a:"")+"]",z,b,v)});else if(b||"object"!==d.type(a))v(g,a);else for(c in a)H(g+"["+c+"]",a[c],b,v)}function S(g){return function(a,b){"string"!=typeof a&&
(b=a,a="*");var v,c=0,h=a.toLowerCase().match(Ba)||[];if(d.isFunction(b))for(;v=h[c++];)"+"===v[0]?(v=v.slice(1)||"*",(g[v]=g[v]||[]).unshift(b)):(g[v]=g[v]||[]).push(b)}}function P(g,a,t,v){function c(l){var f;return h[l]=!0,d.each(g[l]||[],function(g,d){var l=d(a,t,v);return"string"!=typeof l||e||h[l]?e?!(f=l):b:(a.dataTypes.unshift(l),c(l),!1)}),f}var h={},e=g===dc;return c(a.dataTypes[0])||!h["*"]&&c("*")}function fa(g,a){var t,v,c=d.ajaxSettings.flatOptions||{};for(v in a)a[v]!==b&&((c[v]?g:
t||(t={}))[v]=a[v]);return t&&d.extend(!0,g,t),g}function ha(){try{return new a.XMLHttpRequest}catch(g){}}function ja(){return setTimeout(function(){pb=b}),pb=d.now()}function ia(g,a,b){var v,c,h=0,e=Qb.length,l=d.Deferred().always(function(){delete f.elem}),f=function(){if(c)return!1;for(var a=pb||ja(),a=Math.max(0,m.startTime+m.duration-a),z=1-(a/m.duration||0),b=0,t=m.tweens.length;t>b;b++)m.tweens[b].run(z);return l.notifyWith(g,[m,z,a]),1>z&&t?a:(l.resolveWith(g,[m]),!1)},m=l.promise({elem:g,
props:d.extend({},a),opts:d.extend(!0,{specialEasing:{}},b),originalProperties:a,originalOptions:b,startTime:pb||ja(),duration:b.duration,tweens:[],createTween:function(a,z){var b=d.Tween(g,m.opts,a,z,m.opts.specialEasing[a]||m.opts.easing);return m.tweens.push(b),b},stop:function(a){var z=0,b=a?m.tweens.length:0;if(c)return this;for(c=!0;b>z;z++)m.tweens[z].run(1);return a?l.resolveWith(g,[m,a]):l.rejectWith(g,[m,a]),this}});a=m.props;b=m.opts.specialEasing;var x,q,j,u;for(q in a)if(x=d.camelCase(q),
j=b[x],v=a[q],d.isArray(v)&&(j=v[1],v=a[q]=v[0]),q!==x&&(a[x]=v,delete a[q]),u=d.cssHooks[x],u&&"expand"in u)for(q in v=u.expand(v),delete a[x],v)q in a||(a[q]=v[q],b[q]=j);else b[x]=j;for(;e>h;h++)if(v=Qb[h].call(m,g,a,m.opts))return v;var w=m;d.each(a,function(g,a){for(var z=(Hb[g]||[]).concat(Hb["*"]),b=0,t=z.length;t>b&&!z[b].call(w,g,a);b++);});return d.isFunction(m.opts.start)&&m.opts.start.call(g,m),d.fx.timer(d.extend(f,{elem:g,anim:m,queue:m.opts.queue})),m.progress(m.opts.progress).done(m.opts.done,
m.opts.complete).fail(m.opts.fail).always(m.opts.always)}function Y(g,a,b,d,c){return new Y.prototype.init(g,a,b,d,c)}function m(g,a){var b,d={height:g},c=0;for(a=a?1:0;4>c;c+=2-a)b=fb[c],d["margin"+b]=d["padding"+b]=g;return a&&(d.opacity=d.width=g),d}function D(g){return d.isWindow(g)?g:9===g.nodeType?g.defaultView||g.parentWindow:!1}var q,w,A=typeof b,F=a.document,ga=a.location,Za=a.jQuery,$a=a.$,sa={},Ca=[],da=Ca.concat,ta=Ca.push,ka=Ca.slice,u=Ca.indexOf,O=sa.toString,G=sa.hasOwnProperty,Sa=
"1.9.1".trim,d=function(g,a){return new d.fn.init(g,a,w)},Da=/[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,Ba=/\S+/g,ab=/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,ib=/^(?:(<[\w\W]+>)[^>]*|#([\w-]*))$/,jb=/^<(\w+)\s*\/?>(?:<\/\1>|)$/,Ib=/^[\],:{}\s]*$/,Rb=/(?:^|:|,)(?:\s*\[)+/g,Ta=/\\(?:["\\\/bfnrt]|u[\da-fA-F]{4})/g,qb=/"[^"\\\r\n]*"|true|false|null|-?(?:\d+\.|)\d+(?:[eE][+-]?\d+|)/g,Ka=/^-ms-/,Jb=/-([\da-z])/gi,Sb=function(g,a){return a.toUpperCase()},E=function(g){(F.addEventListener||"load"===g.type||
"complete"===F.readyState)&&(Ua(),d.ready())},Ua=function(){F.addEventListener?(F.removeEventListener("DOMContentLoaded",E,!1),a.removeEventListener("load",E,!1)):(F.detachEvent("onreadystatechange",E),a.detachEvent("onload",E))};d.fn=d.prototype={jquery:"1.9.1",constructor:d,init:function(g,a,t){var v,c;if(!g)return this;if("string"==typeof g){if(v="<"===g.charAt(0)&&">"===g.charAt(g.length-1)&&3<=g.length?[null,g,null]:ib.exec(g),!v||!v[1]&&a)return!a||a.jquery?(a||t).find(g):this.constructor(a).find(g);
if(v[1]){if(a=a instanceof d?a[0]:a,d.merge(this,d.parseHTML(v[1],a&&a.nodeType?a.ownerDocument||a:F,!0)),jb.test(v[1])&&d.isPlainObject(a))for(v in a)d.isFunction(this[v])?this[v](a[v]):this.attr(v,a[v]);return this}if(c=F.getElementById(v[2]),c&&c.parentNode){if(c.id!==v[2])return t.find(g);this.length=1;this[0]=c}return this.context=F,this.selector=g,this}return g.nodeType?(this.context=this[0]=g,this.length=1,this):d.isFunction(g)?t.ready(g):(g.selector!==b&&(this.selector=g.selector,this.context=
...
last:function(){return this.eq(-1)},eq:function(g){var a=this.length;g=+g+(0>g?a:0);return this.pushStack(0<=g&&a>g?[this[g]]:[])},map:function(g){return this.pushStack(d.map(this,function(a,b){return g.call(a,b,a)}))},end:function(){return this.prevObject||this.constructor(null)},push:ta,sort:[].sort,splice:[].splice};d.fn.init.prototype=d.fn;d.extend=d.fn.extend=function(){var g,a,t,v,c,h,e=arguments[0]||{},l=1,m=arguments.length,f=!1;"boolean"==typeof e&&(f=e,e=arguments[1]||{},l=2);"object"==
typeof e||d.isFunction(e)||(e={});for(m===l&&(e=this,--l);m>l;l++)if(null!=(c=arguments[l]))for(v in c)g=e[v],t=c[v],e!==t&&(f&&t&&(d.isPlainObject(t)||(a=d.isArray(t)))?(a?(a=!1,h=g&&d.isArray(g)?g:[]):h=g&&d.isPlainObject(g)?g:{},e[v]=d.extend(f,h,t)):t!==b&&(e[v]=t));return e};d.extend({noConflict:function(g){return a.$===d&&(a.$=$a),g&&a.jQuery===d&&(a.jQuery=Za),d},isReady:!1,readyWait:1,holdReady:function(g){g?d.readyWait++:d.ready(!0)},ready:function(g){if(!0===g?!--d.readyWait:!d.isReady){if(!F.body)return setTimeout(d.ready);
d.isReady=!0;!0!==g&&0<--d.readyWait||(q.resolveWith(F,[d]),d.fn.trigger&&d(F).trigger("ready").off("ready"))}},isFunction:function(g){return"function"===d.type(g)},isArray:Array.isArray||function(g){return"array"===d.type(g)},isWindow:function(g){return null!=g&&g==g.window},isNumeric:function(g){return!isNaN(parseFloat(g))&&isFinite(g)},type:function(g){return null==g?g+"":"object"==typeof g||"function"==typeof g?sa[O.call(g)]||"object":typeof g},isPlainObject:function(g){if(!g||"object"!==d.type(g)||
g.nodeType||d.isWindow(g))return!1;try{if(g.constructor&&!G.call(g,"constructor")&&!G.call(g.constructor.prototype,"isPrototypeOf"))return!1}catch(a){return!1}for(var t in g);return t===b||G.call(g,t)},isEmptyObject:function(g){for(var a in g)return!1;return!0},error:function(g){throw Error(g);},parseHTML:function(g,a,b){if(!g||"string"!=typeof g)return null;"boolean"==typeof a&&(b=a,a=!1);a=a||F;var v=jb.exec(g);b=!b&&[];return v?[a.createElement(v[1])]:(v=d.buildFragment([g],a,b),b&&d(b).remove(),
d.merge([],v.childNodes))},parseJSON:function(g){return a.JSON&&a.JSON.parse?a.JSON.parse(g):null===g?g:"string"==typeof g&&(g=d.trim(g),g&&Ib.test(g.replace(Ta,"@").replace(qb,"]").replace(Rb,"")))?Function("return "+g)():(d.error("Invalid JSON: "+g),b)},parseXML:function(g){var z,t;if(!g||"string"!=typeof g)return null;try{a.DOMParser?(t=new DOMParser,z=t.parseFromString(g,"text/xml")):(z=new ActiveXObject("Microsoft.XMLDOM"),z.async="false",z.loadXML(g))}catch(v){z=b}return z&&z.documentElement&&
...
h&&!(d=a.call(g[h],h,g[h]),!1===d);h++);else for(h in g)if(d=a.call(g[h],h,g[h]),!1===d)break;return g},trim:Sa&&!Sa.call("\ufeff\u00a0")?function(g){return null==g?"":Sa.call(g)}:function(g){return null==g?"":(g+"").replace(ab,"")},makeArray:function(g,a){var b=a||[];return null!=g&&(c(Object(g))?d.merge(b,"string"==typeof g?[g]:g):ta.call(b,g)),b},inArray:function(g,a,b){var d;if(a){if(u)return u.call(a,g,b);d=a.length;for(b=b?0>b?Math.max(0,d+b):b:0;d>b;b++)if(b in a&&a[b]===g)return b}return-1},
merge:function(g,a){var d=a.length,v=g.length,c=0;if("number"==typeof d)for(;d>c;c++)g[v++]=a[c];else for(;a[c]!==b;)g[v++]=a[c++];return g.length=v,g},grep:function(g,a,b){var d,c=[],h=0,e=g.length;for(b=!!b;e>h;h++)d=!!a(g[h],h),b!==d&&c.push(g[h]);return c},map:function(g,a,b){var d,h=0,e=g.length,l=[];if(c(g))for(;e>h;h++)d=a(g[h],h,b),null!=d&&(l[l.length]=d);else for(h in g)d=a(g[h],h,b),null!=d&&(l[l.length]=d);return da.apply([],l)},guid:1,proxy:function(g,a){var t,v,c;return"string"==typeof a&&
(c=g[a],a=g,g=c),d.isFunction(g)?(t=ka.call(arguments,2),v=function(){return g.apply(a||this,t.concat(ka.call(arguments)))},v.guid=g.guid=g.guid||d.guid++,v):b},access:function(g,a,t,v,c,h,e){var l=0,m=g.length,f=null==t;if("object"===d.type(t))for(l in c=!0,t)d.access(g,a,l,t[l],!0,h,e);else if(v!==b&&(c=!0,d.isFunction(v)||(e=!0),f&&(e?(a.call(g,v),a=null):(f=a,a=function(g,a,b){return f.call(d(g),b)})),a))for(;m>l;l++)a(g[l],t,e?v:v.call(g[l],l,a(g[l],t)));return c?g:f?a.call(g):m?a(g[0],t):h},
now:function(){return(new Date).getTime()}});d.ready.promise=function(g){if(!q)if(q=d.Deferred(),"complete"===F.readyState)setTimeout(d.ready);else if(F.addEventListener)F.addEventListener("DOMContentLoaded",E,!1),a.addEventListener("load",E,!1);else{F.attachEvent("onreadystatechange",E);a.attachEvent("onload",E);var b=!1;try{b=null==a.frameElement&&F.documentElement}catch(t){}b&&b.doScroll&&function Tc(){if(!d.isReady){try{b.doScroll("left")}catch(g){return setTimeout(Tc,50)}Ua();d.ready()}}()}return q.promise(g)};
d.each("Boolean Number String Function Array Date RegExp Object Error".split(" "),function(g,a){sa["[object "+a+"]"]=a.toLowerCase()});w=d(F);var Va={};d.Callbacks=function(g){var a;if("string"==typeof g){if(!(a=Va[g])){a=g;var t=Va[a]={};a=(d.each(a.match(Ba)||[],function(g,a){t[a]=!0}),t)}}else a=d.extend({},g);g=a;var v,c,h,e,l,m,f=[],q=!g.once&&[],x=function(a){c=g.memory&&a;h=!0;l=m||0;m=0;e=f.length;for(v=!0;f&&e>l;l++)if(!1===f[l].apply(a[0],a[1])&&g.stopOnFalse){c=!1;break}v=!1;f&&(q?q.length&&
x(q.shift()):c?f=[]:j.disable())},j={add:function(){if(f){var a=f.length;(function Yc(a){d.each(a,function(a,b){var z=d.type(b);"function"===z?g.unique&&j.has(b)||f.push(b):b&&b.length&&"string"!==z&&Yc(b)})})(arguments);v?e=f.length:c&&(m=a,x(c))}return this},remove:function(){return f&&d.each(arguments,function(g,a){for(var b;-1<(b=d.inArray(a,f,b));)f.splice(b,1),v&&(e>=b&&e--,l>=b&&l--)}),this},has:function(g){return g?-1<d.inArray(g,f):!(!f||!f.length)},empty:function(){return f=[],this},disable:function(){return f=
q=c=b,this},disabled:function(){return!f},lock:function(){return q=b,c||j.disable(),this},locked:function(){return!q},fireWith:function(g,a){return a=a||[],a=[g,a.slice?a.slice():a],!f||h&&!q||(v?q.push(a):x(a)),this},fire:function(){return j.fireWith(this,arguments),this},fired:function(){return!!h}};return j};d.extend({Deferred:function(g){var a=[["resolve","done",d.Callbacks("once memory"),"resolved"],["reject","fail",d.Callbacks("once memory"),"rejected"],["notify","progress",d.Callbacks("memory")]],
...
h={};return c.pipe=c.then,d.each(a,function(g,d){var e=d[2],l=d[3];c[d[1]]=e.add;l&&e.add(function(){b=l},a[1^g][2].disable,a[2][2].lock);h[d[0]]=function(){return h[d[0]+"With"](this===h?c:this,arguments),this};h[d[0]+"With"]=e.fireWith}),c.promise(h),g&&g.call(h,h),h},when:function(g){var a=0,b=ka.call(arguments),c=b.length,h=1!==c||g&&d.isFunction(g.promise)?c:0,e=1===h?g:d.Deferred(),l=function(g,a,b){return function(d){a[g]=this;b[g]=1<arguments.length?ka.call(arguments):d;b===f?e.notifyWith(a,
b):--h||e.resolveWith(a,b)}},f,m,q;if(1<c){f=Array(c);m=Array(c);for(q=Array(c);c>a;a++)b[a]&&d.isFunction(b[a].promise)?b[a].promise().done(l(a,q,b)).fail(e.reject).progress(l(a,m,f)):--h}return h||e.resolveWith(q,b),e.promise()}});var ec=d,kb;var ba,ea,M,na,oa,ua,Ha,la,Na,ra,J=F.createElement("div");if(J.setAttribute("className","t"),J.innerHTML="  <link/><table></table><a href='/a'>a</a><input type='checkbox'/>",ea=J.getElementsByTagName("*"),M=J.getElementsByTagName("a")[0],!ea||!M||!ea.length)kb=
...
ra,"t"),ba[ra+"Bubbles"]=la in a||!1===J.attributes[la].expando;kb=(J.style.backgroundClip="content-box",J.cloneNode(!0).style.backgroundClip="",ba.clearCloneStyle="content-box"===J.style.backgroundClip,d(function(){var g,b,d,c=F.getElementsByTagName("body")[0];c&&(g=F.createElement("div"),g.style.cssText="border:0;width:0;height:0;position:absolute;top:0;left:-9999px;margin-top:1px",c.appendChild(g).appendChild(J),J.innerHTML="<table><tr><td></td><td>t</td></tr></table>",d=J.getElementsByTagName("td"),
...
g)})},dequeue:function(g){return this.each(function(){d.dequeue(this,g)})},delay:function(g,a){return g=d.fx?d.fx.speeds[g]||g:g,a=a||"fx",this.queue(a,function(a,b){var d=setTimeout(a,g);b.stop=function(){clearTimeout(d)}})},clearQueue:function(g){return this.queue(g||"fx",[])},promise:function(g,a){var t,c=1,h=d.Deferred(),e=this,l=this.length,f=function(){--c||h.resolveWith(e,[e])};"string"!=typeof g&&(a=g,g=b);for(g=g||"fx";l--;)(t=d._data(e[l],g+"queueHooks"))&&t.empty&&(c++,t.empty.add(f));
return f(),h.promise(a)}});var xa,va,h=/[\t\r\n]/g,l=/\r/g,x=/^(?:input|select|textarea|button|object)$/i,Wa=/^(?:a|area)$/i,Oa=/^(?:checked|selected|autofocus|autoplay|async|controls|defer|disabled|hidden|loop|multiple|open|readonly|required|scoped)$/i,Ia=/^(?:checked|selected)$/i,Ea=d.support.getSetAttribute,rb=d.support.input;d.fn.extend({attr:function(g,a){return d.access(this,d.attr,g,a,1<arguments.length)},removeAttr:function(g){return this.each(function(){d.removeAttr(this,g)})},prop:function(g,
a){return d.access(this,d.prop,g,a,1<arguments.length)},removeProp:function(g){return g=d.propFix[g]||g,this.each(function(){try{this[g]=b,delete this[g]}catch(a){}})},addClass:function(g){var a,b,c,e,l,f=0,m=this.length;a="string"==typeof g&&g;if(d.isFunction(g))return this.each(function(a){d(this).addClass(g.call(this,a,this.className))});if(a)for(a=(g||"").match(Ba)||[];m>f;f++)if(b=this[f],c=1===b.nodeType&&(b.className?(" "+b.className+" ").replace(h," "):" ")){for(l=0;e=a[l++];)0>c.indexOf(" "+
e+" ")&&(c+=e+" ");b.className=d.trim(c)}return this},removeClass:function(g){var a,b,c,e,l,f=0,m=this.length;a=0===arguments.length||"string"==typeof g&&g;if(d.isFunction(g))return this.each(function(a){d(this).removeClass(g.call(this,a,this.className))});if(a)for(a=(g||"").match(Ba)||[];m>f;f++)if(b=this[f],c=1===b.nodeType&&(b.className?(" "+b.className+" ").replace(h," "):"")){for(l=0;e=a[l++];)for(;0<=c.indexOf(" "+e+" ");)c=c.replace(" "+e+" "," ");b.className=g?d.trim(c):""}return this},toggleClass:function(g,
a){var b=typeof g,c="boolean"==typeof a;return d.isFunction(g)?this.each(function(b){d(this).toggleClass(g.call(this,b,this.className,a),a)}):this.each(function(){if("string"===b)for(var h,e=0,l=d(this),f=a,m=g.match(Ba)||[];h=m[e++];)f=c?f:!l.hasClass(h),l[f?"addClass":"removeClass"](h);else(b===A||"boolean"===b)&&(this.className&&d._data(this,"__className__",this.className),this.className=this.className||!1===g?"":d._data(this,"__className__")||"")})},hasClass:function(g){g=" "+g+" ";for(var a=
0,b=this.length;b>a;a++)if(1===this[a].nodeType&&0<=(" "+this[a].className+" ").replace(h," ").indexOf(g))return!0;return!1},val:function(g){var a,t,c,h=this[0];if(arguments.length)return c=d.isFunction(g),this.each(function(a){var z,h=d(this);1===this.nodeType&&(z=c?g.call(this,a,h.val()):g,null==z?z="":"number"==typeof z?z+="":d.isArray(z)&&(z=d.map(z,function(a){return null==a?"":a+""})),t=d.valHooks[this.type]||d.valHooks[this.nodeName.toLowerCase()],t&&"set"in t&&t.set(this,z,"value")!==b||(this.value=
z))});if(h)return t=d.valHooks[h.type]||d.valHooks[h.nodeName.toLowerCase()],t&&"get"in t&&(a=t.get(h,"value"))!==b?a:(a=h.value,"string"==typeof a?a.replace(l,""):null==a?"":a)}});d.extend({valHooks:{option:{get:function(a){var b=a.attributes.value;return!b||b.specified?a.value:a.text}},select:{get:function(a){for(var b,c=a.options,h=a.selectedIndex,e="select-one"===a.type||0>h,l=e?null:[],f=e?h+1:c.length,m=0>h?f:e?h:0;f>m;m++)if(b=c[m],!(!b.selected&&m!==h||(d.support.optDisabled?b.disabled:null!==
b.getAttribute("disabled"))||b.parentNode.disabled&&d.nodeName(b.parentNode,"optgroup"))){if(a=d(b).val(),e)return a;l.push(a)}return l},set:function(a,b){var c=d.makeArray(b);return d(a).find("option").each(function(){this.selected=0<=d.inArray(d(this).val(),c)}),c.length||(a.selectedIndex=-1),c}}},attr:function(a,z,c){var h,e,l,f=a.nodeType;if(a&&3!==f&&8!==f&&2!==f)return typeof a.getAttribute===A?d.prop(a,z,c):(e=1!==f||!d.isXMLDoc(a),e&&(z=z.toLowerCase(),h=d.attrHooks[z]||(Oa.test(z)?va:xa)),
c===b?h&&e&&"get"in h&&null!==(l=h.get(a,z))?l:(typeof a.getAttribute!==A&&(l=a.getAttribute(z)),null==l?b:l):null!==c?h&&e&&"set"in h&&(l=h.set(a,c,z))!==b?l:(a.setAttribute(z,c+""),c):(d.removeAttr(a,z),b))},removeAttr:function(a,b){var c,h,e=0,l=b&&b.match(Ba);if(l&&1===a.nodeType)for(;c=l[e++];)h=d.propFix[c]||c,Oa.test(c)?!Ea&&Ia.test(c)?a[d.camelCase("default-"+c)]=a[h]=!1:a[h]=!1:d.attr(a,c,""),a.removeAttribute(Ea?c:h)},attrHooks:{type:{set:function(a,b){if(!d.support.radioValue&&"radio"===
b&&d.nodeName(a,"input")){var c=a.value;return a.setAttribute("type",b),c&&(a.value=c),b}}}},propFix:{tabindex:"tabIndex",readonly:"readOnly","for":"htmlFor","class":"className",maxlength:"maxLength",cellspacing:"cellSpacing",cellpadding:"cellPadding",rowspan:"rowSpan",colspan:"colSpan",usemap:"useMap",frameborder:"frameBorder",contenteditable:"contentEditable"},prop:function(a,c,t){var h,e,l,f=a.nodeType;if(a&&3!==f&&8!==f&&2!==f)return l=1!==f||!d.isXMLDoc(a),l&&(c=d.propFix[c]||c,e=d.propHooks[c]),
t!==b?e&&"set"in e&&(h=e.set(a,t,c))!==b?h:a[c]=t:e&&"get"in e&&null!==(h=e.get(a,c))?h:a[c]},propHooks:{tabIndex:{get:function(a){var d=a.getAttributeNode("tabindex");return d&&d.specified?parseInt(d.value,10):x.test(a.nodeName)||Wa.test(a.nodeName)&&a.href?0:b}}}});va={get:function(a,c){var t=d.prop(a,c),h="boolean"==typeof t&&a.getAttribute(c);return(t="boolean"==typeof t?rb&&Ea?null!=h:Ia.test(c)?a[d.camelCase("default-"+c)]:!!h:a.getAttributeNode(c))&&!1!==t.value?c.toLowerCase():b},set:function(a,
b,c){return!1===b?d.removeAttr(a,c):rb&&Ea||!Ia.test(c)?a.setAttribute(!Ea&&d.propFix[c]||c,c):a[d.camelCase("default-"+c)]=a[c]=!0,c}};rb&&Ea||(d.attrHooks.value={get:function(a,c){var t=a.getAttributeNode(c);return d.nodeName(a,"input")?a.defaultValue:t&&t.specified?t.value:b},set:function(a,c,t){return d.nodeName(a,"input")?(a.defaultValue=c,b):xa&&xa.set(a,c,t)}});Ea||(xa=d.valHooks.button={get:function(a,d){var c=a.getAttributeNode(d);return c&&("id"===d||"name"===d||"coords"===d?""!==c.value:
...
d.event={global:{},add:function(a,c,h,v,e){var l,f,m,q,x,j,u,w,D;if(m=d._data(a)){h.handler&&(q=h,h=q.handler,e=q.selector);h.guid||(h.guid=d.guid++);(f=m.events)||(f=m.events={});(x=m.handle)||(x=m.handle=function(a){return typeof d===A||a&&d.event.triggered===a.type?b:d.event.dispatch.apply(x.elem,arguments)},x.elem=a);c=(c||"").match(Ba)||[""];for(m=c.length;m--;)l=Lb.exec(c[m])||[],w=j=l[1],D=(l[2]||"").split(".").sort(),l=d.event.special[w]||{},w=(e?l.delegateType:l.bindType)||w,l=d.event.special[w]||
{},j=d.extend({type:w,origType:j,data:v,handler:h,guid:h.guid,selector:e,needsContext:e&&d.expr.match.needsContext.test(e),namespace:D.join(".")},q),(u=f[w])||(u=f[w]=[],u.delegateCount=0,l.setup&&!1!==l.setup.call(a,v,D,x)||(a.addEventListener?a.addEventListener(w,x,!1):a.attachEvent&&a.attachEvent("on"+w,x))),l.add&&(l.add.call(a,j),j.handler.guid||(j.handler.guid=h.guid)),e?u.splice(u.delegateCount++,0,j):u.push(j),d.event.global[w]=!0;a=null}},remove:function(a,b,c,h,e){var l,f,m,q,x,j,u,w,A,
D,k,p=d.hasData(a)&&d._data(a);if(p&&(j=p.events)){b=(b||"").match(Ba)||[""];for(x=b.length;x--;)if(m=Lb.exec(b[x])||[],A=k=m[1],D=(m[2]||"").split(".").sort(),A){u=d.event.special[A]||{};A=(h?u.delegateType:u.bindType)||A;w=j[A]||[];m=m[2]&&RegExp("(^|\\.)"+D.join("\\.(?:.*\\.|)")+"(\\.|$)");for(q=l=w.length;l--;)f=w[l],!e&&k!==f.origType||c&&c.guid!==f.guid||m&&!m.test(f.namespace)||h&&h!==f.selector&&("**"!==h||!f.selector)||(w.splice(l,1),f.selector&&w.delegateCount--,u.remove&&u.remove.call(a,
f));q&&!w.length&&(u.teardown&&!1!==u.teardown.call(a,D,p.handle)||d.removeEvent(a,A,p.handle),delete j[A])}else for(A in j)d.event.remove(a,A+b[x],c,h,!0);d.isEmptyObject(j)&&(delete p.handle,d._removeData(a,"events"))}},trigger:function(g,c,h,v){var e,l,f,m,q,x,j=[h||F],u=G.call(g,"type")?g.type:g;x=G.call(g,"namespace")?g.namespace.split("."):[];if(f=e=h=h||F,3!==h.nodeType&&8!==h.nodeType&&!Kb.test(u+d.event.triggered)&&(0<=u.indexOf(".")&&(x=u.split("."),u=x.shift(),x.sort()),l=0>u.indexOf(":")&&
"on"+u,g=g[d.expando]?g:new d.Event(u,"object"==typeof g&&g),g.isTrigger=!0,g.namespace=x.join("."),g.namespace_re=g.namespace?RegExp("(^|\\.)"+x.join("\\.(?:.*\\.|)")+"(\\.|$)"):null,g.result=b,g.target||(g.target=h),c=null==c?[g]:d.makeArray(c,[g]),q=d.event.special[u]||{},v||!q.trigger||!1!==q.trigger.apply(h,c))){if(!v&&!q.noBubble&&!d.isWindow(h)){m=q.delegateType||u;for(Kb.test(m+u)||(f=f.parentNode);f;f=f.parentNode)j.push(f),e=f;e===(h.ownerDocument||F)&&j.push(e.defaultView||e.parentWindow||
a)}for(x=0;(f=j[x++])&&!g.isPropagationStopped();)g.type=1<x?m:q.bindType||u,(e=(d._data(f,"events")||{})[g.type]&&d._data(f,"handle"))&&e.apply(f,c),(e=l&&f[l])&&d.acceptData(f)&&e.apply&&!1===e.apply(f,c)&&g.preventDefault();if(g.type=u,!(v||g.isDefaultPrevented()||q._default&&!1!==q._default.apply(h.ownerDocument,c)||"click"===u&&d.nodeName(h,"a")||!d.acceptData(h)||!l||!h[u]||d.isWindow(h))){(e=h[l])&&(h[l]=null);d.event.triggered=u;try{h[u]()}catch(w){}d.event.triggered=b;e&&(h[l]=e)}return g.result}},
dispatch:function(a){a=d.event.fix(a);var c,h,v,e,l,f=[],m=ka.call(arguments);c=(d._data(this,"events")||{})[a.type]||[];var q=d.event.special[a.type]||{};if(m[0]=a,a.delegateTarget=this,!q.preDispatch||!1!==q.preDispatch.call(this,a)){f=d.event.handlers.call(this,a,c);for(c=0;(e=f[c++])&&!a.isPropagationStopped();){a.currentTarget=e.elem;for(l=0;(v=e.handlers[l++])&&!a.isImmediatePropagationStopped();)(!a.namespace_re||a.namespace_re.test(v.namespace))&&(a.handleObj=v,a.data=v.data,h=((d.event.special[v.origType]||
{}).handle||v.handler).apply(e.elem,m),h!==b&&!1===(a.result=h)&&(a.preventDefault(),a.stopPropagation()))}return q.postDispatch&&q.postDispatch.call(this,a),a.result}},handlers:function(a,c){var h,v,e,l,f=[],m=c.delegateCount,q=a.target;if(m&&q.nodeType&&(!a.button||"click"!==a.type))for(;q!=this;q=q.parentNode||this)if(1===q.nodeType&&(!0!==q.disabled||"click"!==a.type)){e=[];for(l=0;m>l;l++)v=c[l],h=v.selector+" ",e[h]===b&&(e[h]=v.needsContext?0<=d(h,this).index(q):d.find(h,this,null,[q]).length),
e[h]&&e.push(v);e.length&&f.push({elem:q,handlers:e})}return c.length>m&&f.push({elem:this,handlers:c.slice(m)}),f},fix:function(a){if(a[d.expando])return a;var b,c,h;b=a.type;var e=a,l=this.fixHooks[b];l||(this.fixHooks[b]=l=Tb.test(b)?this.mouseHooks:Pa.test(b)?this.keyHooks:{});h=l.props?this.props.concat(l.props):this.props;a=new d.Event(e);for(b=h.length;b--;)c=h[b],a[c]=e[c];return a.target||(a.target=e.srcElement||F),3===a.target.nodeType&&(a.target=a.target.parentNode),a.metaKey=!!a.metaKey,
l.filter?l.filter(a,e):a},props:"altKey bubbles cancelable ctrlKey currentTarget eventPhase metaKey relatedTarget shiftKey target timeStamp view which".split(" "),fixHooks:{},keyHooks:{props:["char","charCode","key","keyCode"],filter:function(a,b){return null==a.which&&(a.which=null!=b.charCode?b.charCode:b.keyCode),a}},mouseHooks:{props:"button buttons clientX clientY fromElement offsetX offsetY pageX pageY screenX screenY toElement".split(" "),filter:function(a,d){var c,h,e,l=d.button,f=d.fromElement;
...
a);a.isDefaultPrevented()&&c.preventDefault()}};d.removeEvent=F.removeEventListener?function(a,b,d){a.removeEventListener&&a.removeEventListener(b,d,!1)}:function(a,b,d){b="on"+b;a.detachEvent&&(typeof a[b]===A&&(a[b]=null),a.detachEvent(b,d))};d.Event=function(a,c){return this instanceof d.Event?(a&&a.type?(this.originalEvent=a,this.type=a.type,this.isDefaultPrevented=a.defaultPrevented||!1===a.returnValue||a.getPreventDefault&&a.getPreventDefault()?k:p):this.type=a,c&&d.extend(this,c),this.timeStamp=
a&&a.timeStamp||d.now(),this[d.expando]=!0,b):new d.Event(a,c)};d.Event.prototype={isDefaultPrevented:p,isPropagationStopped:p,isImmediatePropagationStopped:p,preventDefault:function(){var a=this.originalEvent;this.isDefaultPrevented=k;a&&(a.preventDefault?a.preventDefault():a.returnValue=!1)},stopPropagation:function(){var a=this.originalEvent;this.isPropagationStopped=k;a&&(a.stopPropagation&&a.stopPropagation(),a.cancelBubble=!0)},stopImmediatePropagation:function(){this.isImmediatePropagationStopped=
k;this.stopPropagation()}};d.each({mouseenter:"mouseover",mouseleave:"mouseout"},function(a,b){d.event.special[a]={delegateType:b,bindType:b,handle:function(a){var g,c=a.relatedTarget,h=a.handleObj;return(!c||c!==this&&!d.contains(this,c))&&(a.type=h.origType,g=h.handler.apply(this,arguments),a.type=b),g}}});d.support.submitBubbles||(d.event.special.submit={setup:function(){return d.nodeName(this,"form")?!1:(d.event.add(this,"click._submit keypress._submit",function(a){a=a.target;(a=d.nodeName(a,
...
{setup:function(){0===c++&&F.addEventListener(a,h,!0)},teardown:function(){0===--c&&F.removeEventListener(a,h,!0)}}});d.fn.extend({on:function(a,c,h,e,l){var f,m;if("object"==typeof a){"string"!=typeof c&&(h=h||c,c=b);for(f in a)this.on(f,c,h,a[f],l);return this}if(null==h&&null==e?(e=c,h=c=b):null==e&&("string"==typeof c?(e=h,h=b):(e=h,h=c,c=b)),!1===e)e=p;else if(!e)return this;return 1===l&&(m=e,e=function(a){return d().off(a),m.apply(this,arguments)},e.guid=m.guid||(m.guid=d.guid++)),this.each(function(){d.event.add(this,
...
null,b)},delegate:function(a,b,d,c){return this.on(b,a,d,c)},undelegate:function(a,b,d){return 1===arguments.length?this.off(a,"**"):this.off(b,a||"**",d)},trigger:function(a,b){return this.each(function(){d.event.trigger(a,b,this)})},triggerHandler:function(a,c){var h=this[0];return h?d.event.trigger(a,c,h,!0):b}});var tb=a,mb=function(){var a,b=[];return a=function(d,c){return b.push(d+=" ")>aa.cacheLength&&delete a[b.shift()],a[d]=c}},ya=function(a){return a[ma]=!0,a},Aa=function(a){var b=za.createElement("div");
try{return a(b)}catch(d){return!1}finally{}},Z=function(a,b,d,c){var h,e,l,f,m;if((b?b.ownerDocument||b:nb)!==za&&ub(b),b=b||za,d=d||[],!a||"string"!=typeof a)return d;if(1!==(f=b.nodeType)&&9!==f)return[];if(!La&&!c){if(h=Zc.exec(a))if(l=h[1])if(9===f){if(e=b.getElementById(l),!e||!e.parentNode)return d;if(e.id===l)return d.push(e),d}else{if(b.ownerDocument&&(e=b.ownerDocument.getElementById(l))&&Mb(b,e)&&e.id===l)return d.push(e),d}else{if(h[2])return vb.apply(d,wb.call(b.getElementsByTagName(a),
0)),d;if((l=h[3])&&pa.getByClassName&&b.getElementsByClassName)return vb.apply(d,wb.call(b.getElementsByClassName(l),0)),d}if(pa.qsa&&!Qa.test(a)){if(h=!0,e=ma,l=b,m=9===f&&a,1===f&&"object"!==b.nodeName.toLowerCase()){f=Xa(a);(h=b.getAttribute("id"))?e=h.replace($c,"\\$&"):b.setAttribute("id",e);e="[id='"+e+"'] ";for(l=f.length;l--;)f[l]=e+xb(f[l]);l=fc.test(a)&&b.parentNode||b;m=f.join(",")}if(m)try{return vb.apply(d,wb.call(l.querySelectorAll(m),0)),d}catch(q){}finally{h||b.removeAttribute("id")}}}var x;
a:{a=a.replace(Ub,"$1");var j,u;e=Xa(a);if(!c&&1===e.length){if(x=e[0]=e[0].slice(0),2<x.length&&"ID"===(j=x[0]).type&&9===b.nodeType&&!La&&aa.relative[x[1].type]){if(b=aa.find.ID(j.matches[0].replace(bb,cb),b)[0],!b){x=d;break a}a=a.slice(x.shift().value.length)}for(f=Vb.needsContext.test(a)?0:x.length;f--&&!(j=x[f],aa.relative[h=j.type]);)if((u=aa.find[h])&&(c=u(j.matches[0].replace(bb,cb),fc.test(x[0].type)&&b.parentNode||b))){if(x.splice(f,1),a=c.length&&xb(x),!a){x=(vb.apply(d,wb.call(c,0)),
d);break a}break}}x=(gc(a,e)(c,b,La,d,fc.test(a)),d)}return x},yb=function(a,b){var d=b&&a,c=d&&(~b.sourceIndex||wc)-(~a.sourceIndex||wc);if(c)return c;if(d)for(;d=d.nextSibling;)if(d===b)return-1;return a?1:-1},zb=function(a){return function(b){return"input"===b.nodeName.toLowerCase()&&b.type===a}},Ya=function(a){return function(b){var d=b.nodeName.toLowerCase();return("input"===d||"button"===d)&&b.type===a}},Ma=function(a){return ya(function(b){return b=+b,ya(function(d,c){for(var h,e=a([],d.length,
b),l=e.length;l--;)d[h=e[l]]&&(d[h]=!(c[h]=d[h]))})})},Xa=function(a,b){var d,c,h,e,l,f,m;if(l=xc[a+" "])return b?0:l.slice(0);l=a;f=[];for(m=aa.preFilter;l;){(!d||(c=ad.exec(l)))&&(c&&(l=l.slice(c[0].length)||l),f.push(h=[]));d=!1;(c=bd.exec(l))&&(d=c.shift(),h.push({value:d,type:c[0].replace(Ub," ")}),l=l.slice(d.length));for(e in aa.filter)!(c=Vb[e].exec(l))||m[e]&&!(c=m[e](c))||(d=c.shift(),h.push({value:d,type:e,matches:c}),l=l.slice(d.length));if(!d)break}return b?l.length:l?Z.error(a):xc(a,
f).slice(0)},xb=function(a){for(var b=0,d=a.length,c="";d>b;b++)c+=a[b].value;return c},Ab=function(a,b,d){var c=b.dir,h=d&&"parentNode"===c,e=cd++;return b.first?function(b,d,e){for(;b=b[c];)if(1===b.nodeType||h)return a(b,d,e)}:function(b,d,l){var t,z,f,m=Ra+" "+e;if(l)for(;b=b[c];){if((1===b.nodeType||h)&&a(b,d,l))return!0}else for(;b=b[c];)if(1===b.nodeType||h)if(f=b[ma]||(b[ma]={}),(z=f[c])&&z[0]===m){if(!0===(t=z[1])||t===Wb)return!0===t}else if(z=f[c]=[m],z[1]=a(b,d,l)||Wb,!0===z[1])return!0}},
Xb=function(a){return 1<a.length?function(b,d,c){for(var h=a.length;h--;)if(!a[h](b,d,c))return!1;return!0}:a[0]},Nb=function(a,b,d,c,h){for(var e,l=[],f=0,m=a.length,q=null!=b;m>f;f++)(e=a[f])&&(!d||d(e,c,h))&&(l.push(e),q&&b.push(f));return l},db=function(a,b,d,c,h,e){return c&&!c[ma]&&(c=db(c)),h&&!h[ma]&&(h=db(h,e)),ya(function(e,l,f,m){var q,x,j=[],u=[],w=l.length,A;if(!(A=e)){A=b||"*";for(var qa=f.nodeType?[f]:f,D=[],p=0,k=qa.length;k>p;p++)Z(A,qa[p],D);A=D}A=!a||!e&&b?A:Nb(A,j,a,f,m);qa=d?
h||(e?a:w||c)?[]:l:A;if(d&&d(A,qa,f,m),c){q=Nb(qa,u);c(q,[],f,m);for(f=q.length;f--;)(x=q[f])&&(qa[u[f]]=!(A[u[f]]=x))}if(e){if(h||a){if(h){q=[];for(f=qa.length;f--;)(x=qa[f])&&q.push(A[f]=x);h(null,qa=[],q,m)}for(f=qa.length;f--;)(x=qa[f])&&-1<(q=h?hc.call(e,x):j[f])&&(e[q]=!(l[q]=x))}}else qa=Nb(qa===l?qa.splice(w,qa.length):qa),h?h(null,l,qa,m):vb.apply(l,qa)})},ic=function(a){var b,d,c,h=a.length,e=aa.relative[a[0].type];d=e||aa.relative[" "];for(var l=e?1:0,f=Ab(function(a){return a===b},d,!0),
m=Ab(function(a){return-1<hc.call(b,a)},d,!0),q=[function(a,g,d){return!e&&(d||g!==Yb)||((b=g).nodeType?f(a,g,d):m(a,g,d))}];h>l;l++)if(d=aa.relative[a[l].type])q=[Ab(Xb(q),d)];else{if(d=aa.filter[a[l].type].apply(null,a[l].matches),d[ma]){for(c=++l;h>c&&!aa.relative[a[c].type];c++);return db(1<l&&Xb(q),1<l&&xb(a.slice(0,l-1)).replace(Ub,"$1"),d,c>l&&ic(a.slice(l,c)),h>c&&ic(a=a.slice(c)),h>c&&xb(a))}q.push(d)}return Xb(q)},yc=function(){},Bb,Wb,aa,Zb,zc,gc,Cb,Yb,ub,za,Fa,La,Qa,Db,$b,Mb,jc,ma="sizzle"+
-new Date,nb=tb.document,pa={},Ra=0,cd=0,Ac=mb(),xc=mb(),Bc=mb(),wc=-2147483648,ac=[],dd=ac.pop,vb=ac.push,wb=ac.slice,hc=ac.indexOf||function(a){for(var b=0,d=this.length;d>b;b++)if(this[b]===a)return b;return-1},Cc="(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+".replace("w","w#"),Dc="\\[[\\x20\\t\\r\\n\\f]*((?:\\\\.|[\\w-]|[^\\x00-\\xa0])+)[\\x20\\t\\r\\n\\f]*(?:([*^$|!~]?=)[\\x20\\t\\r\\n\\f]*(?:(['\"])((?:\\\\.|[^\\\\])*?)\\3|("+Cc+")|)|)[\\x20\\t\\r\\n\\f]*\\]",kc=":((?:\\\\.|[\\w-]|[^\\x00-\\xa0])+)(?:\\(((['\"])((?:\\\\.|[^\\\\])*?)\\3|((?:\\\\.|[^\\\\()[\\]]|"+
...
typeof b.getElementById&&!La){var g=b.getElementById(a);return g&&g.parentNode?[g]:[]}},aa.filter.ID=function(a){var b=a.replace(bb,cb);return function(a){return a.getAttribute("id")===b}}):(aa.find.ID=function(a,b){if("undefined"!==typeof b.getElementById&&!La){var g=b.getElementById(a);return g?g.id===a||"undefined"!==typeof g.getAttributeNode&&g.getAttributeNode("id").value===a?[g]:void 0:[]}},aa.filter.ID=function(a){var b=a.replace(bb,cb);return function(a){return(a="undefined"!==typeof a.getAttributeNode&&
a.getAttributeNode("id"))&&a.value===b}});aa.find.TAG=pa.tagNameNoComments?function(a,b){return"undefined"!==typeof b.getElementsByTagName?b.getElementsByTagName(a):void 0}:function(a,b){var g,d=[],c=0,h=b.getElementsByTagName(a);if("*"===a){for(;g=h[c++];)1===g.nodeType&&d.push(g);return d}return h};aa.find.NAME=pa.getByName&&function(a,b){return"undefined"!==typeof b.getElementsByName?b.getElementsByName(name):void 0};aa.find.CLASS=pa.getByClassName&&function(a,b){return"undefined"===typeof b.getElementsByClassName||
La?void 0:b.getElementsByClassName(a)};Db=[];Qa=[":focus"];(pa.qsa=lc.test(b.querySelectorAll+""))&&(Aa(function(a){a.innerHTML="<select><option selected=''></option></select>";a.querySelectorAll("[selected]").length||Qa.push("\\[[\\x20\\t\\r\\n\\f]*(?:checked|disabled|ismap|multiple|readonly|selected|value)");a.querySelectorAll(":checked").length||Qa.push(":checked")}),Aa(function(a){a.innerHTML="<input type='hidden' i=''/>";a.querySelectorAll("[i^='']").length&&Qa.push("[*^$]=[\\x20\\t\\r\\n\\f]*(?:\"\"|'')");
a.querySelectorAll(":enabled").length||Qa.push(":enabled",":disabled");a.querySelectorAll("*,:x");Qa.push(",.*:")}));a=pa;var d;d=$b=Fa.matchesSelector||Fa.mozMatchesSelector||Fa.webkitMatchesSelector||Fa.oMatchesSelector||Fa.msMatchesSelector;d=lc.test(d+"");a=((a.matchesSelector=d)&&Aa(function(a){pa.disconnectedMatch=$b.call(a,"div");$b.call(a,"[s!='']:x");Db.push("!=",kc)}),Qa=RegExp(Qa.join("|")),Db=RegExp(Db.join("|")),Mb=lc.test(Fa.contains+"")||Fa.compareDocumentPosition?function(a,b){var g=
9===a.nodeType?a.documentElement:a,d=b&&b.parentNode;return a===d||!(!d||1!==d.nodeType||!(g.contains?g.contains(d):a.compareDocumentPosition&&16&a.compareDocumentPosition(d)))}:function(a,b){if(b)for(;b=b.parentNode;)if(b===a)return!0;return!1},jc=Fa.compareDocumentPosition?function(a,g){var d;return a===g?(Cb=!0,0):(d=g.compareDocumentPosition&&a.compareDocumentPosition&&a.compareDocumentPosition(g))?1&d||a.parentNode&&11===a.parentNode.nodeType?a===b||Mb(nb,a)?-1:g===b||Mb(nb,g)?1:0:4&d?-1:1:a.compareDocumentPosition?
-1:1}:function(a,g){var d,c=0;d=a.parentNode;var h=g.parentNode,e=[a],l=[g];if(a===g)return Cb=!0,0;if(!d||!h)return a===b?-1:g===b?1:d?-1:h?1:0;if(d===h)return yb(a,g);for(d=a;d=d.parentNode;)e.unshift(d);for(d=g;d=d.parentNode;)l.unshift(d);for(;e[c]===l[c];)c++;return c?yb(e[c],l[c]):e[c]===nb?-1:l[c]===nb?1:0},Cb=!1,[0,0].sort(jc),pa.detectDuplicates=Cb,za)}else a=za;return a};Z.matches=function(a,b){return Z(a,null,null,b)};Z.matchesSelector=function(a,b){if((a.ownerDocument||a)!==za&&ub(a),
b=b.replace(jd,"='$1']"),!(!pa.matchesSelector||La||Db&&Db.test(b)||Qa.test(b)))try{var d=$b.call(a,b);if(d||pa.disconnectedMatch||a.document&&11!==a.document.nodeType)return d}catch(c){}return 0<Z(b,za,null,[a]).length};Z.contains=function(a,b){return(a.ownerDocument||a)!==za&&ub(a),Mb(a,b)};Z.attr=function(a,b){var d;return(a.ownerDocument||a)!==za&&ub(a),La||(b=b.toLowerCase()),(d=aa.attrHandle[b])?d(a):La||pa.attributes?a.getAttribute(b):((d=a.getAttributeNode(b))||a.getAttribute(b))&&!0===a[b]?
b:d&&d.specified?d.value:null};Z.error=function(a){throw Error("Syntax error, unrecognized expression: "+a);};Z.uniqueSort=function(a){var b,d=[],c=1,h=0;if(Cb=!pa.detectDuplicates,a.sort(jc),Cb){for(;b=a[c];c++)b===a[c-1]&&(h=d.push(c));for(;h--;)a.splice(d[h],1)}return a};Zb=Z.getText=function(a){var b,d="",c=0;if(b=a.nodeType)if(1===b||9===b||11===b){if("string"==typeof a.textContent)return a.textContent;for(a=a.firstChild;a;a=a.nextSibling)d+=Zb(a)}else{if(3===b||4===b)return a.nodeValue}else for(;b=
...
"odd"===a[3])),a[5]=+(a[7]+a[8]||"odd"===a[3])):a[3]&&Z.error(a[0]),a},PSEUDO:function(a){var b,d=!a[5]&&a[2];return Vb.CHILD.test(a[0])?null:(a[4]?a[2]=a[4]:d&&ed.test(d)&&(b=Xa(d,!0))&&(b=d.indexOf(")",d.length-b)-d.length)&&(a[0]=a[0].slice(0,b),a[2]=d.slice(0,b)),a.slice(0,3))}},filter:{TAG:function(a){return"*"===a?function(){return!0}:(a=a.replace(bb,cb).toLowerCase(),function(b){return b.nodeName&&b.nodeName.toLowerCase()===a})},CLASS:function(a){var b=Ac[a+" "];return b||(b=RegExp("(^|[\\x20\\t\\r\\n\\f])"+
...
a.slice(-4),f="of-type"===b;return 1===c&&0===h?function(a){return!!a.parentNode}:function(b,d,m){var t,z,q,x,j;d=e!==l?"nextSibling":"previousSibling";var u=b.parentNode,w=f&&b.nodeName.toLowerCase();m=!m&&!f;if(u){if(e){for(;d;){for(z=b;z=z[d];)if(f?z.nodeName.toLowerCase()===w:1===z.nodeType)return!1;j=d="only"===a&&!j&&"nextSibling"}return!0}if(j=[l?u.firstChild:u.lastChild],l&&m){m=u[ma]||(u[ma]={});t=m[a]||[];x=t[0]===Ra&&t[1];q=t[0]===Ra&&t[2];for(z=x&&u.childNodes[x];z=++x&&z&&z[d]||(q=x=
0)||j.pop();)if(1===z.nodeType&&++q&&z===b){m[a]=[Ra,x,q];break}}else if(m&&(t=(b[ma]||(b[ma]={}))[a])&&t[0]===Ra)q=t[1];else for(;(z=++x&&z&&z[d]||(q=x=0)||j.pop())&&(!(f?z.nodeName.toLowerCase()===w:1===z.nodeType)||!++q||!(m&&((z[ma]||(z[ma]={}))[a]=[Ra,q]),z===b)););return q-=h,q===c||0===q%c&&0<=q/c}}},PSEUDO:function(a,b){var d,c=aa.pseudos[a]||aa.setFilters[a.toLowerCase()]||Z.error("unsupported pseudo: "+a);return c[ma]?c(b):1<c.length?(d=[a,a,"",b],aa.setFilters.hasOwnProperty(a.toLowerCase())?
...
lang:ya(function(a){return fd.test(a||"")||Z.error("unsupported lang: "+a),a=a.replace(bb,cb).toLowerCase(),function(b){var d;do if(d=La?b.getAttribute("xml:lang")||b.getAttribute("lang"):b.lang)return d=d.toLowerCase(),d===a||0===d.indexOf(a+"-");while((b=b.parentNode)&&1===b.nodeType);return!1}}),target:function(a){var b=tb.location&&tb.location.hash;return b&&b.slice(1)===a.id},root:function(a){return a===Fa},focus:function(a){return a===za.activeElement&&(!za.hasFocus||za.hasFocus())&&!(!a.type&&
...
d;d+=2)a.push(d);return a}),lt:Ma(function(a,b,d){for(b=0>d?d+b:d;0<=--b;)a.push(b);return a}),gt:Ma(function(a,b,d){for(d=0>d?d+b:d;b>++d;)a.push(d);return a})}};for(Bb in{radio:!0,checkbox:!0,file:!0,password:!0,image:!0})aa.pseudos[Bb]=zb(Bb);for(Bb in{submit:!0,reset:!0})aa.pseudos[Bb]=Ya(Bb);gc=Z.compile=function(a,b){var d,c=[],h=[],e=Bc[a+" "];if(!e){b||(b=Xa(a));for(d=b.length;d--;)e=ic(b[d]),e[ma]?c.push(e):h.push(e);var l=0,f=0<c.length,m=0<h.length;d=function(a,b,d,g,e){var t,q,z=[],x=
0,j="0",u=a&&[],w=null!=e,A=Yb,D=a||m&&aa.find.TAG("*",e&&b.parentNode||b),p=Ra+=null==A?1:Math.random()||0.1;for(w&&(Yb=b!==za&&b,Wb=l);null!=(e=D[j]);j++){if(m&&e){for(t=0;q=h[t++];)if(q(e,b,d)){g.push(e);break}w&&(Ra=p,Wb=++l)}f&&((e=!q&&e)&&x--,a&&u.push(e))}if(x+=j,f&&j!==x){for(t=0;q=c[t++];)q(u,z,b,d);if(a){if(0<x)for(;j--;)u[j]||z[j]||(z[j]=dd.call(g));z=Nb(z)}vb.apply(g,z);w&&!a&&0<z.length&&1<x+c.length&&Z.uniqueSort(g)}return w&&(Ra=p,Yb=A),u};d=f?ya(d):d;e=Bc(a,d)}return e};aa.pseudos.nth=
aa.pseudos.eq;aa.filters=yc.prototype=aa.pseudos;aa.setFilters=new yc;ub();Z.attr=d.attr;d.find=Z;d.expr=Z.selectors;d.expr[":"]=d.expr.pseudos;d.unique=Z.uniqueSort;d.text=Z.getText;d.isXMLDoc=Z.isXML;d.contains=Z.contains;var kd=/Until$/,ld=/^(?:parents|prev(?:Until|All))/,Uc=/^.[^:#\[\.,]*$/,Ec=d.expr.match.needsContext,md={children:!0,contents:!0,next:!0,prev:!0};d.fn.extend({find:function(a){var b,c,h,e=this.length;if("string"!=typeof a)return h=this,this.pushStack(d(a).filter(function(){for(b=
...
!1,function(a){this.parentNode&&this.parentNode.insertBefore(a,this.nextSibling)})},remove:function(a,b){for(var c,h=0;null!=(c=this[h]);h++)(!a||0<d.filter(a,[c]).length)&&(b||1!==c.nodeType||d.cleanData(r(c)),c.parentNode&&(b&&d.contains(c.ownerDocument,c)&&N(r(c,"script")),c.parentNode.removeChild(c)));return this},empty:function(){for(var a,b=0;null!=(a=this[b]);b++){for(1===a.nodeType&&d.cleanData(r(a,!1));a.firstChild;)a.removeChild(a.firstChild);a.options&&d.nodeName(a,"select")&&(a.options.length=
...
(d.cleanData(r(c,!1)),c.innerHTML=a);c=0}catch(e){}}c&&this.empty().append(a)},null,a,arguments.length)},replaceWith:function(a){return d.isFunction(a)||"string"==typeof a||(a=d(a).not(this).detach()),this.domManip([a],!0,function(a){var b=this.nextSibling,c=this.parentNode;c&&(d(this).remove(),c.insertBefore(a,b))})},detach:function(a){return this.remove(a,!0)},domManip:function(a,c,h){a=da.apply([],a);var e,l,f,m,q=0,x=this.length,j=this,u=x-1,w=a[0],A=d.isFunction(w);if(A||!(1>=x||"string"!=typeof w||
d.support.checkClone)&&qd.test(w))return this.each(function(d){var e=j.eq(d);A&&(a[0]=w.call(this,d,c?e.html():b));e.domManip(a,c,h)});if(x&&(m=d.buildFragment(a,this[0].ownerDocument,!1,this),e=m.firstChild,1===m.childNodes.length&&(m=e),e)){c=c&&d.nodeName(e,"tr");f=d.map(r(m,"script"),y);for(l=f.length;x>q;q++)e=m,q!==u&&(e=d.clone(e,!0,!0),l&&d.merge(f,r(e,"script"))),h.call(c&&d.nodeName(this[q],"table")?this[q].getElementsByTagName("tbody")[0]||this[q].appendChild(this[q].ownerDocument.createElement("tbody")):
this[q],e,q);if(l){m=f[f.length-1].ownerDocument;d.map(f,B);for(q=0;l>q;q++)e=f[q],Jc.test(e.type||"")&&!d._data(e,"globalEval")&&d.contains(m,e)&&(e.src?d.ajax({url:e.src,type:"GET",dataType:"script",async:!1,global:!1,"throws":!0}):d.globalEval((e.text||e.textContent||e.innerHTML||"").replace(rd,"")))}m=e=null}return this}});d.each({appendTo:"append",prependTo:"prepend",insertBefore:"before",insertAfter:"after",replaceAll:"replaceWith"},function(a,b){d.fn[a]=function(a){for(var c=0,g=[],h=d(a),
e=h.length-1;e>=c;c++)a=c===e?this:this.clone(!0),d(h[c])[b](a),ta.apply(g,a.get());return this.pushStack(g)}});d.extend({clone:function(a,b,c){var h,e,l,f,m,q=d.contains(a.ownerDocument,a);if(d.support.html5Clone||d.isXMLDoc(a)||!Fc.test("<"+a.nodeName+">")?l=a.cloneNode(!0):(nc.innerHTML=a.outerHTML,nc.removeChild(l=nc.firstChild)),!(d.support.noCloneEvent&&d.support.noCloneChecked||1!==a.nodeType&&11!==a.nodeType||d.isXMLDoc(a))){h=r(l);m=r(a);for(f=0;null!=(e=m[f]);++f)if(h[f]){var x=h[f],j=void 0,
u=void 0,w=void 0;if(1===x.nodeType){if(j=x.nodeName.toLowerCase(),!d.support.noCloneEvent&&x[d.expando]){w=d._data(x);for(u in w.events)d.removeEvent(x,u,w.handle);x.removeAttribute(d.expando)}"script"===j&&x.text!==e.text?(y(x).text=e.text,B(x)):"object"===j?(x.parentNode&&(x.outerHTML=e.outerHTML),d.support.html5Clone&&e.innerHTML&&!d.trim(x.innerHTML)&&(x.innerHTML=e.innerHTML)):"input"===j&&cc.test(e.type)?(x.defaultChecked=x.checked=e.checked,x.value!==e.value&&(x.value=e.value)):"option"===
j?x.defaultSelected=x.selected=e.defaultSelected:("input"===j||"textarea"===j)&&(x.defaultValue=e.defaultValue)}}}if(b)if(c){m=m||r(a);h=h||r(l);for(f=0;null!=(e=m[f]);f++)X(e,h[f])}else X(a,l);return h=r(l,"script"),0<h.length&&N(h,!q&&r(a,"script")),l},buildFragment:function(a,b,c,h){for(var e,l,f,m,q,x,j,u=a.length,w=W(b),A=[],D=0;u>D;D++)if(l=a[D],l||0===l)if("object"===d.type(l))d.merge(A,l.nodeType?[l]:l);else if(od.test(l)){m=m||w.appendChild(b.createElement("div"));q=(Hc.exec(l)||["",""])[1].toLowerCase();
j=Ja[q]||Ja._default;m.innerHTML=j[1]+l.replace(Gc,"<$1></$2>")+j[2];for(e=j[0];e--;)m=m.lastChild;if(!d.support.leadingWhitespace&&mc.test(l)&&A.push(b.createTextNode(mc.exec(l)[0])),!d.support.tbody)for(e=(l="table"!==q||Ic.test(l)?"<table>"!==j[1]||Ic.test(l)?0:m:m.firstChild)&&l.childNodes.length;e--;)d.nodeName(x=l.childNodes[e],"tbody")&&!x.childNodes.length&&l.removeChild(x);d.merge(A,m.childNodes);for(m.textContent="";m.firstChild;)m.removeChild(m.firstChild);m=w.lastChild}else A.push(b.createTextNode(l));
m&&w.removeChild(m);d.support.appendChecked||d.grep(r(A,"input"),U);for(D=0;l=A[D++];)if((!h||-1===d.inArray(l,h))&&(f=d.contains(l.ownerDocument,l),m=r(w.appendChild(l),"script"),f&&N(m),c))for(e=0;l=m[e++];)Jc.test(l.type||"")&&c.push(l);return w},cleanData:function(a,b){for(var c,h,e,l,f=0,m=d.expando,q=d.cache,x=d.support.deleteExpando,j=d.event.special;null!=(c=a[f]);f++)if((b||d.acceptData(c))&&(e=c[m],l=e&&q[e])){if(l.events)for(h in l.events)j[h]?d.event.remove(c,h):d.removeEvent(c,h,l.handle);
q[e]&&(delete q[e],x?delete c[m]:typeof c.removeAttribute!==A?c.removeAttribute(m):c[m]=null,Ca.push(e))}}});var Gb,gb,hb,oc=/alpha\([^)]*\)/i,sd=/opacity\s*=\s*([^)]*)/,td=/^(top|right|bottom|left)$/,ud=/^(none|table(?!-c[ea]).+)/,Kc=/^margin/,Wc=RegExp("^("+Da+")(.*)$","i"),Pb=RegExp("^("+Da+")(?!px)[a-z%]+$","i"),vd=RegExp("^([+-])=("+Da+")","i"),vc={BODY:"block"},wd={position:"absolute",visibility:"hidden",display:"block"},Lc={letterSpacing:0,fontWeight:400},fb=["Top","Right","Bottom","Left"],
uc=["Webkit","O","Moz","ms"];d.fn.extend({css:function(a,c){return d.access(this,function(a,c,g){var h,e={},l=0;if(d.isArray(c)){h=gb(a);for(g=c.length;g>l;l++)e[c[l]]=d.css(a,c[l],!1,h);return e}return g!==b?d.style(a,c,g):d.css(a,c)},a,c,1<arguments.length)},show:function(){return I(this,!0)},hide:function(){return I(this)},toggle:function(a){var b="boolean"==typeof a;return this.each(function(){(b?a:V(this))?d(this).show():d(this).hide()})}});d.extend({cssHooks:{opacity:{get:function(a,b){if(b){var d=
hb(a,"opacity");return""===d?"1":d}}}},cssNumber:{columnCount:!0,fillOpacity:!0,fontWeight:!0,lineHeight:!0,opacity:!0,orphans:!0,widows:!0,zIndex:!0,zoom:!0},cssProps:{"float":d.support.cssFloat?"cssFloat":"styleFloat"},style:function(a,c,h,e){if(a&&3!==a.nodeType&&8!==a.nodeType&&a.style){var l,f,m,q=d.camelCase(c),x=a.style;if(c=d.cssProps[q]||(d.cssProps[q]=K(x,q)),m=d.cssHooks[c]||d.cssHooks[q],h===b)return m&&"get"in m&&(l=m.get(a,!1,e))!==b?l:x[c];if(f=typeof h,"string"===f&&(l=vd.exec(h))&&
(h=(l[1]+1)*l[2]+parseFloat(d.css(a,c)),f="number"),!(null==h||"number"===f&&isNaN(h)||("number"!==f||d.cssNumber[q]||(h+="px"),d.support.clearCloneStyle||""!==h||0!==c.indexOf("background")||(x[c]="inherit"),m&&"set"in m&&(h=m.set(a,h,e))===b)))try{x[c]=h}catch(j){}}},css:function(a,c,h,e){var l,f,m,q=d.camelCase(c);return c=d.cssProps[q]||(d.cssProps[q]=K(a.style,q)),m=d.cssHooks[c]||d.cssHooks[q],m&&"get"in m&&(f=m.get(a,!0,h)),f===b&&(f=hb(a,c,e)),"normal"===f&&c in Lc&&(f=Lc[c]),""===h||h?(l=
parseFloat(f),!0===h||d.isNumeric(l)?l||0:f):f},swap:function(a,b,d,c){var h,e={};for(h in b)e[h]=a.style[h],a.style[h]=b[h];d=d.apply(a,c||[]);for(h in b)a.style[h]=e[h];return d}});a.getComputedStyle?(gb=function(b){return a.getComputedStyle(b,null)},hb=function(a,c,h){var e,l,f,m=(h=h||gb(a))?h.getPropertyValue(c)||h[c]:b,q=a.style;return h&&(""!==m||d.contains(a.ownerDocument,a)||(m=d.style(a,c)),Pb.test(m)&&Kc.test(c)&&(e=q.width,l=q.minWidth,f=q.maxWidth,q.minWidth=q.maxWidth=q.width=m,m=h.width,
q.width=e,q.minWidth=l,q.maxWidth=f)),m}):F.documentElement.currentStyle&&(gb=function(a){return a.currentStyle},hb=function(a,d,c){var h,e,l;c=(c=c||gb(a))?c[d]:b;var f=a.style;return null==c&&f&&f[d]&&(c=f[d]),Pb.test(c)&&!td.test(d)&&(h=f.left,e=a.runtimeStyle,l=e&&e.left,l&&(e.left=a.currentStyle.left),f.left="fontSize"===d?"1em":c,c=f.pixelLeft+"px",f.left=h,l&&(e.left=l)),""===c?"auto":c});d.each(["height","width"],function(a,c){d.cssHooks[c]={get:function(a,h,g){return h?0===a.offsetWidth&&
ud.test(d.css(a,"display"))?d.swap(a,wd,function(){return R(a,c,g)}):R(a,c,g):b},set:function(a,b,h){var g=h&&gb(a);return j(a,b,h?C(a,c,h,d.support.boxSizing&&"border-box"===d.css(a,"boxSizing",!1,g),g):0)}}});d.support.opacity||(d.cssHooks.opacity={get:function(a,b){return sd.test((b&&a.currentStyle?a.currentStyle.filter:a.style.filter)||"")?0.01*parseFloat(RegExp.$1)+"":b?"1":""},set:function(a,b){var c=a.style,h=a.currentStyle,e=d.isNumeric(b)?"alpha(opacity="+100*b+")":"",l=h&&h.filter||c.filter||
"";c.zoom=1;(1<=b||""===b)&&""===d.trim(l.replace(oc,""))&&c.removeAttribute&&(c.removeAttribute("filter"),""===b||h&&!h.filter)||(c.filter=oc.test(l)?l.replace(oc,e):l+" "+e)}});d(function(){d.support.reliableMarginRight||(d.cssHooks.marginRight={get:function(a,c){return c?d.swap(a,{display:"inline-block"},hb,[a,"marginRight"]):b}});!d.support.pixelPosition&&d.fn.position&&d.each(["top","left"],function(a,c){d.cssHooks[c]={get:function(a,h){return h?(h=hb(a,c),Pb.test(h)?d(a).position()[c]+"px":
h):b}}})});d.expr&&d.expr.filters&&(d.expr.filters.hidden=function(a){return 0>=a.offsetWidth&&0>=a.offsetHeight||!d.support.reliableHiddenOffsets&&"none"===(a.style&&a.style.display||d.css(a,"display"))},d.expr.filters.visible=function(a){return!d.expr.filters.hidden(a)});d.each({margin:"",padding:"",border:"Width"},function(a,b){d.cssHooks[a+b]={expand:function(c){var d=0,h={};for(c="string"==typeof c?c.split(" "):[c];4>d;d++)h[a+fb[d]+b]=c[d]||c[d-2]||c[0];return h}};Kc.test(a)||(d.cssHooks[a+
...
"+")};d.each("blur focus focusin focusout load resize scroll unload click dblclick mousedown mouseup mousemove mouseover mouseout mouseenter mouseleave change select submit keydown keypress keyup error contextmenu".split(" "),function(a,b){d.fn[b]=function(a,c){return 0<arguments.length?this.on(b,null,a,c):this.trigger(b)}});d.fn.hover=function(a,b){return this.mouseenter(a).mouseleave(b||a)};var ob,eb,pc=d.now(),qc=/\?/,Ad=/#.*$/,Nc=/([?&])_=[^&]*/,Bd=/^(.*?):[ \t]*([^\r\n]*)\r?$/gm,Cd=/^(?:GET|HEAD)$/,
Dd=/^\/\//,Oc=/^([\w.+-]+:)(?:\/\/([^\/?#:]*)(?::(\d+)|)|)/,Pc=d.fn.load,Qc={},dc={},Rc="*/".concat("*");try{eb=ga.href}catch(Jd){eb=F.createElement("a"),eb.href="",eb=eb.href}ob=Oc.exec(eb.toLowerCase())||[];d.fn.load=function(a,c,h){if("string"!=typeof a&&Pc)return Pc.apply(this,arguments);var e,l,f,m=this,q=a.indexOf(" ");return 0<=q&&(e=a.slice(q,a.length),a=a.slice(0,q)),d.isFunction(c)?(h=c,c=b):c&&"object"==typeof c&&(f="POST"),0<m.length&&d.ajax({url:a,type:f,dataType:"html",data:c}).done(function(a){l=
arguments;m.html(e?d("<div>").append(d.parseHTML(a)).find(e):a)}).complete(h&&function(a,b){m.each(h,l||[a.responseText,b,a])}),this};d.each("ajaxStart ajaxStop ajaxComplete ajaxError ajaxSuccess ajaxSend".split(" "),function(a,b){d.fn[b]=function(a){return this.on(b,a)}});d.each(["get","post"],function(a,c){d[c]=function(a,h,g,e){return d.isFunction(h)&&(e=e||g,g=h,h=b),d.ajax({url:a,type:c,dataType:e,data:h,success:g})}});d.extend({active:0,lastModified:{},etag:{},ajaxSettings:{url:eb,type:"GET",
isLocal:/^(?:about|app|app-storage|.+-extension|file|res|widget):$/.test(ob[1]),global:!0,processData:!0,async:!0,contentType:"application/x-www-form-urlencoded; charset=UTF-8",accepts:{"*":Rc,text:"text/plain",html:"text/html",xml:"application/xml, text/xml",json:"application/json, text/javascript"},contents:{xml:/xml/,html:/html/,json:/json/},responseFields:{xml:"responseXML",text:"responseText"},converters:{"* text":a.String,"text html":!0,"text json":d.parseJSON,"text xml":d.parseXML},flatOptions:{url:!0,
context:!0}},ajaxSetup:function(a,b){return b?fa(fa(a,d.ajaxSettings),b):fa(d.ajaxSettings,a)},ajaxPrefilter:S(Qc),ajaxTransport:S(dc),ajax:function(a,c){function h(a,c,g,e){var l,u,t,v,z,O=c;if(2!==G){G=2;q&&clearTimeout(q);j=b;m=e||"";n.readyState=0<a?4:0;if(g){v=w;e=n;var r,F,C,s,Oa=v.contents,ga=v.dataTypes,Sa=v.responseFields;for(s in Sa)s in g&&(e[Sa[s]]=g[s]);for(;"*"===ga[0];)ga.shift(),F===b&&(F=v.mimeType||e.getResponseHeader("Content-Type"));if(F)for(s in Oa)if(Oa[s]&&Oa[s].test(F)){ga.unshift(s);
break}if(ga[0]in g)C=ga[0];else{for(s in g){if(!ga[0]||v.converters[s+" "+ga[0]]){C=s;break}r||(r=s)}C=C||r}v=C?(C!==ga[0]&&ga.unshift(C),g[C]):b}if(200<=a&&300>a||304===a)if(w.ifModified&&(z=n.getResponseHeader("Last-Modified"),z&&(d.lastModified[f]=z),z=n.getResponseHeader("etag"),z&&(d.etag[f]=z)),204===a)l=!0,O="nocontent";else if(304===a)l=!0,O="notmodified";else{var B;a:{g=w;l=v;var H,Ia;t={};z=0;O=g.dataTypes.slice();r=O[0];if(g.dataFilter&&(l=g.dataFilter(l,g.dataType)),O[1])for(H in g.converters)t[H.toLowerCase()]=
g.converters[H];for(;u=O[++z];)if("*"!==u){if("*"!==r&&r!==u){if(H=t[r+" "+u]||t["* "+u],!H)for(B in t)if(Ia=B.split(" "),Ia[1]===u&&(H=t[r+" "+Ia[0]]||t["* "+Ia[0]])){!0===H?H=t[B]:!0!==t[B]&&(u=Ia[0],O.splice(z--,0,u));break}if(!0!==H)if(H&&g["throws"])l=H(l);else try{l=H(l)}catch(R){B={state:"parsererror",error:H?R:"No conversion from "+r+" to "+u};break a}}r=u}B={state:"success",data:l}}l=B;O=l.state;u=l.data;t=l.error;l=!t}else t=O,(a||!O)&&(O="error",0>a&&(a=0));n.status=a;n.statusText=(c||
O)+"";l?p.resolveWith(A,[u,O,n]):p.rejectWith(A,[n,O,t]);n.statusCode(Wa);Wa=b;x&&D.trigger(l?"ajaxSuccess":"ajaxError",[n,w,l?u:t]);k.fireWith(A,[n,O]);x&&(D.trigger("ajaxComplete",[n,w]),--d.active||d.event.trigger("ajaxStop"))}}"object"==typeof a&&(c=a,a=b);c=c||{};var e,l,f,m,q,x,j,u,w=d.ajaxSetup({},c),A=w.context||w,D=w.context&&(A.nodeType||A.jquery)?d(A):d.event,p=d.Deferred(),k=d.Callbacks("once memory"),Wa=w.statusCode||{},O={},r={},G=0,F="canceled",n={readyState:0,getResponseHeader:function(a){var b;
if(2===G){if(!u)for(u={};b=Bd.exec(m);)u[b[1].toLowerCase()]=b[2];b=u[a.toLowerCase()]}return null==b?null:b},getAllResponseHeaders:function(){return 2===G?m:null},setRequestHeader:function(a,b){var c=a.toLowerCase();return G||(a=r[c]=r[c]||a,O[a]=b),this},overrideMimeType:function(a){return G||(w.mimeType=a),this},statusCode:function(a){var b;if(a)if(2>G)for(b in a)Wa[b]=[Wa[b],a[b]];else n.always(a[n.status]);return this},abort:function(a){a=a||F;return j&&j.abort(a),h(0,a),this}};if(p.promise(n).complete=
k.add,n.success=n.done,n.error=n.fail,w.url=((a||w.url||eb)+"").replace(Ad,"").replace(Dd,ob[1]+"//"),w.type=c.method||c.type||w.method||w.type,w.dataTypes=d.trim(w.dataType||"*").toLowerCase().match(Ba)||[""],null==w.crossDomain&&(e=Oc.exec(w.url.toLowerCase()),w.crossDomain=!(!e||e[1]===ob[1]&&e[2]===ob[2]&&(e[3]||("http:"===e[1]?80:443))==(ob[3]||("http:"===ob[1]?80:443)))),w.data&&w.processData&&"string"!=typeof w.data&&(w.data=d.param(w.data,w.traditional)),P(Qc,w,c,n),2===G)return n;(x=w.global)&&
0===d.active++&&d.event.trigger("ajaxStart");w.type=w.type.toUpperCase();w.hasContent=!Cd.test(w.type);f=w.url;w.hasContent||(w.data&&(f=w.url+=(qc.test(f)?"&":"?")+w.data,delete w.data),!1===w.cache&&(w.url=Nc.test(f)?f.replace(Nc,"$1_="+pc++):f+(qc.test(f)?"&":"?")+"_="+pc++));w.ifModified&&(d.lastModified[f]&&n.setRequestHeader("If-Modified-Since",d.lastModified[f]),d.etag[f]&&n.setRequestHeader("If-None-Match",d.etag[f]));(w.data&&w.hasContent&&!1!==w.contentType||c.contentType)&&n.setRequestHeader("Content-Type",
w.contentType);n.setRequestHeader("Accept",w.dataTypes[0]&&w.accepts[w.dataTypes[0]]?w.accepts[w.dataTypes[0]]+("*"!==w.dataTypes[0]?", "+Rc+"; q=0.01":""):w.accepts["*"]);for(l in w.headers)n.setRequestHeader(l,w.headers[l]);if(w.beforeSend&&(!1===w.beforeSend.call(A,n,w)||2===G))return n.abort();F="abort";for(l in{success:1,error:1,complete:1})n[l](w[l]);if(j=P(dc,w,c,n)){n.readyState=1;x&&D.trigger("ajaxSend",[n,w]);w.async&&0<w.timeout&&(q=setTimeout(function(){n.abort("timeout")},w.timeout));
try{G=1,j.send(O,h)}catch(C){if(!(2>G))throw C;h(-1,C)}}else h(-1,"No Transport");return n},getScript:function(a,c){return d.get(a,b,c,"script")},getJSON:function(a,b,c){return d.get(a,b,c,"json")}});d.ajaxSetup({accepts:{script:"text/javascript, application/javascript, application/ecmascript, application/x-ecmascript"},contents:{script:/(?:java|ecma)script/},converters:{"text script":function(a){return d.globalEval(a),a}}});d.ajaxPrefilter("script",function(a){a.cache===b&&(a.cache=!1);a.crossDomain&&
...
c.onload(b,!0)}}}});var Sc=[],rc=/(=)\?(?=&|$)|\?\?/;d.ajaxSetup({jsonp:"callback",jsonpCallback:function(){var a=Sc.pop()||d.expando+"_"+pc++;return this[a]=!0,a}});d.ajaxPrefilter("json jsonp",function(c,h,e){var l,f,m,q=!1!==c.jsonp&&(rc.test(c.url)?"url":"string"==typeof c.data&&!(c.contentType||"").indexOf("application/x-www-form-urlencoded")&&rc.test(c.data)&&"data");return q||"jsonp"===c.dataTypes[0]?(l=c.jsonpCallback=d.isFunction(c.jsonpCallback)?c.jsonpCallback():c.jsonpCallback,q?c[q]=
c[q].replace(rc,"$1"+l):!1!==c.jsonp&&(c.url+=(qc.test(c.url)?"&":"?")+c.jsonp+"="+l),c.converters["script json"]=function(){return m||d.error(l+" was not called"),m[0]},c.dataTypes[0]="json",f=a[l],a[l]=function(){m=arguments},e.always(function(){a[l]=f;c[l]&&(c.jsonpCallback=h.jsonpCallback,Sc.push(l));m&&d.isFunction(f)&&f(m[0]);m=f=b}),"script"):b});var Eb,Ob,Ed=0,sc=a.ActiveXObject&&function(){for(var a in Eb)Eb[a](b,!0)};d.ajaxSettings.xhr=a.ActiveXObject?function(){var b;if(!(b=!this.isLocal&&
ha()))a:{try{b=new a.ActiveXObject("Microsoft.XMLHTTP");break a}catch(c){}b=void 0}return b}:ha;Ob=d.ajaxSettings.xhr();d.support.cors=!!Ob&&"withCredentials"in Ob;(Ob=d.support.ajax=!!Ob)&&d.ajaxTransport(function(c){if(!c.crossDomain||d.support.cors){var h;return{send:function(e,l){var f,m,q=c.xhr();if(c.username?q.open(c.type,c.url,c.async,c.username,c.password):q.open(c.type,c.url,c.async),c.xhrFields)for(m in c.xhrFields)q[m]=c.xhrFields[m];c.mimeType&&q.overrideMimeType&&q.overrideMimeType(c.mimeType);
c.crossDomain||e["X-Requested-With"]||(e["X-Requested-With"]="XMLHttpRequest");try{for(m in e)q.setRequestHeader(m,e[m])}catch(x){}q.send(c.hasContent&&c.data||null);h=function(a,e){var m,x,j,w;try{if(h&&(e||4===q.readyState))if(h=b,f&&(q.onreadystatechange=d.noop,sc&&delete Eb[f]),e)4!==q.readyState&&q.abort();else{w={};m=q.status;x=q.getAllResponseHeaders();"string"==typeof q.responseText&&(w.text=q.responseText);try{j=q.statusText}catch(u){j=""}m||!c.isLocal||c.crossDomain?1223===m&&(m=204):m=
w.text?200:404}}catch(A){e||l(-1,A)}w&&l(m,j,w,x)};c.async?4===q.readyState?setTimeout(h):(f=++Ed,sc&&(Eb||(Eb={},d(a).unload(sc)),Eb[f]=h),q.onreadystatechange=h):h()},abort:function(){h&&h(b,!0)}}}});var pb,bc,Fd=/^(?:toggle|show|hide)$/,Gd=RegExp("^(?:([+-])=|)("+Da+")([a-z%]*)$","i"),Hd=/queueHooks$/,Qb=[function(a,b,c){var h,e,l,f,m,q,x=this,j=a.style,w={},u=[],A=a.nodeType&&V(a);c.queue||(m=d._queueHooks(a,"fx"),null==m.unqueued&&(m.unqueued=0,q=m.empty.fire,m.empty.fire=function(){m.unqueued||
q()}),m.unqueued++,x.always(function(){x.always(function(){m.unqueued--;d.queue(a,"fx").length||m.empty.fire()})}));1===a.nodeType&&("height"in b||"width"in b)&&(c.overflow=[j.overflow,j.overflowX,j.overflowY],"inline"===d.css(a,"display")&&"none"===d.css(a,"float")&&(d.support.inlineBlockNeedsLayout&&"inline"!==ca(a.nodeName)?j.zoom=1:j.display="inline-block"));c.overflow&&(j.overflow="hidden",d.support.shrinkWrapBlocks||x.always(function(){j.overflow=c.overflow[0];j.overflowX=c.overflow[1];j.overflowY=
c.overflow[2]}));for(e in b)if(l=b[e],Fd.exec(l))(delete b[e],h=h||"toggle"===l,l===(A?"hide":"show"))||u.push(e);if(b=u.length){l=d._data(a,"fxshow")||d._data(a,"fxshow",{});"hidden"in l&&(A=l.hidden);h&&(l.hidden=!A);A?d(a).show():x.done(function(){d(a).hide()});x.done(function(){var b;d._removeData(a,"fxshow");for(b in w)d.style(a,b,w[b])});for(e=0;b>e;e++)h=u[e],f=x.createTween(h,A?l[h]:0),w[h]=l[h]||d.style(a,h),h in l||(l[h]=f.start,A&&(f.end=f.start,f.start="width"===h||"height"===h?1:0))}}],
Hb={"*":[function(a,b){var c,h,e=this.createTween(a,b),l=Gd.exec(b),f=e.cur(),m=+f||0,q=1,x=20;if(l){if(c=+l[2],h=l[3]||(d.cssNumber[a]?"":"px"),"px"!==h&&m){m=d.css(e.elem,a,!0)||c||1;do q=q||".5",m/=q,d.style(e.elem,a,m+h);while(q!==(q=e.cur()/f)&&1!==q&&--x)}e.unit=h;e.start=m;e.end=l[1]?m+(l[1]+1)*c:c}return e}]};d.Animation=d.extend(ia,{tweener:function(a,b){d.isFunction(a)?(b=a,a=["*"]):a=a.split(" ");for(var c,h=0,e=a.length;e>h;h++)c=a[h],Hb[c]=Hb[c]||[],Hb[c].unshift(b)},prefilter:function(a,
...
d.style(a.elem,a.prop,a.now+a.unit):a.elem[a.prop]=a.now}}};Y.propHooks.scrollTop=Y.propHooks.scrollLeft={set:function(a){a.elem.nodeType&&a.elem.parentNode&&(a.elem[a.prop]=a.now)}};d.each(["toggle","show","hide"],function(a,b){var c=d.fn[b];d.fn[b]=function(a,d,h){return null==a||"boolean"==typeof a?c.apply(this,arguments):this.animate(m(b,!0),a,d,h)}});d.fn.extend({fadeTo:function(a,b,c,d){return this.filter(V).css("opacity",0).show().end().animate({opacity:b},a,c,d)},animate:function(a,b,c,h){var e=
d.isEmptyObject(a),l=d.speed(b,c,h),f=function(){var b=ia(this,d.extend({},a),l);f.finish=function(){b.stop(!0)};(e||d._data(this,"finish"))&&b.stop(!0)};return f.finish=f,e||!1===l.queue?this.each(f):this.queue(l.queue,f)},stop:function(a,c,h){var e=function(a){var b=a.stop;delete a.stop;b(h)};return"string"!=typeof a&&(h=c,c=a,a=b),c&&!1!==a&&this.queue(a||"fx",[]),this.each(function(){var b=!0,c=null!=a&&a+"queueHooks",l=d.timers,f=d._data(this);if(c)f[c]&&f[c].stop&&e(f[c]);else for(c in f)f[c]&&
...
(function(a,b,c){function e(a,b,c){for(var e=[],f=0;f<a.length;f++){var m=tinycolor(a[f]),j=0.5>m.toHsl().l?"sp-thumb-el sp-thumb-dark":"sp-thumb-el sp-thumb-light",j=j+(tinycolor.equals(b,a[f])?" sp-thumb-active":""),D=y?"background-color:"+m.toRgbString():"filter:"+m.toFilter();e.push('<span title="'+m.toRgbString()+'" data-color="'+m.toRgbString()+'" class="'+j+'"><span class="sp-thumb-inner" style="'+D+';" /></span>')}return"<div class='sp-cf "+c+"'>"+e.join("")+"</div>"}function f(a,c){var e=
a.outerWidth(),f=a.outerHeight(),m=c.outerHeight(),j=a[0].ownerDocument,D=j.documentElement,p=D.clientWidth+b(j).scrollLeft(),j=D.clientHeight+b(j).scrollTop(),D=c.offset();D.top+=m;D.left-=Math.min(D.left,D.left+e>p&&p>e?Math.abs(D.left+e-p):0);D.top-=Math.min(D.top,D.top+f>j&&j>f?Math.abs(f+m-0):0);return D}function n(){}function s(a){a.stopPropagation()}function k(a,b){var c=Array.prototype.slice,e=c.call(arguments,2);return function(){return a.apply(b,e.concat(c.call(arguments)))}}function p(c,
e,f,m){function j(a){a.stopPropagation&&a.stopPropagation();a.preventDefault&&a.preventDefault();a.returnValue=!1}function D(a){if(r){if(W&&9>document.documentMode&&!a.button)return p();var b=a.originalEvent.touches,d=b?b[0].pageY:a.pageY,b=Math.max(0,Math.min((b?b[0].pageX:a.pageX)-n.left,s)),d=Math.max(0,Math.min(d-n.top,C));u&&j(a);e.apply(c,[b,d,a])}}function p(){r&&(b(k).unbind(O),b(k.body).removeClass("sp-dragging"),m.apply(c,arguments));r=!1}e=e||function(){};f=f||function(){};m=m||function(){};
var k=c.ownerDocument||document,r=!1,n={},C=0,s=0,u="ontouchstart"in a,O={};O.selectstart=j;O.dragstart=j;O[u?"touchmove":"mousemove"]=D;O[u?"touchend":"mouseup"]=p;b(c).bind(u?"touchstart":"mousedown",function(a){if(!(a.which?3==a.which:2==a.button)&&!r&&!1!==f.apply(c,arguments))r=!0,C=b(c).height(),s=b(c).width(),n=b(c).offset(),b(k).bind(O),b(k.body).addClass("sp-dragging"),u||D(a),j(a)})}var Q={beforeShow:n,move:n,change:n,show:n,hide:n,color:!1,flat:!1,showInput:!0,showButtons:!1,clickoutFiresChange:!1,
...
b.fn.spectrum=function(m,j){if("string"==typeof m){var A=this,D=Array.prototype.slice.call(arguments,1);this.each(function(){var a=T[b(this).data("spectrum.id")];if(a){var c=a[m];if(!c)throw Error("Spectrum: no such method: '"+m+"'");"get"==m?A=a.get():"container"==m?A=a.container:"option"==m?A=a.option.apply(a,D):"destroy"==m?(a.destroy(),b(this).removeData("spectrum.id")):c.apply(a,D)}});return A}return this.spectrum("destroy").each(function(){var j,w=function(){l.toggleClass("sp-flat",U);l.toggleClass("sp-input-disabled",
...
0;h<lb.length;h++)for(var e=0;e<lb[h].length;e++)d=tinycolor(lb[h][e]).toRgbString(),c[d]=!0;for(h=0;h<b.length;h++)d=tinycolor(b[h]).toRgbString(),c.hasOwnProperty(d)||(a.push(b[h]),c[d]=!0)}return a.reverse().slice(0,L.maxSelectionSize)},r=function(){var a=B(),c=b.map(lb,function(b,c){return e(b,a,"sp-palette-row sp-palette-row-"+c)});Ga&&c.push(e(D(),a,"sp-palette-row sp-palette-row-selection"));Tb.html(c.join(""))},n=function(){if(L.showInitial){var a=Ya,b=B();Kb.html(e([a,b],b,"sp-palette-row-initial"))}},
C=function(){(0===ea||0===ba||0===na)&&K();l.addClass(wa)},F=function(){l.removeClass(wa)},u=function(){var a=tinycolor(Pa.val());a.ok?d(a):Pa.addClass("sp-validation-error")},O=function(){ja?H():G()},G=function(){if(ja)K();else if(!1!==E.beforeShow(B())){for(var c=0;c<T.length;c++)T[c]&&T[c].hide();ja=!0;b(xa).bind("click.spectrum",H);b(a).bind("resize.spectrum",fa);Aa.addClass("sp-active");l.show();L.showPalette&&r();K();S();Ya=B();n();E.show(Ya)}},H=function(c){if((!c||!("click"==c.type&&2==c.button))&&
ja&&!U)ja=!1,b(xa).unbind("click.spectrum",H),b(a).unbind("resize.spectrum",fa),Aa.removeClass("sp-active"),l.hide(),tinycolor.equals(B(),Ya)||(xb&&"cancel"!==c?X(!0):d(Ya,!0)),E.hide(B())},d=function(a,b){if(!tinycolor.equals(a,B())){var c=tinycolor(a),d=c.toHsv();la=d.h;Na=d.s;ra=d.v;J=d.a;S();b||(Xa=Ma||c.format)}},B=function(){return tinycolor.fromRatio({h:la,s:Na,v:ra,a:Math.round(100*J)/100})},R=function(){S();E.move(B())},S=function(){Pa.removeClass("sp-validation-error");I();var a=tinycolor({h:la,
s:"1.0",v:"1.0"});x.css("background-color",a.toHexString());a=Xa;if(1>J&&("hex"===a||"name"===a))a="rgb";var b=B(),c=b.toHexString(),d=b.toRgbString();y||1===b.alpha?yb.css("background-color",d):(yb.css("background-color","transparent"),yb.css("filter",b.toFilter()));if(L.showAlpha){d=b.toRgb();d.a=0;var d=tinycolor(d).toRgbString(),h="linear-gradient(left, "+d+", "+c+")";W?Ea.css("filter",tinycolor(d).toFilter({gradientType:1},c)):(Ea.css("background","-webkit-"+h),Ea.css("background","-moz-"+h),
Ea.css("background","-ms-"+h),Ea.css("background",h))}if(L.showInput){if(1>J&&("hex"===a||"name"===a))a="rgb";Pa.val(b.toString(a))}L.showPalette&&r();n()},I=function(){var a=Na*ba,b=ea-ra*ea,a=Math.max(-M,Math.min(ba-M,a-M)),b=Math.max(-M,Math.min(ea-M,b-M));Wa.css({top:b,left:a});sb.css({left:J*oa-ua/2});Ia.css({top:la*na-Ha})},X=function(a){var b=B();mb&&va.val(b.toString(Xa)).change();var c=!tinycolor.equals(b,Ya);Ya=b;A(b);a&&c&&E.change(b)},K=function(){ba=x.width();ea=x.height();M=Wa.height();
Oa.width();na=Oa.height();Ha=Ia.height();oa=rb.width();ua=sb.width();U||l.offset(f(l,Z));I()};j=function(){H();h=!0;va.attr("disabled",!0);Z.addClass("sp-disabled")};var L,P=b.extend({},Q,m);P.callbacks={move:k(P.move,this),change:k(P.change,this),show:k(P.show,this),hide:k(P.hide,this),beforeShow:k(P.beforeShow,this)};L=P;var U=L.flat,V=L.showSelectionPalette,ca=L.localStorageKey,Y=L.theme,E=L.callbacks,fa,ha=K,ia;fa=function(){var a=this,b=arguments;ia||(ia=setTimeout(function(){ia=null;ha.apply(a,
b)},10))};var ja=!1,ba=0,ea=0,M=0,na=0,oa=0,ua=0,Ha=0,la=0,Na=0,ra=0,J=1,P=L.palette.slice(0),lb=b.isArray(P[0])?P:[P],Ga=L.selectionPalette.slice(0),wa="sp-dragging",xa=this.ownerDocument,P=xa.body,va=b(this),h=!1,l=b(N,xa).addClass(Y),x=l.find(".sp-color"),Wa=l.find(".sp-dragger"),Oa=l.find(".sp-hue"),Ia=l.find(".sp-slider"),Ea=l.find(".sp-alpha-inner"),rb=l.find(".sp-alpha"),sb=l.find(".sp-alpha-handle"),Pa=l.find(".sp-input"),Tb=l.find(".sp-palette"),Kb=l.find(".sp-initial"),Lb=l.find(".sp-cancel"),
tb=l.find(".sp-choose"),mb=va.is("input"),ya=mb&&!U,Aa=ya?b("<div class='sp-replacer'><div class='sp-preview'><div class='sp-preview-inner'></div></div></div>").addClass(Y):b([]),Z=ya?Aa:va,yb=Aa.find(".sp-preview-inner"),zb=L.color||mb&&va.val(),Ya=!1,Ma=L.preferredFormat,Xa=Ma,xb=!L.showButtons||L.clickoutFiresChange,Y=function(a){a.data&&a.data.ignore?(d(b(this).data("color")),R()):(d(b(this).data("color")),X(!0),R(),H());return!1};W&&l.find("*:not(input)").attr("unselectable","on");w();ya&&va.hide().after(Aa);
U?va.after(l).hide():b(P).append(l.hide());if(ca&&a.localStorage){try{var Ab=a.localStorage[ca].split(",#");1<Ab.length&&(delete a.localStorage[ca],b.each(Ab,function(a,b){A(b)}))}catch(Xb){}try{Ga=a.localStorage[ca].split(";")}catch(Nb){}}Z.bind("click.spectrum touchstart.spectrum",function(a){h||O();a.stopPropagation();b(a.target).is("input")||a.preventDefault()});(va.is(":disabled")||!0===L.disabled)&&j();l.click(s);Pa.change(u);Pa.bind("paste",function(){setTimeout(u,1)});Pa.keydown(function(a){13==
a.keyCode&&u()});Lb.text(L.cancelText);Lb.bind("click.spectrum",function(a){a.stopPropagation();a.preventDefault();H("cancel")});tb.text(L.chooseText);tb.bind("click.spectrum",function(a){a.stopPropagation();a.preventDefault();Pa.hasClass("sp-validation-error")||(X(!0),H())});p(rb,function(a,b,c){J=a/oa;c.shiftKey&&(J=Math.round(10*J)/10);R()});p(Oa,function(a,b){la=parseFloat(b/na);R()},C,F);p(x,function(a,b){Na=parseFloat(a/ba);ra=parseFloat((ea-b)/ea);R()},C,F);zb?(d(zb),S(),Xa=Ma||tinycolor(zb).format,
A(zb)):S();U&&G();C=W?"mousedown.spectrum":"click.spectrum touchstart.spectrum";Tb.delegate(".sp-thumb-el",C,Y);Kb.delegate(".sp-thumb-el:nth-child(1)",C,{ignore:!0},Y);var db={show:G,hide:H,toggle:O,reflow:K,option:function(a,d){if(a===c)return b.extend({},L);if(d===c)return L[a];L[a]=d;w()},enable:function(){h=!1;va.attr("disabled",!1);Z.removeClass("sp-disabled")},disable:j,set:function(a){d(a);X()},get:B,destroy:function(){va.show();Z.unbind("click.spectrum touchstart.spectrum");l.remove();Aa.remove();
T[db.id]=null},container:l};db.id=T.push(db)-1;j=db;b(this).data("spectrum.id",j.id)})};b.fn.spectrum.load=!0;b.fn.spectrum.loadOpts={};b.fn.spectrum.draggable=p;b.fn.spectrum.defaults=Q;b.spectrum={};b.spectrum.localization={};b.spectrum.palettes={};b.fn.spectrum.processNativeColorInputs=function(){var a=b("<input type='color' value='!' />")[0];"color"===a.type&&"!"!=a.value||b("input[type=color]").spectrum({preferredFormat:"hex6"})};var r=function(a){var b,c,e,f,p;if("object"==typeof a&&a.hasOwnProperty("_tc_id"))return a;
c=a;var k=0,n=0,s=0;a=1;var B=!1,y=!1;if("string"==typeof c)a:{c=c.replace(C,"").replace(R,"").toLowerCase();var N=!1;if(ja[c])c=ja[c],N=!0;else if("transparent"==c){c={r:0,g:0,b:0,a:0};break a}c=(b=D.rgb.exec(c))?{r:b[1],g:b[2],b:b[3]}:(b=D.rgba.exec(c))?{r:b[1],g:b[2],b:b[3],a:b[4]}:(b=D.hsl.exec(c))?{h:b[1],s:b[2],l:b[3]}:(b=D.hsla.exec(c))?{h:b[1],s:b[2],l:b[3],a:b[4]}:(b=D.hsv.exec(c))?{h:b[1],s:b[2],v:b[3]}:(b=D.hex6.exec(c))?{r:parseInt(b[1],16),g:parseInt(b[2],16),b:parseInt(b[3],16),format:N?
"name":"hex"}:(b=D.hex3.exec(c))?{r:parseInt(b[1]+""+b[1],16),g:parseInt(b[2]+""+b[2],16),b:parseInt(b[3]+""+b[3],16),format:N?"name":"hex"}:!1}"object"==typeof c&&(c.hasOwnProperty("r")&&c.hasOwnProperty("g")&&c.hasOwnProperty("b")?(k=255*I(c.r,255),n=255*I(c.g,255),s=255*I(c.b,255),B=!0,y="rgb"):c.hasOwnProperty("h")&&c.hasOwnProperty("s")&&c.hasOwnProperty("v")?(y=c.h,n=c.s,s=c.v,y=6*I(y,360),n=I(n,100),s=I(s,100),k=L.floor(y),B=y-k,y=s*(1-n),b=s*(1-B*n),B=s*(1-(1-B)*n),N=k%6,k=255*[s,b,y,y,B,
s][N],n=255*[B,s,s,b,y,y][N],s=255*[y,y,B,s,s,b][N],B=!0,y="hsv"):c.hasOwnProperty("h")&&(c.hasOwnProperty("s")&&c.hasOwnProperty("l"))&&(k=c.h,y=c.s,s=c.l,n=function(a,b,c){0>c&&(c+=1);1<c&&(c-=1);return c<1/6?a+6*(b-a)*c:0.5>c?b:c<2/3?a+6*(b-a)*(2/3-c):a},k=I(k,360),y=I(y,100),s=I(s,100),0===y?y=s=b=s:(b=0.5>s?s*(1+y):s+y-s*y,B=2*s-b,y=n(B,b,k+1/3),s=n(B,b,k),b=n(B,b,k-1/3)),k=255*y,n=255*s,s=255*b,B=!0,y="hsl"),c.hasOwnProperty("a")&&(a=c.a));k=S(255,P(k,0));n=S(255,P(n,0));s=S(255,P(s,0));1>k&&
(k=H(k));1>n&&(n=H(n));1>s&&(s=H(s));b=B;c=c&&c.format||y;e=k;f=n;p=s;var u=ha(a);return{ok:b,format:c,_tc_id:ca++,alpha:u,toHsv:function(){var a=K(e,f,p);return{h:a.h,s:a.s,v:a.v,a:u}},toHsvString:function(){var a=K(e,f,p),b=H(360*a.h),c=H(100*a.s),a=H(100*a.v);return 1==u?"hsv("+b+", "+c+"%, "+a+"%)":"hsva("+b+", "+c+"%, "+a+"%, "+u+")"},toHsl:function(){var a=U(e,f,p);return{h:a.h,s:a.s,l:a.l,a:u}},toHslString:function(){var a=U(e,f,p),b=H(360*a.h),c=H(100*a.s),a=H(100*a.l);return 1==u?"hsl("+
b+", "+c+"%, "+a+"%)":"hsla("+b+", "+c+"%, "+a+"%, "+u+")"},toHex:function(){return V(e,f,p)},toHexString:function(a){return"#"+V(e,f,p,a)},toRgb:function(){return{r:H(e),g:H(f),b:H(p),a:u}},toRgbString:function(){return 1==u?"rgb("+H(e)+", "+H(f)+", "+H(p)+")":"rgba("+H(e)+", "+H(f)+", "+H(p)+", "+u+")"},toName:function(){return m[V(e,f,p)]||!1},toFilter:function(a,b){var c=V(e,f,p,!0),d=c,m=Math.round(255*ha(u)).toString(16),q=m,w=a&&a.gradientType?"GradientType = 1, ":"";b&&(q=r(b),d=q.toHex(),
q=Math.round(255*ha(q.alpha)).toString(16));return"progid:DXImageTransform.Microsoft.gradient("+w+"startColorstr=#"+j(m)+c+",endColorstr=#"+j(q)+d+")"},toString:function(a){a=a||this.format;var b=!1;"rgb"===a&&(b=this.toRgbString());"hex"===a&&(b=this.toHexString());"hex6"===a&&(b=this.toHexString(!0));"name"===a&&(b=this.toName());"hsl"===a&&(b=this.toHslString());"hsv"===a&&(b=this.toHsvString());return b||this.toHexString(!0)}}},U=function(a,b,c){a=I(a,255);b=I(b,255);c=I(c,255);var e=P(a,b,c),
f=S(a,b,c),m,j=(e+f)/2;if(e==f)m=f=0;else{var D=e-f,f=0.5<j?D/(2-e-f):D/(e+f);switch(e){case a:m=(b-c)/D+(b<c?6:0);break;case b:m=(c-a)/D+2;break;case c:m=(a-b)/D+4}m/=6}return{h:m,s:f,l:j}},K=function(a,b,c){a=I(a,255);b=I(b,255);c=I(c,255);var e=P(a,b,c),f=S(a,b,c),m,j=e-f;if(e==f)m=0;else{switch(e){case a:m=(b-c)/j+(b<c?6:0);break;case b:m=(c-a)/j+2;break;case c:m=(a-b)/j+4}m/=6}return{h:m,s:0===e?0:j/e,v:e}},V=function(a,b,c,e){a=[j(H(a).toString(16)),j(H(b).toString(16)),j(H(c).toString(16))];
return!e&&a[0].charAt(0)==a[0].charAt(1)&&a[1].charAt(0)==a[1].charAt(1)&&a[2].charAt(0)==a[2].charAt(1)?a[0].charAt(0)+a[1].charAt(0)+a[2].charAt(0):a.join("")},I=function(a,b){"string"==typeof a&&(-1!=a.indexOf(".")&&1===ha(a))&&(a="100%");var c="string"===typeof a&&-1!=a.indexOf("%");a=S(b,P(0,ha(a)));c&&(a*=b/100);return 1E-6>L.abs(a-b)?1:1<=a?a%b/ha(b):a},j=function(a){return 1==a.length?"0"+a:""+a},C=/^[\s,#]+/,R=/\s+$/,ca=0,L=Math,H=L.round,S=L.min,P=L.max,fa=L.random,ha=this.parseFloat;r.fromRatio=
function(a){if("object"==typeof a)for(var b in a)1===a[b]&&(a[b]="1.0");return r(a)};r.equals=function(a,b){return!a||!b?!1:r(a).toRgbString()==r(b).toRgbString()};r.random=function(){return r.fromRatio({r:fa(),g:fa(),b:fa()})};r.desaturate=function(a,b){var c=r(a).toHsl();c.s-=(b||10)/100;c.s=S(1,P(0,c.s));return r(c)};r.saturate=function(a,b){var c=r(a).toHsl();c.s+=(b||10)/100;c.s=S(1,P(0,c.s));return r(c)};r.greyscale=function(a){return r.desaturate(a,100)};r.lighten=function(a,b){var c=r(a).toHsl();
c.l+=(b||10)/100;c.l=S(1,P(0,c.l));return r(c)};r.darken=function(a,b){var c=r(a).toHsl();c.l-=(b||10)/100;c.l=S(1,P(0,c.l));return r(c)};r.complement=function(a){a=r(a).toHsl();a.h=(a.h+0.5)%1;return r(a)};r.triad=function(a){var b=r(a).toHsl(),c=360*b.h;return[r(a),r({h:(c+120)%360,s:b.s,l:b.l}),r({h:(c+240)%360,s:b.s,l:b.l})]};r.tetrad=function(a){var b=r(a).toHsl(),c=360*b.h;return[r(a),r({h:(c+90)%360,s:b.s,l:b.l}),r({h:(c+180)%360,s:b.s,l:b.l}),r({h:(c+270)%360,s:b.s,l:b.l})]};r.splitcomplement=
function(a){var b=r(a).toHsl(),c=360*b.h;return[r(a),r({h:(c+72)%360,s:b.s,l:b.l}),r({h:(c+216)%360,s:b.s,l:b.l})]};r.analogous=function(a,b,c){b=b||6;c=c||30;var e=r(a).toHsl();c=360/c;a=[r(a)];e.h*=360;for(e.h=(e.h-(c*b>>1)+720)%360;--b;)e.h=(e.h+c)%360,a.push(r(e));return a};r.monochromatic=function(a,b){b=b||6;for(var c=r(a).toHsv(),e=c.h,f=c.s,c=c.v,m=[],j=1/b;b--;)m.push(r({h:e,s:f,v:c})),c=(c+j)%1;return m};r.readable=function(a,b){var c=r(a).toRgb(),e=r(b).toRgb();return 10404<(e.r-c.r)*(e.r-
c.r)+(e.g-c.g)*(e.g-c.g)+(e.b-c.b)*(e.b-c.b)};var ja=r.names={aliceblue:"f0f8ff",antiquewhite:"faebd7",aqua:"0ff",aquamarine:"7fffd4",azure:"f0ffff",beige:"f5f5dc",bisque:"ffe4c4",black:"000",blanchedalmond:"ffebcd",blue:"00f",blueviolet:"8a2be2",brown:"a52a2a",burlywood:"deb887",burntsienna:"ea7e5d",cadetblue:"5f9ea0",chartreuse:"7fff00",chocolate:"d2691e",coral:"ff7f50",cornflowerblue:"6495ed",cornsilk:"fff8dc",crimson:"dc143c",cyan:"0ff",darkblue:"00008b",darkcyan:"008b8b",darkgoldenrod:"b8860b",
...
slategray:"708090",slategrey:"708090",snow:"fffafa",springgreen:"00ff7f",steelblue:"4682b4",tan:"d2b48c",teal:"008080",thistle:"d8bfd8",tomato:"ff6347",turquoise:"40e0d0",violet:"ee82ee",wheat:"f5deb3",white:"fff",whitesmoke:"f5f5f5",yellow:"ff0",yellowgreen:"9acd32"},B=r,X=ja,ia={},Y;for(Y in X)X.hasOwnProperty(Y)&&(ia[X[Y]]=Y);var m=B.hexNames=ia,D;D={rgb:RegExp("rgb[\\s|\\(]+((?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?))[,|\\s]+((?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?))[,|\\s]+((?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?))\\s*\\)?"),
...
c.source&&b.global==c.global&&b.multiline==c.multiline&&b.ignoreCase==c.ignoreCase}if("object"!=typeof b||"object"!=typeof c)return!1;for(var k=e.length;k--;)if(e[k]==b)return!0;e.push(b);var k=0,n=!0;if("[object Array]"==f){if(k=b.length,n=k==c.length)for(;k--&&(n=k in b==k in c&&a(b[k],c[k],e)););}else{if("constructor"in b!="constructor"in c||b.constructor!=c.constructor)return!1;for(var r in b)if(j.has(b,r)&&(k++,!(n=j.has(c,r)&&a(b[r],c[r],e))))break;if(n){for(r in c)if(j.has(c,r)&&!k--)break;
n=!k}}e.pop();return n}var b=this,c=b._,e={},f=Array.prototype,n=Object.prototype,s=f.slice,k=f.unshift,p=n.toString,Q=n.hasOwnProperty,T=f.forEach,W=f.map,y=f.reduce,B=f.reduceRight,N=f.filter,X=f.every,r=f.some,U=f.indexOf,K=f.lastIndexOf,n=Array.isArray,V=Object.keys,I=Function.prototype.bind,j=function(a){return new ia(a)};"undefined"!==typeof exports?("undefined"!==typeof module&&module.exports&&(exports=module.exports=j),exports._=j):b._=j;j.VERSION="1.3.3";var C=j.each=j.forEach=function(a,
b,c){if(null!=a)if(T&&a.forEach===T)a.forEach(b,c);else if(a.length===+a.length)for(var f=0,k=a.length;f<k&&!(f in a&&b.call(c,a[f],f,a)===e);f++);else for(f in a)if(j.has(a,f)&&b.call(c,a[f],f,a)===e)break};j.map=j.collect=function(a,b,c){var e=[];if(null==a)return e;if(W&&a.map===W)return a.map(b,c);C(a,function(a,f,m){e[e.length]=b.call(c,a,f,m)});a.length===+a.length&&(e.length=a.length);return e};j.reduce=j.foldl=j.inject=function(a,b,c,e){var f=2<arguments.length;null==a&&(a=[]);if(y&&a.reduce===
y)return e&&(b=j.bind(b,e)),f?a.reduce(b,c):a.reduce(b);C(a,function(a,m,j){f?c=b.call(e,c,a,m,j):(c=a,f=!0)});if(!f)throw new TypeError("Reduce of empty array with no initial value");return c};j.reduceRight=j.foldr=function(a,b,c,e){var f=2<arguments.length;null==a&&(a=[]);if(B&&a.reduceRight===B)return e&&(b=j.bind(b,e)),f?a.reduceRight(b,c):a.reduceRight(b);var k=j.toArray(a).reverse();e&&!f&&(b=j.bind(b,e));return f?j.reduce(k,b,c,e):j.reduce(k,b)};j.find=j.detect=function(a,b,c){var e;R(a,function(a,
f,m){if(b.call(c,a,f,m))return e=a,!0});return e};j.filter=j.select=function(a,b,c){var e=[];if(null==a)return e;if(N&&a.filter===N)return a.filter(b,c);C(a,function(a,f,m){b.call(c,a,f,m)&&(e[e.length]=a)});return e};j.reject=function(a,b,c){var e=[];if(null==a)return e;C(a,function(a,f,m){b.call(c,a,f,m)||(e[e.length]=a)});return e};j.every=j.all=function(a,b,c){var f=!0;if(null==a)return f;if(X&&a.every===X)return a.every(b,c);C(a,function(a,m,j){if(!(f=f&&b.call(c,a,m,j)))return e});return!!f};
var R=j.some=j.any=function(a,b,c){b||(b=j.identity);var f=!1;if(null==a)return f;if(r&&a.some===r)return a.some(b,c);C(a,function(a,m,j){if(f||(f=b.call(c,a,m,j)))return e});return!!f};j.include=j.contains=function(a,b){return null==a?!1:U&&a.indexOf===U?-1!=a.indexOf(b):R(a,function(a){return a===b})};j.invoke=function(a,b){var c=s.call(arguments,2);return j.map(a,function(a){return(j.isFunction(b)?b||a:a[b]).apply(a,c)})};j.pluck=function(a,b){return j.map(a,function(a){return a[b]})};j.max=function(a,
b,c){if(!b&&j.isArray(a)&&a[0]===+a[0])return Math.max.apply(Math,a);if(!b&&j.isEmpty(a))return-Infinity;var e={computed:-Infinity};C(a,function(a,f,m){f=b?b.call(c,a,f,m):a;f>=e.computed&&(e={value:a,computed:f})});return e.value};j.min=function(a,b,c){if(!b&&j.isArray(a)&&a[0]===+a[0])return Math.min.apply(Math,a);if(!b&&j.isEmpty(a))return Infinity;var e={computed:Infinity};C(a,function(a,f,m){f=b?b.call(c,a,f,m):a;f<e.computed&&(e={value:a,computed:f})});return e.value};j.shuffle=function(a){var b=
...
function(a,b,c){c||(c=j.identity);for(var e=0,f=a.length;e<f;){var k=e+f>>1;c(a[k])<c(b)?e=k+1:f=k}return e};j.toArray=function(a){return!a?[]:j.isArray(a)||j.isArguments(a)?s.call(a):a.toArray&&j.isFunction(a.toArray)?a.toArray():j.values(a)};j.size=function(a){return j.isArray(a)?a.length:j.keys(a).length};j.first=j.head=j.take=function(a,b,c){return null!=b&&!c?s.call(a,0,b):a[0]};j.initial=function(a,b,c){return s.call(a,0,a.length-(null==b||c?1:b))};j.last=function(a,b,c){return null!=b&&!c?
s.call(a,Math.max(a.length-b,0)):a[a.length-1]};j.rest=j.tail=function(a,b,c){return s.call(a,null==b||c?1:b)};j.compact=function(a){return j.filter(a,function(a){return!!a})};j.flatten=function(a,b){return j.reduce(a,function(a,c){if(j.isArray(c))return a.concat(b?c:j.flatten(c));a[a.length]=c;return a},[])};j.without=function(a){return j.difference(a,s.call(arguments,1))};j.uniq=j.unique=function(a,b,c){c=c?j.map(a,c):a;var e=[];3>a.length&&(b=!0);j.reduce(c,function(c,f,q){if(b?j.last(c)!==f||
!c.length:!j.include(c,f))c.push(f),e.push(a[q]);return c},[]);return e};j.union=function(){return j.uniq(j.flatten(arguments,!0))};j.intersection=j.intersect=function(a){var b=s.call(arguments,1);return j.filter(j.uniq(a),function(a){return j.every(b,function(b){return 0<=j.indexOf(b,a)})})};j.difference=function(a){var b=j.flatten(s.call(arguments,1),!0);return j.filter(a,function(a){return!j.include(b,a)})};j.zip=function(){for(var a=s.call(arguments),b=j.max(j.pluck(a,"length")),c=Array(b),e=
...
a)/c),0),f=0,j=Array(e);f<e;)j[f++]=a,a+=c;return j};var ca=function(){};j.bind=function(a,b){var c,e;if(a.bind===I&&I)return I.apply(a,s.call(arguments,1));if(!j.isFunction(a))throw new TypeError;e=s.call(arguments,2);return c=function(){if(!(this instanceof c))return a.apply(b,e.concat(s.call(arguments)));ca.prototype=a.prototype;var f=new ca,j=a.apply(f,e.concat(s.call(arguments)));return Object(j)===j?j:f}};j.bindAll=function(a){var b=s.call(arguments,1);0==b.length&&(b=j.functions(a));C(b,function(b){a[b]=
j.bind(a[b],a)});return a};j.memoize=function(a,b){var c={};b||(b=j.identity);return function(){var e=b.apply(this,arguments);return j.has(c,e)?c[e]:c[e]=a.apply(this,arguments)}};j.delay=function(a,b){var c=s.call(arguments,2);return setTimeout(function(){return a.apply(null,c)},b)};j.defer=function(a){return j.delay.apply(j,[a,1].concat(s.call(arguments,1)))};j.throttle=function(a,b){var c,e,f,k,p,n,r=j.debounce(function(){p=k=!1},b);return function(){c=this;e=arguments;f||(f=setTimeout(function(){f=
null;p&&a.apply(c,e);r()},b));k?p=!0:n=a.apply(c,e);r();k=!0;return n}};j.debounce=function(a,b,c){var e;return function(){var f=this,j=arguments;c&&!e&&a.apply(f,j);clearTimeout(e);e=setTimeout(function(){e=null;c||a.apply(f,j)},b)}};j.once=function(a){var b=!1,c;return function(){if(b)return c;b=!0;return c=a.apply(this,arguments)}};j.wrap=function(a,b){return function(){var c=[a].concat(s.call(arguments,0));return b.apply(this,c)}};j.compose=function(){var a=arguments;return function(){for(var b=
arguments,c=a.length-1;0<=c;c--)b=[a[c].apply(this,b)];return b[0]}};j.after=function(a,b){return 0>=a?b():function(){if(1>--a)return b.apply(this,arguments)}};j.keys=V||function(a){if(a!==Object(a))throw new TypeError("Invalid object");var b=[],c;for(c in a)j.has(a,c)&&(b[b.length]=c);return b};j.values=function(a){return j.map(a,j.identity)};j.functions=j.methods=function(a){var b=[],c;for(c in a)j.isFunction(a[c])&&b.push(c);return b.sort()};j.extend=function(a){C(s.call(arguments,1),function(b){for(var c in b)a[c]=
b[c]});return a};j.pick=function(a){var b={};C(j.flatten(s.call(arguments,1)),function(c){c in a&&(b[c]=a[c])});return b};j.defaults=function(a){C(s.call(arguments,1),function(b){for(var c in b)null==a[c]&&(a[c]=b[c])});return a};j.clone=function(a){return!j.isObject(a)?a:j.isArray(a)?a.slice():j.extend({},a)};j.tap=function(a,b){b(a);return a};j.isEqual=function(b,c){return a(b,c,[])};j.isEmpty=function(a){if(null==a)return!0;if(j.isArray(a)||j.isString(a))return 0===a.length;for(var b in a)if(j.has(a,
...
function(a,b,c){for(var e=0;e<a;e++)b.call(c,e)};j.escape=function(a){return(""+a).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#x27;").replace(/\//g,"&#x2F;")};j.result=function(a,b){if(null==a)return null;var c=a[b];return j.isFunction(c)?c.call(a):c};j.mixin=function(a){C(j.functions(a),function(b){var c=j[b]=a[b];ia.prototype[b]=function(){var a=s.call(arguments);k.call(a,this._wrapped);return Y(c.apply(j,a),this._chain)}})};var L=0;j.uniqueId=
...
(function(){function a(a,b){return"!"!==a[0][0]?'<a href="'+n(b.href)+'"'+(b.title?' title="'+n(b.title)+'"':"")+">"+r.lexer(a[1])+"</a>":'<img src="'+n(b.href)+'" alt="'+n(a[1])+'"'+(b.title?' title="'+n(b.title)+'"':"")+">"}function b(){return K=U.pop()}function c(){switch(K.type){case "space":return"";case "hr":return"<hr>\n";case "heading":return"<h"+K.depth+">"+r.lexer(K.text)+"</h"+K.depth+">\n";case "code":return V.highlight&&(K.code=V.highlight(K.text,K.lang),null!=K.code&&K.code!==K.text&&
...
"";"list_item_end"!==b().type;)a+=c();return"<li>"+a+"</li>\n";case "html":return V.sanitize?r.lexer(K.text):!K.pre&&!V.pedantic?r.lexer(K.text):K.text;case "paragraph":return"<p>"+r.lexer(K.text)+"</p>\n";case "text":return"<p>"+e()+"</p>\n"}}function e(){for(var a=K.text,c;(c=U[U.length-1])&&"text"===c.type;)a+="\n"+b().text;return r.lexer(a)}function f(a){U=a.reverse();for(a="";b();)a+=c();K=U=null;return a}function n(a,b){return a.replace(!b?/&(?!#?\w+;)/g:/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,
"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function s(a){for(var b="",c=a.length,e=0,f;e<c;e++)f=a.charCodeAt(e),0.5<Math.random()&&(f="x"+f.toString(16)),b+="&#"+f+";";return b}function k(){return"(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:/|@)\\b"}function p(a,b){a=a.source;b=b||"";return function ca(c,e){if(!c)return RegExp(a,b);a=a.replace(c,e.source||e);return ca}}function Q(){}function T(a,
b){W(b);return f(y.lexer(a))}function W(a){a||(a=I);V!==a&&(V=a,V.gfm?(y.fences=y.gfm.fences,y.paragraph=y.gfm.paragraph,r.text=r.gfm.text,r.url=r.gfm.url):(y.fences=y.normal.fences,y.paragraph=y.normal.paragraph,r.text=r.normal.text,r.url=r.normal.url),V.pedantic?(r.em=r.pedantic.em,r.strong=r.pedantic.strong):(r.em=r.normal.em,r.strong=r.normal.strong))}var y={newline:/^\n+/,code:/^( {4}[^\n]+\n*)+/,fences:Q,hr:/^( *[-*_]){3,} *(?:\n+|$)/,heading:/^ *(#{1,6}) *([^\n]+?) *#* *(?:\n+|$)/,lheading:/^([^\n]+)\n *(=|-){3,} *\n*/,
blockquote:/^( *>[^\n]+(\n[^\n]+)*\n*)+/,list:/^( *)(bull) [^\0]+?(?:hr|\n{2,}(?! )(?!\1bull )\n*|\s*$)/,html:/^ *(?:comment|closed|closing) *(?:\n{2,}|\s*$)/,def:/^ *\[([^\]]+)\]: *([^\s]+)(?: +["(]([^\n]+)[")])? *(?:\n+|$)/,paragraph:/^([^\n]+\n?(?!body))+\n*/,text:/^[^\n]+/,bullet:/(?:[*+-]|\d+\.)/,item:/^( *)(bull) [^\n]*(?:\n(?!\1bull )[^\n]*)*/};y.item=p(y.item,"gm")(/bull/g,y.bullet)();y.list=p(y.list)(/bull/g,y.bullet)("hr",/\n+(?=(?: *[-*_]){3,} *(?:\n+|$))/)();y.html=p(y.html)("comment",
/\x3c!--[^\0]*?--\x3e/)("closed",/<(tag)[^\0]+?<\/\1>/)("closing",/<tag(?:"[^"]*"|'[^']*'|[^'">])*?>/)(/tag/g,k())();var B=y,N;N=y.paragraph.source;var X=[];(function C(a){a=y[a]?y[a].source:a;X.push(a.replace(/(^|[^\[])\^/g,"$1"));return C})("hr")("heading")("lheading")("blockquote")("<"+k())("def");N=RegExp(N.replace("body",X.join("|")));B.paragraph=N;y.normal={fences:y.fences,paragraph:y.paragraph};y.gfm={fences:/^ *(```|~~~) *(\w+)? *\n([^\0]+?)\s*\1 *(?:\n+|$)/,paragraph:/^/};y.gfm.paragraph=
p(y.paragraph)("(?!","(?!"+y.gfm.fences.source.replace(/(^|[^\[])\^/g,"$2")+"|")();y.lexer=function(a){var b=[];b.links={};a=a.replace(/\r\n|\r/g,"\n").replace(/\t/g,"    ");return y.token(a,b,!0)};y.token=function(a,b,c){a=a.replace(/^ +$/gm,"");for(var e,f,k,p,n,r;a;){if(k=y.newline.exec(a))a=a.substring(k[0].length),1<k[0].length&&b.push({type:"space"});if(k=y.code.exec(a))a=a.substring(k[0].length),k=k[0].replace(/^ {4}/gm,""),b.push({type:"code",text:!V.pedantic?k.replace(/\n+$/,""):k});else if(k=
...
r.link=p(r.link)("inside",r._linkInside)("href",r._linkHref)();r.reflink=p(r.reflink)("inside",r._linkInside)();r.normal={url:r.url,strong:r.strong,em:r.em,text:r.text};r.pedantic={strong:/^__(?=\S)([^\0]*?\S)__(?!_)|^\*\*(?=\S)([^\0]*?\S)\*\*(?!\*)/,em:/^_(?=\S)([^\0]*?\S)_(?!_)|^\*(?=\S)([^\0]*?\S)\*(?!\*)/};r.gfm={url:/^(https?:\/\/[^\s]+[^.,:;"')\]\s])/,text:/^[^\0]+?(?=[\\<!\[_*`]|https?:\/\/| {2,}\n|$)/};r.lexer=function(b){for(var c="",e=U.links,f,k;b;)if(k=r.escape.exec(b))b=b.substring(k[0].length),
c+=k[1];else if(k=r.autolink.exec(b))b=b.substring(k[0].length),"@"===k[2]?(f=":"===k[1][6]?s(k[1].substring(7)):s(k[1]),k=s("mailto:")+f):k=f=n(k[1]),c+='<a href="'+k+'">'+f+"</a>";else if(k=r.url.exec(b))b=b.substring(k[0].length),k=f=n(k[1]),c+='<a href="'+k+'">'+f+"</a>";else if(k=r.tag.exec(b))b=b.substring(k[0].length),c+=V.sanitize?n(k[0]):k[0];else if(k=r.link.exec(b))b=b.substring(k[0].length),c+=a(k,{href:k[2],title:k[3]});else if((k=r.reflink.exec(b))||(k=r.nolink.exec(b)))b=b.substring(k[0].length),
f=(k[2]||k[1]).replace(/\s+/g," "),f=e[f.toLowerCase()],!f||!f.href?(c+=k[0][0],b=k[0].substring(1)+b):c+=a(k,f);else if(k=r.strong.exec(b))b=b.substring(k[0].length),c+="<strong>"+r.lexer(k[2]||k[1])+"</strong>";else if(k=r.em.exec(b))b=b.substring(k[0].length),c+="<em>"+r.lexer(k[2]||k[1])+"</em>";else if(k=r.code.exec(b))b=b.substring(k[0].length),c+="<code>"+n(k[2],!0)+"</code>";else if(k=r.br.exec(b))b=b.substring(k[0].length),c+="<br>";else if(k=r.text.exec(b))b=b.substring(k[0].length),c+=
n(k[0]);return c};var U,K;Q.exec=Q;var V,I;T.options=T.setOptions=function(a){I=a;W(a);return T};T.setOptions({gfm:!0,pedantic:!1,sanitize:!1,highlight:null});T.parser=function(a,b){W(b);return f(a)};T.lexer=function(a,b){W(b);return y.lexer(a)};T.parse=T;"undefined"!==typeof module?module.exports=T:this.marked=T}).call(function(){return this||("undefined"!==typeof window?window:global)}());
function natural_sort(a,b){var c=/(^-?[0-9]+(\.?[0-9]*)[df]?e?[0-9]?$|^0x[0-9a-f]+$|[0-9]+)/gi,e=/(^[ ]*|[ ]*$)/g,f=/(^([\w ]+,?[\w ]+)?[\w ]+,?[\w ]+\d+:\d+(:\d+)?[\w ]?|^\d{1,4}[\/\-]\d{1,4}[\/\-]\d{1,4}|^\w+, \w+ \d+, \d{4})/,n=/^0x[0-9a-f]+$/i,s=/^0/,k=(natural_sort.insensitive&&(""+a).toLowerCase()||""+a).replace(e,"")||"",p=(natural_sort.insensitive&&(""+b).toLowerCase()||""+b).replace(e,"")||"",e=k.replace(c,"\x00$1\x00").replace(/\0$/,"").replace(/^\0/,"").split("\x00"),c=p.replace(c,"\x00$1\x00").replace(/\0$/,
"").replace(/^\0/,"").split("\x00"),k=parseInt(k.match(n))||1!=e.length&&k.match(f)&&Date.parse(k);if(f=parseInt(p.match(n))||k&&p.match(f)&&Date.parse(p)||null){if(k<f)return-1;if(k>f)return 1}k=0;for(p=Math.max(e.length,c.length);k<p;k++){f=!(e[k]||"").match(s)&&parseFloat(e[k])||e[k]||0;n=!(c[k]||"").match(s)&&parseFloat(c[k])||c[k]||0;if(isNaN(f)!==isNaN(n))return isNaN(f)?1:-1;typeof f!==typeof n&&(f+="",n+="");if(f<n)return-1;if(f>n)return 1}return 0}
...
c)return a.remove(b);e.setItem(b,a.serialize(c))},a.get=function(b){return a.deserialize(e.getItem(b))},a.remove=function(a){e.removeItem(a)},a.clear=function(){e.clear()},a.getAll=function(){for(var b={},c=0;c<e.length;++c){var f=e.key(c);b[f]=a.get(f)}return b};else{var s;try{s="globalStorage"in b&&b.globalStorage&&b.globalStorage[b.location.hostname]}catch(k){s=!1}if(s)e=b.globalStorage[b.location.hostname],a.set=function(b,c){if(void 0===c)return a.remove(b);e[b]=a.serialize(c)},a.get=function(b){return a.deserialize(e[b]&&
e[b].value)},a.remove=function(a){delete e[a]},a.clear=function(){for(var a in e)delete e[a]},a.getAll=function(){for(var b={},c=0;c<e.length;++c){var f=e.key(c);b[f]=a.get(f)}return b};else if(c.documentElement.addBehavior){var p,Q;try{Q=new ActiveXObject("htmlfile"),Q.open(),Q.write('<script>document.w=window\x3c/script><iframe src="/favicon.ico"></frame>'),Q.close(),p=Q.w.frames[0].document,e=p.createElement("div")}catch(T){e=c.createElement("div"),p=c.body}var b=function(b){return function(){var c=
...
(this.$events[a]=[]);W.util.isArray(this.$events[a])||(this.$events[a]=[this.$events[a]]);return this.$events[a]};k.prototype.emit=function(a){if(!this.$events)return!1;var b=this.$events[a];if(!b)return!1;var c=Array.prototype.slice.call(arguments,1);if("function"==typeof b)b.apply(this,c);else if(W.util.isArray(b))for(var b=b.slice(),d=0,e=b.length;d<e;d++)b[d].apply(this,c);else return!1;return!0};(function(a,b){function c(a){return 10>a?"0"+a:a}function d(a){k.lastIndex=0;return k.test(a)?'"'+
a.replace(k,function(a){var b=p[a];return"string"===typeof b?b:"\\u"+("0000"+a.charCodeAt(0).toString(16)).slice(-4)})+'"':'"'+a+'"'}function e(a,b){var h,f,l,j,k=u,p,r=b[a];r instanceof Date&&(r=isFinite(a.valueOf())?a.getUTCFullYear()+"-"+c(a.getUTCMonth()+1)+"-"+c(a.getUTCDate())+"T"+c(a.getUTCHours())+":"+c(a.getUTCMinutes())+":"+c(a.getUTCSeconds())+"Z":null);"function"===typeof n&&(r=n.call(b,a,r));switch(typeof r){case "string":return d(r);case "number":return isFinite(r)?String(r):"null";
case "boolean":case "null":return String(r);case "object":if(!r)return"null";u+=m;p=[];if("[object Array]"===Object.prototype.toString.apply(r)){j=r.length;for(h=0;h<j;h+=1)p[h]=e(h,r)||"null";l=0===p.length?"[]":u?"[\n"+u+p.join(",\n"+u)+"\n"+k+"]":"["+p.join(",")+"]";u=k;return l}if(n&&"object"===typeof n){j=n.length;for(h=0;h<j;h+=1)"string"===typeof n[h]&&(f=n[h],(l=e(f,r))&&p.push(d(f)+(u?": ":":")+l))}else for(f in r)Object.prototype.hasOwnProperty.call(r,f)&&(l=e(f,r))&&p.push(d(f)+(u?": ":
":")+l);l=0===p.length?"{}":u?"{\n"+u+p.join(",\n"+u)+"\n"+k+"}":"{"+p.join(",")+"}";u=k;return l}}if(b&&b.parse)return a.JSON={parse:b.parse,stringify:b.stringify};var f=a.JSON={},j=/[\u0000\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,k=/[\\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,u,m,p={"\b":"\\b","\t":"\\t","\n":"\\n","\f":"\\f","\r":"\\r",'"':'\\"',"\\":"\\\\"},n;
...
y=("undefined"!=typeof io?io:module.exports).parser={},B=y.packets="disconnect connect heartbeat message json event ack error noop".split(" "),N=y.reasons=["transport not supported","client not handshaken","unauthorized"],X=y.advice=["reconnect"],r=k.JSON,U=k.util.indexOf;y.encodePacket=function(a){var b=U(B,a.type),c=a.id||"",d=a.endpoint||"",e=a.ack,f=null;switch(a.type){case "error":var j=a.reason?U(N,a.reason):"";a=a.advice?U(X,a.advice):"";if(""!==j||""!==a)f=j+(""!==a?"+"+a:"");break;case "message":""!==
...
y.decodePacket=function(a){var b=a.match(K);if(!b)return{};var c=b[2]||"";a=b[5]||"";var d={type:B[b[1]],endpoint:b[4]||""};c&&(d.id=c,d.ack=b[3]?"data":!0);switch(d.type){case "error":b=a.split("+");d.reason=N[b[0]]||"";d.advice=X[b[1]]||"";break;case "message":d.data=a||"";break;case "event":try{var e=r.parse(a);d.name=e.name;d.args=e.args}catch(f){}d.args=d.args||[];break;case "json":try{d.data=r.parse(a)}catch(j){}break;case "connect":d.qs=a||"";break;case "ack":if(b=a.match(/^([0-9]+)(\+)?(.*)/))if(d.ackId=
b[1],d.args=[],b[3])try{d.args=b[3]?r.parse(b[3]):[]}catch(k){}}return d};y.decodePayload=function(a){if("\ufffd"==a.charAt(0)){for(var b=[],c=1,d="";c<a.length;c++)"\ufffd"==a.charAt(c)?(b.push(y.decodePacket(a.substr(c+1).substr(0,d))),c+=Number(d)+1,d=""):d+=a.charAt(c);return b}return[y.decodePacket(a)]};var V="undefined"!=typeof io?io:module.parent.exports,k=function(a,b){this.socket=a;this.sessid=b};("undefined"!=typeof io?io:module.exports).Transport=k;V.util.mixin(k,V.EventEmitter);k.prototype.heartbeats=
...
C,200==j.status)b(j.responseText);else if(403==j.status)c.onError(j.responseText);else c.connecting=!1,!c.reconnecting&&c.onError(j.responseText)};j.send(null)}};k.prototype.getTransport=function(a){a=a||this.transports;for(var b=0,c;c=a[b];b++)if(I.Transport[c]&&I.Transport[c].check(this)&&(!this.isXDomain()||I.Transport[c].xdomainCheck(this)))return new I.Transport[c](this,this.sessionid);return null};k.prototype.connect=function(a){if(this.connecting)return this;var b=this;b.connecting=!0;this.handshake(function(c,
...
b.options["connect timeout"]))})}b.sessionid=c;b.closeTimeout=1E3*e;b.heartbeatTimeout=1E3*d;b.transports||(b.transports=b.origTransports=f?I.util.intersect(f.split(","),b.options.transports):b.options.transports);b.setHeartbeatTimeout();j(b.transports);b.once("connect",function(){clearTimeout(b.connectTimeoutTimer);a&&"function"==typeof a&&a()})});return this};k.prototype.setHeartbeatTimeout=function(){clearTimeout(this.heartbeatTimeoutTimer);if(!this.transport||this.transport.heartbeats()){var a=
...
this.connecting)this.open&&this.of("").packet({type:"disconnect"}),this.onDisconnect("booted");return this};k.prototype.disconnectSync=function(){var a=I.util.request(),b=["http"+(this.options.secure?"s":"")+":/",this.options.host+":"+this.options.port,this.options.resource,I.protocol,"",this.sessionid].join("/")+"/?disconnect=1";a.open("GET",b,!1);a.send(null);this.onDisconnect("booted")};k.prototype.isXDomain=function(){var a=j.location.port||("https:"==j.location.protocol?443:80);return this.options.host!==
...
a;this.name=b};("undefined"!=typeof io?io:module.exports).SocketNamespace=k;R.util.mixin(k,R.EventEmitter);k.prototype.$emit=R.EventEmitter.prototype.emit;k.prototype.of=function(){return this.socket.of.apply(this.socket,arguments)};k.prototype.packet=function(a){a.endpoint=this.name;this.socket.packet(a);this.flags={};return this};k.prototype.send=function(a,b){var c={type:this.flags.json?"json":"message",data:a};"function"==typeof b&&(c.id=++this.ackPackets,c.ack=!0,this.acks[c.id]=b);return this.packet(c)};
k.prototype.emit=function(a){var b=Array.prototype.slice.call(arguments,1),c=b[b.length-1],d={type:"event",name:a};"function"==typeof c&&(d.id=++this.ackPackets,d.ack="data",this.acks[d.id]=c,b=b.slice(0,b.length-1));d.args=b;return this.packet(d)};k.prototype.disconnect=function(){""===this.name?this.socket.disconnect():(this.packet({type:"disconnect"}),this.$emit("disconnect"));return this};k.prototype.onPacket=function(a){function b(){c.packet({type:"ack",args:R.util.toArray(arguments),ackId:a.id})}
...
!0);S.transports.push("flashsocket");if("undefined"!=typeof window){var fa,ha=function(){if(!Ta){try{var a=G.getElementsByTagName("body")[0].appendChild(G.createElement("span"));a.parentNode.removeChild(a)}catch(b){return}Ta=!0;for(var a=d.length,c=0;c<a;c++)d[c]()}},ja=function(a){Ta?a():d[d.length]=a},k=function(a){if(typeof O.addEventListener!=da)O.addEventListener("load",a,!1);else if(typeof G.addEventListener!=da)G.addEventListener("load",a,!1);else if(typeof O.attachEvent!=da){var b=O;b.attachEvent("onload",
a);ab[ab.length]=[b,"onload",a]}else if("function"==typeof O.onload){var c=O.onload;O.onload=function(){c();a()}}else O.onload=a},ia=function(){var a=Da.length;if(0<a)for(var b=0;b<a;b++){var c=Da[b].id,d=Da[b].callbackFn,e={success:!1,id:c};if(0<E.pv[0]){var f=ga(c);if(f)if(Za(Da[b].swfVersion)&&!(E.wk&&312>E.wk))sa(c,!0),d&&(e.success=!0,e.ref=Y(c),d(e));else if(Da[b].expressInstall&&m()){e={};e.data=Da[b].expressInstall;e.width=f.getAttribute("width")||"0";e.height=f.getAttribute("height")||"0";
f.getAttribute("class")&&(e.styleclass=f.getAttribute("class"));f.getAttribute("align")&&(e.align=f.getAttribute("align"));for(var j={},f=f.getElementsByTagName("param"),k=f.length,u=0;u<k;u++)"movie"!=f[u].getAttribute("name").toLowerCase()&&(j[f[u].getAttribute("name")]=f[u].getAttribute("value"));D(e,j,c,d)}else q(f),d&&d(e)}else if(sa(c,!0),d){if((c=Y(c))&&typeof c.SetVariable!=da)e.success=!0,e.ref=c;d(e)}}},Y=function(a){var b=null;if((a=ga(a))&&"OBJECT"==a.nodeName)typeof a.SetVariable!=da?
b=a:(a=a.getElementsByTagName(ta)[0])&&(b=a);return b},m=function(){return!qb&&Za("6.0.65")&&(E.win||E.mac)&&!(E.wk&&312>E.wk)},D=function(a,b,c,d){qb=!0;Ib=d||null;Rb={success:!1,id:c};var e=ga(c);if(e){"OBJECT"==e.nodeName?(ib=w(e),jb=null):(ib=e,jb=c);a.id=u;if(typeof a.width==da||!/%$/.test(a.width)&&310>parseInt(a.width,10))a.width="310";if(typeof a.height==da||!/%$/.test(a.height)&&137>parseInt(a.height,10))a.height="137";G.title=G.title.slice(0,47)+" - Flash Player Installation";d=E.ie&&E.win?
["Active"].concat("").join("X"):"PlugIn";d="MMredirectURL="+O.location.toString().replace(/&/g,"%26")+"&MMplayerType="+d+"&MMdoctitle="+G.title;b.flashvars=typeof b.flashvars!=da?b.flashvars+("&"+d):d;E.ie&&(E.win&&4!=e.readyState)&&(d=G.createElement("div"),c+="SWFObjectNew",d.setAttribute("id",c),e.parentNode.insertBefore(d,e),e.style.display="none",function(){4==e.readyState?e.parentNode.removeChild(e):setTimeout(arguments.callee,10)}());A(a,b,c)}},q=function(a){if(E.ie&&E.win&&4!=a.readyState){var b=
...
a.id;d=ga(a.id)}else{k=G.createElement(ta);k.setAttribute("type",ka);for(var u in a)a[u]!=Object.prototype[u]&&("styleclass"==u.toLowerCase()?k.setAttribute("class",a[u]):"classid"!=u.toLowerCase()&&k.setAttribute(u,a[u]));for(f in b)b[f]!=Object.prototype[f]&&"movie"!=f.toLowerCase()&&(a=k,j=f,u=b[f],c=G.createElement("param"),c.setAttribute("name",j),c.setAttribute("value",u),a.appendChild(c));e.parentNode.replaceChild(k,e);d=k}return d},F=function(a){var b=ga(a);b&&"OBJECT"==b.nodeName&&(E.ie&&
E.win?(b.style.display="none",function(){if(4==b.readyState){var c=ga(a);if(c){for(var d in c)"function"==typeof c[d]&&(c[d]=null);c.parentNode.removeChild(c)}}else setTimeout(arguments.callee,10)}()):b.parentNode.removeChild(b))},ga=function(a){var b=null;try{b=G.getElementById(a)}catch(c){}return b},Za=function(a){var b=E.pv;a=a.split(".");a[0]=parseInt(a[0],10);a[1]=parseInt(a[1],10)||0;a[2]=parseInt(a[2],10)||0;return b[0]>a[0]||b[0]==a[0]&&b[1]>a[1]||b[0]==a[0]&&b[1]==a[1]&&b[2]>=a[2]?!0:!1},
...
sa=function(a,b){if(Sb){var c=b?"visible":"hidden";Ta&&ga(a)?ga(a).style.visibility=c:$a("#"+a,"visibility:"+c)}},Ca=function(a){return null!=/[\\\"<>\.;]/.exec(a)&&typeof encodeURIComponent!=da?encodeURIComponent(a):a},da="undefined",ta="object",ka="application/x-shockwave-flash",u="SWFObjectExprInst",O=window,G=document;p=navigator;var Sa=!1,d=[function(){if(Sa){var a=G.getElementsByTagName("body")[0],b=G.createElement(ta);b.setAttribute("type",ka);var c=a.appendChild(b);if(c){var d=0;(function(){if(typeof c.GetVariable!=
da){var e=c.GetVariable("$version");e&&(e=e.split(" ")[1].split(","),E.pv=[parseInt(e[0],10),parseInt(e[1],10),parseInt(e[2],10)])}else if(10>d){d++;setTimeout(arguments.callee,10);return}a.removeChild(b);c=null;ia()})()}else ia()}else ia()}],Da=[],Ba=[],ab=[],ib,jb,Ib,Rb,Ta=!1,qb=!1,Ka,Jb,Sb=!0,E,Q=typeof G.getElementById!=da&&typeof G.getElementsByTagName!=da&&typeof G.createElement!=da,Ua=p.userAgent.toLowerCase(),Va=p.platform.toLowerCase(),ec=Va?/win/.test(Va):/win/.test(Ua),Va=Va?/mac/.test(Va):
/mac/.test(Ua),Ua=/webkit/.test(Ua)?parseFloat(Ua.replace(/^.*webkit\/(\d+(\.\d+)?).*$/,"$1")):!1,kb=!+"\v1",ba=[0,0,0],ea=null;if(typeof p.plugins!=da&&typeof p.plugins["Shockwave Flash"]==ta){if((ea=p.plugins["Shockwave Flash"].description)&&!(typeof p.mimeTypes!=da&&p.mimeTypes[ka]&&!p.mimeTypes[ka].enabledPlugin))Sa=!0,kb=!1,ea=ea.replace(/^.*\s+(\S+\s+\S+$)/,"$1"),ba[0]=parseInt(ea.replace(/^(.*)\..*$/,"$1"),10),ba[1]=parseInt(ea.replace(/^.*\.(.*)\s.*$/,"$1"),10),ba[2]=/[a-zA-Z]/.test(ea)?parseInt(ea.replace(/^.*[a-zA-Z]+(.*)$/,
"$1"),10):0}else if(typeof O[["Active"].concat("Object").join("X")]!=da)try{var M=new (window[["Active"].concat("Object").join("X")])("ShockwaveFlash.ShockwaveFlash");if(M&&(ea=M.GetVariable("$version")))kb=!0,ea=ea.split(" ")[1].split(","),ba=[parseInt(ea[0],10),parseInt(ea[1],10),parseInt(ea[2],10)]}catch(na){}E={w3:Q,pv:ba,wk:Ua,ie:kb,win:ec,mac:Va};E.w3&&((typeof G.readyState!=da&&"complete"==G.readyState||typeof G.readyState==da&&(G.getElementsByTagName("body")[0]||G.body))&&ha(),Ta||(typeof G.addEventListener!=
da&&G.addEventListener("DOMContentLoaded",ha,!1),E.ie&&E.win&&(G.attachEvent("onreadystatechange",function(){"complete"==G.readyState&&(G.detachEvent("onreadystatechange",arguments.callee),ha())}),O==top&&function(){if(!Ta){try{G.documentElement.doScroll("left")}catch(a){setTimeout(arguments.callee,0);return}ha()}}()),E.wk&&function(){Ta||(/loaded|complete/.test(G.readyState)?ha():setTimeout(arguments.callee,0))}(),k(ha)));E.ie&&E.win&&window.attachEvent("onunload",function(){for(var a=ab.length,
b=0;b<a;b++)ab[b][0].detachEvent(ab[b][1],ab[b][2]);a=Ba.length;for(b=0;b<a;b++)F(Ba[b]);for(var c in E)E[c]=null;E=null;for(var d in fa)fa[d]=null;fa=null});fa={registerObject:function(a,b,c,d){if(E.w3&&a&&b){var e={};e.id=a;e.swfVersion=b;e.expressInstall=c;e.callbackFn=d;Da[Da.length]=e;sa(a,!1)}else d&&d({success:!1,id:a})},getObjectById:function(a){if(E.w3)return Y(a)},embedSWF:function(a,b,c,d,e,f,j,k,u,p){var n={success:!1,id:b};E.w3&&!(E.wk&&312>E.wk)&&a&&b&&c&&d&&e?(sa(b,!1),ja(function(){c+=
"";d+="";var r={};if(u&&typeof u===ta)for(var q in u)r[q]=u[q];r.data=a;r.width=c;r.height=d;q={};if(k&&typeof k===ta)for(var s in k)q[s]=k[s];if(j&&typeof j===ta)for(var O in j)q.flashvars=typeof q.flashvars!=da?q.flashvars+("&"+O+"="+j[O]):O+"="+j[O];if(Za(e))s=A(r,q,b),r.id==b&&sa(b,!0),n.success=!0,n.ref=s;else{if(f&&m()){r.data=f;D(r,q,b,p);return}sa(b,!0)}p&&p(n)})):p&&p(n)},switchOffAutoHideShow:function(){Sb=!1},ua:E,getFlashPlayerVersion:function(){return{major:E.pv[0],minor:E.pv[1],release:E.pv[2]}},
hasFlashPlayerVersion:Za,createSWF:function(a,b,c){if(E.w3)return A(a,b,c)},showExpressInstall:function(a,b,c,d){E.w3&&m()&&D(a,b,c,d)},removeSWF:function(a){E.w3&&F(a)},createCSS:function(a,b,c,d){E.w3&&$a(a,b,c,d)},addDomLoadEvent:ja,addLoadEvent:k,getQueryParamValue:function(a){var b=G.location.search||G.location.hash;if(b){/\?/.test(b)&&(b=b.split("?")[1]);if(null==a)return Ca(b);for(var b=b.split("&"),c=0;c<b.length;c++)if(b[c].substring(0,b[c].indexOf("="))==a)return Ca(b[c].substring(b[c].indexOf("=")+
1))}return""},expressInstallCallback:function(){if(qb){var a=ga(u);a&&ib&&(a.parentNode.replaceChild(ib,a),jb&&(sa(jb,!0),E.ie&&E.win&&(ib.style.display="block")),Ib&&Ib(Rb));qb=!1}}}}if(!("undefined"==typeof window||window.WebSocket)){var oa=window.console;if(!oa||!oa.log||!oa.error)oa={log:function(){},error:function(){}};fa.hasFlashPlayerVersion("10.0.0")?("file:"==location.protocol&&oa.error("WARNING: web-socket-js doesn't work in file:///... URL unless you set Flash Security Settings properly. Open the page via Web server i.e. http://..."),
...
this.index,u;f.className="socketio";f.style.position="absolute";f.style.top="0px";f.style.left="0px";f.style.display="none";f.target=k;f.method="POST";f.setAttribute("accept-charset","utf-8");j.name="d";f.appendChild(j);document.body.appendChild(f);this.form=f;this.area=j}this.form.action=this.prepareUrl()+e;c();this.area.value=wa.JSON.stringify(a);try{this.form.submit()}catch(m){}this.iframe.attachEvent?u.onreadystatechange=function(){"complete"==d.iframe.readyState&&b()}:this.iframe.onload=b;this.socket.setBuffer(!0)};
...
(function(a){function b(a,b,c,e){var d=c.lang();return d[a].call?d[a](c,e):d[a][b]}function c(a,b){return function(c){return k(a.call(this,c),b)}}function e(a){return function(b){b=a.call(this,b);return b+this.lang().ordinal(b)}}function f(a,b,c){this._d=a;this._isUTC=!!b;this._a=a._a||null;this._lang=c||!1}function n(a){var b=this._data={},c=a.years||a.y||0,e=a.months||a.M||0,d=a.weeks||a.w||0,f=a.days||a.d||0,j=a.hours||a.h||0,k=a.minutes||a.m||0,m=a.seconds||a.s||0;a=a.milliseconds||a.ms||0;this._milliseconds=
a+1E3*m+6E4*k+36E5*j;this._days=f+7*d;this._months=e+12*c;b.milliseconds=a%1E3;m+=s(a/1E3);b.seconds=m%60;k+=s(m/60);b.minutes=k%60;j+=s(k/60);b.hours=j%24;f+=s(j/24);f+=7*d;b.days=f%30;e+=s(f/30);b.months=e%12;c+=s(e/12);b.years=c;this._lang=!1}function s(a){return 0>a?Math.ceil(a):Math.floor(a)}function k(a,b){for(var c=a+"";c.length<b;)c="0"+c;return c}function p(a,b,c){var e=b._milliseconds,d=b._days;b=b._months;var f;e&&a._d.setTime(+a+e*c);d&&a.date(a.date()+d*c);b&&(f=a.date(),a.date(1).month(a.month()+
...
for(var e=5;e--&&ha.test(b);)b=b.replace(ha,c);if(!Ca[b]){var e=Ca,d=b,f=b,j=f.match(fa),k,m;k=0;for(m=j.length;k<m;k++)ka[j[k]]?j[k]=ka[j[k]]:j[k]=j[k].match(/\[.*\]/)?j[k].replace(/^\[|\]$/g,""):j[k].replace(/\\/g,"");e[d]=function(a){var b="";for(k=0;k<m;k++)b+="function"==typeof j[k].call?j[k].call(a,f):j[k];return b}}return Ca[b](a)}function X(a){switch(a){case "DDDD":return m;case "YYYY":return D;case "S":case "SS":case "SSS":case "DDD":return Y;case "MMM":case "MMMM":case "dd":case "ddd":case "dddd":case "a":case "A":return q;
case "Z":case "ZZ":return w;case "T":return A;case "MM":case "DD":case "YY":case "HH":case "hh":case "mm":case "ss":case "M":case "D":case "d":case "H":case "h":case "m":case "s":return ia;default:return RegExp(a.replace("\\",""))}}function r(a,b){var c=[0,0,1,0,0,0,0],e={tzh:0,tzm:0},d=b.match(fa),f,j;for(f=0;f<d.length;f++)if((j=(X(d[f]).exec(a)||[])[0])&&(a=a.slice(a.indexOf(j)+j.length)),ka[d[f]]){var k=c,m=e,p=void 0,n=void 0;switch(d[f]){case "M":case "MM":k[1]=null==j?0:~~j-1;break;case "MMM":case "MMMM":for(p=
...
ia=/\d\d?/,Y=/\d{1,3}/,m=/\d{3}/,D=/\d{1,4}/,q=/[0-9a-z\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]+/i,w=/Z|[\+\-]\d\d:?\d\d/i,A=/T/i,F=/^\s*\d{4}-\d\d-\d\d(T(\d\d(:\d\d(:\d\d(\.\d\d?\d?)?)?)?)?([\+\-]\d\d:?\d\d)?)?/,ga=[["HH:mm:ss.S",/T\d\d:\d\d:\d\d\.\d{1,3}/],["HH:mm:ss",/T\d\d:\d\d:\d\d/],["HH:mm",/T\d\d:\d\d/],["HH",/T\d\d/]],Za=/([\+\-]|\d\d)/gi,$a="Month Date Hours Minutes Seconds Milliseconds".split(" "),sa={Milliseconds:1,Seconds:1E3,Minutes:6E4,Hours:36E5,Days:864E5,Months:2592E6,Years:31536E6},
...
12||12},m:function(){return this.minutes()},s:function(){return this.seconds()},S:function(){return~~(this.milliseconds()/100)},SS:function(){return k(~~(this.milliseconds()/10),2)},SSS:function(){return k(this.milliseconds(),3)},Z:function(){var a=-this.zone();return 0>a&&(a=-a),"+"+k(~~(a/60),2)+":"+k(~~a%60,2)},ZZ:function(){var a=-this.zone();return 0>a&&(a=-a),"+"+k(~~(10*a/6),4)}};da.length;)R=da.pop(),ka[R+"o"]=e(ka[R]);for(;ta.length;)R=ta.pop(),ka[R+R]=c(ka[R],2);ka.DDDD=c(ka.DDD,3);j=function(b,
c){if(null===b||""===b)return null;var e;if(j.isMoment(b))e=new f(new Date(+b._d),b._isUTC,b._lang);else{if(c)if(Q(c)){var k=b.match(ja)||[],d,m=99,p,n;for(p=0;p<c.length;p++)n=r(b,c[p]),d=N(new f(n),c[p]).match(ja)||[],d=T(k,d),d<m&&(m=d,e=n)}else e=r(b,c);else if(e=P.exec(b),b===a)e=new Date;else if(e)e=new Date(+e[1]);else if(b instanceof Date)e=b;else if(Q(b))e=W(b);else if("string"==typeof b)if(e="YYYY-MM-DDT",F.exec(b)){for(k=0;4>k;k++)if(ga[k][1].exec(b)){e+=ga[k][0];break}e=w.exec(b)?r(b,
e+" Z"):r(b,e)}else e=new Date(b);else e=new Date(b);e=new f(e)}return e};j.utc=function(a,b){return Q(a)?new f(W(a,!0),!0):("string"==typeof a&&!w.exec(a)&&(a+=" +0000",b&&(b+=" Z")),j(a,b).utc())};j.unix=function(a){return j(1E3*a)};j.duration=function(a,b){var c=j.isDuration(a),e="number"==typeof a,d=c?a._data:e?{}:a,f;return e&&(b?d[b]=a:d.milliseconds=a),f=new n(d),c&&(f._lang=a._lang),f};j.humanizeDuration=function(a,b,c){return j.duration(a,!0===b?null:b).humanize(!0===b?!0:c)};j.version="1.7.2";
...
338241895,666307205,773529912,1294757372,1396182291,1695183700,1986661051,2177026350,2456956037,2730485921,2820302411,3259730800,3345764771,3516065817,3600352804,4094571909,275423344,430227734,506948616,659060556,883997877,958139571,1322822218,1537002063,1747873779,1955562222,2024104815,2227730452,2361852424,2428436474,2756734187,3204031479,3329325298],k=[1779033703,3144134277,1013904242,2773480762,1359893119,2600822924,528734635,1541459225],n=Array(64),s,N,X,r,U,K,V,I,j,C,R,ca;a[b>>5]|=128<<24-b%
32;a[(b+64>>9<<4)+15]=b;for(j=0;j<a.length;j+=16){s=k[0];N=k[1];X=k[2];r=k[3];U=k[4];K=k[5];V=k[6];I=k[7];for(C=0;64>C;C++)n[C]=16>C?a[C+j]:c(c(c(e(n[C-2],17)^e(n[C-2],19)^n[C-2]>>>10,n[C-7]),e(n[C-15],7)^e(n[C-15],18)^n[C-15]>>>3),n[C-16]),R=c(c(c(c(I,e(U,6)^e(U,11)^e(U,25)),U&K^~U&V),f[C]),n[C]),ca=c(e(s,2)^e(s,13)^e(s,22),s&N^s&X^N&X),I=V,V=K,K=U,U=c(r,R),r=X,X=N,N=s,s=c(R,ca);k[0]=c(s,k[0]);k[1]=c(N,k[1]);k[2]=c(X,k[2]);k[3]=c(r,k[3]);k[4]=c(U,k[4]);k[5]=c(K,k[5]);k[6]=c(V,k[6]);k[7]=c(I,k[7])}return k},
n=function(a){for(var c=[],e=(1<<b)-1,f=0;f<a.length*b;f+=b)c[f>>5]|=(a.charCodeAt(f/b)&e)<<24-f%32;return c},s=function(a){for(var b="",c=0;c<4*a.length;c++)b+="0123456789abcdef".charAt(a[c>>2]>>8*(3-c%4)+4&15)+"0123456789abcdef".charAt(a[c>>2]>>8*(3-c%4)&15);return b},k=function(b){return b="object"==typeof b?a(b).val():b.toString()};a.extend({sha256:function(a){a=k(a);return s(f(n(a),a.length*b))},sha256hmac:function(a,c){a=k(a);c=k(c);var e,W=a;e=c;var y=n(W);16<y.length&&(y=f(y,W.length*b));
for(var B=Array(16),W=Array(16),N=0;16>N;N++)B[N]=y[N]^909522486,W[N]=y[N]^1549556828;e=f(B.concat(n(e)),512+e.length*b);e=f(W.concat(e),768);return s(e)},sha256config:function(a){b=parseInt(a)||8}});a.fn.sha256=function(b){a.sha256config(b);b=k(a(this).val());b=a.sha256(b);a.sha256config(8);return b}})(jQuery);
...
var Thumbs={getDimensions:function(a){var b={},c=!1;$(a).contents().find(".scrap").each(function(){var a,f,n,s;c?(a=$(this).position().left,f=a+$(this).outerWidth(),n=$(this).position().top,s=top+$(this).outerHeight(),a<b.left&&(b.left=a),f>b.right&&(b.right=f),n<b.top&&(b.top=n),s>b.bottom&&(b.bottom=s)):(b.left=$(this).position().left,b.right=b.left+$(this).outerWidth(),b.top=$(this).position().top,b.bottom=b.top+$(this).outerHeight(),c=!0)});b.height=b.bottom-b.top;b.width=b.right-b.left;return b},
...
function(a){a.stopPropagation()});var n=$('<div id="nudgepadEditorSaveButton">Send</div>'),s=$('<div id="nudgepadEditorCancelButton">Close</div>'),k=$('<div id="nudgepadEditorButtonContainer"></div>');f.on("click",function(){s.trigger("click")});s.on("click",function(){n.remove();a.remove();f.remove();k.remove();s.remove();e.remove();c.remove();b.remove()});n.on("click",function(){var e=b.val(),f="nudgepad.console";c.is(":checked")&&(f="nudgepad.exec");$.post(f,{command:e},function(c){a.append(">"+
e.replace(/\n/g,"> \n")+"\n");a.append(c+"\n");a.scrollTop($("pre")[0].scrollHeight+"");b.val("");b.focus()},null,function(c){nudgepad.feedback.record("used console. got error");a.append(">"+e.replace(/\n/g,"> \n")+"\n");a.append("ERROR\n");a.append(c.responseText+"\n");a.scrollTop($("pre")[0].scrollHeight+"");b.val("");b.focus()})});b.on("enterkey",function(){n.click()});$("body").append(f);$("body").append(c);$("body").append(e);$("body").append(a);$("body").append(b);$("body").append(n);$("body").append(s);
$("body").append(k);b.focus()};nudgepad.contentEditor={};nudgepad.contentEditor.blur=function(){$(this).scrap().set("content",$(this).html());$(this).off("tap mousedown slide slidestart hold slideend",nudgepad.contentEditor.killEvent);$(this).removeAttr("contenteditable");var a=$(this).attr("id");$("."+a+"_handle").remove();nudgepad.stage.commit()};
...
nudgepad.getPageDimensions=function(a){a=new Page(a);a._static=!0;var b=$('<iframe class="deleteMe" style="position: fixed; right: 0px; top: 0px;"></iframe>');b.attr("frameborder",0);b.attr("scrolling","no");b.css("width",1);b.css("height",1);$("#nudgepadTemp").append(b);b.contents().find("body").append(a.toHtml());var c={},e=!1;b.contents().find(".scrap").each(function(){var a,b,s,k;e?(a=$(this).position().left,b=a+$(this).outerWidth(),s=$(this).position().top,k=top+$(this).outerHeight(),a<c.left&&
(c.left=a),b>c.right&&(c.right=b),s<c.top&&(c.top=s),k>c.bottom&&(c.bottom=k)):(c.left=$(this).position().left,c.right=c.left+$(this).outerWidth(),c.top=$(this).position().top,c.bottom=c.top+$(this).outerHeight(),e=!0)});c.height=c.bottom-c.top;c.width=c.right-c.left;$(".deleteMe").remove();return c};nudgepad.apps.git=new App("git");nudgepad.apps.git.commit=function(){var a=prompt("Enter your commit message");nudgepad.apps.git.send("git commit -am '"+a+"'")};nudgepad.apps.git.init=function(){nudgepad.apps.git.send("git init")};
...
Grid.prototype.getDelta=function(a){this.eraseSnaplines();var b={},c=[],e=[],f;for(f in a){var n=a[f],s;for(s in this.points)if(this.points.hasOwnProperty(s)){var k=this.points[s],p=k.x-n.x,Q=k.y-n.y;b.x||(b.x=p,b.y=Q);Math.abs(p)<=Math.abs(b.x)&&(b.x=p,c=[n,k]);Math.abs(Q)<=Math.abs(b.y)&&(b.y=Q,e=[n,k])}}a=Math.abs(b.x)<this.radius;f=Math.abs(b.y)<this.radius;a||(b.x=0);f||(b.y=0);(b.x||b.y)&&nudgepad.feedback.record("snap happened");a&&(c[0]={x:c[0].x+b.x,y:c[0].y+b.y},this.drawSnapline(c[0],c[1]));
...
nudgepad.MoveHandle.slide=function(a,b){var c=$(this).owner();c.scrap();var e=nudgepad.MoveHandle.dimensions,f=nudgepad.stage.scrollTop()-nudgepad.MoveHandle.scrollTop,n={y:0,x:0};b.shiftKey||(n=nudgepad.grid.getDelta([{x:e.left+nudgepad.mouse.xChange,y:e.top+nudgepad.mouse.yChange+f},{x:e.right+nudgepad.mouse.xChange,y:e.bottom+nudgepad.mouse.yChange+f},{x:e.center+nudgepad.mouse.xChange,y:e.middle+nudgepad.mouse.yChange+f}]));var s=nudgepad.mouse.yChange+f+n.y,k=nudgepad.mouse.xChange+n.x;$(".selection").each(function(){$(this).scrap().move(k-
nudgepad.MoveHandle.last_x_change,s-nudgepad.MoveHandle.last_y_change)});e="X "+parseFloat(c.css("left"))+"<br>Y "+parseFloat(c.css("top"));$("#nudgepadDimensions").css({left:10+c.right(),top:-10+c.middle()}).html(e);nudgepad.MoveHandle.last_x_change=k;nudgepad.MoveHandle.last_y_change=s;return!1};nudgepad.MoveHandle.slideend=function(){$(".handle").trigger("update").show();nudgepad.grid.removeSnaplines();$("#nudgepadDimensions").remove();nudgepad.stage.commit()};
...
e;for(e in c){var f=e,n=c[e],s="horizontal"==f?nudgepad.mouse.move.pageX:nudgepad.mouse.move.pageY+nudgepad.stage.scrollTop(),k="horizontal"==f?"width":"height",f="horizontal"==f?"left":"top",p=s-n;0<=p?b.css(k,p).css(f,n):b.css(f,s).css(k,-p)}a.preventDefault()};nudgepad.on("main",function(){$(document).on("slide",nudgepad.pages.selectBox.update);$(document).on("slideend",nudgepad.pages.selectBox.clear)});nudgepad.stage.selection={};nudgepad.stage.selection.saved=[];
...
nudgepad.stage.selection.distributeVertical=function(){var a=_.sortBy($(".selection"),function(a){return $(a).top()}),b=0,c=0;_.each(a,function(a,e,s){if(0===e)return!0;e=s[e-1];$(a).attr("id");b+=$(a).top()-$(e).bottom();c++});var e=Math.floor(b/c);0>e&&(e=0);_.each(a,function(a,b,c){if(0===b)return!0;b=c[b-1];c=$(a).scrap();c.set("style top",$(b).bottom()+e+"px");$(a).css("top",c.get("style top"))});$(".handle").trigger("update");nudgepad.stage.commit()};
nudgepad.stage.selection.distributeHorizontal=function(){var a=_.sortBy($(".selection"),function(a){return $(a).left()}),b=0,c=0;_.each(a,function(a,e,s){if(0===e)return!0;e=s[e-1];$(a).attr("id");b+=$(a).left()-$(e).right();c++});var e=Math.floor(b/c);0>e&&(e=0);_.each(a,function(a,b,c){if(0===b)return!0;b=c[b-1];c=$(a).scrap();c.set("style left",$(b).right()+e+"px");$(a).css("left",c.get("style left"))});$(".handle").trigger("update");nudgepad.stage.commit();nudgepad.notify("Distributed",1E3)};
...
nudgepad.StretchHandle.create=function(a,b,c,e){var f=a.element(),n="fixed"==f.css("position")?"fixed":"absolute",s=("top"==b?"n":"bottom"==b?"s":"")+("left"==c?"w":"right"==c?"e":""),k=$("<div></div>");k.attr("value",a.getPath());k.addClass("handle stretch_handle stretch_handle_"+a.id+" "+a.id+"_handle");k.attr("id","stretch_handle_"+b+c+a.id);k.css({cursor:s+"-resize",position:n,width:"5px",height:"5px",border:"1px solid rgba(0, 0, 0, .5)","background-color":"rgba(255, 255, 255, 0.5)","z-index":"50"});
k.data("row",b);k.data("column",c);e&&k.data("fixed",!0);f.parent().append(k);k.on("mousedown",nudgepad.StretchHandle.mousedown);k.on("slide",nudgepad.StretchHandle.slide);k.on("slidestart",nudgepad.StretchHandle.slidestart);k.on("slideend",nudgepad.StretchHandle.slideend);k.on("tap",nudgepad.StretchHandle.tap);k.on("update",nudgepad.StretchHandle.update);k.on("dblclick",nudgepad.StretchHandle.dblclick);k.trigger("update")};nudgepad.StretchHandle.dimensions={};
...
nudgepad.StretchHandle.slide=function(){var a=$(this).owner(),b=$(this).data().row,c=$(this).data().column,e=$(this).data().fixed,f,n;f="left"===c?nudgepad.StretchHandle.dimensions.right:"right"===c?nudgepad.StretchHandle.dimensions.left:nudgepad.StretchHandle.dimensions.center;n="top"===b?nudgepad.StretchHandle.dimensions.bottom:"bottom"===b?nudgepad.StretchHandle.dimensions.top:nudgepad.StretchHandle.dimensions.middle;var s=nudgepad.mouse.move.pageX-$(this).parent().offset().left,k=nudgepad.mouse.move.pageY-
$(this).parent().offset().top,k=nudgepad.StretchHandle.getLength(f,n,s,k,"center"!=c,"middle"!=b),s=a.scrap();"center"!=c&&(s.set("style left",(0<=k.x?f:k.x+f)+"px"),c=a.outerWidth()-a.width(),s.set("style width",Math.abs(k.x)-c+"px"));e?(b=parseFloat(s.get("style width"))/nudgepad.StretchHandle.originalWidth,s.set("style height",Math.round(nudgepad.StretchHandle.originalHeight*b)+"px")):"middle"!=b&&(0<=k.y?s.set("style top",n+"px"):s.set("style top",k.y+n+"px"),b=a.outerHeight()-a.height(),s.set("style height",
Math.abs(k.y)-b+"px"));a.css(s.values.style.values);b="W "+parseFloat(a.css("width"))+"<br> H "+parseFloat(a.css("height"));$("#nudgepadDimensions").css({left:10+a.right(),top:-10+a.middle()}).html(b);$(".stretch_handle_"+s.id).trigger("update");return!1};
...
f.on("tap",function(){$("div").removeClass("selectedEditorOption");$(this).addClass("selectedEditorOption");n.hide();T.hide();a.get("style")&&B.val(a.get("style"));B.show();return!1});c.append(f);var n=$('<div id="blockContainer"></div>');e.append(n);var s=$(".selection").css("background-color"),c=$('<div class="colorBackground"><input type="text" class="colorPicker"></div>');n.append(c);c=$('<div class="editorButton"><img src="/nudgepad/images/dup_lt.png"></div>');c.on("click",function(){nudgepad.stage.selection.duplicate()});
n.append(c);c=$('<div class="editorButton"><img src="/nudgepad/images/lock_lt.png"></div>');c.on("tap",function(){nudgepad.stage.selection.patch("locked true");N.trigger("click");return!1});n.append(c);var k=$('<select id="nudgepadLinkSelect"></select>'),c=$("<option>No link</option>");c.on("click",function(){nudgepad.stage.selection.patch("href ")});k.append(c);_.each(site.values.pages.values,function(a,b){var c=$('<option value="'+b+'">'+ToProperCase(b)+"</option>");c.on("click",function(){nudgepad.stage.selection.patch("type a\nhref "+
$(this).attr("value"))});k.append(c)});c=$("<option>New Page</option>");c.on("click",function(){var a=prompt("Enter the name of your new page",nudgepad.pages.nextName(nudgepad.stage.activePage));if(a){a=Permalink(a);nudgepad.stage.selection.patch("type a\nhref "+a);N.trigger("click");var b=nudgepad.stage.activePage;nudgepad.pages.duplicate(null,a,!0);nudgepad.stage.open(b)}});k.append(c);c=$("<option>External Link</option>");c.on("click",function(){var a=prompt("Enter the url to link to","http://");
a&&nudgepad.stage.selection.patch("type a\nhref "+a)});k.append(c);k.css({display:"none",position:"absolute","z-index":"100000"});k.attr("size",k.find("option").length);k.on("click",function(){k.hide();return!1});n.append(k);c=$('<div class="editorButton"><img src="/nudgepad/images/link_lt.png"></div>');c.on("tap",function(){k.css({left:$(this).position().left,top:$(this).position().top});k.show();return!1});n.append(c);c=$('<div class="editorButton"><img src="/nudgepad/images/up_lt.png" title="Order Up"></div>');
...
nudgepad.textPrompt=function(a,b,c,e,f){var n=$('<textarea id="nudgepadEditorTextarea" class="nudgepad"></textarea>');n.val(b);var s=$('<div id="nudgepadEditorModalScreen" class="nudgepad"/>');s.on("tap mousedown click slide slidestart slideend mouseup",function(a){a.stopPropagation()});n.on("tap mousedown click slide slidestart slideend mouseup",function(a){a.stopPropagation()});if(e)n.on("keypress",e);var k=$('<div id="nudgepadEditorSaveButton" class="nudgepad">'+(f||"Save")+"</div>"),p=$('<div id="nudgepadEditorCancelButton" class="nudgepad">Cancel</div>'),
Q=$('<div id="nudgepadEditorButtonContainer" class="nudgepad"></div>');s.on("click",function(){p.trigger("click")});p.on("click",function(){k.remove();n.remove();s.remove();Q.remove();p.remove()});k.on("click",function(){c&&c(n.val());k.remove();n.remove();s.remove();Q.remove();p.remove()});$("body").append(s);$("body").append(n);$("body").append(k);$("body").append(p);$("body").append(Q);n.focus()};
/**
