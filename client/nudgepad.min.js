...
c=0,h=a.toLowerCase().match(Ba)||[];if(e.isFunction(b))for(;u=h[c++];)"+"===u[0]?(u=u.slice(1)||"*",(j[u]=j[u]||[]).unshift(b)):(j[u]=j[u]||[]).push(b)}}function ca(j,a,y,u){function c(g){var p;return h[g]=!0,e.each(j[g]||[],function(j,e){var g=e(a,y,u);return"string"!=typeof g||d||h[g]?d?!(p=g):b:(a.dataTypes.unshift(g),c(g),!1)}),p}var h={},d=j===bc;return c(a.dataTypes[0])||!h["*"]&&c("*")}function O(j,a){var y,u,c=e.ajaxSettings.flatOptions||{};for(u in a)a[u]!==b&&((c[u]?j:y||(y={}))[u]=a[u]);
...
opts:e.extend(!0,{specialEasing:{}},b),originalProperties:a,originalOptions:b,startTime:nb||ea(),duration:b.duration,tweens:[],createTween:function(a,b){var B=e.Tween(j,f.opts,a,b,f.opts.specialEasing[a]||f.opts.easing);return f.tweens.push(B),B},stop:function(a){var b=0,B=a?f.tweens.length:0;if(c)return this;for(c=!0;B>b;b++)f.tweens[b].run(1);return a?g.resolveWith(j,[f,a]):g.rejectWith(j,[f,a]),this}});a=f.props;b=f.opts.specialEasing;var n,r,A,k;for(r in a)if(n=e.camelCase(r),A=b[n],u=a[r],e.isArray(u)&&
(A=u[1],u=a[r]=u[0]),r!==n&&(a[n]=u,delete a[r]),k=e.cssHooks[n],k&&"expand"in k)for(r in u=k.expand(u),delete a[n],u)r in a||(a[r]=u[r],b[r]=A);else b[n]=A;for(;d>h;h++)if(u=Ob[h].call(f,j,a,f.opts))return u;var v=f;e.each(a,function(j,a){for(var b=(Fb[j]||[]).concat(Fb["*"]),B=0,e=b.length;e>B&&!b[B].call(v,j,a);B++);});return e.isFunction(f.opts.start)&&f.opts.start.call(j,f),e.fx.timer(e.extend(p,{elem:j,anim:f,queue:f.opts.queue})),f.progress(f.opts.progress).done(f.opts.done,f.opts.complete).fail(f.opts.fail).always(f.opts.always)}
function M(j,a,b,e,c){return new M.prototype.init(j,a,b,e,c)}function g(j,a){var b,e={height:j},c=0;for(a=a?1:0;4>c;c+=2-a)b=db[c],e["margin"+b]=e["padding"+b]=j;return a&&(e.opacity=e.width=j),e}function x(j){return e.isWindow(j)?j:9===j.nodeType?j.defaultView||j.parentWindow:!1}var n,r,L=typeof b,F=a.document,fa=a.location,Wa=a.jQuery,Xa=a.$,sa={},Ca=[],ha=Ca.concat,ta=Ca.push,ka=Ca.slice,v=Ca.indexOf,Z=sa.toString,C=sa.hasOwnProperty,Ya="1.9.1".trim,e=function(j,a){return new e.fn.init(j,a,r)},
...
(n.resolveWith(F,[e]),e.fn.trigger&&e(F).trigger("ready").off("ready"))}},isFunction:function(j){return"function"===e.type(j)},isArray:Array.isArray||function(j){return"array"===e.type(j)},isWindow:function(j){return null!=j&&j==j.window},isNumeric:function(j){return!isNaN(parseFloat(j))&&isFinite(j)},type:function(j){return null==j?j+"":"object"==typeof j||"function"==typeof j?sa[Z.call(j)]||"object":typeof j},isPlainObject:function(j){if(!j||"object"!==e.type(j)||j.nodeType||e.isWindow(j))return!1;
...
"complete"===F.readyState)setTimeout(e.ready);else if(F.addEventListener)F.addEventListener("DOMContentLoaded",H,!1),a.addEventListener("load",H,!1);else{F.attachEvent("onreadystatechange",H);a.attachEvent("onload",H);var b=!1;try{b=null==a.frameElement&&F.documentElement}catch(y){}b&&b.doScroll&&function Sc(){if(!e.isReady){try{b.doScroll("left")}catch(j){return setTimeout(Sc,50)}Ra();e.ready()}}()}return n.promise(j)};e.each("Boolean Number String Function Array Date RegExp Object Error".split(" "),
function(j,a){sa["[object "+a+"]"]=a.toLowerCase()});r=e(F);var Sa={};e.Callbacks=function(j){var a;if("string"==typeof j){if(!(a=Sa[j])){a=j;var y=Sa[a]={};a=(e.each(a.match(Ba)||[],function(j,a){y[a]=!0}),y)}}else a=e.extend({},j);j=a;var c,h,d,g,f,p,n=[],r=!j.once&&[],A=function(a){h=j.memory&&a;d=!0;f=p||0;p=0;g=n.length;for(c=!0;n&&g>f;f++)if(!1===n[f].apply(a[0],a[1])&&j.stopOnFalse){h=!1;break}c=!1;n&&(r?r.length&&A(r.shift()):h?n=[]:k.disable())},k={add:function(){if(n){var a=n.length;(function Xc(a){e.each(a,
function(a,b){var B=e.type(b);"function"===B?j.unique&&k.has(b)||n.push(b):b&&b.length&&"string"!==B&&Xc(b)})})(arguments);c?g=n.length:h&&(p=a,A(h))}return this},remove:function(){return n&&e.each(arguments,function(j,a){for(var b;-1<(b=e.inArray(a,n,b));)n.splice(b,1),c&&(g>=b&&g--,f>=b&&f--)}),this},has:function(j){return j?-1<e.inArray(j,n):!(!n||!n.length)},empty:function(){return n=[],this},disable:function(){return n=r=h=b,this},disabled:function(){return!n},lock:function(){return r=b,h||k.disable(),
this},locked:function(){return!r},fireWith:function(j,a){return a=a||[],a=[j,a.slice?a.slice():a],!n||d&&!r||(c?r.push(a):A(a)),this},fire:function(){return k.fireWith(this,arguments),this},fired:function(){return!!d}};return k};e.extend({Deferred:function(j){var a=[["resolve","done",e.Callbacks("once memory"),"resolved"],["reject","fail",e.Callbacks("once memory"),"rejected"],["notify","progress",e.Callbacks("memory")]],b="pending",c={state:function(){return b},always:function(){return h.done(arguments).fail(arguments),
...
b[a].promise().done(g(a,n,b)).fail(d.reject).progress(g(a,p,f)):--h}return h||d.resolveWith(n,b),d.promise()}});var cc=e,ib;var da,ia,R,na,oa,ua,Ha,la,Ma,qa,N=F.createElement("div");if(N.setAttribute("className","t"),N.innerHTML="  <link/><table></table><a href='/a'>a</a><input type='checkbox'/>",ia=N.getElementsByTagName("*"),R=N.getElementsByTagName("a")[0],!ia||!R||!ia.length)ib={};else{oa=F.createElement("select");Ha=oa.appendChild(F.createElement("option"));na=N.getElementsByTagName("input")[0];
...
a.checked=0<=e.inArray(e(a).val(),c):b}})});var rb=/^(?:input|select|textarea)$/i,Na=/^key/,Rb=/^(?:mouse|contextmenu)|click/,Ib=/^(?:focusinfocus|focusoutblur)$/,Jb=/^([^.]*)(?:\.(.+)|)$/;e.event={global:{},add:function(a,c,h,u,d){var g,f,p,n,r,A,k,v,x;if(p=e._data(a)){h.handler&&(n=h,h=n.handler,d=n.selector);h.guid||(h.guid=e.guid++);(f=p.events)||(f=p.events={});(r=p.handle)||(r=p.handle=function(a){return typeof e===L||a&&e.event.triggered===a.type?b:e.event.dispatch.apply(r.elem,arguments)},
r.elem=a);c=(c||"").match(Ba)||[""];for(p=c.length;p--;)g=Jb.exec(c[p])||[],v=A=g[1],x=(g[2]||"").split(".").sort(),g=e.event.special[v]||{},v=(d?g.delegateType:g.bindType)||v,g=e.event.special[v]||{},A=e.extend({type:v,origType:A,data:u,handler:h,guid:h.guid,selector:d,needsContext:d&&e.expr.match.needsContext.test(d),namespace:x.join(".")},n),(k=f[v])||(k=f[v]=[],k.delegateCount=0,g.setup&&!1!==g.setup.call(a,u,x,r)||(a.addEventListener?a.addEventListener(v,r,!1):a.attachEvent&&a.attachEvent("on"+
v,r))),g.add&&(g.add.call(a,A),A.handler.guid||(A.handler.guid=h.guid)),d?k.splice(k.delegateCount++,0,A):k.push(A),e.event.global[v]=!0;a=null}},remove:function(a,b,c,h,d){var g,f,p,n,r,A,k,v,x,L,m,l=e.hasData(a)&&e._data(a);if(l&&(A=l.events)){b=(b||"").match(Ba)||[""];for(r=b.length;r--;)if(p=Jb.exec(b[r])||[],x=m=p[1],L=(p[2]||"").split(".").sort(),x){k=e.event.special[x]||{};x=(h?k.delegateType:k.bindType)||x;v=A[x]||[];p=p[2]&&RegExp("(^|\\.)"+L.join("\\.(?:.*\\.|)")+"(\\.|$)");for(n=g=v.length;g--;)f=
v[g],!d&&m!==f.origType||c&&c.guid!==f.guid||p&&!p.test(f.namespace)||h&&h!==f.selector&&("**"!==h||!f.selector)||(v.splice(g,1),f.selector&&v.delegateCount--,k.remove&&k.remove.call(a,f));n&&!v.length&&(k.teardown&&!1!==k.teardown.call(a,L,l.handle)||e.removeEvent(a,x,l.handle),delete A[x])}else for(x in A)e.event.remove(a,x+b[r],c,h,!0);e.isEmptyObject(A)&&(delete l.handle,e._removeData(a,"events"))}},trigger:function(j,c,h,u){var d,g,f,p,n,r,A=[h||F],k=C.call(j,"type")?j.type:j;r=C.call(j,"namespace")?
j.namespace.split("."):[];if(f=d=h=h||F,3!==h.nodeType&&8!==h.nodeType&&!Ib.test(k+e.event.triggered)&&(0<=k.indexOf(".")&&(r=k.split("."),k=r.shift(),r.sort()),g=0>k.indexOf(":")&&"on"+k,j=j[e.expando]?j:new e.Event(k,"object"==typeof j&&j),j.isTrigger=!0,j.namespace=r.join("."),j.namespace_re=j.namespace?RegExp("(^|\\.)"+r.join("\\.(?:.*\\.|)")+"(\\.|$)"):null,j.result=b,j.target||(j.target=h),c=null==c?[j]:e.makeArray(c,[j]),n=e.event.special[k]||{},u||!n.trigger||!1!==n.trigger.apply(h,c))){if(!u&&
!n.noBubble&&!e.isWindow(h)){p=n.delegateType||k;for(Ib.test(p+k)||(f=f.parentNode);f;f=f.parentNode)A.push(f),d=f;d===(h.ownerDocument||F)&&A.push(d.defaultView||d.parentWindow||a)}for(r=0;(f=A[r++])&&!j.isPropagationStopped();)j.type=1<r?p:n.bindType||k,(d=(e._data(f,"events")||{})[j.type]&&e._data(f,"handle"))&&d.apply(f,c),(d=g&&f[g])&&e.acceptData(f)&&d.apply&&!1===d.apply(f,c)&&j.preventDefault();if(j.type=k,!(u||j.isDefaultPrevented()||n._default&&!1!==n._default.apply(h.ownerDocument,c)||
...
d.elem;for(g=0;(u=d.handlers[g++])&&!a.isImmediatePropagationStopped();)(!a.namespace_re||a.namespace_re.test(u.namespace))&&(a.handleObj=u,a.data=u.data,h=((e.event.special[u.origType]||{}).handle||u.handler).apply(d.elem,p),h!==b&&!1===(a.result=h)&&(a.preventDefault(),a.stopPropagation()))}return n.postDispatch&&n.postDispatch.call(this,a),a.result}},handlers:function(a,c){var h,u,d,g,f=[],p=c.delegateCount,n=a.target;if(p&&n.nodeType&&(!a.button||"click"!==a.type))for(;n!=this;n=n.parentNode||
this)if(1===n.nodeType&&(!0!==n.disabled||"click"!==a.type)){d=[];for(g=0;p>g;g++)u=c[g],h=u.selector+" ",d[h]===b&&(d[h]=u.needsContext?0<=e(h,this).index(n):e.find(h,this,null,[n]).length),d[h]&&d.push(u);d.length&&f.push({elem:n,handlers:d})}return c.length>p&&f.push({elem:this,handlers:c.slice(p)}),f},fix:function(a){if(a[e.expando])return a;var b,c,h;b=a.type;var d=a,g=this.fixHooks[b];g||(this.fixHooks[b]=g=Rb.test(b)?this.mouseHooks:Na.test(b)?this.keyHooks:{});h=g.props?this.props.concat(g.props):
...
r,k=[],A=[],v=g.length,x;if(!(x=d)){x=b||"*";for(var L=f.nodeType?[f]:f,rc=[],m=0,l=L.length;l>m;m++)aa(x,L[m],rc);x=rc}x=!a||!d&&b?x:Lb(x,k,a,f,p);L=c?h||(d?a:v||e)?[]:g:x;if(c&&c(x,L,f,p),e){n=Lb(L,A);e(n,[],f,p);for(f=n.length;f--;)(r=n[f])&&(L[A[f]]=!(x[A[f]]=r))}if(d){if(h||a){if(h){n=[];for(f=L.length;f--;)(r=L[f])&&n.push(x[f]=r);h(null,L=[],n,p)}for(f=L.length;f--;)(r=L[f])&&-1<(n=h?fc.call(d,r):k[f])&&(d[n]=!(g[n]=r))}}else L=Lb(L===g?L.splice(v,L.length):L),h?h(null,g,L,p):ub.apply(g,L)})},
...
c){return function(e){e=aa.attr(e,a);return null==e?"!="===b:b?(e+="","="===b?e===c:"!="===b?e!==c:"^="===b?c&&0===e.indexOf(c):"*="===b?c&&-1<e.indexOf(c):"$="===b?c&&e.slice(-c.length)===c:"~="===b?-1<(" "+e+" ").indexOf(c):"|="===b?e===c||e.slice(0,c.length+1)===c+"-":!1):!0}},CHILD:function(a,b,c,e,h){var d="nth"!==a.slice(0,3),g="last"!==a.slice(-4),f="of-type"===b;return 1===e&&0===h?function(a){return!!a.parentNode}:function(b,c,p){var B,n,y,r,k;c=d!==g?"nextSibling":"previousSibling";var A=
b.parentNode,v=f&&b.nodeName.toLowerCase();p=!p&&!f;if(A){if(d){for(;c;){for(n=b;n=n[c];)if(f?n.nodeName.toLowerCase()===v:1===n.nodeType)return!1;k=c="only"===a&&!k&&"nextSibling"}return!0}if(k=[g?A.firstChild:A.lastChild],g&&p){p=A[ma]||(A[ma]={});B=p[a]||[];r=B[0]===Pa&&B[1];y=B[0]===Pa&&B[2];for(n=r&&A.childNodes[r];n=++r&&n&&n[c]||(y=r=0)||k.pop();)if(1===n.nodeType&&++y&&n===b){p[a]=[Pa,r,y];break}}else if(p&&(B=(b[ma]||(b[ma]={}))[a])&&B[0]===Pa)y=B[1];else for(;(n=++r&&n&&n[c]||(y=r=0)||k.pop())&&
...
this.nextSibling,c=this.parentNode;c&&(e(this).remove(),c.insertBefore(a,b))})},detach:function(a){return this.remove(a,!0)},domManip:function(a,c,h){a=ha.apply([],a);var d,g,f,p,n=0,r=this.length,k=this,A=r-1,v=a[0],x=e.isFunction(v);if(x||!(1>=r||"string"!=typeof v||e.support.checkClone)&&pd.test(v))return this.each(function(e){var d=k.eq(e);x&&(a[0]=v.call(this,e,c?d.html():b));d.domManip(a,c,h)});if(r&&(p=e.buildFragment(a,this[0].ownerDocument,!1,this),d=p.firstChild,1===p.childNodes.length&&
(p=d),d)){c=c&&e.nodeName(d,"tr");f=e.map(w(p,"script"),z);for(g=f.length;r>n;n++)d=p,n!==A&&(d=e.clone(d,!0,!0),g&&e.merge(f,w(d,"script"))),h.call(c&&e.nodeName(this[n],"table")?this[n].getElementsByTagName("tbody")[0]||this[n].appendChild(this[n].ownerDocument.createElement("tbody")):this[n],d,n);if(g){p=f[f.length-1].ownerDocument;e.map(f,G);for(n=0;g>n;n++)d=f[n],Ic.test(d.type||"")&&!e._data(d,"globalEval")&&e.contains(p,d)&&(d.src?e.ajax({url:d.src,type:"GET",dataType:"script",async:!1,global:!1,
...
!Ec.test("<"+a.nodeName+">")?g=a.cloneNode(!0):(lc.innerHTML=a.outerHTML,lc.removeChild(g=lc.firstChild)),!(e.support.noCloneEvent&&e.support.noCloneChecked||1!==a.nodeType&&11!==a.nodeType||e.isXMLDoc(a))){h=w(g);p=w(a);for(f=0;null!=(d=p[f]);++f)if(h[f]){var r=h[f],k=void 0,A=void 0,v=void 0;if(1===r.nodeType){if(k=r.nodeName.toLowerCase(),!e.support.noCloneEvent&&r[e.expando]){v=e._data(r);for(A in v.events)e.removeEvent(r,A,v.handle);r.removeAttribute(e.expando)}"script"===k&&r.text!==d.text?
(z(r).text=d.text,G(r)):"object"===k?(r.parentNode&&(r.outerHTML=d.outerHTML),e.support.html5Clone&&d.innerHTML&&!e.trim(r.innerHTML)&&(r.innerHTML=d.innerHTML)):"input"===k&&ac.test(d.type)?(r.defaultChecked=r.checked=d.checked,r.value!==d.value&&(r.value=d.value)):"option"===k?r.defaultSelected=r.selected=d.defaultSelected:("input"===k||"textarea"===k)&&(r.defaultValue=d.defaultValue)}}}if(b)if(c){p=p||w(a);h=h||w(g);for(f=0;null!=(d=p[f]);f++)D(d,h[f])}else D(a,g);return h=w(g,"script"),0<h.length&&
V(h,!n&&w(a,"script")),g},buildFragment:function(a,b,c,h){for(var d,g,f,p,n,r,k,A=a.length,v=T(b),x=[],L=0;A>L;L++)if(g=a[L],g||0===g)if("object"===e.type(g))e.merge(x,g.nodeType?[g]:g);else if(nd.test(g)){p=p||v.appendChild(b.createElement("div"));n=(Gc.exec(g)||["",""])[1].toLowerCase();k=Ia[n]||Ia._default;p.innerHTML=k[1]+g.replace(Fc,"<$1></$2>")+k[2];for(d=k[0];d--;)p=p.lastChild;if(!e.support.leadingWhitespace&&kc.test(g)&&x.push(b.createTextNode(kc.exec(g)[0])),!e.support.tbody)for(d=(g="table"!==
...
c=c||{};var d,g,f,p,n,r,k,A,v=e.ajaxSetup({},c),x=v.context||v,L=v.context&&(x.nodeType||x.jquery)?e(x):e.event,m=e.Deferred(),l=e.Callbacks("once memory"),s=v.statusCode||{},ra={},w={},Z=0,q="canceled",C={readyState:0,getResponseHeader:function(a){var b;if(2===Z){if(!A)for(A={};b=Ad.exec(p);)A[b[1].toLowerCase()]=b[2];b=A[a.toLowerCase()]}return null==b?null:b},getAllResponseHeaders:function(){return 2===Z?p:null},setRequestHeader:function(a,b){var c=a.toLowerCase();return Z||(a=w[c]=w[c]||a,ra[a]=
...
(!1===v.beforeSend.call(x,C,v)||2===Z))return C.abort();q="abort";for(g in{success:1,error:1,complete:1})C[g](v[g]);if(k=ca(bc,v,c,C)){C.readyState=1;r&&L.trigger("ajaxSend",[C,v]);v.async&&0<v.timeout&&(n=setTimeout(function(){C.abort("timeout")},v.timeout));try{Z=1,k.send(ra,h)}catch(F){if(!(2>Z))throw F;h(-1,F)}}else h(-1,"No Transport");return C},getScript:function(a,c){return e.get(a,b,c,"script")},getJSON:function(a,b,c){return e.get(a,b,c,"json")}});e.ajaxSetup({accepts:{script:"text/javascript, application/javascript, application/ecmascript, application/x-ecmascript"},
...
c.password):n.open(c.type,c.url,c.async),c.xhrFields)for(p in c.xhrFields)n[p]=c.xhrFields[p];c.mimeType&&n.overrideMimeType&&n.overrideMimeType(c.mimeType);c.crossDomain||d["X-Requested-With"]||(d["X-Requested-With"]="XMLHttpRequest");try{for(p in d)n.setRequestHeader(p,d[p])}catch(r){}n.send(c.hasContent&&c.data||null);h=function(a,d){var p,r,k,A;try{if(h&&(d||4===n.readyState))if(h=b,f&&(n.onreadystatechange=e.noop,qc&&delete Db[f]),d)4!==n.readyState&&n.abort();else{A={};p=n.status;r=n.getAllResponseHeaders();
"string"==typeof n.responseText&&(A.text=n.responseText);try{k=n.statusText}catch(v){k=""}p||!c.isLocal||c.crossDomain?1223===p&&(p=204):p=A.text?200:404}}catch(x){d||g(-1,x)}A&&g(p,k,A,r)};c.async?4===n.readyState?setTimeout(h):(f=++Dd,qc&&(Db||(Db={},e(a).unload(qc)),Db[f]=h),n.onreadystatechange=h):h()},abort:function(){h&&h(b,!0)}}}});var nb,$b,Ed=/^(?:toggle|show|hide)$/,Fd=RegExp("^(?:([+-])=|)("+Da+")([a-z%]*)$","i"),Gd=/queueHooks$/,Ob=[function(a,b,c){var h,d,g,f,p,n,r=this,k=a.style,A={},
...
v[d],f=r.createTween(h,x?g[h]:0),A[h]=g[h]||e.style(a,h),h in g||(g[h]=f.start,x&&(f.end=f.start,f.start="width"===h||"height"===h?1:0))}}],Fb={"*":[function(a,b){var c,h,d=this.createTween(a,b),g=Fd.exec(b),f=d.cur(),p=+f||0,n=1,r=20;if(g){if(c=+g[2],h=g[3]||(e.cssNumber[a]?"":"px"),"px"!==h&&p){p=e.css(d.elem,a,!0)||c||1;do n=n||".5",p/=n,e.style(d.elem,a,p+h);while(n!==(n=d.cur()/f)&&1!==n&&--r)}d.unit=h;d.start=p;d.end=g[1]?p+(g[1]+1)*c:c}return d}]};e.Animation=e.extend(I,{tweener:function(a,
...
"relative");var d=e(a),g=d.offset(),f=e.css(a,"top"),p=e.css(a,"left"),n={},r={},k,A;("absolute"===h||"fixed"===h)&&-1<e.inArray("auto",[f,p])?(r=d.position(),k=r.top,A=r.left):(k=parseFloat(f)||0,A=parseFloat(p)||0);e.isFunction(b)&&(b=b.call(a,c,g));null!=b.top&&(n.top=b.top-g.top+k);null!=b.left&&(n.left=b.left-g.left+A);"using"in b?b.using.call(a,n):d.css(n)}};e.fn.extend({position:function(){if(this[0]){var a,b,c={top:0,left:0},h=this[0];return"fixed"===e.css(h,"position")?b=h.getBoundingClientRect():
...
!D.showInput);p.toggleClass("sp-alpha-enabled",D.showAlpha);p.toggleClass("sp-buttons-disabled",!D.showButtons||O);p.toggleClass("sp-palette-disabled",!D.showPalette);p.toggleClass("sp-palette-only",D.showPaletteOnly);p.toggleClass("sp-initial-disabled",!D.showInitial);p.addClass(D.className);K()},x=function(c){if(ca&&(c=tinycolor(c).toRgbString(),-1===b.inArray(c,Ga)&&Ga.push(c),M&&a.localStorage))try{a.localStorage[M]=Ga.join(";")}catch(h){}},L=function(){var a=[],b=Ga,c={},h;if(D.showPalette){for(var e=
...
q=function(){(0===ia||0===da||0===na)&&K();p.addClass(wa)},E=function(){p.removeClass(wa)},v=function(){var a=tinycolor(Na.val());a.ok?e(a):Na.addClass("sp-validation-error")},Z=function(){ea?F():C()},C=function(){if(ea)K();else if(!1!==H.beforeShow(W())){for(var c=0;c<U.length;c++)U[c]&&U[c].hide();ea=!0;b(xa).bind("click.spectrum",F);b(a).bind("resize.spectrum",Q);Aa.addClass("sp-active");p.show();D.showPalette&&m();K();G();Va=W();w();H.show(Va)}},F=function(c){if((!c||!("click"==c.type&&2==c.button))&&
ea&&!O)ea=!1,b(xa).unbind("click.spectrum",F),b(a).unbind("resize.spectrum",Q),Aa.removeClass("sp-active"),p.hide(),tinycolor.equals(W(),Va)||(wb&&"cancel"!==c?I(!0):e(Va,!0)),H.hide(W())},e=function(a,b){if(!tinycolor.equals(a,W())){var c=tinycolor(a),h=c.toHsv();la=h.h;Ma=h.s;qa=h.v;N=h.a;G();b||(Ua=La||c.format)}},W=function(){return tinycolor.fromRatio({h:la,s:Ma,v:qa,a:Math.round(100*N)/100})},P=function(){G();H.move(W())},G=function(){Na.removeClass("sp-validation-error");Y();var a=tinycolor({h:la,
...
sb=p.find(".sp-choose"),kb=va.is("input"),ya=kb&&!O,Aa=ya?b("<div class='sp-replacer'><div class='sp-preview'><div class='sp-preview-inner'></div></div></div>").addClass(X):b([]),aa=ya?Aa:va,xb=Aa.find(".sp-preview-inner"),yb=D.color||kb&&va.val(),Va=!1,La=D.preferredFormat,Ua=La,wb=!D.showButtons||D.clickoutFiresChange,X=function(a){a.data&&a.data.ignore?(e(b(this).data("color")),P()):(e(b(this).data("color")),I(!0),P(),F());return!1};T&&p.find("*:not(input)").attr("unselectable","on");k();ya&&va.hide().after(Aa);
O?va.after(p).hide():b(J).append(p.hide());if(M&&a.localStorage){try{var zb=a.localStorage[M].split(",#");1<zb.length&&(delete a.localStorage[M],b.each(zb,function(a,b){x(b)}))}catch(Vb){}try{Ga=a.localStorage[M].split(";")}catch(Lb){}}aa.bind("click.spectrum touchstart.spectrum",function(a){h||Z();a.stopPropagation();b(a.target).is("input")||a.preventDefault()});(va.is(":disabled")||!0===D.disabled)&&r();p.click(t);Na.change(v);Na.bind("paste",function(){setTimeout(v,1)});Na.keydown(function(a){13==
...
x(yb)):G();O&&C();q=T?"mousedown.spectrum":"click.spectrum touchstart.spectrum";Rb.delegate(".sp-thumb-el",q,X);Ib.delegate(".sp-thumb-el:nth-child(1)",q,{ignore:!0},X);var bb={show:C,hide:F,toggle:Z,reflow:K,option:function(a,h){if(a===c)return b.extend({},D);if(h===c)return D[a];D[a]=h;k()},enable:function(){h=!1;va.attr("disabled",!1);aa.removeClass("sp-disabled")},disable:r,set:function(a){e(a);I()},get:W,destroy:function(){va.show();aa.unbind("click.spectrum touchstart.spectrum");p.remove();
...
a.replace(k,function(a){var b=m[a];return"string"===typeof b?b:"\\u"+("0000"+a.charCodeAt(0).toString(16)).slice(-4)})+'"':'"'+a+'"'}function e(a,b){var h,f,p,g,k=v,m,n=b[a];n instanceof Date&&(n=isFinite(a.valueOf())?a.getUTCFullYear()+"-"+c(a.getUTCMonth()+1)+"-"+c(a.getUTCDate())+"T"+c(a.getUTCHours())+":"+c(a.getUTCMinutes())+":"+c(a.getUTCSeconds())+"Z":null);"function"===typeof q&&(n=q.call(b,a,n));switch(typeof n){case "string":return d(n);case "number":return isFinite(n)?String(n):"null";
case "boolean":case "null":return String(n);case "object":if(!n)return"null";v+=l;m=[];if("[object Array]"===Object.prototype.toString.apply(n)){g=n.length;for(h=0;h<g;h+=1)m[h]=e(h,n)||"null";p=0===m.length?"[]":v?"[\n"+v+m.join(",\n"+v)+"\n"+k+"]":"["+m.join(",")+"]";v=k;return p}if(q&&"object"===typeof q){g=q.length;for(h=0;h<g;h+=1)"string"===typeof q[h]&&(f=q[h],(p=e(f,n))&&m.push(d(f)+(v?": ":":")+p))}else for(f in n)Object.prototype.hasOwnProperty.call(n,f)&&(p=e(f,n))&&m.push(d(f)+(v?": ":
...
case "Z":case "ZZ":return r;case "T":return L;case "MM":case "DD":case "YY":case "HH":case "hh":case "mm":case "ss":case "M":case "D":case "d":case "H":case "h":case "m":case "s":return I;default:return RegExp(a.replace("\\",""))}}function w(a,b){var c=[0,0,1,0,0,0,0],d={tzh:0,tzm:0},e=b.match(O),f,g;for(f=0;f<e.length;f++)if((g=(D(e[f]).exec(a)||[])[0])&&(a=a.slice(a.indexOf(g)+g.length)),ka[e[f]]){var k=c,l=d,m=void 0,n=void 0;switch(e[f]){case "M":case "MM":k[1]=null==g?0:~~g-1;break;case "MMM":case "MMMM":for(m=
...
c){if(null===b||""===b)return null;var d;if(k.isMoment(b))d=new f(new Date(+b._d),b._isUTC,b._lang);else{if(c)if(S(c)){var g=b.match(ea)||[],e,l=99,m,n;for(m=0;m<c.length;m++)n=w(b,c[m]),e=V(new f(n),c[m]).match(ea)||[],e=U(g,e),e<l&&(l=e,d=n)}else d=w(b,c);else if(d=ca.exec(b),b===a)d=new Date;else if(d)d=new Date(+d[1]);else if(b instanceof Date)d=b;else if(S(b))d=T(b);else if("string"==typeof b)if(d="YYYY-MM-DDT",F.exec(b)){for(g=0;4>g;g++)if(fa[g][1].exec(b)){d+=fa[g][0];break}d=r.exec(b)?w(b,
...
r:"Android";else if(!g||(m=!/\bMinefield\b/i.test(b)&&/Firefox|Safari/.exec(g)))if(g&&(!x&&/[\/,]|^[^(]+?\)/.test(b.slice(b.indexOf(m+"/")+8)))&&(g=null),(m=x||n||r)&&(x||n||/Android|Symbian OS|Tablet OS|webOS/.test(r)))g=/[a-z]+(?: Hat)?/i.exec(/Android/.test(r)?r:m)+" Browser";I||(I=["(?:Cloud9|CriOS|CrMo|Opera ?Mini|Raven|Silk(?!/[\\d.]+$))","Version",t(g),"(?:Firefox|Minefield|NetFront)"],I=l(I,function(a,c){return a||(RegExp(c+"(?:-[\\d.]+/|(?: for [\\w-]+)?[ /-])([\\d.]+[^ ();/_-]*)","i").exec(b)||
