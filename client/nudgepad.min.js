...
0)};Events.shortcut.shortcuts.down=function(){nudgepad.stage.selection.move(0,1)};Events.shortcut.shortcuts.right=function(){nudgepad.stage.selection.move(1,0)};Events.shortcut.shortcuts["shift+t"]=function(){$(".nudgepadTimeline").toggle()};Events.shortcut.shortcuts["shift+v"]=nudgepad.stage.toggleView;Events.shortcut.shortcuts["shift+up"]=function(){nudgepad.stage.selection.move(0,-10)};Events.shortcut.shortcuts["shift+left"]=function(){nudgepad.stage.selection.move(-10,0)};Events.shortcut.shortcuts["shift+down"]=
function(){nudgepad.stage.selection.move(0,10)};Events.shortcut.shortcuts["shift+right"]=function(){nudgepad.stage.selection.move(10,0)};Events.shortcut.shortcuts["alt+left"]=nudgepad.stage.back;Events.shortcut.shortcuts["alt+right"]=nudgepad.stage.forward;Events.shortcut.shortcuts["ctrl+z"]=nudgepad.stage.undo;Events.shortcut.shortcuts["meta+z"]=nudgepad.stage.undo;Events.shortcut.shortcuts["meta+shift+z"]=nudgepad.stage.redo;Events.shortcut.shortcuts["meta+y"]=nudgepad.stage.redo;Events.shortcut.shortcuts["ctrl+y"]=
nudgepad.stage.redo;Events.shortcut.shortcuts["meta+shift+c"]=nudgepad.stage.selection.cssPrompt};
