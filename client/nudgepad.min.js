...
$(this).parent().offset().top,l=nudgepad.StretchHandle.getLength(f,q,u,l,"center"!=c,"middle"!=b),u=a.scrap();"center"!=c&&(u.set("style left",(0<=l.x?f:l.x+f)+"px"),c=a.outerWidth()-a.width(),u.set("style width",Math.abs(l.x)-c+"px"));e?(b=parseFloat(u.get("style width"))/nudgepad.StretchHandle.originalWidth,u.set("style height",Math.round(nudgepad.StretchHandle.originalHeight*b)+"px")):"middle"!=b&&(0<=l.y?u.set("style top",q+"px"):u.set("style top",l.y+q+"px"),b=a.outerHeight()-a.height(),u.set("style height",
