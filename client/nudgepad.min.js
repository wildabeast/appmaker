...
j)):null:(this.each(function(){d.data(this,j,a)}),b)},null,a,1<arguments.length,null,!0)},removeData:function(j){return this.each(function(){d.removeData(this,j)})}});d.extend({queue:function(j,a,c){var s;return j?(a=(a||"fx")+"queue",s=d._data(j,a),c&&(!s||d.isArray(c)?s=d._data(j,a,d.makeArray(c)):s.push(c)),s||[]):b},dequeue:function(a,b){b=b||"fx";var c=d.queue(a,b),s=c.length,h=c.shift(),e=d._queueHooks(a,b),g=function(){d.dequeue(a,b)};"inprogress"===h&&(h=c.shift(),s--);(e.cur=h)&&("fx"===
b&&c.unshift("inprogress"),delete e.stop,h.call(a,g,e));!s&&e&&e.empty.fire()},_queueHooks:function(a,b){var c=b+"queueHooks";return d._data(a,c)||d._data(a,c,{empty:d.Callbacks("once memory").add(function(){d._removeData(a,b+"queue");d._removeData(a,c)})})}});d.fn.extend({queue:function(a,C){var c=2;return"string"!=typeof a&&(C=a,a="fx",c--),c>arguments.length?d.queue(this[0],a):C===b?this:this.each(function(){var b=d.queue(this,a,C);d._queueHooks(this,a);"fx"===a&&"inprogress"!==b[0]&&d.dequeue(this,
...
b){var c=typeof a,s="boolean"==typeof b;return d.isFunction(a)?this.each(function(c){d(this).toggleClass(a.call(this,c,this.className,b),b)}):this.each(function(){if("string"===c)for(var h,e=0,g=d(this),f=b,n=a.match(Ba)||[];h=n[e++];)f=s?f:!g.hasClass(h),g[f?"addClass":"removeClass"](h);else(c===L||"boolean"===c)&&(this.className&&d._data(this,"__className__",this.className),this.className=this.className||!1===a?"":d._data(this,"__className__")||"")})},hasClass:function(a){a=" "+a+" ";for(var b=
...
$("#nudgepadConnectionStatus").html("Connecting to server...").show()});nudgepad.socket.on("disconnect",function(a){nudgepad.trigger("disconnect",a)});nudgepad.socket.on("collage.update",function(a){site.values.collage.patch(a);nudgepad.trigger("collage.update")});nudgepad.socket.on("collage.delete",function(a){var b=site.get("collage "+a);nudgepad.notify(b.get("name")+" closed a tab");site.values.collage.delete(a)});nudgepad.socket.on("collage.create",function(a){a=new Space(a);site.values.collage.patch(a);
nudgepad.notify(a.get(a.keys[0]+" name")+" opened a tab")});nudgepad.socket.on("ack",function(a){nudgepad.trigger("ping",a)});nudgepad.socket.on("connect",function(a){console.log("connected to server %s",a);$("#nudgepadConnectionStatus").html("Connected!").fadeOut();nudgepad.restartCheck()});nudgepad.iosMain();var b=store.get("activePage")||"home";site.get("pages "+b)||(b="home");nudgepad.stage.open(b);$(window).on("resize",function(){$(".handle").trigger("update")});nudgepad.warnBeforeReload=!0;
window.onbeforeunload=function(){if(nudgepad.warnBeforeReload)return nudgepad.reloadMessage()};$("body").scrollTop(0);$("body").scrollLeft(0);nudgepad.navigation.openAppFromQueryString();$("#nudgepadLoadingScreen").hide();$(document).on("dragstart","img",function(a){a.preventDefault()});nudgepad.explorer.downloadTimelines();nudgepad.trigger("main");mixpanel.track("I opened NudgePad");nudgepad.query.newSite&&!store.get("opens")&&(store.set("opens",1),mixpanel.track("I created a new website"));a&&a()})};
...
"content",p=e.values.tag;if(p&&p.match(/^(list)$/))return nudgepad.stage.selection.clear(),c.selectMe(),nudgepad.stage.selection.editSource(),!1;p&&p.match(/^(textarea|input|password)$/)&&(f="placeholder");nudgepad.textPrompt("Editing content for this block",e.values[f],function(a){e.values[f]=a;nudgepad.stage.commit();c.remove();$("#nudgepadStageBody").append(e.toHtml(null,!0));c.selectMe()})}};nudgepad.contentEditor.killEvent=function(){nudgepad.mouse.down.stopPropagation();return!1};
