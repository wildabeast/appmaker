(function(a,b){function c(j){var a=j.length,b=d.type(j);return d.isWindow(j)?!1:1===j.nodeType&&a?!0:"array"===b||"function"!==b&&(0===a||"number"==typeof a&&0<a&&a-1 in j)}function e(j,a,y,t){if(d.acceptData(j)){var c,h,e=d.expando,g="string"==typeof a,p=j.nodeType,f=p?d.cache:j,n=p?j[e]:j[e]&&e;if(n&&f[n]&&(t||f[n].data)||!g||y!==b)return n||(p?j[e]=n=Ca.pop()||d.guid++:n=e),f[n]||(f[n]={},p||(f[n].toJSON=d.noop)),("object"==typeof a||"function"==typeof a)&&(t?f[n]=d.extend(f[n],a):f[n].data=d.extend(f[n].data,
a)),c=f[n],t||(c.data||(c.data={}),c=c.data),y!==b&&(c[d.camelCase(a)]=y),g?(h=c[a],null==h&&(h=c[d.camelCase(a)])):h=c,h}}function f(j,a,b){if(d.acceptData(j)){var t,c,h,e=j.nodeType,g=e?d.cache:j,p=e?j[d.expando]:d.expando;if(g[p]){if(a&&(h=b?g[p]:g[p].data)){d.isArray(a)?a=a.concat(d.map(a,d.camelCase)):a in h?a=[a]:(a=d.camelCase(a),a=a in h?[a]:a.split(" "));t=0;for(c=a.length;c>t;t++)delete h[a[t]];if(!(b?u:d.isEmptyObject)(h))return}(b||(delete g[p].data,u(g[p])))&&(e?d.cleanData([j],!0):d.support.deleteExpando||
g!=g.window?delete g[p]:g[p]=null)}}}function q(j,a,y){if(y===b&&1===j.nodeType){var t="data-"+a.replace(wa,"-$1").toLowerCase();if(y=j.getAttribute(t),"string"==typeof y){try{y="true"===y?!0:"false"===y?!1:"null"===y?null:+y+""===y?+y:Ga.test(y)?d.parseJSON(y):y}catch(c){}d.data(j,a,y)}else y=b}return y}function u(j){for(var a in j)if(("data"!==a||!d.isEmptyObject(j[a]))&&"toJSON"!==a)return!1;return!0}function l(){return!0}function s(){return!1}function S(j,a){do j=j[a];while(j&&1!==j.nodeType);
return j}function U(j,a,b){if(a=a||0,d.isFunction(a))return d.grep(j,function(j,d){return!!a.call(j,d,j)===b});if(a.nodeType)return d.grep(j,function(j){return j===a===b});if("string"==typeof a){var t=d.grep(j,function(j){return 1===j.nodeType});if(Tc.test(a))return d.filter(a,t,!b);a=d.filter(a,t)}return d.grep(j,function(j){return 0<=d.inArray(j,a)===b})}function T(j){var a=sc.split("|");j=j.createDocumentFragment();if(j.createElement)for(;a.length;)j.createElement(a.pop());return j}function z(j){var a=
j.getAttributeNode("type");return j.type=(a&&a.specified)+"/"+j.type,j}function F(j){var a=Uc.exec(j.type);return a?j.type=a[1]:j.removeAttribute("type"),j}function V(j,a){for(var b,t=0;null!=(b=j[t]);t++)d._data(b,"globalEval",!a||d._data(a[t],"globalEval"))}function E(j,a){if(1===a.nodeType&&d.hasData(j)){var b,t,c;t=d._data(j);var h=d._data(a,t),e=t.events;if(e)for(b in delete h.handle,h.events={},e){t=0;for(c=e[b].length;c>t;t++)d.event.add(a,b,e[b][t])}h.data&&(h.data=d.extend({},h.data))}}function w(j,
a){var y,t,c=0,h=typeof j.getElementsByTagName!==L?j.getElementsByTagName(a||"*"):typeof j.querySelectorAll!==L?j.querySelectorAll(a||"*"):b;if(!h){h=[];for(y=j.childNodes||j;null!=(t=y[c]);c++)!a||d.nodeName(t,a)?h.push(t):d.merge(h,w(t,a))}return a===b||a&&d.nodeName(j,a)?d.merge([j],h):h}function X(j){ac.test(j.type)&&(j.defaultChecked=j.checked)}function I(j,a){if(a in j)return a;for(var b=a.charAt(0).toUpperCase()+a.slice(1),d=a,c=tc.length;c--;)if(a=tc[c]+b,a in j)return a;return d}function Q(j,
a){return j=a||j,"none"===d.css(j,"display")||!d.contains(j.ownerDocument,j)}function J(j,a){for(var b,t,c,h=[],e=0,g=j.length;g>e;e++)t=j[e],t.style&&(h[e]=d._data(t,"olddisplay"),b=t.style.display,a?(h[e]||"none"!==b||(t.style.display=""),""===t.style.display&&Q(t)&&(h[e]=d._data(t,"olddisplay",ga(t.nodeName)))):h[e]||(c=Q(t),(b&&"none"!==b||!c)&&d._data(t,"olddisplay",c?b:d.css(t,"display"))));for(e=0;g>e;e++)t=j[e],t.style&&(a&&"none"!==t.style.display&&""!==t.style.display||(t.style.display=
a?h[e]||"":"none"));return j}function k(j,a,b){return(j=Vc.exec(a))?Math.max(0,j[1]-(b||0))+(j[2]||"px"):a}function D(j,a,b,t,c){a=b===(t?"border":"content")?4:"width"===a?1:0;for(var h=0;4>a;a+=2)"margin"===b&&(h+=d.css(j,b+db[a],!0,c)),t?("content"===b&&(h-=d.css(j,"padding"+db[a],!0,c)),"margin"!==b&&(h-=d.css(j,"border"+db[a]+"Width",!0,c))):(h+=d.css(j,"padding"+db[a],!0,c),"padding"!==b&&(h+=d.css(j,"border"+db[a]+"Width",!0,c)));return h}function Y(j,a,b){var t=!0,c="width"===a?j.offsetWidth:
j.offsetHeight,h=eb(j),e=d.support.boxSizing&&"border-box"===d.css(j,"boxSizing",!1,h);if(0>=c||null==c){if(c=fb(j,a,h),(0>c||null==c)&&(c=j.style[a]),Nb.test(c))return c;t=e&&(d.support.boxSizingReliable||c===j.style[a]);c=parseFloat(c)||0}return c+D(j,a,b||(e?"border":"content"),t,h)+"px"}function ga(j){var a=A,b=uc[j];return b||(b=W(j,a),"none"!==b&&b||(Eb=(Eb||d("<iframe frameborder='0' width='0' height='0'/>").css("cssText","display:block !important")).appendTo(a.documentElement),a=(Eb[0].contentWindow||
Eb[0].contentDocument).document,a.write("<!doctype html><html><body>"),a.close(),b=W(j,a),Eb.detach()),uc[j]=b),b}function W(j,a){var b=d(a.createElement(j)).appendTo(a.body),t=d.css(b[0],"display");return b.remove(),t}function P(j,a,b,t){var c;if(d.isArray(a))d.each(a,function(a,C){b||Wc.test(j)?t(j,C):P(j+"["+("object"==typeof C?a:"")+"]",C,b,t)});else if(b||"object"!==d.type(a))t(j,a);else for(c in a)P(j+"["+c+"]",a[c],b,t)}function m(j){return function(a,b){"string"!=typeof a&&(b=a,a="*");var t,
c=0,h=a.toLowerCase().match(Ba)||[];if(d.isFunction(b))for(;t=h[c++];)"+"===t[0]?(t=t.slice(1)||"*",(j[t]=j[t]||[]).unshift(b)):(j[t]=j[t]||[]).push(b)}}function ca(j,a,y,t){function c(g){var p;return h[g]=!0,d.each(j[g]||[],function(j,d){var g=d(a,y,t);return"string"!=typeof g||e||h[g]?e?!(p=g):b:(a.dataTypes.unshift(g),c(g),!1)}),p}var h={},e=j===bc;return c(a.dataTypes[0])||!h["*"]&&c("*")}function O(j,a){var y,t,c=d.ajaxSettings.flatOptions||{};for(t in a)a[t]!==b&&((c[t]?j:y||(y={}))[t]=a[t]);
return y&&d.extend(!0,j,y),j}function ja(){try{return new a.XMLHttpRequest}catch(j){}}function ea(){return setTimeout(function(){nb=b}),nb=d.now()}function H(j,a,b){var t,c,h=0,e=Ob.length,g=d.Deferred().always(function(){delete p.elem}),p=function(){if(c)return!1;for(var a=nb||ea(),a=Math.max(0,f.startTime+f.duration-a),b=1-(a/f.duration||0),C=0,d=f.tweens.length;d>C;C++)f.tweens[C].run(b);return g.notifyWith(j,[f,b,a]),1>b&&d?a:(g.resolveWith(j,[f]),!1)},f=g.promise({elem:j,props:d.extend({},a),
opts:d.extend(!0,{specialEasing:{}},b),originalProperties:a,originalOptions:b,startTime:nb||ea(),duration:b.duration,tweens:[],createTween:function(a,b){var C=d.Tween(j,f.opts,a,b,f.opts.specialEasing[a]||f.opts.easing);return f.tweens.push(C),C},stop:function(a){var b=0,C=a?f.tweens.length:0;if(c)return this;for(c=!0;C>b;b++)f.tweens[b].run(1);return a?g.resolveWith(j,[f,a]):g.rejectWith(j,[f,a]),this}});a=f.props;b=f.opts.specialEasing;var n,r,B,k;for(r in a)if(n=d.camelCase(r),B=b[n],t=a[r],d.isArray(t)&&
(B=t[1],t=a[r]=t[0]),r!==n&&(a[n]=t,delete a[r]),k=d.cssHooks[n],k&&"expand"in k)for(r in t=k.expand(t),delete a[n],t)r in a||(a[r]=t[r],b[r]=B);else b[n]=B;for(;e>h;h++)if(t=Ob[h].call(f,j,a,f.opts))return t;var v=f;d.each(a,function(j,a){for(var b=(Fb[j]||[]).concat(Fb["*"]),C=0,d=b.length;d>C&&!b[C].call(v,j,a);C++);});return d.isFunction(f.opts.start)&&f.opts.start.call(j,f),d.fx.timer(d.extend(p,{elem:j,anim:f,queue:f.opts.queue})),f.progress(f.opts.progress).done(f.opts.done,f.opts.complete).fail(f.opts.fail).always(f.opts.always)}
function M(j,a,b,d,c){return new M.prototype.init(j,a,b,d,c)}function g(j,a){var b,d={height:j},c=0;for(a=a?1:0;4>c;c+=2-a)b=db[c],d["margin"+b]=d["padding"+b]=j;return a&&(d.opacity=d.width=j),d}function x(j){return d.isWindow(j)?j:9===j.nodeType?j.defaultView||j.parentWindow:!1}var n,r,L=typeof b,A=a.document,fa=a.location,Wa=a.jQuery,Xa=a.$,sa={},Ca=[],ha=Ca.concat,ta=Ca.push,ka=Ca.slice,v=Ca.indexOf,Z=sa.toString,K=sa.hasOwnProperty,Ya="1.9.1".trim,d=function(j,a){return new d.fn.init(j,a,r)},
Da=/[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,Ba=/\S+/g,Za=/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,gb=/^(?:(<[\w\W]+>)[^>]*|#([\w-]*))$/,hb=/^<(\w+)\s*\/?>(?:<\/\1>|)$/,Gb=/^[\],:{}\s]*$/,Pb=/(?:^|:|,)(?:\s*\[)+/g,Qa=/\\(?:["\\\/bfnrt]|u[\da-fA-F]{4})/g,ob=/"[^"\\\r\n]*"|true|false|null|-?(?:\d+\.|)\d+(?:[eE][+-]?\d+|)/g,Ja=/^-ms-/,Hb=/-([\da-z])/gi,Qb=function(j,a){return a.toUpperCase()},G=function(j){(A.addEventListener||"load"===j.type||"complete"===A.readyState)&&(Ra(),d.ready())},Ra=function(){A.addEventListener?
(A.removeEventListener("DOMContentLoaded",G,!1),a.removeEventListener("load",G,!1)):(A.detachEvent("onreadystatechange",G),a.detachEvent("onload",G))};d.fn=d.prototype={jquery:"1.9.1",constructor:d,init:function(j,a,y){var t,c;if(!j)return this;if("string"==typeof j){if(t="<"===j.charAt(0)&&">"===j.charAt(j.length-1)&&3<=j.length?[null,j,null]:gb.exec(j),!t||!t[1]&&a)return!a||a.jquery?(a||y).find(j):this.constructor(a).find(j);if(t[1]){if(a=a instanceof d?a[0]:a,d.merge(this,d.parseHTML(t[1],a&&
a.nodeType?a.ownerDocument||a:A,!0)),hb.test(t[1])&&d.isPlainObject(a))for(t in a)d.isFunction(this[t])?this[t](a[t]):this.attr(t,a[t]);return this}if(c=A.getElementById(t[2]),c&&c.parentNode){if(c.id!==t[2])return y.find(j);this.length=1;this[0]=c}return this.context=A,this.selector=j,this}return j.nodeType?(this.context=this[0]=j,this.length=1,this):d.isFunction(j)?y.ready(j):(j.selector!==b&&(this.selector=j.selector,this.context=j.context),d.makeArray(j,this))},selector:"",length:0,size:function(){return this.length},
toArray:function(){return ka.call(this)},get:function(j){return null==j?this.toArray():0>j?this[this.length+j]:this[j]},pushStack:function(j){j=d.merge(this.constructor(),j);return j.prevObject=this,j.context=this.context,j},each:function(j,a){return d.each(this,j,a)},ready:function(j){return d.ready.promise().done(j),this},slice:function(){return this.pushStack(ka.apply(this,arguments))},first:function(){return this.eq(0)},last:function(){return this.eq(-1)},eq:function(j){var a=this.length;j=+j+
(0>j?a:0);return this.pushStack(0<=j&&a>j?[this[j]]:[])},map:function(j){return this.pushStack(d.map(this,function(a,b){return j.call(a,b,a)}))},end:function(){return this.prevObject||this.constructor(null)},push:ta,sort:[].sort,splice:[].splice};d.fn.init.prototype=d.fn;d.extend=d.fn.extend=function(){var j,a,y,t,c,h,e=arguments[0]||{},g=1,f=arguments.length,p=!1;"boolean"==typeof e&&(p=e,e=arguments[1]||{},g=2);"object"==typeof e||d.isFunction(e)||(e={});for(f===g&&(e=this,--g);f>g;g++)if(null!=
(c=arguments[g]))for(t in c)j=e[t],y=c[t],e!==y&&(p&&y&&(d.isPlainObject(y)||(a=d.isArray(y)))?(a?(a=!1,h=j&&d.isArray(j)?j:[]):h=j&&d.isPlainObject(j)?j:{},e[t]=d.extend(p,h,y)):y!==b&&(e[t]=y));return e};d.extend({noConflict:function(j){return a.$===d&&(a.$=Xa),j&&a.jQuery===d&&(a.jQuery=Wa),d},isReady:!1,readyWait:1,holdReady:function(j){j?d.readyWait++:d.ready(!0)},ready:function(j){if(!0===j?!--d.readyWait:!d.isReady){if(!A.body)return setTimeout(d.ready);d.isReady=!0;!0!==j&&0<--d.readyWait||
(n.resolveWith(A,[d]),d.fn.trigger&&d(A).trigger("ready").off("ready"))}},isFunction:function(j){return"function"===d.type(j)},isArray:Array.isArray||function(j){return"array"===d.type(j)},isWindow:function(j){return null!=j&&j==j.window},isNumeric:function(j){return!isNaN(parseFloat(j))&&isFinite(j)},type:function(j){return null==j?j+"":"object"==typeof j||"function"==typeof j?sa[Z.call(j)]||"object":typeof j},isPlainObject:function(j){if(!j||"object"!==d.type(j)||j.nodeType||d.isWindow(j))return!1;
try{if(j.constructor&&!K.call(j,"constructor")&&!K.call(j.constructor.prototype,"isPrototypeOf"))return!1}catch(a){return!1}for(var y in j);return y===b||K.call(j,y)},isEmptyObject:function(j){for(var a in j)return!1;return!0},error:function(j){throw Error(j);},parseHTML:function(j,a,b){if(!j||"string"!=typeof j)return null;"boolean"==typeof a&&(b=a,a=!1);a=a||A;var t=hb.exec(j);b=!b&&[];return t?[a.createElement(t[1])]:(t=d.buildFragment([j],a,b),b&&d(b).remove(),d.merge([],t.childNodes))},parseJSON:function(j){return a.JSON&&
a.JSON.parse?a.JSON.parse(j):null===j?j:"string"==typeof j&&(j=d.trim(j),j&&Gb.test(j.replace(Qa,"@").replace(ob,"]").replace(Pb,"")))?Function("return "+j)():(d.error("Invalid JSON: "+j),b)},parseXML:function(j){var C,y;if(!j||"string"!=typeof j)return null;try{a.DOMParser?(y=new DOMParser,C=y.parseFromString(j,"text/xml")):(C=new ActiveXObject("Microsoft.XMLDOM"),C.async="false",C.loadXML(j))}catch(t){C=b}return C&&C.documentElement&&!C.getElementsByTagName("parsererror").length||d.error("Invalid XML: "+
j),C},noop:function(){},globalEval:function(j){j&&d.trim(j)&&(a.execScript||function(j){a.eval.call(a,j)})(j)},camelCase:function(j){return j.replace(Ja,"ms-").replace(Hb,Qb)},nodeName:function(j,a){return j.nodeName&&j.nodeName.toLowerCase()===a.toLowerCase()},each:function(j,a,b){var d,h=0,e=j.length,g=c(j);if(b)if(g)for(;e>h&&!(d=a.apply(j[h],b),!1===d);h++);else for(h in j){if(d=a.apply(j[h],b),!1===d)break}else if(g)for(;e>h&&!(d=a.call(j[h],h,j[h]),!1===d);h++);else for(h in j)if(d=a.call(j[h],
h,j[h]),!1===d)break;return j},trim:Ya&&!Ya.call("\ufeff\u00a0")?function(j){return null==j?"":Ya.call(j)}:function(j){return null==j?"":(j+"").replace(Za,"")},makeArray:function(j,a){var b=a||[];return null!=j&&(c(Object(j))?d.merge(b,"string"==typeof j?[j]:j):ta.call(b,j)),b},inArray:function(j,a,b){var d;if(a){if(v)return v.call(a,j,b);d=a.length;for(b=b?0>b?Math.max(0,d+b):b:0;d>b;b++)if(b in a&&a[b]===j)return b}return-1},merge:function(j,a){var d=a.length,t=j.length,c=0;if("number"==typeof d)for(;d>
c;c++)j[t++]=a[c];else for(;a[c]!==b;)j[t++]=a[c++];return j.length=t,j},grep:function(j,a,b){var d,c=[],h=0,e=j.length;for(b=!!b;e>h;h++)d=!!a(j[h],h),b!==d&&c.push(j[h]);return c},map:function(j,a,b){var d,h=0,e=j.length,g=[];if(c(j))for(;e>h;h++)d=a(j[h],h,b),null!=d&&(g[g.length]=d);else for(h in j)d=a(j[h],h,b),null!=d&&(g[g.length]=d);return ha.apply([],g)},guid:1,proxy:function(j,a){var y,c,h;return"string"==typeof a&&(h=j[a],a=j,j=h),d.isFunction(j)?(y=ka.call(arguments,2),c=function(){return j.apply(a||
this,y.concat(ka.call(arguments)))},c.guid=j.guid=j.guid||d.guid++,c):b},access:function(j,a,y,c,h,e,g){var f=0,p=j.length,n=null==y;if("object"===d.type(y))for(f in h=!0,y)d.access(j,a,f,y[f],!0,e,g);else if(c!==b&&(h=!0,d.isFunction(c)||(g=!0),n&&(g?(a.call(j,c),a=null):(n=a,a=function(j,a,b){return n.call(d(j),b)})),a))for(;p>f;f++)a(j[f],y,g?c:c.call(j[f],f,a(j[f],y)));return h?j:n?a.call(j):p?a(j[0],y):e},now:function(){return(new Date).getTime()}});d.ready.promise=function(j){if(!n)if(n=d.Deferred(),
"complete"===A.readyState)setTimeout(d.ready);else if(A.addEventListener)A.addEventListener("DOMContentLoaded",G,!1),a.addEventListener("load",G,!1);else{A.attachEvent("onreadystatechange",G);a.attachEvent("onload",G);var b=!1;try{b=null==a.frameElement&&A.documentElement}catch(y){}b&&b.doScroll&&function Sc(){if(!d.isReady){try{b.doScroll("left")}catch(j){return setTimeout(Sc,50)}Ra();d.ready()}}()}return n.promise(j)};d.each("Boolean Number String Function Array Date RegExp Object Error".split(" "),
function(j,a){sa["[object "+a+"]"]=a.toLowerCase()});r=d(A);var Sa={};d.Callbacks=function(j){var a;if("string"==typeof j){if(!(a=Sa[j])){a=j;var y=Sa[a]={};a=(d.each(a.match(Ba)||[],function(j,a){y[a]=!0}),y)}}else a=d.extend({},j);j=a;var c,h,e,g,f,p,n=[],r=!j.once&&[],B=function(a){h=j.memory&&a;e=!0;f=p||0;p=0;g=n.length;for(c=!0;n&&g>f;f++)if(!1===n[f].apply(a[0],a[1])&&j.stopOnFalse){h=!1;break}c=!1;n&&(r?r.length&&B(r.shift()):h?n=[]:k.disable())},k={add:function(){if(n){var a=n.length;(function Xc(a){d.each(a,
function(a,b){var C=d.type(b);"function"===C?j.unique&&k.has(b)||n.push(b):b&&b.length&&"string"!==C&&Xc(b)})})(arguments);c?g=n.length:h&&(p=a,B(h))}return this},remove:function(){return n&&d.each(arguments,function(j,a){for(var b;-1<(b=d.inArray(a,n,b));)n.splice(b,1),c&&(g>=b&&g--,f>=b&&f--)}),this},has:function(j){return j?-1<d.inArray(j,n):!(!n||!n.length)},empty:function(){return n=[],this},disable:function(){return n=r=h=b,this},disabled:function(){return!n},lock:function(){return r=b,h||k.disable(),
this},locked:function(){return!r},fireWith:function(j,a){return a=a||[],a=[j,a.slice?a.slice():a],!n||e&&!r||(c?r.push(a):B(a)),this},fire:function(){return k.fireWith(this,arguments),this},fired:function(){return!!e}};return k};d.extend({Deferred:function(j){var a=[["resolve","done",d.Callbacks("once memory"),"resolved"],["reject","fail",d.Callbacks("once memory"),"rejected"],["notify","progress",d.Callbacks("memory")]],b="pending",c={state:function(){return b},always:function(){return h.done(arguments).fail(arguments),
this},then:function(){var j=arguments;return d.Deferred(function(b){d.each(a,function(a,C){var y=C[0],e=d.isFunction(j[a])&&j[a];h[C[1]](function(){var j=e&&e.apply(this,arguments);j&&d.isFunction(j.promise)?j.promise().done(b.resolve).fail(b.reject).progress(b.notify):b[y+"With"](this===c?b.promise():this,e?[j]:arguments)})});j=null}).promise()},promise:function(j){return null!=j?d.extend(j,c):c}},h={};return c.pipe=c.then,d.each(a,function(j,d){var e=d[2],g=d[3];c[d[1]]=e.add;g&&e.add(function(){b=
g},a[1^j][2].disable,a[2][2].lock);h[d[0]]=function(){return h[d[0]+"With"](this===h?c:this,arguments),this};h[d[0]+"With"]=e.fireWith}),c.promise(h),j&&j.call(h,h),h},when:function(j){var a=0,b=ka.call(arguments),c=b.length,h=1!==c||j&&d.isFunction(j.promise)?c:0,e=1===h?j:d.Deferred(),g=function(j,a,b){return function(d){a[j]=this;b[j]=1<arguments.length?ka.call(arguments):d;b===f?e.notifyWith(a,b):--h||e.resolveWith(a,b)}},f,p,n;if(1<c){f=Array(c);p=Array(c);for(n=Array(c);c>a;a++)b[a]&&d.isFunction(b[a].promise)?
b[a].promise().done(g(a,n,b)).fail(e.reject).progress(g(a,p,f)):--h}return h||e.resolveWith(n,b),e.promise()}});var cc=d,ib;var da,ia,R,na,oa,ua,Ha,la,Ma,qa,N=A.createElement("div");if(N.setAttribute("className","t"),N.innerHTML="  <link/><table></table><a href='/a'>a</a><input type='checkbox'/>",ia=N.getElementsByTagName("*"),R=N.getElementsByTagName("a")[0],!ia||!R||!ia.length)ib={};else{oa=A.createElement("select");Ha=oa.appendChild(A.createElement("option"));na=N.getElementsByTagName("input")[0];
...
3===N.offsetWidth,N.style.display="block",N.innerHTML="<div></div>",N.firstChild.style.width="5px",da.shrinkWrapBlocks=3!==N.offsetWidth,da.inlineBlockNeedsLayout&&(c.style.zoom=1)),c.removeChild(j),N=null)}),ia=oa=ua=Ha=R=na=null,da)}cc.support=ib;var Ga=/(?:\{[\s\S]*\}|\[[\s\S]*\])$/,wa=/([A-Z])/g;d.extend({cache:{},expando:"jQuery"+("1.9.1"+Math.random()).replace(/\D/g,""),noData:{embed:!0,object:"clsid:D27CDB6E-AE6D-11cf-96B8-444553540000",applet:!0},hasData:function(j){return j=j.nodeType?d.cache[j[d.expando]]:
j[d.expando],!!j&&!u(j)},data:function(j,a,b){return e(j,a,b)},removeData:function(j,a){return f(j,a)},_data:function(j,a,b){return e(j,a,b,!0)},_removeData:function(j,a){return f(j,a,!0)},acceptData:function(j){if(j.nodeType&&1!==j.nodeType&&9!==j.nodeType)return!1;var a=j.nodeName&&d.noData[j.nodeName.toLowerCase()];return!a||!0!==a&&j.getAttribute("classid")===a}});d.fn.extend({data:function(j,a){var c,t,h=this[0],e=0,g=null;if(j===b){if(this.length&&(g=d.data(h),1===h.nodeType&&!d._data(h,"parsedAttrs"))){for(c=
h.attributes;c.length>e;e++)t=c[e].name,t.indexOf("data-")||(t=d.camelCase(t.slice(5)),q(h,t,g[t]));d._data(h,"parsedAttrs",!0)}return g}return"object"==typeof j?this.each(function(){d.data(this,j)}):d.access(this,function(a){return a===b?h?q(h,j,d.data(h,j)):null:(this.each(function(){d.data(this,j,a)}),b)},null,a,1<arguments.length,null,!0)},removeData:function(j){return this.each(function(){d.removeData(this,j)})}});d.extend({queue:function(j,a,c){var t;return j?(a=(a||"fx")+"queue",t=d._data(j,
a),c&&(!t||d.isArray(c)?t=d._data(j,a,d.makeArray(c)):t.push(c)),t||[]):b},dequeue:function(j,a){a=a||"fx";var b=d.queue(j,a),c=b.length,h=b.shift(),e=d._queueHooks(j,a),g=function(){d.dequeue(j,a)};"inprogress"===h&&(h=b.shift(),c--);(e.cur=h)&&("fx"===a&&b.unshift("inprogress"),delete e.stop,h.call(j,g,e));!c&&e&&e.empty.fire()},_queueHooks:function(a,b){var c=b+"queueHooks";return d._data(a,c)||d._data(a,c,{empty:d.Callbacks("once memory").add(function(){d._removeData(a,b+"queue");d._removeData(a,
c)})})}});d.fn.extend({queue:function(a,C){var c=2;return"string"!=typeof a&&(C=a,a="fx",c--),c>arguments.length?d.queue(this[0],a):C===b?this:this.each(function(){var b=d.queue(this,a,C);d._queueHooks(this,a);"fx"===a&&"inprogress"!==b[0]&&d.dequeue(this,a)})},dequeue:function(a){return this.each(function(){d.dequeue(this,a)})},delay:function(a,b){return a=d.fx?d.fx.speeds[a]||a:a,b=b||"fx",this.queue(b,function(b,d){var C=setTimeout(b,a);d.stop=function(){clearTimeout(C)}})},clearQueue:function(a){return this.queue(a||
"fx",[])},promise:function(a,C){var c,t=1,h=d.Deferred(),e=this,g=this.length,f=function(){--t||h.resolveWith(e,[e])};"string"!=typeof a&&(C=a,a=b);for(a=a||"fx";g--;)(c=d._data(e[g],a+"queueHooks"))&&c.empty&&(t++,c.empty.add(f));return f(),h.promise(C)}});var xa,va,h=/[\t\r\n]/g,p=/\r/g,B=/^(?:input|select|textarea|button|object)$/i,ra=/^(?:a|area)$/i,Ta=/^(?:checked|selected|autofocus|autoplay|async|controls|defer|disabled|hidden|loop|multiple|open|readonly|required|scoped)$/i,pb=/^(?:checked|selected)$/i,
Ea=d.support.getSetAttribute,qb=d.support.input;d.fn.extend({attr:function(a,b){return d.access(this,d.attr,a,b,1<arguments.length)},removeAttr:function(a){return this.each(function(){d.removeAttr(this,a)})},prop:function(a,b){return d.access(this,d.prop,a,b,1<arguments.length)},removeProp:function(a){return a=d.propFix[a]||a,this.each(function(){try{this[a]=b,delete this[a]}catch(d){}})},addClass:function(a){var b,c,t,e,g,f=0,p=this.length;b="string"==typeof a&&a;if(d.isFunction(a))return this.each(function(b){d(this).addClass(a.call(this,
b,this.className))});if(b)for(b=(a||"").match(Ba)||[];p>f;f++)if(c=this[f],t=1===c.nodeType&&(c.className?(" "+c.className+" ").replace(h," "):" ")){for(g=0;e=b[g++];)0>t.indexOf(" "+e+" ")&&(t+=e+" ");c.className=d.trim(t)}return this},removeClass:function(a){var b,c,t,e,g,f=0,p=this.length;b=0===arguments.length||"string"==typeof a&&a;if(d.isFunction(a))return this.each(function(b){d(this).removeClass(a.call(this,b,this.className))});if(b)for(b=(a||"").match(Ba)||[];p>f;f++)if(c=this[f],t=1===c.nodeType&&
(c.className?(" "+c.className+" ").replace(h," "):"")){for(g=0;e=b[g++];)for(;0<=t.indexOf(" "+e+" ");)t=t.replace(" "+e+" "," ");c.className=a?d.trim(t):""}return this},toggleClass:function(a,b){var c=typeof a,h="boolean"==typeof b;return d.isFunction(a)?this.each(function(c){d(this).toggleClass(a.call(this,c,this.className,b),b)}):this.each(function(){if("string"===c)for(var e,g=0,f=d(this),p=b,n=a.match(Ba)||[];e=n[g++];)p=h?p:!f.hasClass(e),f[p?"addClass":"removeClass"](e);else(c===L||"boolean"===
c)&&(this.className&&d._data(this,"__className__",this.className),this.className=this.className||!1===a?"":d._data(this,"__className__")||"")})},hasClass:function(a){a=" "+a+" ";for(var b=0,d=this.length;d>b;b++)if(1===this[b].nodeType&&0<=(" "+this[b].className+" ").replace(h," ").indexOf(a))return!0;return!1},val:function(a){var c,y,h,e=this[0];if(arguments.length)return h=d.isFunction(a),this.each(function(c){var C,e=d(this);1===this.nodeType&&(C=h?a.call(this,c,e.val()):a,null==C?C="":"number"==
typeof C?C+="":d.isArray(C)&&(C=d.map(C,function(a){return null==a?"":a+""})),y=d.valHooks[this.type]||d.valHooks[this.nodeName.toLowerCase()],y&&"set"in y&&y.set(this,C,"value")!==b||(this.value=C))});if(e)return y=d.valHooks[e.type]||d.valHooks[e.nodeName.toLowerCase()],y&&"get"in y&&(c=y.get(e,"value"))!==b?c:(c=e.value,"string"==typeof c?c.replace(p,""):null==c?"":c)}});d.extend({valHooks:{option:{get:function(a){var b=a.attributes.value;return!b||b.specified?a.value:a.text}},select:{get:function(a){for(var b,
c=a.options,h=a.selectedIndex,e="select-one"===a.type||0>h,g=e?null:[],f=e?h+1:c.length,p=0>h?f:e?h:0;f>p;p++)if(b=c[p],!(!b.selected&&p!==h||(d.support.optDisabled?b.disabled:null!==b.getAttribute("disabled"))||b.parentNode.disabled&&d.nodeName(b.parentNode,"optgroup"))){if(a=d(b).val(),e)return a;g.push(a)}return g},set:function(a,b){var c=d.makeArray(b);return d(a).find("option").each(function(){this.selected=0<=d.inArray(d(this).val(),c)}),c.length||(a.selectedIndex=-1),c}}},attr:function(a,c,
y){var h,e,g,f=a.nodeType;if(a&&3!==f&&8!==f&&2!==f)return typeof a.getAttribute===L?d.prop(a,c,y):(e=1!==f||!d.isXMLDoc(a),e&&(c=c.toLowerCase(),h=d.attrHooks[c]||(Ta.test(c)?va:xa)),y===b?h&&e&&"get"in h&&null!==(g=h.get(a,c))?g:(typeof a.getAttribute!==L&&(g=a.getAttribute(c)),null==g?b:g):null!==y?h&&e&&"set"in h&&(g=h.set(a,y,c))!==b?g:(a.setAttribute(c,y+""),y):(d.removeAttr(a,c),b))},removeAttr:function(a,b){var c,h,e=0,g=b&&b.match(Ba);if(g&&1===a.nodeType)for(;c=g[e++];)h=d.propFix[c]||c,
Ta.test(c)?!Ea&&pb.test(c)?a[d.camelCase("default-"+c)]=a[h]=!1:a[h]=!1:d.attr(a,c,""),a.removeAttribute(Ea?c:h)},attrHooks:{type:{set:function(a,b){if(!d.support.radioValue&&"radio"===b&&d.nodeName(a,"input")){var c=a.value;return a.setAttribute("type",b),c&&(a.value=c),b}}}},propFix:{tabindex:"tabIndex",readonly:"readOnly","for":"htmlFor","class":"className",maxlength:"maxLength",cellspacing:"cellSpacing",cellpadding:"cellPadding",rowspan:"rowSpan",colspan:"colSpan",usemap:"useMap",frameborder:"frameBorder",
contenteditable:"contentEditable"},prop:function(a,c,h){var t,e,g,f=a.nodeType;if(a&&3!==f&&8!==f&&2!==f)return g=1!==f||!d.isXMLDoc(a),g&&(c=d.propFix[c]||c,e=d.propHooks[c]),h!==b?e&&"set"in e&&(t=e.set(a,h,c))!==b?t:a[c]=h:e&&"get"in e&&null!==(t=e.get(a,c))?t:a[c]},propHooks:{tabIndex:{get:function(a){var d=a.getAttributeNode("tabindex");return d&&d.specified?parseInt(d.value,10):B.test(a.nodeName)||ra.test(a.nodeName)&&a.href?0:b}}}});va={get:function(a,c){var h=d.prop(a,c),t="boolean"==typeof h&&
a.getAttribute(c);return(h="boolean"==typeof h?qb&&Ea?null!=t:pb.test(c)?a[d.camelCase("default-"+c)]:!!t:a.getAttributeNode(c))&&!1!==h.value?c.toLowerCase():b},set:function(a,b,c){return!1===b?d.removeAttr(a,c):qb&&Ea||!pb.test(c)?a.setAttribute(!Ea&&d.propFix[c]||c,c):a[d.camelCase("default-"+c)]=a[c]=!0,c}};qb&&Ea||(d.attrHooks.value={get:function(a,c){var h=a.getAttributeNode(c);return d.nodeName(a,"input")?a.defaultValue:h&&h.specified?h.value:b},set:function(a,c,h){return d.nodeName(a,"input")?
(a.defaultValue=c,b):xa&&xa.set(a,c,h)}});Ea||(xa=d.valHooks.button={get:function(a,d){var c=a.getAttributeNode(d);return c&&("id"===d||"name"===d||"coords"===d?""!==c.value:c.specified)?c.value:b},set:function(a,d,c){var h=a.getAttributeNode(c);return h||a.setAttributeNode(h=a.ownerDocument.createAttribute(c)),h.value=d+="","value"===c||d===a.getAttribute(c)?d:b}},d.attrHooks.contenteditable={get:xa.get,set:function(a,b,d){xa.set(a,""===b?!1:b,d)}},d.each(["width","height"],function(a,c){d.attrHooks[c]=
d.extend(d.attrHooks[c],{set:function(a,j){return""===j?(a.setAttribute(c,"auto"),j):b}})}));d.support.hrefNormalized||(d.each(["href","src","width","height"],function(a,c){d.attrHooks[c]=d.extend(d.attrHooks[c],{get:function(a){a=a.getAttribute(c,2);return null==a?b:a}})}),d.each(["href","src"],function(a,b){d.propHooks[b]={get:function(a){return a.getAttribute(b,4)}}}));d.support.style||(d.attrHooks.style={get:function(a){return a.style.cssText||b},set:function(a,b){return a.style.cssText=b+""}});
d.support.optSelected||(d.propHooks.selected=d.extend(d.propHooks.selected,{get:function(a){a=a.parentNode;return a&&(a.selectedIndex,a.parentNode&&a.parentNode.selectedIndex),null}}));d.support.enctype||(d.propFix.enctype="encoding");d.support.checkOn||d.each(["radio","checkbox"],function(){d.valHooks[this]={get:function(a){return null===a.getAttribute("value")?"on":a.value}}});d.each(["radio","checkbox"],function(){d.valHooks[this]=d.extend(d.valHooks[this],{set:function(a,c){return d.isArray(c)?
a.checked=0<=d.inArray(d(a).val(),c):b}})});var rb=/^(?:input|select|textarea)$/i,Na=/^key/,Rb=/^(?:mouse|contextmenu)|click/,Ib=/^(?:focusinfocus|focusoutblur)$/,Jb=/^([^.]*)(?:\.(.+)|)$/;d.event={global:{},add:function(a,c,h,t,e){var g,f,p,n,r,B,k,v,x;if(p=d._data(a)){h.handler&&(n=h,h=n.handler,e=n.selector);h.guid||(h.guid=d.guid++);(f=p.events)||(f=p.events={});(r=p.handle)||(r=p.handle=function(a){return typeof d===L||a&&d.event.triggered===a.type?b:d.event.dispatch.apply(r.elem,arguments)},
r.elem=a);c=(c||"").match(Ba)||[""];for(p=c.length;p--;)g=Jb.exec(c[p])||[],v=B=g[1],x=(g[2]||"").split(".").sort(),g=d.event.special[v]||{},v=(e?g.delegateType:g.bindType)||v,g=d.event.special[v]||{},B=d.extend({type:v,origType:B,data:t,handler:h,guid:h.guid,selector:e,needsContext:e&&d.expr.match.needsContext.test(e),namespace:x.join(".")},n),(k=f[v])||(k=f[v]=[],k.delegateCount=0,g.setup&&!1!==g.setup.call(a,t,x,r)||(a.addEventListener?a.addEventListener(v,r,!1):a.attachEvent&&a.attachEvent("on"+
v,r))),g.add&&(g.add.call(a,B),B.handler.guid||(B.handler.guid=h.guid)),e?k.splice(k.delegateCount++,0,B):k.push(B),d.event.global[v]=!0;a=null}},remove:function(a,b,c,h,e){var g,f,p,n,r,B,k,v,x,L,m,l=d.hasData(a)&&d._data(a);if(l&&(B=l.events)){b=(b||"").match(Ba)||[""];for(r=b.length;r--;)if(p=Jb.exec(b[r])||[],x=m=p[1],L=(p[2]||"").split(".").sort(),x){k=d.event.special[x]||{};x=(h?k.delegateType:k.bindType)||x;v=B[x]||[];p=p[2]&&RegExp("(^|\\.)"+L.join("\\.(?:.*\\.|)")+"(\\.|$)");for(n=g=v.length;g--;)f=
v[g],!e&&m!==f.origType||c&&c.guid!==f.guid||p&&!p.test(f.namespace)||h&&h!==f.selector&&("**"!==h||!f.selector)||(v.splice(g,1),f.selector&&v.delegateCount--,k.remove&&k.remove.call(a,f));n&&!v.length&&(k.teardown&&!1!==k.teardown.call(a,L,l.handle)||d.removeEvent(a,x,l.handle),delete B[x])}else for(x in B)d.event.remove(a,x+b[r],c,h,!0);d.isEmptyObject(B)&&(delete l.handle,d._removeData(a,"events"))}},trigger:function(j,c,h,t){var e,g,f,p,n,r,B=[h||A],k=K.call(j,"type")?j.type:j;r=K.call(j,"namespace")?
j.namespace.split("."):[];if(f=e=h=h||A,3!==h.nodeType&&8!==h.nodeType&&!Ib.test(k+d.event.triggered)&&(0<=k.indexOf(".")&&(r=k.split("."),k=r.shift(),r.sort()),g=0>k.indexOf(":")&&"on"+k,j=j[d.expando]?j:new d.Event(k,"object"==typeof j&&j),j.isTrigger=!0,j.namespace=r.join("."),j.namespace_re=j.namespace?RegExp("(^|\\.)"+r.join("\\.(?:.*\\.|)")+"(\\.|$)"):null,j.result=b,j.target||(j.target=h),c=null==c?[j]:d.makeArray(c,[j]),n=d.event.special[k]||{},t||!n.trigger||!1!==n.trigger.apply(h,c))){if(!t&&
!n.noBubble&&!d.isWindow(h)){p=n.delegateType||k;for(Ib.test(p+k)||(f=f.parentNode);f;f=f.parentNode)B.push(f),e=f;e===(h.ownerDocument||A)&&B.push(e.defaultView||e.parentWindow||a)}for(r=0;(f=B[r++])&&!j.isPropagationStopped();)j.type=1<r?p:n.bindType||k,(e=(d._data(f,"events")||{})[j.type]&&d._data(f,"handle"))&&e.apply(f,c),(e=g&&f[g])&&d.acceptData(f)&&e.apply&&!1===e.apply(f,c)&&j.preventDefault();if(j.type=k,!(t||j.isDefaultPrevented()||n._default&&!1!==n._default.apply(h.ownerDocument,c)||
"click"===k&&d.nodeName(h,"a")||!d.acceptData(h)||!g||!h[k]||d.isWindow(h))){(e=h[g])&&(h[g]=null);d.event.triggered=k;try{h[k]()}catch(v){}d.event.triggered=b;e&&(h[g]=e)}return j.result}},dispatch:function(a){a=d.event.fix(a);var c,h,t,e,g,f=[],p=ka.call(arguments);c=(d._data(this,"events")||{})[a.type]||[];var n=d.event.special[a.type]||{};if(p[0]=a,a.delegateTarget=this,!n.preDispatch||!1!==n.preDispatch.call(this,a)){f=d.event.handlers.call(this,a,c);for(c=0;(e=f[c++])&&!a.isPropagationStopped();){a.currentTarget=
e.elem;for(g=0;(t=e.handlers[g++])&&!a.isImmediatePropagationStopped();)(!a.namespace_re||a.namespace_re.test(t.namespace))&&(a.handleObj=t,a.data=t.data,h=((d.event.special[t.origType]||{}).handle||t.handler).apply(e.elem,p),h!==b&&!1===(a.result=h)&&(a.preventDefault(),a.stopPropagation()))}return n.postDispatch&&n.postDispatch.call(this,a),a.result}},handlers:function(a,c){var h,t,e,g,f=[],p=c.delegateCount,n=a.target;if(p&&n.nodeType&&(!a.button||"click"!==a.type))for(;n!=this;n=n.parentNode||
this)if(1===n.nodeType&&(!0!==n.disabled||"click"!==a.type)){e=[];for(g=0;p>g;g++)t=c[g],h=t.selector+" ",e[h]===b&&(e[h]=t.needsContext?0<=d(h,this).index(n):d.find(h,this,null,[n]).length),e[h]&&e.push(t);e.length&&f.push({elem:n,handlers:e})}return c.length>p&&f.push({elem:this,handlers:c.slice(p)}),f},fix:function(a){if(a[d.expando])return a;var b,c,h;b=a.type;var e=a,g=this.fixHooks[b];g||(this.fixHooks[b]=g=Rb.test(b)?this.mouseHooks:Na.test(b)?this.keyHooks:{});h=g.props?this.props.concat(g.props):
...
b&&(a.originalEvent.returnValue=a.result)}}},simulate:function(a,b,c,h){a=d.extend(new d.Event,c,{type:a,isSimulated:!0,originalEvent:{}});h?d.event.trigger(a,null,b):d.event.dispatch.call(b,a);a.isDefaultPrevented()&&c.preventDefault()}};d.removeEvent=A.removeEventListener?function(a,b,c){a.removeEventListener&&a.removeEventListener(b,c,!1)}:function(a,b,c){b="on"+b;a.detachEvent&&(typeof a[b]===L&&(a[b]=null),a.detachEvent(b,c))};d.Event=function(a,c){return this instanceof d.Event?(a&&a.type?(this.originalEvent=
a,this.type=a.type,this.isDefaultPrevented=a.defaultPrevented||!1===a.returnValue||a.getPreventDefault&&a.getPreventDefault()?l:s):this.type=a,c&&d.extend(this,c),this.timeStamp=a&&a.timeStamp||d.now(),this[d.expando]=!0,b):new d.Event(a,c)};d.Event.prototype={isDefaultPrevented:s,isPropagationStopped:s,isImmediatePropagationStopped:s,preventDefault:function(){var a=this.originalEvent;this.isDefaultPrevented=l;a&&(a.preventDefault?a.preventDefault():a.returnValue=!1)},stopPropagation:function(){var a=
this.originalEvent;this.isPropagationStopped=l;a&&(a.stopPropagation&&a.stopPropagation(),a.cancelBubble=!0)},stopImmediatePropagation:function(){this.isImmediatePropagationStopped=l;this.stopPropagation()}};d.each({mouseenter:"mouseover",mouseleave:"mouseout"},function(a,b){d.event.special[a]={delegateType:b,bindType:b,handle:function(a){var j,c=a.relatedTarget,h=a.handleObj;return(!c||c!==this&&!d.contains(this,c))&&(a.type=h.origType,j=h.handler.apply(this,arguments),a.type=b),j}}});d.support.submitBubbles||
(d.event.special.submit={setup:function(){return d.nodeName(this,"form")?!1:(d.event.add(this,"click._submit keypress._submit",function(a){a=a.target;(a=d.nodeName(a,"input")||d.nodeName(a,"button")?a.form:b)&&!d._data(a,"submitBubbles")&&(d.event.add(a,"submit._submit",function(a){a._submit_bubble=!0}),d._data(a,"submitBubbles",!0))}),b)},postDispatch:function(a){a._submit_bubble&&(delete a._submit_bubble,this.parentNode&&!a.isTrigger&&d.event.simulate("submit",this.parentNode,a,!0))},teardown:function(){return d.nodeName(this,
"form")?!1:(d.event.remove(this,"._submit"),b)}});d.support.changeBubbles||(d.event.special.change={setup:function(){return rb.test(this.nodeName)?(("checkbox"===this.type||"radio"===this.type)&&(d.event.add(this,"propertychange._change",function(a){"checked"===a.originalEvent.propertyName&&(this._just_changed=!0)}),d.event.add(this,"click._change",function(a){this._just_changed&&!a.isTrigger&&(this._just_changed=!1);d.event.simulate("change",this,a,!0)})),!1):(d.event.add(this,"beforeactivate._change",
function(a){a=a.target;rb.test(a.nodeName)&&!d._data(a,"changeBubbles")&&(d.event.add(a,"change._change",function(a){!this.parentNode||a.isSimulated||a.isTrigger||d.event.simulate("change",this.parentNode,a,!0)}),d._data(a,"changeBubbles",!0))}),b)},handle:function(a){var c=a.target;return this!==c||a.isSimulated||a.isTrigger||"radio"!==c.type&&"checkbox"!==c.type?a.handleObj.handler.apply(this,arguments):b},teardown:function(){return d.event.remove(this,"._change"),!rb.test(this.nodeName)}});d.support.focusinBubbles||
d.each({focus:"focusin",blur:"focusout"},function(a,b){var c=0,h=function(a){d.event.simulate(b,a.target,d.event.fix(a),!0)};d.event.special[b]={setup:function(){0===c++&&A.addEventListener(a,h,!0)},teardown:function(){0===--c&&A.removeEventListener(a,h,!0)}}});d.fn.extend({on:function(a,c,h,t,e){var g,f;if("object"==typeof a){"string"!=typeof c&&(h=h||c,c=b);for(g in a)this.on(g,c,h,a[g],e);return this}if(null==h&&null==t?(t=c,h=c=b):null==t&&("string"==typeof c?(t=h,h=b):(t=h,h=c,c=b)),!1===t)t=
s;else if(!t)return this;return 1===e&&(f=t,t=function(a){return d().off(a),f.apply(this,arguments)},t.guid=f.guid||(f.guid=d.guid++)),this.each(function(){d.event.add(this,a,t,h,c)})},one:function(a,b,c,d){return this.on(a,b,c,d,1)},off:function(a,c,h){var t,e;if(a&&a.preventDefault&&a.handleObj)return t=a.handleObj,d(a.delegateTarget).off(t.namespace?t.origType+"."+t.namespace:t.origType,t.selector,t.handler),this;if("object"==typeof a){for(e in a)this.off(e,c,a[e]);return this}return(!1===c||"function"==
typeof c)&&(h=c,c=b),!1===h&&(h=s),this.each(function(){d.event.remove(this,a,h,c)})},bind:function(a,b,c){return this.on(a,null,b,c)},unbind:function(a,b){return this.off(a,null,b)},delegate:function(a,b,c,d){return this.on(b,a,c,d)},undelegate:function(a,b,c){return 1===arguments.length?this.off(a,"**"):this.off(b,a||"**",c)},trigger:function(a,b){return this.each(function(){d.event.trigger(a,b,this)})},triggerHandler:function(a,c){var h=this[0];return h?d.event.trigger(a,c,h,!0):b}});var sb=a,
kb=function(){var a,b=[];return a=function(c,d){return b.push(c+=" ")>ba.cacheLength&&delete a[b.shift()],a[c]=d}},ya=function(a){return a[ma]=!0,a},Aa=function(a){var b=za.createElement("div");try{return a(b)}catch(c){return!1}finally{}},aa=function(a,b,c,d){var h,e,g,f,p;if((b?b.ownerDocument||b:lb)!==za&&tb(b),b=b||za,c=c||[],!a||"string"!=typeof a)return c;if(1!==(f=b.nodeType)&&9!==f)return[];if(!Ka&&!d){if(h=Yc.exec(a))if(g=h[1])if(9===f){if(e=b.getElementById(g),!e||!e.parentNode)return c;
if(e.id===g)return c.push(e),c}else{if(b.ownerDocument&&(e=b.ownerDocument.getElementById(g))&&Kb(b,e)&&e.id===g)return c.push(e),c}else{if(h[2])return ub.apply(c,vb.call(b.getElementsByTagName(a),0)),c;if((g=h[3])&&pa.getByClassName&&b.getElementsByClassName)return ub.apply(c,vb.call(b.getElementsByClassName(g),0)),c}if(pa.qsa&&!Oa.test(a)){if(h=!0,e=ma,g=b,p=9===f&&a,1===f&&"object"!==b.nodeName.toLowerCase()){f=Ua(a);(h=b.getAttribute("id"))?e=h.replace(Zc,"\\$&"):b.setAttribute("id",e);e="[id='"+
e+"'] ";for(g=f.length;g--;)f[g]=e+wb(f[g]);g=dc.test(a)&&b.parentNode||b;p=f.join(",")}if(p)try{return ub.apply(c,vb.call(g.querySelectorAll(p),0)),c}catch(n){}finally{h||b.removeAttribute("id")}}}var r;a:{a=a.replace(Sb,"$1");var k,B;e=Ua(a);if(!d&&1===e.length){if(r=e[0]=e[0].slice(0),2<r.length&&"ID"===(k=r[0]).type&&9===b.nodeType&&!Ka&&ba.relative[r[1].type]){if(b=ba.find.ID(k.matches[0].replace($a,ab),b)[0],!b){r=c;break a}a=a.slice(r.shift().value.length)}for(f=Tb.needsContext.test(a)?0:r.length;f--&&
!(k=r[f],ba.relative[h=k.type]);)if((B=ba.find[h])&&(d=B(k.matches[0].replace($a,ab),dc.test(r[0].type)&&b.parentNode||b))){if(r.splice(f,1),a=d.length&&wb(r),!a){r=(ub.apply(c,vb.call(d,0)),c);break a}break}}r=(ec(a,e)(d,b,Ka,c,dc.test(a)),c)}return r},xb=function(a,b){var c=b&&a,d=c&&(~b.sourceIndex||vc)-(~a.sourceIndex||vc);if(d)return d;if(c)for(;c=c.nextSibling;)if(c===b)return-1;return a?1:-1},yb=function(a){return function(b){return"input"===b.nodeName.toLowerCase()&&b.type===a}},Va=function(a){return function(b){var c=
b.nodeName.toLowerCase();return("input"===c||"button"===c)&&b.type===a}},La=function(a){return ya(function(b){return b=+b,ya(function(c,d){for(var h,e=a([],c.length,b),g=e.length;g--;)c[h=e[g]]&&(c[h]=!(d[h]=c[h]))})})},Ua=function(a,b){var c,d,h,e,g,f,p;if(g=wc[a+" "])return b?0:g.slice(0);g=a;f=[];for(p=ba.preFilter;g;){(!c||(d=$c.exec(g)))&&(d&&(g=g.slice(d[0].length)||g),f.push(h=[]));c=!1;(d=ad.exec(g))&&(c=d.shift(),h.push({value:c,type:d[0].replace(Sb," ")}),g=g.slice(c.length));for(e in ba.filter)!(d=
Tb[e].exec(g))||p[e]&&!(d=p[e](d))||(c=d.shift(),h.push({value:c,type:e,matches:d}),g=g.slice(c.length));if(!c)break}return b?g.length:g?aa.error(a):wc(a,f).slice(0)},wb=function(a){for(var b=0,c=a.length,d="";c>b;b++)d+=a[b].value;return d},zb=function(a,b,c){var d=b.dir,h=c&&"parentNode"===d,e=bd++;return b.first?function(b,c,e){for(;b=b[d];)if(1===b.nodeType||h)return a(b,c,e)}:function(b,c,g){var f,C,y,p=Pa+" "+e;if(g)for(;b=b[d];){if((1===b.nodeType||h)&&a(b,c,g))return!0}else for(;b=b[d];)if(1===
b.nodeType||h)if(y=b[ma]||(b[ma]={}),(C=y[d])&&C[0]===p){if(!0===(f=C[1])||f===Ub)return!0===f}else if(C=y[d]=[p],C[1]=a(b,c,g)||Ub,!0===C[1])return!0}},Vb=function(a){return 1<a.length?function(b,c,d){for(var h=a.length;h--;)if(!a[h](b,c,d))return!1;return!0}:a[0]},Lb=function(a,b,c,d,h){for(var e,g=[],f=0,p=a.length,n=null!=b;p>f;f++)(e=a[f])&&(!c||c(e,d,h))&&(g.push(e),n&&b.push(f));return g},bb=function(a,b,c,d,h,e){return d&&!d[ma]&&(d=bb(d)),h&&!h[ma]&&(h=bb(h,e)),ya(function(e,g,f,p){var n,
r,k=[],B=[],v=g.length,x;if(!(x=e)){x=b||"*";for(var L=f.nodeType?[f]:f,rc=[],m=0,l=L.length;l>m;m++)aa(x,L[m],rc);x=rc}x=!a||!e&&b?x:Lb(x,k,a,f,p);L=c?h||(e?a:v||d)?[]:g:x;if(c&&c(x,L,f,p),d){n=Lb(L,B);d(n,[],f,p);for(f=n.length;f--;)(r=n[f])&&(L[B[f]]=!(x[B[f]]=r))}if(e){if(h||a){if(h){n=[];for(f=L.length;f--;)(r=L[f])&&n.push(x[f]=r);h(null,L=[],n,p)}for(f=L.length;f--;)(r=L[f])&&-1<(n=h?fc.call(e,r):k[f])&&(e[n]=!(g[n]=r))}}else L=Lb(L===g?L.splice(v,L.length):L),h?h(null,g,L,p):ub.apply(g,L)})},
gc=function(a){var b,c,d,h=a.length,e=ba.relative[a[0].type];c=e||ba.relative[" "];for(var g=e?1:0,f=zb(function(a){return a===b},c,!0),p=zb(function(a){return-1<fc.call(b,a)},c,!0),n=[function(a,j,c){return!e&&(c||j!==Wb)||((b=j).nodeType?f(a,j,c):p(a,j,c))}];h>g;g++)if(c=ba.relative[a[g].type])n=[zb(Vb(n),c)];else{if(c=ba.filter[a[g].type].apply(null,a[g].matches),c[ma]){for(d=++g;h>d&&!ba.relative[a[d].type];d++);return bb(1<g&&Vb(n),1<g&&wb(a.slice(0,g-1)).replace(Sb,"$1"),c,d>g&&gc(a.slice(g,
d)),h>d&&gc(a=a.slice(d)),h>d&&wb(a))}n.push(c)}return Vb(n)},xc=function(){},Ab,Ub,ba,Xb,yc,ec,Bb,Wb,tb,za,Fa,Ka,Oa,Cb,Yb,Kb,hc,ma="sizzle"+-new Date,lb=sb.document,pa={},Pa=0,bd=0,zc=kb(),wc=kb(),Ac=kb(),vc=-2147483648,Zb=[],cd=Zb.pop,ub=Zb.push,vb=Zb.slice,fc=Zb.indexOf||function(a){for(var b=0,c=this.length;c>b;b++)if(this[b]===a)return b;return-1},Bc="(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+".replace("w","w#"),Cc="\\[[\\x20\\t\\r\\n\\f]*((?:\\\\.|[\\w-]|[^\\x00-\\xa0])+)[\\x20\\t\\r\\n\\f]*(?:([*^$|!~]?=)[\\x20\\t\\r\\n\\f]*(?:(['\"])((?:\\\\.|[^\\\\])*?)\\3|("+
...
j);for(c=a;c=c.parentNode;)e.unshift(c);for(c=j;c=c.parentNode;)g.unshift(c);for(;e[d]===g[d];)d++;return d?xb(e[d],g[d]):e[d]===lb?-1:g[d]===lb?1:0},Bb=!1,[0,0].sort(hc),pa.detectDuplicates=Bb,za)}else a=za;return a};aa.matches=function(a,b){return aa(a,null,null,b)};aa.matchesSelector=function(a,b){if((a.ownerDocument||a)!==za&&tb(a),b=b.replace(hd,"='$1']"),!(!pa.matchesSelector||Ka||Cb&&Cb.test(b)||Oa.test(b)))try{var c=Yb.call(a,b);if(c||pa.disconnectedMatch||a.document&&11!==a.document.nodeType)return c}catch(d){}return 0<
...
c){return function(d){d=aa.attr(d,a);return null==d?"!="===b:b?(d+="","="===b?d===c:"!="===b?d!==c:"^="===b?c&&0===d.indexOf(c):"*="===b?c&&-1<d.indexOf(c):"$="===b?c&&d.slice(-c.length)===c:"~="===b?-1<(" "+d+" ").indexOf(c):"|="===b?d===c||d.slice(0,c.length+1)===c+"-":!1):!0}},CHILD:function(a,b,c,d,h){var e="nth"!==a.slice(0,3),g="last"!==a.slice(-4),f="of-type"===b;return 1===d&&0===h?function(a){return!!a.parentNode}:function(b,c,p){var C,n,y,r,k;c=e!==g?"nextSibling":"previousSibling";var B=
b.parentNode,v=f&&b.nodeName.toLowerCase();p=!p&&!f;if(B){if(e){for(;c;){for(n=b;n=n[c];)if(f?n.nodeName.toLowerCase()===v:1===n.nodeType)return!1;k=c="only"===a&&!k&&"nextSibling"}return!0}if(k=[g?B.firstChild:B.lastChild],g&&p){p=B[ma]||(B[ma]={});C=p[a]||[];r=C[0]===Pa&&C[1];y=C[0]===Pa&&C[2];for(n=r&&B.childNodes[r];n=++r&&n&&n[c]||(y=r=0)||k.pop();)if(1===n.nodeType&&++y&&n===b){p[a]=[Pa,r,y];break}}else if(p&&(C=(b[ma]||(b[ma]={}))[a])&&C[0]===Pa)y=C[1];else for(;(n=++r&&n&&n[c]||(y=r=0)||k.pop())&&
(!(f?n.nodeName.toLowerCase()===v:1===n.nodeType)||!++y||!(p&&((n[ma]||(n[ma]={}))[a]=[Pa,y]),n===b)););return y-=h,y===d||0===y%d&&0<=y/d}}},PSEUDO:function(a,b){var c,d=ba.pseudos[a]||ba.setFilters[a.toLowerCase()]||aa.error("unsupported pseudo: "+a);return d[ma]?d(b):1<d.length?(c=[a,a,"",b],ba.setFilters.hasOwnProperty(a.toLowerCase())?ya(function(a,c){for(var j,h=d(a,b),e=h.length;e--;)j=fc.call(a,h[e]),a[j]=!(c[j]=h[e])}):function(a){return d(a,0,c)}):d}},pseudos:{not:ya(function(a){var b=[],
...
return a})}};for(Ab in{radio:!0,checkbox:!0,file:!0,password:!0,image:!0})ba.pseudos[Ab]=yb(Ab);for(Ab in{submit:!0,reset:!0})ba.pseudos[Ab]=Va(Ab);ec=aa.compile=function(a,b){var c,d=[],h=[],e=Ac[a+" "];if(!e){b||(b=Ua(a));for(c=b.length;c--;)e=gc(b[c]),e[ma]?d.push(e):h.push(e);var g=0,f=0<d.length,p=0<h.length;c=function(a,b,c,j,e){var n,r,C=[],y=0,k="0",B=a&&[],v=null!=e,x=Wb,L=a||p&&ba.find.TAG("*",e&&b.parentNode||b),m=Pa+=null==x?1:Math.random()||0.1;for(v&&(Wb=b!==za&&b,Ub=g);null!=(e=L[k]);k++){if(p&&
e){for(n=0;r=h[n++];)if(r(e,b,c)){j.push(e);break}v&&(Pa=m,Ub=++g)}f&&((e=!r&&e)&&y--,a&&B.push(e))}if(y+=k,f&&k!==y){for(n=0;r=d[n++];)r(B,C,b,c);if(a){if(0<y)for(;k--;)B[k]||C[k]||(C[k]=cd.call(j));C=Lb(C)}ub.apply(j,C);v&&!a&&0<C.length&&1<y+d.length&&aa.uniqueSort(j)}return v&&(Pa=m,Wb=x),B};c=f?ya(c):c;e=Ac(a,c)}return e};ba.pseudos.nth=ba.pseudos.eq;ba.filters=xc.prototype=ba.pseudos;ba.setFilters=new xc;tb();aa.attr=d.attr;d.find=aa;d.expr=aa.selectors;d.expr[":"]=d.expr.pseudos;d.unique=aa.uniqueSort;
d.text=aa.getText;d.isXMLDoc=aa.isXML;d.contains=aa.contains;var jd=/Until$/,kd=/^(?:parents|prev(?:Until|All))/,Tc=/^.[^:#\[\.,]*$/,Dc=d.expr.match.needsContext,ld={children:!0,contents:!0,next:!0,prev:!0};d.fn.extend({find:function(a){var b,c,h,e=this.length;if("string"!=typeof a)return h=this,this.pushStack(d(a).filter(function(){for(b=0;e>b;b++)if(d.contains(h[b],this))return!0}));c=[];for(b=0;e>b;b++)d.find(a,this[b],c);return c=this.pushStack(1<e?d.unique(c):c),c.selector=(this.selector?this.selector+
" ":"")+a,c},has:function(a){var b,c=d(a,this),h=c.length;return this.filter(function(){for(b=0;h>b;b++)if(d.contains(this,c[b]))return!0})},not:function(a){return this.pushStack(U(this,a,!1))},filter:function(a){return this.pushStack(U(this,a,!0))},is:function(a){return!!a&&("string"==typeof a?Dc.test(a)?0<=d(a,this.context).index(this[0]):0<d.filter(a,this).length:0<this.filter(a).length)},closest:function(a,b){for(var c,h=0,e=this.length,g=[],f=Dc.test(a)||"string"!=typeof a?d(a,b||this.context):
0;e>h;h++)for(c=this[h];c&&c.ownerDocument&&c!==b&&11!==c.nodeType;){if(f?-1<f.index(c):d.find.matchesSelector(c,a)){g.push(c);break}c=c.parentNode}return this.pushStack(1<g.length?d.unique(g):g)},index:function(a){return a?"string"==typeof a?d.inArray(this[0],d(a)):d.inArray(a.jquery?a[0]:a,this):this[0]&&this[0].parentNode?this.first().prevAll().length:-1},add:function(a,b){var c="string"==typeof a?d(a,b):d.makeArray(a&&a.nodeType?[a]:a),c=d.merge(this.get(),c);return this.pushStack(d.unique(c))},
addBack:function(a){return this.add(null==a?this.prevObject:this.prevObject.filter(a))}});d.fn.andSelf=d.fn.addBack;d.each({parent:function(a){return(a=a.parentNode)&&11!==a.nodeType?a:null},parents:function(a){return d.dir(a,"parentNode")},parentsUntil:function(a,b,c){return d.dir(a,"parentNode",c)},next:function(a){return S(a,"nextSibling")},prev:function(a){return S(a,"previousSibling")},nextAll:function(a){return d.dir(a,"nextSibling")},prevAll:function(a){return d.dir(a,"previousSibling")},nextUntil:function(a,
b,c){return d.dir(a,"nextSibling",c)},prevUntil:function(a,b,c){return d.dir(a,"previousSibling",c)},siblings:function(a){return d.sibling((a.parentNode||{}).firstChild,a)},children:function(a){return d.sibling(a.firstChild)},contents:function(a){return d.nodeName(a,"iframe")?a.contentDocument||a.contentWindow.document:d.merge([],a.childNodes)}},function(a,b){d.fn[a]=function(c,h){var e=d.map(this,b,c);return jd.test(a)||(h=c),h&&"string"==typeof h&&(e=d.filter(h,e)),e=1<this.length&&!ld[a]?d.unique(e):
e,1<this.length&&kd.test(a)&&(e=e.reverse()),this.pushStack(e)}});d.extend({filter:function(a,b,c){return c&&(a=":not("+a+")"),1===b.length?d.find.matchesSelector(b[0],a)?[b[0]]:[]:d.find.matches(a,b)},dir:function(a,c,h){var e=[];for(a=a[c];a&&9!==a.nodeType&&(h===b||1!==a.nodeType||!d(a).is(h));)1===a.nodeType&&e.push(a),a=a[c];return e},sibling:function(a,b){for(var c=[];a;a=a.nextSibling)1===a.nodeType&&a!==b&&c.push(a);return c}});var sc="abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video",
...
param:[1,"<object>","</object>"],thead:[1,"<table>","</table>"],tr:[2,"<table><tbody>","</tbody></table>"],col:[2,"<table><tbody></tbody><colgroup>","</colgroup></table>"],td:[3,"<table><tbody><tr>","</tr></tbody></table>"],_default:d.support.htmlSerialize?[0,"",""]:[1,"X<div>","</div>"]},lc=T(A).appendChild(A.createElement("div"));Ia.optgroup=Ia.option;Ia.tbody=Ia.tfoot=Ia.colgroup=Ia.caption=Ia.thead;Ia.th=Ia.td;d.fn.extend({text:function(a){return d.access(this,function(a){return a===b?d.text(this):
...
(b&&d.contains(c.ownerDocument,c)&&V(w(c,"script")),c.parentNode.removeChild(c)));return this},empty:function(){for(var a,b=0;null!=(a=this[b]);b++){for(1===a.nodeType&&d.cleanData(w(a,!1));a.firstChild;)a.removeChild(a.firstChild);a.options&&d.nodeName(a,"select")&&(a.options.length=0)}return this},clone:function(a,b){return a=null==a?!1:a,b=null==b?a:b,this.map(function(){return d.clone(this,a,b)})},html:function(a){return d.access(this,function(a){var c=this[0]||{},j=0,h=this.length;if(a===b)return 1===
c.nodeType?c.innerHTML.replace(md,""):b;if(!("string"!=typeof a||od.test(a)||!d.support.htmlSerialize&&Ec.test(a)||!d.support.leadingWhitespace&&kc.test(a)||Ia[(Gc.exec(a)||["",""])[1].toLowerCase()])){a=a.replace(Fc,"<$1></$2>");try{for(;h>j;j++)c=this[j]||{},1===c.nodeType&&(d.cleanData(w(c,!1)),c.innerHTML=a);c=0}catch(e){}}c&&this.empty().append(a)},null,a,arguments.length)},replaceWith:function(a){return d.isFunction(a)||"string"==typeof a||(a=d(a).not(this).detach()),this.domManip([a],!0,function(a){var b=
this.nextSibling,c=this.parentNode;c&&(d(this).remove(),c.insertBefore(a,b))})},detach:function(a){return this.remove(a,!0)},domManip:function(a,c,h){a=ha.apply([],a);var e,g,f,p,n=0,r=this.length,k=this,B=r-1,v=a[0],x=d.isFunction(v);if(x||!(1>=r||"string"!=typeof v||d.support.checkClone)&&pd.test(v))return this.each(function(d){var e=k.eq(d);x&&(a[0]=v.call(this,d,c?e.html():b));e.domManip(a,c,h)});if(r&&(p=d.buildFragment(a,this[0].ownerDocument,!1,this),e=p.firstChild,1===p.childNodes.length&&
(p=e),e)){c=c&&d.nodeName(e,"tr");f=d.map(w(p,"script"),z);for(g=f.length;r>n;n++)e=p,n!==B&&(e=d.clone(e,!0,!0),g&&d.merge(f,w(e,"script"))),h.call(c&&d.nodeName(this[n],"table")?this[n].getElementsByTagName("tbody")[0]||this[n].appendChild(this[n].ownerDocument.createElement("tbody")):this[n],e,n);if(g){p=f[f.length-1].ownerDocument;d.map(f,F);for(n=0;g>n;n++)e=f[n],Ic.test(e.type||"")&&!d._data(e,"globalEval")&&d.contains(p,e)&&(e.src?d.ajax({url:e.src,type:"GET",dataType:"script",async:!1,global:!1,
"throws":!0}):d.globalEval((e.text||e.textContent||e.innerHTML||"").replace(qd,"")))}p=e=null}return this}});d.each({appendTo:"append",prependTo:"prepend",insertBefore:"before",insertAfter:"after",replaceAll:"replaceWith"},function(a,b){d.fn[a]=function(a){for(var c=0,h=[],j=d(a),e=j.length-1;e>=c;c++)a=c===e?this:this.clone(!0),d(j[c])[b](a),ta.apply(h,a.get());return this.pushStack(h)}});d.extend({clone:function(a,b,c){var h,e,g,f,p,n=d.contains(a.ownerDocument,a);if(d.support.html5Clone||d.isXMLDoc(a)||
!Ec.test("<"+a.nodeName+">")?g=a.cloneNode(!0):(lc.innerHTML=a.outerHTML,lc.removeChild(g=lc.firstChild)),!(d.support.noCloneEvent&&d.support.noCloneChecked||1!==a.nodeType&&11!==a.nodeType||d.isXMLDoc(a))){h=w(g);p=w(a);for(f=0;null!=(e=p[f]);++f)if(h[f]){var r=h[f],k=void 0,B=void 0,v=void 0;if(1===r.nodeType){if(k=r.nodeName.toLowerCase(),!d.support.noCloneEvent&&r[d.expando]){v=d._data(r);for(B in v.events)d.removeEvent(r,B,v.handle);r.removeAttribute(d.expando)}"script"===k&&r.text!==e.text?
(z(r).text=e.text,F(r)):"object"===k?(r.parentNode&&(r.outerHTML=e.outerHTML),d.support.html5Clone&&e.innerHTML&&!d.trim(r.innerHTML)&&(r.innerHTML=e.innerHTML)):"input"===k&&ac.test(e.type)?(r.defaultChecked=r.checked=e.checked,r.value!==e.value&&(r.value=e.value)):"option"===k?r.defaultSelected=r.selected=e.defaultSelected:("input"===k||"textarea"===k)&&(r.defaultValue=e.defaultValue)}}}if(b)if(c){p=p||w(a);h=h||w(g);for(f=0;null!=(e=p[f]);f++)E(e,h[f])}else E(a,g);return h=w(g,"script"),0<h.length&&
V(h,!n&&w(a,"script")),g},buildFragment:function(a,b,c,h){for(var e,g,f,p,n,r,k,B=a.length,v=T(b),x=[],L=0;B>L;L++)if(g=a[L],g||0===g)if("object"===d.type(g))d.merge(x,g.nodeType?[g]:g);else if(nd.test(g)){p=p||v.appendChild(b.createElement("div"));n=(Gc.exec(g)||["",""])[1].toLowerCase();k=Ia[n]||Ia._default;p.innerHTML=k[1]+g.replace(Fc,"<$1></$2>")+k[2];for(e=k[0];e--;)p=p.lastChild;if(!d.support.leadingWhitespace&&kc.test(g)&&x.push(b.createTextNode(kc.exec(g)[0])),!d.support.tbody)for(e=(g="table"!==
n||Hc.test(g)?"<table>"!==k[1]||Hc.test(g)?0:p:p.firstChild)&&g.childNodes.length;e--;)d.nodeName(r=g.childNodes[e],"tbody")&&!r.childNodes.length&&g.removeChild(r);d.merge(x,p.childNodes);for(p.textContent="";p.firstChild;)p.removeChild(p.firstChild);p=v.lastChild}else x.push(b.createTextNode(g));p&&v.removeChild(p);d.support.appendChecked||d.grep(w(x,"input"),X);for(L=0;g=x[L++];)if((!h||-1===d.inArray(g,h))&&(f=d.contains(g.ownerDocument,g),p=w(v.appendChild(g),"script"),f&&V(p),c))for(e=0;g=p[e++];)Ic.test(g.type||
"")&&c.push(g);return v},cleanData:function(a,b){for(var c,h,e,g,f=0,p=d.expando,n=d.cache,r=d.support.deleteExpando,k=d.event.special;null!=(c=a[f]);f++)if((b||d.acceptData(c))&&(e=c[p],g=e&&n[e])){if(g.events)for(h in g.events)k[h]?d.event.remove(c,h):d.removeEvent(c,h,g.handle);n[e]&&(delete n[e],r?delete c[p]:typeof c.removeAttribute!==L?c.removeAttribute(p):c[p]=null,Ca.push(e))}}});var Eb,eb,fb,mc=/alpha\([^)]*\)/i,rd=/opacity\s*=\s*([^)]*)/,sd=/^(top|right|bottom|left)$/,td=/^(none|table(?!-c[ea]).+)/,
Jc=/^margin/,Vc=RegExp("^("+Da+")(.*)$","i"),Nb=RegExp("^("+Da+")(?!px)[a-z%]+$","i"),ud=RegExp("^([+-])=("+Da+")","i"),uc={BODY:"block"},vd={position:"absolute",visibility:"hidden",display:"block"},Kc={letterSpacing:0,fontWeight:400},db=["Top","Right","Bottom","Left"],tc=["Webkit","O","Moz","ms"];d.fn.extend({css:function(a,c){return d.access(this,function(a,c,h){var j,e={},g=0;if(d.isArray(c)){j=eb(a);for(h=c.length;h>g;g++)e[c[g]]=d.css(a,c[g],!1,j);return e}return h!==b?d.style(a,c,h):d.css(a,
c)},a,c,1<arguments.length)},show:function(){return J(this,!0)},hide:function(){return J(this)},toggle:function(a){var b="boolean"==typeof a;return this.each(function(){(b?a:Q(this))?d(this).show():d(this).hide()})}});d.extend({cssHooks:{opacity:{get:function(a,b){if(b){var c=fb(a,"opacity");return""===c?"1":c}}}},cssNumber:{columnCount:!0,fillOpacity:!0,fontWeight:!0,lineHeight:!0,opacity:!0,orphans:!0,widows:!0,zIndex:!0,zoom:!0},cssProps:{"float":d.support.cssFloat?"cssFloat":"styleFloat"},style:function(a,
c,h,e){if(a&&3!==a.nodeType&&8!==a.nodeType&&a.style){var g,f,p,n=d.camelCase(c),r=a.style;if(c=d.cssProps[n]||(d.cssProps[n]=I(r,n)),p=d.cssHooks[c]||d.cssHooks[n],h===b)return p&&"get"in p&&(g=p.get(a,!1,e))!==b?g:r[c];if(f=typeof h,"string"===f&&(g=ud.exec(h))&&(h=(g[1]+1)*g[2]+parseFloat(d.css(a,c)),f="number"),!(null==h||"number"===f&&isNaN(h)||("number"!==f||d.cssNumber[n]||(h+="px"),d.support.clearCloneStyle||""!==h||0!==c.indexOf("background")||(r[c]="inherit"),p&&"set"in p&&(h=p.set(a,h,
e))===b)))try{r[c]=h}catch(k){}}},css:function(a,c,h,e){var g,f,p,n=d.camelCase(c);return c=d.cssProps[n]||(d.cssProps[n]=I(a.style,n)),p=d.cssHooks[c]||d.cssHooks[n],p&&"get"in p&&(f=p.get(a,!0,h)),f===b&&(f=fb(a,c,e)),"normal"===f&&c in Kc&&(f=Kc[c]),""===h||h?(g=parseFloat(f),!0===h||d.isNumeric(g)?g||0:f):f},swap:function(a,b,c,d){var h,e={};for(h in b)e[h]=a.style[h],a.style[h]=b[h];c=c.apply(a,d||[]);for(h in b)a.style[h]=e[h];return c}});a.getComputedStyle?(eb=function(b){return a.getComputedStyle(b,
null)},fb=function(a,c,h){var e,g,f,p=(h=h||eb(a))?h.getPropertyValue(c)||h[c]:b,n=a.style;return h&&(""!==p||d.contains(a.ownerDocument,a)||(p=d.style(a,c)),Nb.test(p)&&Jc.test(c)&&(e=n.width,g=n.minWidth,f=n.maxWidth,n.minWidth=n.maxWidth=n.width=p,p=h.width,n.width=e,n.minWidth=g,n.maxWidth=f)),p}):A.documentElement.currentStyle&&(eb=function(a){return a.currentStyle},fb=function(a,c,d){var h,e,g;d=(d=d||eb(a))?d[c]:b;var f=a.style;return null==d&&f&&f[c]&&(d=f[c]),Nb.test(d)&&!sd.test(c)&&(h=
f.left,e=a.runtimeStyle,g=e&&e.left,g&&(e.left=a.currentStyle.left),f.left="fontSize"===c?"1em":d,d=f.pixelLeft+"px",f.left=h,g&&(e.left=g)),""===d?"auto":d});d.each(["height","width"],function(a,c){d.cssHooks[c]={get:function(a,h,j){return h?0===a.offsetWidth&&td.test(d.css(a,"display"))?d.swap(a,vd,function(){return Y(a,c,j)}):Y(a,c,j):b},set:function(a,b,h){var j=h&&eb(a);return k(a,b,h?D(a,c,h,d.support.boxSizing&&"border-box"===d.css(a,"boxSizing",!1,j),j):0)}}});d.support.opacity||(d.cssHooks.opacity=
{get:function(a,b){return rd.test((b&&a.currentStyle?a.currentStyle.filter:a.style.filter)||"")?0.01*parseFloat(RegExp.$1)+"":b?"1":""},set:function(a,b){var c=a.style,h=a.currentStyle,e=d.isNumeric(b)?"alpha(opacity="+100*b+")":"",g=h&&h.filter||c.filter||"";c.zoom=1;(1<=b||""===b)&&""===d.trim(g.replace(mc,""))&&c.removeAttribute&&(c.removeAttribute("filter"),""===b||h&&!h.filter)||(c.filter=mc.test(g)?g.replace(mc,e):g+" "+e)}});d(function(){d.support.reliableMarginRight||(d.cssHooks.marginRight=
{get:function(a,c){return c?d.swap(a,{display:"inline-block"},fb,[a,"marginRight"]):b}});!d.support.pixelPosition&&d.fn.position&&d.each(["top","left"],function(a,c){d.cssHooks[c]={get:function(a,h){return h?(h=fb(a,c),Nb.test(h)?d(a).position()[c]+"px":h):b}}})});d.expr&&d.expr.filters&&(d.expr.filters.hidden=function(a){return 0>=a.offsetWidth&&0>=a.offsetHeight||!d.support.reliableHiddenOffsets&&"none"===(a.style&&a.style.display||d.css(a,"display"))},d.expr.filters.visible=function(a){return!d.expr.filters.hidden(a)});
d.each({margin:"",padding:"",border:"Width"},function(a,b){d.cssHooks[a+b]={expand:function(c){var d=0,h={};for(c="string"==typeof c?c.split(" "):[c];4>d;d++)h[a+db[d]+b]=c[d]||c[d-2]||c[0];return h}};Jc.test(a)||(d.cssHooks[a+b].set=k)});var wd=/%20/g,Wc=/\[\]$/,Lc=/\r?\n/g,xd=/^(?:submit|button|image|reset|file)$/i,yd=/^(?:input|select|textarea|keygen)/i;d.fn.extend({serialize:function(){return d.param(this.serializeArray())},serializeArray:function(){return this.map(function(){var a=d.prop(this,
"elements");return a?d.makeArray(a):this}).filter(function(){var a=this.type;return this.name&&!d(this).is(":disabled")&&yd.test(this.nodeName)&&!xd.test(a)&&(this.checked||!ac.test(a))}).map(function(a,b){var c=d(this).val();return null==c?null:d.isArray(c)?d.map(c,function(a){return{name:b.name,value:a.replace(Lc,"\r\n")}}):{name:b.name,value:c.replace(Lc,"\r\n")}}).get()}});d.param=function(a,c){var h,e=[],g=function(a,b){b=d.isFunction(b)?b():null==b?"":b;e[e.length]=encodeURIComponent(a)+"="+
encodeURIComponent(b)};if(c===b&&(c=d.ajaxSettings&&d.ajaxSettings.traditional),d.isArray(a)||a.jquery&&!d.isPlainObject(a))d.each(a,function(){g(this.name,this.value)});else for(h in a)P(h,a[h],c,g);return e.join("&").replace(wd,"+")};d.each("blur focus focusin focusout load resize scroll unload click dblclick mousedown mouseup mousemove mouseover mouseout mouseenter mouseleave change select submit keydown keypress keyup error contextmenu".split(" "),function(a,b){d.fn[b]=function(a,c){return 0<
arguments.length?this.on(b,null,a,c):this.trigger(b)}});d.fn.hover=function(a,b){return this.mouseenter(a).mouseleave(b||a)};var mb,cb,nc=d.now(),oc=/\?/,zd=/#.*$/,Mc=/([?&])_=[^&]*/,Ad=/^(.*?):[ \t]*([^\r\n]*)\r?$/gm,Bd=/^(?:GET|HEAD)$/,Cd=/^\/\//,Nc=/^([\w.+-]+:)(?:\/\/([^\/?#:]*)(?::(\d+)|)|)/,Oc=d.fn.load,Pc={},bc={},Qc="*/".concat("*");try{cb=fa.href}catch(Id){cb=A.createElement("a"),cb.href="",cb=cb.href}mb=Nc.exec(cb.toLowerCase())||[];d.fn.load=function(a,c,h){if("string"!=typeof a&&Oc)return Oc.apply(this,
arguments);var e,g,f,p=this,n=a.indexOf(" ");return 0<=n&&(e=a.slice(n,a.length),a=a.slice(0,n)),d.isFunction(c)?(h=c,c=b):c&&"object"==typeof c&&(f="POST"),0<p.length&&d.ajax({url:a,type:f,dataType:"html",data:c}).done(function(a){g=arguments;p.html(e?d("<div>").append(d.parseHTML(a)).find(e):a)}).complete(h&&function(a,b){p.each(h,g||[a.responseText,b,a])}),this};d.each("ajaxStart ajaxStop ajaxComplete ajaxError ajaxSuccess ajaxSend".split(" "),function(a,b){d.fn[b]=function(a){return this.on(b,
...
contents:{xml:/xml/,html:/html/,json:/json/},responseFields:{xml:"responseXML",text:"responseText"},converters:{"* text":a.String,"text html":!0,"text json":d.parseJSON,"text xml":d.parseXML},flatOptions:{url:!0,context:!0}},ajaxSetup:function(a,b){return b?O(O(a,d.ajaxSettings),b):O(d.ajaxSettings,a)},ajaxPrefilter:m(Pc),ajaxTransport:m(bc),ajax:function(a,c){function h(a,c,e,j){var g,B,t,C,ra,w=c;if(2!==Z){Z=2;n&&clearTimeout(n);k=b;p=j||"";A.readyState=0<a?4:0;if(e){C=v;j=A;var K,y,q,D,u=C.contents,
W=C.dataTypes,Ta=C.responseFields;for(D in Ta)D in e&&(j[Ta[D]]=e[D]);for(;"*"===W[0];)W.shift(),y===b&&(y=C.mimeType||j.getResponseHeader("Content-Type"));if(y)for(D in u)if(u[D]&&u[D].test(y)){W.unshift(D);break}if(W[0]in e)q=W[0];else{for(D in e){if(!W[0]||C.converters[D+" "+W[0]]){q=D;break}K||(K=D)}q=q||K}C=q?(q!==W[0]&&W.unshift(q),e[q]):b}if(200<=a&&300>a||304===a)if(v.ifModified&&(ra=A.getResponseHeader("Last-Modified"),ra&&(d.lastModified[f]=ra),ra=A.getResponseHeader("etag"),ra&&(d.etag[f]=
ra)),204===a)g=!0,w="nocontent";else if(304===a)g=!0,w="notmodified";else{var P;a:{e=v;g=C;var fa,F;t={};ra=0;w=e.dataTypes.slice();K=w[0];if(e.dataFilter&&(g=e.dataFilter(g,e.dataType)),w[1])for(fa in e.converters)t[fa.toLowerCase()]=e.converters[fa];for(;B=w[++ra];)if("*"!==B){if("*"!==K&&K!==B){if(fa=t[K+" "+B]||t["* "+B],!fa)for(P in t)if(F=P.split(" "),F[1]===B&&(fa=t[K+" "+F[0]]||t["* "+F[0]])){!0===fa?fa=t[P]:!0!==t[P]&&(B=F[0],w.splice(ra--,0,B));break}if(!0!==fa)if(fa&&e["throws"])g=fa(g);
else try{g=fa(g)}catch(Ya){P={state:"parsererror",error:fa?Ya:"No conversion from "+K+" to "+B};break a}}K=B}P={state:"success",data:g}}g=P;w=g.state;B=g.data;t=g.error;g=!t}else t=w,(a||!w)&&(w="error",0>a&&(a=0));A.status=a;A.statusText=(c||w)+"";g?m.resolveWith(x,[B,w,A]):m.rejectWith(x,[A,w,t]);A.statusCode(s);s=b;r&&L.trigger(g?"ajaxSuccess":"ajaxError",[A,v,g?B:t]);l.fireWith(x,[A,w]);r&&(L.trigger("ajaxComplete",[A,v]),--d.active||d.event.trigger("ajaxStop"))}}"object"==typeof a&&(c=a,a=b);
c=c||{};var e,g,f,p,n,r,k,B,v=d.ajaxSetup({},c),x=v.context||v,L=v.context&&(x.nodeType||x.jquery)?d(x):d.event,m=d.Deferred(),l=d.Callbacks("once memory"),s=v.statusCode||{},ra={},w={},Z=0,K="canceled",A={readyState:0,getResponseHeader:function(a){var b;if(2===Z){if(!B)for(B={};b=Ad.exec(p);)B[b[1].toLowerCase()]=b[2];b=B[a.toLowerCase()]}return null==b?null:b},getAllResponseHeaders:function(){return 2===Z?p:null},setRequestHeader:function(a,b){var c=a.toLowerCase();return Z||(a=w[c]=w[c]||a,ra[a]=
b),this},overrideMimeType:function(a){return Z||(v.mimeType=a),this},statusCode:function(a){var b;if(a)if(2>Z)for(b in a)s[b]=[s[b],a[b]];else A.always(a[A.status]);return this},abort:function(a){a=a||K;return k&&k.abort(a),h(0,a),this}};if(m.promise(A).complete=l.add,A.success=A.done,A.error=A.fail,v.url=((a||v.url||cb)+"").replace(zd,"").replace(Cd,mb[1]+"//"),v.type=c.method||c.type||v.method||v.type,v.dataTypes=d.trim(v.dataType||"*").toLowerCase().match(Ba)||[""],null==v.crossDomain&&(e=Nc.exec(v.url.toLowerCase()),
v.crossDomain=!(!e||e[1]===mb[1]&&e[2]===mb[2]&&(e[3]||("http:"===e[1]?80:443))==(mb[3]||("http:"===mb[1]?80:443)))),v.data&&v.processData&&"string"!=typeof v.data&&(v.data=d.param(v.data,v.traditional)),ca(Pc,v,c,A),2===Z)return A;(r=v.global)&&0===d.active++&&d.event.trigger("ajaxStart");v.type=v.type.toUpperCase();v.hasContent=!Bd.test(v.type);f=v.url;v.hasContent||(v.data&&(f=v.url+=(oc.test(f)?"&":"?")+v.data,delete v.data),!1===v.cache&&(v.url=Mc.test(f)?f.replace(Mc,"$1_="+nc++):f+(oc.test(f)?
"&":"?")+"_="+nc++));v.ifModified&&(d.lastModified[f]&&A.setRequestHeader("If-Modified-Since",d.lastModified[f]),d.etag[f]&&A.setRequestHeader("If-None-Match",d.etag[f]));(v.data&&v.hasContent&&!1!==v.contentType||c.contentType)&&A.setRequestHeader("Content-Type",v.contentType);A.setRequestHeader("Accept",v.dataTypes[0]&&v.accepts[v.dataTypes[0]]?v.accepts[v.dataTypes[0]]+("*"!==v.dataTypes[0]?", "+Qc+"; q=0.01":""):v.accepts["*"]);for(g in v.headers)A.setRequestHeader(g,v.headers[g]);if(v.beforeSend&&
(!1===v.beforeSend.call(x,A,v)||2===Z))return A.abort();K="abort";for(g in{success:1,error:1,complete:1})A[g](v[g]);if(k=ca(bc,v,c,A)){A.readyState=1;r&&L.trigger("ajaxSend",[A,v]);v.async&&0<v.timeout&&(n=setTimeout(function(){A.abort("timeout")},v.timeout));try{Z=1,k.send(ra,h)}catch(q){if(!(2>Z))throw q;h(-1,q)}}else h(-1,"No Transport");return A},getScript:function(a,c){return d.get(a,b,c,"script")},getJSON:function(a,b,c){return d.get(a,b,c,"json")}});d.ajaxSetup({accepts:{script:"text/javascript, application/javascript, application/ecmascript, application/x-ecmascript"},
contents:{script:/(?:java|ecma)script/},converters:{"text script":function(a){return d.globalEval(a),a}}});d.ajaxPrefilter("script",function(a){a.cache===b&&(a.cache=!1);a.crossDomain&&(a.type="GET",a.global=!1)});d.ajaxTransport("script",function(a){if(a.crossDomain){var c,h=A.head||d("head")[0]||A.documentElement;return{send:function(b,d){c=A.createElement("script");c.async=!0;a.scriptCharset&&(c.charset=a.scriptCharset);c.src=a.url;c.onload=c.onreadystatechange=function(a,b){(b||!c.readyState||
/loaded|complete/.test(c.readyState))&&(c.onload=c.onreadystatechange=null,c.parentNode&&c.parentNode.removeChild(c),c=null,b||d(200,"success"))};h.insertBefore(c,h.firstChild)},abort:function(){c&&c.onload(b,!0)}}}});var Rc=[],pc=/(=)\?(?=&|$)|\?\?/;d.ajaxSetup({jsonp:"callback",jsonpCallback:function(){var a=Rc.pop()||d.expando+"_"+nc++;return this[a]=!0,a}});d.ajaxPrefilter("json jsonp",function(c,h,e){var g,f,p,n=!1!==c.jsonp&&(pc.test(c.url)?"url":"string"==typeof c.data&&!(c.contentType||"").indexOf("application/x-www-form-urlencoded")&&
pc.test(c.data)&&"data");return n||"jsonp"===c.dataTypes[0]?(g=c.jsonpCallback=d.isFunction(c.jsonpCallback)?c.jsonpCallback():c.jsonpCallback,n?c[n]=c[n].replace(pc,"$1"+g):!1!==c.jsonp&&(c.url+=(oc.test(c.url)?"&":"?")+c.jsonp+"="+g),c.converters["script json"]=function(){return p||d.error(g+" was not called"),p[0]},c.dataTypes[0]="json",f=a[g],a[g]=function(){p=arguments},e.always(function(){a[g]=f;c[g]&&(c.jsonpCallback=h.jsonpCallback,Rc.push(g));p&&d.isFunction(f)&&f(p[0]);p=f=b}),"script"):
b});var Db,Mb,Dd=0,qc=a.ActiveXObject&&function(){for(var a in Db)Db[a](b,!0)};d.ajaxSettings.xhr=a.ActiveXObject?function(){var b;if(!(b=!this.isLocal&&ja()))a:{try{b=new a.ActiveXObject("Microsoft.XMLHTTP");break a}catch(c){}b=void 0}return b}:ja;Mb=d.ajaxSettings.xhr();d.support.cors=!!Mb&&"withCredentials"in Mb;(Mb=d.support.ajax=!!Mb)&&d.ajaxTransport(function(c){if(!c.crossDomain||d.support.cors){var h;return{send:function(e,g){var f,p,n=c.xhr();if(c.username?n.open(c.type,c.url,c.async,c.username,
c.password):n.open(c.type,c.url,c.async),c.xhrFields)for(p in c.xhrFields)n[p]=c.xhrFields[p];c.mimeType&&n.overrideMimeType&&n.overrideMimeType(c.mimeType);c.crossDomain||e["X-Requested-With"]||(e["X-Requested-With"]="XMLHttpRequest");try{for(p in e)n.setRequestHeader(p,e[p])}catch(r){}n.send(c.hasContent&&c.data||null);h=function(a,e){var p,r,k,B;try{if(h&&(e||4===n.readyState))if(h=b,f&&(n.onreadystatechange=d.noop,qc&&delete Db[f]),e)4!==n.readyState&&n.abort();else{B={};p=n.status;r=n.getAllResponseHeaders();
"string"==typeof n.responseText&&(B.text=n.responseText);try{k=n.statusText}catch(v){k=""}p||!c.isLocal||c.crossDomain?1223===p&&(p=204):p=B.text?200:404}}catch(x){e||g(-1,x)}B&&g(p,k,B,r)};c.async?4===n.readyState?setTimeout(h):(f=++Dd,qc&&(Db||(Db={},d(a).unload(qc)),Db[f]=h),n.onreadystatechange=h):h()},abort:function(){h&&h(b,!0)}}}});var nb,$b,Ed=/^(?:toggle|show|hide)$/,Fd=RegExp("^(?:([+-])=|)("+Da+")([a-z%]*)$","i"),Gd=/queueHooks$/,Ob=[function(a,b,c){var h,e,g,f,p,n,r=this,k=a.style,B={},
v=[],x=a.nodeType&&Q(a);c.queue||(p=d._queueHooks(a,"fx"),null==p.unqueued&&(p.unqueued=0,n=p.empty.fire,p.empty.fire=function(){p.unqueued||n()}),p.unqueued++,r.always(function(){r.always(function(){p.unqueued--;d.queue(a,"fx").length||p.empty.fire()})}));1===a.nodeType&&("height"in b||"width"in b)&&(c.overflow=[k.overflow,k.overflowX,k.overflowY],"inline"===d.css(a,"display")&&"none"===d.css(a,"float")&&(d.support.inlineBlockNeedsLayout&&"inline"!==ga(a.nodeName)?k.zoom=1:k.display="inline-block"));
c.overflow&&(k.overflow="hidden",d.support.shrinkWrapBlocks||r.always(function(){k.overflow=c.overflow[0];k.overflowX=c.overflow[1];k.overflowY=c.overflow[2]}));for(e in b)if(g=b[e],Ed.exec(g))(delete b[e],h=h||"toggle"===g,g===(x?"hide":"show"))||v.push(e);if(b=v.length){g=d._data(a,"fxshow")||d._data(a,"fxshow",{});"hidden"in g&&(x=g.hidden);h&&(g.hidden=!x);x?d(a).show():r.done(function(){d(a).hide()});r.done(function(){var b;d._removeData(a,"fxshow");for(b in B)d.style(a,b,B[b])});for(e=0;b>e;e++)h=
v[e],f=r.createTween(h,x?g[h]:0),B[h]=g[h]||d.style(a,h),h in g||(g[h]=f.start,x&&(f.end=f.start,f.start="width"===h||"height"===h?1:0))}}],Fb={"*":[function(a,b){var c,h,e=this.createTween(a,b),g=Fd.exec(b),f=e.cur(),p=+f||0,n=1,r=20;if(g){if(c=+g[2],h=g[3]||(d.cssNumber[a]?"":"px"),"px"!==h&&p){p=d.css(e.elem,a,!0)||c||1;do n=n||".5",p/=n,d.style(e.elem,a,p+h);while(n!==(n=e.cur()/f)&&1!==n&&--r)}e.unit=h;e.start=p;e.end=g[1]?p+(g[1]+1)*c:c}return e}]};d.Animation=d.extend(H,{tweener:function(a,
b){d.isFunction(a)?(b=a,a=["*"]):a=a.split(" ");for(var c,h=0,e=a.length;e>h;h++)c=a[h],Fb[c]=Fb[c]||[],Fb[c].unshift(b)},prefilter:function(a,b){b?Ob.unshift(a):Ob.push(a)}});d.Tween=M;M.prototype={constructor:M,init:function(a,b,c,h,e,g){this.elem=a;this.prop=c;this.easing=e||"swing";this.options=b;this.start=this.now=this.cur();this.end=h;this.unit=g||(d.cssNumber[c]?"":"px")},cur:function(){var a=M.propHooks[this.prop];return a&&a.get?a.get(this):M.propHooks._default.get(this)},run:function(a){var b,
c=M.propHooks[this.prop];return this.pos=b=this.options.duration?d.easing[this.easing](a,this.options.duration*a,0,1,this.options.duration):a,this.now=(this.end-this.start)*b+this.start,this.options.step&&this.options.step.call(this.elem,this.now,this),c&&c.set?c.set(this):M.propHooks._default.set(this),this}};M.prototype.init.prototype=M.prototype;M.propHooks={_default:{get:function(a){var b;return null==a.elem[a.prop]||a.elem.style&&null!=a.elem.style[a.prop]?(b=d.css(a.elem,a.prop,""),b&&"auto"!==
b?b:0):a.elem[a.prop]},set:function(a){d.fx.step[a.prop]?d.fx.step[a.prop](a):a.elem.style&&(null!=a.elem.style[d.cssProps[a.prop]]||d.cssHooks[a.prop])?d.style(a.elem,a.prop,a.now+a.unit):a.elem[a.prop]=a.now}}};M.propHooks.scrollTop=M.propHooks.scrollLeft={set:function(a){a.elem.nodeType&&a.elem.parentNode&&(a.elem[a.prop]=a.now)}};d.each(["toggle","show","hide"],function(a,b){var c=d.fn[b];d.fn[b]=function(a,d,h){return null==a||"boolean"==typeof a?c.apply(this,arguments):this.animate(g(b,!0),
a,d,h)}});d.fn.extend({fadeTo:function(a,b,c,d){return this.filter(Q).css("opacity",0).show().end().animate({opacity:b},a,c,d)},animate:function(a,b,c,h){var e=d.isEmptyObject(a),g=d.speed(b,c,h),f=function(){var b=H(this,d.extend({},a),g);f.finish=function(){b.stop(!0)};(e||d._data(this,"finish"))&&b.stop(!0)};return f.finish=f,e||!1===g.queue?this.each(f):this.queue(g.queue,f)},stop:function(a,c,h){var e=function(a){var b=a.stop;delete a.stop;b(h)};return"string"!=typeof a&&(h=c,c=a,a=b),c&&!1!==
a&&this.queue(a||"fx",[]),this.each(function(){var b=!0,c=null!=a&&a+"queueHooks",g=d.timers,f=d._data(this);if(c)f[c]&&f[c].stop&&e(f[c]);else for(c in f)f[c]&&f[c].stop&&Gd.test(c)&&e(f[c]);for(c=g.length;c--;)g[c].elem!==this||null!=a&&g[c].queue!==a||(g[c].anim.stop(h),b=!1,g.splice(c,1));(b||!h)&&d.dequeue(this,a)})},finish:function(a){return!1!==a&&(a=a||"fx"),this.each(function(){var b,c=d._data(this),h=c[a+"queue"];b=c[a+"queueHooks"];var e=d.timers,g=h?h.length:0;c.finish=!0;d.queue(this,
a,[]);b&&b.cur&&b.cur.finish&&b.cur.finish.call(this);for(b=e.length;b--;)e[b].elem===this&&e[b].queue===a&&(e[b].anim.stop(!0),e.splice(b,1));for(b=0;g>b;b++)h[b]&&h[b].finish&&h[b].finish.call(this);delete c.finish})}});d.each({slideDown:g("show"),slideUp:g("hide"),slideToggle:g("toggle"),fadeIn:{opacity:"show"},fadeOut:{opacity:"hide"},fadeToggle:{opacity:"toggle"}},function(a,b){d.fn[a]=function(a,c,d){return this.animate(b,a,c,d)}});d.speed=function(a,b,c){var h=a&&"object"==typeof a?d.extend({},
a):{complete:c||!c&&b||d.isFunction(a)&&a,duration:a,easing:c&&b||b&&!d.isFunction(b)&&b};return h.duration=d.fx.off?0:"number"==typeof h.duration?h.duration:h.duration in d.fx.speeds?d.fx.speeds[h.duration]:d.fx.speeds._default,(null==h.queue||!0===h.queue)&&(h.queue="fx"),h.old=h.complete,h.complete=function(){d.isFunction(h.old)&&h.old.call(this);h.queue&&d.dequeue(this,h.queue)},h};d.easing={linear:function(a){return a},swing:function(a){return 0.5-Math.cos(a*Math.PI)/2}};d.timers=[];d.fx=M.prototype.init;
d.fx.tick=function(){var a,c=d.timers,h=0;for(nb=d.now();c.length>h;h++)a=c[h],a()||c[h]!==a||c.splice(h--,1);c.length||d.fx.stop();nb=b};d.fx.timer=function(a){a()&&d.timers.push(a)&&d.fx.start()};d.fx.interval=13;d.fx.start=function(){$b||($b=setInterval(d.fx.tick,d.fx.interval))};d.fx.stop=function(){clearInterval($b);$b=null};d.fx.speeds={slow:600,fast:200,_default:400};d.fx.step={};d.expr&&d.expr.filters&&(d.expr.filters.animated=function(a){return d.grep(d.timers,function(b){return a===b.elem}).length});
d.fn.offset=function(a){if(arguments.length)return a===b?this:this.each(function(b){d.offset.setOffset(this,a,b)});var c,h,e={top:0,left:0},g=this[0],f=g&&g.ownerDocument;if(f)return c=f.documentElement,d.contains(c,g)?(typeof g.getBoundingClientRect!==L&&(e=g.getBoundingClientRect()),h=x(f),{top:e.top+(h.pageYOffset||c.scrollTop)-(c.clientTop||0),left:e.left+(h.pageXOffset||c.scrollLeft)-(c.clientLeft||0)}):e};d.offset={setOffset:function(a,b,c){var h=d.css(a,"position");"static"===h&&(a.style.position=
"relative");var e=d(a),g=e.offset(),f=d.css(a,"top"),p=d.css(a,"left"),n={},r={},k,B;("absolute"===h||"fixed"===h)&&-1<d.inArray("auto",[f,p])?(r=e.position(),k=r.top,B=r.left):(k=parseFloat(f)||0,B=parseFloat(p)||0);d.isFunction(b)&&(b=b.call(a,c,g));null!=b.top&&(n.top=b.top-g.top+k);null!=b.left&&(n.left=b.left-g.left+B);"using"in b?b.using.call(a,n):e.css(n)}};d.fn.extend({position:function(){if(this[0]){var a,b,c={top:0,left:0},h=this[0];return"fixed"===d.css(h,"position")?b=h.getBoundingClientRect():
(a=this.offsetParent(),b=this.offset(),d.nodeName(a[0],"html")||(c=a.offset()),c.top+=d.css(a[0],"borderTopWidth",!0),c.left+=d.css(a[0],"borderLeftWidth",!0)),{top:b.top-c.top-d.css(h,"marginTop",!0),left:b.left-c.left-d.css(h,"marginLeft",!0)}}},offsetParent:function(){return this.map(function(){for(var a=this.offsetParent||A.documentElement;a&&!d.nodeName(a,"html")&&"static"===d.css(a,"position");)a=a.offsetParent;return a||A.documentElement})}});d.each({scrollLeft:"pageXOffset",scrollTop:"pageYOffset"},
function(a,c){var h=/Y/.test(c);d.fn[a]=function(e){return d.access(this,function(a,e,g){var f=x(a);return g===b?f?c in f?f[c]:f.document.documentElement[e]:a[e]:(f?f.scrollTo(h?d(f).scrollLeft():g,h?g:d(f).scrollTop()):a[e]=g,b)},a,e,arguments.length,null)}});d.each({Height:"height",Width:"width"},function(a,c){d.each({padding:"inner"+a,content:c,"":"outer"+a},function(h,e){d.fn[e]=function(e,g){var f=arguments.length&&(h||"boolean"!=typeof e),p=h||(!0===e||!0===g?"margin":"border");return d.access(this,
function(c,h,e){var g;return d.isWindow(c)?c.document.documentElement["client"+a]:9===c.nodeType?(g=c.documentElement,Math.max(c.body["scroll"+a],g["scroll"+a],c.body["offset"+a],g["offset"+a],g["client"+a])):e===b?d.css(c,h,p):d.style(c,h,e,p)},c,f?e:b,f,null)}})});a.jQuery=a.$=d;"function"==typeof define&&define.amd&&define.amd.jQuery&&define("jquery",[],function(){return d})})(window);$.fn.top=function(){var a;a=Math.floor(parseFloat(this.css("top"))||this.position().top);return isNaN(a)?0:a};
...
a.outerWidth(),g=a.outerHeight(),f=c.outerHeight(),k=a[0].ownerDocument,x=k.documentElement,m=x.clientWidth+b(k).scrollLeft(),k=x.clientHeight+b(k).scrollTop(),x=c.offset();x.top+=f;x.left-=Math.min(x.left,x.left+e>m&&m>e?Math.abs(x.left+e-m):0);x.top-=Math.min(x.top,x.top+g>k&&k>g?Math.abs(g+f-0):0);return x}function q(){}function u(a){a.stopPropagation()}function l(a,b){var c=Array.prototype.slice,e=c.call(arguments,2);return function(){return a.apply(b,e.concat(c.call(arguments)))}}function s(c,
e,g,f){function k(a){a.stopPropagation&&a.stopPropagation();a.preventDefault&&a.preventDefault();a.returnValue=!1}function x(a){if(s){if(T&&9>document.documentMode&&!a.button)return m();var b=a.originalEvent.touches,d=b?b[0].pageY:a.pageY,b=Math.max(0,Math.min((b?b[0].pageX:a.pageX)-w.left,D)),d=Math.max(0,Math.min(d-w.top,q));v&&k(a);e.apply(c,[b,d,a])}}function m(){s&&(b(l).unbind(Z),b(l.body).removeClass("sp-dragging"),f.apply(c,arguments));s=!1}e=e||function(){};g=g||function(){};f=f||function(){};
...
0;d<jb.length;d++)for(var e=0;e<jb[d].length;e++)h=tinycolor(jb[d][e]).toRgbString(),c[h]=!0;for(d=0;d<b.length;d++)h=tinycolor(b[d]).toRgbString(),c.hasOwnProperty(h)||(a.push(b[d]),c[h]=!0)}return a.reverse().slice(0,E.maxSelectionSize)},m=function(){var a=W(),c=b.map(jb,function(b,c){return e(b,a,"sp-palette-row sp-palette-row-"+c)});Ga&&c.push(e(L(),a,"sp-palette-row sp-palette-row-selection"));Rb.html(c.join(""))},w=function(){if(E.showInitial){var a=Va,b=W();Ib.html(e([a,b],b,"sp-palette-row-initial"))}},
A=function(){(0===ia||0===da||0===na)&&J();p.addClass(wa)},q=function(){p.removeClass(wa)},v=function(){var a=tinycolor(Na.val());a.ok?d(a):Na.addClass("sp-validation-error")},Z=function(){ea?D():K()},K=function(){if(ea)J();else if(!1!==G.beforeShow(W())){for(var c=0;c<U.length;c++)U[c]&&U[c].hide();ea=!0;b(xa).bind("click.spectrum",D);b(a).bind("resize.spectrum",Q);Aa.addClass("sp-active");p.show();E.showPalette&&m();J();F();Va=W();w();G.show(Va)}},D=function(c){if((!c||!("click"==c.type&&2==c.button))&&
ea&&!O)ea=!1,b(xa).unbind("click.spectrum",D),b(a).unbind("resize.spectrum",Q),Aa.removeClass("sp-active"),p.hide(),tinycolor.equals(W(),Va)||(wb&&"cancel"!==c?H(!0):d(Va,!0)),G.hide(W())},d=function(a,b){if(!tinycolor.equals(a,W())){var c=tinycolor(a),h=c.toHsv();la=h.h;Ma=h.s;qa=h.v;N=h.a;F();b||(Ua=La||c.format)}},W=function(){return tinycolor.fromRatio({h:la,s:Ma,v:qa,a:Math.round(100*N)/100})},P=function(){F();G.move(W())},F=function(){Na.removeClass("sp-validation-error");Y();var a=tinycolor({h:la,
...
a.keyCode&&v()});Jb.text(E.cancelText);Jb.bind("click.spectrum",function(a){a.stopPropagation();a.preventDefault();D("cancel")});sb.text(E.chooseText);sb.bind("click.spectrum",function(a){a.stopPropagation();a.preventDefault();Na.hasClass("sp-validation-error")||(H(!0),D())});s(qb,function(a,b,c){N=a/oa;c.shiftKey&&(N=Math.round(10*N)/10);P()});s(Ta,function(a,b){la=parseFloat(b/na);P()},A,q);s(B,function(a,b){Ma=parseFloat(a/da);qa=parseFloat((ia-b)/ia);P()},A,q);yb?(d(yb),F(),Ua=La||tinycolor(yb).format,
x(yb)):F();O&&K();A=T?"mousedown.spectrum":"click.spectrum touchstart.spectrum";Rb.delegate(".sp-thumb-el",A,X);Ib.delegate(".sp-thumb-el:nth-child(1)",A,{ignore:!0},X);var bb={show:K,hide:D,toggle:Z,reflow:J,option:function(a,h){if(a===c)return b.extend({},E);if(h===c)return E[a];E[a]=h;k()},enable:function(){h=!1;va.attr("disabled",!1);aa.removeClass("sp-disabled")},disable:r,set:function(a){d(a);H()},get:W,destroy:function(){va.show();aa.unbind("click.spectrum touchstart.spectrum");p.remove();
...
m(255,ca(q,0));u=m(255,ca(u,0));1>s&&(s=P(s));1>q&&(q=P(q));1>u&&(u=P(u));b=F;c=c&&c.format||z;e=s;f=q;l=u;var v=ja(a);return{ok:b,format:c,_tc_id:ga++,alpha:v,toHsv:function(){var a=I(e,f,l);return{h:a.h,s:a.s,v:a.v,a:v}},toHsvString:function(){var a=I(e,f,l),b=P(360*a.h),c=P(100*a.s),a=P(100*a.v);return 1==v?"hsv("+b+", "+c+"%, "+a+"%)":"hsva("+b+", "+c+"%, "+a+"%, "+v+")"},toHsl:function(){var a=X(e,f,l);return{h:a.h,s:a.s,l:a.l,a:v}},toHslString:function(){var a=X(e,f,l),b=P(360*a.h),c=P(100*
a.s),a=P(100*a.l);return 1==v?"hsl("+b+", "+c+"%, "+a+"%)":"hsla("+b+", "+c+"%, "+a+"%, "+v+")"},toHex:function(){return Q(e,f,l)},toHexString:function(a){return"#"+Q(e,f,l,a)},toRgb:function(){return{r:P(e),g:P(f),b:P(l),a:v}},toRgbString:function(){return 1==v?"rgb("+P(e)+", "+P(f)+", "+P(l)+")":"rgba("+P(e)+", "+P(f)+", "+P(l)+", "+v+")"},toName:function(){return g[Q(e,f,l)]||!1},toFilter:function(a,b){var c=Q(e,f,l,!0),d=c,g=Math.round(255*ja(v)).toString(16),n=g,r=a&&a.gradientType?"GradientType = 1, ":
"";b&&(n=w(b),d=n.toHex(),n=Math.round(255*ja(n.alpha)).toString(16));return"progid:DXImageTransform.Microsoft.gradient("+r+"startColorstr=#"+k(g)+c+",endColorstr=#"+k(n)+d+")"},toString:function(a){a=a||this.format;var b=!1;"rgb"===a&&(b=this.toRgbString());"hex"===a&&(b=this.toHexString());"hex6"===a&&(b=this.toHexString(!0));"name"===a&&(b=this.toName());"hsl"===a&&(b=this.toHslString());"hsv"===a&&(b=this.toHsvString());return b||this.toHexString(!0)}}},X=function(a,b,c){a=J(a,255);b=J(b,255);
...
s(z.paragraph)("(?!","(?!"+z.gfm.fences.source.replace(/(^|[^\[])\^/g,"$2")+"|")();z.lexer=function(a){var b=[];b.links={};a=a.replace(/\r\n|\r/g,"\n").replace(/\t/g,"    ");return z.token(a,b,!0)};z.token=function(a,b,c){a=a.replace(/^ +$/gm,"");for(var e,f,m,l,s,q;a;){if(m=z.newline.exec(a))a=a.substring(m[0].length),1<m[0].length&&b.push({type:"space"});if(m=z.code.exec(a))a=a.substring(m[0].length),m=m[0].replace(/^ {4}/gm,""),b.push({type:"code",text:!Q.pedantic?m.replace(/\n+$/,""):m});else if(m=
...
b,c),b.push({type:"blockquote_end"});else if(m=z.list.exec(a)){a=a.substring(m[0].length);b.push({type:"list_start",ordered:isFinite(m[2])});m=m[0].match(z.item);e=!1;q=m.length;for(s=0;s<q;s++)l=m[s],f=l.length,l=l.replace(/^ *([*+-]|\d+\.) +/,""),~l.indexOf("\n ")&&(f-=l.length,l=!Q.pedantic?l.replace(RegExp("^ {1,"+f+"}","gm"),""):l.replace(/^ {1,4}/gm,"")),f=e||/\n\n(?!\s*$)/.test(l),s!==q-1&&(e="\n"===l[l.length-1],f||(f=e)),b.push({type:f?"loose_item_start":"list_item_start"}),z.token(l,b),
...
function natural_sort(a,b){var c=/(^-?[0-9]+(\.?[0-9]*)[df]?e?[0-9]?$|^0x[0-9a-f]+$|[0-9]+)/gi,e=/(^[ ]*|[ ]*$)/g,f=/(^([\w ]+,?[\w ]+)?[\w ]+,?[\w ]+\d+:\d+(:\d+)?[\w ]?|^\d{1,4}[\/\-]\d{1,4}[\/\-]\d{1,4}|^\w+, \w+ \d+, \d{4})/,q=/^0x[0-9a-f]+$/i,u=/^0/,l=(natural_sort.insensitive&&(""+a).toLowerCase()||""+a).replace(e,"")||"",s=(natural_sort.insensitive&&(""+b).toLowerCase()||""+b).replace(e,"")||"",e=l.replace(c,"\x00$1\x00").replace(/\0$/,"").replace(/^\0/,"").split("\x00"),c=s.replace(c,"\x00$1\x00").replace(/\0$/,
"").replace(/^\0/,"").split("\x00"),l=parseInt(l.match(q))||1!=e.length&&l.match(f)&&Date.parse(l);if(f=parseInt(s.match(q))||l&&s.match(f)&&Date.parse(s)||null){if(l<f)return-1;if(l>f)return 1}l=0;for(s=Math.max(e.length,c.length);l<s;l++){f=!(e[l]||"").match(u)&&parseFloat(e[l])||e[l]||0;q=!(c[l]||"").match(u)&&parseFloat(c[l])||c[l]||0;if(isNaN(f)!==isNaN(q))return isNaN(f)?1:-1;typeof f!==typeof q&&(f+="",q+="");if(f<q)return-1;if(f>q)return 1}return 0}
(function(){var a={},b=window,c=b.document,e;a.disabled=!1;a.set=function(){};a.get=function(){};a.remove=function(){};a.clear=function(){};a.transact=function(b,c,e){var f=a.get(b);null==e&&(e=c,c=null);"undefined"==typeof f&&(f=c||{});e(f);a.set(b,f)};a.getAll=function(){};a.serialize=function(a){return JSON.stringify(a)};a.deserialize=function(a){return"string"!=typeof a?void 0:JSON.parse(a)};var f;try{f="localStorage"in b&&b.localStorage}catch(q){f=!1}if(f)e=b.localStorage,a.set=function(b,c){if(void 0===
...
e[b].value)},a.remove=function(a){delete e[a]},a.clear=function(){for(var a in e)delete e[a]},a.getAll=function(){for(var b={},c=0;c<e.length;++c){var f=e.key(c);b[f]=a.get(f)}return b};else if(c.documentElement.addBehavior){var s,S;try{S=new ActiveXObject("htmlfile"),S.open(),S.write('<script>document.w=window\x3c/script><iframe src="/favicon.ico"></frame>'),S.close(),s=S.w.frames[0].document,e=s.createElement("div")}catch(U){e=c.createElement("div"),s=c.body}var b=function(b){return function(){var c=
Array.prototype.slice.call(arguments,0);c.unshift(e);s.appendChild(e);e.addBehavior("#default#userData");e.load("localStorage");c=b.apply(a,c);s.removeChild(e);return c}},T=/[!"#$%&'()*+,/\\:;<=>?@[\]^`{|}~]/g;a.set=b(function(b,c,e){c=c.replace(T,"___");if(void 0===e)return a.remove(c);b.setAttribute(c,a.serialize(e));b.save("localStorage")});a.get=b(function(b,c){c=c.replace(T,"___");return a.deserialize(b.getAttribute(c))});a.remove=b(function(a,b){b=b.replace(T,"___");a.removeAttribute(b);a.save("localStorage")});
...
a.replace(k,function(a){var b=m[a];return"string"===typeof b?b:"\\u"+("0000"+a.charCodeAt(0).toString(16)).slice(-4)})+'"':'"'+a+'"'}function e(a,b){var h,f,p,g,k=v,m,s=b[a];s instanceof Date&&(s=isFinite(a.valueOf())?a.getUTCFullYear()+"-"+c(a.getUTCMonth()+1)+"-"+c(a.getUTCDate())+"T"+c(a.getUTCHours())+":"+c(a.getUTCMinutes())+":"+c(a.getUTCSeconds())+"Z":null);"function"===typeof n&&(s=n.call(b,a,s));switch(typeof s){case "string":return d(s);case "number":return isFinite(s)?String(s):"null";
case "boolean":case "null":return String(s);case "object":if(!s)return"null";v+=l;m=[];if("[object Array]"===Object.prototype.toString.apply(s)){g=s.length;for(h=0;h<g;h+=1)m[h]=e(h,s)||"null";p=0===m.length?"[]":v?"[\n"+v+m.join(",\n"+v)+"\n"+k+"]":"["+m.join(",")+"]";v=k;return p}if(n&&"object"===typeof n){g=n.length;for(h=0;h<g;h+=1)"string"===typeof n[h]&&(f=n[h],(p=e(f,s))&&m.push(d(f)+(v?": ":":")+p))}else for(f in s)Object.prototype.hasOwnProperty.call(s,f)&&(p=e(f,s))&&m.push(d(f)+(v?": ":
...
Xa=function(a,b,c,d){if(!G.ie||!G.mac){var e=K.getElementsByTagName("head")[0];if(e){c=c&&"string"==typeof c?c:"screen";d&&(Hb=Ja=null);if(!Ja||Hb!=c)d=K.createElement("style"),d.setAttribute("type","text/css"),d.setAttribute("media",c),Ja=e.appendChild(d),G.ie&&(G.win&&typeof K.styleSheets!=ha&&0<K.styleSheets.length)&&(Ja=K.styleSheets[K.styleSheets.length-1]),Hb=c;G.ie&&G.win?Ja&&typeof Ja.addRule==ta&&Ja.addRule(a,b):Ja&&typeof K.createTextNode!=ha&&Ja.appendChild(K.createTextNode(a+" {"+b+"}"))}}},
sa=function(a,b){if(Qb){var c=b?"visible":"hidden";Qa&&fa(a)?fa(a).style.visibility=c:Xa("#"+a,"visibility:"+c)}},Ca=function(a){return null!=/[\\\"<>\.;]/.exec(a)&&typeof encodeURIComponent!=ha?encodeURIComponent(a):a},ha="undefined",ta="object",ka="application/x-shockwave-flash",v="SWFObjectExprInst",Z=window,K=document;s=navigator;var Ya=!1,d=[function(){if(Ya){var a=K.getElementsByTagName("body")[0],b=K.createElement(ta);b.setAttribute("type",ka);var c=a.appendChild(b);if(c){var d=0;(function(){if(typeof c.GetVariable!=
ha){var e=c.GetVariable("$version");e&&(e=e.split(" ")[1].split(","),G.pv=[parseInt(e[0],10),parseInt(e[1],10),parseInt(e[2],10)])}else if(10>d){d++;setTimeout(arguments.callee,10);return}a.removeChild(b);c=null;H()})()}else H()}else H()}],Da=[],Ba=[],Za=[],gb,hb,Gb,Pb,Qa=!1,ob=!1,Ja,Hb,Qb=!0,G,S=typeof K.getElementById!=ha&&typeof K.getElementsByTagName!=ha&&typeof K.createElement!=ha,Ra=s.userAgent.toLowerCase(),Sa=s.platform.toLowerCase(),cc=Sa?/win/.test(Sa):/win/.test(Ra),Sa=Sa?/mac/.test(Sa):
...
case "Z":case "ZZ":return r;case "T":return L;case "MM":case "DD":case "YY":case "HH":case "hh":case "mm":case "ss":case "M":case "D":case "d":case "H":case "h":case "m":case "s":return H;default:return RegExp(a.replace("\\",""))}}function w(a,b){var c=[0,0,1,0,0,0,0],e={tzh:0,tzm:0},d=b.match(O),f,g;for(f=0;f<d.length;f++)if((g=(E(d[f]).exec(a)||[])[0])&&(a=a.slice(a.indexOf(g)+g.length)),ka[d[f]]){var k=c,l=e,m=void 0,s=void 0;switch(d[f]){case "M":case "MM":k[1]=null==g?0:~~g-1;break;case "MMM":case "MMMM":for(m=
...
c){if(null===b||""===b)return null;var e;if(k.isMoment(b))e=new f(new Date(+b._d),b._isUTC,b._lang);else{if(c)if(S(c)){var g=b.match(ea)||[],d,l=99,m,s;for(m=0;m<c.length;m++)s=w(b,c[m]),d=V(new f(s),c[m]).match(ea)||[],d=U(g,d),d<l&&(l=d,e=s)}else e=w(b,c);else if(e=ca.exec(b),b===a)e=new Date;else if(e)e=new Date(+e[1]);else if(b instanceof Date)e=b;else if(S(b))e=T(b);else if("string"==typeof b)if(e="YYYY-MM-DDT",A.exec(b)){for(g=0;4>g;g++)if(fa[g][1].exec(b)){e+=fa[g][0];break}e=r.exec(b)?w(b,
e+" Z"):w(b,e)}else e=new Date(b);else e=new Date(b);e=new f(e)}return e};k.utc=function(a,b){return S(a)?new f(T(a,!0),!0):("string"==typeof a&&!r.exec(a)&&(a+=" +0000",b&&(b+=" Z")),k(a,b).utc())};k.unix=function(a){return k(1E3*a)};k.duration=function(a,b){var c=k.isDuration(a),e="number"==typeof a,d=c?a._data:e?{}:a,f;return e&&(b?d[b]=a:d.milliseconds=a),f=new q(d),c&&(f._lang=a._lang),f};k.humanizeDuration=function(a,b,c){return k.duration(a,!0===b?null:b).humanize(!0===b?!0:c)};k.version="1.7.2";
...
32;a[(b+64>>9<<4)+15]=b;for(k=0;k<a.length;k+=16){u=l[0];V=l[1];E=l[2];w=l[3];X=l[4];I=l[5];Q=l[6];J=l[7];for(D=0;64>D;D++)q[D]=16>D?a[D+k]:c(c(c(e(q[D-2],17)^e(q[D-2],19)^q[D-2]>>>10,q[D-7]),e(q[D-15],7)^e(q[D-15],18)^q[D-15]>>>3),q[D-16]),Y=c(c(c(c(J,e(X,6)^e(X,11)^e(X,25)),X&I^~X&Q),f[D]),q[D]),ga=c(e(u,2)^e(u,13)^e(u,22),u&V^u&E^V&E),J=Q,Q=I,I=X,X=c(w,Y),w=E,E=V,V=u,u=c(Y,ga);l[0]=c(u,l[0]);l[1]=c(V,l[1]);l[2]=c(E,l[2]);l[3]=c(w,l[3]);l[4]=c(X,l[4]);l[5]=c(I,l[5]);l[6]=c(Q,l[6]);l[7]=c(J,l[7])}return l},
q=function(a){for(var c=[],e=(1<<b)-1,f=0;f<a.length*b;f+=b)c[f>>5]|=(a.charCodeAt(f/b)&e)<<24-f%32;return c},u=function(a){for(var b="",c=0;c<4*a.length;c++)b+="0123456789abcdef".charAt(a[c>>2]>>8*(3-c%4)+4&15)+"0123456789abcdef".charAt(a[c>>2]>>8*(3-c%4)&15);return b},l=function(b){return b="object"==typeof b?a(b).val():b.toString()};a.extend({sha256:function(a){a=l(a);return u(f(q(a),a.length*b))},sha256hmac:function(a,c){a=l(a);c=l(c);var e,T=a;e=c;var z=q(T);16<z.length&&(z=f(z,T.length*b));
for(var F=Array(16),T=Array(16),V=0;16>V;V++)F[V]=z[V]^909522486,T[V]=z[V]^1549556828;e=f(F.concat(q(e)),512+e.length*b);e=f(T.concat(e),768);return u(e)},sha256config:function(a){b=parseInt(a)||8}});a.fn.sha256=function(b){a.sha256config(b);b=l(a(this).val());b=a.sha256(b);a.sha256config(8);return b}})(jQuery);
...
Scrap.prototype.loop=function(a){if(!this.values.loop||!this.values.scraps)return null;var b=this.values.scraps.toString(),c=this.values.loop;"string"===typeof c&&c.match(/\{\{/)&&(c=Scrap.getPointer(c.replace(/\{|\}/g,""),a));"string"===typeof c&&(c=this.values.loop.split(/ /g));if(!c)return null;c instanceof Space||(c=new Space(c));var e="";c.each(function(c,q){var u={key:c,value:q},l=b.replace(/\{\{([_a-z0-9\.]+)\}\}/gi,function(b,c){var e;return(e=Scrap.getPointer(c,u))?e:Scrap.getPointer(c,a)});
...
(function(a){function b(a){a=String(a);return a.charAt(0).toUpperCase()+a.slice(1)}function c(a){a=s(a);return/^(?:webOS|i(?:OS|P))/.test(a)?a:b(a)}function e(a,b){for(var c in a)q(a,c)&&b(a[c],c,a)}function f(a){return null==a?b(a):V.call(a).slice(8,-1)}function q(){q=function(a,b){var c=null!=a&&(a.constructor||Object).prototype;return!!c&&b in Object(a)&&!(b in c&&a[b]===c[b])};"Function"==f(Q)?q=function(a,b){return null!=a&&Q.call(a,b)}:{}.__proto__==Object.prototype&&(q=function(a,b){var c=
!1;null!=a&&(a=Object(a),a.__proto__=[a.__proto__,a.__proto__=null,c=b in a][0]);return c});return q.apply(this,arguments)}function u(a){return String(a).replace(/([ -])(?!$)/g,"$1?")}function l(a,b){var c=null,f=function(e,f){c=b(c,e,f,a)},k=-1,l=a.length;if(l==l>>>0)for(;++k<l;)f(a[k],k,a);else e(a,f);return c}function s(a){return String(a).replace(/^ +| +$/g,"")}function S(b){function q(a){return l(a,function(a,e){var f=e.pattern||u(e);if(!a&&(a=RegExp("\\b"+f+" *\\d+[.\\w_]*","i").exec(b)||RegExp("\\b"+
...
function(a){a.stopPropagation()});var q=$('<div id="nudgepadEditorSaveButton">Send</div>'),u=$('<div id="nudgepadEditorCancelButton">Close</div>'),l=$('<div id="nudgepadEditorButtonContainer"></div>');f.on("click",function(){u.trigger("click")});u.on("click",function(){q.remove();a.remove();f.remove();l.remove();u.remove();e.remove();c.remove();b.remove()});q.on("click",function(){var e=b.val(),f="nudgepad.console";c.is(":checked")&&(f="nudgepad.exec");$.post(f,{command:e},function(c){a.append(">"+
e.replace(/\n/g,"> \n")+"\n");a.append(c+"\n");a.scrollTop($("pre")[0].scrollHeight+"");b.val("");b.focus()},null,function(c){mixpanel.track("I used the console and got an error");a.append(">"+e.replace(/\n/g,"> \n")+"\n");a.append("ERROR\n");a.append(c.responseText+"\n");a.scrollTop($("pre")[0].scrollHeight+"");b.val("");b.focus()})});b.on("enterkey",function(){q.click()});$("body").append(f);$("body").append(c);$("body").append(e);$("body").append(a);$("body").append(b);$("body").append(q);$("body").append(u);
$("body").append(l);b.focus()};nudgepad.contentEditor={};nudgepad.contentEditor.onblur=function(){$(this).scrap().set("content",$(this).html());$(this).off("tap mousedown slide slidestart hold slideend",nudgepad.contentEditor.killEvent);$(this).removeAttr("contenteditable");nudgepad.stage.commit();nudgepad.broadcastSelection()};
nudgepad.contentEditor.focus=function(a,b){nudgepad.stage.selection.clear();var c=$(a),e=c.scrap();if(e.isContentEditable())nudgepad.broadcastSelection(e.selector()),c.attr("contenteditable","true"),c.on("tap slide slidestart hold slideend",nudgepad.contentEditor.killEvent),c.on("blur",nudgepad.contentEditor.onblur),c.focus(),MoveCursorToEnd(c[0]),b&&document.execCommand("selectAll",!1,null);else{var f="content",q=e.values.tag;if(q&&q.match(/^(list)$/))return nudgepad.stage.selection.clear(),c.selectMe(),
nudgepad.stage.selection.editSource(),!1;q&&q.match(/^(textarea|input|password)$/)&&(f="placeholder");nudgepad.textPrompt("Editing content for this block",e.values[f],function(a){e.values[f]=a;nudgepad.stage.commit();c.remove();$("#nudgepadStageBody").append(e.toHtml(null,!0));c.selectMe()})}};nudgepad.contentEditor.killEvent=function(){nudgepad.mouse.down.stopPropagation();return!1};nudgepad.apps.develop=new App("develop");nudgepad.apps.develop.files="";nudgepad.apps.develop.log="";
...
q.selector&&(this.context.lineWidth=0.5,q.x in c||(this.context.beginPath(),this.context.moveTo(q.x+0.5,0),this.context.lineTo(q.x+0.5,b),this.context.closePath(),this.context.stroke(),c[q.x]=!0),q.y in e||(this.context.beginPath(),this.context.moveTo(0,q.y+0.5),this.context.lineTo(a,q.y+0.5),this.context.closePath(),this.context.stroke(),e[q.y]=!0))}};
...
Grid.prototype.getDelta=function(a){this.eraseSnaplines();var b={},c=[],e=[],f;for(f in a){var q=a[f],u;for(u in this.points)if(this.points.hasOwnProperty(u)){var l=this.points[u],s=l.x-q.x,S=l.y-q.y;b.x||(b.x=s,b.y=S);Math.abs(s)<=Math.abs(b.x)&&(b.x=s,c=[q,l]);Math.abs(S)<=Math.abs(b.y)&&(b.y=S,e=[q,l])}}a=Math.abs(b.x)<this.radius;f=Math.abs(b.y)<this.radius;a||(b.x=0);f||(b.y=0);a&&(c[0]={x:c[0].x+b.x,y:c[0].y+b.y},this.drawSnapline(c[0],c[1]));f&&(e[0]={x:e[0].x+b.x,y:e[0].y+b.y},this.drawSnapline(e[0],
...
nudgepad.MoveHandle.slide=function(a,b){var c=$(this).owner();c.scrap();var e=nudgepad.MoveHandle.dimensions,f=nudgepad.stage.scrollTop()-nudgepad.MoveHandle.scrollTop,q={y:0,x:0};b.shiftKey||(q=nudgepad.grid.getDelta([{x:e.left+nudgepad.mouse.xChange,y:e.top+nudgepad.mouse.yChange+f},{x:e.right+nudgepad.mouse.xChange,y:e.bottom+nudgepad.mouse.yChange+f},{x:e.center+nudgepad.mouse.xChange,y:e.middle+nudgepad.mouse.yChange+f}]));var u=nudgepad.mouse.yChange+f+q.y,l=nudgepad.mouse.xChange+q.x;$(".selection").each(function(){$(this).scrap().move(l-
nudgepad.MoveHandle.last_x_change,u-nudgepad.MoveHandle.last_y_change)});e="X "+parseFloat(c.css("left"))+"<br>Y "+parseFloat(c.css("top"));$("#nudgepadDimensions").css({left:10+c.offset().left+c.outerWidth(),top:-10+c.offset().top+Math.round(c.outerHeight(!0)/2)}).html(e);nudgepad.MoveHandle.last_x_change=l;nudgepad.MoveHandle.last_y_change=u;return!1};nudgepad.MoveHandle.slideend=function(){$(".handle").trigger("update").show();nudgepad.grid.removeSnaplines();$("#nudgepadDimensions").hide();nudgepad.stage.commit()};
...
nudgepad.MoveHandle.update=function(){var a=$(this).owner(),b=Math.min(10,a.outerHeight(!0)-20),c=Math.min(10,a.outerWidth()-20),a={left:a.left()+c+"px",top:a.top()+b+"px",height:a.outerHeight(!0)-2*b+"px",width:a.outerWidth()-2*c+"px"};$(this).css(a)};nudgepad.navigation={};
...
nudgepad.StretchHandle.slide=function(){var a=$(this).owner(),b=$(this).data().row,c=$(this).data().column,e=$(this).data().fixed,f,q;f="left"===c?nudgepad.StretchHandle.dimensions.right:"right"===c?nudgepad.StretchHandle.dimensions.left:nudgepad.StretchHandle.dimensions.center;q="top"===b?nudgepad.StretchHandle.dimensions.bottom:"bottom"===b?nudgepad.StretchHandle.dimensions.top:nudgepad.StretchHandle.dimensions.middle;var u=nudgepad.mouse.move.pageX-$(this).parent().offset().left,l=nudgepad.mouse.move.pageY-
$(this).parent().offset().top,l=nudgepad.StretchHandle.getLength(f,q,u,l,"center"!=c,"middle"!=b),u=a.scrap();"center"!=c&&(u.set("style left",(0<=l.x?f:l.x+f)+"px"),c=a.outerWidth()-a.width(),u.set("style width",Math.abs(l.x)-c+"px"));e?(b=parseFloat(u.get("style width"))/nudgepad.StretchHandle.originalWidth,u.set("style height",Math.round(nudgepad.StretchHandle.originalHeight*b)+"px")):"middle"!=b&&(0<=l.y?u.set("style top",q+"px"):u.set("style top",l.y+q+"px"),b=a.outerHeight(!0)-a.height(),u.set("style height",
Math.abs(l.y)-b+"px"));a.css(u.values.style.values);b="W "+parseFloat(a.css("width"))+"<br> H "+parseFloat(a.css("height"));$("#nudgepadDimensions").css({left:10+a.offset().left+a.outerWidth(),top:-10+a.offset().top+Math.round(a.outerHeight(!0)/2)}).html(b);$(".stretch_handle_"+u.id).trigger("update");return!1};
