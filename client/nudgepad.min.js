...
d.extend({},h.data))}}function s(g,a){var t,x,c=0,h=typeof g.getElementsByTagName!==A?g.getElementsByTagName(a||"*"):typeof g.querySelectorAll!==A?g.querySelectorAll(a||"*"):b;if(!h){h=[];for(t=g.childNodes||g;null!=(x=t[c]);c++)!a||d.nodeName(x,a)?h.push(x):d.merge(h,s(x,a))}return a===b||a&&d.nodeName(g,a)?d.merge([g],h):h}function U(g){cc.test(g.type)&&(g.defaultChecked=g.checked)}function K(g,a){if(a in g)return a;for(var b=a.charAt(0).toUpperCase()+a.slice(1),d=a,c=uc.length;c--;)if(a=uc[c]+
b,a in g)return a;return d}function V(g,a){return g=a||g,"none"===d.css(g,"display")||!d.contains(g.ownerDocument,g)}function I(g,a){for(var b,x,c,h=[],e=0,m=g.length;m>e;e++)x=g[e],x.style&&(h[e]=d._data(x,"olddisplay"),b=x.style.display,a?(h[e]||"none"!==b||(x.style.display=""),""===x.style.display&&V(x)&&(h[e]=d._data(x,"olddisplay",ca(x.nodeName)))):h[e]||(c=V(x),(b&&"none"!==b||!c)&&d._data(x,"olddisplay",c?b:d.css(x,"display"))));for(e=0;m>e;e++)x=g[e],x.style&&(a&&"none"!==x.style.display&&
""!==x.style.display||(x.style.display=a?h[e]||"":"none"));return g}function j(g,a,b){return(g=Wc.exec(a))?Math.max(0,g[1]-(b||0))+(g[2]||"px"):a}function C(g,a,b,x,c){a=b===(x?"border":"content")?4:"width"===a?1:0;for(var h=0;4>a;a+=2)"margin"===b&&(h+=d.css(g,b+gb[a],!0,c)),x?("content"===b&&(h-=d.css(g,"padding"+gb[a],!0,c)),"margin"!==b&&(h-=d.css(g,"border"+gb[a]+"Width",!0,c))):(h+=d.css(g,"padding"+gb[a],!0,c),"padding"!==b&&(h+=d.css(g,"border"+gb[a]+"Width",!0,c)));return h}function R(g,
...
a=(Gb[0].contentWindow||Gb[0].contentDocument).document,a.write("<!doctype html><html><body>"),a.close(),b=L(g,a),Gb.detach()),vc[g]=b),b}function L(g,a){var b=d(a.createElement(g)).appendTo(a.body),x=d.css(b[0],"display");return b.remove(),x}function H(g,a,b,x){var c;if(d.isArray(a))d.each(a,function(a,z){b||Xc.test(g)?x(g,z):H(g+"["+("object"==typeof z?a:"")+"]",z,b,x)});else if(b||"object"!==d.type(a))x(g,a);else for(c in a)H(g+"["+c+"]",a[c],b,x)}function S(g){return function(a,b){"string"!=typeof a&&
(b=a,a="*");var x,c=0,h=a.toLowerCase().match(Ba)||[];if(d.isFunction(b))for(;x=h[c++];)"+"===x[0]?(x=x.slice(1)||"*",(g[x]=g[x]||[]).unshift(b)):(g[x]=g[x]||[]).push(b)}}function P(g,a,t,x){function c(m){var f;return h[m]=!0,d.each(g[m]||[],function(g,d){var m=d(a,t,x);return"string"!=typeof m||e||h[m]?e?!(f=m):b:(a.dataTypes.unshift(m),c(m),!1)}),f}var h={},e=g===dc;return c(a.dataTypes[0])||!h["*"]&&c("*")}function fa(g,a){var t,x,c=d.ajaxSettings.flatOptions||{};for(x in a)a[x]!==b&&((c[x]?g:
t||(t={}))[x]=a[x]);return t&&d.extend(!0,g,t),g}function ha(){try{return new a.XMLHttpRequest}catch(g){}}function ja(){return setTimeout(function(){qb=b}),qb=d.now()}function ia(g,a,b){var x,c,h=0,e=Qb.length,m=d.Deferred().always(function(){delete f.elem}),f=function(){if(c)return!1;for(var a=qb||ja(),a=Math.max(0,k.startTime+k.duration-a),z=1-(a/k.duration||0),b=0,t=k.tweens.length;t>b;b++)k.tweens[b].run(z);return m.notifyWith(g,[k,z,a]),1>z&&t?a:(m.resolveWith(g,[k]),!1)},k=m.promise({elem:g,
props:d.extend({},a),opts:d.extend(!0,{specialEasing:{}},b),originalProperties:a,originalOptions:b,startTime:qb||ja(),duration:b.duration,tweens:[],createTween:function(a,z){var b=d.Tween(g,k.opts,a,z,k.opts.specialEasing[a]||k.opts.easing);return k.tweens.push(b),b},stop:function(a){var z=0,b=a?k.tweens.length:0;if(c)return this;for(c=!0;b>z;z++)k.tweens[z].run(1);return a?m.resolveWith(g,[k,a]):m.rejectWith(g,[k,a]),this}});a=k.props;b=k.opts.specialEasing;var u,n,j,w;for(n in a)if(u=d.camelCase(n),
j=b[u],x=a[n],d.isArray(x)&&(j=x[1],x=a[n]=x[0]),n!==u&&(a[u]=x,delete a[n]),w=d.cssHooks[u],w&&"expand"in w)for(n in x=w.expand(x),delete a[u],x)n in a||(a[n]=x[n],b[n]=j);else b[u]=j;for(;e>h;h++)if(x=Qb[h].call(k,g,a,k.opts))return x;var v=k;d.each(a,function(g,a){for(var z=(Hb[g]||[]).concat(Hb["*"]),b=0,t=z.length;t>b&&!z[b].call(v,g,a);b++);});return d.isFunction(k.opts.start)&&k.opts.start.call(g,k),d.fx.timer(d.extend(f,{elem:g,anim:k,queue:k.opts.queue})),k.progress(k.opts.progress).done(k.opts.done,
k.opts.complete).fail(k.opts.fail).always(k.opts.always)}function Y(g,a,b,d,c){return new Y.prototype.init(g,a,b,d,c)}function k(g,a){var b,d={height:g},c=0;for(a=a?1:0;4>c;c+=2-a)b=gb[c],d["margin"+b]=d["padding"+b]=g;return a&&(d.opacity=d.width=g),d}function D(g){return d.isWindow(g)?g:9===g.nodeType?g.defaultView||g.parentWindow:!1}var n,v,A=typeof b,F=a.document,ga=a.location,$a=a.jQuery,ab=a.$,sa={},Ca=[],da=Ca.concat,ta=Ca.push,ka=Ca.slice,w=Ca.indexOf,O=sa.toString,G=sa.hasOwnProperty,Ta=
...
"complete"===F.readyState)&&(Va(),d.ready())},Va=function(){F.addEventListener?(F.removeEventListener("DOMContentLoaded",E,!1),a.removeEventListener("load",E,!1)):(F.detachEvent("onreadystatechange",E),a.detachEvent("onload",E))};d.fn=d.prototype={jquery:"1.9.1",constructor:d,init:function(g,a,t){var x,c;if(!g)return this;if("string"==typeof g){if(x="<"===g.charAt(0)&&">"===g.charAt(g.length-1)&&3<=g.length?[null,g,null]:jb.exec(g),!x||!x[1]&&a)return!a||a.jquery?(a||t).find(g):this.constructor(a).find(g);
if(x[1]){if(a=a instanceof d?a[0]:a,d.merge(this,d.parseHTML(x[1],a&&a.nodeType?a.ownerDocument||a:F,!0)),kb.test(x[1])&&d.isPlainObject(a))for(x in a)d.isFunction(this[x])?this[x](a[x]):this.attr(x,a[x]);return this}if(c=F.getElementById(x[2]),c&&c.parentNode){if(c.id!==x[2])return t.find(g);this.length=1;this[0]=c}return this.context=F,this.selector=g,this}return g.nodeType?(this.context=this[0]=g,this.length=1,this):d.isFunction(g)?t.ready(g):(g.selector!==b&&(this.selector=g.selector,this.context=
...
last:function(){return this.eq(-1)},eq:function(g){var a=this.length;g=+g+(0>g?a:0);return this.pushStack(0<=g&&a>g?[this[g]]:[])},map:function(g){return this.pushStack(d.map(this,function(a,b){return g.call(a,b,a)}))},end:function(){return this.prevObject||this.constructor(null)},push:ta,sort:[].sort,splice:[].splice};d.fn.init.prototype=d.fn;d.extend=d.fn.extend=function(){var g,a,t,x,c,h,e=arguments[0]||{},m=1,k=arguments.length,f=!1;"boolean"==typeof e&&(f=e,e=arguments[1]||{},m=2);"object"==
typeof e||d.isFunction(e)||(e={});for(k===m&&(e=this,--m);k>m;m++)if(null!=(c=arguments[m]))for(x in c)g=e[x],t=c[x],e!==t&&(f&&t&&(d.isPlainObject(t)||(a=d.isArray(t)))?(a?(a=!1,h=g&&d.isArray(g)?g:[]):h=g&&d.isPlainObject(g)?g:{},e[x]=d.extend(f,h,t)):t!==b&&(e[x]=t));return e};d.extend({noConflict:function(g){return a.$===d&&(a.$=ab),g&&a.jQuery===d&&(a.jQuery=$a),d},isReady:!1,readyWait:1,holdReady:function(g){g?d.readyWait++:d.ready(!0)},ready:function(g){if(!0===g?!--d.readyWait:!d.isReady){if(!F.body)return setTimeout(d.ready);
...
d.merge([],x.childNodes))},parseJSON:function(g){return a.JSON&&a.JSON.parse?a.JSON.parse(g):null===g?g:"string"==typeof g&&(g=d.trim(g),g&&Ib.test(g.replace(Ua,"@").replace(rb,"]").replace(Rb,"")))?Function("return "+g)():(d.error("Invalid JSON: "+g),b)},parseXML:function(g){var z,t;if(!g||"string"!=typeof g)return null;try{a.DOMParser?(t=new DOMParser,z=t.parseFromString(g,"text/xml")):(z=new ActiveXObject("Microsoft.XMLDOM"),z.async="false",z.loadXML(g))}catch(x){z=b}return z&&z.documentElement&&
...
d.each("Boolean Number String Function Array Date RegExp Object Error".split(" "),function(g,a){sa["[object "+a+"]"]=a.toLowerCase()});v=d(F);var Wa={};d.Callbacks=function(g){var a;if("string"==typeof g){if(!(a=Wa[g])){a=g;var t=Wa[a]={};a=(d.each(a.match(Ba)||[],function(g,a){t[a]=!0}),t)}}else a=d.extend({},g);g=a;var c,h,e,m,k,f,n=[],u=!g.once&&[],j=function(a){h=g.memory&&a;e=!0;k=f||0;f=0;m=n.length;for(c=!0;n&&m>k;k++)if(!1===n[k].apply(a[0],a[1])&&g.stopOnFalse){h=!1;break}c=!1;n&&(u?u.length&&
j(u.shift()):h?n=[]:w.disable())},w={add:function(){if(n){var a=n.length;(function Yc(a){d.each(a,function(a,b){var z=d.type(b);"function"===z?g.unique&&w.has(b)||n.push(b):b&&b.length&&"string"!==z&&Yc(b)})})(arguments);c?m=n.length:h&&(f=a,j(h))}return this},remove:function(){return n&&d.each(arguments,function(g,a){for(var b;-1<(b=d.inArray(a,n,b));)n.splice(b,1),c&&(m>=b&&m--,k>=b&&k--)}),this},has:function(g){return g?-1<d.inArray(g,n):!(!n||!n.length)},empty:function(){return n=[],this},disable:function(){return n=
u=h=b,this},disabled:function(){return!n},lock:function(){return u=b,h||w.disable(),this},locked:function(){return!u},fireWith:function(g,a){return a=a||[],a=[g,a.slice?a.slice():a],!n||e&&!u||(c?u.push(a):j(a)),this},fire:function(){return w.fireWith(this,arguments),this},fired:function(){return!!e}};return w};d.extend({Deferred:function(g){var a=[["resolve","done",d.Callbacks("once memory"),"resolved"],["reject","fail",d.Callbacks("once memory"),"rejected"],["notify","progress",d.Callbacks("memory")]],
...
return k(),h.promise(a)}});var xa,va,h=/[\t\r\n]/g,m=/\r/g,u=/^(?:input|select|textarea|button|object)$/i,Xa=/^(?:a|area)$/i,Oa=/^(?:checked|selected|autofocus|autoplay|async|controls|defer|disabled|hidden|loop|multiple|open|readonly|required|scoped)$/i,Ia=/^(?:checked|selected)$/i,Ea=d.support.getSetAttribute,sb=d.support.input;d.fn.extend({attr:function(g,a){return d.access(this,d.attr,g,a,1<arguments.length)},removeAttr:function(g){return this.each(function(){d.removeAttr(this,g)})},prop:function(g,
a){return d.access(this,d.prop,g,a,1<arguments.length)},removeProp:function(g){return g=d.propFix[g]||g,this.each(function(){try{this[g]=b,delete this[g]}catch(a){}})},addClass:function(g){var a,b,c,e,m,k=0,f=this.length;a="string"==typeof g&&g;if(d.isFunction(g))return this.each(function(a){d(this).addClass(g.call(this,a,this.className))});if(a)for(a=(g||"").match(Ba)||[];f>k;k++)if(b=this[k],c=1===b.nodeType&&(b.className?(" "+b.className+" ").replace(h," "):" ")){for(m=0;e=a[m++];)0>c.indexOf(" "+
e+" ")&&(c+=e+" ");b.className=d.trim(c)}return this},removeClass:function(g){var a,b,c,e,m,k=0,f=this.length;a=0===arguments.length||"string"==typeof g&&g;if(d.isFunction(g))return this.each(function(a){d(this).removeClass(g.call(this,a,this.className))});if(a)for(a=(g||"").match(Ba)||[];f>k;k++)if(b=this[k],c=1===b.nodeType&&(b.className?(" "+b.className+" ").replace(h," "):"")){for(m=0;e=a[m++];)for(;0<=c.indexOf(" "+e+" ");)c=c.replace(" "+e+" "," ");b.className=g?d.trim(c):""}return this},toggleClass:function(g,
a){var b=typeof g,c="boolean"==typeof a;return d.isFunction(g)?this.each(function(b){d(this).toggleClass(g.call(this,b,this.className,a),a)}):this.each(function(){if("string"===b)for(var h,e=0,m=d(this),k=a,f=g.match(Ba)||[];h=f[e++];)k=c?k:!m.hasClass(h),m[k?"addClass":"removeClass"](h);else(b===A||"boolean"===b)&&(this.className&&d._data(this,"__className__",this.className),this.className=this.className||!1===g?"":d._data(this,"__className__")||"")})},hasClass:function(g){g=" "+g+" ";for(var a=
0,b=this.length;b>a;a++)if(1===this[a].nodeType&&0<=(" "+this[a].className+" ").replace(h," ").indexOf(g))return!0;return!1},val:function(g){var a,c,h,e=this[0];if(arguments.length)return h=d.isFunction(g),this.each(function(a){var z,e=d(this);1===this.nodeType&&(z=h?g.call(this,a,e.val()):g,null==z?z="":"number"==typeof z?z+="":d.isArray(z)&&(z=d.map(z,function(a){return null==a?"":a+""})),c=d.valHooks[this.type]||d.valHooks[this.nodeName.toLowerCase()],c&&"set"in c&&c.set(this,z,"value")!==b||(this.value=
z))});if(e)return c=d.valHooks[e.type]||d.valHooks[e.nodeName.toLowerCase()],c&&"get"in c&&(a=c.get(e,"value"))!==b?a:(a=e.value,"string"==typeof a?a.replace(m,""):null==a?"":a)}});d.extend({valHooks:{option:{get:function(a){var b=a.attributes.value;return!b||b.specified?a.value:a.text}},select:{get:function(a){for(var b,c=a.options,h=a.selectedIndex,e="select-one"===a.type||0>h,m=e?null:[],k=e?h+1:c.length,f=0>h?k:e?h:0;k>f;f++)if(b=c[f],!(!b.selected&&f!==h||(d.support.optDisabled?b.disabled:null!==
...
d.event={global:{},add:function(a,c,h,x,e){var m,k,f,n,u,j,w,v,D;if(f=d._data(a)){h.handler&&(n=h,h=n.handler,e=n.selector);h.guid||(h.guid=d.guid++);(k=f.events)||(k=f.events={});(u=f.handle)||(u=f.handle=function(a){return typeof d===A||a&&d.event.triggered===a.type?b:d.event.dispatch.apply(u.elem,arguments)},u.elem=a);c=(c||"").match(Ba)||[""];for(f=c.length;f--;)m=Lb.exec(c[f])||[],v=j=m[1],D=(m[2]||"").split(".").sort(),m=d.event.special[v]||{},v=(e?m.delegateType:m.bindType)||v,m=d.event.special[v]||
{},j=d.extend({type:v,origType:j,data:x,handler:h,guid:h.guid,selector:e,needsContext:e&&d.expr.match.needsContext.test(e),namespace:D.join(".")},n),(w=k[v])||(w=k[v]=[],w.delegateCount=0,m.setup&&!1!==m.setup.call(a,x,D,u)||(a.addEventListener?a.addEventListener(v,u,!1):a.attachEvent&&a.attachEvent("on"+v,u))),m.add&&(m.add.call(a,j),j.handler.guid||(j.handler.guid=h.guid)),e?w.splice(w.delegateCount++,0,j):w.push(j),d.event.global[v]=!0;a=null}},remove:function(a,b,c,h,e){var m,k,f,n,u,j,w,v,A,
D,l,q=d.hasData(a)&&d._data(a);if(q&&(j=q.events)){b=(b||"").match(Ba)||[""];for(u=b.length;u--;)if(f=Lb.exec(b[u])||[],A=l=f[1],D=(f[2]||"").split(".").sort(),A){w=d.event.special[A]||{};A=(h?w.delegateType:w.bindType)||A;v=j[A]||[];f=f[2]&&RegExp("(^|\\.)"+D.join("\\.(?:.*\\.|)")+"(\\.|$)");for(n=m=v.length;m--;)k=v[m],!e&&l!==k.origType||c&&c.guid!==k.guid||f&&!f.test(k.namespace)||h&&h!==k.selector&&("**"!==h||!k.selector)||(v.splice(m,1),k.selector&&v.delegateCount--,w.remove&&w.remove.call(a,
k));n&&!v.length&&(w.teardown&&!1!==w.teardown.call(a,D,q.handle)||d.removeEvent(a,A,q.handle),delete j[A])}else for(A in j)d.event.remove(a,A+b[u],c,h,!0);d.isEmptyObject(j)&&(delete q.handle,d._removeData(a,"events"))}},trigger:function(g,c,h,x){var e,m,k,f,n,u,j=[h||F],w=G.call(g,"type")?g.type:g;u=G.call(g,"namespace")?g.namespace.split("."):[];if(k=e=h=h||F,3!==h.nodeType&&8!==h.nodeType&&!Kb.test(w+d.event.triggered)&&(0<=w.indexOf(".")&&(u=w.split("."),w=u.shift(),u.sort()),m=0>w.indexOf(":")&&
"on"+w,g=g[d.expando]?g:new d.Event(w,"object"==typeof g&&g),g.isTrigger=!0,g.namespace=u.join("."),g.namespace_re=g.namespace?RegExp("(^|\\.)"+u.join("\\.(?:.*\\.|)")+"(\\.|$)"):null,g.result=b,g.target||(g.target=h),c=null==c?[g]:d.makeArray(c,[g]),n=d.event.special[w]||{},x||!n.trigger||!1!==n.trigger.apply(h,c))){if(!x&&!n.noBubble&&!d.isWindow(h)){f=n.delegateType||w;for(Kb.test(f+w)||(k=k.parentNode);k;k=k.parentNode)j.push(k),e=k;e===(h.ownerDocument||F)&&j.push(e.defaultView||e.parentWindow||
a)}for(u=0;(k=j[u++])&&!g.isPropagationStopped();)g.type=1<u?f:n.bindType||w,(e=(d._data(k,"events")||{})[g.type]&&d._data(k,"handle"))&&e.apply(k,c),(e=m&&k[m])&&d.acceptData(k)&&e.apply&&!1===e.apply(k,c)&&g.preventDefault();if(g.type=w,!(x||g.isDefaultPrevented()||n._default&&!1!==n._default.apply(h.ownerDocument,c)||"click"===w&&d.nodeName(h,"a")||!d.acceptData(h)||!m||!h[w]||d.isWindow(h))){(e=h[m])&&(h[m]=null);d.event.triggered=w;try{h[w]()}catch(v){}d.event.triggered=b;e&&(h[m]=e)}return g.result}},
dispatch:function(a){a=d.event.fix(a);var c,h,x,e,m,k=[],f=ka.call(arguments);c=(d._data(this,"events")||{})[a.type]||[];var n=d.event.special[a.type]||{};if(f[0]=a,a.delegateTarget=this,!n.preDispatch||!1!==n.preDispatch.call(this,a)){k=d.event.handlers.call(this,a,c);for(c=0;(e=k[c++])&&!a.isPropagationStopped();){a.currentTarget=e.elem;for(m=0;(x=e.handlers[m++])&&!a.isImmediatePropagationStopped();)(!a.namespace_re||a.namespace_re.test(x.namespace))&&(a.handleObj=x,a.data=x.data,h=((d.event.special[x.origType]||
{}).handle||x.handler).apply(e.elem,f),h!==b&&!1===(a.result=h)&&(a.preventDefault(),a.stopPropagation()))}return n.postDispatch&&n.postDispatch.call(this,a),a.result}},handlers:function(a,c){var h,x,e,m,k=[],f=c.delegateCount,n=a.target;if(f&&n.nodeType&&(!a.button||"click"!==a.type))for(;n!=this;n=n.parentNode||this)if(1===n.nodeType&&(!0!==n.disabled||"click"!==a.type)){e=[];for(m=0;f>m;m++)x=c[m],h=x.selector+" ",e[h]===b&&(e[h]=x.needsContext?0<=d(h,this).index(n):d.find(h,this,null,[n]).length),
e[h]&&e.push(x);e.length&&k.push({elem:n,handlers:e})}return c.length>f&&k.push({elem:this,handlers:c.slice(f)}),k},fix:function(a){if(a[d.expando])return a;var b,c,h;b=a.type;var e=a,m=this.fixHooks[b];m||(this.fixHooks[b]=m=Tb.test(b)?this.mouseHooks:Pa.test(b)?this.keyHooks:{});h=m.props?this.props.concat(m.props):this.props;a=new d.Event(e);for(b=h.length;b--;)c=h[b],a[c]=e[c];return a.target||(a.target=e.srcElement||F),3===a.target.nodeType&&(a.target=a.target.parentNode),a.metaKey=!!a.metaKey,
m.filter?m.filter(a,e):a},props:"altKey bubbles cancelable ctrlKey currentTarget eventPhase metaKey relatedTarget shiftKey target timeStamp view which".split(" "),fixHooks:{},keyHooks:{props:["char","charCode","key","keyCode"],filter:function(a,b){return null==a.which&&(a.which=null!=b.charCode?b.charCode:b.keyCode),a}},mouseHooks:{props:"button buttons clientX clientY fromElement offsetX offsetY pageX pageY screenX screenY toElement".split(" "),filter:function(a,d){var c,h,e,m=d.button,k=d.fromElement;
return null==a.pageX&&null!=d.clientX&&(h=a.target.ownerDocument||F,e=h.documentElement,c=h.body,a.pageX=d.clientX+(e&&e.scrollLeft||c&&c.scrollLeft||0)-(e&&e.clientLeft||c&&c.clientLeft||0),a.pageY=d.clientY+(e&&e.scrollTop||c&&c.scrollTop||0)-(e&&e.clientTop||c&&c.clientTop||0)),!a.relatedTarget&&k&&(a.relatedTarget=k===a.target?d.toElement:k),a.which||m===b||(a.which=1&m?1:2&m?3:4&m?2:0),a}},special:{load:{noBubble:!0},click:{trigger:function(){return d.nodeName(this,"input")&&"checkbox"===this.type&&
...
Xb=function(a){return 1<a.length?function(b,c,d){for(var h=a.length;h--;)if(!a[h](b,c,d))return!1;return!0}:a[0]},Nb=function(a,b,c,d,h){for(var e,m=[],k=0,f=a.length,n=null!=b;f>k;k++)(e=a[k])&&(!c||c(e,d,h))&&(m.push(e),n&&b.push(k));return m},eb=function(a,b,c,d,h,e){return d&&!d[ma]&&(d=eb(d)),h&&!h[ma]&&(h=eb(h,e)),ya(function(e,m,k,f){var n,u,j=[],w=[],v=m.length,A;if(!(A=e)){A=b||"*";for(var qa=k.nodeType?[k]:k,D=[],q=0,l=qa.length;l>q;q++)Z(A,qa[q],D);A=D}A=!a||!e&&b?A:Nb(A,j,a,k,f);qa=c?
h||(e?a:v||d)?[]:m:A;if(c&&c(A,qa,k,f),d){n=Nb(qa,w);d(n,[],k,f);for(k=n.length;k--;)(u=n[k])&&(qa[w[k]]=!(A[w[k]]=u))}if(e){if(h||a){if(h){n=[];for(k=qa.length;k--;)(u=qa[k])&&n.push(A[k]=u);h(null,qa=[],n,f)}for(k=qa.length;k--;)(u=qa[k])&&-1<(n=h?hc.call(e,u):j[k])&&(e[n]=!(m[n]=u))}}else qa=Nb(qa===m?qa.splice(v,qa.length):qa),h?h(null,m,qa,f):wb.apply(m,qa)})},ic=function(a){var b,c,d,h=a.length,e=aa.relative[a[0].type];c=e||aa.relative[" "];for(var m=e?1:0,k=Bb(function(a){return a===b},c,!0),
...
a.slice(-4),k="of-type"===b;return 1===d&&0===h?function(a){return!!a.parentNode}:function(b,c,f){var t,z,n,u,j;c=e!==m?"nextSibling":"previousSibling";var w=b.parentNode,v=k&&b.nodeName.toLowerCase();f=!f&&!k;if(w){if(e){for(;c;){for(z=b;z=z[c];)if(k?z.nodeName.toLowerCase()===v:1===z.nodeType)return!1;j=c="only"===a&&!j&&"nextSibling"}return!0}if(j=[m?w.firstChild:w.lastChild],m&&f){f=w[ma]||(w[ma]={});t=f[a]||[];u=t[0]===Ra&&t[1];n=t[0]===Ra&&t[2];for(z=u&&w.childNodes[u];z=++u&&z&&z[c]||(n=u=
0)||j.pop();)if(1===z.nodeType&&++n&&z===b){f[a]=[Ra,u,n];break}}else if(f&&(t=(b[ma]||(b[ma]={}))[a])&&t[0]===Ra)n=t[1];else for(;(z=++u&&z&&z[c]||(n=u=0)||j.pop())&&(!(k?z.nodeName.toLowerCase()===v:1===z.nodeType)||!++n||!(f&&((z[ma]||(z[ma]={}))[a]=[Ra,n]),z===b)););return n-=h,n===d||0===n%d&&0<=n/d}}},PSEUDO:function(a,b){var c,d=aa.pseudos[a]||aa.setFilters[a.toLowerCase()]||Z.error("unsupported pseudo: "+a);return d[ma]?d(b):1<d.length?(c=[a,a,"",b],aa.setFilters.hasOwnProperty(a.toLowerCase())?
ya(function(a,g){for(var c,h=d(a,b),e=h.length;e--;)c=hc.call(a,h[e]),a[c]=!(g[c]=h[e])}):function(a){return d(a,0,c)}):d}},pseudos:{not:ya(function(a){var b=[],c=[],d=gc(a.replace(Ub,"$1"));return d[ma]?ya(function(a,b,g,c){var h;g=d(a,null,c,[]);for(c=a.length;c--;)(h=g[c])&&(a[c]=!(b[c]=h))}):function(a,g,h){return b[0]=a,d(b,null,h,c),!c.pop()}}),has:ya(function(a){return function(b){return 0<Z(a,b).length}}),contains:ya(function(a){return function(b){return-1<(b.textContent||b.innerText||Zb(b)).indexOf(a)}}),
...
c;c+=2)a.push(c);return a}),lt:Ma(function(a,b,c){for(b=0>c?c+b:c;0<=--b;)a.push(b);return a}),gt:Ma(function(a,b,c){for(c=0>c?c+b:c;b>++c;)a.push(c);return a})}};for(Cb in{radio:!0,checkbox:!0,file:!0,password:!0,image:!0})aa.pseudos[Cb]=Ab(Cb);for(Cb in{submit:!0,reset:!0})aa.pseudos[Cb]=Za(Cb);gc=Z.compile=function(a,b){var c,d=[],h=[],e=Bc[a+" "];if(!e){b||(b=Ya(a));for(c=b.length;c--;)e=ic(b[c]),e[ma]?d.push(e):h.push(e);var m=0,k=0<d.length,f=0<h.length;c=function(a,b,c,g,e){var t,n,z=[],u=
0,j="0",w=a&&[],v=null!=e,A=Yb,D=a||f&&aa.find.TAG("*",e&&b.parentNode||b),q=Ra+=null==A?1:Math.random()||0.1;for(v&&(Yb=b!==za&&b,Wb=m);null!=(e=D[j]);j++){if(f&&e){for(t=0;n=h[t++];)if(n(e,b,c)){g.push(e);break}v&&(Ra=q,Wb=++m)}k&&((e=!n&&e)&&u--,a&&w.push(e))}if(u+=j,k&&j!==u){for(t=0;n=d[t++];)n(w,z,b,c);if(a){if(0<u)for(;j--;)w[j]||z[j]||(z[j]=dd.call(g));z=Nb(z)}wb.apply(g,z);v&&!a&&0<z.length&&1<u+d.length&&Z.uniqueSort(g)}return v&&(Ra=q,Yb=A),w};c=k?ya(c):c;e=Bc(a,c)}return e};aa.pseudos.nth=
...
(d.cleanData(s(c,!1)),c.innerHTML=a);c=0}catch(e){}}c&&this.empty().append(a)},null,a,arguments.length)},replaceWith:function(a){return d.isFunction(a)||"string"==typeof a||(a=d(a).not(this).detach()),this.domManip([a],!0,function(a){var b=this.nextSibling,c=this.parentNode;c&&(d(this).remove(),c.insertBefore(a,b))})},detach:function(a){return this.remove(a,!0)},domManip:function(a,c,h){a=da.apply([],a);var e,m,k,f,n=0,u=this.length,j=this,w=u-1,v=a[0],A=d.isFunction(v);if(A||!(1>=u||"string"!=typeof v||
d.support.checkClone)&&qd.test(v))return this.each(function(d){var e=j.eq(d);A&&(a[0]=v.call(this,d,c?e.html():b));e.domManip(a,c,h)});if(u&&(f=d.buildFragment(a,this[0].ownerDocument,!1,this),e=f.firstChild,1===f.childNodes.length&&(f=e),e)){c=c&&d.nodeName(e,"tr");k=d.map(s(f,"script"),y);for(m=k.length;u>n;n++)e=f,n!==w&&(e=d.clone(e,!0,!0),m&&d.merge(k,s(e,"script"))),h.call(c&&d.nodeName(this[n],"table")?this[n].getElementsByTagName("tbody")[0]||this[n].appendChild(this[n].ownerDocument.createElement("tbody")):
...
e=h.length-1;e>=c;c++)a=c===e?this:this.clone(!0),d(h[c])[b](a),ta.apply(g,a.get());return this.pushStack(g)}});d.extend({clone:function(a,b,c){var h,e,m,k,f,n=d.contains(a.ownerDocument,a);if(d.support.html5Clone||d.isXMLDoc(a)||!Fc.test("<"+a.nodeName+">")?m=a.cloneNode(!0):(nc.innerHTML=a.outerHTML,nc.removeChild(m=nc.firstChild)),!(d.support.noCloneEvent&&d.support.noCloneChecked||1!==a.nodeType&&11!==a.nodeType||d.isXMLDoc(a))){h=s(m);f=s(a);for(k=0;null!=(e=f[k]);++k)if(h[k]){var u=h[k],j=void 0,
w=void 0,v=void 0;if(1===u.nodeType){if(j=u.nodeName.toLowerCase(),!d.support.noCloneEvent&&u[d.expando]){v=d._data(u);for(w in v.events)d.removeEvent(u,w,v.handle);u.removeAttribute(d.expando)}"script"===j&&u.text!==e.text?(y(u).text=e.text,B(u)):"object"===j?(u.parentNode&&(u.outerHTML=e.outerHTML),d.support.html5Clone&&e.innerHTML&&!d.trim(u.innerHTML)&&(u.innerHTML=e.innerHTML)):"input"===j&&cc.test(e.type)?(u.defaultChecked=u.checked=e.checked,u.value!==e.value&&(u.value=e.value)):"option"===
j?u.defaultSelected=u.selected=e.defaultSelected:("input"===j||"textarea"===j)&&(u.defaultValue=e.defaultValue)}}}if(b)if(c){f=f||s(a);h=h||s(m);for(k=0;null!=(e=f[k]);k++)X(e,h[k])}else X(a,m);return h=s(m,"script"),0<h.length&&N(h,!n&&s(a,"script")),m},buildFragment:function(a,b,c,h){for(var e,m,k,f,n,u,j,w=a.length,v=W(b),A=[],D=0;w>D;D++)if(m=a[D],m||0===m)if("object"===d.type(m))d.merge(A,m.nodeType?[m]:m);else if(od.test(m)){f=f||v.appendChild(b.createElement("div"));n=(Hc.exec(m)||["",""])[1].toLowerCase();
j=Ja[n]||Ja._default;f.innerHTML=j[1]+m.replace(Gc,"<$1></$2>")+j[2];for(e=j[0];e--;)f=f.lastChild;if(!d.support.leadingWhitespace&&mc.test(m)&&A.push(b.createTextNode(mc.exec(m)[0])),!d.support.tbody)for(e=(m="table"!==n||Ic.test(m)?"<table>"!==j[1]||Ic.test(m)?0:f:f.firstChild)&&m.childNodes.length;e--;)d.nodeName(u=m.childNodes[e],"tbody")&&!u.childNodes.length&&m.removeChild(u);d.merge(A,f.childNodes);for(f.textContent="";f.firstChild;)f.removeChild(f.firstChild);f=v.lastChild}else A.push(b.createTextNode(m));
f&&v.removeChild(f);d.support.appendChecked||d.grep(s(A,"input"),U);for(D=0;m=A[D++];)if((!h||-1===d.inArray(m,h))&&(k=d.contains(m.ownerDocument,m),f=s(v.appendChild(m),"script"),k&&N(f),c))for(e=0;m=f[e++];)Jc.test(m.type||"")&&c.push(m);return v},cleanData:function(a,b){for(var c,h,e,m,k=0,f=d.expando,n=d.cache,u=d.support.deleteExpando,j=d.event.special;null!=(c=a[k]);k++)if((b||d.acceptData(c))&&(e=c[f],m=e&&n[e])){if(m.events)for(h in m.events)j[h]?d.event.remove(c,h):d.removeEvent(c,h,m.handle);
n[e]&&(delete n[e],u?delete c[f]:typeof c.removeAttribute!==A?c.removeAttribute(f):c[f]=null,Ca.push(e))}}});var Gb,hb,ib,oc=/alpha\([^)]*\)/i,sd=/opacity\s*=\s*([^)]*)/,td=/^(top|right|bottom|left)$/,ud=/^(none|table(?!-c[ea]).+)/,Kc=/^margin/,Wc=RegExp("^("+Da+")(.*)$","i"),Pb=RegExp("^("+Da+")(?!px)[a-z%]+$","i"),vd=RegExp("^([+-])=("+Da+")","i"),vc={BODY:"block"},wd={position:"absolute",visibility:"hidden",display:"block"},Lc={letterSpacing:0,fontWeight:400},gb=["Top","Right","Bottom","Left"],
...
ib(a,"opacity");return""===c?"1":c}}}},cssNumber:{columnCount:!0,fillOpacity:!0,fontWeight:!0,lineHeight:!0,opacity:!0,orphans:!0,widows:!0,zIndex:!0,zoom:!0},cssProps:{"float":d.support.cssFloat?"cssFloat":"styleFloat"},style:function(a,c,h,e){if(a&&3!==a.nodeType&&8!==a.nodeType&&a.style){var m,k,f,n=d.camelCase(c),u=a.style;if(c=d.cssProps[n]||(d.cssProps[n]=K(u,n)),f=d.cssHooks[c]||d.cssHooks[n],h===b)return f&&"get"in f&&(m=f.get(a,!1,e))!==b?m:u[c];if(k=typeof h,"string"===k&&(m=vd.exec(h))&&
(h=(m[1]+1)*m[2]+parseFloat(d.css(a,c)),k="number"),!(null==h||"number"===k&&isNaN(h)||("number"!==k||d.cssNumber[n]||(h+="px"),d.support.clearCloneStyle||""!==h||0!==c.indexOf("background")||(u[c]="inherit"),f&&"set"in f&&(h=f.set(a,h,e))===b)))try{u[c]=h}catch(j){}}},css:function(a,c,h,e){var m,k,f,n=d.camelCase(c);return c=d.cssProps[n]||(d.cssProps[n]=K(a.style,n)),f=d.cssHooks[c]||d.cssHooks[n],f&&"get"in f&&(k=f.get(a,!0,h)),k===b&&(k=ib(a,c,e)),"normal"===k&&c in Lc&&(k=Lc[c]),""===h||h?(m=
...
context:!0}},ajaxSetup:function(a,b){return b?fa(fa(a,d.ajaxSettings),b):fa(d.ajaxSettings,a)},ajaxPrefilter:S(Qc),ajaxTransport:S(dc),ajax:function(a,c){function h(a,c,g,e){var m,w,t,x,z,O=c;if(2!==G){G=2;n&&clearTimeout(n);j=b;f=e||"";p.readyState=0<a?4:0;if(g){x=v;e=p;var s,F,C,r,Oa=x.contents,ga=x.dataTypes,Ta=x.responseFields;for(r in Ta)r in g&&(e[Ta[r]]=g[r]);for(;"*"===ga[0];)ga.shift(),F===b&&(F=x.mimeType||e.getResponseHeader("Content-Type"));if(F)for(r in Oa)if(Oa[r]&&Oa[r].test(F)){ga.unshift(r);
break}if(ga[0]in g)C=ga[0];else{for(r in g){if(!ga[0]||x.converters[r+" "+ga[0]]){C=r;break}s||(s=r)}C=C||s}x=C?(C!==ga[0]&&ga.unshift(C),g[C]):b}if(200<=a&&300>a||304===a)if(v.ifModified&&(z=p.getResponseHeader("Last-Modified"),z&&(d.lastModified[k]=z),z=p.getResponseHeader("etag"),z&&(d.etag[k]=z)),204===a)m=!0,O="nocontent";else if(304===a)m=!0,O="notmodified";else{var B;a:{g=v;m=x;var H,Ia;t={};z=0;O=g.dataTypes.slice();s=O[0];if(g.dataFilter&&(m=g.dataFilter(m,g.dataType)),O[1])for(H in g.converters)t[H.toLowerCase()]=
g.converters[H];for(;w=O[++z];)if("*"!==w){if("*"!==s&&s!==w){if(H=t[s+" "+w]||t["* "+w],!H)for(B in t)if(Ia=B.split(" "),Ia[1]===w&&(H=t[s+" "+Ia[0]]||t["* "+Ia[0]])){!0===H?H=t[B]:!0!==t[B]&&(w=Ia[0],O.splice(z--,0,w));break}if(!0!==H)if(H&&g["throws"])m=H(m);else try{m=H(m)}catch(R){B={state:"parsererror",error:H?R:"No conversion from "+s+" to "+w};break a}}s=w}B={state:"success",data:m}}m=B;O=m.state;w=m.data;t=m.error;m=!t}else t=O,(a||!O)&&(O="error",0>a&&(a=0));p.status=a;p.statusText=(c||
O)+"";m?q.resolveWith(A,[w,O,p]):q.rejectWith(A,[p,O,t]);p.statusCode(Xa);Xa=b;u&&D.trigger(m?"ajaxSuccess":"ajaxError",[p,v,m?w:t]);l.fireWith(A,[p,O]);u&&(D.trigger("ajaxComplete",[p,v]),--d.active||d.event.trigger("ajaxStop"))}}"object"==typeof a&&(c=a,a=b);c=c||{};var e,m,k,f,n,u,j,w,v=d.ajaxSetup({},c),A=v.context||v,D=v.context&&(A.nodeType||A.jquery)?d(A):d.event,q=d.Deferred(),l=d.Callbacks("once memory"),Xa=v.statusCode||{},O={},s={},G=0,F="canceled",p={readyState:0,getResponseHeader:function(a){var b;
...
l.add,p.success=p.done,p.error=p.fail,v.url=((a||v.url||fb)+"").replace(Ad,"").replace(Dd,pb[1]+"//"),v.type=c.method||c.type||v.method||v.type,v.dataTypes=d.trim(v.dataType||"*").toLowerCase().match(Ba)||[""],null==v.crossDomain&&(e=Oc.exec(v.url.toLowerCase()),v.crossDomain=!(!e||e[1]===pb[1]&&e[2]===pb[2]&&(e[3]||("http:"===e[1]?80:443))==(pb[3]||("http:"===pb[1]?80:443)))),v.data&&v.processData&&"string"!=typeof v.data&&(v.data=d.param(v.data,v.traditional)),P(Qc,v,c,p),2===G)return p;(u=v.global)&&
...
v.contentType);p.setRequestHeader("Accept",v.dataTypes[0]&&v.accepts[v.dataTypes[0]]?v.accepts[v.dataTypes[0]]+("*"!==v.dataTypes[0]?", "+Rc+"; q=0.01":""):v.accepts["*"]);for(m in v.headers)p.setRequestHeader(m,v.headers[m]);if(v.beforeSend&&(!1===v.beforeSend.call(A,p,v)||2===G))return p.abort();F="abort";for(m in{success:1,error:1,complete:1})p[m](v[m]);if(j=P(dc,v,c,p)){p.readyState=1;u&&D.trigger("ajaxSend",[p,v]);v.async&&0<v.timeout&&(n=setTimeout(function(){p.abort("timeout")},v.timeout));
...
c.crossDomain||e["X-Requested-With"]||(e["X-Requested-With"]="XMLHttpRequest");try{for(f in e)n.setRequestHeader(f,e[f])}catch(u){}n.send(c.hasContent&&c.data||null);h=function(a,e){var f,u,j,v;try{if(h&&(e||4===n.readyState))if(h=b,k&&(n.onreadystatechange=d.noop,sc&&delete Fb[k]),e)4!==n.readyState&&n.abort();else{v={};f=n.status;u=n.getAllResponseHeaders();"string"==typeof n.responseText&&(v.text=n.responseText);try{j=n.statusText}catch(w){j=""}f||!c.isLocal||c.crossDomain?1223===f&&(f=204):f=
v.text?200:404}}catch(A){e||m(-1,A)}v&&m(f,j,v,u)};c.async?4===n.readyState?setTimeout(h):(k=++Ed,sc&&(Fb||(Fb={},d(a).unload(sc)),Fb[k]=h),n.onreadystatechange=h):h()},abort:function(){h&&h(b,!0)}}}});var qb,bc,Fd=/^(?:toggle|show|hide)$/,Gd=RegExp("^(?:([+-])=|)("+Da+")([a-z%]*)$","i"),Hd=/queueHooks$/,Qb=[function(a,b,c){var h,e,m,k,f,n,u=this,j=a.style,v={},w=[],A=a.nodeType&&V(a);c.queue||(f=d._queueHooks(a,"fx"),null==f.unqueued&&(f.unqueued=0,n=f.empty.fire,f.empty.fire=function(){f.unqueued||
n()}),f.unqueued++,u.always(function(){u.always(function(){f.unqueued--;d.queue(a,"fx").length||f.empty.fire()})}));1===a.nodeType&&("height"in b||"width"in b)&&(c.overflow=[j.overflow,j.overflowX,j.overflowY],"inline"===d.css(a,"display")&&"none"===d.css(a,"float")&&(d.support.inlineBlockNeedsLayout&&"inline"!==ca(a.nodeName)?j.zoom=1:j.display="inline-block"));c.overflow&&(j.overflow="hidden",d.support.shrinkWrapBlocks||u.always(function(){j.overflow=c.overflow[0];j.overflowX=c.overflow[1];j.overflowY=
c.overflow[2]}));for(e in b)if(m=b[e],Fd.exec(m))(delete b[e],h=h||"toggle"===m,m===(A?"hide":"show"))||w.push(e);if(b=w.length){m=d._data(a,"fxshow")||d._data(a,"fxshow",{});"hidden"in m&&(A=m.hidden);h&&(m.hidden=!A);A?d(a).show():u.done(function(){d(a).hide()});u.done(function(){var b;d._removeData(a,"fxshow");for(b in v)d.style(a,b,v[b])});for(e=0;b>e;e++)h=w[e],k=u.createTween(h,A?m[h]:0),v[h]=m[h]||d.style(a,h),h in m||(m[h]=k.start,A&&(k.end=k.start,k.start="width"===h||"height"===h?1:0))}}],
Hb={"*":[function(a,b){var c,h,e=this.createTween(a,b),m=Gd.exec(b),k=e.cur(),f=+k||0,n=1,u=20;if(m){if(c=+m[2],h=m[3]||(d.cssNumber[a]?"":"px"),"px"!==h&&f){f=d.css(e.elem,a,!0)||c||1;do n=n||".5",f/=n,d.style(e.elem,a,f+h);while(n!==(n=e.cur()/k)&&1!==n&&--u)}e.unit=h;e.start=f;e.end=m[1]?f+(m[1]+1)*c:c}return e}]};d.Animation=d.extend(ia,{tweener:function(a,b){d.isFunction(a)?(b=a,a=["*"]):a=a.split(" ");for(var c,h=0,e=a.length;e>h;h++)c=a[h],Hb[c]=Hb[c]||[],Hb[c].unshift(b)},prefilter:function(a,
...
e,k,f){function j(a){a.stopPropagation&&a.stopPropagation();a.preventDefault&&a.preventDefault();a.returnValue=!1}function D(a){if(s){if(W&&9>document.documentMode&&!a.button)return q();var b=a.originalEvent.touches,d=b?b[0].pageY:a.pageY,b=Math.max(0,Math.min((b?b[0].pageX:a.pageX)-p.left,r)),d=Math.max(0,Math.min(d-p.top,C));w&&j(a);e.apply(c,[b,d,a])}}function q(){s&&(b(l).unbind(O),b(l.body).removeClass("sp-dragging"),f.apply(c,arguments));s=!1}e=e||function(){};k=k||function(){};f=f||function(){};
var l=c.ownerDocument||document,s=!1,p={},C=0,r=0,w="ontouchstart"in a,O={};O.selectstart=j;O.dragstart=j;O[w?"touchmove":"mousemove"]=D;O[w?"touchend":"mouseup"]=q;b(c).bind(w?"touchstart":"mousedown",function(a){if(!(a.which?3==a.which:2==a.button)&&!s&&!1!==k.apply(c,arguments))s=!0,C=b(c).height(),r=b(c).width(),p=b(c).offset(),b(l).bind(O),b(l.body).addClass("sp-dragging"),w||D(a),j(a)})}var Q={beforeShow:p,move:p,change:p,show:p,hide:p,color:!1,flat:!1,showInput:!0,showButtons:!1,clickoutFiresChange:!1,
...
(l=H(l));1>p&&(p=H(p));1>r&&(r=H(r));b=B;c=c&&c.format||y;e=l;f=p;q=r;var w=ha(a);return{ok:b,format:c,_tc_id:ca++,alpha:w,toHsv:function(){var a=K(e,f,q);return{h:a.h,s:a.s,v:a.v,a:w}},toHsvString:function(){var a=K(e,f,q),b=H(360*a.h),c=H(100*a.s),a=H(100*a.v);return 1==w?"hsv("+b+", "+c+"%, "+a+"%)":"hsva("+b+", "+c+"%, "+a+"%, "+w+")"},toHsl:function(){var a=U(e,f,q);return{h:a.h,s:a.s,l:a.l,a:w}},toHslString:function(){var a=U(e,f,q),b=H(360*a.h),c=H(100*a.s),a=H(100*a.l);return 1==w?"hsl("+
b+", "+c+"%, "+a+"%)":"hsla("+b+", "+c+"%, "+a+"%, "+w+")"},toHex:function(){return V(e,f,q)},toHexString:function(a){return"#"+V(e,f,q,a)},toRgb:function(){return{r:H(e),g:H(f),b:H(q),a:w}},toRgbString:function(){return 1==w?"rgb("+H(e)+", "+H(f)+", "+H(q)+")":"rgba("+H(e)+", "+H(f)+", "+H(q)+", "+w+")"},toName:function(){return k[V(e,f,q)]||!1},toFilter:function(a,b){var c=V(e,f,q,!0),d=c,k=Math.round(255*ha(w)).toString(16),n=k,v=a&&a.gradientType?"GradientType = 1, ":"";b&&(n=s(b),d=n.toHex(),
...
e.parseUri=function(a){a=f.exec(a||"");for(var b={},c=14;c--;)b[p[c]]=a[c]||"";return b};e.uniqueUri=function(a){var b=a.protocol,e=a.host;a=a.port;"document"in c?(e=e||document.domain,a=a||("https"==b&&"https:"!==document.location.protocol?443:document.location.port)):(e=e||"localhost",!a&&"https"==b&&(a=443));return(b||"http")+"://"+e+":"+(a||80)};e.query=function(a,b){var c=e.chunkQuery(a||""),d=[];e.merge(c,e.chunkQuery(b||""));for(var f in c)c.hasOwnProperty(f)&&d.push(f+"="+c[f]);return d.length?
"?"+d.join("&"):""};e.chunkQuery=function(a){var b={};a=a.split("&");for(var c=0,e=a.length,d;c<e;++c)d=a[c].split("="),d[0]&&(b[d[0]]=d[1]);return b};var r=!1;e.load=function(a){if("document"in c&&"complete"===document.readyState||r)return a();e.on(c,"load",a,!1)};e.on=function(a,b,c,e){a.attachEvent?a.attachEvent("on"+b,c):a.addEventListener&&a.addEventListener(b,c,e)};e.request=function(a){if(a&&"undefined"!=typeof XDomainRequest&&!e.ua.hasCORS)return new XDomainRequest;if("undefined"!=typeof XMLHttpRequest&&
...
f.getAttribute("class")&&(e.styleclass=f.getAttribute("class"));f.getAttribute("align")&&(e.align=f.getAttribute("align"));for(var j={},f=f.getElementsByTagName("param"),l=f.length,w=0;w<l;w++)"movie"!=f[w].getAttribute("name").toLowerCase()&&(j[f[w].getAttribute("name")]=f[w].getAttribute("value"));D(e,j,c,d)}else n(f),d&&d(e)}else if(sa(c,!0),d){if((c=Y(c))&&typeof c.SetVariable!=da)e.success=!0,e.ref=c;d(e)}}},Y=function(a){var b=null;if((a=ga(a))&&"OBJECT"==a.nodeName)typeof a.SetVariable!=da?
...
sa=function(a,b){if(Sb){var c=b?"visible":"hidden";Ua&&ga(a)?ga(a).style.visibility=c:ab("#"+a,"visibility:"+c)}},Ca=function(a){return null!=/[\\\"<>\.;]/.exec(a)&&typeof encodeURIComponent!=da?encodeURIComponent(a):a},da="undefined",ta="object",ka="application/x-shockwave-flash",w="SWFObjectExprInst",O=window,G=document;q=navigator;var Ta=!1,d=[function(){if(Ta){var a=G.getElementsByTagName("body")[0],b=G.createElement(ta);b.setAttribute("type",ka);var c=a.appendChild(b);if(c){var d=0;(function(){if(typeof c.GetVariable!=
...
this.index,l;f.className="socketio";f.style.position="absolute";f.style.top="0px";f.style.left="0px";f.style.display="none";f.target=k;f.method="POST";f.setAttribute("accept-charset","utf-8");j.name="d";f.appendChild(j);document.body.appendChild(f);this.form=f;this.area=j}this.form.action=this.prepareUrl()+e;c();this.area.value=wa.JSON.stringify(a);try{this.form.submit()}catch(w){}this.iframe.attachEvent?l.onreadystatechange=function(){"complete"==d.iframe.readyState&&b()}:this.iframe.onload=b;this.socket.setBuffer(!0)};
...
case "Z":case "ZZ":return v;case "T":return A;case "MM":case "DD":case "YY":case "HH":case "hh":case "mm":case "ss":case "M":case "D":case "d":case "H":case "h":case "m":case "s":return ia;default:return RegExp(a.replace("\\",""))}}function s(a,b){var c=[0,0,1,0,0,0,0],e={tzh:0,tzm:0},d=b.match(fa),f,j;for(f=0;f<d.length;f++)if((j=(X(d[f]).exec(a)||[])[0])&&(a=a.slice(a.indexOf(j)+j.length)),ka[d[f]]){var k=c,l=e,q=void 0,p=void 0;switch(d[f]){case "M":case "MM":k[1]=null==j?0:~~j-1;break;case "MMM":case "MMMM":for(q=
...
c){if(null===b||""===b)return null;var e;if(j.isMoment(b))e=new f(new Date(+b._d),b._isUTC,b._lang);else{if(c)if(Q(c)){var k=b.match(ja)||[],d,l=99,q,p;for(q=0;q<c.length;q++)p=s(b,c[q]),d=N(new f(p),c[q]).match(ja)||[],d=T(k,d),d<l&&(l=d,e=p)}else e=s(b,c);else if(e=P.exec(b),b===a)e=new Date;else if(e)e=new Date(+e[1]);else if(b instanceof Date)e=b;else if(Q(b))e=W(b);else if("string"==typeof b)if(e="YYYY-MM-DDT",F.exec(b)){for(k=0;4>k;k++)if(ga[k][1].exec(b)){e+=ga[k][0];break}e=v.exec(b)?s(b,
e+" Z"):s(b,e)}else e=new Date(b);else e=new Date(b);e=new f(e)}return e};j.utc=function(a,b){return Q(a)?new f(W(a,!0),!0):("string"==typeof a&&!v.exec(a)&&(a+=" +0000",b&&(b+=" Z")),j(a,b).utc())};j.unix=function(a){return j(1E3*a)};j.duration=function(a,b){var c=j.isDuration(a),e="number"==typeof a,d=c?a._data:e?{}:a,f;return e&&(b?d[b]=a:d.milliseconds=a),f=new p(d),c&&(f._lang=a._lang),f};j.humanizeDuration=function(a,b,c){return j.duration(a,!0===b?null:b).humanize(!0===b?!0:c)};j.version="1.7.2";
...
nudgepad.MoveHandle.last_x_change,r-nudgepad.MoveHandle.last_y_change)});e="X "+parseFloat(c.css("left"))+"<br>Y "+parseFloat(c.css("top"));$("#nudgepadDimensions").css({left:10+c.right(),top:-10+c.middle()}).html(e);nudgepad.MoveHandle.last_x_change=l;nudgepad.MoveHandle.last_y_change=r;return!1};nudgepad.MoveHandle.slideend=function(){$(".handle").trigger("update").show();nudgepad.grid.removeSnaplines();$("#nudgepadDimensions").remove();nudgepad.stage.commit()};
...
Scrap.prototype.render=function(a,b){if(this.values.tag&&this.values.tag.match(/title|script|meta|head/))return this;if(this.values.tag&&this.values.tag.match(/style|link/))return this.setElementType(a),this.setContent(a),$("#nudgepadStageStyles").append(this.div.toHtml()),this;if(this.values.tag&&"body"===this.values.tag)return this.setElementType(a),this.setContent(a),this.setStyle(a),this.div.addClass("scrap"),this.div.attr("path",this.getPath()),this.div.attr("selector",this.selector()),this.div.tag=
...
Math.abs(l.y)-b+"px"));a.css(r.values.style.values);b="W "+parseFloat(a.css("width"))+"<br> H "+parseFloat(a.css("height"));$("#nudgepadDimensions").css({left:10+a.right(),top:-10+a.middle()}).html(b);$(".stretch_handle_"+r.id).trigger("update");return!1};
