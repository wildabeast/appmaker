(function(a,b){function c(j){var a=j.length,b=d.type(j);return d.isWindow(j)?!1:1===j.nodeType&&a?!0:"array"===b||"function"!==b&&(0===a||"number"==typeof a&&0<a&&a-1 in j)}function e(j,a,y,s){if(d.acceptData(j)){var c,h,Eb=d.expando,e="string"==typeof a,g=j.nodeType,n=g?d.cache:j,f=g?j[Eb]:j[Eb]&&Eb;if(f&&n[f]&&(s||n[f].data)||!e||y!==b)return f||(g?j[Eb]=f=Ca.pop()||d.guid++:f=Eb),n[f]||(n[f]={},g||(n[f].toJSON=d.noop)),("object"==typeof a||"function"==typeof a)&&(s?n[f]=d.extend(n[f],a):n[f].data=
d.extend(n[f].data,a)),c=n[f],s||(c.data||(c.data={}),c=c.data),y!==b&&(c[d.camelCase(a)]=y),e?(h=c[a],null==h&&(h=c[d.camelCase(a)])):h=c,h}}function f(j,a,b){if(d.acceptData(j)){var s,c,h,e=j.nodeType,g=e?d.cache:j,n=e?j[d.expando]:d.expando;if(g[n]){if(a&&(h=b?g[n]:g[n].data)){d.isArray(a)?a=a.concat(d.map(a,d.camelCase)):a in h?a=[a]:(a=d.camelCase(a),a=a in h?[a]:a.split(" "));s=0;for(c=a.length;c>s;s++)delete h[a[s]];if(!(b?u:d.isEmptyObject)(h))return}(b||(delete g[n].data,u(g[n])))&&(e?d.cleanData([j],
!0):d.support.deleteExpando||g!=g.window?delete g[n]:g[n]=null)}}}function p(j,a,y){if(y===b&&1===j.nodeType){var s="data-"+a.replace(wa,"-$1").toLowerCase();if(y=j.getAttribute(s),"string"==typeof y){try{y="true"===y?!0:"false"===y?!1:"null"===y?null:+y+""===y?+y:Ga.test(y)?d.parseJSON(y):y}catch(c){}d.data(j,a,y)}else y=b}return y}function u(j){for(var a in j)if(("data"!==a||!d.isEmptyObject(j[a]))&&"toJSON"!==a)return!1;return!0}function l(){return!0}function t(){return!1}function S(j,a){do j=
j[a];while(j&&1!==j.nodeType);return j}function U(j,a,b){if(a=a||0,d.isFunction(a))return d.grep(j,function(j,d){return!!a.call(j,d,j)===b});if(a.nodeType)return d.grep(j,function(j){return j===a===b});if("string"==typeof a){var s=d.grep(j,function(j){return 1===j.nodeType});if(Uc.test(a))return d.filter(a,s,!b);a=d.filter(a,s)}return d.grep(j,function(j){return 0<=d.inArray(j,a)===b})}function T(j){var a=tc.split("|");j=j.createDocumentFragment();if(j.createElement)for(;a.length;)j.createElement(a.pop());
return j}function z(j){var a=j.getAttributeNode("type");return j.type=(a&&a.specified)+"/"+j.type,j}function F(j){var a=Vc.exec(j.type);return a?j.type=a[1]:j.removeAttribute("type"),j}function V(j,a){for(var b,s=0;null!=(b=j[s]);s++)d._data(b,"globalEval",!a||d._data(a[s],"globalEval"))}function E(j,a){if(1===a.nodeType&&d.hasData(j)){var b,s,c;s=d._data(j);var h=d._data(a,s),g=s.events;if(g)for(b in delete h.handle,h.events={},g){s=0;for(c=g[b].length;c>s;s++)d.event.add(a,b,g[b][s])}h.data&&(h.data=
...
b,a in j)return a;return d}function Q(j,a){return j=a||j,"none"===d.css(j,"display")||!d.contains(j.ownerDocument,j)}function J(j,a){for(var b,s,c,h=[],g=0,e=j.length;e>g;g++)s=j[g],s.style&&(h[g]=d._data(s,"olddisplay"),b=s.style.display,a?(h[g]||"none"!==b||(s.style.display=""),""===s.style.display&&Q(s)&&(h[g]=d._data(s,"olddisplay",ga(s.nodeName)))):h[g]||(c=Q(s),(b&&"none"!==b||!c)&&d._data(s,"olddisplay",c?b:d.css(s,"display"))));for(g=0;e>g;g++)s=j[g],s.style&&(a&&"none"!==s.style.display&&
""!==s.style.display||(s.style.display=a?h[g]||"":"none"));return j}function k(j,a,b){return(j=Wc.exec(a))?Math.max(0,j[1]-(b||0))+(j[2]||"px"):a}function D(j,a,b,s,c){a=b===(s?"border":"content")?4:"width"===a?1:0;for(var h=0;4>a;a+=2)"margin"===b&&(h+=d.css(j,b+db[a],!0,c)),s?("content"===b&&(h-=d.css(j,"padding"+db[a],!0,c)),"margin"!==b&&(h-=d.css(j,"border"+db[a]+"Width",!0,c))):(h+=d.css(j,"padding"+db[a],!0,c),"padding"!==b&&(h+=d.css(j,"border"+db[a]+"Width",!0,c)));return h}function Y(j,
a,b){var s=!0,c="width"===a?j.offsetWidth:j.offsetHeight,h=eb(j),g=d.support.boxSizing&&"border-box"===d.css(j,"boxSizing",!1,h);if(0>=c||null==c){if(c=fb(j,a,h),(0>c||null==c)&&(c=j.style[a]),Ob.test(c))return c;s=g&&(d.support.boxSizingReliable||c===j.style[a]);c=parseFloat(c)||0}return c+D(j,a,b||(g?"border":"content"),s,h)+"px"}function ga(j){var a=A,b=vc[j];return b||(b=W(j,a),"none"!==b&&b||(Fb=(Fb||d("<iframe frameborder='0' width='0' height='0'/>").css("cssText","display:block !important")).appendTo(a.documentElement),
...
(b=a,a="*");var s,c=0,h=a.toLowerCase().match(Ba)||[];if(d.isFunction(b))for(;s=h[c++];)"+"===s[0]?(s=s.slice(1)||"*",(j[s]=j[s]||[]).unshift(b)):(j[s]=j[s]||[]).push(b)}}function ca(j,a,y,s){function c(e){var n;return h[e]=!0,d.each(j[e]||[],function(j,d){var e=d(a,y,s);return"string"!=typeof e||g||h[e]?g?!(n=e):b:(a.dataTypes.unshift(e),c(e),!1)}),n}var h={},g=j===cc;return c(a.dataTypes[0])||!h["*"]&&c("*")}function O(j,a){var y,s,c=d.ajaxSettings.flatOptions||{};for(s in a)a[s]!==b&&((c[s]?j:
y||(y={}))[s]=a[s]);return y&&d.extend(!0,j,y),j}function ja(){try{return new a.XMLHttpRequest}catch(j){}}function ea(){return setTimeout(function(){nb=b}),nb=d.now()}function H(j,a,b){var s,c,h=0,g=Pb.length,e=d.Deferred().always(function(){delete n.elem}),n=function(){if(c)return!1;for(var a=nb||ea(),a=Math.max(0,f.startTime+f.duration-a),b=1-(a/f.duration||0),C=0,d=f.tweens.length;d>C;C++)f.tweens[C].run(b);return e.notifyWith(j,[f,b,a]),1>b&&d?a:(e.resolveWith(j,[f]),!1)},f=e.promise({elem:j,
props:d.extend({},a),opts:d.extend(!0,{specialEasing:{}},b),originalProperties:a,originalOptions:b,startTime:nb||ea(),duration:b.duration,tweens:[],createTween:function(a,b){var C=d.Tween(j,f.opts,a,b,f.opts.specialEasing[a]||f.opts.easing);return f.tweens.push(C),C},stop:function(a){var b=0,C=a?f.tweens.length:0;if(c)return this;for(c=!0;C>b;b++)f.tweens[b].run(1);return a?e.resolveWith(j,[f,a]):e.rejectWith(j,[f,a]),this}});a=f.props;b=f.opts.specialEasing;var q,r,B,k;for(r in a)if(q=d.camelCase(r),
B=b[q],s=a[r],d.isArray(s)&&(B=s[1],s=a[r]=s[0]),r!==q&&(a[q]=s,delete a[r]),k=d.cssHooks[q],k&&"expand"in k)for(r in s=k.expand(s),delete a[q],s)r in a||(a[r]=s[r],b[r]=B);else b[q]=B;for(;g>h;h++)if(s=Pb[h].call(f,j,a,f.opts))return s;var v=f;d.each(a,function(j,a){for(var b=(Gb[j]||[]).concat(Gb["*"]),C=0,d=b.length;d>C&&!b[C].call(v,j,a);C++);});return d.isFunction(f.opts.start)&&f.opts.start.call(j,f),d.fx.timer(d.extend(n,{elem:j,anim:f,queue:f.opts.queue})),f.progress(f.opts.progress).done(f.opts.done,
f.opts.complete).fail(f.opts.fail).always(f.opts.always)}function M(j,a,b,d,c){return new M.prototype.init(j,a,b,d,c)}function g(j,a){var b,d={height:j},c=0;for(a=a?1:0;4>c;c+=2-a)b=db[c],d["margin"+b]=d["padding"+b]=j;return a&&(d.opacity=d.width=j),d}function x(j){return d.isWindow(j)?j:9===j.nodeType?j.defaultView||j.parentWindow:!1}var q,r,L=typeof b,A=a.document,fa=a.location,Wa=a.jQuery,Xa=a.$,sa={},Ca=[],ha=Ca.concat,ta=Ca.push,ka=Ca.slice,v=Ca.indexOf,Z=sa.toString,K=sa.hasOwnProperty,Ya=
"1.9.1".trim,d=function(j,a){return new d.fn.init(j,a,r)},Da=/[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,Ba=/\S+/g,Za=/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,gb=/^(?:(<[\w\W]+>)[^>]*|#([\w-]*))$/,hb=/^<(\w+)\s*\/?>(?:<\/\1>|)$/,Hb=/^[\],:{}\s]*$/,Qb=/(?:^|:|,)(?:\s*\[)+/g,Qa=/\\(?:["\\\/bfnrt]|u[\da-fA-F]{4})/g,ob=/"[^"\\\r\n]*"|true|false|null|-?(?:\d+\.|)\d+(?:[eE][+-]?\d+|)/g,Ja=/^-ms-/,Ib=/-([\da-z])/gi,Rb=function(j,a){return a.toUpperCase()},G=function(j){(A.addEventListener||"load"===j.type||
"complete"===A.readyState)&&(Ra(),d.ready())},Ra=function(){A.addEventListener?(A.removeEventListener("DOMContentLoaded",G,!1),a.removeEventListener("load",G,!1)):(A.detachEvent("onreadystatechange",G),a.detachEvent("onload",G))};d.fn=d.prototype={jquery:"1.9.1",constructor:d,init:function(j,a,y){var s,c;if(!j)return this;if("string"==typeof j){if(s="<"===j.charAt(0)&&">"===j.charAt(j.length-1)&&3<=j.length?[null,j,null]:gb.exec(j),!s||!s[1]&&a)return!a||a.jquery?(a||y).find(j):this.constructor(a).find(j);
if(s[1]){if(a=a instanceof d?a[0]:a,d.merge(this,d.parseHTML(s[1],a&&a.nodeType?a.ownerDocument||a:A,!0)),hb.test(s[1])&&d.isPlainObject(a))for(s in a)d.isFunction(this[s])?this[s](a[s]):this.attr(s,a[s]);return this}if(c=A.getElementById(s[2]),c&&c.parentNode){if(c.id!==s[2])return y.find(j);this.length=1;this[0]=c}return this.context=A,this.selector=j,this}return j.nodeType?(this.context=this[0]=j,this.length=1,this):d.isFunction(j)?y.ready(j):(j.selector!==b&&(this.selector=j.selector,this.context=
...
last:function(){return this.eq(-1)},eq:function(j){var a=this.length;j=+j+(0>j?a:0);return this.pushStack(0<=j&&a>j?[this[j]]:[])},map:function(j){return this.pushStack(d.map(this,function(a,b){return j.call(a,b,a)}))},end:function(){return this.prevObject||this.constructor(null)},push:ta,sort:[].sort,splice:[].splice};d.fn.init.prototype=d.fn;d.extend=d.fn.extend=function(){var j,a,y,s,c,h,g=arguments[0]||{},e=1,f=arguments.length,n=!1;"boolean"==typeof g&&(n=g,g=arguments[1]||{},e=2);"object"==
typeof g||d.isFunction(g)||(g={});for(f===e&&(g=this,--e);f>e;e++)if(null!=(c=arguments[e]))for(s in c)j=g[s],y=c[s],g!==y&&(n&&y&&(d.isPlainObject(y)||(a=d.isArray(y)))?(a?(a=!1,h=j&&d.isArray(j)?j:[]):h=j&&d.isPlainObject(j)?j:{},g[s]=d.extend(n,h,y)):y!==b&&(g[s]=y));return g};d.extend({noConflict:function(j){return a.$===d&&(a.$=Xa),j&&a.jQuery===d&&(a.jQuery=Wa),d},isReady:!1,readyWait:1,holdReady:function(j){j?d.readyWait++:d.ready(!0)},ready:function(j){if(!0===j?!--d.readyWait:!d.isReady){if(!A.body)return setTimeout(d.ready);
...
j.nodeType||d.isWindow(j))return!1;try{if(j.constructor&&!K.call(j,"constructor")&&!K.call(j.constructor.prototype,"isPrototypeOf"))return!1}catch(a){return!1}for(var y in j);return y===b||K.call(j,y)},isEmptyObject:function(j){for(var a in j)return!1;return!0},error:function(j){throw Error(j);},parseHTML:function(j,a,b){if(!j||"string"!=typeof j)return null;"boolean"==typeof a&&(b=a,a=!1);a=a||A;var s=hb.exec(j);b=!b&&[];return s?[a.createElement(s[1])]:(s=d.buildFragment([j],a,b),b&&d(b).remove(),
d.merge([],s.childNodes))},parseJSON:function(j){return a.JSON&&a.JSON.parse?a.JSON.parse(j):null===j?j:"string"==typeof j&&(j=d.trim(j),j&&Hb.test(j.replace(Qa,"@").replace(ob,"]").replace(Qb,"")))?Function("return "+j)():(d.error("Invalid JSON: "+j),b)},parseXML:function(j){var C,y;if(!j||"string"!=typeof j)return null;try{a.DOMParser?(y=new DOMParser,C=y.parseFromString(j,"text/xml")):(C=new ActiveXObject("Microsoft.XMLDOM"),C.async="false",C.loadXML(j))}catch(s){C=b}return C&&C.documentElement&&
!C.getElementsByTagName("parsererror").length||d.error("Invalid XML: "+j),C},noop:function(){},globalEval:function(j){j&&d.trim(j)&&(a.execScript||function(j){a.eval.call(a,j)})(j)},camelCase:function(j){return j.replace(Ja,"ms-").replace(Ib,Rb)},nodeName:function(j,a){return j.nodeName&&j.nodeName.toLowerCase()===a.toLowerCase()},each:function(j,a,b){var d,h=0,g=j.length,e=c(j);if(b)if(e)for(;g>h&&!(d=a.apply(j[h],b),!1===d);h++);else for(h in j){if(d=a.apply(j[h],b),!1===d)break}else if(e)for(;g>
h&&!(d=a.call(j[h],h,j[h]),!1===d);h++);else for(h in j)if(d=a.call(j[h],h,j[h]),!1===d)break;return j},trim:Ya&&!Ya.call("\ufeff\u00a0")?function(j){return null==j?"":Ya.call(j)}:function(j){return null==j?"":(j+"").replace(Za,"")},makeArray:function(j,a){var b=a||[];return null!=j&&(c(Object(j))?d.merge(b,"string"==typeof j?[j]:j):ta.call(b,j)),b},inArray:function(j,a,b){var d;if(a){if(v)return v.call(a,j,b);d=a.length;for(b=b?0>b?Math.max(0,d+b):b:0;d>b;b++)if(b in a&&a[b]===j)return b}return-1},
merge:function(j,a){var d=a.length,s=j.length,c=0;if("number"==typeof d)for(;d>c;c++)j[s++]=a[c];else for(;a[c]!==b;)j[s++]=a[c++];return j.length=s,j},grep:function(j,a,b){var d,c=[],h=0,g=j.length;for(b=!!b;g>h;h++)d=!!a(j[h],h),b!==d&&c.push(j[h]);return c},map:function(j,a,b){var d,h=0,g=j.length,e=[];if(c(j))for(;g>h;h++)d=a(j[h],h,b),null!=d&&(e[e.length]=d);else for(h in j)d=a(j[h],h,b),null!=d&&(e[e.length]=d);return ha.apply([],e)},guid:1,proxy:function(j,a){var y,c,h;return"string"==typeof a&&
(h=j[a],a=j,j=h),d.isFunction(j)?(y=ka.call(arguments,2),c=function(){return j.apply(a||this,y.concat(ka.call(arguments)))},c.guid=j.guid=j.guid||d.guid++,c):b},access:function(j,a,y,c,h,g,e){var f=0,n=j.length,q=null==y;if("object"===d.type(y))for(f in h=!0,y)d.access(j,a,f,y[f],!0,g,e);else if(c!==b&&(h=!0,d.isFunction(c)||(e=!0),q&&(e?(a.call(j,c),a=null):(q=a,a=function(j,a,b){return q.call(d(j),b)})),a))for(;n>f;f++)a(j[f],y,e?c:c.call(j[f],f,a(j[f],y)));return h?j:q?a.call(j):n?a(j[0],y):g},
now:function(){return(new Date).getTime()}});d.ready.promise=function(j){if(!q)if(q=d.Deferred(),"complete"===A.readyState)setTimeout(d.ready);else if(A.addEventListener)A.addEventListener("DOMContentLoaded",G,!1),a.addEventListener("load",G,!1);else{A.attachEvent("onreadystatechange",G);a.attachEvent("onload",G);var b=!1;try{b=null==a.frameElement&&A.documentElement}catch(y){}b&&b.doScroll&&function Tc(){if(!d.isReady){try{b.doScroll("left")}catch(j){return setTimeout(Tc,50)}Ra();d.ready()}}()}return q.promise(j)};
d.each("Boolean Number String Function Array Date RegExp Object Error".split(" "),function(j,a){sa["[object "+a+"]"]=a.toLowerCase()});r=d(A);var Sa={};d.Callbacks=function(j){var a;if("string"==typeof j){if(!(a=Sa[j])){a=j;var y=Sa[a]={};a=(d.each(a.match(Ba)||[],function(j,a){y[a]=!0}),y)}}else a=d.extend({},j);j=a;var c,h,g,e,f,n,q=[],r=!j.once&&[],B=function(a){h=j.memory&&a;g=!0;f=n||0;n=0;e=q.length;for(c=!0;q&&e>f;f++)if(!1===q[f].apply(a[0],a[1])&&j.stopOnFalse){h=!1;break}c=!1;q&&(r?r.length&&
B(r.shift()):h?q=[]:k.disable())},k={add:function(){if(q){var a=q.length;(function Yc(a){d.each(a,function(a,b){var C=d.type(b);"function"===C?j.unique&&k.has(b)||q.push(b):b&&b.length&&"string"!==C&&Yc(b)})})(arguments);c?e=q.length:h&&(n=a,B(h))}return this},remove:function(){return q&&d.each(arguments,function(j,a){for(var b;-1<(b=d.inArray(a,q,b));)q.splice(b,1),c&&(e>=b&&e--,f>=b&&f--)}),this},has:function(j){return j?-1<d.inArray(j,q):!(!q||!q.length)},empty:function(){return q=[],this},disable:function(){return q=
r=h=b,this},disabled:function(){return!q},lock:function(){return r=b,h||k.disable(),this},locked:function(){return!r},fireWith:function(j,a){return a=a||[],a=[j,a.slice?a.slice():a],!q||g&&!r||(c?r.push(a):B(a)),this},fire:function(){return k.fireWith(this,arguments),this},fired:function(){return!!g}};return k};d.extend({Deferred:function(j){var a=[["resolve","done",d.Callbacks("once memory"),"resolved"],["reject","fail",d.Callbacks("once memory"),"rejected"],["notify","progress",d.Callbacks("memory")]],
b="pending",c={state:function(){return b},always:function(){return h.done(arguments).fail(arguments),this},then:function(){var j=arguments;return d.Deferred(function(b){d.each(a,function(a,C){var y=C[0],g=d.isFunction(j[a])&&j[a];h[C[1]](function(){var j=g&&g.apply(this,arguments);j&&d.isFunction(j.promise)?j.promise().done(b.resolve).fail(b.reject).progress(b.notify):b[y+"With"](this===c?b.promise():this,g?[j]:arguments)})});j=null}).promise()},promise:function(j){return null!=j?d.extend(j,c):c}},
h={};return c.pipe=c.then,d.each(a,function(j,d){var g=d[2],e=d[3];c[d[1]]=g.add;e&&g.add(function(){b=e},a[1^j][2].disable,a[2][2].lock);h[d[0]]=function(){return h[d[0]+"With"](this===h?c:this,arguments),this};h[d[0]+"With"]=g.fireWith}),c.promise(h),j&&j.call(h,h),h},when:function(j){var a=0,b=ka.call(arguments),c=b.length,h=1!==c||j&&d.isFunction(j.promise)?c:0,g=1===h?j:d.Deferred(),e=function(j,a,b){return function(d){a[j]=this;b[j]=1<arguments.length?ka.call(arguments):d;b===f?g.notifyWith(a,
b):--h||g.resolveWith(a,b)}},f,n,q;if(1<c){f=Array(c);n=Array(c);for(q=Array(c);c>a;a++)b[a]&&d.isFunction(b[a].promise)?b[a].promise().done(e(a,q,b)).fail(g.reject).progress(e(a,n,f)):--h}return h||g.resolveWith(q,b),g.promise()}});var dc=d,ib;var da,ia,R,na,oa,ua,Ha,la,Ma,qa,N=A.createElement("div");if(N.setAttribute("className","t"),N.innerHTML="  <link/><table></table><a href='/a'>a</a><input type='checkbox'/>",ia=N.getElementsByTagName("*"),R=N.getElementsByTagName("a")[0],!ia||!R||!ia.length)ib=
...
j.nodeName&&d.noData[j.nodeName.toLowerCase()];return!a||!0!==a&&j.getAttribute("classid")===a}});d.fn.extend({data:function(j,a){var c,s,h=this[0],g=0,e=null;if(j===b){if(this.length&&(e=d.data(h),1===h.nodeType&&!d._data(h,"parsedAttrs"))){for(c=h.attributes;c.length>g;g++)s=c[g].name,s.indexOf("data-")||(s=d.camelCase(s.slice(5)),p(h,s,e[s]));d._data(h,"parsedAttrs",!0)}return e}return"object"==typeof j?this.each(function(){d.data(this,j)}):d.access(this,function(a){return a===b?h?p(h,j,d.data(h,
j)):null:(this.each(function(){d.data(this,j,a)}),b)},null,a,1<arguments.length,null,!0)},removeData:function(j){return this.each(function(){d.removeData(this,j)})}});d.extend({queue:function(j,a,c){var s;return j?(a=(a||"fx")+"queue",s=d._data(j,a),c&&(!s||d.isArray(c)?s=d._data(j,a,d.makeArray(c)):s.push(c)),s||[]):b},dequeue:function(a,b){b=b||"fx";var c=d.queue(a,b),s=c.length,h=c.shift(),g=d._queueHooks(a,b),e=function(){d.dequeue(a,b)};"inprogress"===h&&(h=c.shift(),s--);(g.cur=h)&&("fx"===
b&&c.unshift("inprogress"),delete g.stop,h.call(a,e,g));!s&&g&&g.empty.fire()},_queueHooks:function(a,b){var c=b+"queueHooks";return d._data(a,c)||d._data(a,c,{empty:d.Callbacks("once memory").add(function(){d._removeData(a,b+"queue");d._removeData(a,c)})})}});d.fn.extend({queue:function(a,C){var c=2;return"string"!=typeof a&&(C=a,a="fx",c--),c>arguments.length?d.queue(this[0],a):C===b?this:this.each(function(){var b=d.queue(this,a,C);d._queueHooks(this,a);"fx"===a&&"inprogress"!==b[0]&&d.dequeue(this,
a)})},dequeue:function(a){return this.each(function(){d.dequeue(this,a)})},delay:function(a,b){return a=d.fx?d.fx.speeds[a]||a:a,b=b||"fx",this.queue(b,function(b,d){var C=setTimeout(b,a);d.stop=function(){clearTimeout(C)}})},clearQueue:function(a){return this.queue(a||"fx",[])},promise:function(a,C){var c,s=1,h=d.Deferred(),g=this,e=this.length,f=function(){--s||h.resolveWith(g,[g])};"string"!=typeof a&&(C=a,a=b);for(a=a||"fx";e--;)(c=d._data(g[e],a+"queueHooks"))&&c.empty&&(s++,c.empty.add(f));
return f(),h.promise(C)}});var xa,va,h=/[\t\r\n]/g,n=/\r/g,B=/^(?:input|select|textarea|button|object)$/i,ra=/^(?:a|area)$/i,Ta=/^(?:checked|selected|autofocus|autoplay|async|controls|defer|disabled|hidden|loop|multiple|open|readonly|required|scoped)$/i,pb=/^(?:checked|selected)$/i,Ea=d.support.getSetAttribute,qb=d.support.input;d.fn.extend({attr:function(a,b){return d.access(this,d.attr,a,b,1<arguments.length)},removeAttr:function(a){return this.each(function(){d.removeAttr(this,a)})},prop:function(a,
b){return d.access(this,d.prop,a,b,1<arguments.length)},removeProp:function(a){return a=d.propFix[a]||a,this.each(function(){try{this[a]=b,delete this[a]}catch(d){}})},addClass:function(a){var b,c,s,g,e,f=0,n=this.length;b="string"==typeof a&&a;if(d.isFunction(a))return this.each(function(b){d(this).addClass(a.call(this,b,this.className))});if(b)for(b=(a||"").match(Ba)||[];n>f;f++)if(c=this[f],s=1===c.nodeType&&(c.className?(" "+c.className+" ").replace(h," "):" ")){for(e=0;g=b[e++];)0>s.indexOf(" "+
g+" ")&&(s+=g+" ");c.className=d.trim(s)}return this},removeClass:function(a){var b,c,s,g,e,f=0,n=this.length;b=0===arguments.length||"string"==typeof a&&a;if(d.isFunction(a))return this.each(function(b){d(this).removeClass(a.call(this,b,this.className))});if(b)for(b=(a||"").match(Ba)||[];n>f;f++)if(c=this[f],s=1===c.nodeType&&(c.className?(" "+c.className+" ").replace(h," "):"")){for(e=0;g=b[e++];)for(;0<=s.indexOf(" "+g+" ");)s=s.replace(" "+g+" "," ");c.className=a?d.trim(s):""}return this},toggleClass:function(a,
b){var c=typeof a,s="boolean"==typeof b;return d.isFunction(a)?this.each(function(c){d(this).toggleClass(a.call(this,c,this.className,b),b)}):this.each(function(){if("string"===c)for(var h,g=0,e=d(this),f=b,n=a.match(Ba)||[];h=n[g++];)f=s?f:!e.hasClass(h),e[f?"addClass":"removeClass"](h);else(c===L||"boolean"===c)&&(this.className&&d._data(this,"__className__",this.className),this.className=this.className||!1===a?"":d._data(this,"__className__")||"")})},hasClass:function(a){a=" "+a+" ";for(var b=
0,d=this.length;d>b;b++)if(1===this[b].nodeType&&0<=(" "+this[b].className+" ").replace(h," ").indexOf(a))return!0;return!1},val:function(a){var c,y,h,g=this[0];if(arguments.length)return h=d.isFunction(a),this.each(function(c){var C,g=d(this);1===this.nodeType&&(C=h?a.call(this,c,g.val()):a,null==C?C="":"number"==typeof C?C+="":d.isArray(C)&&(C=d.map(C,function(a){return null==a?"":a+""})),y=d.valHooks[this.type]||d.valHooks[this.nodeName.toLowerCase()],y&&"set"in y&&y.set(this,C,"value")!==b||(this.value=
C))});if(g)return y=d.valHooks[g.type]||d.valHooks[g.nodeName.toLowerCase()],y&&"get"in y&&(c=y.get(g,"value"))!==b?c:(c=g.value,"string"==typeof c?c.replace(n,""):null==c?"":c)}});d.extend({valHooks:{option:{get:function(a){var b=a.attributes.value;return!b||b.specified?a.value:a.text}},select:{get:function(a){for(var b,c=a.options,h=a.selectedIndex,g="select-one"===a.type||0>h,e=g?null:[],f=g?h+1:c.length,n=0>h?f:g?h:0;f>n;n++)if(b=c[n],!(!b.selected&&n!==h||(d.support.optDisabled?b.disabled:null!==
b.getAttribute("disabled"))||b.parentNode.disabled&&d.nodeName(b.parentNode,"optgroup"))){if(a=d(b).val(),g)return a;e.push(a)}return e},set:function(a,b){var c=d.makeArray(b);return d(a).find("option").each(function(){this.selected=0<=d.inArray(d(this).val(),c)}),c.length||(a.selectedIndex=-1),c}}},attr:function(a,c,y){var h,g,e,f=a.nodeType;if(a&&3!==f&&8!==f&&2!==f)return typeof a.getAttribute===L?d.prop(a,c,y):(g=1!==f||!d.isXMLDoc(a),g&&(c=c.toLowerCase(),h=d.attrHooks[c]||(Ta.test(c)?va:xa)),
y===b?h&&g&&"get"in h&&null!==(e=h.get(a,c))?e:(typeof a.getAttribute!==L&&(e=a.getAttribute(c)),null==e?b:e):null!==y?h&&g&&"set"in h&&(e=h.set(a,y,c))!==b?e:(a.setAttribute(c,y+""),y):(d.removeAttr(a,c),b))},removeAttr:function(a,b){var c,h,g=0,e=b&&b.match(Ba);if(e&&1===a.nodeType)for(;c=e[g++];)h=d.propFix[c]||c,Ta.test(c)?!Ea&&pb.test(c)?a[d.camelCase("default-"+c)]=a[h]=!1:a[h]=!1:d.attr(a,c,""),a.removeAttribute(Ea?c:h)},attrHooks:{type:{set:function(a,b){if(!d.support.radioValue&&"radio"===
b&&d.nodeName(a,"input")){var c=a.value;return a.setAttribute("type",b),c&&(a.value=c),b}}}},propFix:{tabindex:"tabIndex",readonly:"readOnly","for":"htmlFor","class":"className",maxlength:"maxLength",cellspacing:"cellSpacing",cellpadding:"cellPadding",rowspan:"rowSpan",colspan:"colSpan",usemap:"useMap",frameborder:"frameBorder",contenteditable:"contentEditable"},prop:function(a,c,h){var s,g,e,f=a.nodeType;if(a&&3!==f&&8!==f&&2!==f)return e=1!==f||!d.isXMLDoc(a),e&&(c=d.propFix[c]||c,g=d.propHooks[c]),
h!==b?g&&"set"in g&&(s=g.set(a,h,c))!==b?s:a[c]=h:g&&"get"in g&&null!==(s=g.get(a,c))?s:a[c]},propHooks:{tabIndex:{get:function(a){var d=a.getAttributeNode("tabindex");return d&&d.specified?parseInt(d.value,10):B.test(a.nodeName)||ra.test(a.nodeName)&&a.href?0:b}}}});va={get:function(a,c){var h=d.prop(a,c),s="boolean"==typeof h&&a.getAttribute(c);return(h="boolean"==typeof h?qb&&Ea?null!=s:pb.test(c)?a[d.camelCase("default-"+c)]:!!s:a.getAttributeNode(c))&&!1!==h.value?c.toLowerCase():b},set:function(a,
b,c){return!1===b?d.removeAttr(a,c):qb&&Ea||!pb.test(c)?a.setAttribute(!Ea&&d.propFix[c]||c,c):a[d.camelCase("default-"+c)]=a[c]=!0,c}};qb&&Ea||(d.attrHooks.value={get:function(a,c){var h=a.getAttributeNode(c);return d.nodeName(a,"input")?a.defaultValue:h&&h.specified?h.value:b},set:function(a,c,h){return d.nodeName(a,"input")?(a.defaultValue=c,b):xa&&xa.set(a,c,h)}});Ea||(xa=d.valHooks.button={get:function(a,d){var c=a.getAttributeNode(d);return c&&("id"===d||"name"===d||"coords"===d?""!==c.value:
...
null}}));d.support.enctype||(d.propFix.enctype="encoding");d.support.checkOn||d.each(["radio","checkbox"],function(){d.valHooks[this]={get:function(a){return null===a.getAttribute("value")?"on":a.value}}});d.each(["radio","checkbox"],function(){d.valHooks[this]=d.extend(d.valHooks[this],{set:function(a,c){return d.isArray(c)?a.checked=0<=d.inArray(d(a).val(),c):b}})});var rb=/^(?:input|select|textarea)$/i,Na=/^key/,Sb=/^(?:mouse|contextmenu)|click/,Jb=/^(?:focusinfocus|focusoutblur)$/,Kb=/^([^.]*)(?:\.(.+)|)$/;
d.event={global:{},add:function(a,c,h,s,g){var e,f,n,q,r,B,k,v,x;if(n=d._data(a)){h.handler&&(q=h,h=q.handler,g=q.selector);h.guid||(h.guid=d.guid++);(f=n.events)||(f=n.events={});(r=n.handle)||(r=n.handle=function(a){return typeof d===L||a&&d.event.triggered===a.type?b:d.event.dispatch.apply(r.elem,arguments)},r.elem=a);c=(c||"").match(Ba)||[""];for(n=c.length;n--;)e=Kb.exec(c[n])||[],v=B=e[1],x=(e[2]||"").split(".").sort(),e=d.event.special[v]||{},v=(g?e.delegateType:e.bindType)||v,e=d.event.special[v]||
{},B=d.extend({type:v,origType:B,data:s,handler:h,guid:h.guid,selector:g,needsContext:g&&d.expr.match.needsContext.test(g),namespace:x.join(".")},q),(k=f[v])||(k=f[v]=[],k.delegateCount=0,e.setup&&!1!==e.setup.call(a,s,x,r)||(a.addEventListener?a.addEventListener(v,r,!1):a.attachEvent&&a.attachEvent("on"+v,r))),e.add&&(e.add.call(a,B),B.handler.guid||(B.handler.guid=h.guid)),g?k.splice(k.delegateCount++,0,B):k.push(B),d.event.global[v]=!0;a=null}},remove:function(a,b,c,h,g){var e,f,n,q,r,B,k,v,x,
L,m,l=d.hasData(a)&&d._data(a);if(l&&(B=l.events)){b=(b||"").match(Ba)||[""];for(r=b.length;r--;)if(n=Kb.exec(b[r])||[],x=m=n[1],L=(n[2]||"").split(".").sort(),x){k=d.event.special[x]||{};x=(h?k.delegateType:k.bindType)||x;v=B[x]||[];n=n[2]&&RegExp("(^|\\.)"+L.join("\\.(?:.*\\.|)")+"(\\.|$)");for(q=e=v.length;e--;)f=v[e],!g&&m!==f.origType||c&&c.guid!==f.guid||n&&!n.test(f.namespace)||h&&h!==f.selector&&("**"!==h||!f.selector)||(v.splice(e,1),f.selector&&v.delegateCount--,k.remove&&k.remove.call(a,
f));q&&!v.length&&(k.teardown&&!1!==k.teardown.call(a,L,l.handle)||d.removeEvent(a,x,l.handle),delete B[x])}else for(x in B)d.event.remove(a,x+b[r],c,h,!0);d.isEmptyObject(B)&&(delete l.handle,d._removeData(a,"events"))}},trigger:function(j,c,h,s){var g,e,f,n,q,r,B=[h||A],k=K.call(j,"type")?j.type:j;r=K.call(j,"namespace")?j.namespace.split("."):[];if(f=g=h=h||A,3!==h.nodeType&&8!==h.nodeType&&!Jb.test(k+d.event.triggered)&&(0<=k.indexOf(".")&&(r=k.split("."),k=r.shift(),r.sort()),e=0>k.indexOf(":")&&
"on"+k,j=j[d.expando]?j:new d.Event(k,"object"==typeof j&&j),j.isTrigger=!0,j.namespace=r.join("."),j.namespace_re=j.namespace?RegExp("(^|\\.)"+r.join("\\.(?:.*\\.|)")+"(\\.|$)"):null,j.result=b,j.target||(j.target=h),c=null==c?[j]:d.makeArray(c,[j]),q=d.event.special[k]||{},s||!q.trigger||!1!==q.trigger.apply(h,c))){if(!s&&!q.noBubble&&!d.isWindow(h)){n=q.delegateType||k;for(Jb.test(n+k)||(f=f.parentNode);f;f=f.parentNode)B.push(f),g=f;g===(h.ownerDocument||A)&&B.push(g.defaultView||g.parentWindow||
a)}for(r=0;(f=B[r++])&&!j.isPropagationStopped();)j.type=1<r?n:q.bindType||k,(g=(d._data(f,"events")||{})[j.type]&&d._data(f,"handle"))&&g.apply(f,c),(g=e&&f[e])&&d.acceptData(f)&&g.apply&&!1===g.apply(f,c)&&j.preventDefault();if(j.type=k,!(s||j.isDefaultPrevented()||q._default&&!1!==q._default.apply(h.ownerDocument,c)||"click"===k&&d.nodeName(h,"a")||!d.acceptData(h)||!e||!h[k]||d.isWindow(h))){(g=h[e])&&(h[e]=null);d.event.triggered=k;try{h[k]()}catch(v){}d.event.triggered=b;g&&(h[e]=g)}return j.result}},
dispatch:function(a){a=d.event.fix(a);var c,h,s,g,e,f=[],n=ka.call(arguments);c=(d._data(this,"events")||{})[a.type]||[];var q=d.event.special[a.type]||{};if(n[0]=a,a.delegateTarget=this,!q.preDispatch||!1!==q.preDispatch.call(this,a)){f=d.event.handlers.call(this,a,c);for(c=0;(g=f[c++])&&!a.isPropagationStopped();){a.currentTarget=g.elem;for(e=0;(s=g.handlers[e++])&&!a.isImmediatePropagationStopped();)(!a.namespace_re||a.namespace_re.test(s.namespace))&&(a.handleObj=s,a.data=s.data,h=((d.event.special[s.origType]||
{}).handle||s.handler).apply(g.elem,n),h!==b&&!1===(a.result=h)&&(a.preventDefault(),a.stopPropagation()))}return q.postDispatch&&q.postDispatch.call(this,a),a.result}},handlers:function(a,c){var h,s,g,e,f=[],n=c.delegateCount,q=a.target;if(n&&q.nodeType&&(!a.button||"click"!==a.type))for(;q!=this;q=q.parentNode||this)if(1===q.nodeType&&(!0!==q.disabled||"click"!==a.type)){g=[];for(e=0;n>e;e++)s=c[e],h=s.selector+" ",g[h]===b&&(g[h]=s.needsContext?0<=d(h,this).index(q):d.find(h,this,null,[q]).length),
g[h]&&g.push(s);g.length&&f.push({elem:q,handlers:g})}return c.length>n&&f.push({elem:this,handlers:c.slice(n)}),f},fix:function(a){if(a[d.expando])return a;var b,c,h;b=a.type;var g=a,e=this.fixHooks[b];e||(this.fixHooks[b]=e=Sb.test(b)?this.mouseHooks:Na.test(b)?this.keyHooks:{});h=e.props?this.props.concat(e.props):this.props;a=new d.Event(g);for(b=h.length;b--;)c=h[b],a[c]=g[c];return a.target||(a.target=g.srcElement||A),3===a.target.nodeType&&(a.target=a.target.parentNode),a.metaKey=!!a.metaKey,
e.filter?e.filter(a,g):a},props:"altKey bubbles cancelable ctrlKey currentTarget eventPhase metaKey relatedTarget shiftKey target timeStamp view which".split(" "),fixHooks:{},keyHooks:{props:["char","charCode","key","keyCode"],filter:function(a,b){return null==a.which&&(a.which=null!=b.charCode?b.charCode:b.keyCode),a}},mouseHooks:{props:"button buttons clientX clientY fromElement offsetX offsetY pageX pageY screenX screenY toElement".split(" "),filter:function(a,c){var d,h,g,e=c.button,f=c.fromElement;
return null==a.pageX&&null!=c.clientX&&(h=a.target.ownerDocument||A,g=h.documentElement,d=h.body,a.pageX=c.clientX+(g&&g.scrollLeft||d&&d.scrollLeft||0)-(g&&g.clientLeft||d&&d.clientLeft||0),a.pageY=c.clientY+(g&&g.scrollTop||d&&d.scrollTop||0)-(g&&g.clientTop||d&&d.clientTop||0)),!a.relatedTarget&&f&&(a.relatedTarget=f===a.target?c.toElement:f),a.which||e===b||(a.which=1&e?1:2&e?3:4&e?2:0),a}},special:{load:{noBubble:!0},click:{trigger:function(){return d.nodeName(this,"input")&&"checkbox"===this.type&&
...
"input")||d.nodeName(a,"button")?a.form:b)&&!d._data(a,"submitBubbles")&&(d.event.add(a,"submit._submit",function(a){a._submit_bubble=!0}),d._data(a,"submitBubbles",!0))}),b)},postDispatch:function(a){a._submit_bubble&&(delete a._submit_bubble,this.parentNode&&!a.isTrigger&&d.event.simulate("submit",this.parentNode,a,!0))},teardown:function(){return d.nodeName(this,"form")?!1:(d.event.remove(this,"._submit"),b)}});d.support.changeBubbles||(d.event.special.change={setup:function(){return rb.test(this.nodeName)?
(("checkbox"===this.type||"radio"===this.type)&&(d.event.add(this,"propertychange._change",function(a){"checked"===a.originalEvent.propertyName&&(this._just_changed=!0)}),d.event.add(this,"click._change",function(a){this._just_changed&&!a.isTrigger&&(this._just_changed=!1);d.event.simulate("change",this,a,!0)})),!1):(d.event.add(this,"beforeactivate._change",function(a){a=a.target;rb.test(a.nodeName)&&!d._data(a,"changeBubbles")&&(d.event.add(a,"change._change",function(a){!this.parentNode||a.isSimulated||
a.isTrigger||d.event.simulate("change",this.parentNode,a,!0)}),d._data(a,"changeBubbles",!0))}),b)},handle:function(a){var c=a.target;return this!==c||a.isSimulated||a.isTrigger||"radio"!==c.type&&"checkbox"!==c.type?a.handleObj.handler.apply(this,arguments):b},teardown:function(){return d.event.remove(this,"._change"),!rb.test(this.nodeName)}});d.support.focusinBubbles||d.each({focus:"focusin",blur:"focusout"},function(a,b){var c=0,h=function(a){d.event.simulate(b,a.target,d.event.fix(a),!0)};d.event.special[b]=
{setup:function(){0===c++&&A.addEventListener(a,h,!0)},teardown:function(){0===--c&&A.removeEventListener(a,h,!0)}}});d.fn.extend({on:function(a,c,h,s,g){var e,f;if("object"==typeof a){"string"!=typeof c&&(h=h||c,c=b);for(e in a)this.on(e,c,h,a[e],g);return this}if(null==h&&null==s?(s=c,h=c=b):null==s&&("string"==typeof c?(s=h,h=b):(s=h,h=c,c=b)),!1===s)s=t;else if(!s)return this;return 1===g&&(f=s,s=function(a){return d().off(a),f.apply(this,arguments)},s.guid=f.guid||(f.guid=d.guid++)),this.each(function(){d.event.add(this,
a,s,h,c)})},one:function(a,b,c,d){return this.on(a,b,c,d,1)},off:function(a,c,h){var s,g;if(a&&a.preventDefault&&a.handleObj)return s=a.handleObj,d(a.delegateTarget).off(s.namespace?s.origType+"."+s.namespace:s.origType,s.selector,s.handler),this;if("object"==typeof a){for(g in a)this.off(g,c,a[g]);return this}return(!1===c||"function"==typeof c)&&(h=c,c=b),!1===h&&(h=t),this.each(function(){d.event.remove(this,a,h,c)})},bind:function(a,b,c){return this.on(a,null,b,c)},unbind:function(a,b){return this.off(a,
null,b)},delegate:function(a,b,c,d){return this.on(b,a,c,d)},undelegate:function(a,b,c){return 1===arguments.length?this.off(a,"**"):this.off(b,a||"**",c)},trigger:function(a,b){return this.each(function(){d.event.trigger(a,b,this)})},triggerHandler:function(a,c){var h=this[0];return h?d.event.trigger(a,c,h,!0):b}});var sb=a,kb=function(){var a,b=[];return a=function(c,d){return b.push(c+=" ")>ba.cacheLength&&delete a[b.shift()],a[c]=d}},ya=function(a){return a[ma]=!0,a},Aa=function(a){var b=za.createElement("div");
try{return a(b)}catch(c){return!1}finally{}},aa=function(a,b,c,d){var h,g,e,f,n;if((b?b.ownerDocument||b:lb)!==za&&tb(b),b=b||za,c=c||[],!a||"string"!=typeof a)return c;if(1!==(f=b.nodeType)&&9!==f)return[];if(!Ka&&!d){if(h=Zc.exec(a))if(e=h[1])if(9===f){if(g=b.getElementById(e),!g||!g.parentNode)return c;if(g.id===e)return c.push(g),c}else{if(b.ownerDocument&&(g=b.ownerDocument.getElementById(e))&&Lb(b,g)&&g.id===e)return c.push(g),c}else{if(h[2])return ub.apply(c,vb.call(b.getElementsByTagName(a),
0)),c;if((e=h[3])&&pa.getByClassName&&b.getElementsByClassName)return ub.apply(c,vb.call(b.getElementsByClassName(e),0)),c}if(pa.qsa&&!Oa.test(a)){if(h=!0,g=ma,e=b,n=9===f&&a,1===f&&"object"!==b.nodeName.toLowerCase()){f=Ua(a);(h=b.getAttribute("id"))?g=h.replace($c,"\\$&"):b.setAttribute("id",g);g="[id='"+g+"'] ";for(e=f.length;e--;)f[e]=g+wb(f[e]);e=ec.test(a)&&b.parentNode||b;n=f.join(",")}if(n)try{return ub.apply(c,vb.call(e.querySelectorAll(n),0)),c}catch(q){}finally{h||b.removeAttribute("id")}}}var r;
a:{a=a.replace(Tb,"$1");var k,B;g=Ua(a);if(!d&&1===g.length){if(r=g[0]=g[0].slice(0),2<r.length&&"ID"===(k=r[0]).type&&9===b.nodeType&&!Ka&&ba.relative[r[1].type]){if(b=ba.find.ID(k.matches[0].replace($a,ab),b)[0],!b){r=c;break a}a=a.slice(r.shift().value.length)}for(f=Ub.needsContext.test(a)?0:r.length;f--&&!(k=r[f],ba.relative[h=k.type]);)if((B=ba.find[h])&&(d=B(k.matches[0].replace($a,ab),ec.test(r[0].type)&&b.parentNode||b))){if(r.splice(f,1),a=d.length&&wb(r),!a){r=(ub.apply(c,vb.call(d,0)),
c);break a}break}}r=(fc(a,g)(d,b,Ka,c,ec.test(a)),c)}return r},xb=function(a,b){var c=b&&a,d=c&&(~b.sourceIndex||wc)-(~a.sourceIndex||wc);if(d)return d;if(c)for(;c=c.nextSibling;)if(c===b)return-1;return a?1:-1},yb=function(a){return function(b){return"input"===b.nodeName.toLowerCase()&&b.type===a}},Va=function(a){return function(b){var c=b.nodeName.toLowerCase();return("input"===c||"button"===c)&&b.type===a}},La=function(a){return ya(function(b){return b=+b,ya(function(c,d){for(var h,g=a([],c.length,
b),e=g.length;e--;)c[h=g[e]]&&(c[h]=!(d[h]=c[h]))})})},Ua=function(a,b){var c,d,h,g,e,f,n;if(e=xc[a+" "])return b?0:e.slice(0);e=a;f=[];for(n=ba.preFilter;e;){(!c||(d=ad.exec(e)))&&(d&&(e=e.slice(d[0].length)||e),f.push(h=[]));c=!1;(d=bd.exec(e))&&(c=d.shift(),h.push({value:c,type:d[0].replace(Tb," ")}),e=e.slice(c.length));for(g in ba.filter)!(d=Ub[g].exec(e))||n[g]&&!(d=n[g](d))||(c=d.shift(),h.push({value:c,type:g,matches:d}),e=e.slice(c.length));if(!c)break}return b?e.length:e?aa.error(a):xc(a,
f).slice(0)},wb=function(a){for(var b=0,c=a.length,d="";c>b;b++)d+=a[b].value;return d},zb=function(a,b,c){var d=b.dir,h=c&&"parentNode"===d,g=cd++;return b.first?function(b,c,g){for(;b=b[d];)if(1===b.nodeType||h)return a(b,c,g)}:function(b,c,e){var f,C,y,n=Pa+" "+g;if(e)for(;b=b[d];){if((1===b.nodeType||h)&&a(b,c,e))return!0}else for(;b=b[d];)if(1===b.nodeType||h)if(y=b[ma]||(b[ma]={}),(C=y[d])&&C[0]===n){if(!0===(f=C[1])||f===Vb)return!0===f}else if(C=y[d]=[n],C[1]=a(b,c,e)||Vb,!0===C[1])return!0}},
Wb=function(a){return 1<a.length?function(b,c,d){for(var h=a.length;h--;)if(!a[h](b,c,d))return!1;return!0}:a[0]},Mb=function(a,b,c,d,h){for(var g,e=[],f=0,n=a.length,q=null!=b;n>f;f++)(g=a[f])&&(!c||c(g,d,h))&&(e.push(g),q&&b.push(f));return e},bb=function(a,b,c,d,h,g){return d&&!d[ma]&&(d=bb(d)),h&&!h[ma]&&(h=bb(h,g)),ya(function(g,e,f,n){var q,r,k=[],B=[],v=e.length,x;if(!(x=g)){x=b||"*";for(var L=f.nodeType?[f]:f,sc=[],m=0,l=L.length;l>m;m++)aa(x,L[m],sc);x=sc}x=!a||!g&&b?x:Mb(x,k,a,f,n);L=c?
h||(g?a:v||d)?[]:e:x;if(c&&c(x,L,f,n),d){q=Mb(L,B);d(q,[],f,n);for(f=q.length;f--;)(r=q[f])&&(L[B[f]]=!(x[B[f]]=r))}if(g){if(h||a){if(h){q=[];for(f=L.length;f--;)(r=L[f])&&q.push(x[f]=r);h(null,L=[],q,n)}for(f=L.length;f--;)(r=L[f])&&-1<(q=h?gc.call(g,r):k[f])&&(g[q]=!(e[q]=r))}}else L=Mb(L===e?L.splice(v,L.length):L),h?h(null,e,L,n):ub.apply(e,L)})},hc=function(a){var b,c,d,h=a.length,g=ba.relative[a[0].type];c=g||ba.relative[" "];for(var e=g?1:0,f=zb(function(a){return a===b},c,!0),n=zb(function(a){return-1<
gc.call(b,a)},c,!0),q=[function(a,j,c){return!g&&(c||j!==Xb)||((b=j).nodeType?f(a,j,c):n(a,j,c))}];h>e;e++)if(c=ba.relative[a[e].type])q=[zb(Wb(q),c)];else{if(c=ba.filter[a[e].type].apply(null,a[e].matches),c[ma]){for(d=++e;h>d&&!ba.relative[a[d].type];d++);return bb(1<e&&Wb(q),1<e&&wb(a.slice(0,e-1)).replace(Tb,"$1"),c,d>e&&hc(a.slice(e,d)),h>d&&hc(a=a.slice(d)),h>d&&wb(a))}q.push(c)}return Wb(q)},yc=function(){},Ab,Vb,ba,Yb,zc,fc,Bb,Xb,tb,za,Fa,Ka,Oa,Cb,Zb,Lb,ic,ma="sizzle"+-new Date,lb=sb.document,
pa={},Pa=0,cd=0,Ac=kb(),xc=kb(),Bc=kb(),wc=-2147483648,$b=[],dd=$b.pop,ub=$b.push,vb=$b.slice,gc=$b.indexOf||function(a){for(var b=0,c=this.length;c>b;b++)if(this[b]===a)return b;return-1},Cc="(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+".replace("w","w#"),Dc="\\[[\\x20\\t\\r\\n\\f]*((?:\\\\.|[\\w-]|[^\\x00-\\xa0])+)[\\x20\\t\\r\\n\\f]*(?:([*^$|!~]?=)[\\x20\\t\\r\\n\\f]*(?:(['\"])((?:\\\\.|[^\\\\])*?)\\3|("+Cc+")|)|)[\\x20\\t\\r\\n\\f]*\\]",jc=":((?:\\\\.|[\\w-]|[^\\x00-\\xa0])+)(?:\\(((['\"])((?:\\\\.|[^\\\\])*?)\\3|((?:\\\\.|[^\\\\()[\\]]|"+
...
Ka?void 0:b.getElementsByClassName(a)};Cb=[];Oa=[":focus"];(pa.qsa=kc.test(b.querySelectorAll+""))&&(Aa(function(a){a.innerHTML="<select><option selected=''></option></select>";a.querySelectorAll("[selected]").length||Oa.push("\\[[\\x20\\t\\r\\n\\f]*(?:checked|disabled|ismap|multiple|readonly|selected|value)");a.querySelectorAll(":checked").length||Oa.push(":checked")}),Aa(function(a){a.innerHTML="<input type='hidden' i=''/>";a.querySelectorAll("[i^='']").length&&Oa.push("[*^$]=[\\x20\\t\\r\\n\\f]*(?:\"\"|'')");
a.querySelectorAll(":enabled").length||Oa.push(":enabled",":disabled");a.querySelectorAll("*,:x");Oa.push(",.*:")}));a=pa;var c;c=Zb=Fa.matchesSelector||Fa.mozMatchesSelector||Fa.webkitMatchesSelector||Fa.oMatchesSelector||Fa.msMatchesSelector;c=kc.test(c+"");a=((a.matchesSelector=c)&&Aa(function(a){pa.disconnectedMatch=Zb.call(a,"div");Zb.call(a,"[s!='']:x");Cb.push("!=",jc)}),Oa=RegExp(Oa.join("|")),Cb=RegExp(Cb.join("|")),Lb=kc.test(Fa.contains+"")||Fa.compareDocumentPosition?function(a,b){var j=
9===a.nodeType?a.documentElement:a,c=b&&b.parentNode;return a===c||!(!c||1!==c.nodeType||!(j.contains?j.contains(c):a.compareDocumentPosition&&16&a.compareDocumentPosition(c)))}:function(a,b){if(b)for(;b=b.parentNode;)if(b===a)return!0;return!1},ic=Fa.compareDocumentPosition?function(a,j){var c;return a===j?(Bb=!0,0):(c=j.compareDocumentPosition&&a.compareDocumentPosition&&a.compareDocumentPosition(j))?1&c||a.parentNode&&11===a.parentNode.nodeType?a===b||Lb(lb,a)?-1:j===b||Lb(lb,j)?1:0:4&c?-1:1:a.compareDocumentPosition?
-1:1}:function(a,j){var c,d=0;c=a.parentNode;var h=j.parentNode,g=[a],e=[j];if(a===j)return Bb=!0,0;if(!c||!h)return a===b?-1:j===b?1:c?-1:h?1:0;if(c===h)return xb(a,j);for(c=a;c=c.parentNode;)g.unshift(c);for(c=j;c=c.parentNode;)e.unshift(c);for(;g[d]===e[d];)d++;return d?xb(g[d],e[d]):g[d]===lb?-1:e[d]===lb?1:0},Bb=!1,[0,0].sort(ic),pa.detectDuplicates=Bb,za)}else a=za;return a};aa.matches=function(a,b){return aa(a,null,null,b)};aa.matchesSelector=function(a,b){if((a.ownerDocument||a)!==za&&tb(a),
b=b.replace(jd,"='$1']"),!(!pa.matchesSelector||Ka||Cb&&Cb.test(b)||Oa.test(b)))try{var c=Zb.call(a,b);if(c||pa.disconnectedMatch||a.document&&11!==a.document.nodeType)return c}catch(d){}return 0<aa(b,za,null,[a]).length};aa.contains=function(a,b){return(a.ownerDocument||a)!==za&&tb(a),Lb(a,b)};aa.attr=function(a,b){var c;return(a.ownerDocument||a)!==za&&tb(a),Ka||(b=b.toLowerCase()),(c=ba.attrHandle[b])?c(a):Ka||pa.attributes?a.getAttribute(b):((c=a.getAttributeNode(b))||a.getAttribute(b))&&!0===
a[b]?b:c&&c.specified?c.value:null};aa.error=function(a){throw Error("Syntax error, unrecognized expression: "+a);};aa.uniqueSort=function(a){var b,c=[],d=1,h=0;if(Bb=!pa.detectDuplicates,a.sort(ic),Bb){for(;b=a[d];d++)b===a[d-1]&&(h=c.push(d));for(;h--;)a.splice(c[h],1)}return a};Yb=aa.getText=function(a){var b,c="",d=0;if(b=a.nodeType)if(1===b||9===b||11===b){if("string"==typeof a.textContent)return a.textContent;for(a=a.firstChild;a;a=a.nextSibling)c+=Yb(a)}else{if(3===b||4===b)return a.nodeValue}else for(;b=
a[d];d++)c+=Yb(b);return c};ba=aa.selectors={cacheLength:50,createPseudo:ya,match:Ub,find:{},relative:{">":{dir:"parentNode",first:!0}," ":{dir:"parentNode"},"+":{dir:"previousSibling",first:!0},"~":{dir:"previousSibling"}},preFilter:{ATTR:function(a){return a[1]=a[1].replace($a,ab),a[3]=(a[4]||a[5]||"").replace($a,ab),"~="===a[2]&&(a[3]=" "+a[3]+" "),a.slice(0,4)},CHILD:function(a){return a[1]=a[1].toLowerCase(),"nth"===a[1].slice(0,3)?(a[3]||aa.error(a[0]),a[4]=+(a[4]?a[5]+(a[6]||1):2*("even"===
a[3]||"odd"===a[3])),a[5]=+(a[7]+a[8]||"odd"===a[3])):a[3]&&aa.error(a[0]),a},PSEUDO:function(a){var b,c=!a[5]&&a[2];return Ub.CHILD.test(a[0])?null:(a[4]?a[2]=a[4]:c&&ed.test(c)&&(b=Ua(c,!0))&&(b=c.indexOf(")",c.length-b)-c.length)&&(a[0]=a[0].slice(0,b),a[2]=c.slice(0,b)),a.slice(0,3))}},filter:{TAG:function(a){return"*"===a?function(){return!0}:(a=a.replace($a,ab).toLowerCase(),function(b){return b.nodeName&&b.nodeName.toLowerCase()===a})},CLASS:function(a){var b=Ac[a+" "];return b||(b=RegExp("(^|[\\x20\\t\\r\\n\\f])"+
a+"([\\x20\\t\\r\\n\\f]|$)"))&&Ac(a,function(a){return b.test(a.className||"undefined"!==typeof a.getAttribute&&a.getAttribute("class")||"")})},ATTR:function(a,b,c){return function(d){d=aa.attr(d,a);return null==d?"!="===b:b?(d+="","="===b?d===c:"!="===b?d!==c:"^="===b?c&&0===d.indexOf(c):"*="===b?c&&-1<d.indexOf(c):"$="===b?c&&d.slice(-c.length)===c:"~="===b?-1<(" "+d+" ").indexOf(c):"|="===b?d===c||d.slice(0,c.length+1)===c+"-":!1):!0}},CHILD:function(a,b,c,d,h){var g="nth"!==a.slice(0,3),e="last"!==
a.slice(-4),f="of-type"===b;return 1===d&&0===h?function(a){return!!a.parentNode}:function(b,c,n){var C,q,y,r,k;c=g!==e?"nextSibling":"previousSibling";var B=b.parentNode,v=f&&b.nodeName.toLowerCase();n=!n&&!f;if(B){if(g){for(;c;){for(q=b;q=q[c];)if(f?q.nodeName.toLowerCase()===v:1===q.nodeType)return!1;k=c="only"===a&&!k&&"nextSibling"}return!0}if(k=[e?B.firstChild:B.lastChild],e&&n){n=B[ma]||(B[ma]={});C=n[a]||[];r=C[0]===Pa&&C[1];y=C[0]===Pa&&C[2];for(q=r&&B.childNodes[r];q=++r&&q&&q[c]||(y=r=
...
ya(function(a,c){for(var j,h=d(a,b),g=h.length;g--;)j=gc.call(a,h[g]),a[j]=!(c[j]=h[g])}):function(a){return d(a,0,c)}):d}},pseudos:{not:ya(function(a){var b=[],c=[],d=fc(a.replace(Tb,"$1"));return d[ma]?ya(function(a,b,c,j){var h;c=d(a,null,j,[]);for(j=a.length;j--;)(h=c[j])&&(a[j]=!(b[j]=h))}):function(a,j,h){return b[0]=a,d(b,null,h,c),!c.pop()}}),has:ya(function(a){return function(b){return 0<aa(a,b).length}}),contains:ya(function(a){return function(b){return-1<(b.textContent||b.innerText||Yb(b)).indexOf(a)}}),
lang:ya(function(a){return fd.test(a||"")||aa.error("unsupported lang: "+a),a=a.replace($a,ab).toLowerCase(),function(b){var c;do if(c=Ka?b.getAttribute("xml:lang")||b.getAttribute("lang"):b.lang)return c=c.toLowerCase(),c===a||0===c.indexOf(a+"-");while((b=b.parentNode)&&1===b.nodeType);return!1}}),target:function(a){var b=sb.location&&sb.location.hash;return b&&b.slice(1)===a.id},root:function(a){return a===Fa},focus:function(a){return a===za.activeElement&&(!za.hasFocus||za.hasFocus())&&!(!a.type&&
...
c;c+=2)a.push(c);return a}),lt:La(function(a,b,c){for(b=0>c?c+b:c;0<=--b;)a.push(b);return a}),gt:La(function(a,b,c){for(c=0>c?c+b:c;b>++c;)a.push(c);return a})}};for(Ab in{radio:!0,checkbox:!0,file:!0,password:!0,image:!0})ba.pseudos[Ab]=yb(Ab);for(Ab in{submit:!0,reset:!0})ba.pseudos[Ab]=Va(Ab);fc=aa.compile=function(a,b){var c,d=[],h=[],g=Bc[a+" "];if(!g){b||(b=Ua(a));for(c=b.length;c--;)g=hc(b[c]),g[ma]?d.push(g):h.push(g);var e=0,f=0<d.length,n=0<h.length;c=function(a,b,c,j,g){var q,r,C=[],y=
0,k="0",B=a&&[],v=null!=g,x=Xb,L=a||n&&ba.find.TAG("*",g&&b.parentNode||b),m=Pa+=null==x?1:Math.random()||0.1;for(v&&(Xb=b!==za&&b,Vb=e);null!=(g=L[k]);k++){if(n&&g){for(q=0;r=h[q++];)if(r(g,b,c)){j.push(g);break}v&&(Pa=m,Vb=++e)}f&&((g=!r&&g)&&y--,a&&B.push(g))}if(y+=k,f&&k!==y){for(q=0;r=d[q++];)r(B,C,b,c);if(a){if(0<y)for(;k--;)B[k]||C[k]||(C[k]=dd.call(j));C=Mb(C)}ub.apply(j,C);v&&!a&&0<C.length&&1<y+d.length&&aa.uniqueSort(j)}return v&&(Pa=m,Xb=x),B};c=f?ya(c):c;g=Bc(a,c)}return g};ba.pseudos.nth=
ba.pseudos.eq;ba.filters=yc.prototype=ba.pseudos;ba.setFilters=new yc;tb();aa.attr=d.attr;d.find=aa;d.expr=aa.selectors;d.expr[":"]=d.expr.pseudos;d.unique=aa.uniqueSort;d.text=aa.getText;d.isXMLDoc=aa.isXML;d.contains=aa.contains;var kd=/Until$/,ld=/^(?:parents|prev(?:Until|All))/,Uc=/^.[^:#\[\.,]*$/,Ec=d.expr.match.needsContext,md={children:!0,contents:!0,next:!0,prev:!0};d.fn.extend({find:function(a){var b,c,h,g=this.length;if("string"!=typeof a)return h=this,this.pushStack(d(a).filter(function(){for(b=
0;g>b;b++)if(d.contains(h[b],this))return!0}));c=[];for(b=0;g>b;b++)d.find(a,this[b],c);return c=this.pushStack(1<g?d.unique(c):c),c.selector=(this.selector?this.selector+" ":"")+a,c},has:function(a){var b,c=d(a,this),h=c.length;return this.filter(function(){for(b=0;h>b;b++)if(d.contains(this,c[b]))return!0})},not:function(a){return this.pushStack(U(this,a,!1))},filter:function(a){return this.pushStack(U(this,a,!0))},is:function(a){return!!a&&("string"==typeof a?Ec.test(a)?0<=d(a,this.context).index(this[0]):
0<d.filter(a,this).length:0<this.filter(a).length)},closest:function(a,b){for(var c,h=0,g=this.length,e=[],f=Ec.test(a)||"string"!=typeof a?d(a,b||this.context):0;g>h;h++)for(c=this[h];c&&c.ownerDocument&&c!==b&&11!==c.nodeType;){if(f?-1<f.index(c):d.find.matchesSelector(c,a)){e.push(c);break}c=c.parentNode}return this.pushStack(1<e.length?d.unique(e):e)},index:function(a){return a?"string"==typeof a?d.inArray(this[0],d(a)):d.inArray(a.jquery?a[0]:a,this):this[0]&&this[0].parentNode?this.first().prevAll().length:
...
b){d.fn[a]=function(c,h){var g=d.map(this,b,c);return kd.test(a)||(h=c),h&&"string"==typeof h&&(g=d.filter(h,g)),g=1<this.length&&!md[a]?d.unique(g):g,1<this.length&&ld.test(a)&&(g=g.reverse()),this.pushStack(g)}});d.extend({filter:function(a,b,c){return c&&(a=":not("+a+")"),1===b.length?d.find.matchesSelector(b[0],a)?[b[0]]:[]:d.find.matches(a,b)},dir:function(a,c,h){var g=[];for(a=a[c];a&&9!==a.nodeType&&(h===b||1!==a.nodeType||!d(a).is(h));)1===a.nodeType&&g.push(a),a=a[c];return g},sibling:function(a,
...
(d.cleanData(w(c,!1)),c.innerHTML=a);c=0}catch(g){}}c&&this.empty().append(a)},null,a,arguments.length)},replaceWith:function(a){return d.isFunction(a)||"string"==typeof a||(a=d(a).not(this).detach()),this.domManip([a],!0,function(a){var b=this.nextSibling,c=this.parentNode;c&&(d(this).remove(),c.insertBefore(a,b))})},detach:function(a){return this.remove(a,!0)},domManip:function(a,c,h){a=ha.apply([],a);var g,e,f,n,q=0,r=this.length,k=this,B=r-1,v=a[0],x=d.isFunction(v);if(x||!(1>=r||"string"!=typeof v||
d.support.checkClone)&&qd.test(v))return this.each(function(d){var g=k.eq(d);x&&(a[0]=v.call(this,d,c?g.html():b));g.domManip(a,c,h)});if(r&&(n=d.buildFragment(a,this[0].ownerDocument,!1,this),g=n.firstChild,1===n.childNodes.length&&(n=g),g)){c=c&&d.nodeName(g,"tr");f=d.map(w(n,"script"),z);for(e=f.length;r>q;q++)g=n,q!==B&&(g=d.clone(g,!0,!0),e&&d.merge(f,w(g,"script"))),h.call(c&&d.nodeName(this[q],"table")?this[q].getElementsByTagName("tbody")[0]||this[q].appendChild(this[q].ownerDocument.createElement("tbody")):
this[q],g,q);if(e){n=f[f.length-1].ownerDocument;d.map(f,F);for(q=0;e>q;q++)g=f[q],Jc.test(g.type||"")&&!d._data(g,"globalEval")&&d.contains(n,g)&&(g.src?d.ajax({url:g.src,type:"GET",dataType:"script",async:!1,global:!1,"throws":!0}):d.globalEval((g.text||g.textContent||g.innerHTML||"").replace(rd,"")))}n=g=null}return this}});d.each({appendTo:"append",prependTo:"prepend",insertBefore:"before",insertAfter:"after",replaceAll:"replaceWith"},function(a,b){d.fn[a]=function(a){for(var c=0,h=[],j=d(a),
g=j.length-1;g>=c;c++)a=c===g?this:this.clone(!0),d(j[c])[b](a),ta.apply(h,a.get());return this.pushStack(h)}});d.extend({clone:function(a,b,c){var h,g,e,f,n,q=d.contains(a.ownerDocument,a);if(d.support.html5Clone||d.isXMLDoc(a)||!Fc.test("<"+a.nodeName+">")?e=a.cloneNode(!0):(mc.innerHTML=a.outerHTML,mc.removeChild(e=mc.firstChild)),!(d.support.noCloneEvent&&d.support.noCloneChecked||1!==a.nodeType&&11!==a.nodeType||d.isXMLDoc(a))){h=w(e);n=w(a);for(f=0;null!=(g=n[f]);++f)if(h[f]){var r=h[f],k=void 0,
B=void 0,v=void 0;if(1===r.nodeType){if(k=r.nodeName.toLowerCase(),!d.support.noCloneEvent&&r[d.expando]){v=d._data(r);for(B in v.events)d.removeEvent(r,B,v.handle);r.removeAttribute(d.expando)}"script"===k&&r.text!==g.text?(z(r).text=g.text,F(r)):"object"===k?(r.parentNode&&(r.outerHTML=g.outerHTML),d.support.html5Clone&&g.innerHTML&&!d.trim(r.innerHTML)&&(r.innerHTML=g.innerHTML)):"input"===k&&bc.test(g.type)?(r.defaultChecked=r.checked=g.checked,r.value!==g.value&&(r.value=g.value)):"option"===
k?r.defaultSelected=r.selected=g.defaultSelected:("input"===k||"textarea"===k)&&(r.defaultValue=g.defaultValue)}}}if(b)if(c){n=n||w(a);h=h||w(e);for(f=0;null!=(g=n[f]);f++)E(g,h[f])}else E(a,e);return h=w(e,"script"),0<h.length&&V(h,!q&&w(a,"script")),e},buildFragment:function(a,b,c,h){for(var g,e,f,n,q,r,k,B=a.length,v=T(b),x=[],L=0;B>L;L++)if(e=a[L],e||0===e)if("object"===d.type(e))d.merge(x,e.nodeType?[e]:e);else if(od.test(e)){n=n||v.appendChild(b.createElement("div"));q=(Hc.exec(e)||["",""])[1].toLowerCase();
k=Ia[q]||Ia._default;n.innerHTML=k[1]+e.replace(Gc,"<$1></$2>")+k[2];for(g=k[0];g--;)n=n.lastChild;if(!d.support.leadingWhitespace&&lc.test(e)&&x.push(b.createTextNode(lc.exec(e)[0])),!d.support.tbody)for(g=(e="table"!==q||Ic.test(e)?"<table>"!==k[1]||Ic.test(e)?0:n:n.firstChild)&&e.childNodes.length;g--;)d.nodeName(r=e.childNodes[g],"tbody")&&!r.childNodes.length&&e.removeChild(r);d.merge(x,n.childNodes);for(n.textContent="";n.firstChild;)n.removeChild(n.firstChild);n=v.lastChild}else x.push(b.createTextNode(e));
n&&v.removeChild(n);d.support.appendChecked||d.grep(w(x,"input"),X);for(L=0;e=x[L++];)if((!h||-1===d.inArray(e,h))&&(f=d.contains(e.ownerDocument,e),n=w(v.appendChild(e),"script"),f&&V(n),c))for(g=0;e=n[g++];)Jc.test(e.type||"")&&c.push(e);return v},cleanData:function(a,b){for(var c,h,g,e,f=0,n=d.expando,q=d.cache,r=d.support.deleteExpando,k=d.event.special;null!=(c=a[f]);f++)if((b||d.acceptData(c))&&(g=c[n],e=g&&q[g])){if(e.events)for(h in e.events)k[h]?d.event.remove(c,h):d.removeEvent(c,h,e.handle);
q[g]&&(delete q[g],r?delete c[n]:typeof c.removeAttribute!==L?c.removeAttribute(n):c[n]=null,Ca.push(g))}}});var Fb,eb,fb,nc=/alpha\([^)]*\)/i,sd=/opacity\s*=\s*([^)]*)/,td=/^(top|right|bottom|left)$/,ud=/^(none|table(?!-c[ea]).+)/,Kc=/^margin/,Wc=RegExp("^("+Da+")(.*)$","i"),Ob=RegExp("^("+Da+")(?!px)[a-z%]+$","i"),vd=RegExp("^([+-])=("+Da+")","i"),vc={BODY:"block"},wd={position:"absolute",visibility:"hidden",display:"block"},Lc={letterSpacing:0,fontWeight:400},db=["Top","Right","Bottom","Left"],
uc=["Webkit","O","Moz","ms"];d.fn.extend({css:function(a,c){return d.access(this,function(a,c,h){var j,g={},e=0;if(d.isArray(c)){j=eb(a);for(h=c.length;h>e;e++)g[c[e]]=d.css(a,c[e],!1,j);return g}return h!==b?d.style(a,c,h):d.css(a,c)},a,c,1<arguments.length)},show:function(){return J(this,!0)},hide:function(){return J(this)},toggle:function(a){var b="boolean"==typeof a;return this.each(function(){(b?a:Q(this))?d(this).show():d(this).hide()})}});d.extend({cssHooks:{opacity:{get:function(a,b){if(b){var c=
fb(a,"opacity");return""===c?"1":c}}}},cssNumber:{columnCount:!0,fillOpacity:!0,fontWeight:!0,lineHeight:!0,opacity:!0,orphans:!0,widows:!0,zIndex:!0,zoom:!0},cssProps:{"float":d.support.cssFloat?"cssFloat":"styleFloat"},style:function(a,c,h,g){if(a&&3!==a.nodeType&&8!==a.nodeType&&a.style){var e,f,n,q=d.camelCase(c),r=a.style;if(c=d.cssProps[q]||(d.cssProps[q]=I(r,q)),n=d.cssHooks[c]||d.cssHooks[q],h===b)return n&&"get"in n&&(e=n.get(a,!1,g))!==b?e:r[c];if(f=typeof h,"string"===f&&(e=vd.exec(h))&&
(h=(e[1]+1)*e[2]+parseFloat(d.css(a,c)),f="number"),!(null==h||"number"===f&&isNaN(h)||("number"!==f||d.cssNumber[q]||(h+="px"),d.support.clearCloneStyle||""!==h||0!==c.indexOf("background")||(r[c]="inherit"),n&&"set"in n&&(h=n.set(a,h,g))===b)))try{r[c]=h}catch(k){}}},css:function(a,c,h,g){var e,f,n,q=d.camelCase(c);return c=d.cssProps[q]||(d.cssProps[q]=I(a.style,q)),n=d.cssHooks[c]||d.cssHooks[q],n&&"get"in n&&(f=n.get(a,!0,h)),f===b&&(f=fb(a,c,g)),"normal"===f&&c in Lc&&(f=Lc[c]),""===h||h?(e=
parseFloat(f),!0===h||d.isNumeric(e)?e||0:f):f},swap:function(a,b,c,d){var h,g={};for(h in b)g[h]=a.style[h],a.style[h]=b[h];c=c.apply(a,d||[]);for(h in b)a.style[h]=g[h];return c}});a.getComputedStyle?(eb=function(b){return a.getComputedStyle(b,null)},fb=function(a,c,h){var g,e,f,n=(h=h||eb(a))?h.getPropertyValue(c)||h[c]:b,q=a.style;return h&&(""!==n||d.contains(a.ownerDocument,a)||(n=d.style(a,c)),Ob.test(n)&&Kc.test(c)&&(g=q.width,e=q.minWidth,f=q.maxWidth,q.minWidth=q.maxWidth=q.width=n,n=h.width,
q.width=g,q.minWidth=e,q.maxWidth=f)),n}):A.documentElement.currentStyle&&(eb=function(a){return a.currentStyle},fb=function(a,c,d){var h,g,e;d=(d=d||eb(a))?d[c]:b;var f=a.style;return null==d&&f&&f[c]&&(d=f[c]),Ob.test(d)&&!td.test(c)&&(h=f.left,g=a.runtimeStyle,e=g&&g.left,e&&(g.left=a.currentStyle.left),f.left="fontSize"===c?"1em":d,d=f.pixelLeft+"px",f.left=h,e&&(g.left=e)),""===d?"auto":d});d.each(["height","width"],function(a,c){d.cssHooks[c]={get:function(a,h,j){return h?0===a.offsetWidth&&
ud.test(d.css(a,"display"))?d.swap(a,wd,function(){return Y(a,c,j)}):Y(a,c,j):b},set:function(a,b,h){var j=h&&eb(a);return k(a,b,h?D(a,c,h,d.support.boxSizing&&"border-box"===d.css(a,"boxSizing",!1,j),j):0)}}});d.support.opacity||(d.cssHooks.opacity={get:function(a,b){return sd.test((b&&a.currentStyle?a.currentStyle.filter:a.style.filter)||"")?0.01*parseFloat(RegExp.$1)+"":b?"1":""},set:function(a,b){var c=a.style,h=a.currentStyle,g=d.isNumeric(b)?"alpha(opacity="+100*b+")":"",e=h&&h.filter||c.filter||
"";c.zoom=1;(1<=b||""===b)&&""===d.trim(e.replace(nc,""))&&c.removeAttribute&&(c.removeAttribute("filter"),""===b||h&&!h.filter)||(c.filter=nc.test(e)?e.replace(nc,g):e+" "+g)}});d(function(){d.support.reliableMarginRight||(d.cssHooks.marginRight={get:function(a,c){return c?d.swap(a,{display:"inline-block"},fb,[a,"marginRight"]):b}});!d.support.pixelPosition&&d.fn.position&&d.each(["top","left"],function(a,c){d.cssHooks[c]={get:function(a,h){return h?(h=fb(a,c),Ob.test(h)?d(a).position()[c]+"px":
h):b}}})});d.expr&&d.expr.filters&&(d.expr.filters.hidden=function(a){return 0>=a.offsetWidth&&0>=a.offsetHeight||!d.support.reliableHiddenOffsets&&"none"===(a.style&&a.style.display||d.css(a,"display"))},d.expr.filters.visible=function(a){return!d.expr.filters.hidden(a)});d.each({margin:"",padding:"",border:"Width"},function(a,b){d.cssHooks[a+b]={expand:function(c){var d=0,h={};for(c="string"==typeof c?c.split(" "):[c];4>d;d++)h[a+db[d]+b]=c[d]||c[d-2]||c[0];return h}};Kc.test(a)||(d.cssHooks[a+
...
return null==c?null:d.isArray(c)?d.map(c,function(a){return{name:b.name,value:a.replace(Mc,"\r\n")}}):{name:b.name,value:c.replace(Mc,"\r\n")}}).get()}});d.param=function(a,c){var h,g=[],e=function(a,b){b=d.isFunction(b)?b():null==b?"":b;g[g.length]=encodeURIComponent(a)+"="+encodeURIComponent(b)};if(c===b&&(c=d.ajaxSettings&&d.ajaxSettings.traditional),d.isArray(a)||a.jquery&&!d.isPlainObject(a))d.each(a,function(){e(this.name,this.value)});else for(h in a)P(h,a[h],c,e);return g.join("&").replace(xd,
"+")};d.each("blur focus focusin focusout load resize scroll unload click dblclick mousedown mouseup mousemove mouseover mouseout mouseenter mouseleave change select submit keydown keypress keyup error contextmenu".split(" "),function(a,b){d.fn[b]=function(a,c){return 0<arguments.length?this.on(b,null,a,c):this.trigger(b)}});d.fn.hover=function(a,b){return this.mouseenter(a).mouseleave(b||a)};var mb,cb,oc=d.now(),pc=/\?/,Ad=/#.*$/,Nc=/([?&])_=[^&]*/,Bd=/^(.*?):[ \t]*([^\r\n]*)\r?$/gm,Cd=/^(?:GET|HEAD)$/,
Dd=/^\/\//,Oc=/^([\w.+-]+:)(?:\/\/([^\/?#:]*)(?::(\d+)|)|)/,Pc=d.fn.load,Qc={},cc={},Rc="*/".concat("*");try{cb=fa.href}catch(Jd){cb=A.createElement("a"),cb.href="",cb=cb.href}mb=Oc.exec(cb.toLowerCase())||[];d.fn.load=function(a,c,h){if("string"!=typeof a&&Pc)return Pc.apply(this,arguments);var g,e,f,n=this,q=a.indexOf(" ");return 0<=q&&(g=a.slice(q,a.length),a=a.slice(0,q)),d.isFunction(c)?(h=c,c=b):c&&"object"==typeof c&&(f="POST"),0<n.length&&d.ajax({url:a,type:f,dataType:"html",data:c}).done(function(a){e=
arguments;n.html(g?d("<div>").append(d.parseHTML(a)).find(g):a)}).complete(h&&function(a,b){n.each(h,e||[a.responseText,b,a])}),this};d.each("ajaxStart ajaxStop ajaxComplete ajaxError ajaxSuccess ajaxSend".split(" "),function(a,b){d.fn[b]=function(a){return this.on(b,a)}});d.each(["get","post"],function(a,c){d[c]=function(a,h,g,j){return d.isFunction(h)&&(j=j||g,g=h,h=b),d.ajax({url:a,type:c,dataType:j,data:h,success:g})}});d.extend({active:0,lastModified:{},etag:{},ajaxSettings:{url:cb,type:"GET",
isLocal:/^(?:about|app|app-storage|.+-extension|file|res|widget):$/.test(mb[1]),global:!0,processData:!0,async:!0,contentType:"application/x-www-form-urlencoded; charset=UTF-8",accepts:{"*":Rc,text:"text/plain",html:"text/html",xml:"application/xml, text/xml",json:"application/json, text/javascript"},contents:{xml:/xml/,html:/html/,json:/json/},responseFields:{xml:"responseXML",text:"responseText"},converters:{"* text":a.String,"text html":!0,"text json":d.parseJSON,"text xml":d.parseXML},flatOptions:{url:!0,
context:!0}},ajaxSetup:function(a,b){return b?O(O(a,d.ajaxSettings),b):O(d.ajaxSettings,a)},ajaxPrefilter:m(Qc),ajaxTransport:m(cc),ajax:function(a,c){function h(a,c,g,j){var e,B,s,C,ra,w=c;if(2!==Z){Z=2;q&&clearTimeout(q);k=b;n=j||"";A.readyState=0<a?4:0;if(g){C=v;j=A;var K,y,p,D,u=C.contents,W=C.dataTypes,Ta=C.responseFields;for(D in Ta)D in g&&(j[Ta[D]]=g[D]);for(;"*"===W[0];)W.shift(),y===b&&(y=C.mimeType||j.getResponseHeader("Content-Type"));if(y)for(D in u)if(u[D]&&u[D].test(y)){W.unshift(D);
break}if(W[0]in g)p=W[0];else{for(D in g){if(!W[0]||C.converters[D+" "+W[0]]){p=D;break}K||(K=D)}p=p||K}C=p?(p!==W[0]&&W.unshift(p),g[p]):b}if(200<=a&&300>a||304===a)if(v.ifModified&&(ra=A.getResponseHeader("Last-Modified"),ra&&(d.lastModified[f]=ra),ra=A.getResponseHeader("etag"),ra&&(d.etag[f]=ra)),204===a)e=!0,w="nocontent";else if(304===a)e=!0,w="notmodified";else{var P;a:{g=v;e=C;var fa,F;s={};ra=0;w=g.dataTypes.slice();K=w[0];if(g.dataFilter&&(e=g.dataFilter(e,g.dataType)),w[1])for(fa in g.converters)s[fa.toLowerCase()]=
g.converters[fa];for(;B=w[++ra];)if("*"!==B){if("*"!==K&&K!==B){if(fa=s[K+" "+B]||s["* "+B],!fa)for(P in s)if(F=P.split(" "),F[1]===B&&(fa=s[K+" "+F[0]]||s["* "+F[0]])){!0===fa?fa=s[P]:!0!==s[P]&&(B=F[0],w.splice(ra--,0,B));break}if(!0!==fa)if(fa&&g["throws"])e=fa(e);else try{e=fa(e)}catch(Ya){P={state:"parsererror",error:fa?Ya:"No conversion from "+K+" to "+B};break a}}K=B}P={state:"success",data:e}}e=P;w=e.state;B=e.data;s=e.error;e=!s}else s=w,(a||!w)&&(w="error",0>a&&(a=0));A.status=a;A.statusText=
(c||w)+"";e?m.resolveWith(x,[B,w,A]):m.rejectWith(x,[A,w,s]);A.statusCode(t);t=b;r&&L.trigger(e?"ajaxSuccess":"ajaxError",[A,v,e?B:s]);l.fireWith(x,[A,w]);r&&(L.trigger("ajaxComplete",[A,v]),--d.active||d.event.trigger("ajaxStop"))}}"object"==typeof a&&(c=a,a=b);c=c||{};var g,e,f,n,q,r,k,B,v=d.ajaxSetup({},c),x=v.context||v,L=v.context&&(x.nodeType||x.jquery)?d(x):d.event,m=d.Deferred(),l=d.Callbacks("once memory"),t=v.statusCode||{},ra={},w={},Z=0,K="canceled",A={readyState:0,getResponseHeader:function(a){var b;
...
l.add,A.success=A.done,A.error=A.fail,v.url=((a||v.url||cb)+"").replace(Ad,"").replace(Dd,mb[1]+"//"),v.type=c.method||c.type||v.method||v.type,v.dataTypes=d.trim(v.dataType||"*").toLowerCase().match(Ba)||[""],null==v.crossDomain&&(g=Oc.exec(v.url.toLowerCase()),v.crossDomain=!(!g||g[1]===mb[1]&&g[2]===mb[2]&&(g[3]||("http:"===g[1]?80:443))==(mb[3]||("http:"===mb[1]?80:443)))),v.data&&v.processData&&"string"!=typeof v.data&&(v.data=d.param(v.data,v.traditional)),ca(Qc,v,c,A),2===Z)return A;(r=v.global)&&
...
v.contentType);A.setRequestHeader("Accept",v.dataTypes[0]&&v.accepts[v.dataTypes[0]]?v.accepts[v.dataTypes[0]]+("*"!==v.dataTypes[0]?", "+Rc+"; q=0.01":""):v.accepts["*"]);for(e in v.headers)A.setRequestHeader(e,v.headers[e]);if(v.beforeSend&&(!1===v.beforeSend.call(x,A,v)||2===Z))return A.abort();K="abort";for(e in{success:1,error:1,complete:1})A[e](v[e]);if(k=ca(cc,v,c,A)){A.readyState=1;r&&L.trigger("ajaxSend",[A,v]);v.async&&0<v.timeout&&(q=setTimeout(function(){A.abort("timeout")},v.timeout));
...
c.onload(b,!0)}}}});var Sc=[],qc=/(=)\?(?=&|$)|\?\?/;d.ajaxSetup({jsonp:"callback",jsonpCallback:function(){var a=Sc.pop()||d.expando+"_"+oc++;return this[a]=!0,a}});d.ajaxPrefilter("json jsonp",function(c,h,g){var e,f,n,q=!1!==c.jsonp&&(qc.test(c.url)?"url":"string"==typeof c.data&&!(c.contentType||"").indexOf("application/x-www-form-urlencoded")&&qc.test(c.data)&&"data");return q||"jsonp"===c.dataTypes[0]?(e=c.jsonpCallback=d.isFunction(c.jsonpCallback)?c.jsonpCallback():c.jsonpCallback,q?c[q]=
c[q].replace(qc,"$1"+e):!1!==c.jsonp&&(c.url+=(pc.test(c.url)?"&":"?")+c.jsonp+"="+e),c.converters["script json"]=function(){return n||d.error(e+" was not called"),n[0]},c.dataTypes[0]="json",f=a[e],a[e]=function(){n=arguments},g.always(function(){a[e]=f;c[e]&&(c.jsonpCallback=h.jsonpCallback,Sc.push(e));n&&d.isFunction(f)&&f(n[0]);n=f=b}),"script"):b});var Db,Nb,Ed=0,rc=a.ActiveXObject&&function(){for(var a in Db)Db[a](b,!0)};d.ajaxSettings.xhr=a.ActiveXObject?function(){var b;if(!(b=!this.isLocal&&
ja()))a:{try{b=new a.ActiveXObject("Microsoft.XMLHTTP");break a}catch(c){}b=void 0}return b}:ja;Nb=d.ajaxSettings.xhr();d.support.cors=!!Nb&&"withCredentials"in Nb;(Nb=d.support.ajax=!!Nb)&&d.ajaxTransport(function(c){if(!c.crossDomain||d.support.cors){var h;return{send:function(g,e){var f,n,q=c.xhr();if(c.username?q.open(c.type,c.url,c.async,c.username,c.password):q.open(c.type,c.url,c.async),c.xhrFields)for(n in c.xhrFields)q[n]=c.xhrFields[n];c.mimeType&&q.overrideMimeType&&q.overrideMimeType(c.mimeType);
c.crossDomain||g["X-Requested-With"]||(g["X-Requested-With"]="XMLHttpRequest");try{for(n in g)q.setRequestHeader(n,g[n])}catch(r){}q.send(c.hasContent&&c.data||null);h=function(a,g){var n,r,k,B;try{if(h&&(g||4===q.readyState))if(h=b,f&&(q.onreadystatechange=d.noop,rc&&delete Db[f]),g)4!==q.readyState&&q.abort();else{B={};n=q.status;r=q.getAllResponseHeaders();"string"==typeof q.responseText&&(B.text=q.responseText);try{k=q.statusText}catch(v){k=""}n||!c.isLocal||c.crossDomain?1223===n&&(n=204):n=
B.text?200:404}}catch(x){g||e(-1,x)}B&&e(n,k,B,r)};c.async?4===q.readyState?setTimeout(h):(f=++Ed,rc&&(Db||(Db={},d(a).unload(rc)),Db[f]=h),q.onreadystatechange=h):h()},abort:function(){h&&h(b,!0)}}}});var nb,ac,Fd=/^(?:toggle|show|hide)$/,Gd=RegExp("^(?:([+-])=|)("+Da+")([a-z%]*)$","i"),Hd=/queueHooks$/,Pb=[function(a,b,c){var h,g,e,f,n,q,r=this,k=a.style,B={},v=[],x=a.nodeType&&Q(a);c.queue||(n=d._queueHooks(a,"fx"),null==n.unqueued&&(n.unqueued=0,q=n.empty.fire,n.empty.fire=function(){n.unqueued||
...
c.overflow[2]}));for(g in b)if(e=b[g],Fd.exec(e))(delete b[g],h=h||"toggle"===e,e===(x?"hide":"show"))||v.push(g);if(b=v.length){e=d._data(a,"fxshow")||d._data(a,"fxshow",{});"hidden"in e&&(x=e.hidden);h&&(e.hidden=!x);x?d(a).show():r.done(function(){d(a).hide()});r.done(function(){var b;d._removeData(a,"fxshow");for(b in B)d.style(a,b,B[b])});for(g=0;b>g;g++)h=v[g],f=r.createTween(h,x?e[h]:0),B[h]=e[h]||d.style(a,h),h in e||(e[h]=f.start,x&&(f.end=f.start,f.start="width"===h||"height"===h?1:0))}}],
Gb={"*":[function(a,b){var c,h,g=this.createTween(a,b),e=Gd.exec(b),f=g.cur(),n=+f||0,q=1,r=20;if(e){if(c=+e[2],h=e[3]||(d.cssNumber[a]?"":"px"),"px"!==h&&n){n=d.css(g.elem,a,!0)||c||1;do q=q||".5",n/=q,d.style(g.elem,a,n+h);while(q!==(q=g.cur()/f)&&1!==q&&--r)}g.unit=h;g.start=n;g.end=e[1]?n+(e[1]+1)*c:c}return g}]};d.Animation=d.extend(H,{tweener:function(a,b){d.isFunction(a)?(b=a,a=["*"]):a=a.split(" ");for(var c,h=0,g=a.length;g>h;h++)c=a[h],Gb[c]=Gb[c]||[],Gb[c].unshift(b)},prefilter:function(a,
b){b?Pb.unshift(a):Pb.push(a)}});d.Tween=M;M.prototype={constructor:M,init:function(a,b,c,h,g,e){this.elem=a;this.prop=c;this.easing=g||"swing";this.options=b;this.start=this.now=this.cur();this.end=h;this.unit=e||(d.cssNumber[c]?"":"px")},cur:function(){var a=M.propHooks[this.prop];return a&&a.get?a.get(this):M.propHooks._default.get(this)},run:function(a){var b,c=M.propHooks[this.prop];return this.pos=b=this.options.duration?d.easing[this.easing](a,this.options.duration*a,0,1,this.options.duration):
...
d.isEmptyObject(a),e=d.speed(b,c,h),f=function(){var b=H(this,d.extend({},a),e);f.finish=function(){b.stop(!0)};(g||d._data(this,"finish"))&&b.stop(!0)};return f.finish=f,g||!1===e.queue?this.each(f):this.queue(e.queue,f)},stop:function(a,c,h){var g=function(a){var b=a.stop;delete a.stop;b(h)};return"string"!=typeof a&&(h=c,c=a,a=b),c&&!1!==a&&this.queue(a||"fx",[]),this.each(function(){var b=!0,c=null!=a&&a+"queueHooks",e=d.timers,f=d._data(this);if(c)f[c]&&f[c].stop&&g(f[c]);else for(c in f)f[c]&&
f[c].stop&&Hd.test(c)&&g(f[c]);for(c=e.length;c--;)e[c].elem!==this||null!=a&&e[c].queue!==a||(e[c].anim.stop(h),b=!1,e.splice(c,1));(b||!h)&&d.dequeue(this,a)})},finish:function(a){return!1!==a&&(a=a||"fx"),this.each(function(){var b,c=d._data(this),h=c[a+"queue"];b=c[a+"queueHooks"];var g=d.timers,e=h?h.length:0;c.finish=!0;d.queue(this,a,[]);b&&b.cur&&b.cur.finish&&b.cur.finish.call(this);for(b=g.length;b--;)g[b].elem===this&&g[b].queue===a&&(g[b].anim.stop(!0),g.splice(b,1));for(b=0;e>b;b++)h[b]&&
...
(function(a,b,c){function e(a,b,c){for(var g=[],e=0;e<a.length;e++){var f=tinycolor(a[e]),k=0.5>f.toHsl().l?"sp-thumb-el sp-thumb-dark":"sp-thumb-el sp-thumb-light",k=k+(tinycolor.equals(b,a[e])?" sp-thumb-active":""),x=z?"background-color:"+f.toRgbString():"filter:"+f.toFilter();g.push('<span title="'+f.toRgbString()+'" data-color="'+f.toRgbString()+'" class="'+k+'"><span class="sp-thumb-inner" style="'+x+';" /></span>')}return"<div class='sp-cf "+c+"'>"+g.join("")+"</div>"}function f(a,c){var g=
a.outerWidth(),e=a.outerHeight(),f=c.outerHeight(),k=a[0].ownerDocument,x=k.documentElement,m=x.clientWidth+b(k).scrollLeft(),k=x.clientHeight+b(k).scrollTop(),x=c.offset();x.top+=f;x.left-=Math.min(x.left,x.left+g>m&&m>g?Math.abs(x.left+g-m):0);x.top-=Math.min(x.top,x.top+e>k&&k>e?Math.abs(e+f-0):0);return x}function p(){}function u(a){a.stopPropagation()}function l(a,b){var c=Array.prototype.slice,g=c.call(arguments,2);return function(){return a.apply(b,g.concat(c.call(arguments)))}}function t(c,
g,e,f){function k(a){a.stopPropagation&&a.stopPropagation();a.preventDefault&&a.preventDefault();a.returnValue=!1}function x(a){if(t){if(T&&9>document.documentMode&&!a.button)return m();var b=a.originalEvent.touches,d=b?b[0].pageY:a.pageY,b=Math.max(0,Math.min((b?b[0].pageX:a.pageX)-w.left,D)),d=Math.max(0,Math.min(d-w.top,p));v&&k(a);g.apply(c,[b,d,a])}}function m(){t&&(b(l).unbind(Z),b(l.body).removeClass("sp-dragging"),f.apply(c,arguments));t=!1}g=g||function(){};e=e||function(){};f=f||function(){};
var l=c.ownerDocument||document,t=!1,w={},p=0,D=0,v="ontouchstart"in a,Z={};Z.selectstart=k;Z.dragstart=k;Z[v?"touchmove":"mousemove"]=x;Z[v?"touchend":"mouseup"]=m;b(c).bind(v?"touchstart":"mousedown",function(a){if(!(a.which?3==a.which:2==a.button)&&!t&&!1!==e.apply(c,arguments))t=!0,p=b(c).height(),D=b(c).width(),w=b(c).offset(),b(l).bind(Z),b(l.body).addClass("sp-dragging"),v||x(a),k(a)})}var S={beforeShow:p,move:p,change:p,show:p,hide:p,color:!1,flat:!1,showInput:!0,showButtons:!1,clickoutFiresChange:!1,
...
0;d<jb.length;d++)for(var g=0;g<jb[d].length;g++)h=tinycolor(jb[d][g]).toRgbString(),c[h]=!0;for(d=0;d<b.length;d++)h=tinycolor(b[d]).toRgbString(),c.hasOwnProperty(h)||(a.push(b[d]),c[h]=!0)}return a.reverse().slice(0,E.maxSelectionSize)},m=function(){var a=W(),c=b.map(jb,function(b,c){return e(b,a,"sp-palette-row sp-palette-row-"+c)});Ga&&c.push(e(L(),a,"sp-palette-row sp-palette-row-selection"));Sb.html(c.join(""))},w=function(){if(E.showInitial){var a=Va,b=W();Jb.html(e([a,b],b,"sp-palette-row-initial"))}},
A=function(){(0===ia||0===da||0===na)&&J();n.addClass(wa)},p=function(){n.removeClass(wa)},v=function(){var a=tinycolor(Na.val());a.ok?d(a):Na.addClass("sp-validation-error")},Z=function(){ea?D():K()},K=function(){if(ea)J();else if(!1!==G.beforeShow(W())){for(var c=0;c<U.length;c++)U[c]&&U[c].hide();ea=!0;b(xa).bind("click.spectrum",D);b(a).bind("resize.spectrum",Q);Aa.addClass("sp-active");n.show();E.showPalette&&m();J();F();Va=W();w();G.show(Va)}},D=function(c){if((!c||!("click"==c.type&&2==c.button))&&
ea&&!O)ea=!1,b(xa).unbind("click.spectrum",D),b(a).unbind("resize.spectrum",Q),Aa.removeClass("sp-active"),n.hide(),tinycolor.equals(W(),Va)||(wb&&"cancel"!==c?H(!0):d(Va,!0)),G.hide(W())},d=function(a,b){if(!tinycolor.equals(a,W())){var c=tinycolor(a),h=c.toHsv();la=h.h;Ma=h.s;qa=h.v;N=h.a;F();b||(Ua=La||c.format)}},W=function(){return tinycolor.fromRatio({h:la,s:Ma,v:qa,a:Math.round(100*N)/100})},P=function(){F();G.move(W())},F=function(){Na.removeClass("sp-validation-error");Y();var a=tinycolor({h:la,
s:"1.0",v:"1.0"});B.css("background-color",a.toHexString());a=Ua;if(1>N&&("hex"===a||"name"===a))a="rgb";var b=W(),c=b.toHexString(),h=b.toRgbString();z||1===b.alpha?xb.css("background-color",h):(xb.css("background-color","transparent"),xb.css("filter",b.toFilter()));if(E.showAlpha){h=b.toRgb();h.a=0;var h=tinycolor(h).toRgbString(),d="linear-gradient(left, "+h+", "+c+")";T?Ea.css("filter",tinycolor(h).toFilter({gradientType:1},c)):(Ea.css("background","-webkit-"+d),Ea.css("background","-moz-"+d),
...
Ta.width();na=Ta.height();Ha=pb.height();oa=qb.width();ua=rb.width();O||n.offset(f(n,aa));Y()};r=function(){D();h=!0;va.attr("disabled",!0);aa.addClass("sp-disabled")};var E,I=b.extend({},S,g);I.callbacks={move:l(I.move,this),change:l(I.change,this),show:l(I.show,this),hide:l(I.hide,this),beforeShow:l(I.beforeShow,this)};E=I;var O=E.flat,ca=E.showSelectionPalette,M=E.localStorageKey,X=E.theme,G=E.callbacks,Q,ga=J,ja;Q=function(){var a=this,b=arguments;ja||(ja=setTimeout(function(){ja=null;ga.apply(a,
b)},10))};var ea=!1,da=0,ia=0,R=0,na=0,oa=0,ua=0,Ha=0,la=0,Ma=0,qa=0,N=1,I=E.palette.slice(0),jb=b.isArray(I[0])?I:[I],Ga=E.selectionPalette.slice(0),wa="sp-dragging",xa=this.ownerDocument,I=xa.body,va=b(this),h=!1,n=b(V,xa).addClass(X),B=n.find(".sp-color"),ra=n.find(".sp-dragger"),Ta=n.find(".sp-hue"),pb=n.find(".sp-slider"),Ea=n.find(".sp-alpha-inner"),qb=n.find(".sp-alpha"),rb=n.find(".sp-alpha-handle"),Na=n.find(".sp-input"),Sb=n.find(".sp-palette"),Jb=n.find(".sp-initial"),Kb=n.find(".sp-cancel"),
sb=n.find(".sp-choose"),kb=va.is("input"),ya=kb&&!O,Aa=ya?b("<div class='sp-replacer'><div class='sp-preview'><div class='sp-preview-inner'></div></div></div>").addClass(X):b([]),aa=ya?Aa:va,xb=Aa.find(".sp-preview-inner"),yb=E.color||kb&&va.val(),Va=!1,La=E.preferredFormat,Ua=La,wb=!E.showButtons||E.clickoutFiresChange,X=function(a){a.data&&a.data.ignore?(d(b(this).data("color")),P()):(d(b(this).data("color")),H(!0),P(),D());return!1};T&&n.find("*:not(input)").attr("unselectable","on");k();ya&&va.hide().after(Aa);
O?va.after(n).hide():b(I).append(n.hide());if(M&&a.localStorage){try{var zb=a.localStorage[M].split(",#");1<zb.length&&(delete a.localStorage[M],b.each(zb,function(a,b){x(b)}))}catch(Wb){}try{Ga=a.localStorage[M].split(";")}catch(Mb){}}aa.bind("click.spectrum touchstart.spectrum",function(a){h||Z();a.stopPropagation();b(a.target).is("input")||a.preventDefault()});(va.is(":disabled")||!0===E.disabled)&&r();n.click(u);Na.change(v);Na.bind("paste",function(){setTimeout(v,1)});Na.keydown(function(a){13==
a.keyCode&&v()});Kb.text(E.cancelText);Kb.bind("click.spectrum",function(a){a.stopPropagation();a.preventDefault();D("cancel")});sb.text(E.chooseText);sb.bind("click.spectrum",function(a){a.stopPropagation();a.preventDefault();Na.hasClass("sp-validation-error")||(H(!0),D())});t(qb,function(a,b,c){N=a/oa;c.shiftKey&&(N=Math.round(10*N)/10);P()});t(Ta,function(a,b){la=parseFloat(b/na);P()},A,p);t(B,function(a,b){Ma=parseFloat(a/da);qa=parseFloat((ia-b)/ia);P()},A,p);yb?(d(yb),F(),Ua=La||tinycolor(yb).format,
x(yb)):F();O&&K();A=T?"mousedown.spectrum":"click.spectrum touchstart.spectrum";Sb.delegate(".sp-thumb-el",A,X);Jb.delegate(".sp-thumb-el:nth-child(1)",A,{ignore:!0},X);var bb={show:K,hide:D,toggle:Z,reflow:J,option:function(a,h){if(a===c)return b.extend({},E);if(h===c)return E[a];E[a]=h;k()},enable:function(){h=!1;va.attr("disabled",!1);aa.removeClass("sp-disabled")},disable:r,set:function(a){d(a);H()},get:W,destroy:function(){va.show();aa.unbind("click.spectrum touchstart.spectrum");n.remove();
Aa.remove();U[bb.id]=null},container:n};bb.id=U.push(bb)-1;r=bb;b(this).data("spectrum.id",r.id)})};b.fn.spectrum.load=!0;b.fn.spectrum.loadOpts={};b.fn.spectrum.draggable=t;b.fn.spectrum.defaults=S;b.spectrum={};b.spectrum.localization={};b.spectrum.palettes={};b.fn.spectrum.processNativeColorInputs=function(){var a=b("<input type='color' value='!' />")[0];"color"===a.type&&"!"!=a.value||b("input[type=color]").spectrum({preferredFormat:"hex6"})};var w=function(a){var b,c,e,f,l;if("object"==typeof a&&
...
c=J(c,255);var g=ca(a,b,c),e=m(a,b,c),f,k=(g+e)/2;if(g==e)f=e=0;else{var x=g-e,e=0.5<k?x/(2-g-e):x/(g+e);switch(g){case a:f=(b-c)/x+(b<c?6:0);break;case b:f=(c-a)/x+2;break;case c:f=(a-b)/x+4}f/=6}return{h:f,s:e,l:k}},I=function(a,b,c){a=J(a,255);b=J(b,255);c=J(c,255);var g=ca(a,b,c),e=m(a,b,c),f,k=g-e;if(g==e)f=0;else{switch(g){case a:f=(b-c)/k+(b<c?6:0);break;case b:f=(c-a)/k+2;break;case c:f=(a-b)/k+4}f/=6}return{h:f,s:0===g?0:k/g,v:g}},Q=function(a,b,c,g){a=[k(P(a).toString(16)),k(P(b).toString(16)),
k(P(c).toString(16))];return!g&&a[0].charAt(0)==a[0].charAt(1)&&a[1].charAt(0)==a[1].charAt(1)&&a[2].charAt(0)==a[2].charAt(1)?a[0].charAt(0)+a[1].charAt(0)+a[2].charAt(0):a.join("")},J=function(a,b){"string"==typeof a&&(-1!=a.indexOf(".")&&1===ja(a))&&(a="100%");var c="string"===typeof a&&-1!=a.indexOf("%");a=m(b,ca(0,ja(a)));c&&(a*=b/100);return 1E-6>W.abs(a-b)?1:1<=a?a%b/ja(b):a},k=function(a){return 1==a.length?"0"+a:""+a},D=/^[\s,#]+/,Y=/\s+$/,ga=0,W=Math,P=W.round,m=W.min,ca=W.max,O=W.random,
...
360,s:b.s,l:b.l})]};w.splitcomplement=function(a){var b=w(a).toHsl(),c=360*b.h;return[w(a),w({h:(c+72)%360,s:b.s,l:b.l}),w({h:(c+216)%360,s:b.s,l:b.l})]};w.analogous=function(a,b,c){b=b||6;c=c||30;var g=w(a).toHsl();c=360/c;a=[w(a)];g.h*=360;for(g.h=(g.h-(c*b>>1)+720)%360;--b;)g.h=(g.h+c)%360,a.push(w(g));return a};w.monochromatic=function(a,b){b=b||6;for(var c=w(a).toHsv(),g=c.h,e=c.s,c=c.v,f=[],k=1/b;b--;)f.push(w({h:g,s:e,v:c})),c=(c+k)%1;return f};w.readable=function(a,b){var c=w(a).toRgb(),g=
w(b).toRgb();return 10404<(g.r-c.r)*(g.r-c.r)+(g.g-c.g)*(g.g-c.g)+(g.b-c.b)*(g.b-c.b)};var ea=w.names={aliceblue:"f0f8ff",antiquewhite:"faebd7",aqua:"0ff",aquamarine:"7fffd4",azure:"f0ffff",beige:"f5f5dc",bisque:"ffe4c4",black:"000",blanchedalmond:"ffebcd",blue:"00f",blueviolet:"8a2be2",brown:"a52a2a",burlywood:"deb887",burntsienna:"ea7e5d",cadetblue:"5f9ea0",chartreuse:"7fff00",chocolate:"d2691e",coral:"ff7f50",cornflowerblue:"6495ed",cornsilk:"fff8dc",crimson:"dc143c",cyan:"0ff",darkblue:"00008b",
...
b,c){if(!b&&k.isArray(a)&&a[0]===+a[0])return Math.max.apply(Math,a);if(!b&&k.isEmpty(a))return-Infinity;var e={computed:-Infinity};D(a,function(a,g,f){g=b?b.call(c,a,g,f):a;g>=e.computed&&(e={value:a,computed:g})});return e.value};k.min=function(a,b,c){if(!b&&k.isArray(a)&&a[0]===+a[0])return Math.min.apply(Math,a);if(!b&&k.isEmpty(a))return Infinity;var e={computed:Infinity};D(a,function(a,g,f){g=b?b.call(c,a,g,f):a;g<e.computed&&(e={value:a,computed:g})});return e.value};k.shuffle=function(a){var b=
[],c;D(a,function(a,e){c=Math.floor(Math.random()*(e+1));b[e]=b[c];b[c]=a});return b};k.sortBy=function(a,b,c){var e=k.isFunction(b)?b:function(a){return a[b]};return k.pluck(k.map(a,function(a,b,g){return{value:a,criteria:e.call(c,a,b,g)}}).sort(function(a,b){var c=a.criteria,e=b.criteria;return void 0===c?1:void 0===e?-1:c<e?-1:c>e?1:0}),"value")};k.groupBy=function(a,b){var c={},e=k.isFunction(b)?b:function(a){return a[b]};D(a,function(a,b){var g=e(a,b);(c[g]||(c[g]=[])).push(a)});return c};k.sortedIndex=
...
d);if(k["force new connection"]||!b.sockets[f])g=new b.Socket(k);!k["force new connection"]&&g&&(b.sockets[f]=g);g=g||b.sockets[f];return g.of(1<e.path.length?e.path:"")};var c=this,e=("undefined"!=typeof io?io:module.exports).util={},f=/^(?:(?![^:@]+:[^:@\/]*@)([^:\/?#.]+):)?(?:\/\/)?((?:(([^:@]*)(?::([^:@]*))?)?@)?([^:\/?#]*)(?::(\d*))?)(((\/(?:[^?#](?![^?#\/]*\.[^?#\/.]+(?:[?#]|$)))*\/?)?([^?#\/]*))(?:\?([^#]*))?(?:#(.*))?)/,p="source protocol authority userInfo user password host port relative path directory file query anchor".split(" ");
...
a.replace(k,function(a){var b=m[a];return"string"===typeof b?b:"\\u"+("0000"+a.charCodeAt(0).toString(16)).slice(-4)})+'"':'"'+a+'"'}function e(a,b){var h,f,g,n,k=v,m,p=b[a];p instanceof Date&&(p=isFinite(a.valueOf())?a.getUTCFullYear()+"-"+c(a.getUTCMonth()+1)+"-"+c(a.getUTCDate())+"T"+c(a.getUTCHours())+":"+c(a.getUTCMinutes())+":"+c(a.getUTCSeconds())+"Z":null);"function"===typeof t&&(p=t.call(b,a,p));switch(typeof p){case "string":return d(p);case "number":return isFinite(p)?String(p):"null";
case "boolean":case "null":return String(p);case "object":if(!p)return"null";v+=l;m=[];if("[object Array]"===Object.prototype.toString.apply(p)){n=p.length;for(h=0;h<n;h+=1)m[h]=e(h,p)||"null";g=0===m.length?"[]":v?"[\n"+v+m.join(",\n"+v)+"\n"+k+"]":"["+m.join(",")+"]";v=k;return g}if(t&&"object"===typeof t){n=t.length;for(h=0;h<n;h+=1)"string"===typeof t[h]&&(f=t[h],(g=e(f,p))&&m.push(d(f)+(v?": ":":")+g))}else for(f in p)Object.prototype.hasOwnProperty.call(p,f)&&(g=e(f,p))&&m.push(d(f)+(v?": ":
":")+g);g=0===m.length?"{}":v?"{\n"+v+m.join(",\n"+v)+"\n"+k+"}":"{"+m.join(",")+"}";v=k;return g}}if(b&&b.parse)return a.JSON={parse:b.parse,stringify:b.stringify};var f=a.JSON={},g=/[\u0000\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,k=/[\\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,v,l,m={"\b":"\\b","\t":"\\t","\n":"\\n","\f":"\\f","\r":"\\r",'"':'\\"',"\\":"\\\\"},t;
f.stringify=function(a,b,c){var d;l=v="";if("number"===typeof c)for(d=0;d<c;d+=1)l+=" ";else"string"===typeof c&&(l=c);if((t=b)&&"function"!==typeof b&&("object"!==typeof b||"number"!==typeof b.length))throw Error("JSON.stringify");return e("",{"":a})};f.parse=function(a,b){function c(a,d){var h,e,f=a[d];if(f&&"object"===typeof f)for(h in f)Object.prototype.hasOwnProperty.call(f,h)&&(e=c(f,h),void 0!==e?f[h]=e:delete f[h]);return b.call(a,d,f)}var d;a=String(a);g.lastIndex=0;g.test(a)&&(a=a.replace(g,
...
!0);m.transports.push("flashsocket");if("undefined"!=typeof window){var O,ja=function(){if(!Qa){try{var a=K.getElementsByTagName("body")[0].appendChild(K.createElement("span"));a.parentNode.removeChild(a)}catch(b){return}Qa=!0;for(var a=d.length,c=0;c<a;c++)d[c]()}},ea=function(a){Qa?a():d[d.length]=a},l=function(a){if(typeof Z.addEventListener!=ha)Z.addEventListener("load",a,!1);else if(typeof K.addEventListener!=ha)K.addEventListener("load",a,!1);else if(typeof Z.attachEvent!=ha){var b=Z;b.attachEvent("onload",
a);Za[Za.length]=[b,"onload",a]}else if("function"==typeof Z.onload){var c=Z.onload;Z.onload=function(){c();a()}}else Z.onload=a},H=function(){var a=Da.length;if(0<a)for(var b=0;b<a;b++){var c=Da[b].id,d=Da[b].callbackFn,e={success:!1,id:c};if(0<G.pv[0]){var f=fa(c);if(f)if(Wa(Da[b].swfVersion)&&!(G.wk&&312>G.wk))sa(c,!0),d&&(e.success=!0,e.ref=M(c),d(e));else if(Da[b].expressInstall&&g()){e={};e.data=Da[b].expressInstall;e.width=f.getAttribute("width")||"0";e.height=f.getAttribute("height")||"0";
...
sa=function(a,b){if(Rb){var c=b?"visible":"hidden";Qa&&fa(a)?fa(a).style.visibility=c:Xa("#"+a,"visibility:"+c)}},Ca=function(a){return null!=/[\\\"<>\.;]/.exec(a)&&typeof encodeURIComponent!=ha?encodeURIComponent(a):a},ha="undefined",ta="object",ka="application/x-shockwave-flash",v="SWFObjectExprInst",Z=window,K=document;t=navigator;var Ya=!1,d=[function(){if(Ya){var a=K.getElementsByTagName("body")[0],b=K.createElement(ta);b.setAttribute("type",ka);var c=a.appendChild(b);if(c){var d=0;(function(){if(typeof c.GetVariable!=
ha){var e=c.GetVariable("$version");e&&(e=e.split(" ")[1].split(","),G.pv=[parseInt(e[0],10),parseInt(e[1],10),parseInt(e[2],10)])}else if(10>d){d++;setTimeout(arguments.callee,10);return}a.removeChild(b);c=null;H()})()}else H()}else H()}],Da=[],Ba=[],Za=[],gb,hb,Hb,Qb,Qa=!1,ob=!1,Ja,Ib,Rb=!0,G,S=typeof K.getElementById!=ha&&typeof K.getElementsByTagName!=ha&&typeof K.createElement!=ha,Ra=t.userAgent.toLowerCase(),Sa=t.platform.toLowerCase(),dc=Sa?/win/.test(Sa):/win/.test(Ra),Sa=Sa?/mac/.test(Sa):
/mac/.test(Ra),Ra=/webkit/.test(Ra)?parseFloat(Ra.replace(/^.*webkit\/(\d+(\.\d+)?).*$/,"$1")):!1,ib=!+"\v1",da=[0,0,0],ia=null;if(typeof t.plugins!=ha&&typeof t.plugins["Shockwave Flash"]==ta){if((ia=t.plugins["Shockwave Flash"].description)&&!(typeof t.mimeTypes!=ha&&t.mimeTypes[ka]&&!t.mimeTypes[ka].enabledPlugin))Ya=!0,ib=!1,ia=ia.replace(/^.*\s+(\S+\s+\S+$)/,"$1"),da[0]=parseInt(ia.replace(/^(.*)\..*$/,"$1"),10),da[1]=parseInt(ia.replace(/^.*\.(.*)\s.*$/,"$1"),10),da[2]=/[a-zA-Z]/.test(ia)?parseInt(ia.replace(/^.*[a-zA-Z]+(.*)$/,
"$1"),10):0}else if(typeof Z[["Active"].concat("Object").join("X")]!=ha)try{var R=new (window[["Active"].concat("Object").join("X")])("ShockwaveFlash.ShockwaveFlash");if(R&&(ia=R.GetVariable("$version")))ib=!0,ia=ia.split(" ")[1].split(","),da=[parseInt(ia[0],10),parseInt(ia[1],10),parseInt(ia[2],10)]}catch(na){}G={w3:S,pv:da,wk:Ra,ie:ib,win:dc,mac:Sa};G.w3&&((typeof K.readyState!=ha&&"complete"==K.readyState||typeof K.readyState==ha&&(K.getElementsByTagName("body")[0]||K.body))&&ja(),Qa||(typeof K.addEventListener!=
...
"";d+="";var p={};if(l&&typeof l===ta)for(var q in l)p[q]=l[q];p.data=a;p.width=c;p.height=d;q={};if(v&&typeof v===ta)for(var r in v)q[r]=v[r];if(k&&typeof k===ta)for(var w in k)q.flashvars=typeof q.flashvars!=ha?q.flashvars+("&"+w+"="+k[w]):w+"="+k[w];if(Wa(e))r=L(p,q,b),p.id==b&&sa(b,!0),t.success=!0,t.ref=r;else{if(f&&g()){p.data=f;x(p,q,b,m);return}sa(b,!0)}m&&m(t)})):m&&m(t)},switchOffAutoHideShow:function(){Rb=!1},ua:G,getFlashPlayerVersion:function(){return{major:G.pv[0],minor:G.pv[1],release:G.pv[2]}},
...
nudgepad.stage.selection.toSpace=function(){var a=new Space;$(".selection").each(function(){var b=$(this).scrap();a.set(b.getPath(),new Space(b.toString()))});return a};nudgepad.broadcastSelection=function(){nudgepad.setColor();var a="",b=" ";$(".selection").each(function(){a+=b+$(this).scrap().selector();b=","});a+="{box-shadow: 0 0 4px "+nudgepad.tab.get("color")+";cursor: not-allowed;}";nudgepad.tab.patch("selection "+a)};
