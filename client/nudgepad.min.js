...
u||(u={}))[t]=a[t]);return u&&d.extend(!0,g,u),g}function ha(){try{return new a.XMLHttpRequest}catch(g){}}function ja(){return setTimeout(function(){qb=b}),qb=d.now()}function ia(g,a,b){var t,c,h=0,e=Qb.length,l=d.Deferred().always(function(){delete f.elem}),f=function(){if(c)return!1;for(var a=qb||ja(),a=Math.max(0,k.startTime+k.duration-a),z=1-(a/k.duration||0),b=0,u=k.tweens.length;u>b;b++)k.tweens[b].run(z);return l.notifyWith(g,[k,z,a]),1>z&&u?a:(l.resolveWith(g,[k]),!1)},k=l.promise({elem:g,
