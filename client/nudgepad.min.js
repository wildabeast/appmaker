...
nudgepad.codePanel.livePreview=function(){var a=new Space($("#nudgepadCodePanel").val());nudgepad.stage.selection.exists()||(nudgepad.pages.stage=new Page(a),nudgepad.stage.render())};nudgepad.codePanel.close=function(){$("#nudgepadCodePanel").hide();$("#nudgepadStage").css({width:"100%",left:""})};
nudgepad.codePanel.open=function(){var a=$("#nudgepadCodePanel");a.show();$("#nudgepadStage").css({width:"100%",left:"40%"});nudgepad.stage.selection.exists()?a.val(nudgepad.stage.selection.toSpace().toString()):a.val(nudgepad.pages.stage.toString());a.on("keyup",nudgepad.codePanel.livePreviewStart);a.on("blur",nudgepad.stage.commit);a.on("tap mousedown click slide slidestart slideend mouseup",function(a){a.stopPropagation()})};
nudgepad.codePanel.toggle=function(){0<$("#nudgepadCodePanel:visible").length?nudgepad.codePanel.close():nudgepad.codePanel.open()};
