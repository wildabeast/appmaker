(function(a,b){function c(g){var a=g.length,u=e.type(g);return e.isWindow(g)?!1:1===g.nodeType&&a?!0:"array"===u||"function"!==u&&(0===a||"number"==typeof a&&0<a&&a-1 in g)}function d(g,a,u,x){if(e.acceptData(g)){var c,h,Sa=e.expando,d="string"==typeof a,l=g.nodeType,f=l?e.cache:g,k=l?g[Sa]:g[Sa]&&Sa;if(k&&f[k]&&(x||f[k].data)||!d||u!==b)return k||(l?g[Sa]=k=Ca.pop()||e.guid++:k=Sa),f[k]||(f[k]={},l||(f[k].toJSON=e.noop)),("object"==typeof a||"function"==typeof a)&&(x?f[k]=e.extend(f[k],a):f[k].data=
e.extend(f[k].data,a)),c=f[k],x||(c.data||(c.data={}),c=c.data),u!==b&&(c[e.camelCase(a)]=u),d?(h=c[a],null==h&&(h=c[e.camelCase(a)])):h=c,h}}function f(g,a,u){if(e.acceptData(g)){var b,c,h,Sa=g.nodeType,d=Sa?e.cache:g,l=Sa?g[e.expando]:e.expando;if(d[l]){if(a&&(h=u?d[l]:d[l].data)){e.isArray(a)?a=a.concat(e.map(a,e.camelCase)):a in h?a=[a]:(a=e.camelCase(a),a=a in h?[a]:a.split(" "));b=0;for(c=a.length;c>b;b++)delete h[a[b]];if(!(u?q:e.isEmptyObject)(h))return}(u||(delete d[l].data,q(d[l])))&&(Sa?
e.cleanData([g],!0):e.support.deleteExpando||d!=d.window?delete d[l]:d[l]=null)}}}function n(g,a,u){if(u===b&&1===g.nodeType){var x="data-"+a.replace(wa,"-$1").toLowerCase();if(u=g.getAttribute(x),"string"==typeof u){try{u="true"===u?!0:"false"===u?!1:"null"===u?null:+u+""===u?+u:Ga.test(u)?e.parseJSON(u):u}catch(c){}e.data(g,a,u)}else u=b}return u}function q(g){for(var a in g)if(("data"!==a||!e.isEmptyObject(g[a]))&&"toJSON"!==a)return!1;return!0}function m(){return!0}function p(){return!1}function Q(g,
a){do g=g[a];while(g&&1!==g.nodeType);return g}function T(g,a,u){if(a=a||0,e.isFunction(a))return e.grep(g,function(g,b){return!!a.call(g,b,g)===u});if(a.nodeType)return e.grep(g,function(g){return g===a===u});if("string"==typeof a){var b=e.grep(g,function(g){return 1===g.nodeType});if(Uc.test(a))return e.filter(a,b,!u);a=e.filter(a,b)}return e.grep(g,function(g){return 0<=e.inArray(g,a)===u})}function W(g){var a=tc.split("|");g=g.createDocumentFragment();if(g.createElement)for(;a.length;)g.createElement(a.pop());
return g}function y(g){var a=g.getAttributeNode("type");return g.type=(a&&a.specified)+"/"+g.type,g}function B(g){var a=Vc.exec(g.type);return a?g.type=a[1]:g.removeAttribute("type"),g}function N(g,a){for(var u,b=0;null!=(u=g[b]);b++)e._data(u,"globalEval",!a||e._data(a[b],"globalEval"))}function X(g,a){if(1===a.nodeType&&e.hasData(g)){var u,b,c;b=e._data(g);var h=e._data(a,b),d=b.events;if(d)for(u in delete h.handle,h.events={},d){b=0;for(c=d[u].length;c>b;b++)e.event.add(a,u,d[u][b])}h.data&&(h.data=
e.extend({},h.data))}}function s(g,a){var u,x,c=0,h=typeof g.getElementsByTagName!==A?g.getElementsByTagName(a||"*"):typeof g.querySelectorAll!==A?g.querySelectorAll(a||"*"):b;if(!h){h=[];for(u=g.childNodes||g;null!=(x=u[c]);c++)!a||e.nodeName(x,a)?h.push(x):e.merge(h,s(x,a))}return a===b||a&&e.nodeName(g,a)?e.merge([g],h):h}function U(g){cc.test(g.type)&&(g.defaultChecked=g.checked)}function K(g,a){if(a in g)return a;for(var b=a.charAt(0).toUpperCase()+a.slice(1),e=a,c=uc.length;c--;)if(a=uc[c]+
b,a in g)return a;return e}function V(g,a){return g=a||g,"none"===e.css(g,"display")||!e.contains(g.ownerDocument,g)}function I(g,a){for(var b,x,c,h=[],d=0,l=g.length;l>d;d++)x=g[d],x.style&&(h[d]=e._data(x,"olddisplay"),b=x.style.display,a?(h[d]||"none"!==b||(x.style.display=""),""===x.style.display&&V(x)&&(h[d]=e._data(x,"olddisplay",ca(x.nodeName)))):h[d]||(c=V(x),(b&&"none"!==b||!c)&&e._data(x,"olddisplay",c?b:e.css(x,"display"))));for(d=0;l>d;d++)x=g[d],x.style&&(a&&"none"!==x.style.display&&
""!==x.style.display||(x.style.display=a?h[d]||"":"none"));return g}function j(g,a,b){return(g=Wc.exec(a))?Math.max(0,g[1]-(b||0))+(g[2]||"px"):a}function C(g,a,b,x,c){a=b===(x?"border":"content")?4:"width"===a?1:0;for(var h=0;4>a;a+=2)"margin"===b&&(h+=e.css(g,b+gb[a],!0,c)),x?("content"===b&&(h-=e.css(g,"padding"+gb[a],!0,c)),"margin"!==b&&(h-=e.css(g,"border"+gb[a]+"Width",!0,c))):(h+=e.css(g,"padding"+gb[a],!0,c),"padding"!==b&&(h+=e.css(g,"border"+gb[a]+"Width",!0,c)));return h}function R(g,
a,b){var x=!0,c="width"===a?g.offsetWidth:g.offsetHeight,h=hb(g),d=e.support.boxSizing&&"border-box"===e.css(g,"boxSizing",!1,h);if(0>=c||null==c){if(c=ib(g,a,h),(0>c||null==c)&&(c=g.style[a]),Pb.test(c))return c;x=d&&(e.support.boxSizingReliable||c===g.style[a]);c=parseFloat(c)||0}return c+C(g,a,b||(d?"border":"content"),x,h)+"px"}function ca(g){var a=F,b=vc[g];return b||(b=L(g,a),"none"!==b&&b||(Gb=(Gb||e("<iframe frameborder='0' width='0' height='0'/>").css("cssText","display:block !important")).appendTo(a.documentElement),
a=(Gb[0].contentWindow||Gb[0].contentDocument).document,a.write("<!doctype html><html><body>"),a.close(),b=L(g,a),Gb.detach()),vc[g]=b),b}function L(g,a){var b=e(a.createElement(g)).appendTo(a.body),x=e.css(b[0],"display");return b.remove(),x}function H(g,a,b,x){var c;if(e.isArray(a))e.each(a,function(a,z){b||Xc.test(g)?x(g,z):H(g+"["+("object"==typeof z?a:"")+"]",z,b,x)});else if(b||"object"!==e.type(a))x(g,a);else for(c in a)H(g+"["+c+"]",a[c],b,x)}function S(g){return function(a,b){"string"!=typeof a&&
(b=a,a="*");var x,c=0,h=a.toLowerCase().match(Ba)||[];if(e.isFunction(b))for(;x=h[c++];)"+"===x[0]?(x=x.slice(1)||"*",(g[x]=g[x]||[]).unshift(b)):(g[x]=g[x]||[]).push(b)}}function P(g,a,u,x){function c(l){var f;return h[l]=!0,e.each(g[l]||[],function(g,e){var l=e(a,u,x);return"string"!=typeof l||d||h[l]?d?!(f=l):b:(a.dataTypes.unshift(l),c(l),!1)}),f}var h={},d=g===dc;return c(a.dataTypes[0])||!h["*"]&&c("*")}function fa(g,a){var u,x,c=e.ajaxSettings.flatOptions||{};for(x in a)a[x]!==b&&((c[x]?g:
u||(u={}))[x]=a[x]);return u&&e.extend(!0,g,u),g}function ha(){try{return new a.XMLHttpRequest}catch(g){}}function ja(){return setTimeout(function(){qb=b}),qb=e.now()}function ia(g,a,b){var x,c,h=0,d=Qb.length,l=e.Deferred().always(function(){delete f.elem}),f=function(){if(c)return!1;for(var a=qb||ja(),a=Math.max(0,k.startTime+k.duration-a),z=1-(a/k.duration||0),b=0,u=k.tweens.length;u>b;b++)k.tweens[b].run(z);return l.notifyWith(g,[k,z,a]),1>z&&u?a:(l.resolveWith(g,[k]),!1)},k=l.promise({elem:g,
props:e.extend({},a),opts:e.extend(!0,{specialEasing:{}},b),originalProperties:a,originalOptions:b,startTime:qb||ja(),duration:b.duration,tweens:[],createTween:function(a,z){var b=e.Tween(g,k.opts,a,z,k.opts.specialEasing[a]||k.opts.easing);return k.tweens.push(b),b},stop:function(a){var z=0,b=a?k.tweens.length:0;if(c)return this;for(c=!0;b>z;z++)k.tweens[z].run(1);return a?l.resolveWith(g,[k,a]):l.rejectWith(g,[k,a]),this}});a=k.props;b=k.opts.specialEasing;var r,t,j,w;for(t in a)if(r=e.camelCase(t),
j=b[r],x=a[t],e.isArray(x)&&(j=x[1],x=a[t]=x[0]),t!==r&&(a[r]=x,delete a[t]),w=e.cssHooks[r],w&&"expand"in w)for(t in x=w.expand(x),delete a[r],x)t in a||(a[t]=x[t],b[t]=j);else b[r]=j;for(;d>h;h++)if(x=Qb[h].call(k,g,a,k.opts))return x;var v=k;e.each(a,function(g,a){for(var z=(Hb[g]||[]).concat(Hb["*"]),b=0,u=z.length;u>b&&!z[b].call(v,g,a);b++);});return e.isFunction(k.opts.start)&&k.opts.start.call(g,k),e.fx.timer(e.extend(f,{elem:g,anim:k,queue:k.opts.queue})),k.progress(k.opts.progress).done(k.opts.done,
k.opts.complete).fail(k.opts.fail).always(k.opts.always)}function Y(g,a,b,e,c){return new Y.prototype.init(g,a,b,e,c)}function k(g,a){var b,e={height:g},c=0;for(a=a?1:0;4>c;c+=2-a)b=gb[c],e["margin"+b]=e["padding"+b]=g;return a&&(e.opacity=e.width=g),e}function D(g){return e.isWindow(g)?g:9===g.nodeType?g.defaultView||g.parentWindow:!1}var t,v,A=typeof b,F=a.document,ga=a.location,$a=a.jQuery,ab=a.$,sa={},Ca=[],da=Ca.concat,ta=Ca.push,ka=Ca.slice,w=Ca.indexOf,O=sa.toString,G=sa.hasOwnProperty,Ta=
"1.9.1".trim,e=function(g,a){return new e.fn.init(g,a,v)},Da=/[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,Ba=/\S+/g,bb=/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,jb=/^(?:(<[\w\W]+>)[^>]*|#([\w-]*))$/,kb=/^<(\w+)\s*\/?>(?:<\/\1>|)$/,Ib=/^[\],:{}\s]*$/,Rb=/(?:^|:|,)(?:\s*\[)+/g,Ua=/\\(?:["\\\/bfnrt]|u[\da-fA-F]{4})/g,rb=/"[^"\\\r\n]*"|true|false|null|-?(?:\d+\.|)\d+(?:[eE][+-]?\d+|)/g,Ka=/^-ms-/,Jb=/-([\da-z])/gi,Sb=function(g,a){return a.toUpperCase()},E=function(g){(F.addEventListener||"load"===g.type||
"complete"===F.readyState)&&(Va(),e.ready())},Va=function(){F.addEventListener?(F.removeEventListener("DOMContentLoaded",E,!1),a.removeEventListener("load",E,!1)):(F.detachEvent("onreadystatechange",E),a.detachEvent("onload",E))};e.fn=e.prototype={jquery:"1.9.1",constructor:e,init:function(g,a,u){var x,c;if(!g)return this;if("string"==typeof g){if(x="<"===g.charAt(0)&&">"===g.charAt(g.length-1)&&3<=g.length?[null,g,null]:jb.exec(g),!x||!x[1]&&a)return!a||a.jquery?(a||u).find(g):this.constructor(a).find(g);
if(x[1]){if(a=a instanceof e?a[0]:a,e.merge(this,e.parseHTML(x[1],a&&a.nodeType?a.ownerDocument||a:F,!0)),kb.test(x[1])&&e.isPlainObject(a))for(x in a)e.isFunction(this[x])?this[x](a[x]):this.attr(x,a[x]);return this}if(c=F.getElementById(x[2]),c&&c.parentNode){if(c.id!==x[2])return u.find(g);this.length=1;this[0]=c}return this.context=F,this.selector=g,this}return g.nodeType?(this.context=this[0]=g,this.length=1,this):e.isFunction(g)?u.ready(g):(g.selector!==b&&(this.selector=g.selector,this.context=
g.context),e.makeArray(g,this))},selector:"",length:0,size:function(){return this.length},toArray:function(){return ka.call(this)},get:function(g){return null==g?this.toArray():0>g?this[this.length+g]:this[g]},pushStack:function(g){g=e.merge(this.constructor(),g);return g.prevObject=this,g.context=this.context,g},each:function(g,a){return e.each(this,g,a)},ready:function(g){return e.ready.promise().done(g),this},slice:function(){return this.pushStack(ka.apply(this,arguments))},first:function(){return this.eq(0)},
last:function(){return this.eq(-1)},eq:function(g){var a=this.length;g=+g+(0>g?a:0);return this.pushStack(0<=g&&a>g?[this[g]]:[])},map:function(g){return this.pushStack(e.map(this,function(a,b){return g.call(a,b,a)}))},end:function(){return this.prevObject||this.constructor(null)},push:ta,sort:[].sort,splice:[].splice};e.fn.init.prototype=e.fn;e.extend=e.fn.extend=function(){var g,a,u,x,c,h,d=arguments[0]||{},l=1,k=arguments.length,f=!1;"boolean"==typeof d&&(f=d,d=arguments[1]||{},l=2);"object"==
typeof d||e.isFunction(d)||(d={});for(k===l&&(d=this,--l);k>l;l++)if(null!=(c=arguments[l]))for(x in c)g=d[x],u=c[x],d!==u&&(f&&u&&(e.isPlainObject(u)||(a=e.isArray(u)))?(a?(a=!1,h=g&&e.isArray(g)?g:[]):h=g&&e.isPlainObject(g)?g:{},d[x]=e.extend(f,h,u)):u!==b&&(d[x]=u));return d};e.extend({noConflict:function(g){return a.$===e&&(a.$=ab),g&&a.jQuery===e&&(a.jQuery=$a),e},isReady:!1,readyWait:1,holdReady:function(g){g?e.readyWait++:e.ready(!0)},ready:function(g){if(!0===g?!--e.readyWait:!e.isReady){if(!F.body)return setTimeout(e.ready);
e.isReady=!0;!0!==g&&0<--e.readyWait||(t.resolveWith(F,[e]),e.fn.trigger&&e(F).trigger("ready").off("ready"))}},isFunction:function(g){return"function"===e.type(g)},isArray:Array.isArray||function(g){return"array"===e.type(g)},isWindow:function(g){return null!=g&&g==g.window},isNumeric:function(g){return!isNaN(parseFloat(g))&&isFinite(g)},type:function(g){return null==g?g+"":"object"==typeof g||"function"==typeof g?sa[O.call(g)]||"object":typeof g},isPlainObject:function(g){if(!g||"object"!==e.type(g)||
g.nodeType||e.isWindow(g))return!1;try{if(g.constructor&&!G.call(g,"constructor")&&!G.call(g.constructor.prototype,"isPrototypeOf"))return!1}catch(a){return!1}for(var u in g);return u===b||G.call(g,u)},isEmptyObject:function(g){for(var a in g)return!1;return!0},error:function(g){throw Error(g);},parseHTML:function(g,a,b){if(!g||"string"!=typeof g)return null;"boolean"==typeof a&&(b=a,a=!1);a=a||F;var x=kb.exec(g);b=!b&&[];return x?[a.createElement(x[1])]:(x=e.buildFragment([g],a,b),b&&e(b).remove(),
e.merge([],x.childNodes))},parseJSON:function(g){return a.JSON&&a.JSON.parse?a.JSON.parse(g):null===g?g:"string"==typeof g&&(g=e.trim(g),g&&Ib.test(g.replace(Ua,"@").replace(rb,"]").replace(Rb,"")))?Function("return "+g)():(e.error("Invalid JSON: "+g),b)},parseXML:function(g){var z,u;if(!g||"string"!=typeof g)return null;try{a.DOMParser?(u=new DOMParser,z=u.parseFromString(g,"text/xml")):(z=new ActiveXObject("Microsoft.XMLDOM"),z.async="false",z.loadXML(g))}catch(x){z=b}return z&&z.documentElement&&
!z.getElementsByTagName("parsererror").length||e.error("Invalid XML: "+g),z},noop:function(){},globalEval:function(g){g&&e.trim(g)&&(a.execScript||function(g){a.eval.call(a,g)})(g)},camelCase:function(g){return g.replace(Ka,"ms-").replace(Jb,Sb)},nodeName:function(g,a){return g.nodeName&&g.nodeName.toLowerCase()===a.toLowerCase()},each:function(g,a,b){var e,h=0,d=g.length,l=c(g);if(b)if(l)for(;d>h&&!(e=a.apply(g[h],b),!1===e);h++);else for(h in g){if(e=a.apply(g[h],b),!1===e)break}else if(l)for(;d>
h&&!(e=a.call(g[h],h,g[h]),!1===e);h++);else for(h in g)if(e=a.call(g[h],h,g[h]),!1===e)break;return g},trim:Ta&&!Ta.call("\ufeff\u00a0")?function(g){return null==g?"":Ta.call(g)}:function(g){return null==g?"":(g+"").replace(bb,"")},makeArray:function(g,a){var b=a||[];return null!=g&&(c(Object(g))?e.merge(b,"string"==typeof g?[g]:g):ta.call(b,g)),b},inArray:function(g,a,b){var e;if(a){if(w)return w.call(a,g,b);e=a.length;for(b=b?0>b?Math.max(0,e+b):b:0;e>b;b++)if(b in a&&a[b]===g)return b}return-1},
merge:function(g,a){var e=a.length,x=g.length,c=0;if("number"==typeof e)for(;e>c;c++)g[x++]=a[c];else for(;a[c]!==b;)g[x++]=a[c++];return g.length=x,g},grep:function(g,a,b){var e,c=[],h=0,d=g.length;for(b=!!b;d>h;h++)e=!!a(g[h],h),b!==e&&c.push(g[h]);return c},map:function(g,a,b){var e,h=0,d=g.length,l=[];if(c(g))for(;d>h;h++)e=a(g[h],h,b),null!=e&&(l[l.length]=e);else for(h in g)e=a(g[h],h,b),null!=e&&(l[l.length]=e);return da.apply([],l)},guid:1,proxy:function(g,a){var u,c,h;return"string"==typeof a&&
(h=g[a],a=g,g=h),e.isFunction(g)?(u=ka.call(arguments,2),c=function(){return g.apply(a||this,u.concat(ka.call(arguments)))},c.guid=g.guid=g.guid||e.guid++,c):b},access:function(g,a,u,c,h,d,l){var k=0,f=g.length,t=null==u;if("object"===e.type(u))for(k in h=!0,u)e.access(g,a,k,u[k],!0,d,l);else if(c!==b&&(h=!0,e.isFunction(c)||(l=!0),t&&(l?(a.call(g,c),a=null):(t=a,a=function(g,a,b){return t.call(e(g),b)})),a))for(;f>k;k++)a(g[k],u,l?c:c.call(g[k],k,a(g[k],u)));return h?g:t?a.call(g):f?a(g[0],u):d},
now:function(){return(new Date).getTime()}});e.ready.promise=function(g){if(!t)if(t=e.Deferred(),"complete"===F.readyState)setTimeout(e.ready);else if(F.addEventListener)F.addEventListener("DOMContentLoaded",E,!1),a.addEventListener("load",E,!1);else{F.attachEvent("onreadystatechange",E);a.attachEvent("onload",E);var b=!1;try{b=null==a.frameElement&&F.documentElement}catch(u){}b&&b.doScroll&&function Tc(){if(!e.isReady){try{b.doScroll("left")}catch(g){return setTimeout(Tc,50)}Va();e.ready()}}()}return t.promise(g)};
e.each("Boolean Number String Function Array Date RegExp Object Error".split(" "),function(g,a){sa["[object "+a+"]"]=a.toLowerCase()});v=e(F);var Wa={};e.Callbacks=function(g){var a;if("string"==typeof g){if(!(a=Wa[g])){a=g;var u=Wa[a]={};a=(e.each(a.match(Ba)||[],function(g,a){u[a]=!0}),u)}}else a=e.extend({},g);g=a;var c,h,d,l,k,f,t=[],r=!g.once&&[],j=function(a){h=g.memory&&a;d=!0;k=f||0;f=0;l=t.length;for(c=!0;t&&l>k;k++)if(!1===t[k].apply(a[0],a[1])&&g.stopOnFalse){h=!1;break}c=!1;t&&(r?r.length&&
j(r.shift()):h?t=[]:w.disable())},w={add:function(){if(t){var a=t.length;(function Yc(a){e.each(a,function(a,b){var z=e.type(b);"function"===z?g.unique&&w.has(b)||t.push(b):b&&b.length&&"string"!==z&&Yc(b)})})(arguments);c?l=t.length:h&&(f=a,j(h))}return this},remove:function(){return t&&e.each(arguments,function(g,a){for(var b;-1<(b=e.inArray(a,t,b));)t.splice(b,1),c&&(l>=b&&l--,k>=b&&k--)}),this},has:function(g){return g?-1<e.inArray(g,t):!(!t||!t.length)},empty:function(){return t=[],this},disable:function(){return t=
r=h=b,this},disabled:function(){return!t},lock:function(){return r=b,h||w.disable(),this},locked:function(){return!r},fireWith:function(g,a){return a=a||[],a=[g,a.slice?a.slice():a],!t||d&&!r||(c?r.push(a):j(a)),this},fire:function(){return w.fireWith(this,arguments),this},fired:function(){return!!d}};return w};e.extend({Deferred:function(g){var a=[["resolve","done",e.Callbacks("once memory"),"resolved"],["reject","fail",e.Callbacks("once memory"),"rejected"],["notify","progress",e.Callbacks("memory")]],
b="pending",c={state:function(){return b},always:function(){return h.done(arguments).fail(arguments),this},then:function(){var g=arguments;return e.Deferred(function(b){e.each(a,function(a,z){var u=z[0],d=e.isFunction(g[a])&&g[a];h[z[1]](function(){var g=d&&d.apply(this,arguments);g&&e.isFunction(g.promise)?g.promise().done(b.resolve).fail(b.reject).progress(b.notify):b[u+"With"](this===c?b.promise():this,d?[g]:arguments)})});g=null}).promise()},promise:function(g){return null!=g?e.extend(g,c):c}},
h={};return c.pipe=c.then,e.each(a,function(g,e){var d=e[2],l=e[3];c[e[1]]=d.add;l&&d.add(function(){b=l},a[1^g][2].disable,a[2][2].lock);h[e[0]]=function(){return h[e[0]+"With"](this===h?c:this,arguments),this};h[e[0]+"With"]=d.fireWith}),c.promise(h),g&&g.call(h,h),h},when:function(g){var a=0,b=ka.call(arguments),c=b.length,h=1!==c||g&&e.isFunction(g.promise)?c:0,d=1===h?g:e.Deferred(),l=function(g,a,b){return function(e){a[g]=this;b[g]=1<arguments.length?ka.call(arguments):e;b===k?d.notifyWith(a,
b):--h||d.resolveWith(a,b)}},k,f,t;if(1<c){k=Array(c);f=Array(c);for(t=Array(c);c>a;a++)b[a]&&e.isFunction(b[a].promise)?b[a].promise().done(l(a,t,b)).fail(d.reject).progress(l(a,f,k)):--h}return h||d.resolveWith(t,b),d.promise()}});var ec=e,lb;var ba,ea,M,na,oa,ua,Ha,la,Na,ra,J=F.createElement("div");if(J.setAttribute("className","t"),J.innerHTML="  <link/><table></table><a href='/a'>a</a><input type='checkbox'/>",ea=J.getElementsByTagName("*"),M=J.getElementsByTagName("a")[0],!ea||!M||!ea.length)lb=
...
ra,"t"),ba[ra+"Bubbles"]=la in a||!1===J.attributes[la].expando;lb=(J.style.backgroundClip="content-box",J.cloneNode(!0).style.backgroundClip="",ba.clearCloneStyle="content-box"===J.style.backgroundClip,e(function(){var g,b,e,c=F.getElementsByTagName("body")[0];c&&(g=F.createElement("div"),g.style.cssText="border:0;width:0;height:0;position:absolute;top:0;left:-9999px;margin-top:1px",c.appendChild(g).appendChild(J),J.innerHTML="<table><tr><td></td><td>t</td></tr></table>",e=J.getElementsByTagName("td"),
e[0].style.cssText="padding:0;margin:0;border:0;display:none",Na=0===e[0].offsetHeight,e[0].style.display="",e[1].style.display="none",ba.reliableHiddenOffsets=Na&&0===e[0].offsetHeight,J.innerHTML="",J.style.cssText="box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;padding:1px;border:1px;display:block;width:4px;margin-top:1%;position:absolute;top:1%;",ba.boxSizing=4===J.offsetWidth,ba.doesNotIncludeMarginInBodyOffset=1!==c.offsetTop,a.getComputedStyle&&(ba.pixelPosition=
"1%"!==(a.getComputedStyle(J,null)||{}).top,ba.boxSizingReliable="4px"===(a.getComputedStyle(J,null)||{width:"4px"}).width,b=J.appendChild(F.createElement("div")),b.style.cssText=J.style.cssText="padding:0;margin:0;border:0;display:block;box-sizing:content-box;-moz-box-sizing:content-box;-webkit-box-sizing:content-box;",b.style.marginRight=b.style.width="0",J.style.width="1px",ba.reliableMarginRight=!parseFloat((a.getComputedStyle(b,null)||{}).marginRight)),typeof J.style.zoom!==A&&(J.innerHTML="",
...
/([A-Z])/g;e.extend({cache:{},expando:"jQuery"+("1.9.1"+Math.random()).replace(/\D/g,""),noData:{embed:!0,object:"clsid:D27CDB6E-AE6D-11cf-96B8-444553540000",applet:!0},hasData:function(g){return g=g.nodeType?e.cache[g[e.expando]]:g[e.expando],!!g&&!q(g)},data:function(g,a,b){return d(g,a,b)},removeData:function(g,a){return f(g,a)},_data:function(g,a,b){return d(g,a,b,!0)},_removeData:function(g,a){return f(g,a,!0)},acceptData:function(g){if(g.nodeType&&1!==g.nodeType&&9!==g.nodeType)return!1;var a=
g.nodeName&&e.noData[g.nodeName.toLowerCase()];return!a||!0!==a&&g.getAttribute("classid")===a}});e.fn.extend({data:function(g,a){var u,c,h=this[0],d=0,l=null;if(g===b){if(this.length&&(l=e.data(h),1===h.nodeType&&!e._data(h,"parsedAttrs"))){for(u=h.attributes;u.length>d;d++)c=u[d].name,c.indexOf("data-")||(c=e.camelCase(c.slice(5)),n(h,c,l[c]));e._data(h,"parsedAttrs",!0)}return l}return"object"==typeof g?this.each(function(){e.data(this,g)}):e.access(this,function(a){return a===b?h?n(h,g,e.data(h,
g)):null:(this.each(function(){e.data(this,g,a)}),b)},null,a,1<arguments.length,null,!0)},removeData:function(g){return this.each(function(){e.removeData(this,g)})}});e.extend({queue:function(g,a,u){var c;return g?(a=(a||"fx")+"queue",c=e._data(g,a),u&&(!c||e.isArray(u)?c=e._data(g,a,e.makeArray(u)):c.push(u)),c||[]):b},dequeue:function(g,a){a=a||"fx";var b=e.queue(g,a),c=b.length,h=b.shift(),d=e._queueHooks(g,a),l=function(){e.dequeue(g,a)};"inprogress"===h&&(h=b.shift(),c--);(d.cur=h)&&("fx"===
a&&b.unshift("inprogress"),delete d.stop,h.call(g,l,d));!c&&d&&d.empty.fire()},_queueHooks:function(g,a){var b=a+"queueHooks";return e._data(g,b)||e._data(g,b,{empty:e.Callbacks("once memory").add(function(){e._removeData(g,a+"queue");e._removeData(g,b)})})}});e.fn.extend({queue:function(g,a){var u=2;return"string"!=typeof g&&(a=g,g="fx",u--),u>arguments.length?e.queue(this[0],g):a===b?this:this.each(function(){var b=e.queue(this,g,a);e._queueHooks(this,g);"fx"===g&&"inprogress"!==b[0]&&e.dequeue(this,
g)})},dequeue:function(g){return this.each(function(){e.dequeue(this,g)})},delay:function(g,a){return g=e.fx?e.fx.speeds[g]||g:g,a=a||"fx",this.queue(a,function(a,b){var e=setTimeout(a,g);b.stop=function(){clearTimeout(e)}})},clearQueue:function(g){return this.queue(g||"fx",[])},promise:function(g,a){var u,c=1,h=e.Deferred(),d=this,l=this.length,k=function(){--c||h.resolveWith(d,[d])};"string"!=typeof g&&(a=g,g=b);for(g=g||"fx";l--;)(u=e._data(d[l],g+"queueHooks"))&&u.empty&&(c++,u.empty.add(k));
return k(),h.promise(a)}});var xa,va,h=/[\t\r\n]/g,l=/\r/g,r=/^(?:input|select|textarea|button|object)$/i,Xa=/^(?:a|area)$/i,Oa=/^(?:checked|selected|autofocus|autoplay|async|controls|defer|disabled|hidden|loop|multiple|open|readonly|required|scoped)$/i,Ia=/^(?:checked|selected)$/i,Ea=e.support.getSetAttribute,sb=e.support.input;e.fn.extend({attr:function(g,a){return e.access(this,e.attr,g,a,1<arguments.length)},removeAttr:function(g){return this.each(function(){e.removeAttr(this,g)})},prop:function(g,
a){return e.access(this,e.prop,g,a,1<arguments.length)},removeProp:function(g){return g=e.propFix[g]||g,this.each(function(){try{this[g]=b,delete this[g]}catch(a){}})},addClass:function(g){var a,b,c,d,l,k=0,f=this.length;a="string"==typeof g&&g;if(e.isFunction(g))return this.each(function(a){e(this).addClass(g.call(this,a,this.className))});if(a)for(a=(g||"").match(Ba)||[];f>k;k++)if(b=this[k],c=1===b.nodeType&&(b.className?(" "+b.className+" ").replace(h," "):" ")){for(l=0;d=a[l++];)0>c.indexOf(" "+
d+" ")&&(c+=d+" ");b.className=e.trim(c)}return this},removeClass:function(g){var a,b,c,d,l,k=0,f=this.length;a=0===arguments.length||"string"==typeof g&&g;if(e.isFunction(g))return this.each(function(a){e(this).removeClass(g.call(this,a,this.className))});if(a)for(a=(g||"").match(Ba)||[];f>k;k++)if(b=this[k],c=1===b.nodeType&&(b.className?(" "+b.className+" ").replace(h," "):"")){for(l=0;d=a[l++];)for(;0<=c.indexOf(" "+d+" ");)c=c.replace(" "+d+" "," ");b.className=g?e.trim(c):""}return this},toggleClass:function(g,
a){var b=typeof g,c="boolean"==typeof a;return e.isFunction(g)?this.each(function(b){e(this).toggleClass(g.call(this,b,this.className,a),a)}):this.each(function(){if("string"===b)for(var h,d=0,l=e(this),k=a,f=g.match(Ba)||[];h=f[d++];)k=c?k:!l.hasClass(h),l[k?"addClass":"removeClass"](h);else(b===A||"boolean"===b)&&(this.className&&e._data(this,"__className__",this.className),this.className=this.className||!1===g?"":e._data(this,"__className__")||"")})},hasClass:function(g){g=" "+g+" ";for(var a=
0,b=this.length;b>a;a++)if(1===this[a].nodeType&&0<=(" "+this[a].className+" ").replace(h," ").indexOf(g))return!0;return!1},val:function(a){var z,c,h,d=this[0];if(arguments.length)return h=e.isFunction(a),this.each(function(z){var d,l=e(this);1===this.nodeType&&(d=h?a.call(this,z,l.val()):a,null==d?d="":"number"==typeof d?d+="":e.isArray(d)&&(d=e.map(d,function(a){return null==a?"":a+""})),c=e.valHooks[this.type]||e.valHooks[this.nodeName.toLowerCase()],c&&"set"in c&&c.set(this,d,"value")!==b||(this.value=
d))});if(d)return c=e.valHooks[d.type]||e.valHooks[d.nodeName.toLowerCase()],c&&"get"in c&&(z=c.get(d,"value"))!==b?z:(z=d.value,"string"==typeof z?z.replace(l,""):null==z?"":z)}});e.extend({valHooks:{option:{get:function(a){var b=a.attributes.value;return!b||b.specified?a.value:a.text}},select:{get:function(a){for(var b,c=a.options,h=a.selectedIndex,d="select-one"===a.type||0>h,l=d?null:[],k=d?h+1:c.length,f=0>h?k:d?h:0;k>f;f++)if(b=c[f],!(!b.selected&&f!==h||(e.support.optDisabled?b.disabled:null!==
b.getAttribute("disabled"))||b.parentNode.disabled&&e.nodeName(b.parentNode,"optgroup"))){if(a=e(b).val(),d)return a;l.push(a)}return l},set:function(a,b){var c=e.makeArray(b);return e(a).find("option").each(function(){this.selected=0<=e.inArray(e(this).val(),c)}),c.length||(a.selectedIndex=-1),c}}},attr:function(a,c,u){var h,d,l,k=a.nodeType;if(a&&3!==k&&8!==k&&2!==k)return typeof a.getAttribute===A?e.prop(a,c,u):(d=1!==k||!e.isXMLDoc(a),d&&(c=c.toLowerCase(),h=e.attrHooks[c]||(Oa.test(c)?va:xa)),
u===b?h&&d&&"get"in h&&null!==(l=h.get(a,c))?l:(typeof a.getAttribute!==A&&(l=a.getAttribute(c)),null==l?b:l):null!==u?h&&d&&"set"in h&&(l=h.set(a,u,c))!==b?l:(a.setAttribute(c,u+""),u):(e.removeAttr(a,c),b))},removeAttr:function(a,b){var c,h,d=0,l=b&&b.match(Ba);if(l&&1===a.nodeType)for(;c=l[d++];)h=e.propFix[c]||c,Oa.test(c)?!Ea&&Ia.test(c)?a[e.camelCase("default-"+c)]=a[h]=!1:a[h]=!1:e.attr(a,c,""),a.removeAttribute(Ea?c:h)},attrHooks:{type:{set:function(a,b){if(!e.support.radioValue&&"radio"===
b&&e.nodeName(a,"input")){var c=a.value;return a.setAttribute("type",b),c&&(a.value=c),b}}}},propFix:{tabindex:"tabIndex",readonly:"readOnly","for":"htmlFor","class":"className",maxlength:"maxLength",cellspacing:"cellSpacing",cellpadding:"cellPadding",rowspan:"rowSpan",colspan:"colSpan",usemap:"useMap",frameborder:"frameBorder",contenteditable:"contentEditable"},prop:function(a,c,u){var h,d,l,k=a.nodeType;if(a&&3!==k&&8!==k&&2!==k)return l=1!==k||!e.isXMLDoc(a),l&&(c=e.propFix[c]||c,d=e.propHooks[c]),
u!==b?d&&"set"in d&&(h=d.set(a,u,c))!==b?h:a[c]=u:d&&"get"in d&&null!==(h=d.get(a,c))?h:a[c]},propHooks:{tabIndex:{get:function(a){var e=a.getAttributeNode("tabindex");return e&&e.specified?parseInt(e.value,10):r.test(a.nodeName)||Xa.test(a.nodeName)&&a.href?0:b}}}});va={get:function(a,c){var u=e.prop(a,c),h="boolean"==typeof u&&a.getAttribute(c);return(u="boolean"==typeof u?sb&&Ea?null!=h:Ia.test(c)?a[e.camelCase("default-"+c)]:!!h:a.getAttributeNode(c))&&!1!==u.value?c.toLowerCase():b},set:function(a,
b,c){return!1===b?e.removeAttr(a,c):sb&&Ea||!Ia.test(c)?a.setAttribute(!Ea&&e.propFix[c]||c,c):a[e.camelCase("default-"+c)]=a[c]=!0,c}};sb&&Ea||(e.attrHooks.value={get:function(a,c){var u=a.getAttributeNode(c);return e.nodeName(a,"input")?a.defaultValue:u&&u.specified?u.value:b},set:function(a,c,u){return e.nodeName(a,"input")?(a.defaultValue=c,b):xa&&xa.set(a,c,u)}});Ea||(xa=e.valHooks.button={get:function(a,e){var c=a.getAttributeNode(e);return c&&("id"===e||"name"===e||"coords"===e?""!==c.value:
c.specified)?c.value:b},set:function(a,e,c){var h=a.getAttributeNode(c);return h||a.setAttributeNode(h=a.ownerDocument.createAttribute(c)),h.value=e+="","value"===c||e===a.getAttribute(c)?e:b}},e.attrHooks.contenteditable={get:xa.get,set:function(a,b,e){xa.set(a,""===b?!1:b,e)}},e.each(["width","height"],function(a,c){e.attrHooks[c]=e.extend(e.attrHooks[c],{set:function(a,g){return""===g?(a.setAttribute(c,"auto"),g):b}})}));e.support.hrefNormalized||(e.each(["href","src","width","height"],function(a,
c){e.attrHooks[c]=e.extend(e.attrHooks[c],{get:function(a){a=a.getAttribute(c,2);return null==a?b:a}})}),e.each(["href","src"],function(a,b){e.propHooks[b]={get:function(a){return a.getAttribute(b,4)}}}));e.support.style||(e.attrHooks.style={get:function(a){return a.style.cssText||b},set:function(a,b){return a.style.cssText=b+""}});e.support.optSelected||(e.propHooks.selected=e.extend(e.propHooks.selected,{get:function(a){a=a.parentNode;return a&&(a.selectedIndex,a.parentNode&&a.parentNode.selectedIndex),
null}}));e.support.enctype||(e.propFix.enctype="encoding");e.support.checkOn||e.each(["radio","checkbox"],function(){e.valHooks[this]={get:function(a){return null===a.getAttribute("value")?"on":a.value}}});e.each(["radio","checkbox"],function(){e.valHooks[this]=e.extend(e.valHooks[this],{set:function(a,c){return e.isArray(c)?a.checked=0<=e.inArray(e(a).val(),c):b}})});var tb=/^(?:input|select|textarea)$/i,Pa=/^key/,Tb=/^(?:mouse|contextmenu)|click/,Kb=/^(?:focusinfocus|focusoutblur)$/,Lb=/^([^.]*)(?:\.(.+)|)$/;
e.event={global:{},add:function(a,c,h,x,d){var l,k,f,t,r,j,w,v,D;if(f=e._data(a)){h.handler&&(t=h,h=t.handler,d=t.selector);h.guid||(h.guid=e.guid++);(k=f.events)||(k=f.events={});(r=f.handle)||(r=f.handle=function(a){return typeof e===A||a&&e.event.triggered===a.type?b:e.event.dispatch.apply(r.elem,arguments)},r.elem=a);c=(c||"").match(Ba)||[""];for(f=c.length;f--;)l=Lb.exec(c[f])||[],v=j=l[1],D=(l[2]||"").split(".").sort(),l=e.event.special[v]||{},v=(d?l.delegateType:l.bindType)||v,l=e.event.special[v]||
{},j=e.extend({type:v,origType:j,data:x,handler:h,guid:h.guid,selector:d,needsContext:d&&e.expr.match.needsContext.test(d),namespace:D.join(".")},t),(w=k[v])||(w=k[v]=[],w.delegateCount=0,l.setup&&!1!==l.setup.call(a,x,D,r)||(a.addEventListener?a.addEventListener(v,r,!1):a.attachEvent&&a.attachEvent("on"+v,r))),l.add&&(l.add.call(a,j),j.handler.guid||(j.handler.guid=h.guid)),d?w.splice(w.delegateCount++,0,j):w.push(j),e.event.global[v]=!0;a=null}},remove:function(a,b,c,h,d){var l,k,f,t,r,j,w,v,A,
D,m,p=e.hasData(a)&&e._data(a);if(p&&(j=p.events)){b=(b||"").match(Ba)||[""];for(r=b.length;r--;)if(f=Lb.exec(b[r])||[],A=m=f[1],D=(f[2]||"").split(".").sort(),A){w=e.event.special[A]||{};A=(h?w.delegateType:w.bindType)||A;v=j[A]||[];f=f[2]&&RegExp("(^|\\.)"+D.join("\\.(?:.*\\.|)")+"(\\.|$)");for(t=l=v.length;l--;)k=v[l],!d&&m!==k.origType||c&&c.guid!==k.guid||f&&!f.test(k.namespace)||h&&h!==k.selector&&("**"!==h||!k.selector)||(v.splice(l,1),k.selector&&v.delegateCount--,w.remove&&w.remove.call(a,
k));t&&!v.length&&(w.teardown&&!1!==w.teardown.call(a,D,p.handle)||e.removeEvent(a,A,p.handle),delete j[A])}else for(A in j)e.event.remove(a,A+b[r],c,h,!0);e.isEmptyObject(j)&&(delete p.handle,e._removeData(a,"events"))}},trigger:function(g,c,h,x){var d,l,k,f,t,r,j=[h||F],w=G.call(g,"type")?g.type:g;r=G.call(g,"namespace")?g.namespace.split("."):[];if(k=d=h=h||F,3!==h.nodeType&&8!==h.nodeType&&!Kb.test(w+e.event.triggered)&&(0<=w.indexOf(".")&&(r=w.split("."),w=r.shift(),r.sort()),l=0>w.indexOf(":")&&
"on"+w,g=g[e.expando]?g:new e.Event(w,"object"==typeof g&&g),g.isTrigger=!0,g.namespace=r.join("."),g.namespace_re=g.namespace?RegExp("(^|\\.)"+r.join("\\.(?:.*\\.|)")+"(\\.|$)"):null,g.result=b,g.target||(g.target=h),c=null==c?[g]:e.makeArray(c,[g]),t=e.event.special[w]||{},x||!t.trigger||!1!==t.trigger.apply(h,c))){if(!x&&!t.noBubble&&!e.isWindow(h)){f=t.delegateType||w;for(Kb.test(f+w)||(k=k.parentNode);k;k=k.parentNode)j.push(k),d=k;d===(h.ownerDocument||F)&&j.push(d.defaultView||d.parentWindow||
a)}for(r=0;(k=j[r++])&&!g.isPropagationStopped();)g.type=1<r?f:t.bindType||w,(d=(e._data(k,"events")||{})[g.type]&&e._data(k,"handle"))&&d.apply(k,c),(d=l&&k[l])&&e.acceptData(k)&&d.apply&&!1===d.apply(k,c)&&g.preventDefault();if(g.type=w,!(x||g.isDefaultPrevented()||t._default&&!1!==t._default.apply(h.ownerDocument,c)||"click"===w&&e.nodeName(h,"a")||!e.acceptData(h)||!l||!h[w]||e.isWindow(h))){(d=h[l])&&(h[l]=null);e.event.triggered=w;try{h[w]()}catch(v){}e.event.triggered=b;d&&(h[l]=d)}return g.result}},
dispatch:function(a){a=e.event.fix(a);var c,h,d,l,k,f=[],t=ka.call(arguments);c=(e._data(this,"events")||{})[a.type]||[];var r=e.event.special[a.type]||{};if(t[0]=a,a.delegateTarget=this,!r.preDispatch||!1!==r.preDispatch.call(this,a)){f=e.event.handlers.call(this,a,c);for(c=0;(l=f[c++])&&!a.isPropagationStopped();){a.currentTarget=l.elem;for(k=0;(d=l.handlers[k++])&&!a.isImmediatePropagationStopped();)(!a.namespace_re||a.namespace_re.test(d.namespace))&&(a.handleObj=d,a.data=d.data,h=((e.event.special[d.origType]||
{}).handle||d.handler).apply(l.elem,t),h!==b&&!1===(a.result=h)&&(a.preventDefault(),a.stopPropagation()))}return r.postDispatch&&r.postDispatch.call(this,a),a.result}},handlers:function(a,c){var h,d,l,k,f=[],t=c.delegateCount,r=a.target;if(t&&r.nodeType&&(!a.button||"click"!==a.type))for(;r!=this;r=r.parentNode||this)if(1===r.nodeType&&(!0!==r.disabled||"click"!==a.type)){l=[];for(k=0;t>k;k++)d=c[k],h=d.selector+" ",l[h]===b&&(l[h]=d.needsContext?0<=e(h,this).index(r):e.find(h,this,null,[r]).length),
l[h]&&l.push(d);l.length&&f.push({elem:r,handlers:l})}return c.length>t&&f.push({elem:this,handlers:c.slice(t)}),f},fix:function(a){if(a[e.expando])return a;var b,c,h;b=a.type;var d=a,l=this.fixHooks[b];l||(this.fixHooks[b]=l=Tb.test(b)?this.mouseHooks:Pa.test(b)?this.keyHooks:{});h=l.props?this.props.concat(l.props):this.props;a=new e.Event(d);for(b=h.length;b--;)c=h[b],a[c]=d[c];return a.target||(a.target=d.srcElement||F),3===a.target.nodeType&&(a.target=a.target.parentNode),a.metaKey=!!a.metaKey,
l.filter?l.filter(a,d):a},props:"altKey bubbles cancelable ctrlKey currentTarget eventPhase metaKey relatedTarget shiftKey target timeStamp view which".split(" "),fixHooks:{},keyHooks:{props:["char","charCode","key","keyCode"],filter:function(a,b){return null==a.which&&(a.which=null!=b.charCode?b.charCode:b.keyCode),a}},mouseHooks:{props:"button buttons clientX clientY fromElement offsetX offsetY pageX pageY screenX screenY toElement".split(" "),filter:function(a,e){var c,h,d,l=e.button,k=e.fromElement;
return null==a.pageX&&null!=e.clientX&&(h=a.target.ownerDocument||F,d=h.documentElement,c=h.body,a.pageX=e.clientX+(d&&d.scrollLeft||c&&c.scrollLeft||0)-(d&&d.clientLeft||c&&c.clientLeft||0),a.pageY=e.clientY+(d&&d.scrollTop||c&&c.scrollTop||0)-(d&&d.clientTop||c&&c.clientTop||0)),!a.relatedTarget&&k&&(a.relatedTarget=k===a.target?e.toElement:k),a.which||l===b||(a.which=1&l?1:2&l?3:4&l?2:0),a}},special:{load:{noBubble:!0},click:{trigger:function(){return e.nodeName(this,"input")&&"checkbox"===this.type&&
this.click?(this.click(),!1):b}},focus:{trigger:function(){if(this!==F.activeElement&&this.focus)try{return this.focus(),!1}catch(a){}},delegateType:"focusin"},blur:{trigger:function(){return this===F.activeElement&&this.blur?(this.blur(),!1):b},delegateType:"focusout"},beforeunload:{postDispatch:function(a){a.result!==b&&(a.originalEvent.returnValue=a.result)}}},simulate:function(a,b,c,h){a=e.extend(new e.Event,c,{type:a,isSimulated:!0,originalEvent:{}});h?e.event.trigger(a,null,b):e.event.dispatch.call(b,
a);a.isDefaultPrevented()&&c.preventDefault()}};e.removeEvent=F.removeEventListener?function(a,b,c){a.removeEventListener&&a.removeEventListener(b,c,!1)}:function(a,b,c){b="on"+b;a.detachEvent&&(typeof a[b]===A&&(a[b]=null),a.detachEvent(b,c))};e.Event=function(a,c){return this instanceof e.Event?(a&&a.type?(this.originalEvent=a,this.type=a.type,this.isDefaultPrevented=a.defaultPrevented||!1===a.returnValue||a.getPreventDefault&&a.getPreventDefault()?m:p):this.type=a,c&&e.extend(this,c),this.timeStamp=
a&&a.timeStamp||e.now(),this[e.expando]=!0,b):new e.Event(a,c)};e.Event.prototype={isDefaultPrevented:p,isPropagationStopped:p,isImmediatePropagationStopped:p,preventDefault:function(){var a=this.originalEvent;this.isDefaultPrevented=m;a&&(a.preventDefault?a.preventDefault():a.returnValue=!1)},stopPropagation:function(){var a=this.originalEvent;this.isPropagationStopped=m;a&&(a.stopPropagation&&a.stopPropagation(),a.cancelBubble=!0)},stopImmediatePropagation:function(){this.isImmediatePropagationStopped=
m;this.stopPropagation()}};e.each({mouseenter:"mouseover",mouseleave:"mouseout"},function(a,b){e.event.special[a]={delegateType:b,bindType:b,handle:function(a){var g,c=a.relatedTarget,h=a.handleObj;return(!c||c!==this&&!e.contains(this,c))&&(a.type=h.origType,g=h.handler.apply(this,arguments),a.type=b),g}}});e.support.submitBubbles||(e.event.special.submit={setup:function(){return e.nodeName(this,"form")?!1:(e.event.add(this,"click._submit keypress._submit",function(a){a=a.target;(a=e.nodeName(a,
"input")||e.nodeName(a,"button")?a.form:b)&&!e._data(a,"submitBubbles")&&(e.event.add(a,"submit._submit",function(a){a._submit_bubble=!0}),e._data(a,"submitBubbles",!0))}),b)},postDispatch:function(a){a._submit_bubble&&(delete a._submit_bubble,this.parentNode&&!a.isTrigger&&e.event.simulate("submit",this.parentNode,a,!0))},teardown:function(){return e.nodeName(this,"form")?!1:(e.event.remove(this,"._submit"),b)}});e.support.changeBubbles||(e.event.special.change={setup:function(){return tb.test(this.nodeName)?
(("checkbox"===this.type||"radio"===this.type)&&(e.event.add(this,"propertychange._change",function(a){"checked"===a.originalEvent.propertyName&&(this._just_changed=!0)}),e.event.add(this,"click._change",function(a){this._just_changed&&!a.isTrigger&&(this._just_changed=!1);e.event.simulate("change",this,a,!0)})),!1):(e.event.add(this,"beforeactivate._change",function(a){a=a.target;tb.test(a.nodeName)&&!e._data(a,"changeBubbles")&&(e.event.add(a,"change._change",function(a){!this.parentNode||a.isSimulated||
a.isTrigger||e.event.simulate("change",this.parentNode,a,!0)}),e._data(a,"changeBubbles",!0))}),b)},handle:function(a){var c=a.target;return this!==c||a.isSimulated||a.isTrigger||"radio"!==c.type&&"checkbox"!==c.type?a.handleObj.handler.apply(this,arguments):b},teardown:function(){return e.event.remove(this,"._change"),!tb.test(this.nodeName)}});e.support.focusinBubbles||e.each({focus:"focusin",blur:"focusout"},function(a,b){var c=0,h=function(a){e.event.simulate(b,a.target,e.event.fix(a),!0)};e.event.special[b]=
{setup:function(){0===c++&&F.addEventListener(a,h,!0)},teardown:function(){0===--c&&F.removeEventListener(a,h,!0)}}});e.fn.extend({on:function(a,c,h,d,l){var k,f;if("object"==typeof a){"string"!=typeof c&&(h=h||c,c=b);for(k in a)this.on(k,c,h,a[k],l);return this}if(null==h&&null==d?(d=c,h=c=b):null==d&&("string"==typeof c?(d=h,h=b):(d=h,h=c,c=b)),!1===d)d=p;else if(!d)return this;return 1===l&&(f=d,d=function(a){return e().off(a),f.apply(this,arguments)},d.guid=f.guid||(f.guid=e.guid++)),this.each(function(){e.event.add(this,
a,d,h,c)})},one:function(a,b,c,e){return this.on(a,b,c,e,1)},off:function(a,c,h){var d,l;if(a&&a.preventDefault&&a.handleObj)return d=a.handleObj,e(a.delegateTarget).off(d.namespace?d.origType+"."+d.namespace:d.origType,d.selector,d.handler),this;if("object"==typeof a){for(l in a)this.off(l,c,a[l]);return this}return(!1===c||"function"==typeof c)&&(h=c,c=b),!1===h&&(h=p),this.each(function(){e.event.remove(this,a,h,c)})},bind:function(a,b,c){return this.on(a,null,b,c)},unbind:function(a,b){return this.off(a,
null,b)},delegate:function(a,b,c,e){return this.on(b,a,c,e)},undelegate:function(a,b,c){return 1===arguments.length?this.off(a,"**"):this.off(b,a||"**",c)},trigger:function(a,b){return this.each(function(){e.event.trigger(a,b,this)})},triggerHandler:function(a,c){var h=this[0];return h?e.event.trigger(a,c,h,!0):b}});var ub=a,nb=function(){var a,b=[];return a=function(c,e){return b.push(c+=" ")>aa.cacheLength&&delete a[b.shift()],a[c]=e}},ya=function(a){return a[ma]=!0,a},Aa=function(a){var b=za.createElement("div");
try{return a(b)}catch(c){return!1}finally{}},Z=function(a,b,c,e){var h,d,l,k,f;if((b?b.ownerDocument||b:ob)!==za&&vb(b),b=b||za,c=c||[],!a||"string"!=typeof a)return c;if(1!==(k=b.nodeType)&&9!==k)return[];if(!La&&!e){if(h=Zc.exec(a))if(l=h[1])if(9===k){if(d=b.getElementById(l),!d||!d.parentNode)return c;if(d.id===l)return c.push(d),c}else{if(b.ownerDocument&&(d=b.ownerDocument.getElementById(l))&&Mb(b,d)&&d.id===l)return c.push(d),c}else{if(h[2])return wb.apply(c,xb.call(b.getElementsByTagName(a),
0)),c;if((l=h[3])&&pa.getByClassName&&b.getElementsByClassName)return wb.apply(c,xb.call(b.getElementsByClassName(l),0)),c}if(pa.qsa&&!Qa.test(a)){if(h=!0,d=ma,l=b,f=9===k&&a,1===k&&"object"!==b.nodeName.toLowerCase()){k=Ya(a);(h=b.getAttribute("id"))?d=h.replace($c,"\\$&"):b.setAttribute("id",d);d="[id='"+d+"'] ";for(l=k.length;l--;)k[l]=d+yb(k[l]);l=fc.test(a)&&b.parentNode||b;f=k.join(",")}if(f)try{return wb.apply(c,xb.call(l.querySelectorAll(f),0)),c}catch(t){}finally{h||b.removeAttribute("id")}}}var r;
a:{a=a.replace(Ub,"$1");var j,w;d=Ya(a);if(!e&&1===d.length){if(r=d[0]=d[0].slice(0),2<r.length&&"ID"===(j=r[0]).type&&9===b.nodeType&&!La&&aa.relative[r[1].type]){if(b=aa.find.ID(j.matches[0].replace(cb,db),b)[0],!b){r=c;break a}a=a.slice(r.shift().value.length)}for(k=Vb.needsContext.test(a)?0:r.length;k--&&!(j=r[k],aa.relative[h=j.type]);)if((w=aa.find[h])&&(e=w(j.matches[0].replace(cb,db),fc.test(r[0].type)&&b.parentNode||b))){if(r.splice(k,1),a=e.length&&yb(r),!a){r=(wb.apply(c,xb.call(e,0)),
c);break a}break}}r=(gc(a,d)(e,b,La,c,fc.test(a)),c)}return r},zb=function(a,b){var c=b&&a,e=c&&(~b.sourceIndex||wc)-(~a.sourceIndex||wc);if(e)return e;if(c)for(;c=c.nextSibling;)if(c===b)return-1;return a?1:-1},Ab=function(a){return function(b){return"input"===b.nodeName.toLowerCase()&&b.type===a}},Za=function(a){return function(b){var c=b.nodeName.toLowerCase();return("input"===c||"button"===c)&&b.type===a}},Ma=function(a){return ya(function(b){return b=+b,ya(function(c,e){for(var h,d=a([],c.length,
b),l=d.length;l--;)c[h=d[l]]&&(c[h]=!(e[h]=c[h]))})})},Ya=function(a,b){var c,e,h,d,l,k,f;if(l=xc[a+" "])return b?0:l.slice(0);l=a;k=[];for(f=aa.preFilter;l;){(!c||(e=ad.exec(l)))&&(e&&(l=l.slice(e[0].length)||l),k.push(h=[]));c=!1;(e=bd.exec(l))&&(c=e.shift(),h.push({value:c,type:e[0].replace(Ub," ")}),l=l.slice(c.length));for(d in aa.filter)!(e=Vb[d].exec(l))||f[d]&&!(e=f[d](e))||(c=e.shift(),h.push({value:c,type:d,matches:e}),l=l.slice(c.length));if(!c)break}return b?l.length:l?Z.error(a):xc(a,
k).slice(0)},yb=function(a){for(var b=0,c=a.length,e="";c>b;b++)e+=a[b].value;return e},Bb=function(a,b,c){var e=b.dir,h=c&&"parentNode"===e,d=cd++;return b.first?function(b,c,d){for(;b=b[e];)if(1===b.nodeType||h)return a(b,c,d)}:function(b,c,l){var u,k,z,f=Ra+" "+d;if(l)for(;b=b[e];){if((1===b.nodeType||h)&&a(b,c,l))return!0}else for(;b=b[e];)if(1===b.nodeType||h)if(z=b[ma]||(b[ma]={}),(k=z[e])&&k[0]===f){if(!0===(u=k[1])||u===Wb)return!0===u}else if(k=z[e]=[f],k[1]=a(b,c,l)||Wb,!0===k[1])return!0}},
Xb=function(a){return 1<a.length?function(b,c,e){for(var h=a.length;h--;)if(!a[h](b,c,e))return!1;return!0}:a[0]},Nb=function(a,b,c,e,h){for(var d,l=[],k=0,f=a.length,r=null!=b;f>k;k++)(d=a[k])&&(!c||c(d,e,h))&&(l.push(d),r&&b.push(k));return l},eb=function(a,b,c,e,h,d){return e&&!e[ma]&&(e=eb(e)),h&&!h[ma]&&(h=eb(h,d)),ya(function(d,l,k,f){var r,t,j=[],w=[],v=l.length,A;if(!(A=d)){A=b||"*";for(var qa=k.nodeType?[k]:k,D=[],p=0,m=qa.length;m>p;p++)Z(A,qa[p],D);A=D}A=!a||!d&&b?A:Nb(A,j,a,k,f);qa=c?
h||(d?a:v||e)?[]:l:A;if(c&&c(A,qa,k,f),e){r=Nb(qa,w);e(r,[],k,f);for(k=r.length;k--;)(t=r[k])&&(qa[w[k]]=!(A[w[k]]=t))}if(d){if(h||a){if(h){r=[];for(k=qa.length;k--;)(t=qa[k])&&r.push(A[k]=t);h(null,qa=[],r,f)}for(k=qa.length;k--;)(t=qa[k])&&-1<(r=h?hc.call(d,t):j[k])&&(d[r]=!(l[r]=t))}}else qa=Nb(qa===l?qa.splice(v,qa.length):qa),h?h(null,l,qa,f):wb.apply(l,qa)})},ic=function(a){var b,c,e,h=a.length,d=aa.relative[a[0].type];c=d||aa.relative[" "];for(var l=d?1:0,k=Bb(function(a){return a===b},c,!0),
f=Bb(function(a){return-1<hc.call(b,a)},c,!0),r=[function(a,g,c){return!d&&(c||g!==Yb)||((b=g).nodeType?k(a,g,c):f(a,g,c))}];h>l;l++)if(c=aa.relative[a[l].type])r=[Bb(Xb(r),c)];else{if(c=aa.filter[a[l].type].apply(null,a[l].matches),c[ma]){for(e=++l;h>e&&!aa.relative[a[e].type];e++);return eb(1<l&&Xb(r),1<l&&yb(a.slice(0,l-1)).replace(Ub,"$1"),c,e>l&&ic(a.slice(l,e)),h>e&&ic(a=a.slice(e)),h>e&&yb(a))}r.push(c)}return Xb(r)},yc=function(){},Cb,Wb,aa,Zb,zc,gc,Db,Yb,vb,za,Fa,La,Qa,Eb,$b,Mb,jc,ma="sizzle"+
-new Date,ob=ub.document,pa={},Ra=0,cd=0,Ac=nb(),xc=nb(),Bc=nb(),wc=-2147483648,ac=[],dd=ac.pop,wb=ac.push,xb=ac.slice,hc=ac.indexOf||function(a){for(var b=0,c=this.length;c>b;b++)if(this[b]===a)return b;return-1},Cc="(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+".replace("w","w#"),Dc="\\[[\\x20\\t\\r\\n\\f]*((?:\\\\.|[\\w-]|[^\\x00-\\xa0])+)[\\x20\\t\\r\\n\\f]*(?:([*^$|!~]?=)[\\x20\\t\\r\\n\\f]*(?:(['\"])((?:\\\\.|[^\\\\])*?)\\3|("+Cc+")|)|)[\\x20\\t\\r\\n\\f]*\\]",kc=":((?:\\\\.|[\\w-]|[^\\x00-\\xa0])+)(?:\\(((['\"])((?:\\\\.|[^\\\\])*?)\\3|((?:\\\\.|[^\\\\()[\\]]|"+
...
typeof b.getElementById&&!La){var g=b.getElementById(a);return g&&g.parentNode?[g]:[]}},aa.filter.ID=function(a){var b=a.replace(cb,db);return function(a){return a.getAttribute("id")===b}}):(aa.find.ID=function(a,b){if("undefined"!==typeof b.getElementById&&!La){var g=b.getElementById(a);return g?g.id===a||"undefined"!==typeof g.getAttributeNode&&g.getAttributeNode("id").value===a?[g]:void 0:[]}},aa.filter.ID=function(a){var b=a.replace(cb,db);return function(a){return(a="undefined"!==typeof a.getAttributeNode&&
a.getAttributeNode("id"))&&a.value===b}});aa.find.TAG=pa.tagNameNoComments?function(a,b){return"undefined"!==typeof b.getElementsByTagName?b.getElementsByTagName(a):void 0}:function(a,b){var g,c=[],e=0,h=b.getElementsByTagName(a);if("*"===a){for(;g=h[e++];)1===g.nodeType&&c.push(g);return c}return h};aa.find.NAME=pa.getByName&&function(a,b){return"undefined"!==typeof b.getElementsByName?b.getElementsByName(name):void 0};aa.find.CLASS=pa.getByClassName&&function(a,b){return"undefined"===typeof b.getElementsByClassName||
La?void 0:b.getElementsByClassName(a)};Eb=[];Qa=[":focus"];(pa.qsa=lc.test(b.querySelectorAll+""))&&(Aa(function(a){a.innerHTML="<select><option selected=''></option></select>";a.querySelectorAll("[selected]").length||Qa.push("\\[[\\x20\\t\\r\\n\\f]*(?:checked|disabled|ismap|multiple|readonly|selected|value)");a.querySelectorAll(":checked").length||Qa.push(":checked")}),Aa(function(a){a.innerHTML="<input type='hidden' i=''/>";a.querySelectorAll("[i^='']").length&&Qa.push("[*^$]=[\\x20\\t\\r\\n\\f]*(?:\"\"|'')");
a.querySelectorAll(":enabled").length||Qa.push(":enabled",":disabled");a.querySelectorAll("*,:x");Qa.push(",.*:")}));a=pa;var c;c=$b=Fa.matchesSelector||Fa.mozMatchesSelector||Fa.webkitMatchesSelector||Fa.oMatchesSelector||Fa.msMatchesSelector;c=lc.test(c+"");a=((a.matchesSelector=c)&&Aa(function(a){pa.disconnectedMatch=$b.call(a,"div");$b.call(a,"[s!='']:x");Eb.push("!=",kc)}),Qa=RegExp(Qa.join("|")),Eb=RegExp(Eb.join("|")),Mb=lc.test(Fa.contains+"")||Fa.compareDocumentPosition?function(a,b){var g=
9===a.nodeType?a.documentElement:a,c=b&&b.parentNode;return a===c||!(!c||1!==c.nodeType||!(g.contains?g.contains(c):a.compareDocumentPosition&&16&a.compareDocumentPosition(c)))}:function(a,b){if(b)for(;b=b.parentNode;)if(b===a)return!0;return!1},jc=Fa.compareDocumentPosition?function(a,g){var c;return a===g?(Db=!0,0):(c=g.compareDocumentPosition&&a.compareDocumentPosition&&a.compareDocumentPosition(g))?1&c||a.parentNode&&11===a.parentNode.nodeType?a===b||Mb(ob,a)?-1:g===b||Mb(ob,g)?1:0:4&c?-1:1:a.compareDocumentPosition?
-1:1}:function(a,g){var c,e=0;c=a.parentNode;var h=g.parentNode,d=[a],l=[g];if(a===g)return Db=!0,0;if(!c||!h)return a===b?-1:g===b?1:c?-1:h?1:0;if(c===h)return zb(a,g);for(c=a;c=c.parentNode;)d.unshift(c);for(c=g;c=c.parentNode;)l.unshift(c);for(;d[e]===l[e];)e++;return e?zb(d[e],l[e]):d[e]===ob?-1:l[e]===ob?1:0},Db=!1,[0,0].sort(jc),pa.detectDuplicates=Db,za)}else a=za;return a};Z.matches=function(a,b){return Z(a,null,null,b)};Z.matchesSelector=function(a,b){if((a.ownerDocument||a)!==za&&vb(a),
b=b.replace(jd,"='$1']"),!(!pa.matchesSelector||La||Eb&&Eb.test(b)||Qa.test(b)))try{var c=$b.call(a,b);if(c||pa.disconnectedMatch||a.document&&11!==a.document.nodeType)return c}catch(e){}return 0<Z(b,za,null,[a]).length};Z.contains=function(a,b){return(a.ownerDocument||a)!==za&&vb(a),Mb(a,b)};Z.attr=function(a,b){var c;return(a.ownerDocument||a)!==za&&vb(a),La||(b=b.toLowerCase()),(c=aa.attrHandle[b])?c(a):La||pa.attributes?a.getAttribute(b):((c=a.getAttributeNode(b))||a.getAttribute(b))&&!0===a[b]?
b:c&&c.specified?c.value:null};Z.error=function(a){throw Error("Syntax error, unrecognized expression: "+a);};Z.uniqueSort=function(a){var b,c=[],e=1,h=0;if(Db=!pa.detectDuplicates,a.sort(jc),Db){for(;b=a[e];e++)b===a[e-1]&&(h=c.push(e));for(;h--;)a.splice(c[h],1)}return a};Zb=Z.getText=function(a){var b,c="",e=0;if(b=a.nodeType)if(1===b||9===b||11===b){if("string"==typeof a.textContent)return a.textContent;for(a=a.firstChild;a;a=a.nextSibling)c+=Zb(a)}else{if(3===b||4===b)return a.nodeValue}else for(;b=
a[e];e++)c+=Zb(b);return c};aa=Z.selectors={cacheLength:50,createPseudo:ya,match:Vb,find:{},relative:{">":{dir:"parentNode",first:!0}," ":{dir:"parentNode"},"+":{dir:"previousSibling",first:!0},"~":{dir:"previousSibling"}},preFilter:{ATTR:function(a){return a[1]=a[1].replace(cb,db),a[3]=(a[4]||a[5]||"").replace(cb,db),"~="===a[2]&&(a[3]=" "+a[3]+" "),a.slice(0,4)},CHILD:function(a){return a[1]=a[1].toLowerCase(),"nth"===a[1].slice(0,3)?(a[3]||Z.error(a[0]),a[4]=+(a[4]?a[5]+(a[6]||1):2*("even"===a[3]||
"odd"===a[3])),a[5]=+(a[7]+a[8]||"odd"===a[3])):a[3]&&Z.error(a[0]),a},PSEUDO:function(a){var b,c=!a[5]&&a[2];return Vb.CHILD.test(a[0])?null:(a[4]?a[2]=a[4]:c&&ed.test(c)&&(b=Ya(c,!0))&&(b=c.indexOf(")",c.length-b)-c.length)&&(a[0]=a[0].slice(0,b),a[2]=c.slice(0,b)),a.slice(0,3))}},filter:{TAG:function(a){return"*"===a?function(){return!0}:(a=a.replace(cb,db).toLowerCase(),function(b){return b.nodeName&&b.nodeName.toLowerCase()===a})},CLASS:function(a){var b=Ac[a+" "];return b||(b=RegExp("(^|[\\x20\\t\\r\\n\\f])"+
a+"([\\x20\\t\\r\\n\\f]|$)"))&&Ac(a,function(a){return b.test(a.className||"undefined"!==typeof a.getAttribute&&a.getAttribute("class")||"")})},ATTR:function(a,b,c){return function(e){e=Z.attr(e,a);return null==e?"!="===b:b?(e+="","="===b?e===c:"!="===b?e!==c:"^="===b?c&&0===e.indexOf(c):"*="===b?c&&-1<e.indexOf(c):"$="===b?c&&e.slice(-c.length)===c:"~="===b?-1<(" "+e+" ").indexOf(c):"|="===b?e===c||e.slice(0,c.length+1)===c+"-":!1):!0}},CHILD:function(a,b,c,e,h){var d="nth"!==a.slice(0,3),l="last"!==
a.slice(-4),k="of-type"===b;return 1===e&&0===h?function(a){return!!a.parentNode}:function(b,c,f){var u,z,r,t,j;c=d!==l?"nextSibling":"previousSibling";var w=b.parentNode,v=k&&b.nodeName.toLowerCase();f=!f&&!k;if(w){if(d){for(;c;){for(z=b;z=z[c];)if(k?z.nodeName.toLowerCase()===v:1===z.nodeType)return!1;j=c="only"===a&&!j&&"nextSibling"}return!0}if(j=[l?w.firstChild:w.lastChild],l&&f){f=w[ma]||(w[ma]={});u=f[a]||[];t=u[0]===Ra&&u[1];r=u[0]===Ra&&u[2];for(z=t&&w.childNodes[t];z=++t&&z&&z[c]||(r=t=
0)||j.pop();)if(1===z.nodeType&&++r&&z===b){f[a]=[Ra,t,r];break}}else if(f&&(u=(b[ma]||(b[ma]={}))[a])&&u[0]===Ra)r=u[1];else for(;(z=++t&&z&&z[c]||(r=t=0)||j.pop())&&(!(k?z.nodeName.toLowerCase()===v:1===z.nodeType)||!++r||!(f&&((z[ma]||(z[ma]={}))[a]=[Ra,r]),z===b)););return r-=h,r===e||0===r%e&&0<=r/e}}},PSEUDO:function(a,b){var c,e=aa.pseudos[a]||aa.setFilters[a.toLowerCase()]||Z.error("unsupported pseudo: "+a);return e[ma]?e(b):1<e.length?(c=[a,a,"",b],aa.setFilters.hasOwnProperty(a.toLowerCase())?
ya(function(a,g){for(var c,h=e(a,b),d=h.length;d--;)c=hc.call(a,h[d]),a[c]=!(g[c]=h[d])}):function(a){return e(a,0,c)}):e}},pseudos:{not:ya(function(a){var b=[],c=[],e=gc(a.replace(Ub,"$1"));return e[ma]?ya(function(a,b,g,c){var h;g=e(a,null,c,[]);for(c=a.length;c--;)(h=g[c])&&(a[c]=!(b[c]=h))}):function(a,g,h){return b[0]=a,e(b,null,h,c),!c.pop()}}),has:ya(function(a){return function(b){return 0<Z(a,b).length}}),contains:ya(function(a){return function(b){return-1<(b.textContent||b.innerText||Zb(b)).indexOf(a)}}),
lang:ya(function(a){return fd.test(a||"")||Z.error("unsupported lang: "+a),a=a.replace(cb,db).toLowerCase(),function(b){var c;do if(c=La?b.getAttribute("xml:lang")||b.getAttribute("lang"):b.lang)return c=c.toLowerCase(),c===a||0===c.indexOf(a+"-");while((b=b.parentNode)&&1===b.nodeType);return!1}}),target:function(a){var b=ub.location&&ub.location.hash;return b&&b.slice(1)===a.id},root:function(a){return a===Fa},focus:function(a){return a===za.activeElement&&(!za.hasFocus||za.hasFocus())&&!(!a.type&&
...
input:function(a){return gd.test(a.nodeName)},button:function(a){var b=a.nodeName.toLowerCase();return"input"===b&&"button"===a.type||"button"===b},text:function(a){var b;return"input"===a.nodeName.toLowerCase()&&"text"===a.type&&(null==(b=a.getAttribute("type"))||b.toLowerCase()===a.type)},first:Ma(function(){return[0]}),last:Ma(function(a,b){return[b-1]}),eq:Ma(function(a,b,c){return[0>c?c+b:c]}),even:Ma(function(a,b){for(var c=0;b>c;c+=2)a.push(c);return a}),odd:Ma(function(a,b){for(var c=1;b>
c;c+=2)a.push(c);return a}),lt:Ma(function(a,b,c){for(b=0>c?c+b:c;0<=--b;)a.push(b);return a}),gt:Ma(function(a,b,c){for(c=0>c?c+b:c;b>++c;)a.push(c);return a})}};for(Cb in{radio:!0,checkbox:!0,file:!0,password:!0,image:!0})aa.pseudos[Cb]=Ab(Cb);for(Cb in{submit:!0,reset:!0})aa.pseudos[Cb]=Za(Cb);gc=Z.compile=function(a,b){var c,e=[],h=[],d=Bc[a+" "];if(!d){b||(b=Ya(a));for(c=b.length;c--;)d=ic(b[c]),d[ma]?e.push(d):h.push(d);var l=0,k=0<e.length,f=0<h.length;c=function(a,b,c,g,d){var u,r,t=[],z=
0,j="0",w=a&&[],v=null!=d,A=Yb,D=a||f&&aa.find.TAG("*",d&&b.parentNode||b),p=Ra+=null==A?1:Math.random()||0.1;for(v&&(Yb=b!==za&&b,Wb=l);null!=(d=D[j]);j++){if(f&&d){for(u=0;r=h[u++];)if(r(d,b,c)){g.push(d);break}v&&(Ra=p,Wb=++l)}k&&((d=!r&&d)&&z--,a&&w.push(d))}if(z+=j,k&&j!==z){for(u=0;r=e[u++];)r(w,t,b,c);if(a){if(0<z)for(;j--;)w[j]||t[j]||(t[j]=dd.call(g));t=Nb(t)}wb.apply(g,t);v&&!a&&0<t.length&&1<z+e.length&&Z.uniqueSort(g)}return v&&(Ra=p,Yb=A),w};c=k?ya(c):c;d=Bc(a,c)}return d};aa.pseudos.nth=
aa.pseudos.eq;aa.filters=yc.prototype=aa.pseudos;aa.setFilters=new yc;vb();Z.attr=e.attr;e.find=Z;e.expr=Z.selectors;e.expr[":"]=e.expr.pseudos;e.unique=Z.uniqueSort;e.text=Z.getText;e.isXMLDoc=Z.isXML;e.contains=Z.contains;var kd=/Until$/,ld=/^(?:parents|prev(?:Until|All))/,Uc=/^.[^:#\[\.,]*$/,Ec=e.expr.match.needsContext,md={children:!0,contents:!0,next:!0,prev:!0};e.fn.extend({find:function(a){var b,c,h,d=this.length;if("string"!=typeof a)return h=this,this.pushStack(e(a).filter(function(){for(b=
0;d>b;b++)if(e.contains(h[b],this))return!0}));c=[];for(b=0;d>b;b++)e.find(a,this[b],c);return c=this.pushStack(1<d?e.unique(c):c),c.selector=(this.selector?this.selector+" ":"")+a,c},has:function(a){var b,c=e(a,this),h=c.length;return this.filter(function(){for(b=0;h>b;b++)if(e.contains(this,c[b]))return!0})},not:function(a){return this.pushStack(T(this,a,!1))},filter:function(a){return this.pushStack(T(this,a,!0))},is:function(a){return!!a&&("string"==typeof a?Ec.test(a)?0<=e(a,this.context).index(this[0]):
0<e.filter(a,this).length:0<this.filter(a).length)},closest:function(a,b){for(var c,h=0,d=this.length,l=[],k=Ec.test(a)||"string"!=typeof a?e(a,b||this.context):0;d>h;h++)for(c=this[h];c&&c.ownerDocument&&c!==b&&11!==c.nodeType;){if(k?-1<k.index(c):e.find.matchesSelector(c,a)){l.push(c);break}c=c.parentNode}return this.pushStack(1<l.length?e.unique(l):l)},index:function(a){return a?"string"==typeof a?e.inArray(this[0],e(a)):e.inArray(a.jquery?a[0]:a,this):this[0]&&this[0].parentNode?this.first().prevAll().length:
-1},add:function(a,b){var c="string"==typeof a?e(a,b):e.makeArray(a&&a.nodeType?[a]:a),c=e.merge(this.get(),c);return this.pushStack(e.unique(c))},addBack:function(a){return this.add(null==a?this.prevObject:this.prevObject.filter(a))}});e.fn.andSelf=e.fn.addBack;e.each({parent:function(a){return(a=a.parentNode)&&11!==a.nodeType?a:null},parents:function(a){return e.dir(a,"parentNode")},parentsUntil:function(a,b,c){return e.dir(a,"parentNode",c)},next:function(a){return Q(a,"nextSibling")},prev:function(a){return Q(a,
"previousSibling")},nextAll:function(a){return e.dir(a,"nextSibling")},prevAll:function(a){return e.dir(a,"previousSibling")},nextUntil:function(a,b,c){return e.dir(a,"nextSibling",c)},prevUntil:function(a,b,c){return e.dir(a,"previousSibling",c)},siblings:function(a){return e.sibling((a.parentNode||{}).firstChild,a)},children:function(a){return e.sibling(a.firstChild)},contents:function(a){return e.nodeName(a,"iframe")?a.contentDocument||a.contentWindow.document:e.merge([],a.childNodes)}},function(a,
b){e.fn[a]=function(c,h){var d=e.map(this,b,c);return kd.test(a)||(h=c),h&&"string"==typeof h&&(d=e.filter(h,d)),d=1<this.length&&!md[a]?e.unique(d):d,1<this.length&&ld.test(a)&&(d=d.reverse()),this.pushStack(d)}});e.extend({filter:function(a,b,c){return c&&(a=":not("+a+")"),1===b.length?e.find.matchesSelector(b[0],a)?[b[0]]:[]:e.find.matches(a,b)},dir:function(a,c,h){var d=[];for(a=a[c];a&&9!==a.nodeType&&(h===b||1!==a.nodeType||!e(a).is(h));)1===a.nodeType&&d.push(a),a=a[c];return d},sibling:function(a,
...
nc=W(F).appendChild(F.createElement("div"));Ja.optgroup=Ja.option;Ja.tbody=Ja.tfoot=Ja.colgroup=Ja.caption=Ja.thead;Ja.th=Ja.td;e.fn.extend({text:function(a){return e.access(this,function(a){return a===b?e.text(this):this.empty().append((this[0]&&this[0].ownerDocument||F).createTextNode(a))},null,a,arguments.length)},wrapAll:function(a){if(e.isFunction(a))return this.each(function(b){e(this).wrapAll(a.call(this,b))});if(this[0]){var b=e(a,this[0].ownerDocument).eq(0).clone(!0);this[0].parentNode&&
b.insertBefore(this[0]);b.map(function(){for(var a=this;a.firstChild&&1===a.firstChild.nodeType;)a=a.firstChild;return a}).append(this)}return this},wrapInner:function(a){return e.isFunction(a)?this.each(function(b){e(this).wrapInner(a.call(this,b))}):this.each(function(){var b=e(this),c=b.contents();c.length?c.wrapAll(a):b.append(a)})},wrap:function(a){var b=e.isFunction(a);return this.each(function(c){e(this).wrapAll(b?a.call(this,c):a)})},unwrap:function(){return this.parent().each(function(){e.nodeName(this,
...
!1,function(a){this.parentNode&&this.parentNode.insertBefore(a,this.nextSibling)})},remove:function(a,b){for(var c,h=0;null!=(c=this[h]);h++)(!a||0<e.filter(a,[c]).length)&&(b||1!==c.nodeType||e.cleanData(s(c)),c.parentNode&&(b&&e.contains(c.ownerDocument,c)&&N(s(c,"script")),c.parentNode.removeChild(c)));return this},empty:function(){for(var a,b=0;null!=(a=this[b]);b++){for(1===a.nodeType&&e.cleanData(s(a,!1));a.firstChild;)a.removeChild(a.firstChild);a.options&&e.nodeName(a,"select")&&(a.options.length=
0)}return this},clone:function(a,b){return a=null==a?!1:a,b=null==b?a:b,this.map(function(){return e.clone(this,a,b)})},html:function(a){return e.access(this,function(a){var c=this[0]||{},g=0,h=this.length;if(a===b)return 1===c.nodeType?c.innerHTML.replace(nd,""):b;if(!("string"!=typeof a||pd.test(a)||!e.support.htmlSerialize&&Fc.test(a)||!e.support.leadingWhitespace&&mc.test(a)||Ja[(Hc.exec(a)||["",""])[1].toLowerCase()])){a=a.replace(Gc,"<$1></$2>");try{for(;h>g;g++)c=this[g]||{},1===c.nodeType&&
(e.cleanData(s(c,!1)),c.innerHTML=a);c=0}catch(d){}}c&&this.empty().append(a)},null,a,arguments.length)},replaceWith:function(a){return e.isFunction(a)||"string"==typeof a||(a=e(a).not(this).detach()),this.domManip([a],!0,function(a){var b=this.nextSibling,c=this.parentNode;c&&(e(this).remove(),c.insertBefore(a,b))})},detach:function(a){return this.remove(a,!0)},domManip:function(a,c,h){a=da.apply([],a);var d,l,k,f,r=0,t=this.length,j=this,w=t-1,v=a[0],A=e.isFunction(v);if(A||!(1>=t||"string"!=typeof v||
e.support.checkClone)&&qd.test(v))return this.each(function(e){var d=j.eq(e);A&&(a[0]=v.call(this,e,c?d.html():b));d.domManip(a,c,h)});if(t&&(f=e.buildFragment(a,this[0].ownerDocument,!1,this),d=f.firstChild,1===f.childNodes.length&&(f=d),d)){c=c&&e.nodeName(d,"tr");k=e.map(s(f,"script"),y);for(l=k.length;t>r;r++)d=f,r!==w&&(d=e.clone(d,!0,!0),l&&e.merge(k,s(d,"script"))),h.call(c&&e.nodeName(this[r],"table")?this[r].getElementsByTagName("tbody")[0]||this[r].appendChild(this[r].ownerDocument.createElement("tbody")):
this[r],d,r);if(l){f=k[k.length-1].ownerDocument;e.map(k,B);for(r=0;l>r;r++)d=k[r],Jc.test(d.type||"")&&!e._data(d,"globalEval")&&e.contains(f,d)&&(d.src?e.ajax({url:d.src,type:"GET",dataType:"script",async:!1,global:!1,"throws":!0}):e.globalEval((d.text||d.textContent||d.innerHTML||"").replace(rd,"")))}f=d=null}return this}});e.each({appendTo:"append",prependTo:"prepend",insertBefore:"before",insertAfter:"after",replaceAll:"replaceWith"},function(a,b){e.fn[a]=function(a){for(var c=0,g=[],h=e(a),
d=h.length-1;d>=c;c++)a=c===d?this:this.clone(!0),e(h[c])[b](a),ta.apply(g,a.get());return this.pushStack(g)}});e.extend({clone:function(a,b,c){var h,d,l,k,f,r=e.contains(a.ownerDocument,a);if(e.support.html5Clone||e.isXMLDoc(a)||!Fc.test("<"+a.nodeName+">")?l=a.cloneNode(!0):(nc.innerHTML=a.outerHTML,nc.removeChild(l=nc.firstChild)),!(e.support.noCloneEvent&&e.support.noCloneChecked||1!==a.nodeType&&11!==a.nodeType||e.isXMLDoc(a))){h=s(l);f=s(a);for(k=0;null!=(d=f[k]);++k)if(h[k]){var t=h[k],j=void 0,
w=void 0,v=void 0;if(1===t.nodeType){if(j=t.nodeName.toLowerCase(),!e.support.noCloneEvent&&t[e.expando]){v=e._data(t);for(w in v.events)e.removeEvent(t,w,v.handle);t.removeAttribute(e.expando)}"script"===j&&t.text!==d.text?(y(t).text=d.text,B(t)):"object"===j?(t.parentNode&&(t.outerHTML=d.outerHTML),e.support.html5Clone&&d.innerHTML&&!e.trim(t.innerHTML)&&(t.innerHTML=d.innerHTML)):"input"===j&&cc.test(d.type)?(t.defaultChecked=t.checked=d.checked,t.value!==d.value&&(t.value=d.value)):"option"===
j?t.defaultSelected=t.selected=d.defaultSelected:("input"===j||"textarea"===j)&&(t.defaultValue=d.defaultValue)}}}if(b)if(c){f=f||s(a);h=h||s(l);for(k=0;null!=(d=f[k]);k++)X(d,h[k])}else X(a,l);return h=s(l,"script"),0<h.length&&N(h,!r&&s(a,"script")),l},buildFragment:function(a,b,c,h){for(var d,l,k,f,r,t,j,w=a.length,v=W(b),A=[],D=0;w>D;D++)if(l=a[D],l||0===l)if("object"===e.type(l))e.merge(A,l.nodeType?[l]:l);else if(od.test(l)){f=f||v.appendChild(b.createElement("div"));r=(Hc.exec(l)||["",""])[1].toLowerCase();
j=Ja[r]||Ja._default;f.innerHTML=j[1]+l.replace(Gc,"<$1></$2>")+j[2];for(d=j[0];d--;)f=f.lastChild;if(!e.support.leadingWhitespace&&mc.test(l)&&A.push(b.createTextNode(mc.exec(l)[0])),!e.support.tbody)for(d=(l="table"!==r||Ic.test(l)?"<table>"!==j[1]||Ic.test(l)?0:f:f.firstChild)&&l.childNodes.length;d--;)e.nodeName(t=l.childNodes[d],"tbody")&&!t.childNodes.length&&l.removeChild(t);e.merge(A,f.childNodes);for(f.textContent="";f.firstChild;)f.removeChild(f.firstChild);f=v.lastChild}else A.push(b.createTextNode(l));
f&&v.removeChild(f);e.support.appendChecked||e.grep(s(A,"input"),U);for(D=0;l=A[D++];)if((!h||-1===e.inArray(l,h))&&(k=e.contains(l.ownerDocument,l),f=s(v.appendChild(l),"script"),k&&N(f),c))for(d=0;l=f[d++];)Jc.test(l.type||"")&&c.push(l);return v},cleanData:function(a,b){for(var c,h,d,l,k=0,f=e.expando,r=e.cache,t=e.support.deleteExpando,j=e.event.special;null!=(c=a[k]);k++)if((b||e.acceptData(c))&&(d=c[f],l=d&&r[d])){if(l.events)for(h in l.events)j[h]?e.event.remove(c,h):e.removeEvent(c,h,l.handle);
r[d]&&(delete r[d],t?delete c[f]:typeof c.removeAttribute!==A?c.removeAttribute(f):c[f]=null,Ca.push(d))}}});var Gb,hb,ib,oc=/alpha\([^)]*\)/i,sd=/opacity\s*=\s*([^)]*)/,td=/^(top|right|bottom|left)$/,ud=/^(none|table(?!-c[ea]).+)/,Kc=/^margin/,Wc=RegExp("^("+Da+")(.*)$","i"),Pb=RegExp("^("+Da+")(?!px)[a-z%]+$","i"),vd=RegExp("^([+-])=("+Da+")","i"),vc={BODY:"block"},wd={position:"absolute",visibility:"hidden",display:"block"},Lc={letterSpacing:0,fontWeight:400},gb=["Top","Right","Bottom","Left"],
uc=["Webkit","O","Moz","ms"];e.fn.extend({css:function(a,c){return e.access(this,function(a,c,g){var h,d={},l=0;if(e.isArray(c)){h=hb(a);for(g=c.length;g>l;l++)d[c[l]]=e.css(a,c[l],!1,h);return d}return g!==b?e.style(a,c,g):e.css(a,c)},a,c,1<arguments.length)},show:function(){return I(this,!0)},hide:function(){return I(this)},toggle:function(a){var b="boolean"==typeof a;return this.each(function(){(b?a:V(this))?e(this).show():e(this).hide()})}});e.extend({cssHooks:{opacity:{get:function(a,b){if(b){var c=
ib(a,"opacity");return""===c?"1":c}}}},cssNumber:{columnCount:!0,fillOpacity:!0,fontWeight:!0,lineHeight:!0,opacity:!0,orphans:!0,widows:!0,zIndex:!0,zoom:!0},cssProps:{"float":e.support.cssFloat?"cssFloat":"styleFloat"},style:function(a,c,h,d){if(a&&3!==a.nodeType&&8!==a.nodeType&&a.style){var l,k,f,r=e.camelCase(c),t=a.style;if(c=e.cssProps[r]||(e.cssProps[r]=K(t,r)),f=e.cssHooks[c]||e.cssHooks[r],h===b)return f&&"get"in f&&(l=f.get(a,!1,d))!==b?l:t[c];if(k=typeof h,"string"===k&&(l=vd.exec(h))&&
(h=(l[1]+1)*l[2]+parseFloat(e.css(a,c)),k="number"),!(null==h||"number"===k&&isNaN(h)||("number"!==k||e.cssNumber[r]||(h+="px"),e.support.clearCloneStyle||""!==h||0!==c.indexOf("background")||(t[c]="inherit"),f&&"set"in f&&(h=f.set(a,h,d))===b)))try{t[c]=h}catch(j){}}},css:function(a,c,h,d){var l,k,f,r=e.camelCase(c);return c=e.cssProps[r]||(e.cssProps[r]=K(a.style,r)),f=e.cssHooks[c]||e.cssHooks[r],f&&"get"in f&&(k=f.get(a,!0,h)),k===b&&(k=ib(a,c,d)),"normal"===k&&c in Lc&&(k=Lc[c]),""===h||h?(l=
parseFloat(k),!0===h||e.isNumeric(l)?l||0:k):k},swap:function(a,b,c,e){var h,d={};for(h in b)d[h]=a.style[h],a.style[h]=b[h];c=c.apply(a,e||[]);for(h in b)a.style[h]=d[h];return c}});a.getComputedStyle?(hb=function(b){return a.getComputedStyle(b,null)},ib=function(a,c,h){var d,l,k,f=(h=h||hb(a))?h.getPropertyValue(c)||h[c]:b,r=a.style;return h&&(""!==f||e.contains(a.ownerDocument,a)||(f=e.style(a,c)),Pb.test(f)&&Kc.test(c)&&(d=r.width,l=r.minWidth,k=r.maxWidth,r.minWidth=r.maxWidth=r.width=f,f=h.width,
r.width=d,r.minWidth=l,r.maxWidth=k)),f}):F.documentElement.currentStyle&&(hb=function(a){return a.currentStyle},ib=function(a,c,e){var h,d,l;e=(e=e||hb(a))?e[c]:b;var k=a.style;return null==e&&k&&k[c]&&(e=k[c]),Pb.test(e)&&!td.test(c)&&(h=k.left,d=a.runtimeStyle,l=d&&d.left,l&&(d.left=a.currentStyle.left),k.left="fontSize"===c?"1em":e,e=k.pixelLeft+"px",k.left=h,l&&(d.left=l)),""===e?"auto":e});e.each(["height","width"],function(a,c){e.cssHooks[c]={get:function(a,h,g){return h?0===a.offsetWidth&&
ud.test(e.css(a,"display"))?e.swap(a,wd,function(){return R(a,c,g)}):R(a,c,g):b},set:function(a,b,h){var g=h&&hb(a);return j(a,b,h?C(a,c,h,e.support.boxSizing&&"border-box"===e.css(a,"boxSizing",!1,g),g):0)}}});e.support.opacity||(e.cssHooks.opacity={get:function(a,b){return sd.test((b&&a.currentStyle?a.currentStyle.filter:a.style.filter)||"")?0.01*parseFloat(RegExp.$1)+"":b?"1":""},set:function(a,b){var c=a.style,h=a.currentStyle,d=e.isNumeric(b)?"alpha(opacity="+100*b+")":"",l=h&&h.filter||c.filter||
"";c.zoom=1;(1<=b||""===b)&&""===e.trim(l.replace(oc,""))&&c.removeAttribute&&(c.removeAttribute("filter"),""===b||h&&!h.filter)||(c.filter=oc.test(l)?l.replace(oc,d):l+" "+d)}});e(function(){e.support.reliableMarginRight||(e.cssHooks.marginRight={get:function(a,c){return c?e.swap(a,{display:"inline-block"},ib,[a,"marginRight"]):b}});!e.support.pixelPosition&&e.fn.position&&e.each(["top","left"],function(a,c){e.cssHooks[c]={get:function(a,h){return h?(h=ib(a,c),Pb.test(h)?e(a).position()[c]+"px":
h):b}}})});e.expr&&e.expr.filters&&(e.expr.filters.hidden=function(a){return 0>=a.offsetWidth&&0>=a.offsetHeight||!e.support.reliableHiddenOffsets&&"none"===(a.style&&a.style.display||e.css(a,"display"))},e.expr.filters.visible=function(a){return!e.expr.filters.hidden(a)});e.each({margin:"",padding:"",border:"Width"},function(a,b){e.cssHooks[a+b]={expand:function(c){var e=0,h={};for(c="string"==typeof c?c.split(" "):[c];4>e;e++)h[a+gb[e]+b]=c[e]||c[e-2]||c[0];return h}};Kc.test(a)||(e.cssHooks[a+
b].set=j)});var xd=/%20/g,Xc=/\[\]$/,Mc=/\r?\n/g,yd=/^(?:submit|button|image|reset|file)$/i,zd=/^(?:input|select|textarea|keygen)/i;e.fn.extend({serialize:function(){return e.param(this.serializeArray())},serializeArray:function(){return this.map(function(){var a=e.prop(this,"elements");return a?e.makeArray(a):this}).filter(function(){var a=this.type;return this.name&&!e(this).is(":disabled")&&zd.test(this.nodeName)&&!yd.test(a)&&(this.checked||!cc.test(a))}).map(function(a,b){var c=e(this).val();
return null==c?null:e.isArray(c)?e.map(c,function(a){return{name:b.name,value:a.replace(Mc,"\r\n")}}):{name:b.name,value:c.replace(Mc,"\r\n")}}).get()}});e.param=function(a,c){var h,d=[],l=function(a,b){b=e.isFunction(b)?b():null==b?"":b;d[d.length]=encodeURIComponent(a)+"="+encodeURIComponent(b)};if(c===b&&(c=e.ajaxSettings&&e.ajaxSettings.traditional),e.isArray(a)||a.jquery&&!e.isPlainObject(a))e.each(a,function(){l(this.name,this.value)});else for(h in a)H(h,a[h],c,l);return d.join("&").replace(xd,
"+")};e.each("blur focus focusin focusout load resize scroll unload click dblclick mousedown mouseup mousemove mouseover mouseout mouseenter mouseleave change select submit keydown keypress keyup error contextmenu".split(" "),function(a,b){e.fn[b]=function(a,c){return 0<arguments.length?this.on(b,null,a,c):this.trigger(b)}});e.fn.hover=function(a,b){return this.mouseenter(a).mouseleave(b||a)};var pb,fb,pc=e.now(),qc=/\?/,Ad=/#.*$/,Nc=/([?&])_=[^&]*/,Bd=/^(.*?):[ \t]*([^\r\n]*)\r?$/gm,Cd=/^(?:GET|HEAD)$/,
Dd=/^\/\//,Oc=/^([\w.+-]+:)(?:\/\/([^\/?#:]*)(?::(\d+)|)|)/,Pc=e.fn.load,Qc={},dc={},Rc="*/".concat("*");try{fb=ga.href}catch(Jd){fb=F.createElement("a"),fb.href="",fb=fb.href}pb=Oc.exec(fb.toLowerCase())||[];e.fn.load=function(a,c,h){if("string"!=typeof a&&Pc)return Pc.apply(this,arguments);var d,l,k,f=this,r=a.indexOf(" ");return 0<=r&&(d=a.slice(r,a.length),a=a.slice(0,r)),e.isFunction(c)?(h=c,c=b):c&&"object"==typeof c&&(k="POST"),0<f.length&&e.ajax({url:a,type:k,dataType:"html",data:c}).done(function(a){l=
arguments;f.html(d?e("<div>").append(e.parseHTML(a)).find(d):a)}).complete(h&&function(a,b){f.each(h,l||[a.responseText,b,a])}),this};e.each("ajaxStart ajaxStop ajaxComplete ajaxError ajaxSuccess ajaxSend".split(" "),function(a,b){e.fn[b]=function(a){return this.on(b,a)}});e.each(["get","post"],function(a,c){e[c]=function(a,h,g,d){return e.isFunction(h)&&(d=d||g,g=h,h=b),e.ajax({url:a,type:c,dataType:d,data:h,success:g})}});e.extend({active:0,lastModified:{},etag:{},ajaxSettings:{url:fb,type:"GET",
isLocal:/^(?:about|app|app-storage|.+-extension|file|res|widget):$/.test(pb[1]),global:!0,processData:!0,async:!0,contentType:"application/x-www-form-urlencoded; charset=UTF-8",accepts:{"*":Rc,text:"text/plain",html:"text/html",xml:"application/xml, text/xml",json:"application/json, text/javascript"},contents:{xml:/xml/,html:/html/,json:/json/},responseFields:{xml:"responseXML",text:"responseText"},converters:{"* text":a.String,"text html":!0,"text json":e.parseJSON,"text xml":e.parseXML},flatOptions:{url:!0,
context:!0}},ajaxSetup:function(a,b){return b?fa(fa(a,e.ajaxSettings),b):fa(e.ajaxSettings,a)},ajaxPrefilter:S(Qc),ajaxTransport:S(dc),ajax:function(a,c){function h(a,c,g,d){var l,w,u,z,x,O=c;if(2!==G){G=2;r&&clearTimeout(r);j=b;f=d||"";n.readyState=0<a?4:0;if(g){z=v;d=n;var s,F,C,q,Oa=z.contents,ga=z.dataTypes,Ta=z.responseFields;for(q in Ta)q in g&&(d[Ta[q]]=g[q]);for(;"*"===ga[0];)ga.shift(),F===b&&(F=z.mimeType||d.getResponseHeader("Content-Type"));if(F)for(q in Oa)if(Oa[q]&&Oa[q].test(F)){ga.unshift(q);
break}if(ga[0]in g)C=ga[0];else{for(q in g){if(!ga[0]||z.converters[q+" "+ga[0]]){C=q;break}s||(s=q)}C=C||s}z=C?(C!==ga[0]&&ga.unshift(C),g[C]):b}if(200<=a&&300>a||304===a)if(v.ifModified&&(x=n.getResponseHeader("Last-Modified"),x&&(e.lastModified[k]=x),x=n.getResponseHeader("etag"),x&&(e.etag[k]=x)),204===a)l=!0,O="nocontent";else if(304===a)l=!0,O="notmodified";else{var B;a:{g=v;l=z;var H,Ia;u={};x=0;O=g.dataTypes.slice();s=O[0];if(g.dataFilter&&(l=g.dataFilter(l,g.dataType)),O[1])for(H in g.converters)u[H.toLowerCase()]=
g.converters[H];for(;w=O[++x];)if("*"!==w){if("*"!==s&&s!==w){if(H=u[s+" "+w]||u["* "+w],!H)for(B in u)if(Ia=B.split(" "),Ia[1]===w&&(H=u[s+" "+Ia[0]]||u["* "+Ia[0]])){!0===H?H=u[B]:!0!==u[B]&&(w=Ia[0],O.splice(x--,0,w));break}if(!0!==H)if(H&&g["throws"])l=H(l);else try{l=H(l)}catch(R){B={state:"parsererror",error:H?R:"No conversion from "+s+" to "+w};break a}}s=w}B={state:"success",data:l}}l=B;O=l.state;w=l.data;u=l.error;l=!u}else u=O,(a||!O)&&(O="error",0>a&&(a=0));n.status=a;n.statusText=(c||
O)+"";l?p.resolveWith(A,[w,O,n]):p.rejectWith(A,[n,O,u]);n.statusCode(Xa);Xa=b;t&&D.trigger(l?"ajaxSuccess":"ajaxError",[n,v,l?w:u]);m.fireWith(A,[n,O]);t&&(D.trigger("ajaxComplete",[n,v]),--e.active||e.event.trigger("ajaxStop"))}}"object"==typeof a&&(c=a,a=b);c=c||{};var d,l,k,f,r,t,j,w,v=e.ajaxSetup({},c),A=v.context||v,D=v.context&&(A.nodeType||A.jquery)?e(A):e.event,p=e.Deferred(),m=e.Callbacks("once memory"),Xa=v.statusCode||{},O={},s={},G=0,F="canceled",n={readyState:0,getResponseHeader:function(a){var b;
if(2===G){if(!w)for(w={};b=Bd.exec(f);)w[b[1].toLowerCase()]=b[2];b=w[a.toLowerCase()]}return null==b?null:b},getAllResponseHeaders:function(){return 2===G?f:null},setRequestHeader:function(a,b){var c=a.toLowerCase();return G||(a=s[c]=s[c]||a,O[a]=b),this},overrideMimeType:function(a){return G||(v.mimeType=a),this},statusCode:function(a){var b;if(a)if(2>G)for(b in a)Xa[b]=[Xa[b],a[b]];else n.always(a[n.status]);return this},abort:function(a){a=a||F;return j&&j.abort(a),h(0,a),this}};if(p.promise(n).complete=
m.add,n.success=n.done,n.error=n.fail,v.url=((a||v.url||fb)+"").replace(Ad,"").replace(Dd,pb[1]+"//"),v.type=c.method||c.type||v.method||v.type,v.dataTypes=e.trim(v.dataType||"*").toLowerCase().match(Ba)||[""],null==v.crossDomain&&(d=Oc.exec(v.url.toLowerCase()),v.crossDomain=!(!d||d[1]===pb[1]&&d[2]===pb[2]&&(d[3]||("http:"===d[1]?80:443))==(pb[3]||("http:"===pb[1]?80:443)))),v.data&&v.processData&&"string"!=typeof v.data&&(v.data=e.param(v.data,v.traditional)),P(Qc,v,c,n),2===G)return n;(t=v.global)&&
0===e.active++&&e.event.trigger("ajaxStart");v.type=v.type.toUpperCase();v.hasContent=!Cd.test(v.type);k=v.url;v.hasContent||(v.data&&(k=v.url+=(qc.test(k)?"&":"?")+v.data,delete v.data),!1===v.cache&&(v.url=Nc.test(k)?k.replace(Nc,"$1_="+pc++):k+(qc.test(k)?"&":"?")+"_="+pc++));v.ifModified&&(e.lastModified[k]&&n.setRequestHeader("If-Modified-Since",e.lastModified[k]),e.etag[k]&&n.setRequestHeader("If-None-Match",e.etag[k]));(v.data&&v.hasContent&&!1!==v.contentType||c.contentType)&&n.setRequestHeader("Content-Type",
v.contentType);n.setRequestHeader("Accept",v.dataTypes[0]&&v.accepts[v.dataTypes[0]]?v.accepts[v.dataTypes[0]]+("*"!==v.dataTypes[0]?", "+Rc+"; q=0.01":""):v.accepts["*"]);for(l in v.headers)n.setRequestHeader(l,v.headers[l]);if(v.beforeSend&&(!1===v.beforeSend.call(A,n,v)||2===G))return n.abort();F="abort";for(l in{success:1,error:1,complete:1})n[l](v[l]);if(j=P(dc,v,c,n)){n.readyState=1;t&&D.trigger("ajaxSend",[n,v]);v.async&&0<v.timeout&&(r=setTimeout(function(){n.abort("timeout")},v.timeout));
try{G=1,j.send(O,h)}catch(C){if(!(2>G))throw C;h(-1,C)}}else h(-1,"No Transport");return n},getScript:function(a,c){return e.get(a,b,c,"script")},getJSON:function(a,b,c){return e.get(a,b,c,"json")}});e.ajaxSetup({accepts:{script:"text/javascript, application/javascript, application/ecmascript, application/x-ecmascript"},contents:{script:/(?:java|ecma)script/},converters:{"text script":function(a){return e.globalEval(a),a}}});e.ajaxPrefilter("script",function(a){a.cache===b&&(a.cache=!1);a.crossDomain&&
(a.type="GET",a.global=!1)});e.ajaxTransport("script",function(a){if(a.crossDomain){var c,h=F.head||e("head")[0]||F.documentElement;return{send:function(b,e){c=F.createElement("script");c.async=!0;a.scriptCharset&&(c.charset=a.scriptCharset);c.src=a.url;c.onload=c.onreadystatechange=function(a,b){(b||!c.readyState||/loaded|complete/.test(c.readyState))&&(c.onload=c.onreadystatechange=null,c.parentNode&&c.parentNode.removeChild(c),c=null,b||e(200,"success"))};h.insertBefore(c,h.firstChild)},abort:function(){c&&
c.onload(b,!0)}}}});var Sc=[],rc=/(=)\?(?=&|$)|\?\?/;e.ajaxSetup({jsonp:"callback",jsonpCallback:function(){var a=Sc.pop()||e.expando+"_"+pc++;return this[a]=!0,a}});e.ajaxPrefilter("json jsonp",function(c,h,d){var l,k,f,r=!1!==c.jsonp&&(rc.test(c.url)?"url":"string"==typeof c.data&&!(c.contentType||"").indexOf("application/x-www-form-urlencoded")&&rc.test(c.data)&&"data");return r||"jsonp"===c.dataTypes[0]?(l=c.jsonpCallback=e.isFunction(c.jsonpCallback)?c.jsonpCallback():c.jsonpCallback,r?c[r]=
c[r].replace(rc,"$1"+l):!1!==c.jsonp&&(c.url+=(qc.test(c.url)?"&":"?")+c.jsonp+"="+l),c.converters["script json"]=function(){return f||e.error(l+" was not called"),f[0]},c.dataTypes[0]="json",k=a[l],a[l]=function(){f=arguments},d.always(function(){a[l]=k;c[l]&&(c.jsonpCallback=h.jsonpCallback,Sc.push(l));f&&e.isFunction(k)&&k(f[0]);f=k=b}),"script"):b});var Fb,Ob,Ed=0,sc=a.ActiveXObject&&function(){for(var a in Fb)Fb[a](b,!0)};e.ajaxSettings.xhr=a.ActiveXObject?function(){var b;if(!(b=!this.isLocal&&
ha()))a:{try{b=new a.ActiveXObject("Microsoft.XMLHTTP");break a}catch(c){}b=void 0}return b}:ha;Ob=e.ajaxSettings.xhr();e.support.cors=!!Ob&&"withCredentials"in Ob;(Ob=e.support.ajax=!!Ob)&&e.ajaxTransport(function(c){if(!c.crossDomain||e.support.cors){var h;return{send:function(d,l){var k,f,r=c.xhr();if(c.username?r.open(c.type,c.url,c.async,c.username,c.password):r.open(c.type,c.url,c.async),c.xhrFields)for(f in c.xhrFields)r[f]=c.xhrFields[f];c.mimeType&&r.overrideMimeType&&r.overrideMimeType(c.mimeType);
c.crossDomain||d["X-Requested-With"]||(d["X-Requested-With"]="XMLHttpRequest");try{for(f in d)r.setRequestHeader(f,d[f])}catch(t){}r.send(c.hasContent&&c.data||null);h=function(a,d){var f,t,j,v;try{if(h&&(d||4===r.readyState))if(h=b,k&&(r.onreadystatechange=e.noop,sc&&delete Fb[k]),d)4!==r.readyState&&r.abort();else{v={};f=r.status;t=r.getAllResponseHeaders();"string"==typeof r.responseText&&(v.text=r.responseText);try{j=r.statusText}catch(w){j=""}f||!c.isLocal||c.crossDomain?1223===f&&(f=204):f=
v.text?200:404}}catch(A){d||l(-1,A)}v&&l(f,j,v,t)};c.async?4===r.readyState?setTimeout(h):(k=++Ed,sc&&(Fb||(Fb={},e(a).unload(sc)),Fb[k]=h),r.onreadystatechange=h):h()},abort:function(){h&&h(b,!0)}}}});var qb,bc,Fd=/^(?:toggle|show|hide)$/,Gd=RegExp("^(?:([+-])=|)("+Da+")([a-z%]*)$","i"),Hd=/queueHooks$/,Qb=[function(a,b,c){var h,d,l,k,f,r,t=this,j=a.style,v={},w=[],A=a.nodeType&&V(a);c.queue||(f=e._queueHooks(a,"fx"),null==f.unqueued&&(f.unqueued=0,r=f.empty.fire,f.empty.fire=function(){f.unqueued||
r()}),f.unqueued++,t.always(function(){t.always(function(){f.unqueued--;e.queue(a,"fx").length||f.empty.fire()})}));1===a.nodeType&&("height"in b||"width"in b)&&(c.overflow=[j.overflow,j.overflowX,j.overflowY],"inline"===e.css(a,"display")&&"none"===e.css(a,"float")&&(e.support.inlineBlockNeedsLayout&&"inline"!==ca(a.nodeName)?j.zoom=1:j.display="inline-block"));c.overflow&&(j.overflow="hidden",e.support.shrinkWrapBlocks||t.always(function(){j.overflow=c.overflow[0];j.overflowX=c.overflow[1];j.overflowY=
c.overflow[2]}));for(d in b)if(l=b[d],Fd.exec(l))(delete b[d],h=h||"toggle"===l,l===(A?"hide":"show"))||w.push(d);if(b=w.length){l=e._data(a,"fxshow")||e._data(a,"fxshow",{});"hidden"in l&&(A=l.hidden);h&&(l.hidden=!A);A?e(a).show():t.done(function(){e(a).hide()});t.done(function(){var b;e._removeData(a,"fxshow");for(b in v)e.style(a,b,v[b])});for(d=0;b>d;d++)h=w[d],k=t.createTween(h,A?l[h]:0),v[h]=l[h]||e.style(a,h),h in l||(l[h]=k.start,A&&(k.end=k.start,k.start="width"===h||"height"===h?1:0))}}],
Hb={"*":[function(a,b){var c,h,d=this.createTween(a,b),l=Gd.exec(b),k=d.cur(),f=+k||0,r=1,t=20;if(l){if(c=+l[2],h=l[3]||(e.cssNumber[a]?"":"px"),"px"!==h&&f){f=e.css(d.elem,a,!0)||c||1;do r=r||".5",f/=r,e.style(d.elem,a,f+h);while(r!==(r=d.cur()/k)&&1!==r&&--t)}d.unit=h;d.start=f;d.end=l[1]?f+(l[1]+1)*c:c}return d}]};e.Animation=e.extend(ia,{tweener:function(a,b){e.isFunction(a)?(b=a,a=["*"]):a=a.split(" ");for(var c,h=0,d=a.length;d>h;h++)c=a[h],Hb[c]=Hb[c]||[],Hb[c].unshift(b)},prefilter:function(a,
b){b?Qb.unshift(a):Qb.push(a)}});e.Tween=Y;Y.prototype={constructor:Y,init:function(a,b,c,h,d,l){this.elem=a;this.prop=c;this.easing=d||"swing";this.options=b;this.start=this.now=this.cur();this.end=h;this.unit=l||(e.cssNumber[c]?"":"px")},cur:function(){var a=Y.propHooks[this.prop];return a&&a.get?a.get(this):Y.propHooks._default.get(this)},run:function(a){var b,c=Y.propHooks[this.prop];return this.pos=b=this.options.duration?e.easing[this.easing](a,this.options.duration*a,0,1,this.options.duration):
a,this.now=(this.end-this.start)*b+this.start,this.options.step&&this.options.step.call(this.elem,this.now,this),c&&c.set?c.set(this):Y.propHooks._default.set(this),this}};Y.prototype.init.prototype=Y.prototype;Y.propHooks={_default:{get:function(a){var b;return null==a.elem[a.prop]||a.elem.style&&null!=a.elem.style[a.prop]?(b=e.css(a.elem,a.prop,""),b&&"auto"!==b?b:0):a.elem[a.prop]},set:function(a){e.fx.step[a.prop]?e.fx.step[a.prop](a):a.elem.style&&(null!=a.elem.style[e.cssProps[a.prop]]||e.cssHooks[a.prop])?
e.style(a.elem,a.prop,a.now+a.unit):a.elem[a.prop]=a.now}}};Y.propHooks.scrollTop=Y.propHooks.scrollLeft={set:function(a){a.elem.nodeType&&a.elem.parentNode&&(a.elem[a.prop]=a.now)}};e.each(["toggle","show","hide"],function(a,b){var c=e.fn[b];e.fn[b]=function(a,e,h){return null==a||"boolean"==typeof a?c.apply(this,arguments):this.animate(k(b,!0),a,e,h)}});e.fn.extend({fadeTo:function(a,b,c,e){return this.filter(V).css("opacity",0).show().end().animate({opacity:b},a,c,e)},animate:function(a,b,c,h){var d=
e.isEmptyObject(a),l=e.speed(b,c,h),k=function(){var b=ia(this,e.extend({},a),l);k.finish=function(){b.stop(!0)};(d||e._data(this,"finish"))&&b.stop(!0)};return k.finish=k,d||!1===l.queue?this.each(k):this.queue(l.queue,k)},stop:function(a,c,h){var d=function(a){var b=a.stop;delete a.stop;b(h)};return"string"!=typeof a&&(h=c,c=a,a=b),c&&!1!==a&&this.queue(a||"fx",[]),this.each(function(){var b=!0,c=null!=a&&a+"queueHooks",l=e.timers,k=e._data(this);if(c)k[c]&&k[c].stop&&d(k[c]);else for(c in k)k[c]&&
k[c].stop&&Hd.test(c)&&d(k[c]);for(c=l.length;c--;)l[c].elem!==this||null!=a&&l[c].queue!==a||(l[c].anim.stop(h),b=!1,l.splice(c,1));(b||!h)&&e.dequeue(this,a)})},finish:function(a){return!1!==a&&(a=a||"fx"),this.each(function(){var b,c=e._data(this),h=c[a+"queue"];b=c[a+"queueHooks"];var d=e.timers,l=h?h.length:0;c.finish=!0;e.queue(this,a,[]);b&&b.cur&&b.cur.finish&&b.cur.finish.call(this);for(b=d.length;b--;)d[b].elem===this&&d[b].queue===a&&(d[b].anim.stop(!0),d.splice(b,1));for(b=0;l>b;b++)h[b]&&
h[b].finish&&h[b].finish.call(this);delete c.finish})}});e.each({slideDown:k("show"),slideUp:k("hide"),slideToggle:k("toggle"),fadeIn:{opacity:"show"},fadeOut:{opacity:"hide"},fadeToggle:{opacity:"toggle"}},function(a,b){e.fn[a]=function(a,c,e){return this.animate(b,a,c,e)}});e.speed=function(a,b,c){var h=a&&"object"==typeof a?e.extend({},a):{complete:c||!c&&b||e.isFunction(a)&&a,duration:a,easing:c&&b||b&&!e.isFunction(b)&&b};return h.duration=e.fx.off?0:"number"==typeof h.duration?h.duration:h.duration in
e.fx.speeds?e.fx.speeds[h.duration]:e.fx.speeds._default,(null==h.queue||!0===h.queue)&&(h.queue="fx"),h.old=h.complete,h.complete=function(){e.isFunction(h.old)&&h.old.call(this);h.queue&&e.dequeue(this,h.queue)},h};e.easing={linear:function(a){return a},swing:function(a){return 0.5-Math.cos(a*Math.PI)/2}};e.timers=[];e.fx=Y.prototype.init;e.fx.tick=function(){var a,c=e.timers,h=0;for(qb=e.now();c.length>h;h++)a=c[h],a()||c[h]!==a||c.splice(h--,1);c.length||e.fx.stop();qb=b};e.fx.timer=function(a){a()&&
e.timers.push(a)&&e.fx.start()};e.fx.interval=13;e.fx.start=function(){bc||(bc=setInterval(e.fx.tick,e.fx.interval))};e.fx.stop=function(){clearInterval(bc);bc=null};e.fx.speeds={slow:600,fast:200,_default:400};e.fx.step={};e.expr&&e.expr.filters&&(e.expr.filters.animated=function(a){return e.grep(e.timers,function(b){return a===b.elem}).length});e.fn.offset=function(a){if(arguments.length)return a===b?this:this.each(function(b){e.offset.setOffset(this,a,b)});var c,h,d={top:0,left:0},l=this[0],k=
l&&l.ownerDocument;if(k)return c=k.documentElement,e.contains(c,l)?(typeof l.getBoundingClientRect!==A&&(d=l.getBoundingClientRect()),h=D(k),{top:d.top+(h.pageYOffset||c.scrollTop)-(c.clientTop||0),left:d.left+(h.pageXOffset||c.scrollLeft)-(c.clientLeft||0)}):d};e.offset={setOffset:function(a,b,c){var h=e.css(a,"position");"static"===h&&(a.style.position="relative");var d=e(a),l=d.offset(),k=e.css(a,"top"),f=e.css(a,"left"),r={},t={},j,v;("absolute"===h||"fixed"===h)&&-1<e.inArray("auto",[k,f])?(t=
d.position(),j=t.top,v=t.left):(j=parseFloat(k)||0,v=parseFloat(f)||0);e.isFunction(b)&&(b=b.call(a,c,l));null!=b.top&&(r.top=b.top-l.top+j);null!=b.left&&(r.left=b.left-l.left+v);"using"in b?b.using.call(a,r):d.css(r)}};e.fn.extend({position:function(){if(this[0]){var a,b,c={top:0,left:0},h=this[0];return"fixed"===e.css(h,"position")?b=h.getBoundingClientRect():(a=this.offsetParent(),b=this.offset(),e.nodeName(a[0],"html")||(c=a.offset()),c.top+=e.css(a[0],"borderTopWidth",!0),c.left+=e.css(a[0],
"borderLeftWidth",!0)),{top:b.top-c.top-e.css(h,"marginTop",!0),left:b.left-c.left-e.css(h,"marginLeft",!0)}}},offsetParent:function(){return this.map(function(){for(var a=this.offsetParent||F.documentElement;a&&!e.nodeName(a,"html")&&"static"===e.css(a,"position");)a=a.offsetParent;return a||F.documentElement})}});e.each({scrollLeft:"pageXOffset",scrollTop:"pageYOffset"},function(a,c){var h=/Y/.test(c);e.fn[a]=function(d){return e.access(this,function(a,d,l){var k=D(a);return l===b?k?c in k?k[c]:
k.document.documentElement[d]:a[d]:(k?k.scrollTo(h?e(k).scrollLeft():l,h?l:e(k).scrollTop()):a[d]=l,b)},a,d,arguments.length,null)}});e.each({Height:"height",Width:"width"},function(a,c){e.each({padding:"inner"+a,content:c,"":"outer"+a},function(h,d){e.fn[d]=function(d,l){var k=arguments.length&&(h||"boolean"!=typeof d),f=h||(!0===d||!0===l?"margin":"border");return e.access(this,function(c,h,d){var l;return e.isWindow(c)?c.document.documentElement["client"+a]:9===c.nodeType?(l=c.documentElement,
Math.max(c.body["scroll"+a],l["scroll"+a],c.body["offset"+a],l["offset"+a],l["client"+a])):d===b?e.css(c,h,f):e.style(c,h,d,f)},c,k?d:b,k,null)}})});a.jQuery=a.$=e;"function"==typeof define&&define.amd&&define.amd.jQuery&&define("jquery",[],function(){return e})})(window);$.fn.top=function(){var a;a=Math.floor(parseFloat(this.css("top"))||this.position().top);return isNaN(a)?0:a};$.fn.middle=function(){return Math.round(this.top()+Math.round($(this).outerHeight()/2))};
...
(function(a,b,c){function d(a,b,c){for(var d=[],k=0;k<a.length;k++){var f=tinycolor(a[k]),j=0.5>f.toHsl().l?"sp-thumb-el sp-thumb-dark":"sp-thumb-el sp-thumb-light",j=j+(tinycolor.equals(b,a[k])?" sp-thumb-active":""),D=y?"background-color:"+f.toRgbString():"filter:"+f.toFilter();d.push('<span title="'+f.toRgbString()+'" data-color="'+f.toRgbString()+'" class="'+j+'"><span class="sp-thumb-inner" style="'+D+';" /></span>')}return"<div class='sp-cf "+c+"'>"+d.join("")+"</div>"}function f(a,c){var d=
a.outerWidth(),k=a.outerHeight(),f=c.outerHeight(),j=a[0].ownerDocument,D=j.documentElement,p=D.clientWidth+b(j).scrollLeft(),j=D.clientHeight+b(j).scrollTop(),D=c.offset();D.top+=f;D.left-=Math.min(D.left,D.left+d>p&&p>d?Math.abs(D.left+d-p):0);D.top-=Math.min(D.top,D.top+k>j&&j>k?Math.abs(k+f-0):0);return D}function n(){}function q(a){a.stopPropagation()}function m(a,b){var c=Array.prototype.slice,d=c.call(arguments,2);return function(){return a.apply(b,d.concat(c.call(arguments)))}}function p(c,
d,k,f){function j(a){a.stopPropagation&&a.stopPropagation();a.preventDefault&&a.preventDefault();a.returnValue=!1}function D(a){if(s){if(W&&9>document.documentMode&&!a.button)return p();var b=a.originalEvent.touches,e=b?b[0].pageY:a.pageY,b=Math.max(0,Math.min((b?b[0].pageX:a.pageX)-n.left,q)),e=Math.max(0,Math.min(e-n.top,C));w&&j(a);d.apply(c,[b,e,a])}}function p(){s&&(b(m).unbind(O),b(m.body).removeClass("sp-dragging"),f.apply(c,arguments));s=!1}d=d||function(){};k=k||function(){};f=f||function(){};
var m=c.ownerDocument||document,s=!1,n={},C=0,q=0,w="ontouchstart"in a,O={};O.selectstart=j;O.dragstart=j;O[w?"touchmove":"mousemove"]=D;O[w?"touchend":"mouseup"]=p;b(c).bind(w?"touchstart":"mousedown",function(a){if(!(a.which?3==a.which:2==a.button)&&!s&&!1!==k.apply(c,arguments))s=!0,C=b(c).height(),q=b(c).width(),n=b(c).offset(),b(m).bind(O),b(m.body).addClass("sp-dragging"),w||D(a),j(a)})}var Q={beforeShow:n,move:n,change:n,show:n,hide:n,color:!1,flat:!1,showInput:!0,showButtons:!1,clickoutFiresChange:!1,
showInitial:!1,showPalette:!1,showPaletteOnly:!1,showSelectionPalette:!0,localStorageKey:!1,maxSelectionSize:7,cancelText:"cancel",chooseText:"choose",preferredFormat:!1,className:"",showAlpha:!1,theme:"sp-light",palette:["fff","000"],selectionPalette:[],disabled:!1},T=[],W=!!/msie/i.exec(a.navigator.userAgent),y,B=document.createElement("div").style;B.cssText="background-color:rgba(0,0,0,.5)";y=!!~(""+B.backgroundColor).indexOf("rgba")||!!~(""+B.backgroundColor).indexOf("hsla");var N,B="";if(W)for(var X=
1;6>=X;X++)B+="<div class='sp-"+X+"'></div>";N=["<div class='sp-container'><div class='sp-palette-container'><div class='sp-palette sp-thumb sp-cf'></div></div><div class='sp-picker-container'><div class='sp-top sp-cf'><div class='sp-fill'></div><div class='sp-top-inner'><div class='sp-color'><div class='sp-sat'><div class='sp-val'><div class='sp-dragger'></div></div></div></div><div class='sp-hue'><div class='sp-slider'></div>",B,"</div></div><div class='sp-alpha'><div class='sp-alpha-inner'><div class='sp-alpha-handle'></div></div></div></div><div class='sp-input-container sp-cf'><input class='sp-input' type='text' spellcheck='false'  /></div><div class='sp-initial sp-thumb sp-cf'></div><div class='sp-button-container sp-cf'><a class='sp-cancel' href='#'></a><button class='sp-choose'></button></div></div></div>"].join("");
b.fn.spectrum=function(k,j){if("string"==typeof k){var A=this,D=Array.prototype.slice.call(arguments,1);this.each(function(){var a=T[b(this).data("spectrum.id")];if(a){var c=a[k];if(!c)throw Error("Spectrum: no such method: '"+k+"'");"get"==k?A=a.get():"container"==k?A=a.container:"option"==k?A=a.option.apply(a,D):"destroy"==k?(a.destroy(),b(this).removeData("spectrum.id")):c.apply(a,D)}});return A}return this.spectrum("destroy").each(function(){var j,v=function(){l.toggleClass("sp-flat",U);l.toggleClass("sp-input-disabled",
!L.showInput);l.toggleClass("sp-alpha-enabled",L.showAlpha);l.toggleClass("sp-buttons-disabled",!L.showButtons||U);l.toggleClass("sp-palette-disabled",!L.showPalette);l.toggleClass("sp-palette-only",L.showPaletteOnly);l.toggleClass("sp-initial-disabled",!L.showInitial);l.addClass(L.className);K()},A=function(c){if(V&&(c=tinycolor(c).toRgbString(),-1===b.inArray(c,Ga)&&Ga.push(c),ca&&a.localStorage))try{a.localStorage[ca]=Ga.join(";")}catch(h){}},D=function(){var a=[],b=Ga,c={},h;if(L.showPalette){for(var e=
0;e<mb.length;e++)for(var d=0;d<mb[e].length;d++)h=tinycolor(mb[e][d]).toRgbString(),c[h]=!0;for(e=0;e<b.length;e++)h=tinycolor(b[e]).toRgbString(),c.hasOwnProperty(h)||(a.push(b[e]),c[h]=!0)}return a.reverse().slice(0,L.maxSelectionSize)},s=function(){var a=B(),c=b.map(mb,function(b,c){return d(b,a,"sp-palette-row sp-palette-row-"+c)});Ga&&c.push(d(D(),a,"sp-palette-row sp-palette-row-selection"));Tb.html(c.join(""))},n=function(){if(L.showInitial){var a=Za,b=B();Kb.html(d([a,b],b,"sp-palette-row-initial"))}},
C=function(){(0===ea||0===ba||0===na)&&K();l.addClass(wa)},F=function(){l.removeClass(wa)},w=function(){var a=tinycolor(Pa.val());a.ok?e(a):Pa.addClass("sp-validation-error")},O=function(){ja?H():G()},G=function(){if(ja)K();else if(!1!==E.beforeShow(B())){for(var c=0;c<T.length;c++)T[c]&&T[c].hide();ja=!0;b(xa).bind("click.spectrum",H);b(a).bind("resize.spectrum",fa);Aa.addClass("sp-active");l.show();L.showPalette&&s();K();S();Za=B();n();E.show(Za)}},H=function(c){if((!c||!("click"==c.type&&2==c.button))&&
ja&&!U)ja=!1,b(xa).unbind("click.spectrum",H),b(a).unbind("resize.spectrum",fa),Aa.removeClass("sp-active"),l.hide(),tinycolor.equals(B(),Za)||(yb&&"cancel"!==c?X(!0):e(Za,!0)),E.hide(B())},e=function(a,b){if(!tinycolor.equals(a,B())){var c=tinycolor(a),h=c.toHsv();la=h.h;Na=h.s;ra=h.v;J=h.a;S();b||(Ya=Ma||c.format)}},B=function(){return tinycolor.fromRatio({h:la,s:Na,v:ra,a:Math.round(100*J)/100})},R=function(){S();E.move(B())},S=function(){Pa.removeClass("sp-validation-error");I();var a=tinycolor({h:la,
s:"1.0",v:"1.0"});r.css("background-color",a.toHexString());a=Ya;if(1>J&&("hex"===a||"name"===a))a="rgb";var b=B(),c=b.toHexString(),h=b.toRgbString();y||1===b.alpha?zb.css("background-color",h):(zb.css("background-color","transparent"),zb.css("filter",b.toFilter()));if(L.showAlpha){h=b.toRgb();h.a=0;var h=tinycolor(h).toRgbString(),e="linear-gradient(left, "+h+", "+c+")";W?Ea.css("filter",tinycolor(h).toFilter({gradientType:1},c)):(Ea.css("background","-webkit-"+e),Ea.css("background","-moz-"+e),
Ea.css("background","-ms-"+e),Ea.css("background",e))}if(L.showInput){if(1>J&&("hex"===a||"name"===a))a="rgb";Pa.val(b.toString(a))}L.showPalette&&s();n()},I=function(){var a=Na*ba,b=ea-ra*ea,a=Math.max(-M,Math.min(ba-M,a-M)),b=Math.max(-M,Math.min(ea-M,b-M));Xa.css({top:b,left:a});tb.css({left:J*oa-ua/2});Ia.css({top:la*na-Ha})},X=function(a){var b=B();nb&&va.val(b.toString(Ya)).change();var c=!tinycolor.equals(b,Za);Za=b;A(b);a&&c&&E.change(b)},K=function(){ba=r.width();ea=r.height();M=Xa.height();
Oa.width();na=Oa.height();Ha=Ia.height();oa=sb.width();ua=tb.width();U||l.offset(f(l,Z));I()};j=function(){H();h=!0;va.attr("disabled",!0);Z.addClass("sp-disabled")};var L,P=b.extend({},Q,k);P.callbacks={move:m(P.move,this),change:m(P.change,this),show:m(P.show,this),hide:m(P.hide,this),beforeShow:m(P.beforeShow,this)};L=P;var U=L.flat,V=L.showSelectionPalette,ca=L.localStorageKey,Y=L.theme,E=L.callbacks,fa,ha=K,ia;fa=function(){var a=this,b=arguments;ia||(ia=setTimeout(function(){ia=null;ha.apply(a,
b)},10))};var ja=!1,ba=0,ea=0,M=0,na=0,oa=0,ua=0,Ha=0,la=0,Na=0,ra=0,J=1,P=L.palette.slice(0),mb=b.isArray(P[0])?P:[P],Ga=L.selectionPalette.slice(0),wa="sp-dragging",xa=this.ownerDocument,P=xa.body,va=b(this),h=!1,l=b(N,xa).addClass(Y),r=l.find(".sp-color"),Xa=l.find(".sp-dragger"),Oa=l.find(".sp-hue"),Ia=l.find(".sp-slider"),Ea=l.find(".sp-alpha-inner"),sb=l.find(".sp-alpha"),tb=l.find(".sp-alpha-handle"),Pa=l.find(".sp-input"),Tb=l.find(".sp-palette"),Kb=l.find(".sp-initial"),Lb=l.find(".sp-cancel"),
ub=l.find(".sp-choose"),nb=va.is("input"),ya=nb&&!U,Aa=ya?b("<div class='sp-replacer'><div class='sp-preview'><div class='sp-preview-inner'></div></div></div>").addClass(Y):b([]),Z=ya?Aa:va,zb=Aa.find(".sp-preview-inner"),Ab=L.color||nb&&va.val(),Za=!1,Ma=L.preferredFormat,Ya=Ma,yb=!L.showButtons||L.clickoutFiresChange,Y=function(a){a.data&&a.data.ignore?(e(b(this).data("color")),R()):(e(b(this).data("color")),X(!0),R(),H());return!1};W&&l.find("*:not(input)").attr("unselectable","on");v();ya&&va.hide().after(Aa);
U?va.after(l).hide():b(P).append(l.hide());if(ca&&a.localStorage){try{var Bb=a.localStorage[ca].split(",#");1<Bb.length&&(delete a.localStorage[ca],b.each(Bb,function(a,b){A(b)}))}catch(Xb){}try{Ga=a.localStorage[ca].split(";")}catch(Nb){}}Z.bind("click.spectrum touchstart.spectrum",function(a){h||O();a.stopPropagation();b(a.target).is("input")||a.preventDefault()});(va.is(":disabled")||!0===L.disabled)&&j();l.click(q);Pa.change(w);Pa.bind("paste",function(){setTimeout(w,1)});Pa.keydown(function(a){13==
a.keyCode&&w()});Lb.text(L.cancelText);Lb.bind("click.spectrum",function(a){a.stopPropagation();a.preventDefault();H("cancel")});ub.text(L.chooseText);ub.bind("click.spectrum",function(a){a.stopPropagation();a.preventDefault();Pa.hasClass("sp-validation-error")||(X(!0),H())});p(sb,function(a,b,c){J=a/oa;c.shiftKey&&(J=Math.round(10*J)/10);R()});p(Oa,function(a,b){la=parseFloat(b/na);R()},C,F);p(r,function(a,b){Na=parseFloat(a/ba);ra=parseFloat((ea-b)/ea);R()},C,F);Ab?(e(Ab),S(),Ya=Ma||tinycolor(Ab).format,
A(Ab)):S();U&&G();C=W?"mousedown.spectrum":"click.spectrum touchstart.spectrum";Tb.delegate(".sp-thumb-el",C,Y);Kb.delegate(".sp-thumb-el:nth-child(1)",C,{ignore:!0},Y);var eb={show:G,hide:H,toggle:O,reflow:K,option:function(a,h){if(a===c)return b.extend({},L);if(h===c)return L[a];L[a]=h;v()},enable:function(){h=!1;va.attr("disabled",!1);Z.removeClass("sp-disabled")},disable:j,set:function(a){e(a);X()},get:B,destroy:function(){va.show();Z.unbind("click.spectrum touchstart.spectrum");l.remove();Aa.remove();
T[eb.id]=null},container:l};eb.id=T.push(eb)-1;j=eb;b(this).data("spectrum.id",j.id)})};b.fn.spectrum.load=!0;b.fn.spectrum.loadOpts={};b.fn.spectrum.draggable=p;b.fn.spectrum.defaults=Q;b.spectrum={};b.spectrum.localization={};b.spectrum.palettes={};b.fn.spectrum.processNativeColorInputs=function(){var a=b("<input type='color' value='!' />")[0];"color"===a.type&&"!"!=a.value||b("input[type=color]").spectrum({preferredFormat:"hex6"})};var s=function(a){var b,c,d,f,p;if("object"==typeof a&&a.hasOwnProperty("_tc_id"))return a;
c=a;var m=0,n=0,q=0;a=1;var B=!1,y=!1;if("string"==typeof c)a:{c=c.replace(C,"").replace(R,"").toLowerCase();var N=!1;if(ja[c])c=ja[c],N=!0;else if("transparent"==c){c={r:0,g:0,b:0,a:0};break a}c=(b=D.rgb.exec(c))?{r:b[1],g:b[2],b:b[3]}:(b=D.rgba.exec(c))?{r:b[1],g:b[2],b:b[3],a:b[4]}:(b=D.hsl.exec(c))?{h:b[1],s:b[2],l:b[3]}:(b=D.hsla.exec(c))?{h:b[1],s:b[2],l:b[3],a:b[4]}:(b=D.hsv.exec(c))?{h:b[1],s:b[2],v:b[3]}:(b=D.hex6.exec(c))?{r:parseInt(b[1],16),g:parseInt(b[2],16),b:parseInt(b[3],16),format:N?
"name":"hex"}:(b=D.hex3.exec(c))?{r:parseInt(b[1]+""+b[1],16),g:parseInt(b[2]+""+b[2],16),b:parseInt(b[3]+""+b[3],16),format:N?"name":"hex"}:!1}"object"==typeof c&&(c.hasOwnProperty("r")&&c.hasOwnProperty("g")&&c.hasOwnProperty("b")?(m=255*I(c.r,255),n=255*I(c.g,255),q=255*I(c.b,255),B=!0,y="rgb"):c.hasOwnProperty("h")&&c.hasOwnProperty("s")&&c.hasOwnProperty("v")?(y=c.h,n=c.s,q=c.v,y=6*I(y,360),n=I(n,100),q=I(q,100),m=L.floor(y),B=y-m,y=q*(1-n),b=q*(1-B*n),B=q*(1-(1-B)*n),N=m%6,m=255*[q,b,y,y,B,
q][N],n=255*[B,q,q,b,y,y][N],q=255*[y,y,B,q,q,b][N],B=!0,y="hsv"):c.hasOwnProperty("h")&&(c.hasOwnProperty("s")&&c.hasOwnProperty("l"))&&(m=c.h,y=c.s,q=c.l,n=function(a,b,c){0>c&&(c+=1);1<c&&(c-=1);return c<1/6?a+6*(b-a)*c:0.5>c?b:c<2/3?a+6*(b-a)*(2/3-c):a},m=I(m,360),y=I(y,100),q=I(q,100),0===y?y=q=b=q:(b=0.5>q?q*(1+y):q+y-q*y,B=2*q-b,y=n(B,b,m+1/3),q=n(B,b,m),b=n(B,b,m-1/3)),m=255*y,n=255*q,q=255*b,B=!0,y="hsl"),c.hasOwnProperty("a")&&(a=c.a));m=S(255,P(m,0));n=S(255,P(n,0));q=S(255,P(q,0));1>m&&
(m=H(m));1>n&&(n=H(n));1>q&&(q=H(q));b=B;c=c&&c.format||y;d=m;f=n;p=q;var w=ha(a);return{ok:b,format:c,_tc_id:ca++,alpha:w,toHsv:function(){var a=K(d,f,p);return{h:a.h,s:a.s,v:a.v,a:w}},toHsvString:function(){var a=K(d,f,p),b=H(360*a.h),c=H(100*a.s),a=H(100*a.v);return 1==w?"hsv("+b+", "+c+"%, "+a+"%)":"hsva("+b+", "+c+"%, "+a+"%, "+w+")"},toHsl:function(){var a=U(d,f,p);return{h:a.h,s:a.s,l:a.l,a:w}},toHslString:function(){var a=U(d,f,p),b=H(360*a.h),c=H(100*a.s),a=H(100*a.l);return 1==w?"hsl("+
b+", "+c+"%, "+a+"%)":"hsla("+b+", "+c+"%, "+a+"%, "+w+")"},toHex:function(){return V(d,f,p)},toHexString:function(a){return"#"+V(d,f,p,a)},toRgb:function(){return{r:H(d),g:H(f),b:H(p),a:w}},toRgbString:function(){return 1==w?"rgb("+H(d)+", "+H(f)+", "+H(p)+")":"rgba("+H(d)+", "+H(f)+", "+H(p)+", "+w+")"},toName:function(){return k[V(d,f,p)]||!1},toFilter:function(a,b){var c=V(d,f,p,!0),e=c,k=Math.round(255*ha(w)).toString(16),t=k,v=a&&a.gradientType?"GradientType = 1, ":"";b&&(t=s(b),e=t.toHex(),
t=Math.round(255*ha(t.alpha)).toString(16));return"progid:DXImageTransform.Microsoft.gradient("+v+"startColorstr=#"+j(k)+c+",endColorstr=#"+j(t)+e+")"},toString:function(a){a=a||this.format;var b=!1;"rgb"===a&&(b=this.toRgbString());"hex"===a&&(b=this.toHexString());"hex6"===a&&(b=this.toHexString(!0));"name"===a&&(b=this.toName());"hsl"===a&&(b=this.toHslString());"hsv"===a&&(b=this.toHsvString());return b||this.toHexString(!0)}}},U=function(a,b,c){a=I(a,255);b=I(b,255);c=I(c,255);var d=P(a,b,c),
k=S(a,b,c),f,j=(d+k)/2;if(d==k)f=k=0;else{var D=d-k,k=0.5<j?D/(2-d-k):D/(d+k);switch(d){case a:f=(b-c)/D+(b<c?6:0);break;case b:f=(c-a)/D+2;break;case c:f=(a-b)/D+4}f/=6}return{h:f,s:k,l:j}},K=function(a,b,c){a=I(a,255);b=I(b,255);c=I(c,255);var d=P(a,b,c),k=S(a,b,c),f,j=d-k;if(d==k)f=0;else{switch(d){case a:f=(b-c)/j+(b<c?6:0);break;case b:f=(c-a)/j+2;break;case c:f=(a-b)/j+4}f/=6}return{h:f,s:0===d?0:j/d,v:d}},V=function(a,b,c,d){a=[j(H(a).toString(16)),j(H(b).toString(16)),j(H(c).toString(16))];
return!d&&a[0].charAt(0)==a[0].charAt(1)&&a[1].charAt(0)==a[1].charAt(1)&&a[2].charAt(0)==a[2].charAt(1)?a[0].charAt(0)+a[1].charAt(0)+a[2].charAt(0):a.join("")},I=function(a,b){"string"==typeof a&&(-1!=a.indexOf(".")&&1===ha(a))&&(a="100%");var c="string"===typeof a&&-1!=a.indexOf("%");a=S(b,P(0,ha(a)));c&&(a*=b/100);return 1E-6>L.abs(a-b)?1:1<=a?a%b/ha(b):a},j=function(a){return 1==a.length?"0"+a:""+a},C=/^[\s,#]+/,R=/\s+$/,ca=0,L=Math,H=L.round,S=L.min,P=L.max,fa=L.random,ha=this.parseFloat;s.fromRatio=
function(a){if("object"==typeof a)for(var b in a)1===a[b]&&(a[b]="1.0");return s(a)};s.equals=function(a,b){return!a||!b?!1:s(a).toRgbString()==s(b).toRgbString()};s.random=function(){return s.fromRatio({r:fa(),g:fa(),b:fa()})};s.desaturate=function(a,b){var c=s(a).toHsl();c.s-=(b||10)/100;c.s=S(1,P(0,c.s));return s(c)};s.saturate=function(a,b){var c=s(a).toHsl();c.s+=(b||10)/100;c.s=S(1,P(0,c.s));return s(c)};s.greyscale=function(a){return s.desaturate(a,100)};s.lighten=function(a,b){var c=s(a).toHsl();
c.l+=(b||10)/100;c.l=S(1,P(0,c.l));return s(c)};s.darken=function(a,b){var c=s(a).toHsl();c.l-=(b||10)/100;c.l=S(1,P(0,c.l));return s(c)};s.complement=function(a){a=s(a).toHsl();a.h=(a.h+0.5)%1;return s(a)};s.triad=function(a){var b=s(a).toHsl(),c=360*b.h;return[s(a),s({h:(c+120)%360,s:b.s,l:b.l}),s({h:(c+240)%360,s:b.s,l:b.l})]};s.tetrad=function(a){var b=s(a).toHsl(),c=360*b.h;return[s(a),s({h:(c+90)%360,s:b.s,l:b.l}),s({h:(c+180)%360,s:b.s,l:b.l}),s({h:(c+270)%360,s:b.s,l:b.l})]};s.splitcomplement=
function(a){var b=s(a).toHsl(),c=360*b.h;return[s(a),s({h:(c+72)%360,s:b.s,l:b.l}),s({h:(c+216)%360,s:b.s,l:b.l})]};s.analogous=function(a,b,c){b=b||6;c=c||30;var d=s(a).toHsl();c=360/c;a=[s(a)];d.h*=360;for(d.h=(d.h-(c*b>>1)+720)%360;--b;)d.h=(d.h+c)%360,a.push(s(d));return a};s.monochromatic=function(a,b){b=b||6;for(var c=s(a).toHsv(),d=c.h,k=c.s,c=c.v,f=[],j=1/b;b--;)f.push(s({h:d,s:k,v:c})),c=(c+j)%1;return f};s.readable=function(a,b){var c=s(a).toRgb(),d=s(b).toRgb();return 10404<(d.r-c.r)*(d.r-
c.r)+(d.g-c.g)*(d.g-c.g)+(d.b-c.b)*(d.b-c.b)};var ja=s.names={aliceblue:"f0f8ff",antiquewhite:"faebd7",aqua:"0ff",aquamarine:"7fffd4",azure:"f0ffff",beige:"f5f5dc",bisque:"ffe4c4",black:"000",blanchedalmond:"ffebcd",blue:"00f",blueviolet:"8a2be2",brown:"a52a2a",burlywood:"deb887",burntsienna:"ea7e5d",cadetblue:"5f9ea0",chartreuse:"7fff00",chocolate:"d2691e",coral:"ff7f50",cornflowerblue:"6495ed",cornsilk:"fff8dc",crimson:"dc143c",cyan:"0ff",darkblue:"00008b",darkcyan:"008b8b",darkgoldenrod:"b8860b",
...
slategray:"708090",slategrey:"708090",snow:"fffafa",springgreen:"00ff7f",steelblue:"4682b4",tan:"d2b48c",teal:"008080",thistle:"d8bfd8",tomato:"ff6347",turquoise:"40e0d0",violet:"ee82ee",wheat:"f5deb3",white:"fff",whitesmoke:"f5f5f5",yellow:"ff0",yellowgreen:"9acd32"},B=s,X=ja,ia={},Y;for(Y in X)X.hasOwnProperty(Y)&&(ia[X[Y]]=Y);var k=B.hexNames=ia,D;D={rgb:RegExp("rgb[\\s|\\(]+((?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?))[,|\\s]+((?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?))[,|\\s]+((?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?))\\s*\\)?"),
...
c.source&&b.global==c.global&&b.multiline==c.multiline&&b.ignoreCase==c.ignoreCase}if("object"!=typeof b||"object"!=typeof c)return!1;for(var m=d.length;m--;)if(d[m]==b)return!0;d.push(b);var m=0,n=!0;if("[object Array]"==f){if(m=b.length,n=m==c.length)for(;m--&&(n=m in b==m in c&&a(b[m],c[m],d)););}else{if("constructor"in b!="constructor"in c||b.constructor!=c.constructor)return!1;for(var s in b)if(j.has(b,s)&&(m++,!(n=j.has(c,s)&&a(b[s],c[s],d))))break;if(n){for(s in c)if(j.has(c,s)&&!m--)break;
n=!m}}d.pop();return n}var b=this,c=b._,d={},f=Array.prototype,n=Object.prototype,q=f.slice,m=f.unshift,p=n.toString,Q=n.hasOwnProperty,T=f.forEach,W=f.map,y=f.reduce,B=f.reduceRight,N=f.filter,X=f.every,s=f.some,U=f.indexOf,K=f.lastIndexOf,n=Array.isArray,V=Object.keys,I=Function.prototype.bind,j=function(a){return new ia(a)};"undefined"!==typeof exports?("undefined"!==typeof module&&module.exports&&(exports=module.exports=j),exports._=j):b._=j;j.VERSION="1.3.3";var C=j.each=j.forEach=function(a,
b,c){if(null!=a)if(T&&a.forEach===T)a.forEach(b,c);else if(a.length===+a.length)for(var f=0,m=a.length;f<m&&!(f in a&&b.call(c,a[f],f,a)===d);f++);else for(f in a)if(j.has(a,f)&&b.call(c,a[f],f,a)===d)break};j.map=j.collect=function(a,b,c){var d=[];if(null==a)return d;if(W&&a.map===W)return a.map(b,c);C(a,function(a,k,f){d[d.length]=b.call(c,a,k,f)});a.length===+a.length&&(d.length=a.length);return d};j.reduce=j.foldl=j.inject=function(a,b,c,d){var f=2<arguments.length;null==a&&(a=[]);if(y&&a.reduce===
y)return d&&(b=j.bind(b,d)),f?a.reduce(b,c):a.reduce(b);C(a,function(a,k,j){f?c=b.call(d,c,a,k,j):(c=a,f=!0)});if(!f)throw new TypeError("Reduce of empty array with no initial value");return c};j.reduceRight=j.foldr=function(a,b,c,d){var f=2<arguments.length;null==a&&(a=[]);if(B&&a.reduceRight===B)return d&&(b=j.bind(b,d)),f?a.reduceRight(b,c):a.reduceRight(b);var m=j.toArray(a).reverse();d&&!f&&(b=j.bind(b,d));return f?j.reduce(m,b,c,d):j.reduce(m,b)};j.find=j.detect=function(a,b,c){var d;R(a,function(a,
k,f){if(b.call(c,a,k,f))return d=a,!0});return d};j.filter=j.select=function(a,b,c){var d=[];if(null==a)return d;if(N&&a.filter===N)return a.filter(b,c);C(a,function(a,f,k){b.call(c,a,f,k)&&(d[d.length]=a)});return d};j.reject=function(a,b,c){var d=[];if(null==a)return d;C(a,function(a,f,k){b.call(c,a,f,k)||(d[d.length]=a)});return d};j.every=j.all=function(a,b,c){var f=!0;if(null==a)return f;if(X&&a.every===X)return a.every(b,c);C(a,function(a,k,j){if(!(f=f&&b.call(c,a,k,j)))return d});return!!f};
var R=j.some=j.any=function(a,b,c){b||(b=j.identity);var f=!1;if(null==a)return f;if(s&&a.some===s)return a.some(b,c);C(a,function(a,k,j){if(f||(f=b.call(c,a,k,j)))return d});return!!f};j.include=j.contains=function(a,b){return null==a?!1:U&&a.indexOf===U?-1!=a.indexOf(b):R(a,function(a){return a===b})};j.invoke=function(a,b){var c=q.call(arguments,2);return j.map(a,function(a){return(j.isFunction(b)?b||a:a[b]).apply(a,c)})};j.pluck=function(a,b){return j.map(a,function(a){return a[b]})};j.max=function(a,
b,c){if(!b&&j.isArray(a)&&a[0]===+a[0])return Math.max.apply(Math,a);if(!b&&j.isEmpty(a))return-Infinity;var d={computed:-Infinity};C(a,function(a,f,k){f=b?b.call(c,a,f,k):a;f>=d.computed&&(d={value:a,computed:f})});return d.value};j.min=function(a,b,c){if(!b&&j.isArray(a)&&a[0]===+a[0])return Math.min.apply(Math,a);if(!b&&j.isEmpty(a))return Infinity;var d={computed:Infinity};C(a,function(a,f,k){f=b?b.call(c,a,f,k):a;f<d.computed&&(d={value:a,computed:f})});return d.value};j.shuffle=function(a){var b=
[],c;C(a,function(a,d){c=Math.floor(Math.random()*(d+1));b[d]=b[c];b[c]=a});return b};j.sortBy=function(a,b,c){var d=j.isFunction(b)?b:function(a){return a[b]};return j.pluck(j.map(a,function(a,b,f){return{value:a,criteria:d.call(c,a,b,f)}}).sort(function(a,b){var c=a.criteria,d=b.criteria;return void 0===c?1:void 0===d?-1:c<d?-1:c>d?1:0}),"value")};j.groupBy=function(a,b){var c={},d=j.isFunction(b)?b:function(a){return a[b]};C(a,function(a,b){var f=d(a,b);(c[f]||(c[f]=[])).push(a)});return c};j.sortedIndex=
function(a,b,c){c||(c=j.identity);for(var d=0,f=a.length;d<f;){var m=d+f>>1;c(a[m])<c(b)?d=m+1:f=m}return d};j.toArray=function(a){return!a?[]:j.isArray(a)||j.isArguments(a)?q.call(a):a.toArray&&j.isFunction(a.toArray)?a.toArray():j.values(a)};j.size=function(a){return j.isArray(a)?a.length:j.keys(a).length};j.first=j.head=j.take=function(a,b,c){return null!=b&&!c?q.call(a,0,b):a[0]};j.initial=function(a,b,c){return q.call(a,0,a.length-(null==b||c?1:b))};j.last=function(a,b,c){return null!=b&&!c?
q.call(a,Math.max(a.length-b,0)):a[a.length-1]};j.rest=j.tail=function(a,b,c){return q.call(a,null==b||c?1:b)};j.compact=function(a){return j.filter(a,function(a){return!!a})};j.flatten=function(a,b){return j.reduce(a,function(a,c){if(j.isArray(c))return a.concat(b?c:j.flatten(c));a[a.length]=c;return a},[])};j.without=function(a){return j.difference(a,q.call(arguments,1))};j.uniq=j.unique=function(a,b,c){c=c?j.map(a,c):a;var d=[];3>a.length&&(b=!0);j.reduce(c,function(c,f,m){if(b?j.last(c)!==f||
!c.length:!j.include(c,f))c.push(f),d.push(a[m]);return c},[]);return d};j.union=function(){return j.uniq(j.flatten(arguments,!0))};j.intersection=j.intersect=function(a){var b=q.call(arguments,1);return j.filter(j.uniq(a),function(a){return j.every(b,function(b){return 0<=j.indexOf(b,a)})})};j.difference=function(a){var b=j.flatten(q.call(arguments,1),!0);return j.filter(a,function(a){return!j.include(b,a)})};j.zip=function(){for(var a=q.call(arguments),b=j.max(j.pluck(a,"length")),c=Array(b),d=
0;d<b;d++)c[d]=j.pluck(a,""+d);return c};j.indexOf=function(a,b,c){if(null==a)return-1;var d;if(c)return c=j.sortedIndex(a,b),a[c]===b?c:-1;if(U&&a.indexOf===U)return a.indexOf(b);c=0;for(d=a.length;c<d;c++)if(c in a&&a[c]===b)return c;return-1};j.lastIndexOf=function(a,b){if(null==a)return-1;if(K&&a.lastIndexOf===K)return a.lastIndexOf(b);for(var c=a.length;c--;)if(c in a&&a[c]===b)return c;return-1};j.range=function(a,b,c){1>=arguments.length&&(b=a||0,a=0);c=arguments[2]||1;for(var d=Math.max(Math.ceil((b-
a)/c),0),f=0,j=Array(d);f<d;)j[f++]=a,a+=c;return j};var ca=function(){};j.bind=function(a,b){var c,d;if(a.bind===I&&I)return I.apply(a,q.call(arguments,1));if(!j.isFunction(a))throw new TypeError;d=q.call(arguments,2);return c=function(){if(!(this instanceof c))return a.apply(b,d.concat(q.call(arguments)));ca.prototype=a.prototype;var f=new ca,j=a.apply(f,d.concat(q.call(arguments)));return Object(j)===j?j:f}};j.bindAll=function(a){var b=q.call(arguments,1);0==b.length&&(b=j.functions(a));C(b,function(b){a[b]=
j.bind(a[b],a)});return a};j.memoize=function(a,b){var c={};b||(b=j.identity);return function(){var d=b.apply(this,arguments);return j.has(c,d)?c[d]:c[d]=a.apply(this,arguments)}};j.delay=function(a,b){var c=q.call(arguments,2);return setTimeout(function(){return a.apply(null,c)},b)};j.defer=function(a){return j.delay.apply(j,[a,1].concat(q.call(arguments,1)))};j.throttle=function(a,b){var c,d,f,m,p,n,s=j.debounce(function(){p=m=!1},b);return function(){c=this;d=arguments;f||(f=setTimeout(function(){f=
null;p&&a.apply(c,d);s()},b));m?p=!0:n=a.apply(c,d);s();m=!0;return n}};j.debounce=function(a,b,c){var d;return function(){var f=this,j=arguments;c&&!d&&a.apply(f,j);clearTimeout(d);d=setTimeout(function(){d=null;c||a.apply(f,j)},b)}};j.once=function(a){var b=!1,c;return function(){if(b)return c;b=!0;return c=a.apply(this,arguments)}};j.wrap=function(a,b){return function(){var c=[a].concat(q.call(arguments,0));return b.apply(this,c)}};j.compose=function(){var a=arguments;return function(){for(var b=
arguments,c=a.length-1;0<=c;c--)b=[a[c].apply(this,b)];return b[0]}};j.after=function(a,b){return 0>=a?b():function(){if(1>--a)return b.apply(this,arguments)}};j.keys=V||function(a){if(a!==Object(a))throw new TypeError("Invalid object");var b=[],c;for(c in a)j.has(a,c)&&(b[b.length]=c);return b};j.values=function(a){return j.map(a,j.identity)};j.functions=j.methods=function(a){var b=[],c;for(c in a)j.isFunction(a[c])&&b.push(c);return b.sort()};j.extend=function(a){C(q.call(arguments,1),function(b){for(var c in b)a[c]=
b[c]});return a};j.pick=function(a){var b={};C(j.flatten(q.call(arguments,1)),function(c){c in a&&(b[c]=a[c])});return b};j.defaults=function(a){C(q.call(arguments,1),function(b){for(var c in b)null==a[c]&&(a[c]=b[c])});return a};j.clone=function(a){return!j.isObject(a)?a:j.isArray(a)?a.slice():j.extend({},a)};j.tap=function(a,b){b(a);return a};j.isEqual=function(b,c){return a(b,c,[])};j.isEmpty=function(a){if(null==a)return!0;if(j.isArray(a)||j.isString(a))return 0===a.length;for(var b in a)if(j.has(a,
...
p.call(a)};j.isFinite=function(a){return j.isNumber(a)&&isFinite(a)};j.isNaN=function(a){return a!==a};j.isBoolean=function(a){return!0===a||!1===a||"[object Boolean]"==p.call(a)};j.isDate=function(a){return"[object Date]"==p.call(a)};j.isRegExp=function(a){return"[object RegExp]"==p.call(a)};j.isNull=function(a){return null===a};j.isUndefined=function(a){return void 0===a};j.has=function(a,b){return Q.call(a,b)};j.noConflict=function(){b._=c;return this};j.identity=function(a){return a};j.times=
function(a,b,c){for(var d=0;d<a;d++)b.call(c,d)};j.escape=function(a){return(""+a).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#x27;").replace(/\//g,"&#x2F;")};j.result=function(a,b){if(null==a)return null;var c=a[b];return j.isFunction(c)?c.call(a):c};j.mixin=function(a){C(j.functions(a),function(b){var c=j[b]=a[b];ia.prototype[b]=function(){var a=q.call(arguments);m.call(a,this._wrapped);return Y(c.apply(j,a),this._chain)}})};var L=0;j.uniqueId=
function(a){var b=L++;return a?a+b:b};j.templateSettings={evaluate:/<%([\s\S]+?)%>/g,interpolate:/<%=([\s\S]+?)%>/g,escape:/<%-([\s\S]+?)%>/g};var H=/.^/,S={"\\":"\\","'":"'",r:"\r",n:"\n",t:"\t",u2028:"\u2028",u2029:"\u2029"},P;for(P in S)S[S[P]]=P;var fa=/\\|'|\r|\n|\t|\u2028|\u2029/g,ha=/\\(\\|'|r|n|t|u2028|u2029)/g,ja=function(a){return a.replace(ha,function(a,b){return S[b]})};j.template=function(a,b,c){c=j.defaults(c||{},j.templateSettings);a="__p+='"+a.replace(fa,function(a){return"\\"+S[a]}).replace(c.escape||
...
return b};j.chain=function(a){return j(a).chain()};var ia=function(a){this._wrapped=a};j.prototype=ia.prototype;var Y=function(a,b){return b?j(a).chain():a};j.mixin(j);C("pop push reverse shift sort splice unshift".split(" "),function(a){var b=f[a];ia.prototype[a]=function(){var c=this._wrapped;b.apply(c,arguments);var d=c.length;("shift"==a||"splice"==a)&&0===d&&delete c[0];return Y(c,this._chain)}});C(["concat","join","slice"],function(a){var b=f[a];ia.prototype[a]=function(){return Y(b.apply(this._wrapped,
...
/\x3c!--[^\0]*?--\x3e/)("closed",/<(tag)[^\0]+?<\/\1>/)("closing",/<tag(?:"[^"]*"|'[^']*'|[^'">])*?>/)(/tag/g,m())();var B=y,N;N=y.paragraph.source;var X=[];(function C(a){a=y[a]?y[a].source:a;X.push(a.replace(/(^|[^\[])\^/g,"$1"));return C})("hr")("heading")("lheading")("blockquote")("<"+m())("def");N=RegExp(N.replace("body",X.join("|")));B.paragraph=N;y.normal={fences:y.fences,paragraph:y.paragraph};y.gfm={fences:/^ *(```|~~~) *(\w+)? *\n([^\0]+?)\s*\1 *(?:\n+|$)/,paragraph:/^/};y.gfm.paragraph=
p(y.paragraph)("(?!","(?!"+y.gfm.fences.source.replace(/(^|[^\[])\^/g,"$2")+"|")();y.lexer=function(a){var b=[];b.links={};a=a.replace(/\r\n|\r/g,"\n").replace(/\t/g,"    ");return y.token(a,b,!0)};y.token=function(a,b,c){a=a.replace(/^ +$/gm,"");for(var d,f,m,p,n,s;a;){if(m=y.newline.exec(a))a=a.substring(m[0].length),1<m[0].length&&b.push({type:"space"});if(m=y.code.exec(a))a=a.substring(m[0].length),m=m[0].replace(/^ {4}/gm,""),b.push({type:"code",text:!V.pedantic?m.replace(/\n+$/,""):m});else if(m=
...
b,c),b.push({type:"blockquote_end"});else if(m=y.list.exec(a)){a=a.substring(m[0].length);b.push({type:"list_start",ordered:isFinite(m[2])});m=m[0].match(y.item);d=!1;s=m.length;for(n=0;n<s;n++)p=m[n],f=p.length,p=p.replace(/^ *([*+-]|\d+\.) +/,""),~p.indexOf("\n ")&&(f-=p.length,p=!V.pedantic?p.replace(RegExp("^ {1,"+f+"}","gm"),""):p.replace(/^ {1,4}/gm,"")),f=d||/\n\n(?!\s*$)/.test(p),n!==s-1&&(d="\n"===p[p.length-1],f||(f=d)),b.push({type:f?"loose_item_start":"list_item_start"}),y.token(p,b),
...
autolink:/^<([^ >]+(@|:\/)[^ >]+)>/,url:Q,tag:/^\x3c!--[^\0]*?--\x3e|^<\/?\w+(?:"[^"]*"|'[^']*'|[^'">])*?>/,link:/^!?\[(inside)\]\(href\)/,reflink:/^!?\[(inside)\]\s*\[([^\]]*)\]/,nolink:/^!?\[((?:\[[^\]]*\]|[^\[\]])*)\]/,strong:/^__([^\0]+?)__(?!_)|^\*\*([^\0]+?)\*\*(?!\*)/,em:/^\b_((?:__|[^\0])+?)_\b|^\*((?:\*\*|[^\0])+?)\*(?!\*)/,code:/^(`+)([^\0]*?[^`])\1(?!`)/,br:/^ {2,}\n(?!\s*$)/,text:/^[^\0]+?(?=[\\<!\[_*`]| {2,}\n|$)/,_linkInside:/(?:\[[^\]]*\]|[^\]]|\](?=[^\[]*\]))*/,_linkHref:/\s*<?([^\s]*?)>?(?:\s+['"]([^\0]*?)['"])?\s*/};
s.link=p(s.link)("inside",s._linkInside)("href",s._linkHref)();s.reflink=p(s.reflink)("inside",s._linkInside)();s.normal={url:s.url,strong:s.strong,em:s.em,text:s.text};s.pedantic={strong:/^__(?=\S)([^\0]*?\S)__(?!_)|^\*\*(?=\S)([^\0]*?\S)\*\*(?!\*)/,em:/^_(?=\S)([^\0]*?\S)_(?!_)|^\*(?=\S)([^\0]*?\S)\*(?!\*)/};s.gfm={url:/^(https?:\/\/[^\s]+[^.,:;"')\]\s])/,text:/^[^\0]+?(?=[\\<!\[_*`]|https?:\/\/| {2,}\n|$)/};s.lexer=function(b){for(var c="",d=U.links,f,m;b;)if(m=s.escape.exec(b))b=b.substring(m[0].length),
c+=m[1];else if(m=s.autolink.exec(b))b=b.substring(m[0].length),"@"===m[2]?(f=":"===m[1][6]?q(m[1].substring(7)):q(m[1]),m=q("mailto:")+f):m=f=n(m[1]),c+='<a href="'+m+'">'+f+"</a>";else if(m=s.url.exec(b))b=b.substring(m[0].length),m=f=n(m[1]),c+='<a href="'+m+'">'+f+"</a>";else if(m=s.tag.exec(b))b=b.substring(m[0].length),c+=V.sanitize?n(m[0]):m[0];else if(m=s.link.exec(b))b=b.substring(m[0].length),c+=a(m,{href:m[2],title:m[3]});else if((m=s.reflink.exec(b))||(m=s.nolink.exec(b)))b=b.substring(m[0].length),
f=(m[2]||m[1]).replace(/\s+/g," "),f=d[f.toLowerCase()],!f||!f.href?(c+=m[0][0],b=m[0].substring(1)+b):c+=a(m,f);else if(m=s.strong.exec(b))b=b.substring(m[0].length),c+="<strong>"+s.lexer(m[2]||m[1])+"</strong>";else if(m=s.em.exec(b))b=b.substring(m[0].length),c+="<em>"+s.lexer(m[2]||m[1])+"</em>";else if(m=s.code.exec(b))b=b.substring(m[0].length),c+="<code>"+n(m[2],!0)+"</code>";else if(m=s.br.exec(b))b=b.substring(m[0].length),c+="<br>";else if(m=s.text.exec(b))b=b.substring(m[0].length),c+=
n(m[0]);return c};var U,K;Q.exec=Q;var V,I;T.options=T.setOptions=function(a){I=a;W(a);return T};T.setOptions({gfm:!0,pedantic:!1,sanitize:!1,highlight:null});T.parser=function(a,b){W(b);return f(a)};T.lexer=function(a,b){W(b);return y.lexer(a)};T.parse=T;"undefined"!==typeof module?module.exports=T:this.marked=T}).call(function(){return this||("undefined"!==typeof window?window:global)}());
function natural_sort(a,b){var c=/(^-?[0-9]+(\.?[0-9]*)[df]?e?[0-9]?$|^0x[0-9a-f]+$|[0-9]+)/gi,d=/(^[ ]*|[ ]*$)/g,f=/(^([\w ]+,?[\w ]+)?[\w ]+,?[\w ]+\d+:\d+(:\d+)?[\w ]?|^\d{1,4}[\/\-]\d{1,4}[\/\-]\d{1,4}|^\w+, \w+ \d+, \d{4})/,n=/^0x[0-9a-f]+$/i,q=/^0/,m=(natural_sort.insensitive&&(""+a).toLowerCase()||""+a).replace(d,"")||"",p=(natural_sort.insensitive&&(""+b).toLowerCase()||""+b).replace(d,"")||"",d=m.replace(c,"\x00$1\x00").replace(/\0$/,"").replace(/^\0/,"").split("\x00"),c=p.replace(c,"\x00$1\x00").replace(/\0$/,
"").replace(/^\0/,"").split("\x00"),m=parseInt(m.match(n))||1!=d.length&&m.match(f)&&Date.parse(m);if(f=parseInt(p.match(n))||m&&p.match(f)&&Date.parse(p)||null){if(m<f)return-1;if(m>f)return 1}m=0;for(p=Math.max(d.length,c.length);m<p;m++){f=!(d[m]||"").match(q)&&parseFloat(d[m])||d[m]||0;n=!(c[m]||"").match(q)&&parseFloat(c[m])||c[m]||0;if(isNaN(f)!==isNaN(n))return isNaN(f)?1:-1;typeof f!==typeof n&&(f+="",n+="");if(f<n)return-1;if(f>n)return 1}return 0}
...
c)return a.remove(b);d.setItem(b,a.serialize(c))},a.get=function(b){return a.deserialize(d.getItem(b))},a.remove=function(a){d.removeItem(a)},a.clear=function(){d.clear()},a.getAll=function(){for(var b={},c=0;c<d.length;++c){var f=d.key(c);b[f]=a.get(f)}return b};else{var q;try{q="globalStorage"in b&&b.globalStorage&&b.globalStorage[b.location.hostname]}catch(m){q=!1}if(q)d=b.globalStorage[b.location.hostname],a.set=function(b,c){if(void 0===c)return a.remove(b);d[b]=a.serialize(c)},a.get=function(b){return a.deserialize(d[b]&&
d[b].value)},a.remove=function(a){delete d[a]},a.clear=function(){for(var a in d)delete d[a]},a.getAll=function(){for(var b={},c=0;c<d.length;++c){var f=d.key(c);b[f]=a.get(f)}return b};else if(c.documentElement.addBehavior){var p,Q;try{Q=new ActiveXObject("htmlfile"),Q.open(),Q.write('<script>document.w=window\x3c/script><iframe src="/favicon.ico"></frame>'),Q.close(),p=Q.w.frames[0].document,d=p.createElement("div")}catch(T){d=c.createElement("div"),p=c.body}var b=function(b){return function(){var c=
Array.prototype.slice.call(arguments,0);c.unshift(d);p.appendChild(d);d.addBehavior("#default#userData");d.load("localStorage");c=b.apply(a,c);p.removeChild(d);return c}},W=/[!"#$%&'()*+,/\\:;<=>?@[\]^`{|}~]/g;a.set=b(function(b,c,d){c=c.replace(W,"___");if(void 0===d)return a.remove(c);b.setAttribute(c,a.serialize(d));b.save("localStorage")});a.get=b(function(b,c){c=c.replace(W,"___");return a.deserialize(b.getAttribute(c))});a.remove=b(function(a,b){b=b.replace(W,"___");a.removeAttribute(b);a.save("localStorage")});
...
d);if(k["force new connection"]||!b.sockets[f])j=new b.Socket(k);!k["force new connection"]&&j&&(b.sockets[f]=j);j=j||b.sockets[f];return j.of(1<e.path.length?e.path:"")};var c=this,d=("undefined"!=typeof io?io:module.exports).util={},f=/^(?:(?![^:@]+:[^:@\/]*@)([^:\/?#.]+):)?(?:\/\/)?((?:(([^:@]*)(?::([^:@]*))?)?@)?([^:\/?#]*)(?::(\d*))?)(((\/(?:[^?#](?![^?#\/]*\.[^?#\/.]+(?:[?#]|$)))*\/?)?([^?#\/]*))(?:\?([^#]*))?(?:#(.*))?)/,n="source protocol authority userInfo user password host port relative path directory file query anchor".split(" ");
...
y=("undefined"!=typeof io?io:module.exports).parser={},B=y.packets="disconnect connect heartbeat message json event ack error noop".split(" "),N=y.reasons=["transport not supported","client not handshaken","unauthorized"],X=y.advice=["reconnect"],s=m.JSON,U=m.util.indexOf;y.encodePacket=function(a){var b=U(B,a.type),c=a.id||"",d=a.endpoint||"",e=a.ack,f=null;switch(a.type){case "error":var j=a.reason?U(N,a.reason):"";a=a.advice?U(X,a.advice):"";if(""!==j||""!==a)f=j+(""!==a?"+"+a:"");break;case "message":""!==
...
a;this.name=b};("undefined"!=typeof io?io:module.exports).SocketNamespace=m;R.util.mixin(m,R.EventEmitter);m.prototype.$emit=R.EventEmitter.prototype.emit;m.prototype.of=function(){return this.socket.of.apply(this.socket,arguments)};m.prototype.packet=function(a){a.endpoint=this.name;this.socket.packet(a);this.flags={};return this};m.prototype.send=function(a,b){var c={type:this.flags.json?"json":"message",data:a};"function"==typeof b&&(c.id=++this.ackPackets,c.ack=!0,this.acks[c.id]=b);return this.packet(c)};
m.prototype.emit=function(a){var b=Array.prototype.slice.call(arguments,1),c=b[b.length-1],d={type:"event",name:a};"function"==typeof c&&(d.id=++this.ackPackets,d.ack="data",this.acks[d.id]=c,b=b.slice(0,b.length-1));d.args=b;return this.packet(d)};m.prototype.disconnect=function(){""===this.name?this.socket.disconnect():(this.packet({type:"disconnect"}),this.$emit("disconnect"));return this};m.prototype.onPacket=function(a){function b(){c.packet({type:"ack",args:R.util.toArray(arguments),ackId:a.id})}
...
function(){return"WebSocket"in H&&!("__addTask"in WebSocket)||"MozWebSocket"in H};m.xdomainCheck=function(){return!0};L.transports.push("websocket");var S="undefined"!=typeof io?io:module.parent.exports,P=function(){S.Transport.websocket.apply(this,arguments)};("undefined"!=typeof io?io.Transport:module.exports).flashsocket=P;S.util.inherit(P,S.Transport.websocket);P.prototype.name="flashsocket";P.prototype.open=function(){var a=this,b=arguments;WebSocket.__addTask(function(){S.Transport.websocket.prototype.open.apply(a,
b)});return this};P.prototype.send=function(){var a=this,b=arguments;WebSocket.__addTask(function(){S.Transport.websocket.prototype.send.apply(a,b)});return this};P.prototype.close=function(){WebSocket.__tasks.length=0;S.Transport.websocket.prototype.close.call(this);return this};P.prototype.ready=function(a,b){function c(){var e=a.options,f=e["flash policy port"],j=["http"+(e.secure?"s":"")+":/",e.host+":"+e.port,e.resource,"static/flashsocket","WebSocketMain"+(a.isXDomain()?"Insecure":"")+".swf"];
P.loaded||("undefined"===typeof WEB_SOCKET_SWF_LOCATION&&(WEB_SOCKET_SWF_LOCATION=j.join("/")),843!==f&&WebSocket.loadFlashPolicyFile("xmlsocket://"+e.host+":"+f),WebSocket.__initialize(),P.loaded=!0);b.call(d)}var d=this;if(document.body)return c();S.util.load(c)};P.check=function(){return"undefined"==typeof WebSocket||!("__initialize"in WebSocket)||!fa?!1:10<=fa.getFlashPlayerVersion().major};P.xdomainCheck=function(){return!0};"undefined"!=typeof window&&(WEB_SOCKET_DISABLE_AUTO_INITIALIZATION=
!0);S.transports.push("flashsocket");if("undefined"!=typeof window){var fa,ha=function(){if(!Ua){try{var a=G.getElementsByTagName("body")[0].appendChild(G.createElement("span"));a.parentNode.removeChild(a)}catch(b){return}Ua=!0;for(var a=e.length,c=0;c<a;c++)e[c]()}},ja=function(a){Ua?a():e[e.length]=a},m=function(a){if(typeof O.addEventListener!=da)O.addEventListener("load",a,!1);else if(typeof G.addEventListener!=da)G.addEventListener("load",a,!1);else if(typeof O.attachEvent!=da){var b=O;b.attachEvent("onload",
...
["Active"].concat("").join("X"):"PlugIn";d="MMredirectURL="+O.location.toString().replace(/&/g,"%26")+"&MMplayerType="+d+"&MMdoctitle="+G.title;b.flashvars=typeof b.flashvars!=da?b.flashvars+("&"+d):d;E.ie&&(E.win&&4!=e.readyState)&&(d=G.createElement("div"),c+="SWFObjectNew",d.setAttribute("id",c),e.parentNode.insertBefore(d,e),e.style.display="none",function(){4==e.readyState?e.parentNode.removeChild(e):setTimeout(arguments.callee,10)}());A(a,b,c)}},t=function(a){if(E.ie&&E.win&&4!=a.readyState){var b=
G.createElement("div");a.parentNode.insertBefore(b,a);b.parentNode.replaceChild(v(a),b);a.style.display="none";(function(){4==a.readyState?a.parentNode.removeChild(a):setTimeout(arguments.callee,10)})()}else a.parentNode.replaceChild(v(a),a)},v=function(a){var b=G.createElement("div");if(E.win&&E.ie)b.innerHTML=a.innerHTML;else if(a=a.getElementsByTagName(ta)[0])if(a=a.childNodes)for(var c=a.length,d=0;d<c;d++)!(1==a[d].nodeType&&"PARAM"==a[d].nodeName)&&8!=a[d].nodeType&&b.appendChild(a[d].cloneNode(!0));
return b},A=function(a,b,c){var d,e=ga(c);if(E.wk&&312>E.wk)return d;if(e)if(typeof a.id==da&&(a.id=c),E.ie&&E.win){var f="",j;for(j in a)a[j]!=Object.prototype[j]&&("data"==j.toLowerCase()?b.movie=a[j]:"styleclass"==j.toLowerCase()?f+=' class="'+a[j]+'"':"classid"!=j.toLowerCase()&&(f+=" "+j+'="'+a[j]+'"'));j="";for(var k in b)b[k]!=Object.prototype[k]&&(j+='<param name="'+k+'" value="'+b[k]+'" />');e.outerHTML='<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"'+f+">"+j+"</object>";Ba[Ba.length]=
...
sa=function(a,b){if(Sb){var c=b?"visible":"hidden";Ua&&ga(a)?ga(a).style.visibility=c:ab("#"+a,"visibility:"+c)}},Ca=function(a){return null!=/[\\\"<>\.;]/.exec(a)&&typeof encodeURIComponent!=da?encodeURIComponent(a):a},da="undefined",ta="object",ka="application/x-shockwave-flash",w="SWFObjectExprInst",O=window,G=document;p=navigator;var Ta=!1,e=[function(){if(Ta){var a=G.getElementsByTagName("body")[0],b=G.createElement(ta);b.setAttribute("type",ka);var c=a.appendChild(b);if(c){var d=0;(function(){if(typeof c.GetVariable!=
da){var e=c.GetVariable("$version");e&&(e=e.split(" ")[1].split(","),E.pv=[parseInt(e[0],10),parseInt(e[1],10),parseInt(e[2],10)])}else if(10>d){d++;setTimeout(arguments.callee,10);return}a.removeChild(b);c=null;ia()})()}else ia()}else ia()}],Da=[],Ba=[],bb=[],jb,kb,Ib,Rb,Ua=!1,rb=!1,Ka,Jb,Sb=!0,E,Q=typeof G.getElementById!=da&&typeof G.getElementsByTagName!=da&&typeof G.createElement!=da,Va=p.userAgent.toLowerCase(),Wa=p.platform.toLowerCase(),ec=Wa?/win/.test(Wa):/win/.test(Va),Wa=Wa?/mac/.test(Wa):
...
"$1"),10):0}else if(typeof O[["Active"].concat("Object").join("X")]!=da)try{var M=new (window[["Active"].concat("Object").join("X")])("ShockwaveFlash.ShockwaveFlash");if(M&&(ea=M.GetVariable("$version")))lb=!0,ea=ea.split(" ")[1].split(","),ba=[parseInt(ea[0],10),parseInt(ea[1],10),parseInt(ea[2],10)]}catch(na){}E={w3:Q,pv:ba,wk:Va,ie:lb,win:ec,mac:Wa};E.w3&&((typeof G.readyState!=da&&"complete"==G.readyState||typeof G.readyState==da&&(G.getElementsByTagName("body")[0]||G.body))&&ha(),Ua||(typeof G.addEventListener!=
da&&G.addEventListener("DOMContentLoaded",ha,!1),E.ie&&E.win&&(G.attachEvent("onreadystatechange",function(){"complete"==G.readyState&&(G.detachEvent("onreadystatechange",arguments.callee),ha())}),O==top&&function(){if(!Ua){try{G.documentElement.doScroll("left")}catch(a){setTimeout(arguments.callee,0);return}ha()}}()),E.wk&&function(){Ua||(/loaded|complete/.test(G.readyState)?ha():setTimeout(arguments.callee,0))}(),m(ha)));E.ie&&E.win&&window.attachEvent("onunload",function(){for(var a=bb.length,
...
"";d+="";var s={};if(w&&typeof w===ta)for(var q in w)s[q]=w[q];s.data=a;s.width=c;s.height=d;q={};if(m&&typeof m===ta)for(var O in m)q[O]=m[O];if(j&&typeof j===ta)for(var t in j)q.flashvars=typeof q.flashvars!=da?q.flashvars+("&"+t+"="+j[t]):t+"="+j[t];if($a(e))O=A(s,q,b),s.id==b&&sa(b,!0),n.success=!0,n.ref=O;else{if(f&&k()){s.data=f;D(s,q,b,p);return}sa(b,!0)}p&&p(n)})):p&&p(n)},switchOffAutoHideShow:function(){Sb=!1},ua:E,getFlashPlayerVersion:function(){return{major:E.pv[0],minor:E.pv[1],release:E.pv[2]}},
hasFlashPlayerVersion:$a,createSWF:function(a,b,c){if(E.w3)return A(a,b,c)},showExpressInstall:function(a,b,c,d){E.w3&&k()&&D(a,b,c,d)},removeSWF:function(a){E.w3&&F(a)},createCSS:function(a,b,c,d){E.w3&&ab(a,b,c,d)},addDomLoadEvent:ja,addLoadEvent:m,getQueryParamValue:function(a){var b=G.location.search||G.location.hash;if(b){/\?/.test(b)&&(b=b.split("?")[1]);if(null==a)return Ca(b);for(var b=b.split("&"),c=0;c<b.length;c++)if(b[c].substring(0,b[c].indexOf("="))==a)return Ca(b[c].substring(b[c].indexOf("=")+
...
M.prototype.post=function(a){function b(){c();d.socket.setBuffer(!1)}function c(){d.iframe&&d.form.removeChild(d.iframe);try{m=document.createElement('<iframe name="'+d.iframeId+'">')}catch(a){m=document.createElement("iframe"),m.name=d.iframeId}m.id=d.iframeId;d.form.appendChild(m);d.iframe=m}var d=this,e=wa.util.query(this.socket.options.query,"t="+ +new Date+"&i="+this.index);if(!this.form){var f=document.createElement("form"),j=document.createElement("textarea"),k=this.iframeId="socketio_iframe_"+
this.index,m;f.className="socketio";f.style.position="absolute";f.style.top="0px";f.style.left="0px";f.style.display="none";f.target=k;f.method="POST";f.setAttribute("accept-charset","utf-8");j.name="d";f.appendChild(j);document.body.appendChild(f);this.form=f;this.area=j}this.form.action=this.prepareUrl()+e;c();this.area.value=wa.JSON.stringify(a);try{this.form.submit()}catch(w){}this.iframe.attachEvent?m.onreadystatechange=function(){"complete"==d.iframe.readyState&&b()}:this.iframe.onload=b;this.socket.setBuffer(!0)};
...
(function(a){function b(a,b,c,d){var e=c.lang();return e[a].call?e[a](c,d):e[a][b]}function c(a,b){return function(c){return m(a.call(this,c),b)}}function d(a){return function(b){b=a.call(this,b);return b+this.lang().ordinal(b)}}function f(a,b,c){this._d=a;this._isUTC=!!b;this._a=a._a||null;this._lang=c||!1}function n(a){var b=this._data={},c=a.years||a.y||0,d=a.months||a.M||0,e=a.weeks||a.w||0,f=a.days||a.d||0,j=a.hours||a.h||0,k=a.minutes||a.m||0,m=a.seconds||a.s||0;a=a.milliseconds||a.ms||0;this._milliseconds=
a+1E3*m+6E4*k+36E5*j;this._days=f+7*e;this._months=d+12*c;b.milliseconds=a%1E3;m+=q(a/1E3);b.seconds=m%60;k+=q(m/60);b.minutes=k%60;j+=q(k/60);b.hours=j%24;f+=q(j/24);f+=7*e;b.days=f%30;d+=q(f/30);b.months=d%12;c+=q(d/12);b.years=c;this._lang=!1}function q(a){return 0>a?Math.ceil(a):Math.floor(a)}function m(a,b){for(var c=a+"";c.length<b;)c="0"+c;return c}function p(a,b,c){var d=b._milliseconds,e=b._days;b=b._months;var f;d&&a._d.setTime(+a+d*c);e&&a.date(a.date()+e*c);b&&(f=a.date(),a.date(1).month(a.month()+
b*c).date(Math.min(f,a.daysInMonth())))}function Q(a){return"[object Array]"===Object.prototype.toString.call(a)}function T(a,b){var c=Math.min(a.length,b.length),d=Math.abs(a.length-b.length),e=0,f;for(f=0;f<c;f++)~~a[f]!==~~b[f]&&e++;return e+d}function W(a,b,c,d){var e,f,j=[];for(e=0;7>e;e++)j[e]=a[e]=null==a[e]?2===e?1:0:a[e];return a[7]=j[7]=b,null!=a[8]&&(j[8]=a[8]),a[3]+=c||0,a[4]+=d||0,f=new Date(0),b?(f.setUTCFullYear(a[0],a[1],a[2]),f.setUTCHours(a[3],a[4],a[5],a[6])):(f.setFullYear(a[0],
a[1],a[2]),f.setHours(a[3],a[4],a[5],a[6])),f._a=j,f}function y(a,b){var c,d,e=[];!b&&H&&(b=require("./lang/"+a));for(c=0;c<S.length;c++)b[S[c]]=b[S[c]]||ca.en[S[c]];for(c=0;12>c;c++)d=j([2E3,c]),e[c]=RegExp("^"+(b.months[c]||b.months(d,""))+"|^"+(b.monthsShort[c]||b.monthsShort(d,"")).replace(".",""),"i");return b.monthsParse=b.monthsParse||e,ca[a]=b,b}function B(a){return(a="string"==typeof a&&a||a&&a._lang||null)?ca[a]||y(a):j}function N(a,b){function c(b){return a.lang().longDateFormat[b]||b}
for(var d=5;d--&&ha.test(b);)b=b.replace(ha,c);if(!Ca[b]){var d=Ca,e=b,f=b,j=f.match(fa),k,m;k=0;for(m=j.length;k<m;k++)ka[j[k]]?j[k]=ka[j[k]]:j[k]=j[k].match(/\[.*\]/)?j[k].replace(/^\[|\]$/g,""):j[k].replace(/\\/g,"");d[e]=function(a){var b="";for(k=0;k<m;k++)b+="function"==typeof j[k].call?j[k].call(a,f):j[k];return b}}return Ca[b](a)}function X(a){switch(a){case "DDDD":return k;case "YYYY":return D;case "S":case "SS":case "SSS":case "DDD":return Y;case "MMM":case "MMMM":case "dd":case "ddd":case "dddd":case "a":case "A":return t;
case "Z":case "ZZ":return v;case "T":return A;case "MM":case "DD":case "YY":case "HH":case "hh":case "mm":case "ss":case "M":case "D":case "d":case "H":case "h":case "m":case "s":return ia;default:return RegExp(a.replace("\\",""))}}function s(a,b){var c=[0,0,1,0,0,0,0],d={tzh:0,tzm:0},e=b.match(fa),f,j;for(f=0;f<e.length;f++)if((j=(X(e[f]).exec(a)||[])[0])&&(a=a.slice(a.indexOf(j)+j.length)),ka[e[f]]){var k=c,m=d,p=void 0,n=void 0;switch(e[f]){case "M":case "MM":k[1]=null==j?0:~~j-1;break;case "MMM":case "MMMM":for(p=
0;12>p;p++)if(B().monthsParse[p].test(j)){k[1]=p;n=!0;break}n||(k[8]=!1);break;case "D":case "DD":case "DDD":case "DDDD":null!=j&&(k[2]=~~j);break;case "YY":k[0]=~~j+(70<~~j?1900:2E3);break;case "YYYY":k[0]=~~Math.abs(j);break;case "a":case "A":m.isPm="pm"===(j+"").toLowerCase();break;case "H":case "HH":case "h":case "hh":k[3]=~~j;break;case "m":case "mm":k[4]=~~j;break;case "s":case "ss":k[5]=~~j;break;case "S":case "SS":case "SSS":k[6]=~~(1E3*("0."+j));break;case "Z":case "ZZ":m.isUTC=!0,(p=(j+
"").match($a))&&p[1]&&(m.tzh=~~p[1]),p&&p[2]&&(m.tzm=~~p[2]),p&&"+"===p[0]&&(m.tzh=-m.tzh,m.tzm=-m.tzm)}null==j&&(k[8]=!1)}return d.isPm&&12>c[3]&&(c[3]+=12),!1===d.isPm&&12===c[3]&&(c[3]=0),W(c,d.isUTC,d.tzh,d.tzm)}function U(a,b,c,d,e){e=e.relativeTime[a];return"function"==typeof e?e(b||1,!!c,a,d):e.replace(/%d/i,b||1)}function K(a,b){j.fn[a]=function(a){var c=this._isUTC?"UTC":"";return null!=a?(this._d["set"+c+b](a),this):this._d["get"+c+b]()}}function V(a){j.duration.fn[a]=function(){return this._data[a]}}
function I(a,b){j.duration.fn["as"+a]=function(){return+this/b}}for(var j,C=Math.round,R,ca={},L="en",H="undefined"!=typeof module&&module.exports,S="months monthsShort weekdays weekdaysShort weekdaysMin longDateFormat calendar relativeTime ordinal meridiem".split(" "),P=/^\/?Date\((\-?\d+)/i,fa=/(\[[^\[]*\])|(\\)?(Mo|MM?M?M?|Do|DDDo|DD?D?D?|ddd?d?|do?|w[o|w]?|YYYY|YY|a|A|hh?|HH?|mm?|ss?|SS?S?|zz?|ZZ?|.)/g,ha=/(\[[^\[]*\])|(\\)?(LT|LL?L?L?)/g,ja=/([0-9a-zA-Z\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]+)/gi,
ia=/\d\d?/,Y=/\d{1,3}/,k=/\d{3}/,D=/\d{1,4}/,t=/[0-9a-z\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]+/i,v=/Z|[\+\-]\d\d:?\d\d/i,A=/T/i,F=/^\s*\d{4}-\d\d-\d\d(T(\d\d(:\d\d(:\d\d(\.\d\d?\d?)?)?)?)?([\+\-]\d\d:?\d\d)?)?/,ga=[["HH:mm:ss.S",/T\d\d:\d\d:\d\d\.\d{1,3}/],["HH:mm:ss",/T\d\d:\d\d:\d\d/],["HH:mm",/T\d\d:\d\d/],["HH",/T\d\d/]],$a=/([\+\-]|\d\d)/gi,ab="Month Date Hours Minutes Seconds Milliseconds".split(" "),sa={Milliseconds:1,Seconds:1E3,Minutes:6E4,Hours:36E5,Days:864E5,Months:2592E6,Years:31536E6},
...
12||12},m:function(){return this.minutes()},s:function(){return this.seconds()},S:function(){return~~(this.milliseconds()/100)},SS:function(){return m(~~(this.milliseconds()/10),2)},SSS:function(){return m(this.milliseconds(),3)},Z:function(){var a=-this.zone();return 0>a&&(a=-a),"+"+m(~~(a/60),2)+":"+m(~~a%60,2)},ZZ:function(){var a=-this.zone();return 0>a&&(a=-a),"+"+m(~~(10*a/6),4)}};da.length;)R=da.pop(),ka[R+"o"]=d(ka[R]);for(;ta.length;)R=ta.pop(),ka[R+R]=c(ka[R],2);ka.DDDD=c(ka.DDD,3);j=function(b,
c){if(null===b||""===b)return null;var d;if(j.isMoment(b))d=new f(new Date(+b._d),b._isUTC,b._lang);else{if(c)if(Q(c)){var k=b.match(ja)||[],e,m=99,p,n;for(p=0;p<c.length;p++)n=s(b,c[p]),e=N(new f(n),c[p]).match(ja)||[],e=T(k,e),e<m&&(m=e,d=n)}else d=s(b,c);else if(d=P.exec(b),b===a)d=new Date;else if(d)d=new Date(+d[1]);else if(b instanceof Date)d=b;else if(Q(b))d=W(b);else if("string"==typeof b)if(d="YYYY-MM-DDT",F.exec(b)){for(k=0;4>k;k++)if(ga[k][1].exec(b)){d+=ga[k][0];break}d=v.exec(b)?s(b,
d+" Z"):s(b,d)}else d=new Date(b);else d=new Date(b);d=new f(d)}return d};j.utc=function(a,b){return Q(a)?new f(W(a,!0),!0):("string"==typeof a&&!v.exec(a)&&(a+=" +0000",b&&(b+=" Z")),j(a,b).utc())};j.unix=function(a){return j(1E3*a)};j.duration=function(a,b){var c=j.isDuration(a),d="number"==typeof a,e=c?a._data:d?{}:a,f;return d&&(b?e[b]=a:e.milliseconds=a),f=new n(e),c&&(f._lang=a._lang),f};j.humanizeDuration=function(a,b,c){return j.duration(a,!0===b?null:b).humanize(!0===b?!0:c)};j.version="1.7.2";
j.defaultFormat="YYYY-MM-DDTHH:mm:ssZ";j.lang=function(a,b){var c;if(!a)return L;(b||!ca[a])&&y(a,b);if(ca[a]){for(c=0;c<S.length;c++)j[S[c]]=ca[a][S[c]];j.monthsParse=ca[a].monthsParse;L=a}};j.langData=B;j.isMoment=function(a){return a instanceof f};j.isDuration=function(a){return a instanceof n};j.lang("en",{months:"January February March April May June July August September October November December".split(" "),monthsShort:"Jan Feb Mar Apr May Jun Jul Aug Sep Oct Nov Dec".split(" "),weekdays:"Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" "),
...
this.minutes(),this.seconds(),this.milliseconds(),!!this._isUTC]},isValid:function(){return this._a?null!=this._a[8]?!!this._a[8]:!T(this._a,(this._a[7]?j.utc(this._a):j(this._a)).toArray()):!isNaN(this._d.getTime())},utc:function(){return this._isUTC=!0,this},local:function(){return this._isUTC=!1,this},format:function(a){return N(this,a?a:j.defaultFormat)},add:function(a,b){var c=b?j.duration(+b,a):j.duration(a);return p(this,c,1),this},subtract:function(a,b){var c=b?j.duration(+b,a):j.duration(a);
return p(this,c,-1),this},diff:function(a,b,c){a=this._isUTC?j(a).utc():j(a).local();var d=6E4*(this.zone()-a.zone()),d=this._d-a._d-d,e=this.year()-a.year(),f=this.month()-a.month();a=this.date()-a.date();var k;return"months"===b?k=12*e+f+a/30:"years"===b?k=e+(f+a/30)/12:k="seconds"===b?d/1E3:"minutes"===b?d/6E4:"hours"===b?d/36E5:"days"===b?d/864E5:"weeks"===b?d/6048E5:d,c?k:C(k)},from:function(a,b){return j.duration(this.diff(a)).lang(this._lang).humanize(!b)},fromNow:function(a){return this.from(j(),
...
daysInMonth:function(){return j.utc([this.year(),this.month()+1,0]).date()},lang:function(b){return b===a?B(this):(this._lang=b,this)}};for(R=0;R<ab.length;R++)K(ab[R].toLowerCase(),ab[R]);K("year","FullYear");j.duration.fn=n.prototype={weeks:function(){return q(this.days()/7)},valueOf:function(){return this._milliseconds+864E5*this._days+2592E6*this._months},humanize:function(a){var b=+this,c=this.lang().relativeTime,d;d=!a;var e=this.lang(),f=C(Math.abs(b)/1E3),j=C(f/60),k=C(j/60),m=C(k/24),p=C(m/
365),f=45>f&&["s",f]||1===j&&["m"]||45>j&&["mm",j]||1===k&&["h"]||22>k&&["hh",k]||1===m&&["d"]||25>=m&&["dd",m]||45>=m&&["M"]||345>m&&["MM",C(m/30)]||1===p&&["y"]||["yy",p];d=(f[2]=d,f[3]=0<b,f[4]=e,U.apply({},f));b=0>=b?c.past:c.future;return a&&("function"==typeof b?d=b(d):d=b.replace(/%s/i,d)),d},lang:j.fn.lang};for(R in sa)sa.hasOwnProperty(R)&&(I(R,sa[R]),V(R.toLowerCase()));I("Weeks",6048E5);H&&(module.exports=j);"undefined"==typeof ender&&(this.moment=j);"function"==typeof define&&define.amd&&
...
338241895,666307205,773529912,1294757372,1396182291,1695183700,1986661051,2177026350,2456956037,2730485921,2820302411,3259730800,3345764771,3516065817,3600352804,4094571909,275423344,430227734,506948616,659060556,883997877,958139571,1322822218,1537002063,1747873779,1955562222,2024104815,2227730452,2361852424,2428436474,2756734187,3204031479,3329325298],m=[1779033703,3144134277,1013904242,2773480762,1359893119,2600822924,528734635,1541459225],n=Array(64),q,N,X,s,U,K,V,I,j,C,R,ca;a[b>>5]|=128<<24-b%
32;a[(b+64>>9<<4)+15]=b;for(j=0;j<a.length;j+=16){q=m[0];N=m[1];X=m[2];s=m[3];U=m[4];K=m[5];V=m[6];I=m[7];for(C=0;64>C;C++)n[C]=16>C?a[C+j]:c(c(c(d(n[C-2],17)^d(n[C-2],19)^n[C-2]>>>10,n[C-7]),d(n[C-15],7)^d(n[C-15],18)^n[C-15]>>>3),n[C-16]),R=c(c(c(c(I,d(U,6)^d(U,11)^d(U,25)),U&K^~U&V),f[C]),n[C]),ca=c(d(q,2)^d(q,13)^d(q,22),q&N^q&X^N&X),I=V,V=K,K=U,U=c(s,R),s=X,X=N,N=q,q=c(R,ca);m[0]=c(q,m[0]);m[1]=c(N,m[1]);m[2]=c(X,m[2]);m[3]=c(s,m[3]);m[4]=c(U,m[4]);m[5]=c(K,m[5]);m[6]=c(V,m[6]);m[7]=c(I,m[7])}return m},
n=function(a){for(var c=[],d=(1<<b)-1,f=0;f<a.length*b;f+=b)c[f>>5]|=(a.charCodeAt(f/b)&d)<<24-f%32;return c},q=function(a){for(var b="",c=0;c<4*a.length;c++)b+="0123456789abcdef".charAt(a[c>>2]>>8*(3-c%4)+4&15)+"0123456789abcdef".charAt(a[c>>2]>>8*(3-c%4)&15);return b},m=function(b){return b="object"==typeof b?a(b).val():b.toString()};a.extend({sha256:function(a){a=m(a);return q(f(n(a),a.length*b))},sha256hmac:function(a,c){a=m(a);c=m(c);var d,W=a;d=c;var y=n(W);16<y.length&&(y=f(y,W.length*b));
for(var B=Array(16),W=Array(16),N=0;16>N;N++)B[N]=y[N]^909522486,W[N]=y[N]^1549556828;d=f(B.concat(n(d)),512+d.length*b);d=f(W.concat(d),768);return q(d)},sha256config:function(a){b=parseInt(a)||8}});a.fn.sha256=function(b){a.sha256config(b);b=m(a(this).val());b=a.sha256(b);a.sha256config(8);return b}})(jQuery);
function Space(a){this.keys=[];this.values={};if("string"===typeof a)return this.loadFromString(a);if(a instanceof Space){this.keys=a.keys;for(var b in this.keys){var c=this.keys[b];this.values[c]=a.values[c]}return this}for(c in a)a.hasOwnProperty(c)&&(b=a[c],"object"===typeof b?this.set(c,new Space(b)):this.set(c,b));return this}Space.strRepeat=function(a,b){for(var c="",d=0;d<b;d++)c+=" ";return c};
Space.union=function(){var a=Space.unionSingle(arguments[0],arguments[1]),b;for(b in arguments)if(1!==b&&(a=Space.unionSingle(a,arguments[b]),!a.keys.length))break;return a};Space.unionSingle=function(a,b){var c=new Space;if(!(b instanceof Space))return c;for(var d in a.keys){var f=a.keys[d],n=a.values[f];n instanceof Space&&(b.values[f]&&b.values[f]instanceof Space)&&c.set(f,Space.unionSingle(n,b.values[f]));n===b.values[f]&&c.set(f,n)}return c};Space.prototype.keys=[];Space.prototype.values={};
...
Space.prototype.diff=function(a){var b=new Space;a instanceof Space||(a=new Space(a));for(var c in this.keys){var d=this.keys[c],f=a.values[d];"undefined"===typeof f?b.set(d,""):typeof this.values[d]!==typeof f?"object"===typeof f?b.set(d,new Space(f)):this.values[d]!=f&&b.set(d,f):"object"!==typeof this.values[d]?this.values[d]!=f&&b.set(d,f):(f=this.values[d].diff(f),f.keys.length&&b.set(d,f))}for(c in a.keys)d=a.keys[c],f=a.values[d],this.values[d]||("object"!==typeof f?b.set(d,f):f instanceof
Space?b.set(d,new Space(f)):b.set(d,new Space(a)));return b};Space.prototype.diffOrder=function(a){a instanceof Space||(a=new Space(a));var b=new Space,c;for(c in a.keys){var d=a.keys[c],f=a.values[d];f instanceof Space&&this.values[d]instanceof Space&&(f=this.values[d].diffOrder(f),f.empty()||b.set(d,f))}if(a.keys.join(" ")===this.keys.join(" "))return b;b.keys=a.keys;for(c in a.keys)d=a.keys[c],b.values.hasOwnProperty(d)||(b.values[d]=new Space);return b};
...
Space.prototype.getBySpace=function(a){var b=new Space,c;for(c in a.keys){var d=a.keys[c],f=this.values[d];"undefined"!==typeof f&&(!(a.values[d]instanceof Space)||!a.values[d].keys.length?b.set(d,f):f instanceof Space&&b.set(d,f.getBySpace(a.values[d])))}return b};Space.prototype.length=function(){return this.keys.length};
...
Space.prototype.next=function(a){a=this.keys.indexOf(a)+1;return this.keys[a]?this.keys[a]:this.keys[0]};Space.prototype.patch=function(a){a instanceof Space||(a=new Space(a));for(var b in a.keys){var c=a.keys[b],d=a.values[c];if("string"===typeof d)if(""===d)this["delete"](c);else this.set(c,d);else if("number"===typeof d)this.set(c,d);else if(d instanceof Space&&!d.keys.length)this["delete"](c);else this.values[c]instanceof Space?this.values[c].patch(d):this.set(c,new Space(d))}return this};
Space.prototype.patchOrder=function(a){a instanceof Space||(a=new Space(a));var b=this.keys.length,c;for(c in a.keys){var d=a.keys[c];if(!this.values.hasOwnProperty(d))break;b--}0===b&&(this.keys=a.keys);for(c in a.keys)d=a.keys[c],b=a.values[d],b instanceof Space&&(b.keys.length&&this.values[d]instanceof Space)&&this.values[d].patchOrder(b);return this};Space.prototype.prev=function(a){a=this.keys.indexOf(a)-1;return 0<=a?this.keys[a]:this.keys[this.keys.length-1]};
Space.prototype.rename=function(a,b){this.values[b]=this.values[a];delete this.values[a];this.keys[this.keys.indexOf(a)]=b;return this};Space.prototype.set=function(a,b,c){if(!a)return null;a=a.toString().split(/ /g);for(var d=this,f;f=a.shift();)void 0===d.values[f]&&("number"===typeof c?d.keys.splice(c,0,f):d.keys.push(f)),a.length?d.values[f]instanceof Space||(d.values[f]=new Space):d.values[f]=b,d=d.values[f];return this};
...
var Thumbs={getDimensions:function(a){var b={},c=!1;$(a).contents().find(".scrap").each(function(){var a,f,n,q;c?(a=$(this).position().left,f=a+$(this).outerWidth(),n=$(this).position().top,q=top+$(this).outerHeight(),a<b.left&&(b.left=a),f>b.right&&(b.right=f),n<b.top&&(b.top=n),q>b.bottom&&(b.bottom=q)):(b.left=$(this).position().left,b.right=b.left+$(this).outerWidth(),b.top=$(this).position().top,b.bottom=b.top+$(this).outerHeight(),c=!0)});b.height=b.bottom-b.top;b.width=b.right-b.left;return b},
...
transform:c,"-moz-transform":c,"transform-origin":"0 0"}),d;if(b.height<f||b.height<b.width)return c=1*c/b.width,c="scale("+c+")",a.css({"-webkit-transform":c,transform:c,"-moz-transform":c,"transform-origin":"0 0"}),d;c=1*f/b.height;c="scale("+c+")";a.css({"-webkit-transform":c,transform:c,"-moz-transform":c,"transform-origin":"0 0"});return d}};function App(a){this.name=a;this._open=!1}App.openApp=null;
...
function(a){a.stopPropagation()});var n=$('<div id="nudgepadEditorSaveButton">Send</div>'),q=$('<div id="nudgepadEditorCancelButton">Close</div>'),m=$('<div id="nudgepadEditorButtonContainer"></div>');f.on("click",function(){q.trigger("click")});q.on("click",function(){n.remove();a.remove();f.remove();m.remove();q.remove();d.remove();c.remove();b.remove()});n.on("click",function(){var d=b.val(),f="nudgepad.console";c.is(":checked")&&(f="nudgepad.exec");$.post(f,{command:d},function(c){a.append(">"+
d.replace(/\n/g,"> \n")+"\n");a.append(c+"\n");a.scrollTop($("pre")[0].scrollHeight+"");b.val("");b.focus()},null,function(c){nudgepad.feedback.record("used console. got error");a.append(">"+d.replace(/\n/g,"> \n")+"\n");a.append("ERROR\n");a.append(c.responseText+"\n");a.scrollTop($("pre")[0].scrollHeight+"");b.val("");b.focus()})});b.on("enterkey",function(){n.click()});$("body").append(f);$("body").append(c);$("body").append(d);$("body").append(a);$("body").append(b);$("body").append(n);$("body").append(q);
...
nudgepad.contentEditor.focus=function(a,b){nudgepad.stage.selection.clear();var c=$(a),d=c.scrap();if(d.isContentEditable())nudgepad.emit("workerSelection",nudgepad.stage.activePage.concat(" ",nudgepad.cookie.email,a,"{box-shadow: 0 0 2px red;cursor: not-allowed;}")),c.attr("contenteditable","true"),c.on("tap slide slidestart hold slideend",nudgepad.contentEditor.killEvent),c.on("blur",nudgepad.contentEditor.blur),c.focus(),MoveCursorToEnd(c[0]),b&&document.execCommand("selectAll",!1,null);else{var f=
"content",n=d.values.tag;if(n&&n.match(/^(list)$/))return nudgepad.stage.selection.clear(),c.selectMe(),nudgepad.stage.selection.editSource(),!1;n&&n.match(/^(textarea|input|password)$/)&&(f="placeholder");nudgepad.textPrompt("Editing content for this block",d.values[f],function(a){d.values[f]=a;nudgepad.stage.commit();c.remove();$("#nudgepadStageBody").append(d.toHtml(null,!0));c.selectMe()})}};nudgepad.contentEditor.killEvent=function(){nudgepad.mouse.down.stopPropagation();return!1};
...
nudgepad.apps.develop.renderExplorer=function(){var a=nudgepad.apps.develop.files;nudgepad.apps.develop.path&&(a=a.get(nudgepad.apps.develop.path));var b;b='<table id="nudgepadExplorer"><tr class="explorerHeader"><td>Filename</td><td></td><td></td><td>Size</td><td>Age</td></tr>';var c=a.keys,d;for(d in c){var f=c[d],n=a.values[f],q="<tr";n.get("timeSinceLastChange")?(q+=' class="explorerFile" value="'+f+'">',q+='<td class="explorerEdit standardCell">'+f+"</td>",q+='<td class="explorerRename standardCell">Rename</td>',
q+='<td class="explorerRemove standardCell">Delete</td>',q+='<td class="standardCell">'+n.get("size")+"KB</td>",q+='<td class="standardCell">'+moment(n.get("mtime")).fromNow()+"</td>"):(q+=' class="explorerFolder" value="'+f+'">',q+='<td class="explorerFolderName standardCell" colspan=5>'+f+"</td>");q+="</tr>";b+=q}nudgepad.apps.develop.explorer=b+"</table>";$(".nudgepad#explorerPath").text(nudgepad.domain+"/"+nudgepad.apps.develop.pathPretty);$(".nudgepad#explorerHolder").html(nudgepad.apps.develop.explorer)};
...
nudgepad.getPageDimensions=function(a){a=new Page(a);a._static=!0;var b=$('<iframe class="deleteMe" style="position: fixed; right: 0px; top: 0px;"></iframe>');b.attr("frameborder",0);b.attr("scrolling","no");b.css("width",1);b.css("height",1);$("#nudgepadTemp").append(b);b.contents().find("body").append(a.toHtml());var c={},d=!1;b.contents().find(".scrap").each(function(){var a,b,q,m;d?(a=$(this).position().left,b=a+$(this).outerWidth(),q=$(this).position().top,m=top+$(this).outerHeight(),a<c.left&&
(c.left=a),b>c.right&&(c.right=b),q<c.top&&(c.top=q),m>c.bottom&&(c.bottom=m)):(c.left=$(this).position().left,c.right=c.left+$(this).outerWidth(),c.top=$(this).position().top,c.bottom=c.top+$(this).outerHeight(),d=!0)});c.height=c.bottom-c.top;c.width=c.right-c.left;$(".deleteMe").remove();return c};nudgepad.apps.git=new App("git");nudgepad.apps.git.commit=function(){var a=prompt("Enter your commit message");nudgepad.apps.git.send("git commit -am '"+a+"'")};nudgepad.apps.git.init=function(){nudgepad.apps.git.send("git init")};
...
"absolute","z-index":"50"});b.parent().append(c);c.on("tap",nudgepad.MoveHandle.tap);c.on("update",nudgepad.MoveHandle.update);c.on("dblclick",function(){a.edit(!0)});c.trigger("update")};nudgepad.MoveHandle.dimensions={};nudgepad.MoveHandle.mousedown=function(){nudgepad.MoveHandle.dimensions=$(this).owner().dimensions();nudgepad.grid.create();nudgepad.MoveHandle.last_x_change=0;nudgepad.MoveHandle.last_y_change=0;nudgepad.MoveHandle.scrollTop=nudgepad.stage.scrollTop();return!0};
...
nudgepad.MoveHandle.slide=function(a,b){var c=$(this).owner();c.scrap();var d=nudgepad.MoveHandle.dimensions,f=nudgepad.stage.scrollTop()-nudgepad.MoveHandle.scrollTop,n={y:0,x:0};b.shiftKey||(n=nudgepad.grid.getDelta([{x:d.left+nudgepad.mouse.xChange,y:d.top+nudgepad.mouse.yChange+f},{x:d.right+nudgepad.mouse.xChange,y:d.bottom+nudgepad.mouse.yChange+f},{x:d.center+nudgepad.mouse.xChange,y:d.middle+nudgepad.mouse.yChange+f}]));var q=nudgepad.mouse.yChange+f+n.y,m=nudgepad.mouse.xChange+n.x;$(".selection").each(function(){$(this).scrap().move(m-
nudgepad.MoveHandle.last_x_change,q-nudgepad.MoveHandle.last_y_change)});d="X "+parseFloat(c.css("left"))+"<br>Y "+parseFloat(c.css("top"));$("#nudgepadDimensions").css({left:10+c.right(),top:-10+c.middle()}).html(d);nudgepad.MoveHandle.last_x_change=m;nudgepad.MoveHandle.last_y_change=q;return!1};nudgepad.MoveHandle.slideend=function(){$(".handle").trigger("update").show();nudgepad.grid.removeSnaplines();$("#nudgepadDimensions").remove();nudgepad.stage.commit()};
...
Scrap.prototype.edit=function(a){this.values.onedit&&nudgepad.apps[this.values.onedit]?nudgepad.apps[this.values.onedit].open():nudgepad.contentEditor.focus(this.selector(),a);return this};Scrap.prototype.isContentEditable=function(){return"nl2br"===this.values.content_format||"markdown"===this.values.content_format||this.values.content&&this.values.content.match(/\{\{.*\}\}/)||this.values.tag&&this.values.tag.match(/^(textarea|input|password|label|button|list|ul|ol)$/)?!1:!0};
...
Scrap.prototype.render=function(a,b){if(this.values.tag&&this.values.tag.match(/title|script|meta|head/))return this;if(this.values.tag&&this.values.tag.match(/style|link/))return this.setElementTag(a),this.setContent(a),$("#nudgepadStageStyles").append(this.div.toHtml()),this;if(this.values.tag&&"body"===this.values.tag)return this.setElementTag(a),this.setContent(a),this.setStyle(a),this.div.addClass("scrap"),this.div.attr("path",this.getPath()),this.div.attr("selector",this.selector()),this.div.tag=
"div",$("#nudgepadStageBody").append(this.div.toHtml()),this;b?$(this.parentSelector()).insertAt(b,this.toHtml(a)):$(this.parentSelector()).append(this.toHtml(a));return this};Scrap.prototype.selector=function(){return"#nudgepadStageBody>#"+this.path.replace(/ /g,">#")};Scrap.prototype.toHtml=function(a){this.setElementTag(a);this.setContent(a);this.setStyle(a);this.div.addClass("scrap");this.div.attr("path",this.getPath());this.div.attr("selector",this.selector());return this.div.toHtml()};
...
d;for(d in c){var f=d,n=c[d],q="horizontal"==f?nudgepad.mouse.move.pageX:nudgepad.mouse.move.pageY+nudgepad.stage.scrollTop(),m="horizontal"==f?"width":"height",f="horizontal"==f?"left":"top",p=q-n;0<=p?b.css(m,p).css(f,n):b.css(f,q).css(m,-p)}a.preventDefault()};nudgepad.on("main",function(){$(document).on("slide",nudgepad.pages.selectBox.update);$(document).on("slideend",nudgepad.pages.selectBox.clear)});nudgepad.stage.selection={};nudgepad.stage.selection.saved=[];
...
nudgepad.stage.selection.distributeVertical=function(){var a=_.sortBy($(".selection"),function(a){return $(a).top()}),b=0,c=0;_.each(a,function(a,d,q){if(0===d)return!0;d=q[d-1];$(a).attr("id");b+=$(a).top()-$(d).bottom();c++});var d=Math.floor(b/c);0>d&&(d=0);_.each(a,function(a,b,c){if(0===b)return!0;b=c[b-1];c=$(a).scrap();c.set("style top",$(b).bottom()+d+"px");$(a).css("top",c.get("style top"))});$(".handle").trigger("update");nudgepad.stage.commit()};
nudgepad.stage.selection.distributeHorizontal=function(){var a=_.sortBy($(".selection"),function(a){return $(a).left()}),b=0,c=0;_.each(a,function(a,d,q){if(0===d)return!0;d=q[d-1];$(a).attr("id");b+=$(a).left()-$(d).right();c++});var d=Math.floor(b/c);0>d&&(d=0);_.each(a,function(a,b,c){if(0===b)return!0;b=c[b-1];c=$(a).scrap();c.set("style left",$(b).right()+d+"px");$(a).css("left",c.get("style left"))});$(".handle").trigger("update");nudgepad.stage.commit();nudgepad.notify("Distributed",1E3)};
...
nudgepad.stage.selection.move=function(a,b){if(!$(".selection").length)return!1;$(".selection").each(function(){$(this).scrap().move(a,b)});var c=$($(".selection")[0]),d="X "+parseFloat(c.css("left"))+"<br>Y "+parseFloat(c.css("top"));c.parent().append($('<div id="nudgepadDimensions" class="nudgepad_popup"></div>'));$("#nudgepadDimensions").css({left:10+c.right(),top:-10+c.middle()}).html(d).show();$(".handle").trigger("update");nudgepad.stage.commit()};
...
Events.shortcut.shortcuts["meta+backspace"]=nudgepad.pages.trash;Events.shortcut.shortcuts["meta+o"]=nudgepad.pages.spotlight;Events.shortcut.shortcuts["ctrl+o"]=nudgepad.pages.spotlight;Events.shortcut.shortcuts["ctrl+n"]=nudgepad.pages.blank;Events.shortcut.shortcuts["meta+n"]=nudgepad.pages.blank;Events.shortcut.shortcuts.esc=nudgepad.stage.selection.clear;Events.shortcut.shortcuts["shift+n"]=nudgepad.pages.duplicate;Events.shortcut.shortcuts.up=function(){nudgepad.stage.selection.move(0,-1)};
Events.shortcut.shortcuts.left=function(){nudgepad.stage.selection.move(-1,0)};Events.shortcut.shortcuts.down=function(){nudgepad.stage.selection.move(0,1)};Events.shortcut.shortcuts.right=function(){nudgepad.stage.selection.move(1,0)};Events.shortcut.shortcuts["shift+t"]=function(){$(".nudgepadTimeline").toggle()};Events.shortcut.shortcuts["shift+v"]=nudgepad.stage.toggleView;Events.shortcut.shortcuts["shift+up"]=function(){nudgepad.stage.selection.move(0,-10)};Events.shortcut.shortcuts["shift+left"]=
function(){nudgepad.stage.selection.move(-10,0)};Events.shortcut.shortcuts["shift+down"]=function(){nudgepad.stage.selection.move(0,10)};Events.shortcut.shortcuts["shift+right"]=function(){nudgepad.stage.selection.move(10,0)};Events.shortcut.shortcuts["alt+left"]=nudgepad.stage.back;Events.shortcut.shortcuts["alt+right"]=nudgepad.stage.forward;Events.shortcut.shortcuts["ctrl+z"]=nudgepad.stage.undo;Events.shortcut.shortcuts["meta+z"]=nudgepad.stage.undo;Events.shortcut.shortcuts["meta+shift+z"]=nudgepad.stage.redo;
Events.shortcut.shortcuts["meta+y"]=nudgepad.stage.redo;Events.shortcut.shortcuts["ctrl+y"]=nudgepad.stage.redo;Events.shortcut.shortcuts["meta+shift+c"]=nudgepad.stage.selection.cssPrompt};
...
$("#nudgepadSignupFormButton").on("click",function(){var a=$("#nudgepadSignupFormEmail").val();if(!ValidateEmail(a))return nudgepad.error("Invalid Email");$.post("/nudgepad.updateEmail",{email:a,sendWelcomeEmail:"true"},function(){nudgepad.warnBeforeReload=!1;document.location="/nudgepad?app=pages"})});$("#nudgepadSignupFormEmail").focus()});Space.prototype.autokey=function(a){a=a||"";if(!this.get(a))return a;for(var b=2;this.get(a+b.toString());)b++;return a+b.toString()};
...
nudgepad.stage.commit=function(){var a=(new Date).getTime(),b=nudgepad.pages.edge.diff(nudgepad.pages.stage),c=nudgepad.pages.edge.diffOrder(nudgepad.pages.stage);if(b.empty()&&c.empty())return console.log("no change"),!1;var d=new Space;d.set("author",nudgepad.cookie.email);b.empty()||d.set("values",new Space(b.toString()));c.empty()||d.set("order",new Space(c.toString()));nudgepad.stage.timeline.set(a,d);nudgepad.pages.edge=new Space(nudgepad.pages.stage.toString());nudgepad.stage.version=nudgepad.stage.timeline.keys.length;
nudgepad.stage.updateTimeline();nudgepad.trigger("selection");c=new Space;c.set("timelines "+nudgepad.stage.activePage+" "+a,d);site.set("pages "+nudgepad.stage.activePage,new Space(nudgepad.pages.stage.toString()));nudgepad.emit("commit",c.toString());return b};
...
nudgepad.stage.setTimeline=function(a){if(site.get("timelines "+a))return nudgepad.stage.timeline=site.get("timelines "+a),!0;var b=$.ajax({type:"GET",url:"/nudgepad.site.timelines."+a,async:!1});b.done(function(b){site.set("timelines "+a,new Space(b))});b.fail(function(){var b=site.get("pages "+a),d=new Space;if(b&&!b.empty()){var f=new Space;f.set("author",nudgepad.cookie.email);f.set("values",new Space(b.toString()))}site.set("timelines "+a,d);b=new Space;b.set("timelines "+a,d);nudgepad.emit("patch",
b.toString());nudgepad.notify("Timeline created")});nudgepad.stage.timeline=site.get("timelines "+a)};
var stageViews=new Space({full:function(){$("#nudgepadStage").css({width:"100%",padding:0});$("#nudgepadStageBody").css({height:"100%","min-height":"1000px"})},ipad:function(){var a=Math.round(($(window).width()-768)/2)+"px";$("#nudgepadStage").css({width:"768px",padding:"20px "+a+" 20px "+a});$("#nudgepadStageBody").css({height:"100%","min-height":"1024px"})},ios:function(){var a=Math.round(($(window).width()-320)/2)+"px";$("#nudgepadStage").css({padding:"20px "+a+" 20px "+a,width:"320px"});$("#nudgepadStageBody").css({height:"356px"})}});
...
nudgepad.StretchHandle.create=function(a,b,c,d){var f=a.element(),n="fixed"==f.css("position")?"fixed":"absolute",q=("top"==b?"n":"bottom"==b?"s":"")+("left"==c?"w":"right"==c?"e":""),m=$("<div></div>");m.attr("value",a.getPath());m.addClass("handle stretch_handle stretch_handle_"+a.id+" "+a.id+"_handle");m.attr("id","stretch_handle_"+b+c+a.id);m.css({cursor:q+"-resize",position:n,width:"5px",height:"5px",border:"1px solid rgba(0, 0, 0, .5)","background-color":"rgba(255, 255, 255, 0.5)","z-index":"50"});
...
nudgepad.StretchHandle.slide=function(){var a=$(this).owner(),b=$(this).data().row,c=$(this).data().column,d=$(this).data().fixed,f,n;f="left"===c?nudgepad.StretchHandle.dimensions.right:"right"===c?nudgepad.StretchHandle.dimensions.left:nudgepad.StretchHandle.dimensions.center;n="top"===b?nudgepad.StretchHandle.dimensions.bottom:"bottom"===b?nudgepad.StretchHandle.dimensions.top:nudgepad.StretchHandle.dimensions.middle;var q=nudgepad.mouse.move.pageX-$(this).parent().offset().left,m=nudgepad.mouse.move.pageY-
$(this).parent().offset().top,m=nudgepad.StretchHandle.getLength(f,n,q,m,"center"!=c,"middle"!=b),q=a.scrap();"center"!=c&&(q.set("style left",(0<=m.x?f:m.x+f)+"px"),c=a.outerWidth()-a.width(),q.set("style width",Math.abs(m.x)-c+"px"));d?(b=parseFloat(q.get("style width"))/nudgepad.StretchHandle.originalWidth,q.set("style height",Math.round(nudgepad.StretchHandle.originalHeight*b)+"px")):"middle"!=b&&(0<=m.y?q.set("style top",n+"px"):q.set("style top",m.y+n+"px"),b=a.outerHeight()-a.height(),q.set("style height",
Math.abs(m.y)-b+"px"));a.css(q.values.style.values);b="W "+parseFloat(a.css("width"))+"<br> H "+parseFloat(a.css("height"));$("#nudgepadDimensions").css({left:10+a.right(),top:-10+a.middle()}).html(b);$(".stretch_handle_"+q.id).trigger("update");return!1};
...
nudgepad.styleEditor=function(a){$(".handle").remove();var b=$('<div id="nudgepadStyleEditorModal" class="nudgepad"/>');b.on("tap mousedown click slide slidestart slideend mouseup",function(a){a.stopPropagation()});b.on("click",function(){N.trigger("click")});$("body").append(b);var c=a.element(),d=$('<div id="nudgepadStyleEditor" class="nudgepad"></div>');d.css({left:c.offset().left+2+"px",top:c.offset().top+c.outerHeight()+4+"px"});c=$('<div id="nudgepadStyleEditorTopBar"></div>');d.append(c);var f=
$('<div class="editorOption selectedEditorOption">Block</div>');f.on("tap",function(){$("div").removeClass("selectedEditorOption");$(this).addClass("selectedEditorOption");B.hide();T.hide();n.show();return!1});c.append(f);f=$('<div class="editorOption">Text</div>');f.on("tap",function(){$("div").removeClass("selectedEditorOption");$(this).addClass("selectedEditorOption");n.hide();B.hide();a.get("style")&&B.val(a.get("style"));T.show();return!1});c.append(f);f=$('<div class="editorOption">Code</div>');
f.on("tap",function(){$("div").removeClass("selectedEditorOption");$(this).addClass("selectedEditorOption");n.hide();T.hide();a.get("style")&&B.val(a.get("style"));B.show();return!1});c.append(f);var n=$('<div id="blockContainer"></div>');d.append(n);var q=$(".selection").css("background-color"),c=$('<div class="colorBackground"><input type="text" class="colorPicker"></div>');n.append(c);c=$('<div class="editorButton"><img src="/nudgepad/images/dup_lt.png"></div>');c.on("click",function(){nudgepad.stage.selection.duplicate()});
n.append(c);c=$('<div class="editorButton"><img src="/nudgepad/images/lock_lt.png"></div>');c.on("tap",function(){nudgepad.stage.selection.patch("locked true");N.trigger("click");return!1});n.append(c);var m=$('<select id="nudgepadLinkSelect"></select>'),c=$("<option>No link</option>");c.on("click",function(){nudgepad.stage.selection.patch("href ")});m.append(c);_.each(site.values.pages.values,function(a,b){var c=$('<option value="'+b+'">'+ToProperCase(b)+"</option>");c.on("click",function(){nudgepad.stage.selection.patch("tag a\nhref "+
$(this).attr("value"))});m.append(c)});c=$("<option>New Page</option>");c.on("click",function(){var a=prompt("Enter the name of your new page",nudgepad.pages.nextName(nudgepad.stage.activePage));if(a){a=Permalink(a);nudgepad.stage.selection.patch("tag a\nhref "+a);N.trigger("click");var b=nudgepad.stage.activePage;nudgepad.pages.duplicate(null,a,!0);nudgepad.stage.open(b)}});m.append(c);c=$("<option>External Link</option>");c.on("click",function(){var a=prompt("Enter the url to link to","http://");
...
nudgepad.stage.commit();$(".handle").trigger("update");return!1});f.append(p);p=$('<div id="textStyleThree" class="toolButton toolButtonThree">Auto</div>');p.on("click",function(){nudgepad.stage.selection.cssPreview({"text-decoration":"none","font-weight":"normal","font-style":"normal"});return!1});f.append(p);p=$('<div class="clear"></div>');T.append(p);var B=$('<textarea id="nudgepadStyleEditorCssEditor"></textarea>');a.get("style")&&B.val(a.get("style"));B.on("tap mousedown click slide slidestart slideend mouseup",
function(a){a.stopPropagation()});nudgepad.livePreviewScrap=a;B.on("keyup",nudgepad.livePreviewStart);d.append(B);f=$('<div id="nudgepadStyleEditorBottomBar"></div>');B.append(f);var N=$('<div id="nudgepadStyleEditorSaveButton">Save</div>');N.on("click",function(){nudgepad.stage.commit();$(".handle").trigger("update");d.remove();b.remove()});B.append(N);$("body").append(d);var X;$(".colorPicker").spectrum({color:q,move:function(a){nudgepad.stage.selection.cssPreview("background-color "+a.toHexString());
q=a.toHexString()},change:function(a){$("#basic-log").text("change called: "+a.toHexString());q=a.toHexString()},show:function(){X="background-color "},hide:function(){nudgepad.stage.commit();$(".handle").trigger("update")}});$(".colorBorderPicker").spectrum({color:Q,move:function(a){nudgepad.stage.selection.cssPreview("border-color "+a.toHexString());Q=a.toHexString()},change:function(a){$("#basic-log").text("change called: "+a.toHexString());Q=a.toHexString()},show:function(){X="border-color "},
hide:function(){nudgepad.stage.commit();$(".handle").trigger("update")}});$(".colorFontPicker").spectrum({color:c,move:function(a){nudgepad.stage.selection.cssPreview("color "+a.toHexString());Q=a.toHexString()},change:function(a){$("#basic-log").text("change called: "+a.toHexString());Q=a.toHexString()},show:function(){X="color "},hide:function(){nudgepad.stage.commit();$(".handle").trigger("update")}});$(document).on("slide slidestart slideend",".sp-container",function(){return!1});$(".sp-input[type=text]").on("keydown",
...
nudgepad.pages.updateTabs=function(){$("#nudgepadTabs").html("");var a=site.get("pages").keys;_.each(a,function(a){var c=$("<span>"+a+"</span>");a===nudgepad.stage.activePage&&c.css("color","white");_.each(nudgepad.openPages,function(d){a===d&&c.addClass("openPage")});c.on("hold",function(){window.open($(this).text(),"published");return!0});c.on("click",function(){nudgepad.stage.open($(this).text());return!0});c.attr("value",a);$("#nudgepadTabs").append(c)})};
nudgepad.textPrompt=function(a,b,c,d,f){var n=$('<textarea id="nudgepadEditorTextarea" class="nudgepad"></textarea>');n.val(b);var q=$('<div id="nudgepadEditorModalScreen" class="nudgepad"/>');q.on("tap mousedown click slide slidestart slideend mouseup",function(a){a.stopPropagation()});n.on("tap mousedown click slide slidestart slideend mouseup",function(a){a.stopPropagation()});if(d)n.on("keypress",d);var m=$('<div id="nudgepadEditorSaveButton" class="nudgepad">'+(f||"Save")+"</div>"),p=$('<div id="nudgepadEditorCancelButton" class="nudgepad">Cancel</div>'),
Q=$('<div id="nudgepadEditorButtonContainer" class="nudgepad"></div>');q.on("click",function(){p.trigger("click")});p.on("click",function(){m.remove();n.remove();q.remove();Q.remove();p.remove()});m.on("click",function(){c&&c(n.val());m.remove();n.remove();q.remove();Q.remove();p.remove()});$("body").append(q);$("body").append(n);$("body").append(m);$("body").append(p);$("body").append(Q);n.focus()};
/**
