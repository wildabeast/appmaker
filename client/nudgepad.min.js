(function(a,b){function c(g){var a=g.length,t=d.type(g);return d.isWindow(g)?!1:1===g.nodeType&&a?!0:"array"===t||"function"!==t&&(0===a||"number"==typeof a&&0<a&&a-1 in g)}function e(g,a,t,u){if(d.acceptData(g)){var c,h,Sa=d.expando,e="string"==typeof a,m=g.nodeType,f=m?d.cache:g,k=m?g[Sa]:g[Sa]&&Sa;if(k&&f[k]&&(u||f[k].data)||!e||t!==b)return k||(m?g[Sa]=k=Ca.pop()||d.guid++:k=Sa),f[k]||(f[k]={},m||(f[k].toJSON=d.noop)),("object"==typeof a||"function"==typeof a)&&(u?f[k]=d.extend(f[k],a):f[k].data=
d.extend(f[k].data,a)),c=f[k],u||(c.data||(c.data={}),c=c.data),t!==b&&(c[d.camelCase(a)]=t),e?(h=c[a],null==h&&(h=c[d.camelCase(a)])):h=c,h}}function f(g,a,t){if(d.acceptData(g)){var b,c,h,Sa=g.nodeType,e=Sa?d.cache:g,m=Sa?g[d.expando]:d.expando;if(e[m]){if(a&&(h=t?e[m]:e[m].data)){d.isArray(a)?a=a.concat(d.map(a,d.camelCase)):a in h?a=[a]:(a=d.camelCase(a),a=a in h?[a]:a.split(" "));b=0;for(c=a.length;c>b;b++)delete h[a[b]];if(!(t?r:d.isEmptyObject)(h))return}(t||(delete e[m].data,r(e[m])))&&(Sa?
d.cleanData([g],!0):d.support.deleteExpando||e!=e.window?delete e[m]:e[m]=null)}}}function p(g,a,t){if(t===b&&1===g.nodeType){var u="data-"+a.replace(wa,"-$1").toLowerCase();if(t=g.getAttribute(u),"string"==typeof t){try{t="true"===t?!0:"false"===t?!1:"null"===t?null:+t+""===t?+t:Ga.test(t)?d.parseJSON(t):t}catch(c){}d.data(g,a,t)}else t=b}return t}function r(g){for(var a in g)if(("data"!==a||!d.isEmptyObject(g[a]))&&"toJSON"!==a)return!1;return!0}function l(){return!0}function q(){return!1}function Q(g,
a){do g=g[a];while(g&&1!==g.nodeType);return g}function T(g,a,t){if(a=a||0,d.isFunction(a))return d.grep(g,function(g,b){return!!a.call(g,b,g)===t});if(a.nodeType)return d.grep(g,function(g){return g===a===t});if("string"==typeof a){var b=d.grep(g,function(g){return 1===g.nodeType});if(Uc.test(a))return d.filter(a,b,!t);a=d.filter(a,b)}return d.grep(g,function(g){return 0<=d.inArray(g,a)===t})}function W(g){var a=tc.split("|");g=g.createDocumentFragment();if(g.createElement)for(;a.length;)g.createElement(a.pop());
return g}function y(g){var a=g.getAttributeNode("type");return g.type=(a&&a.specified)+"/"+g.type,g}function B(g){var a=Vc.exec(g.type);return a?g.type=a[1]:g.removeAttribute("type"),g}function N(g,a){for(var b,u=0;null!=(b=g[u]);u++)d._data(b,"globalEval",!a||d._data(a[u],"globalEval"))}function X(g,a){if(1===a.nodeType&&d.hasData(g)){var b,u,c;u=d._data(g);var h=d._data(a,u),e=u.events;if(e)for(b in delete h.handle,h.events={},e){u=0;for(c=e[b].length;c>u;u++)d.event.add(a,b,e[b][u])}h.data&&(h.data=
d.extend({},h.data))}}function s(g,a){var t,u,c=0,h=typeof g.getElementsByTagName!==A?g.getElementsByTagName(a||"*"):typeof g.querySelectorAll!==A?g.querySelectorAll(a||"*"):b;if(!h){h=[];for(t=g.childNodes||g;null!=(u=t[c]);c++)!a||d.nodeName(u,a)?h.push(u):d.merge(h,s(u,a))}return a===b||a&&d.nodeName(g,a)?d.merge([g],h):h}function U(g){cc.test(g.type)&&(g.defaultChecked=g.checked)}function K(g,a){if(a in g)return a;for(var b=a.charAt(0).toUpperCase()+a.slice(1),d=a,c=uc.length;c--;)if(a=uc[c]+
b,a in g)return a;return d}function V(g,a){return g=a||g,"none"===d.css(g,"display")||!d.contains(g.ownerDocument,g)}function I(g,a){for(var b,u,c,h=[],e=0,m=g.length;m>e;e++)u=g[e],u.style&&(h[e]=d._data(u,"olddisplay"),b=u.style.display,a?(h[e]||"none"!==b||(u.style.display=""),""===u.style.display&&V(u)&&(h[e]=d._data(u,"olddisplay",ca(u.nodeName)))):h[e]||(c=V(u),(b&&"none"!==b||!c)&&d._data(u,"olddisplay",c?b:d.css(u,"display"))));for(e=0;m>e;e++)u=g[e],u.style&&(a&&"none"!==u.style.display&&
""!==u.style.display||(u.style.display=a?h[e]||"":"none"));return g}function j(g,a,b){return(g=Wc.exec(a))?Math.max(0,g[1]-(b||0))+(g[2]||"px"):a}function C(g,a,b,u,c){a=b===(u?"border":"content")?4:"width"===a?1:0;for(var h=0;4>a;a+=2)"margin"===b&&(h+=d.css(g,b+gb[a],!0,c)),u?("content"===b&&(h-=d.css(g,"padding"+gb[a],!0,c)),"margin"!==b&&(h-=d.css(g,"border"+gb[a]+"Width",!0,c))):(h+=d.css(g,"padding"+gb[a],!0,c),"padding"!==b&&(h+=d.css(g,"border"+gb[a]+"Width",!0,c)));return h}function R(g,
a,b){var u=!0,c="width"===a?g.offsetWidth:g.offsetHeight,h=hb(g),e=d.support.boxSizing&&"border-box"===d.css(g,"boxSizing",!1,h);if(0>=c||null==c){if(c=ib(g,a,h),(0>c||null==c)&&(c=g.style[a]),Pb.test(c))return c;u=e&&(d.support.boxSizingReliable||c===g.style[a]);c=parseFloat(c)||0}return c+C(g,a,b||(e?"border":"content"),u,h)+"px"}function ca(g){var a=F,b=vc[g];return b||(b=L(g,a),"none"!==b&&b||(Gb=(Gb||d("<iframe frameborder='0' width='0' height='0'/>").css("cssText","display:block !important")).appendTo(a.documentElement),
a=(Gb[0].contentWindow||Gb[0].contentDocument).document,a.write("<!doctype html><html><body>"),a.close(),b=L(g,a),Gb.detach()),vc[g]=b),b}function L(g,a){var b=d(a.createElement(g)).appendTo(a.body),u=d.css(b[0],"display");return b.remove(),u}function H(g,a,b,u){var c;if(d.isArray(a))d.each(a,function(a,z){b||Xc.test(g)?u(g,z):H(g+"["+("object"==typeof z?a:"")+"]",z,b,u)});else if(b||"object"!==d.type(a))u(g,a);else for(c in a)H(g+"["+c+"]",a[c],b,u)}function S(g){return function(a,b){"string"!=typeof a&&
(b=a,a="*");var u,c=0,h=a.toLowerCase().match(Ba)||[];if(d.isFunction(b))for(;u=h[c++];)"+"===u[0]?(u=u.slice(1)||"*",(g[u]=g[u]||[]).unshift(b)):(g[u]=g[u]||[]).push(b)}}function P(g,a,t,u){function c(m){var f;return h[m]=!0,d.each(g[m]||[],function(g,d){var m=d(a,t,u);return"string"!=typeof m||e||h[m]?e?!(f=m):b:(a.dataTypes.unshift(m),c(m),!1)}),f}var h={},e=g===dc;return c(a.dataTypes[0])||!h["*"]&&c("*")}function fa(g,a){var t,u,c=d.ajaxSettings.flatOptions||{};for(u in a)a[u]!==b&&((c[u]?g:
t||(t={}))[u]=a[u]);return t&&d.extend(!0,g,t),g}function ha(){try{return new a.XMLHttpRequest}catch(g){}}function ja(){return setTimeout(function(){qb=b}),qb=d.now()}function ia(g,a,b){var u,c,h=0,e=Qb.length,m=d.Deferred().always(function(){delete f.elem}),f=function(){if(c)return!1;for(var a=qb||ja(),a=Math.max(0,k.startTime+k.duration-a),z=1-(a/k.duration||0),b=0,t=k.tweens.length;t>b;b++)k.tweens[b].run(z);return m.notifyWith(g,[k,z,a]),1>z&&t?a:(m.resolveWith(g,[k]),!1)},k=m.promise({elem:g,
props:d.extend({},a),opts:d.extend(!0,{specialEasing:{}},b),originalProperties:a,originalOptions:b,startTime:qb||ja(),duration:b.duration,tweens:[],createTween:function(a,z){var b=d.Tween(g,k.opts,a,z,k.opts.specialEasing[a]||k.opts.easing);return k.tweens.push(b),b},stop:function(a){var z=0,b=a?k.tweens.length:0;if(c)return this;for(c=!0;b>z;z++)k.tweens[z].run(1);return a?m.resolveWith(g,[k,a]):m.rejectWith(g,[k,a]),this}});a=k.props;b=k.opts.specialEasing;var v,n,j,x;for(n in a)if(v=d.camelCase(n),
j=b[v],u=a[n],d.isArray(u)&&(j=u[1],u=a[n]=u[0]),n!==v&&(a[v]=u,delete a[n]),x=d.cssHooks[v],x&&"expand"in x)for(n in u=x.expand(u),delete a[v],u)n in a||(a[n]=u[n],b[n]=j);else b[v]=j;for(;e>h;h++)if(u=Qb[h].call(k,g,a,k.opts))return u;var w=k;d.each(a,function(g,a){for(var z=(Hb[g]||[]).concat(Hb["*"]),b=0,t=z.length;t>b&&!z[b].call(w,g,a);b++);});return d.isFunction(k.opts.start)&&k.opts.start.call(g,k),d.fx.timer(d.extend(f,{elem:g,anim:k,queue:k.opts.queue})),k.progress(k.opts.progress).done(k.opts.done,
k.opts.complete).fail(k.opts.fail).always(k.opts.always)}function Y(g,a,b,d,c){return new Y.prototype.init(g,a,b,d,c)}function k(g,a){var b,d={height:g},c=0;for(a=a?1:0;4>c;c+=2-a)b=gb[c],d["margin"+b]=d["padding"+b]=g;return a&&(d.opacity=d.width=g),d}function D(g){return d.isWindow(g)?g:9===g.nodeType?g.defaultView||g.parentWindow:!1}var n,w,A=typeof b,F=a.document,ga=a.location,$a=a.jQuery,ab=a.$,sa={},Ca=[],da=Ca.concat,ta=Ca.push,ka=Ca.slice,x=Ca.indexOf,O=sa.toString,G=sa.hasOwnProperty,Ta=
"1.9.1".trim,d=function(g,a){return new d.fn.init(g,a,w)},Da=/[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,Ba=/\S+/g,bb=/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,jb=/^(?:(<[\w\W]+>)[^>]*|#([\w-]*))$/,kb=/^<(\w+)\s*\/?>(?:<\/\1>|)$/,Ib=/^[\],:{}\s]*$/,Rb=/(?:^|:|,)(?:\s*\[)+/g,Ua=/\\(?:["\\\/bfnrt]|u[\da-fA-F]{4})/g,rb=/"[^"\\\r\n]*"|true|false|null|-?(?:\d+\.|)\d+(?:[eE][+-]?\d+|)/g,Ka=/^-ms-/,Jb=/-([\da-z])/gi,Sb=function(g,a){return a.toUpperCase()},E=function(g){(F.addEventListener||"load"===g.type||
"complete"===F.readyState)&&(Va(),d.ready())},Va=function(){F.addEventListener?(F.removeEventListener("DOMContentLoaded",E,!1),a.removeEventListener("load",E,!1)):(F.detachEvent("onreadystatechange",E),a.detachEvent("onload",E))};d.fn=d.prototype={jquery:"1.9.1",constructor:d,init:function(g,a,t){var u,c;if(!g)return this;if("string"==typeof g){if(u="<"===g.charAt(0)&&">"===g.charAt(g.length-1)&&3<=g.length?[null,g,null]:jb.exec(g),!u||!u[1]&&a)return!a||a.jquery?(a||t).find(g):this.constructor(a).find(g);
if(u[1]){if(a=a instanceof d?a[0]:a,d.merge(this,d.parseHTML(u[1],a&&a.nodeType?a.ownerDocument||a:F,!0)),kb.test(u[1])&&d.isPlainObject(a))for(u in a)d.isFunction(this[u])?this[u](a[u]):this.attr(u,a[u]);return this}if(c=F.getElementById(u[2]),c&&c.parentNode){if(c.id!==u[2])return t.find(g);this.length=1;this[0]=c}return this.context=F,this.selector=g,this}return g.nodeType?(this.context=this[0]=g,this.length=1,this):d.isFunction(g)?t.ready(g):(g.selector!==b&&(this.selector=g.selector,this.context=
...
last:function(){return this.eq(-1)},eq:function(g){var a=this.length;g=+g+(0>g?a:0);return this.pushStack(0<=g&&a>g?[this[g]]:[])},map:function(g){return this.pushStack(d.map(this,function(a,b){return g.call(a,b,a)}))},end:function(){return this.prevObject||this.constructor(null)},push:ta,sort:[].sort,splice:[].splice};d.fn.init.prototype=d.fn;d.extend=d.fn.extend=function(){var g,a,t,u,c,h,e=arguments[0]||{},m=1,k=arguments.length,f=!1;"boolean"==typeof e&&(f=e,e=arguments[1]||{},m=2);"object"==
typeof e||d.isFunction(e)||(e={});for(k===m&&(e=this,--m);k>m;m++)if(null!=(c=arguments[m]))for(u in c)g=e[u],t=c[u],e!==t&&(f&&t&&(d.isPlainObject(t)||(a=d.isArray(t)))?(a?(a=!1,h=g&&d.isArray(g)?g:[]):h=g&&d.isPlainObject(g)?g:{},e[u]=d.extend(f,h,t)):t!==b&&(e[u]=t));return e};d.extend({noConflict:function(g){return a.$===d&&(a.$=ab),g&&a.jQuery===d&&(a.jQuery=$a),d},isReady:!1,readyWait:1,holdReady:function(g){g?d.readyWait++:d.ready(!0)},ready:function(g){if(!0===g?!--d.readyWait:!d.isReady){if(!F.body)return setTimeout(d.ready);
d.isReady=!0;!0!==g&&0<--d.readyWait||(n.resolveWith(F,[d]),d.fn.trigger&&d(F).trigger("ready").off("ready"))}},isFunction:function(g){return"function"===d.type(g)},isArray:Array.isArray||function(g){return"array"===d.type(g)},isWindow:function(g){return null!=g&&g==g.window},isNumeric:function(g){return!isNaN(parseFloat(g))&&isFinite(g)},type:function(g){return null==g?g+"":"object"==typeof g||"function"==typeof g?sa[O.call(g)]||"object":typeof g},isPlainObject:function(g){if(!g||"object"!==d.type(g)||
g.nodeType||d.isWindow(g))return!1;try{if(g.constructor&&!G.call(g,"constructor")&&!G.call(g.constructor.prototype,"isPrototypeOf"))return!1}catch(a){return!1}for(var t in g);return t===b||G.call(g,t)},isEmptyObject:function(g){for(var a in g)return!1;return!0},error:function(g){throw Error(g);},parseHTML:function(g,a,b){if(!g||"string"!=typeof g)return null;"boolean"==typeof a&&(b=a,a=!1);a=a||F;var u=kb.exec(g);b=!b&&[];return u?[a.createElement(u[1])]:(u=d.buildFragment([g],a,b),b&&d(b).remove(),
d.merge([],u.childNodes))},parseJSON:function(g){return a.JSON&&a.JSON.parse?a.JSON.parse(g):null===g?g:"string"==typeof g&&(g=d.trim(g),g&&Ib.test(g.replace(Ua,"@").replace(rb,"]").replace(Rb,"")))?Function("return "+g)():(d.error("Invalid JSON: "+g),b)},parseXML:function(g){var z,t;if(!g||"string"!=typeof g)return null;try{a.DOMParser?(t=new DOMParser,z=t.parseFromString(g,"text/xml")):(z=new ActiveXObject("Microsoft.XMLDOM"),z.async="false",z.loadXML(g))}catch(u){z=b}return z&&z.documentElement&&
!z.getElementsByTagName("parsererror").length||d.error("Invalid XML: "+g),z},noop:function(){},globalEval:function(g){g&&d.trim(g)&&(a.execScript||function(g){a.eval.call(a,g)})(g)},camelCase:function(g){return g.replace(Ka,"ms-").replace(Jb,Sb)},nodeName:function(g,a){return g.nodeName&&g.nodeName.toLowerCase()===a.toLowerCase()},each:function(g,a,b){var d,h=0,e=g.length,m=c(g);if(b)if(m)for(;e>h&&!(d=a.apply(g[h],b),!1===d);h++);else for(h in g){if(d=a.apply(g[h],b),!1===d)break}else if(m)for(;e>
h&&!(d=a.call(g[h],h,g[h]),!1===d);h++);else for(h in g)if(d=a.call(g[h],h,g[h]),!1===d)break;return g},trim:Ta&&!Ta.call("\ufeff\u00a0")?function(g){return null==g?"":Ta.call(g)}:function(g){return null==g?"":(g+"").replace(bb,"")},makeArray:function(g,a){var b=a||[];return null!=g&&(c(Object(g))?d.merge(b,"string"==typeof g?[g]:g):ta.call(b,g)),b},inArray:function(g,a,b){var d;if(a){if(x)return x.call(a,g,b);d=a.length;for(b=b?0>b?Math.max(0,d+b):b:0;d>b;b++)if(b in a&&a[b]===g)return b}return-1},
merge:function(g,a){var d=a.length,u=g.length,c=0;if("number"==typeof d)for(;d>c;c++)g[u++]=a[c];else for(;a[c]!==b;)g[u++]=a[c++];return g.length=u,g},grep:function(g,a,b){var d,c=[],h=0,e=g.length;for(b=!!b;e>h;h++)d=!!a(g[h],h),b!==d&&c.push(g[h]);return c},map:function(g,a,b){var d,h=0,e=g.length,m=[];if(c(g))for(;e>h;h++)d=a(g[h],h,b),null!=d&&(m[m.length]=d);else for(h in g)d=a(g[h],h,b),null!=d&&(m[m.length]=d);return da.apply([],m)},guid:1,proxy:function(g,a){var t,u,c;return"string"==typeof a&&
(c=g[a],a=g,g=c),d.isFunction(g)?(t=ka.call(arguments,2),u=function(){return g.apply(a||this,t.concat(ka.call(arguments)))},u.guid=g.guid=g.guid||d.guid++,u):b},access:function(g,a,t,c,h,e,m){var k=0,f=g.length,n=null==t;if("object"===d.type(t))for(k in h=!0,t)d.access(g,a,k,t[k],!0,e,m);else if(c!==b&&(h=!0,d.isFunction(c)||(m=!0),n&&(m?(a.call(g,c),a=null):(n=a,a=function(g,a,b){return n.call(d(g),b)})),a))for(;f>k;k++)a(g[k],t,m?c:c.call(g[k],k,a(g[k],t)));return h?g:n?a.call(g):f?a(g[0],t):e},
now:function(){return(new Date).getTime()}});d.ready.promise=function(g){if(!n)if(n=d.Deferred(),"complete"===F.readyState)setTimeout(d.ready);else if(F.addEventListener)F.addEventListener("DOMContentLoaded",E,!1),a.addEventListener("load",E,!1);else{F.attachEvent("onreadystatechange",E);a.attachEvent("onload",E);var b=!1;try{b=null==a.frameElement&&F.documentElement}catch(t){}b&&b.doScroll&&function Tc(){if(!d.isReady){try{b.doScroll("left")}catch(g){return setTimeout(Tc,50)}Va();d.ready()}}()}return n.promise(g)};
d.each("Boolean Number String Function Array Date RegExp Object Error".split(" "),function(g,a){sa["[object "+a+"]"]=a.toLowerCase()});w=d(F);var Wa={};d.Callbacks=function(g){var a;if("string"==typeof g){if(!(a=Wa[g])){a=g;var t=Wa[a]={};a=(d.each(a.match(Ba)||[],function(g,a){t[a]=!0}),t)}}else a=d.extend({},g);g=a;var c,h,e,m,k,f,n=[],v=!g.once&&[],j=function(a){h=g.memory&&a;e=!0;k=f||0;f=0;m=n.length;for(c=!0;n&&m>k;k++)if(!1===n[k].apply(a[0],a[1])&&g.stopOnFalse){h=!1;break}c=!1;n&&(v?v.length&&
j(v.shift()):h?n=[]:x.disable())},x={add:function(){if(n){var a=n.length;(function Yc(a){d.each(a,function(a,b){var z=d.type(b);"function"===z?g.unique&&x.has(b)||n.push(b):b&&b.length&&"string"!==z&&Yc(b)})})(arguments);c?m=n.length:h&&(f=a,j(h))}return this},remove:function(){return n&&d.each(arguments,function(g,a){for(var b;-1<(b=d.inArray(a,n,b));)n.splice(b,1),c&&(m>=b&&m--,k>=b&&k--)}),this},has:function(g){return g?-1<d.inArray(g,n):!(!n||!n.length)},empty:function(){return n=[],this},disable:function(){return n=
v=h=b,this},disabled:function(){return!n},lock:function(){return v=b,h||x.disable(),this},locked:function(){return!v},fireWith:function(g,a){return a=a||[],a=[g,a.slice?a.slice():a],!n||e&&!v||(c?v.push(a):j(a)),this},fire:function(){return x.fireWith(this,arguments),this},fired:function(){return!!e}};return x};d.extend({Deferred:function(g){var a=[["resolve","done",d.Callbacks("once memory"),"resolved"],["reject","fail",d.Callbacks("once memory"),"rejected"],["notify","progress",d.Callbacks("memory")]],
b="pending",c={state:function(){return b},always:function(){return h.done(arguments).fail(arguments),this},then:function(){var g=arguments;return d.Deferred(function(b){d.each(a,function(a,z){var t=z[0],e=d.isFunction(g[a])&&g[a];h[z[1]](function(){var g=e&&e.apply(this,arguments);g&&d.isFunction(g.promise)?g.promise().done(b.resolve).fail(b.reject).progress(b.notify):b[t+"With"](this===c?b.promise():this,e?[g]:arguments)})});g=null}).promise()},promise:function(g){return null!=g?d.extend(g,c):c}},
h={};return c.pipe=c.then,d.each(a,function(g,d){var e=d[2],m=d[3];c[d[1]]=e.add;m&&e.add(function(){b=m},a[1^g][2].disable,a[2][2].lock);h[d[0]]=function(){return h[d[0]+"With"](this===h?c:this,arguments),this};h[d[0]+"With"]=e.fireWith}),c.promise(h),g&&g.call(h,h),h},when:function(g){var a=0,b=ka.call(arguments),c=b.length,h=1!==c||g&&d.isFunction(g.promise)?c:0,e=1===h?g:d.Deferred(),m=function(g,a,b){return function(d){a[g]=this;b[g]=1<arguments.length?ka.call(arguments):d;b===k?e.notifyWith(a,
b):--h||e.resolveWith(a,b)}},k,f,n;if(1<c){k=Array(c);f=Array(c);for(n=Array(c);c>a;a++)b[a]&&d.isFunction(b[a].promise)?b[a].promise().done(m(a,n,b)).fail(e.reject).progress(m(a,f,k)):--h}return h||e.resolveWith(n,b),e.promise()}});var ec=d,lb;var ba,ea,M,na,oa,ua,Ha,la,Na,ra,J=F.createElement("div");if(J.setAttribute("className","t"),J.innerHTML="  <link/><table></table><a href='/a'>a</a><input type='checkbox'/>",ea=J.getElementsByTagName("*"),M=J.getElementsByTagName("a")[0],!ea||!M||!ea.length)lb=
...
g.nodeName&&d.noData[g.nodeName.toLowerCase()];return!a||!0!==a&&g.getAttribute("classid")===a}});d.fn.extend({data:function(g,a){var t,c,h=this[0],e=0,m=null;if(g===b){if(this.length&&(m=d.data(h),1===h.nodeType&&!d._data(h,"parsedAttrs"))){for(t=h.attributes;t.length>e;e++)c=t[e].name,c.indexOf("data-")||(c=d.camelCase(c.slice(5)),p(h,c,m[c]));d._data(h,"parsedAttrs",!0)}return m}return"object"==typeof g?this.each(function(){d.data(this,g)}):d.access(this,function(a){return a===b?h?p(h,g,d.data(h,
g)):null:(this.each(function(){d.data(this,g,a)}),b)},null,a,1<arguments.length,null,!0)},removeData:function(g){return this.each(function(){d.removeData(this,g)})}});d.extend({queue:function(g,a,t){var c;return g?(a=(a||"fx")+"queue",c=d._data(g,a),t&&(!c||d.isArray(t)?c=d._data(g,a,d.makeArray(t)):c.push(t)),c||[]):b},dequeue:function(g,a){a=a||"fx";var b=d.queue(g,a),c=b.length,h=b.shift(),e=d._queueHooks(g,a),m=function(){d.dequeue(g,a)};"inprogress"===h&&(h=b.shift(),c--);(e.cur=h)&&("fx"===
a&&b.unshift("inprogress"),delete e.stop,h.call(g,m,e));!c&&e&&e.empty.fire()},_queueHooks:function(g,a){var b=a+"queueHooks";return d._data(g,b)||d._data(g,b,{empty:d.Callbacks("once memory").add(function(){d._removeData(g,a+"queue");d._removeData(g,b)})})}});d.fn.extend({queue:function(g,a){var t=2;return"string"!=typeof g&&(a=g,g="fx",t--),t>arguments.length?d.queue(this[0],g):a===b?this:this.each(function(){var b=d.queue(this,g,a);d._queueHooks(this,g);"fx"===g&&"inprogress"!==b[0]&&d.dequeue(this,
g)})},dequeue:function(g){return this.each(function(){d.dequeue(this,g)})},delay:function(g,a){return g=d.fx?d.fx.speeds[g]||g:g,a=a||"fx",this.queue(a,function(a,b){var d=setTimeout(a,g);b.stop=function(){clearTimeout(d)}})},clearQueue:function(g){return this.queue(g||"fx",[])},promise:function(g,a){var t,c=1,h=d.Deferred(),e=this,m=this.length,k=function(){--c||h.resolveWith(e,[e])};"string"!=typeof g&&(a=g,g=b);for(g=g||"fx";m--;)(t=d._data(e[m],g+"queueHooks"))&&t.empty&&(c++,t.empty.add(k));
return k(),h.promise(a)}});var xa,va,h=/[\t\r\n]/g,m=/\r/g,v=/^(?:input|select|textarea|button|object)$/i,Xa=/^(?:a|area)$/i,Oa=/^(?:checked|selected|autofocus|autoplay|async|controls|defer|disabled|hidden|loop|multiple|open|readonly|required|scoped)$/i,Ia=/^(?:checked|selected)$/i,Ea=d.support.getSetAttribute,sb=d.support.input;d.fn.extend({attr:function(g,a){return d.access(this,d.attr,g,a,1<arguments.length)},removeAttr:function(g){return this.each(function(){d.removeAttr(this,g)})},prop:function(g,
a){return d.access(this,d.prop,g,a,1<arguments.length)},removeProp:function(a){return a=d.propFix[a]||a,this.each(function(){try{this[a]=b,delete this[a]}catch(d){}})},addClass:function(a){var b,t,c,e,m,k=0,f=this.length;b="string"==typeof a&&a;if(d.isFunction(a))return this.each(function(b){d(this).addClass(a.call(this,b,this.className))});if(b)for(b=(a||"").match(Ba)||[];f>k;k++)if(t=this[k],c=1===t.nodeType&&(t.className?(" "+t.className+" ").replace(h," "):" ")){for(m=0;e=b[m++];)0>c.indexOf(" "+
e+" ")&&(c+=e+" ");t.className=d.trim(c)}return this},removeClass:function(a){var b,c,u,e,m,k=0,f=this.length;b=0===arguments.length||"string"==typeof a&&a;if(d.isFunction(a))return this.each(function(b){d(this).removeClass(a.call(this,b,this.className))});if(b)for(b=(a||"").match(Ba)||[];f>k;k++)if(c=this[k],u=1===c.nodeType&&(c.className?(" "+c.className+" ").replace(h," "):"")){for(m=0;e=b[m++];)for(;0<=u.indexOf(" "+e+" ");)u=u.replace(" "+e+" "," ");c.className=a?d.trim(u):""}return this},toggleClass:function(a,
b){var c=typeof a,h="boolean"==typeof b;return d.isFunction(a)?this.each(function(c){d(this).toggleClass(a.call(this,c,this.className,b),b)}):this.each(function(){if("string"===c)for(var e,m=0,k=d(this),f=b,n=a.match(Ba)||[];e=n[m++];)f=h?f:!k.hasClass(e),k[f?"addClass":"removeClass"](e);else(c===A||"boolean"===c)&&(this.className&&d._data(this,"__className__",this.className),this.className=this.className||!1===a?"":d._data(this,"__className__")||"")})},hasClass:function(a){a=" "+a+" ";for(var b=
0,d=this.length;d>b;b++)if(1===this[b].nodeType&&0<=(" "+this[b].className+" ").replace(h," ").indexOf(a))return!0;return!1},val:function(a){var c,t,h,e=this[0];if(arguments.length)return h=d.isFunction(a),this.each(function(c){var z,e=d(this);1===this.nodeType&&(z=h?a.call(this,c,e.val()):a,null==z?z="":"number"==typeof z?z+="":d.isArray(z)&&(z=d.map(z,function(a){return null==a?"":a+""})),t=d.valHooks[this.type]||d.valHooks[this.nodeName.toLowerCase()],t&&"set"in t&&t.set(this,z,"value")!==b||(this.value=
z))});if(e)return t=d.valHooks[e.type]||d.valHooks[e.nodeName.toLowerCase()],t&&"get"in t&&(c=t.get(e,"value"))!==b?c:(c=e.value,"string"==typeof c?c.replace(m,""):null==c?"":c)}});d.extend({valHooks:{option:{get:function(a){var b=a.attributes.value;return!b||b.specified?a.value:a.text}},select:{get:function(a){for(var b,c=a.options,h=a.selectedIndex,e="select-one"===a.type||0>h,m=e?null:[],k=e?h+1:c.length,f=0>h?k:e?h:0;k>f;f++)if(b=c[f],!(!b.selected&&f!==h||(d.support.optDisabled?b.disabled:null!==
b.getAttribute("disabled"))||b.parentNode.disabled&&d.nodeName(b.parentNode,"optgroup"))){if(a=d(b).val(),e)return a;m.push(a)}return m},set:function(a,b){var c=d.makeArray(b);return d(a).find("option").each(function(){this.selected=0<=d.inArray(d(this).val(),c)}),c.length||(a.selectedIndex=-1),c}}},attr:function(a,c,t){var h,e,m,k=a.nodeType;if(a&&3!==k&&8!==k&&2!==k)return typeof a.getAttribute===A?d.prop(a,c,t):(e=1!==k||!d.isXMLDoc(a),e&&(c=c.toLowerCase(),h=d.attrHooks[c]||(Oa.test(c)?va:xa)),
t===b?h&&e&&"get"in h&&null!==(m=h.get(a,c))?m:(typeof a.getAttribute!==A&&(m=a.getAttribute(c)),null==m?b:m):null!==t?h&&e&&"set"in h&&(m=h.set(a,t,c))!==b?m:(a.setAttribute(c,t+""),t):(d.removeAttr(a,c),b))},removeAttr:function(a,b){var c,h,e=0,m=b&&b.match(Ba);if(m&&1===a.nodeType)for(;c=m[e++];)h=d.propFix[c]||c,Oa.test(c)?!Ea&&Ia.test(c)?a[d.camelCase("default-"+c)]=a[h]=!1:a[h]=!1:d.attr(a,c,""),a.removeAttribute(Ea?c:h)},attrHooks:{type:{set:function(a,b){if(!d.support.radioValue&&"radio"===
b&&d.nodeName(a,"input")){var c=a.value;return a.setAttribute("type",b),c&&(a.value=c),b}}}},propFix:{tabindex:"tabIndex",readonly:"readOnly","for":"htmlFor","class":"className",maxlength:"maxLength",cellspacing:"cellSpacing",cellpadding:"cellPadding",rowspan:"rowSpan",colspan:"colSpan",usemap:"useMap",frameborder:"frameBorder",contenteditable:"contentEditable"},prop:function(a,c,t){var h,e,m,k=a.nodeType;if(a&&3!==k&&8!==k&&2!==k)return m=1!==k||!d.isXMLDoc(a),m&&(c=d.propFix[c]||c,e=d.propHooks[c]),
t!==b?e&&"set"in e&&(h=e.set(a,t,c))!==b?h:a[c]=t:e&&"get"in e&&null!==(h=e.get(a,c))?h:a[c]},propHooks:{tabIndex:{get:function(a){var d=a.getAttributeNode("tabindex");return d&&d.specified?parseInt(d.value,10):v.test(a.nodeName)||Xa.test(a.nodeName)&&a.href?0:b}}}});va={get:function(a,c){var t=d.prop(a,c),h="boolean"==typeof t&&a.getAttribute(c);return(t="boolean"==typeof t?sb&&Ea?null!=h:Ia.test(c)?a[d.camelCase("default-"+c)]:!!h:a.getAttributeNode(c))&&!1!==t.value?c.toLowerCase():b},set:function(a,
b,c){return!1===b?d.removeAttr(a,c):sb&&Ea||!Ia.test(c)?a.setAttribute(!Ea&&d.propFix[c]||c,c):a[d.camelCase("default-"+c)]=a[c]=!0,c}};sb&&Ea||(d.attrHooks.value={get:function(a,c){var t=a.getAttributeNode(c);return d.nodeName(a,"input")?a.defaultValue:t&&t.specified?t.value:b},set:function(a,c,t){return d.nodeName(a,"input")?(a.defaultValue=c,b):xa&&xa.set(a,c,t)}});Ea||(xa=d.valHooks.button={get:function(a,d){var c=a.getAttributeNode(d);return c&&("id"===d||"name"===d||"coords"===d?""!==c.value:
...
d.event={global:{},add:function(a,c,h,u,e){var m,k,f,n,v,j,x,w,D;if(f=d._data(a)){h.handler&&(n=h,h=n.handler,e=n.selector);h.guid||(h.guid=d.guid++);(k=f.events)||(k=f.events={});(v=f.handle)||(v=f.handle=function(a){return typeof d===A||a&&d.event.triggered===a.type?b:d.event.dispatch.apply(v.elem,arguments)},v.elem=a);c=(c||"").match(Ba)||[""];for(f=c.length;f--;)m=Lb.exec(c[f])||[],w=j=m[1],D=(m[2]||"").split(".").sort(),m=d.event.special[w]||{},w=(e?m.delegateType:m.bindType)||w,m=d.event.special[w]||
{},j=d.extend({type:w,origType:j,data:u,handler:h,guid:h.guid,selector:e,needsContext:e&&d.expr.match.needsContext.test(e),namespace:D.join(".")},n),(x=k[w])||(x=k[w]=[],x.delegateCount=0,m.setup&&!1!==m.setup.call(a,u,D,v)||(a.addEventListener?a.addEventListener(w,v,!1):a.attachEvent&&a.attachEvent("on"+w,v))),m.add&&(m.add.call(a,j),j.handler.guid||(j.handler.guid=h.guid)),e?x.splice(x.delegateCount++,0,j):x.push(j),d.event.global[w]=!0;a=null}},remove:function(a,b,c,h,e){var m,k,f,n,v,j,x,w,A,
D,l,q=d.hasData(a)&&d._data(a);if(q&&(j=q.events)){b=(b||"").match(Ba)||[""];for(v=b.length;v--;)if(f=Lb.exec(b[v])||[],A=l=f[1],D=(f[2]||"").split(".").sort(),A){x=d.event.special[A]||{};A=(h?x.delegateType:x.bindType)||A;w=j[A]||[];f=f[2]&&RegExp("(^|\\.)"+D.join("\\.(?:.*\\.|)")+"(\\.|$)");for(n=m=w.length;m--;)k=w[m],!e&&l!==k.origType||c&&c.guid!==k.guid||f&&!f.test(k.namespace)||h&&h!==k.selector&&("**"!==h||!k.selector)||(w.splice(m,1),k.selector&&w.delegateCount--,x.remove&&x.remove.call(a,
k));n&&!w.length&&(x.teardown&&!1!==x.teardown.call(a,D,q.handle)||d.removeEvent(a,A,q.handle),delete j[A])}else for(A in j)d.event.remove(a,A+b[v],c,h,!0);d.isEmptyObject(j)&&(delete q.handle,d._removeData(a,"events"))}},trigger:function(g,c,h,u){var e,m,k,f,n,v,j=[h||F],x=G.call(g,"type")?g.type:g;v=G.call(g,"namespace")?g.namespace.split("."):[];if(k=e=h=h||F,3!==h.nodeType&&8!==h.nodeType&&!Kb.test(x+d.event.triggered)&&(0<=x.indexOf(".")&&(v=x.split("."),x=v.shift(),v.sort()),m=0>x.indexOf(":")&&
"on"+x,g=g[d.expando]?g:new d.Event(x,"object"==typeof g&&g),g.isTrigger=!0,g.namespace=v.join("."),g.namespace_re=g.namespace?RegExp("(^|\\.)"+v.join("\\.(?:.*\\.|)")+"(\\.|$)"):null,g.result=b,g.target||(g.target=h),c=null==c?[g]:d.makeArray(c,[g]),n=d.event.special[x]||{},u||!n.trigger||!1!==n.trigger.apply(h,c))){if(!u&&!n.noBubble&&!d.isWindow(h)){f=n.delegateType||x;for(Kb.test(f+x)||(k=k.parentNode);k;k=k.parentNode)j.push(k),e=k;e===(h.ownerDocument||F)&&j.push(e.defaultView||e.parentWindow||
a)}for(v=0;(k=j[v++])&&!g.isPropagationStopped();)g.type=1<v?f:n.bindType||x,(e=(d._data(k,"events")||{})[g.type]&&d._data(k,"handle"))&&e.apply(k,c),(e=m&&k[m])&&d.acceptData(k)&&e.apply&&!1===e.apply(k,c)&&g.preventDefault();if(g.type=x,!(u||g.isDefaultPrevented()||n._default&&!1!==n._default.apply(h.ownerDocument,c)||"click"===x&&d.nodeName(h,"a")||!d.acceptData(h)||!m||!h[x]||d.isWindow(h))){(e=h[m])&&(h[m]=null);d.event.triggered=x;try{h[x]()}catch(w){}d.event.triggered=b;e&&(h[m]=e)}return g.result}},
dispatch:function(a){a=d.event.fix(a);var c,h,u,e,m,k=[],f=ka.call(arguments);c=(d._data(this,"events")||{})[a.type]||[];var n=d.event.special[a.type]||{};if(f[0]=a,a.delegateTarget=this,!n.preDispatch||!1!==n.preDispatch.call(this,a)){k=d.event.handlers.call(this,a,c);for(c=0;(e=k[c++])&&!a.isPropagationStopped();){a.currentTarget=e.elem;for(m=0;(u=e.handlers[m++])&&!a.isImmediatePropagationStopped();)(!a.namespace_re||a.namespace_re.test(u.namespace))&&(a.handleObj=u,a.data=u.data,h=((d.event.special[u.origType]||
{}).handle||u.handler).apply(e.elem,f),h!==b&&!1===(a.result=h)&&(a.preventDefault(),a.stopPropagation()))}return n.postDispatch&&n.postDispatch.call(this,a),a.result}},handlers:function(a,c){var h,u,e,m,k=[],f=c.delegateCount,n=a.target;if(f&&n.nodeType&&(!a.button||"click"!==a.type))for(;n!=this;n=n.parentNode||this)if(1===n.nodeType&&(!0!==n.disabled||"click"!==a.type)){e=[];for(m=0;f>m;m++)u=c[m],h=u.selector+" ",e[h]===b&&(e[h]=u.needsContext?0<=d(h,this).index(n):d.find(h,this,null,[n]).length),
e[h]&&e.push(u);e.length&&k.push({elem:n,handlers:e})}return c.length>f&&k.push({elem:this,handlers:c.slice(f)}),k},fix:function(a){if(a[d.expando])return a;var b,c,h;b=a.type;var e=a,m=this.fixHooks[b];m||(this.fixHooks[b]=m=Tb.test(b)?this.mouseHooks:Pa.test(b)?this.keyHooks:{});h=m.props?this.props.concat(m.props):this.props;a=new d.Event(e);for(b=h.length;b--;)c=h[b],a[c]=e[c];return a.target||(a.target=e.srcElement||F),3===a.target.nodeType&&(a.target=a.target.parentNode),a.metaKey=!!a.metaKey,
m.filter?m.filter(a,e):a},props:"altKey bubbles cancelable ctrlKey currentTarget eventPhase metaKey relatedTarget shiftKey target timeStamp view which".split(" "),fixHooks:{},keyHooks:{props:["char","charCode","key","keyCode"],filter:function(a,b){return null==a.which&&(a.which=null!=b.charCode?b.charCode:b.keyCode),a}},mouseHooks:{props:"button buttons clientX clientY fromElement offsetX offsetY pageX pageY screenX screenY toElement".split(" "),filter:function(a,c){var d,h,e,m=c.button,k=c.fromElement;
return null==a.pageX&&null!=c.clientX&&(h=a.target.ownerDocument||F,e=h.documentElement,d=h.body,a.pageX=c.clientX+(e&&e.scrollLeft||d&&d.scrollLeft||0)-(e&&e.clientLeft||d&&d.clientLeft||0),a.pageY=c.clientY+(e&&e.scrollTop||d&&d.scrollTop||0)-(e&&e.clientTop||d&&d.clientTop||0)),!a.relatedTarget&&k&&(a.relatedTarget=k===a.target?c.toElement:k),a.which||m===b||(a.which=1&m?1:2&m?3:4&m?2:0),a}},special:{load:{noBubble:!0},click:{trigger:function(){return d.nodeName(this,"input")&&"checkbox"===this.type&&
...
a);a.isDefaultPrevented()&&c.preventDefault()}};d.removeEvent=F.removeEventListener?function(a,b,c){a.removeEventListener&&a.removeEventListener(b,c,!1)}:function(a,b,c){b="on"+b;a.detachEvent&&(typeof a[b]===A&&(a[b]=null),a.detachEvent(b,c))};d.Event=function(a,c){return this instanceof d.Event?(a&&a.type?(this.originalEvent=a,this.type=a.type,this.isDefaultPrevented=a.defaultPrevented||!1===a.returnValue||a.getPreventDefault&&a.getPreventDefault()?l:q):this.type=a,c&&d.extend(this,c),this.timeStamp=
a&&a.timeStamp||d.now(),this[d.expando]=!0,b):new d.Event(a,c)};d.Event.prototype={isDefaultPrevented:q,isPropagationStopped:q,isImmediatePropagationStopped:q,preventDefault:function(){var a=this.originalEvent;this.isDefaultPrevented=l;a&&(a.preventDefault?a.preventDefault():a.returnValue=!1)},stopPropagation:function(){var a=this.originalEvent;this.isPropagationStopped=l;a&&(a.stopPropagation&&a.stopPropagation(),a.cancelBubble=!0)},stopImmediatePropagation:function(){this.isImmediatePropagationStopped=
...
{setup:function(){0===c++&&F.addEventListener(a,h,!0)},teardown:function(){0===--c&&F.removeEventListener(a,h,!0)}}});d.fn.extend({on:function(a,c,h,e,m){var k,f;if("object"==typeof a){"string"!=typeof c&&(h=h||c,c=b);for(k in a)this.on(k,c,h,a[k],m);return this}if(null==h&&null==e?(e=c,h=c=b):null==e&&("string"==typeof c?(e=h,h=b):(e=h,h=c,c=b)),!1===e)e=q;else if(!e)return this;return 1===m&&(f=e,e=function(a){return d().off(a),f.apply(this,arguments)},e.guid=f.guid||(f.guid=d.guid++)),this.each(function(){d.event.add(this,
a,e,h,c)})},one:function(a,b,c,d){return this.on(a,b,c,d,1)},off:function(a,c,h){var e,m;if(a&&a.preventDefault&&a.handleObj)return e=a.handleObj,d(a.delegateTarget).off(e.namespace?e.origType+"."+e.namespace:e.origType,e.selector,e.handler),this;if("object"==typeof a){for(m in a)this.off(m,c,a[m]);return this}return(!1===c||"function"==typeof c)&&(h=c,c=b),!1===h&&(h=q),this.each(function(){d.event.remove(this,a,h,c)})},bind:function(a,b,c){return this.on(a,null,b,c)},unbind:function(a,b){return this.off(a,
null,b)},delegate:function(a,b,c,d){return this.on(b,a,c,d)},undelegate:function(a,b,c){return 1===arguments.length?this.off(a,"**"):this.off(b,a||"**",c)},trigger:function(a,b){return this.each(function(){d.event.trigger(a,b,this)})},triggerHandler:function(a,c){var h=this[0];return h?d.event.trigger(a,c,h,!0):b}});var ub=a,nb=function(){var a,b=[];return a=function(c,d){return b.push(c+=" ")>aa.cacheLength&&delete a[b.shift()],a[c]=d}},ya=function(a){return a[ma]=!0,a},Aa=function(a){var b=za.createElement("div");
try{return a(b)}catch(c){return!1}finally{}},Z=function(a,b,c,d){var h,e,m,k,f;if((b?b.ownerDocument||b:ob)!==za&&vb(b),b=b||za,c=c||[],!a||"string"!=typeof a)return c;if(1!==(k=b.nodeType)&&9!==k)return[];if(!La&&!d){if(h=Zc.exec(a))if(m=h[1])if(9===k){if(e=b.getElementById(m),!e||!e.parentNode)return c;if(e.id===m)return c.push(e),c}else{if(b.ownerDocument&&(e=b.ownerDocument.getElementById(m))&&Mb(b,e)&&e.id===m)return c.push(e),c}else{if(h[2])return wb.apply(c,xb.call(b.getElementsByTagName(a),
0)),c;if((m=h[3])&&pa.getByClassName&&b.getElementsByClassName)return wb.apply(c,xb.call(b.getElementsByClassName(m),0)),c}if(pa.qsa&&!Qa.test(a)){if(h=!0,e=ma,m=b,f=9===k&&a,1===k&&"object"!==b.nodeName.toLowerCase()){k=Ya(a);(h=b.getAttribute("id"))?e=h.replace($c,"\\$&"):b.setAttribute("id",e);e="[id='"+e+"'] ";for(m=k.length;m--;)k[m]=e+yb(k[m]);m=fc.test(a)&&b.parentNode||b;f=k.join(",")}if(f)try{return wb.apply(c,xb.call(m.querySelectorAll(f),0)),c}catch(n){}finally{h||b.removeAttribute("id")}}}var v;
a:{a=a.replace(Ub,"$1");var j,x;e=Ya(a);if(!d&&1===e.length){if(v=e[0]=e[0].slice(0),2<v.length&&"ID"===(j=v[0]).type&&9===b.nodeType&&!La&&aa.relative[v[1].type]){if(b=aa.find.ID(j.matches[0].replace(cb,db),b)[0],!b){v=c;break a}a=a.slice(v.shift().value.length)}for(k=Vb.needsContext.test(a)?0:v.length;k--&&!(j=v[k],aa.relative[h=j.type]);)if((x=aa.find[h])&&(d=x(j.matches[0].replace(cb,db),fc.test(v[0].type)&&b.parentNode||b))){if(v.splice(k,1),a=d.length&&yb(v),!a){v=(wb.apply(c,xb.call(d,0)),
c);break a}break}}v=(gc(a,e)(d,b,La,c,fc.test(a)),c)}return v},zb=function(a,b){var c=b&&a,d=c&&(~b.sourceIndex||wc)-(~a.sourceIndex||wc);if(d)return d;if(c)for(;c=c.nextSibling;)if(c===b)return-1;return a?1:-1},Ab=function(a){return function(b){return"input"===b.nodeName.toLowerCase()&&b.type===a}},Za=function(a){return function(b){var c=b.nodeName.toLowerCase();return("input"===c||"button"===c)&&b.type===a}},Ma=function(a){return ya(function(b){return b=+b,ya(function(c,d){for(var h,e=a([],c.length,
b),m=e.length;m--;)c[h=e[m]]&&(c[h]=!(d[h]=c[h]))})})},Ya=function(a,b){var c,d,h,e,m,k,f;if(m=xc[a+" "])return b?0:m.slice(0);m=a;k=[];for(f=aa.preFilter;m;){(!c||(d=ad.exec(m)))&&(d&&(m=m.slice(d[0].length)||m),k.push(h=[]));c=!1;(d=bd.exec(m))&&(c=d.shift(),h.push({value:c,type:d[0].replace(Ub," ")}),m=m.slice(c.length));for(e in aa.filter)!(d=Vb[e].exec(m))||f[e]&&!(d=f[e](d))||(c=d.shift(),h.push({value:c,type:e,matches:d}),m=m.slice(c.length));if(!c)break}return b?m.length:m?Z.error(a):xc(a,
k).slice(0)},yb=function(a){for(var b=0,c=a.length,d="";c>b;b++)d+=a[b].value;return d},Bb=function(a,b,c){var d=b.dir,h=c&&"parentNode"===d,e=cd++;return b.first?function(b,c,e){for(;b=b[d];)if(1===b.nodeType||h)return a(b,c,e)}:function(b,c,m){var t,k,z,f=Ra+" "+e;if(m)for(;b=b[d];){if((1===b.nodeType||h)&&a(b,c,m))return!0}else for(;b=b[d];)if(1===b.nodeType||h)if(z=b[ma]||(b[ma]={}),(k=z[d])&&k[0]===f){if(!0===(t=k[1])||t===Wb)return!0===t}else if(k=z[d]=[f],k[1]=a(b,c,m)||Wb,!0===k[1])return!0}},
Xb=function(a){return 1<a.length?function(b,c,d){for(var h=a.length;h--;)if(!a[h](b,c,d))return!1;return!0}:a[0]},Nb=function(a,b,c,d,h){for(var e,m=[],k=0,f=a.length,n=null!=b;f>k;k++)(e=a[k])&&(!c||c(e,d,h))&&(m.push(e),n&&b.push(k));return m},eb=function(a,b,c,d,h,e){return d&&!d[ma]&&(d=eb(d)),h&&!h[ma]&&(h=eb(h,e)),ya(function(e,m,k,f){var n,v,j=[],x=[],w=m.length,A;if(!(A=e)){A=b||"*";for(var qa=k.nodeType?[k]:k,D=[],q=0,l=qa.length;l>q;q++)Z(A,qa[q],D);A=D}A=!a||!e&&b?A:Nb(A,j,a,k,f);qa=c?
h||(e?a:w||d)?[]:m:A;if(c&&c(A,qa,k,f),d){n=Nb(qa,x);d(n,[],k,f);for(k=n.length;k--;)(v=n[k])&&(qa[x[k]]=!(A[x[k]]=v))}if(e){if(h||a){if(h){n=[];for(k=qa.length;k--;)(v=qa[k])&&n.push(A[k]=v);h(null,qa=[],n,f)}for(k=qa.length;k--;)(v=qa[k])&&-1<(n=h?hc.call(e,v):j[k])&&(e[n]=!(m[n]=v))}}else qa=Nb(qa===m?qa.splice(w,qa.length):qa),h?h(null,m,qa,f):wb.apply(m,qa)})},ic=function(a){var b,c,d,h=a.length,e=aa.relative[a[0].type];c=e||aa.relative[" "];for(var m=e?1:0,k=Bb(function(a){return a===b},c,!0),
f=Bb(function(a){return-1<hc.call(b,a)},c,!0),n=[function(a,g,c){return!e&&(c||g!==Yb)||((b=g).nodeType?k(a,g,c):f(a,g,c))}];h>m;m++)if(c=aa.relative[a[m].type])n=[Bb(Xb(n),c)];else{if(c=aa.filter[a[m].type].apply(null,a[m].matches),c[ma]){for(d=++m;h>d&&!aa.relative[a[d].type];d++);return eb(1<m&&Xb(n),1<m&&yb(a.slice(0,m-1)).replace(Ub,"$1"),c,d>m&&ic(a.slice(m,d)),h>d&&ic(a=a.slice(d)),h>d&&yb(a))}n.push(c)}return Xb(n)},yc=function(){},Cb,Wb,aa,Zb,zc,gc,Db,Yb,vb,za,Fa,La,Qa,Eb,$b,Mb,jc,ma="sizzle"+
...
a.getAttributeNode("id"))&&a.value===b}});aa.find.TAG=pa.tagNameNoComments?function(a,b){return"undefined"!==typeof b.getElementsByTagName?b.getElementsByTagName(a):void 0}:function(a,b){var g,c=[],d=0,h=b.getElementsByTagName(a);if("*"===a){for(;g=h[d++];)1===g.nodeType&&c.push(g);return c}return h};aa.find.NAME=pa.getByName&&function(a,b){return"undefined"!==typeof b.getElementsByName?b.getElementsByName(name):void 0};aa.find.CLASS=pa.getByClassName&&function(a,b){return"undefined"===typeof b.getElementsByClassName||
...
a+"([\\x20\\t\\r\\n\\f]|$)"))&&Ac(a,function(a){return b.test(a.className||"undefined"!==typeof a.getAttribute&&a.getAttribute("class")||"")})},ATTR:function(a,b,c){return function(d){d=Z.attr(d,a);return null==d?"!="===b:b?(d+="","="===b?d===c:"!="===b?d!==c:"^="===b?c&&0===d.indexOf(c):"*="===b?c&&-1<d.indexOf(c):"$="===b?c&&d.slice(-c.length)===c:"~="===b?-1<(" "+d+" ").indexOf(c):"|="===b?d===c||d.slice(0,c.length+1)===c+"-":!1):!0}},CHILD:function(a,b,c,d,h){var e="nth"!==a.slice(0,3),m="last"!==
a.slice(-4),k="of-type"===b;return 1===d&&0===h?function(a){return!!a.parentNode}:function(b,c,t){var f,z,n,v,j;c=e!==m?"nextSibling":"previousSibling";var x=b.parentNode,w=k&&b.nodeName.toLowerCase();t=!t&&!k;if(x){if(e){for(;c;){for(z=b;z=z[c];)if(k?z.nodeName.toLowerCase()===w:1===z.nodeType)return!1;j=c="only"===a&&!j&&"nextSibling"}return!0}if(j=[m?x.firstChild:x.lastChild],m&&t){t=x[ma]||(x[ma]={});f=t[a]||[];v=f[0]===Ra&&f[1];n=f[0]===Ra&&f[2];for(z=v&&x.childNodes[v];z=++v&&z&&z[c]||(n=v=
0)||j.pop();)if(1===z.nodeType&&++n&&z===b){t[a]=[Ra,v,n];break}}else if(t&&(f=(b[ma]||(b[ma]={}))[a])&&f[0]===Ra)n=f[1];else for(;(z=++v&&z&&z[c]||(n=v=0)||j.pop())&&(!(k?z.nodeName.toLowerCase()===w:1===z.nodeType)||!++n||!(t&&((z[ma]||(z[ma]={}))[a]=[Ra,n]),z===b)););return n-=h,n===d||0===n%d&&0<=n/d}}},PSEUDO:function(a,b){var c,d=aa.pseudos[a]||aa.setFilters[a.toLowerCase()]||Z.error("unsupported pseudo: "+a);return d[ma]?d(b):1<d.length?(c=[a,a,"",b],aa.setFilters.hasOwnProperty(a.toLowerCase())?
ya(function(a,g){for(var c,h=d(a,b),e=h.length;e--;)c=hc.call(a,h[e]),a[c]=!(g[c]=h[e])}):function(a){return d(a,0,c)}):d}},pseudos:{not:ya(function(a){var b=[],c=[],d=gc(a.replace(Ub,"$1"));return d[ma]?ya(function(a,b,c,g){var h;c=d(a,null,g,[]);for(g=a.length;g--;)(h=c[g])&&(a[g]=!(b[g]=h))}):function(a,g,h){return b[0]=a,d(b,null,h,c),!c.pop()}}),has:ya(function(a){return function(b){return 0<Z(a,b).length}}),contains:ya(function(a){return function(b){return-1<(b.textContent||b.innerText||Zb(b)).indexOf(a)}}),
...
c;c+=2)a.push(c);return a}),lt:Ma(function(a,b,c){for(b=0>c?c+b:c;0<=--b;)a.push(b);return a}),gt:Ma(function(a,b,c){for(c=0>c?c+b:c;b>++c;)a.push(c);return a})}};for(Cb in{radio:!0,checkbox:!0,file:!0,password:!0,image:!0})aa.pseudos[Cb]=Ab(Cb);for(Cb in{submit:!0,reset:!0})aa.pseudos[Cb]=Za(Cb);gc=Z.compile=function(a,b){var c,d=[],h=[],e=Bc[a+" "];if(!e){b||(b=Ya(a));for(c=b.length;c--;)e=ic(b[c]),e[ma]?d.push(e):h.push(e);var m=0,k=0<d.length,f=0<h.length;c=function(a,b,c,g,e){var t,n,z=[],v=
0,j="0",x=a&&[],w=null!=e,A=Yb,D=a||f&&aa.find.TAG("*",e&&b.parentNode||b),q=Ra+=null==A?1:Math.random()||0.1;for(w&&(Yb=b!==za&&b,Wb=m);null!=(e=D[j]);j++){if(f&&e){for(t=0;n=h[t++];)if(n(e,b,c)){g.push(e);break}w&&(Ra=q,Wb=++m)}k&&((e=!n&&e)&&v--,a&&x.push(e))}if(v+=j,k&&j!==v){for(t=0;n=d[t++];)n(x,z,b,c);if(a){if(0<v)for(;j--;)x[j]||z[j]||(z[j]=dd.call(g));z=Nb(z)}wb.apply(g,z);w&&!a&&0<z.length&&1<v+d.length&&Z.uniqueSort(g)}return w&&(Ra=q,Yb=A),x};c=k?ya(c):c;e=Bc(a,c)}return e};aa.pseudos.nth=
...
0;e>b;b++)if(d.contains(h[b],this))return!0}));c=[];for(b=0;e>b;b++)d.find(a,this[b],c);return c=this.pushStack(1<e?d.unique(c):c),c.selector=(this.selector?this.selector+" ":"")+a,c},has:function(a){var b,c=d(a,this),h=c.length;return this.filter(function(){for(b=0;h>b;b++)if(d.contains(this,c[b]))return!0})},not:function(a){return this.pushStack(T(this,a,!1))},filter:function(a){return this.pushStack(T(this,a,!0))},is:function(a){return!!a&&("string"==typeof a?Ec.test(a)?0<=d(a,this.context).index(this[0]):
0<d.filter(a,this).length:0<this.filter(a).length)},closest:function(a,b){for(var c,h=0,e=this.length,m=[],k=Ec.test(a)||"string"!=typeof a?d(a,b||this.context):0;e>h;h++)for(c=this[h];c&&c.ownerDocument&&c!==b&&11!==c.nodeType;){if(k?-1<k.index(c):d.find.matchesSelector(c,a)){m.push(c);break}c=c.parentNode}return this.pushStack(1<m.length?d.unique(m):m)},index:function(a){return a?"string"==typeof a?d.inArray(this[0],d(a)):d.inArray(a.jquery?a[0]:a,this):this[0]&&this[0].parentNode?this.first().prevAll().length:
...
(d.cleanData(s(c,!1)),c.innerHTML=a);c=0}catch(e){}}c&&this.empty().append(a)},null,a,arguments.length)},replaceWith:function(a){return d.isFunction(a)||"string"==typeof a||(a=d(a).not(this).detach()),this.domManip([a],!0,function(a){var b=this.nextSibling,c=this.parentNode;c&&(d(this).remove(),c.insertBefore(a,b))})},detach:function(a){return this.remove(a,!0)},domManip:function(a,c,h){a=da.apply([],a);var e,m,k,f,n=0,v=this.length,j=this,x=v-1,w=a[0],A=d.isFunction(w);if(A||!(1>=v||"string"!=typeof w||
d.support.checkClone)&&qd.test(w))return this.each(function(d){var e=j.eq(d);A&&(a[0]=w.call(this,d,c?e.html():b));e.domManip(a,c,h)});if(v&&(f=d.buildFragment(a,this[0].ownerDocument,!1,this),e=f.firstChild,1===f.childNodes.length&&(f=e),e)){c=c&&d.nodeName(e,"tr");k=d.map(s(f,"script"),y);for(m=k.length;v>n;n++)e=f,n!==x&&(e=d.clone(e,!0,!0),m&&d.merge(k,s(e,"script"))),h.call(c&&d.nodeName(this[n],"table")?this[n].getElementsByTagName("tbody")[0]||this[n].appendChild(this[n].ownerDocument.createElement("tbody")):
this[n],e,n);if(m){f=k[k.length-1].ownerDocument;d.map(k,B);for(n=0;m>n;n++)e=k[n],Jc.test(e.type||"")&&!d._data(e,"globalEval")&&d.contains(f,e)&&(e.src?d.ajax({url:e.src,type:"GET",dataType:"script",async:!1,global:!1,"throws":!0}):d.globalEval((e.text||e.textContent||e.innerHTML||"").replace(rd,"")))}f=e=null}return this}});d.each({appendTo:"append",prependTo:"prepend",insertBefore:"before",insertAfter:"after",replaceAll:"replaceWith"},function(a,b){d.fn[a]=function(a){for(var c=0,g=[],h=d(a),
e=h.length-1;e>=c;c++)a=c===e?this:this.clone(!0),d(h[c])[b](a),ta.apply(g,a.get());return this.pushStack(g)}});d.extend({clone:function(a,b,c){var h,e,m,k,f,n=d.contains(a.ownerDocument,a);if(d.support.html5Clone||d.isXMLDoc(a)||!Fc.test("<"+a.nodeName+">")?m=a.cloneNode(!0):(nc.innerHTML=a.outerHTML,nc.removeChild(m=nc.firstChild)),!(d.support.noCloneEvent&&d.support.noCloneChecked||1!==a.nodeType&&11!==a.nodeType||d.isXMLDoc(a))){h=s(m);f=s(a);for(k=0;null!=(e=f[k]);++k)if(h[k]){var v=h[k],j=void 0,
x=void 0,w=void 0;if(1===v.nodeType){if(j=v.nodeName.toLowerCase(),!d.support.noCloneEvent&&v[d.expando]){w=d._data(v);for(x in w.events)d.removeEvent(v,x,w.handle);v.removeAttribute(d.expando)}"script"===j&&v.text!==e.text?(y(v).text=e.text,B(v)):"object"===j?(v.parentNode&&(v.outerHTML=e.outerHTML),d.support.html5Clone&&e.innerHTML&&!d.trim(v.innerHTML)&&(v.innerHTML=e.innerHTML)):"input"===j&&cc.test(e.type)?(v.defaultChecked=v.checked=e.checked,v.value!==e.value&&(v.value=e.value)):"option"===
j?v.defaultSelected=v.selected=e.defaultSelected:("input"===j||"textarea"===j)&&(v.defaultValue=e.defaultValue)}}}if(b)if(c){f=f||s(a);h=h||s(m);for(k=0;null!=(e=f[k]);k++)X(e,h[k])}else X(a,m);return h=s(m,"script"),0<h.length&&N(h,!n&&s(a,"script")),m},buildFragment:function(a,b,c,h){for(var e,m,k,f,n,v,j,x=a.length,w=W(b),A=[],D=0;x>D;D++)if(m=a[D],m||0===m)if("object"===d.type(m))d.merge(A,m.nodeType?[m]:m);else if(od.test(m)){f=f||w.appendChild(b.createElement("div"));n=(Hc.exec(m)||["",""])[1].toLowerCase();
j=Ja[n]||Ja._default;f.innerHTML=j[1]+m.replace(Gc,"<$1></$2>")+j[2];for(e=j[0];e--;)f=f.lastChild;if(!d.support.leadingWhitespace&&mc.test(m)&&A.push(b.createTextNode(mc.exec(m)[0])),!d.support.tbody)for(e=(m="table"!==n||Ic.test(m)?"<table>"!==j[1]||Ic.test(m)?0:f:f.firstChild)&&m.childNodes.length;e--;)d.nodeName(v=m.childNodes[e],"tbody")&&!v.childNodes.length&&m.removeChild(v);d.merge(A,f.childNodes);for(f.textContent="";f.firstChild;)f.removeChild(f.firstChild);f=w.lastChild}else A.push(b.createTextNode(m));
f&&w.removeChild(f);d.support.appendChecked||d.grep(s(A,"input"),U);for(D=0;m=A[D++];)if((!h||-1===d.inArray(m,h))&&(k=d.contains(m.ownerDocument,m),f=s(w.appendChild(m),"script"),k&&N(f),c))for(e=0;m=f[e++];)Jc.test(m.type||"")&&c.push(m);return w},cleanData:function(a,b){for(var c,h,e,m,k=0,f=d.expando,n=d.cache,v=d.support.deleteExpando,j=d.event.special;null!=(c=a[k]);k++)if((b||d.acceptData(c))&&(e=c[f],m=e&&n[e])){if(m.events)for(h in m.events)j[h]?d.event.remove(c,h):d.removeEvent(c,h,m.handle);
n[e]&&(delete n[e],v?delete c[f]:typeof c.removeAttribute!==A?c.removeAttribute(f):c[f]=null,Ca.push(e))}}});var Gb,hb,ib,oc=/alpha\([^)]*\)/i,sd=/opacity\s*=\s*([^)]*)/,td=/^(top|right|bottom|left)$/,ud=/^(none|table(?!-c[ea]).+)/,Kc=/^margin/,Wc=RegExp("^("+Da+")(.*)$","i"),Pb=RegExp("^("+Da+")(?!px)[a-z%]+$","i"),vd=RegExp("^([+-])=("+Da+")","i"),vc={BODY:"block"},wd={position:"absolute",visibility:"hidden",display:"block"},Lc={letterSpacing:0,fontWeight:400},gb=["Top","Right","Bottom","Left"],
uc=["Webkit","O","Moz","ms"];d.fn.extend({css:function(a,c){return d.access(this,function(a,c,g){var h,e={},m=0;if(d.isArray(c)){h=hb(a);for(g=c.length;g>m;m++)e[c[m]]=d.css(a,c[m],!1,h);return e}return g!==b?d.style(a,c,g):d.css(a,c)},a,c,1<arguments.length)},show:function(){return I(this,!0)},hide:function(){return I(this)},toggle:function(a){var b="boolean"==typeof a;return this.each(function(){(b?a:V(this))?d(this).show():d(this).hide()})}});d.extend({cssHooks:{opacity:{get:function(a,b){if(b){var c=
ib(a,"opacity");return""===c?"1":c}}}},cssNumber:{columnCount:!0,fillOpacity:!0,fontWeight:!0,lineHeight:!0,opacity:!0,orphans:!0,widows:!0,zIndex:!0,zoom:!0},cssProps:{"float":d.support.cssFloat?"cssFloat":"styleFloat"},style:function(a,c,h,e){if(a&&3!==a.nodeType&&8!==a.nodeType&&a.style){var m,k,f,n=d.camelCase(c),v=a.style;if(c=d.cssProps[n]||(d.cssProps[n]=K(v,n)),f=d.cssHooks[c]||d.cssHooks[n],h===b)return f&&"get"in f&&(m=f.get(a,!1,e))!==b?m:v[c];if(k=typeof h,"string"===k&&(m=vd.exec(h))&&
(h=(m[1]+1)*m[2]+parseFloat(d.css(a,c)),k="number"),!(null==h||"number"===k&&isNaN(h)||("number"!==k||d.cssNumber[n]||(h+="px"),d.support.clearCloneStyle||""!==h||0!==c.indexOf("background")||(v[c]="inherit"),f&&"set"in f&&(h=f.set(a,h,e))===b)))try{v[c]=h}catch(j){}}},css:function(a,c,h,e){var m,k,f,n=d.camelCase(c);return c=d.cssProps[n]||(d.cssProps[n]=K(a.style,n)),f=d.cssHooks[c]||d.cssHooks[n],f&&"get"in f&&(k=f.get(a,!0,h)),k===b&&(k=ib(a,c,e)),"normal"===k&&c in Lc&&(k=Lc[c]),""===h||h?(m=
parseFloat(k),!0===h||d.isNumeric(m)?m||0:k):k},swap:function(a,b,c,d){var h,e={};for(h in b)e[h]=a.style[h],a.style[h]=b[h];c=c.apply(a,d||[]);for(h in b)a.style[h]=e[h];return c}});a.getComputedStyle?(hb=function(b){return a.getComputedStyle(b,null)},ib=function(a,c,h){var e,m,k,f=(h=h||hb(a))?h.getPropertyValue(c)||h[c]:b,n=a.style;return h&&(""!==f||d.contains(a.ownerDocument,a)||(f=d.style(a,c)),Pb.test(f)&&Kc.test(c)&&(e=n.width,m=n.minWidth,k=n.maxWidth,n.minWidth=n.maxWidth=n.width=f,f=h.width,
n.width=e,n.minWidth=m,n.maxWidth=k)),f}):F.documentElement.currentStyle&&(hb=function(a){return a.currentStyle},ib=function(a,c,d){var h,e,m;d=(d=d||hb(a))?d[c]:b;var k=a.style;return null==d&&k&&k[c]&&(d=k[c]),Pb.test(d)&&!td.test(c)&&(h=k.left,e=a.runtimeStyle,m=e&&e.left,m&&(e.left=a.currentStyle.left),k.left="fontSize"===c?"1em":d,d=k.pixelLeft+"px",k.left=h,m&&(e.left=m)),""===d?"auto":d});d.each(["height","width"],function(a,c){d.cssHooks[c]={get:function(a,h,g){return h?0===a.offsetWidth&&
ud.test(d.css(a,"display"))?d.swap(a,wd,function(){return R(a,c,g)}):R(a,c,g):b},set:function(a,b,h){var g=h&&hb(a);return j(a,b,h?C(a,c,h,d.support.boxSizing&&"border-box"===d.css(a,"boxSizing",!1,g),g):0)}}});d.support.opacity||(d.cssHooks.opacity={get:function(a,b){return sd.test((b&&a.currentStyle?a.currentStyle.filter:a.style.filter)||"")?0.01*parseFloat(RegExp.$1)+"":b?"1":""},set:function(a,b){var c=a.style,h=a.currentStyle,e=d.isNumeric(b)?"alpha(opacity="+100*b+")":"",m=h&&h.filter||c.filter||
"";c.zoom=1;(1<=b||""===b)&&""===d.trim(m.replace(oc,""))&&c.removeAttribute&&(c.removeAttribute("filter"),""===b||h&&!h.filter)||(c.filter=oc.test(m)?m.replace(oc,e):m+" "+e)}});d(function(){d.support.reliableMarginRight||(d.cssHooks.marginRight={get:function(a,c){return c?d.swap(a,{display:"inline-block"},ib,[a,"marginRight"]):b}});!d.support.pixelPosition&&d.fn.position&&d.each(["top","left"],function(a,c){d.cssHooks[c]={get:function(a,h){return h?(h=ib(a,c),Pb.test(h)?d(a).position()[c]+"px":
h):b}}})});d.expr&&d.expr.filters&&(d.expr.filters.hidden=function(a){return 0>=a.offsetWidth&&0>=a.offsetHeight||!d.support.reliableHiddenOffsets&&"none"===(a.style&&a.style.display||d.css(a,"display"))},d.expr.filters.visible=function(a){return!d.expr.filters.hidden(a)});d.each({margin:"",padding:"",border:"Width"},function(a,b){d.cssHooks[a+b]={expand:function(c){var d=0,h={};for(c="string"==typeof c?c.split(" "):[c];4>d;d++)h[a+gb[d]+b]=c[d]||c[d-2]||c[0];return h}};Kc.test(a)||(d.cssHooks[a+
...
return null==c?null:d.isArray(c)?d.map(c,function(a){return{name:b.name,value:a.replace(Mc,"\r\n")}}):{name:b.name,value:c.replace(Mc,"\r\n")}}).get()}});d.param=function(a,c){var h,e=[],m=function(a,b){b=d.isFunction(b)?b():null==b?"":b;e[e.length]=encodeURIComponent(a)+"="+encodeURIComponent(b)};if(c===b&&(c=d.ajaxSettings&&d.ajaxSettings.traditional),d.isArray(a)||a.jquery&&!d.isPlainObject(a))d.each(a,function(){m(this.name,this.value)});else for(h in a)H(h,a[h],c,m);return e.join("&").replace(xd,
"+")};d.each("blur focus focusin focusout load resize scroll unload click dblclick mousedown mouseup mousemove mouseover mouseout mouseenter mouseleave change select submit keydown keypress keyup error contextmenu".split(" "),function(a,b){d.fn[b]=function(a,c){return 0<arguments.length?this.on(b,null,a,c):this.trigger(b)}});d.fn.hover=function(a,b){return this.mouseenter(a).mouseleave(b||a)};var pb,fb,pc=d.now(),qc=/\?/,Ad=/#.*$/,Nc=/([?&])_=[^&]*/,Bd=/^(.*?):[ \t]*([^\r\n]*)\r?$/gm,Cd=/^(?:GET|HEAD)$/,
Dd=/^\/\//,Oc=/^([\w.+-]+:)(?:\/\/([^\/?#:]*)(?::(\d+)|)|)/,Pc=d.fn.load,Qc={},dc={},Rc="*/".concat("*");try{fb=ga.href}catch(Jd){fb=F.createElement("a"),fb.href="",fb=fb.href}pb=Oc.exec(fb.toLowerCase())||[];d.fn.load=function(a,c,h){if("string"!=typeof a&&Pc)return Pc.apply(this,arguments);var e,m,k,f=this,n=a.indexOf(" ");return 0<=n&&(e=a.slice(n,a.length),a=a.slice(0,n)),d.isFunction(c)?(h=c,c=b):c&&"object"==typeof c&&(k="POST"),0<f.length&&d.ajax({url:a,type:k,dataType:"html",data:c}).done(function(a){m=
arguments;f.html(e?d("<div>").append(d.parseHTML(a)).find(e):a)}).complete(h&&function(a,b){f.each(h,m||[a.responseText,b,a])}),this};d.each("ajaxStart ajaxStop ajaxComplete ajaxError ajaxSuccess ajaxSend".split(" "),function(a,b){d.fn[b]=function(a){return this.on(b,a)}});d.each(["get","post"],function(a,c){d[c]=function(a,h,g,e){return d.isFunction(h)&&(e=e||g,g=h,h=b),d.ajax({url:a,type:c,dataType:e,data:h,success:g})}});d.extend({active:0,lastModified:{},etag:{},ajaxSettings:{url:fb,type:"GET",
...
context:!0}},ajaxSetup:function(a,b){return b?fa(fa(a,d.ajaxSettings),b):fa(d.ajaxSettings,a)},ajaxPrefilter:S(Qc),ajaxTransport:S(dc),ajax:function(a,c){function h(a,c,g,e){var m,x,t,u,z,O=c;if(2!==G){G=2;n&&clearTimeout(n);j=b;f=e||"";p.readyState=0<a?4:0;if(g){u=w;e=p;var s,F,C,r,Oa=u.contents,ga=u.dataTypes,Ta=u.responseFields;for(r in Ta)r in g&&(e[Ta[r]]=g[r]);for(;"*"===ga[0];)ga.shift(),F===b&&(F=u.mimeType||e.getResponseHeader("Content-Type"));if(F)for(r in Oa)if(Oa[r]&&Oa[r].test(F)){ga.unshift(r);
break}if(ga[0]in g)C=ga[0];else{for(r in g){if(!ga[0]||u.converters[r+" "+ga[0]]){C=r;break}s||(s=r)}C=C||s}u=C?(C!==ga[0]&&ga.unshift(C),g[C]):b}if(200<=a&&300>a||304===a)if(w.ifModified&&(z=p.getResponseHeader("Last-Modified"),z&&(d.lastModified[k]=z),z=p.getResponseHeader("etag"),z&&(d.etag[k]=z)),204===a)m=!0,O="nocontent";else if(304===a)m=!0,O="notmodified";else{var B;a:{g=w;m=u;var H,Ia;t={};z=0;O=g.dataTypes.slice();s=O[0];if(g.dataFilter&&(m=g.dataFilter(m,g.dataType)),O[1])for(H in g.converters)t[H.toLowerCase()]=
g.converters[H];for(;x=O[++z];)if("*"!==x){if("*"!==s&&s!==x){if(H=t[s+" "+x]||t["* "+x],!H)for(B in t)if(Ia=B.split(" "),Ia[1]===x&&(H=t[s+" "+Ia[0]]||t["* "+Ia[0]])){!0===H?H=t[B]:!0!==t[B]&&(x=Ia[0],O.splice(z--,0,x));break}if(!0!==H)if(H&&g["throws"])m=H(m);else try{m=H(m)}catch(R){B={state:"parsererror",error:H?R:"No conversion from "+s+" to "+x};break a}}s=x}B={state:"success",data:m}}m=B;O=m.state;x=m.data;t=m.error;m=!t}else t=O,(a||!O)&&(O="error",0>a&&(a=0));p.status=a;p.statusText=(c||
O)+"";m?q.resolveWith(A,[x,O,p]):q.rejectWith(A,[p,O,t]);p.statusCode(Xa);Xa=b;v&&D.trigger(m?"ajaxSuccess":"ajaxError",[p,w,m?x:t]);l.fireWith(A,[p,O]);v&&(D.trigger("ajaxComplete",[p,w]),--d.active||d.event.trigger("ajaxStop"))}}"object"==typeof a&&(c=a,a=b);c=c||{};var e,m,k,f,n,v,j,x,w=d.ajaxSetup({},c),A=w.context||w,D=w.context&&(A.nodeType||A.jquery)?d(A):d.event,q=d.Deferred(),l=d.Callbacks("once memory"),Xa=w.statusCode||{},O={},s={},G=0,F="canceled",p={readyState:0,getResponseHeader:function(a){var b;
if(2===G){if(!x)for(x={};b=Bd.exec(f);)x[b[1].toLowerCase()]=b[2];b=x[a.toLowerCase()]}return null==b?null:b},getAllResponseHeaders:function(){return 2===G?f:null},setRequestHeader:function(a,b){var c=a.toLowerCase();return G||(a=s[c]=s[c]||a,O[a]=b),this},overrideMimeType:function(a){return G||(w.mimeType=a),this},statusCode:function(a){var b;if(a)if(2>G)for(b in a)Xa[b]=[Xa[b],a[b]];else p.always(a[p.status]);return this},abort:function(a){a=a||F;return j&&j.abort(a),h(0,a),this}};if(q.promise(p).complete=
l.add,p.success=p.done,p.error=p.fail,w.url=((a||w.url||fb)+"").replace(Ad,"").replace(Dd,pb[1]+"//"),w.type=c.method||c.type||w.method||w.type,w.dataTypes=d.trim(w.dataType||"*").toLowerCase().match(Ba)||[""],null==w.crossDomain&&(e=Oc.exec(w.url.toLowerCase()),w.crossDomain=!(!e||e[1]===pb[1]&&e[2]===pb[2]&&(e[3]||("http:"===e[1]?80:443))==(pb[3]||("http:"===pb[1]?80:443)))),w.data&&w.processData&&"string"!=typeof w.data&&(w.data=d.param(w.data,w.traditional)),P(Qc,w,c,p),2===G)return p;(v=w.global)&&
0===d.active++&&d.event.trigger("ajaxStart");w.type=w.type.toUpperCase();w.hasContent=!Cd.test(w.type);k=w.url;w.hasContent||(w.data&&(k=w.url+=(qc.test(k)?"&":"?")+w.data,delete w.data),!1===w.cache&&(w.url=Nc.test(k)?k.replace(Nc,"$1_="+pc++):k+(qc.test(k)?"&":"?")+"_="+pc++));w.ifModified&&(d.lastModified[k]&&p.setRequestHeader("If-Modified-Since",d.lastModified[k]),d.etag[k]&&p.setRequestHeader("If-None-Match",d.etag[k]));(w.data&&w.hasContent&&!1!==w.contentType||c.contentType)&&p.setRequestHeader("Content-Type",
w.contentType);p.setRequestHeader("Accept",w.dataTypes[0]&&w.accepts[w.dataTypes[0]]?w.accepts[w.dataTypes[0]]+("*"!==w.dataTypes[0]?", "+Rc+"; q=0.01":""):w.accepts["*"]);for(m in w.headers)p.setRequestHeader(m,w.headers[m]);if(w.beforeSend&&(!1===w.beforeSend.call(A,p,w)||2===G))return p.abort();F="abort";for(m in{success:1,error:1,complete:1})p[m](w[m]);if(j=P(dc,w,c,p)){p.readyState=1;v&&D.trigger("ajaxSend",[p,w]);w.async&&0<w.timeout&&(n=setTimeout(function(){p.abort("timeout")},w.timeout));
try{G=1,j.send(O,h)}catch(C){if(!(2>G))throw C;h(-1,C)}}else h(-1,"No Transport");return p},getScript:function(a,c){return d.get(a,b,c,"script")},getJSON:function(a,b,c){return d.get(a,b,c,"json")}});d.ajaxSetup({accepts:{script:"text/javascript, application/javascript, application/ecmascript, application/x-ecmascript"},contents:{script:/(?:java|ecma)script/},converters:{"text script":function(a){return d.globalEval(a),a}}});d.ajaxPrefilter("script",function(a){a.cache===b&&(a.cache=!1);a.crossDomain&&
...
c.onload(b,!0)}}}});var Sc=[],rc=/(=)\?(?=&|$)|\?\?/;d.ajaxSetup({jsonp:"callback",jsonpCallback:function(){var a=Sc.pop()||d.expando+"_"+pc++;return this[a]=!0,a}});d.ajaxPrefilter("json jsonp",function(c,h,e){var m,k,f,n=!1!==c.jsonp&&(rc.test(c.url)?"url":"string"==typeof c.data&&!(c.contentType||"").indexOf("application/x-www-form-urlencoded")&&rc.test(c.data)&&"data");return n||"jsonp"===c.dataTypes[0]?(m=c.jsonpCallback=d.isFunction(c.jsonpCallback)?c.jsonpCallback():c.jsonpCallback,n?c[n]=
c[n].replace(rc,"$1"+m):!1!==c.jsonp&&(c.url+=(qc.test(c.url)?"&":"?")+c.jsonp+"="+m),c.converters["script json"]=function(){return f||d.error(m+" was not called"),f[0]},c.dataTypes[0]="json",k=a[m],a[m]=function(){f=arguments},e.always(function(){a[m]=k;c[m]&&(c.jsonpCallback=h.jsonpCallback,Sc.push(m));f&&d.isFunction(k)&&k(f[0]);f=k=b}),"script"):b});var Fb,Ob,Ed=0,sc=a.ActiveXObject&&function(){for(var a in Fb)Fb[a](b,!0)};d.ajaxSettings.xhr=a.ActiveXObject?function(){var b;if(!(b=!this.isLocal&&
ha()))a:{try{b=new a.ActiveXObject("Microsoft.XMLHTTP");break a}catch(c){}b=void 0}return b}:ha;Ob=d.ajaxSettings.xhr();d.support.cors=!!Ob&&"withCredentials"in Ob;(Ob=d.support.ajax=!!Ob)&&d.ajaxTransport(function(c){if(!c.crossDomain||d.support.cors){var h;return{send:function(e,m){var k,f,n=c.xhr();if(c.username?n.open(c.type,c.url,c.async,c.username,c.password):n.open(c.type,c.url,c.async),c.xhrFields)for(f in c.xhrFields)n[f]=c.xhrFields[f];c.mimeType&&n.overrideMimeType&&n.overrideMimeType(c.mimeType);
c.crossDomain||e["X-Requested-With"]||(e["X-Requested-With"]="XMLHttpRequest");try{for(f in e)n.setRequestHeader(f,e[f])}catch(v){}n.send(c.hasContent&&c.data||null);h=function(a,e){var f,v,j,w;try{if(h&&(e||4===n.readyState))if(h=b,k&&(n.onreadystatechange=d.noop,sc&&delete Fb[k]),e)4!==n.readyState&&n.abort();else{w={};f=n.status;v=n.getAllResponseHeaders();"string"==typeof n.responseText&&(w.text=n.responseText);try{j=n.statusText}catch(x){j=""}f||!c.isLocal||c.crossDomain?1223===f&&(f=204):f=
w.text?200:404}}catch(A){e||m(-1,A)}w&&m(f,j,w,v)};c.async?4===n.readyState?setTimeout(h):(k=++Ed,sc&&(Fb||(Fb={},d(a).unload(sc)),Fb[k]=h),n.onreadystatechange=h):h()},abort:function(){h&&h(b,!0)}}}});var qb,bc,Fd=/^(?:toggle|show|hide)$/,Gd=RegExp("^(?:([+-])=|)("+Da+")([a-z%]*)$","i"),Hd=/queueHooks$/,Qb=[function(a,b,c){var h,e,m,k,f,n,v=this,j=a.style,w={},x=[],A=a.nodeType&&V(a);c.queue||(f=d._queueHooks(a,"fx"),null==f.unqueued&&(f.unqueued=0,n=f.empty.fire,f.empty.fire=function(){f.unqueued||
n()}),f.unqueued++,v.always(function(){v.always(function(){f.unqueued--;d.queue(a,"fx").length||f.empty.fire()})}));1===a.nodeType&&("height"in b||"width"in b)&&(c.overflow=[j.overflow,j.overflowX,j.overflowY],"inline"===d.css(a,"display")&&"none"===d.css(a,"float")&&(d.support.inlineBlockNeedsLayout&&"inline"!==ca(a.nodeName)?j.zoom=1:j.display="inline-block"));c.overflow&&(j.overflow="hidden",d.support.shrinkWrapBlocks||v.always(function(){j.overflow=c.overflow[0];j.overflowX=c.overflow[1];j.overflowY=
c.overflow[2]}));for(e in b)if(m=b[e],Fd.exec(m))(delete b[e],h=h||"toggle"===m,m===(A?"hide":"show"))||x.push(e);if(b=x.length){m=d._data(a,"fxshow")||d._data(a,"fxshow",{});"hidden"in m&&(A=m.hidden);h&&(m.hidden=!A);A?d(a).show():v.done(function(){d(a).hide()});v.done(function(){var b;d._removeData(a,"fxshow");for(b in w)d.style(a,b,w[b])});for(e=0;b>e;e++)h=x[e],k=v.createTween(h,A?m[h]:0),w[h]=m[h]||d.style(a,h),h in m||(m[h]=k.start,A&&(k.end=k.start,k.start="width"===h||"height"===h?1:0))}}],
Hb={"*":[function(a,b){var c,h,e=this.createTween(a,b),m=Gd.exec(b),k=e.cur(),f=+k||0,n=1,v=20;if(m){if(c=+m[2],h=m[3]||(d.cssNumber[a]?"":"px"),"px"!==h&&f){f=d.css(e.elem,a,!0)||c||1;do n=n||".5",f/=n,d.style(e.elem,a,f+h);while(n!==(n=e.cur()/k)&&1!==n&&--v)}e.unit=h;e.start=f;e.end=m[1]?f+(m[1]+1)*c:c}return e}]};d.Animation=d.extend(ia,{tweener:function(a,b){d.isFunction(a)?(b=a,a=["*"]):a=a.split(" ");for(var c,h=0,e=a.length;e>h;h++)c=a[h],Hb[c]=Hb[c]||[],Hb[c].unshift(b)},prefilter:function(a,
b){b?Qb.unshift(a):Qb.push(a)}});d.Tween=Y;Y.prototype={constructor:Y,init:function(a,b,c,h,e,m){this.elem=a;this.prop=c;this.easing=e||"swing";this.options=b;this.start=this.now=this.cur();this.end=h;this.unit=m||(d.cssNumber[c]?"":"px")},cur:function(){var a=Y.propHooks[this.prop];return a&&a.get?a.get(this):Y.propHooks._default.get(this)},run:function(a){var b,c=Y.propHooks[this.prop];return this.pos=b=this.options.duration?d.easing[this.easing](a,this.options.duration*a,0,1,this.options.duration):
...
d.isEmptyObject(a),m=d.speed(b,c,h),k=function(){var b=ia(this,d.extend({},a),m);k.finish=function(){b.stop(!0)};(e||d._data(this,"finish"))&&b.stop(!0)};return k.finish=k,e||!1===m.queue?this.each(k):this.queue(m.queue,k)},stop:function(a,c,h){var e=function(a){var b=a.stop;delete a.stop;b(h)};return"string"!=typeof a&&(h=c,c=a,a=b),c&&!1!==a&&this.queue(a||"fx",[]),this.each(function(){var b=!0,c=null!=a&&a+"queueHooks",m=d.timers,k=d._data(this);if(c)k[c]&&k[c].stop&&e(k[c]);else for(c in k)k[c]&&
k[c].stop&&Hd.test(c)&&e(k[c]);for(c=m.length;c--;)m[c].elem!==this||null!=a&&m[c].queue!==a||(m[c].anim.stop(h),b=!1,m.splice(c,1));(b||!h)&&d.dequeue(this,a)})},finish:function(a){return!1!==a&&(a=a||"fx"),this.each(function(){var b,c=d._data(this),h=c[a+"queue"];b=c[a+"queueHooks"];var e=d.timers,m=h?h.length:0;c.finish=!0;d.queue(this,a,[]);b&&b.cur&&b.cur.finish&&b.cur.finish.call(this);for(b=e.length;b--;)e[b].elem===this&&e[b].queue===a&&(e[b].anim.stop(!0),e.splice(b,1));for(b=0;m>b;b++)h[b]&&
...
d.timers.push(a)&&d.fx.start()};d.fx.interval=13;d.fx.start=function(){bc||(bc=setInterval(d.fx.tick,d.fx.interval))};d.fx.stop=function(){clearInterval(bc);bc=null};d.fx.speeds={slow:600,fast:200,_default:400};d.fx.step={};d.expr&&d.expr.filters&&(d.expr.filters.animated=function(a){return d.grep(d.timers,function(b){return a===b.elem}).length});d.fn.offset=function(a){if(arguments.length)return a===b?this:this.each(function(b){d.offset.setOffset(this,a,b)});var c,h,e={top:0,left:0},m=this[0],k=
m&&m.ownerDocument;if(k)return c=k.documentElement,d.contains(c,m)?(typeof m.getBoundingClientRect!==A&&(e=m.getBoundingClientRect()),h=D(k),{top:e.top+(h.pageYOffset||c.scrollTop)-(c.clientTop||0),left:e.left+(h.pageXOffset||c.scrollLeft)-(c.clientLeft||0)}):e};d.offset={setOffset:function(a,b,c){var h=d.css(a,"position");"static"===h&&(a.style.position="relative");var e=d(a),m=e.offset(),k=d.css(a,"top"),f=d.css(a,"left"),n={},v={},j,w;("absolute"===h||"fixed"===h)&&-1<d.inArray("auto",[k,f])?(v=
e.position(),j=v.top,w=v.left):(j=parseFloat(k)||0,w=parseFloat(f)||0);d.isFunction(b)&&(b=b.call(a,c,m));null!=b.top&&(n.top=b.top-m.top+j);null!=b.left&&(n.left=b.left-m.left+w);"using"in b?b.using.call(a,n):e.css(n)}};d.fn.extend({position:function(){if(this[0]){var a,b,c={top:0,left:0},h=this[0];return"fixed"===d.css(h,"position")?b=h.getBoundingClientRect():(a=this.offsetParent(),b=this.offset(),d.nodeName(a[0],"html")||(c=a.offset()),c.top+=d.css(a[0],"borderTopWidth",!0),c.left+=d.css(a[0],
"borderLeftWidth",!0)),{top:b.top-c.top-d.css(h,"marginTop",!0),left:b.left-c.left-d.css(h,"marginLeft",!0)}}},offsetParent:function(){return this.map(function(){for(var a=this.offsetParent||F.documentElement;a&&!d.nodeName(a,"html")&&"static"===d.css(a,"position");)a=a.offsetParent;return a||F.documentElement})}});d.each({scrollLeft:"pageXOffset",scrollTop:"pageYOffset"},function(a,c){var h=/Y/.test(c);d.fn[a]=function(e){return d.access(this,function(a,e,m){var k=D(a);return m===b?k?c in k?k[c]:
k.document.documentElement[e]:a[e]:(k?k.scrollTo(h?d(k).scrollLeft():m,h?m:d(k).scrollTop()):a[e]=m,b)},a,e,arguments.length,null)}});d.each({Height:"height",Width:"width"},function(a,c){d.each({padding:"inner"+a,content:c,"":"outer"+a},function(h,e){d.fn[e]=function(e,m){var k=arguments.length&&(h||"boolean"!=typeof e),f=h||(!0===e||!0===m?"margin":"border");return d.access(this,function(c,h,e){var m;return d.isWindow(c)?c.document.documentElement["client"+a]:9===c.nodeType?(m=c.documentElement,
Math.max(c.body["scroll"+a],m["scroll"+a],c.body["offset"+a],m["offset"+a],m["client"+a])):e===b?d.css(c,h,f):d.style(c,h,e,f)},c,k?e:b,k,null)}})});a.jQuery=a.$=d;"function"==typeof define&&define.amd&&define.amd.jQuery&&define("jquery",[],function(){return d})})(window);$.fn.top=function(){var a;a=Math.floor(parseFloat(this.css("top"))||this.position().top);return isNaN(a)?0:a};$.fn.middle=function(){return Math.round(this.top()+Math.round($(this).outerHeight()/2))};
...
a.outerWidth(),k=a.outerHeight(),f=c.outerHeight(),j=a[0].ownerDocument,D=j.documentElement,q=D.clientWidth+b(j).scrollLeft(),j=D.clientHeight+b(j).scrollTop(),D=c.offset();D.top+=f;D.left-=Math.min(D.left,D.left+e>q&&q>e?Math.abs(D.left+e-q):0);D.top-=Math.min(D.top,D.top+k>j&&j>k?Math.abs(k+f-0):0);return D}function p(){}function r(a){a.stopPropagation()}function l(a,b){var c=Array.prototype.slice,e=c.call(arguments,2);return function(){return a.apply(b,e.concat(c.call(arguments)))}}function q(c,
e,k,f){function j(a){a.stopPropagation&&a.stopPropagation();a.preventDefault&&a.preventDefault();a.returnValue=!1}function D(a){if(s){if(W&&9>document.documentMode&&!a.button)return q();var b=a.originalEvent.touches,d=b?b[0].pageY:a.pageY,b=Math.max(0,Math.min((b?b[0].pageX:a.pageX)-p.left,r)),d=Math.max(0,Math.min(d-p.top,C));x&&j(a);e.apply(c,[b,d,a])}}function q(){s&&(b(l).unbind(O),b(l.body).removeClass("sp-dragging"),f.apply(c,arguments));s=!1}e=e||function(){};k=k||function(){};f=f||function(){};
var l=c.ownerDocument||document,s=!1,p={},C=0,r=0,x="ontouchstart"in a,O={};O.selectstart=j;O.dragstart=j;O[x?"touchmove":"mousemove"]=D;O[x?"touchend":"mouseup"]=q;b(c).bind(x?"touchstart":"mousedown",function(a){if(!(a.which?3==a.which:2==a.button)&&!s&&!1!==k.apply(c,arguments))s=!0,C=b(c).height(),r=b(c).width(),p=b(c).offset(),b(l).bind(O),b(l.body).addClass("sp-dragging"),x||D(a),j(a)})}var Q={beforeShow:p,move:p,change:p,show:p,hide:p,color:!1,flat:!1,showInput:!0,showButtons:!1,clickoutFiresChange:!1,
...
b.fn.spectrum=function(k,j){if("string"==typeof k){var A=this,D=Array.prototype.slice.call(arguments,1);this.each(function(){var a=T[b(this).data("spectrum.id")];if(a){var c=a[k];if(!c)throw Error("Spectrum: no such method: '"+k+"'");"get"==k?A=a.get():"container"==k?A=a.container:"option"==k?A=a.option.apply(a,D):"destroy"==k?(a.destroy(),b(this).removeData("spectrum.id")):c.apply(a,D)}});return A}return this.spectrum("destroy").each(function(){var j,w=function(){m.toggleClass("sp-flat",U);m.toggleClass("sp-input-disabled",
!L.showInput);m.toggleClass("sp-alpha-enabled",L.showAlpha);m.toggleClass("sp-buttons-disabled",!L.showButtons||U);m.toggleClass("sp-palette-disabled",!L.showPalette);m.toggleClass("sp-palette-only",L.showPaletteOnly);m.toggleClass("sp-initial-disabled",!L.showInitial);m.addClass(L.className);K()},A=function(c){if(V&&(c=tinycolor(c).toRgbString(),-1===b.inArray(c,Ga)&&Ga.push(c),ca&&a.localStorage))try{a.localStorage[ca]=Ga.join(";")}catch(h){}},D=function(){var a=[],b=Ga,c={},h;if(L.showPalette){for(var d=
0;d<mb.length;d++)for(var e=0;e<mb[d].length;e++)h=tinycolor(mb[d][e]).toRgbString(),c[h]=!0;for(d=0;d<b.length;d++)h=tinycolor(b[d]).toRgbString(),c.hasOwnProperty(h)||(a.push(b[d]),c[h]=!0)}return a.reverse().slice(0,L.maxSelectionSize)},s=function(){var a=B(),c=b.map(mb,function(b,c){return e(b,a,"sp-palette-row sp-palette-row-"+c)});Ga&&c.push(e(D(),a,"sp-palette-row sp-palette-row-selection"));Tb.html(c.join(""))},p=function(){if(L.showInitial){var a=Za,b=B();Kb.html(e([a,b],b,"sp-palette-row-initial"))}},
C=function(){(0===ea||0===ba||0===na)&&K();m.addClass(wa)},F=function(){m.removeClass(wa)},x=function(){var a=tinycolor(Pa.val());a.ok?d(a):Pa.addClass("sp-validation-error")},O=function(){ja?H():G()},G=function(){if(ja)K();else if(!1!==E.beforeShow(B())){for(var c=0;c<T.length;c++)T[c]&&T[c].hide();ja=!0;b(xa).bind("click.spectrum",H);b(a).bind("resize.spectrum",fa);Aa.addClass("sp-active");m.show();L.showPalette&&s();K();S();Za=B();p();E.show(Za)}},H=function(c){if((!c||!("click"==c.type&&2==c.button))&&
ja&&!U)ja=!1,b(xa).unbind("click.spectrum",H),b(a).unbind("resize.spectrum",fa),Aa.removeClass("sp-active"),m.hide(),tinycolor.equals(B(),Za)||(yb&&"cancel"!==c?X(!0):d(Za,!0)),E.hide(B())},d=function(a,b){if(!tinycolor.equals(a,B())){var c=tinycolor(a),h=c.toHsv();la=h.h;Na=h.s;ra=h.v;J=h.a;S();b||(Ya=Ma||c.format)}},B=function(){return tinycolor.fromRatio({h:la,s:Na,v:ra,a:Math.round(100*J)/100})},R=function(){S();E.move(B())},S=function(){Pa.removeClass("sp-validation-error");I();var a=tinycolor({h:la,
s:"1.0",v:"1.0"});v.css("background-color",a.toHexString());a=Ya;if(1>J&&("hex"===a||"name"===a))a="rgb";var b=B(),c=b.toHexString(),h=b.toRgbString();y||1===b.alpha?zb.css("background-color",h):(zb.css("background-color","transparent"),zb.css("filter",b.toFilter()));if(L.showAlpha){h=b.toRgb();h.a=0;var h=tinycolor(h).toRgbString(),d="linear-gradient(left, "+h+", "+c+")";W?Ea.css("filter",tinycolor(h).toFilter({gradientType:1},c)):(Ea.css("background","-webkit-"+d),Ea.css("background","-moz-"+d),
Ea.css("background","-ms-"+d),Ea.css("background",d))}if(L.showInput){if(1>J&&("hex"===a||"name"===a))a="rgb";Pa.val(b.toString(a))}L.showPalette&&s();p()},I=function(){var a=Na*ba,b=ea-ra*ea,a=Math.max(-M,Math.min(ba-M,a-M)),b=Math.max(-M,Math.min(ea-M,b-M));Xa.css({top:b,left:a});tb.css({left:J*oa-ua/2});Ia.css({top:la*na-Ha})},X=function(a){var b=B();nb&&va.val(b.toString(Ya)).change();var c=!tinycolor.equals(b,Za);Za=b;A(b);a&&c&&E.change(b)},K=function(){ba=v.width();ea=v.height();M=Xa.height();
Oa.width();na=Oa.height();Ha=Ia.height();oa=sb.width();ua=tb.width();U||m.offset(f(m,Z));I()};j=function(){H();h=!0;va.attr("disabled",!0);Z.addClass("sp-disabled")};var L,P=b.extend({},Q,k);P.callbacks={move:l(P.move,this),change:l(P.change,this),show:l(P.show,this),hide:l(P.hide,this),beforeShow:l(P.beforeShow,this)};L=P;var U=L.flat,V=L.showSelectionPalette,ca=L.localStorageKey,Y=L.theme,E=L.callbacks,fa,ha=K,ia;fa=function(){var a=this,b=arguments;ia||(ia=setTimeout(function(){ia=null;ha.apply(a,
b)},10))};var ja=!1,ba=0,ea=0,M=0,na=0,oa=0,ua=0,Ha=0,la=0,Na=0,ra=0,J=1,P=L.palette.slice(0),mb=b.isArray(P[0])?P:[P],Ga=L.selectionPalette.slice(0),wa="sp-dragging",xa=this.ownerDocument,P=xa.body,va=b(this),h=!1,m=b(N,xa).addClass(Y),v=m.find(".sp-color"),Xa=m.find(".sp-dragger"),Oa=m.find(".sp-hue"),Ia=m.find(".sp-slider"),Ea=m.find(".sp-alpha-inner"),sb=m.find(".sp-alpha"),tb=m.find(".sp-alpha-handle"),Pa=m.find(".sp-input"),Tb=m.find(".sp-palette"),Kb=m.find(".sp-initial"),Lb=m.find(".sp-cancel"),
ub=m.find(".sp-choose"),nb=va.is("input"),ya=nb&&!U,Aa=ya?b("<div class='sp-replacer'><div class='sp-preview'><div class='sp-preview-inner'></div></div></div>").addClass(Y):b([]),Z=ya?Aa:va,zb=Aa.find(".sp-preview-inner"),Ab=L.color||nb&&va.val(),Za=!1,Ma=L.preferredFormat,Ya=Ma,yb=!L.showButtons||L.clickoutFiresChange,Y=function(a){a.data&&a.data.ignore?(d(b(this).data("color")),R()):(d(b(this).data("color")),X(!0),R(),H());return!1};W&&m.find("*:not(input)").attr("unselectable","on");w();ya&&va.hide().after(Aa);
U?va.after(m).hide():b(P).append(m.hide());if(ca&&a.localStorage){try{var Bb=a.localStorage[ca].split(",#");1<Bb.length&&(delete a.localStorage[ca],b.each(Bb,function(a,b){A(b)}))}catch(Xb){}try{Ga=a.localStorage[ca].split(";")}catch(Nb){}}Z.bind("click.spectrum touchstart.spectrum",function(a){h||O();a.stopPropagation();b(a.target).is("input")||a.preventDefault()});(va.is(":disabled")||!0===L.disabled)&&j();m.click(r);Pa.change(x);Pa.bind("paste",function(){setTimeout(x,1)});Pa.keydown(function(a){13==
a.keyCode&&x()});Lb.text(L.cancelText);Lb.bind("click.spectrum",function(a){a.stopPropagation();a.preventDefault();H("cancel")});ub.text(L.chooseText);ub.bind("click.spectrum",function(a){a.stopPropagation();a.preventDefault();Pa.hasClass("sp-validation-error")||(X(!0),H())});q(sb,function(a,b,c){J=a/oa;c.shiftKey&&(J=Math.round(10*J)/10);R()});q(Oa,function(a,b){la=parseFloat(b/na);R()},C,F);q(v,function(a,b){Na=parseFloat(a/ba);ra=parseFloat((ea-b)/ea);R()},C,F);Ab?(d(Ab),S(),Ya=Ma||tinycolor(Ab).format,
A(Ab)):S();U&&G();C=W?"mousedown.spectrum":"click.spectrum touchstart.spectrum";Tb.delegate(".sp-thumb-el",C,Y);Kb.delegate(".sp-thumb-el:nth-child(1)",C,{ignore:!0},Y);var eb={show:G,hide:H,toggle:O,reflow:K,option:function(a,h){if(a===c)return b.extend({},L);if(h===c)return L[a];L[a]=h;w()},enable:function(){h=!1;va.attr("disabled",!1);Z.removeClass("sp-disabled")},disable:j,set:function(a){d(a);X()},get:B,destroy:function(){va.show();Z.unbind("click.spectrum touchstart.spectrum");m.remove();Aa.remove();
T[eb.id]=null},container:m};eb.id=T.push(eb)-1;j=eb;b(this).data("spectrum.id",j.id)})};b.fn.spectrum.load=!0;b.fn.spectrum.loadOpts={};b.fn.spectrum.draggable=q;b.fn.spectrum.defaults=Q;b.spectrum={};b.spectrum.localization={};b.spectrum.palettes={};b.fn.spectrum.processNativeColorInputs=function(){var a=b("<input type='color' value='!' />")[0];"color"===a.type&&"!"!=a.value||b("input[type=color]").spectrum({preferredFormat:"hex6"})};var s=function(a){var b,c,e,f,q;if("object"==typeof a&&a.hasOwnProperty("_tc_id"))return a;
c=a;var l=0,p=0,r=0;a=1;var B=!1,y=!1;if("string"==typeof c)a:{c=c.replace(C,"").replace(R,"").toLowerCase();var N=!1;if(ja[c])c=ja[c],N=!0;else if("transparent"==c){c={r:0,g:0,b:0,a:0};break a}c=(b=D.rgb.exec(c))?{r:b[1],g:b[2],b:b[3]}:(b=D.rgba.exec(c))?{r:b[1],g:b[2],b:b[3],a:b[4]}:(b=D.hsl.exec(c))?{h:b[1],s:b[2],l:b[3]}:(b=D.hsla.exec(c))?{h:b[1],s:b[2],l:b[3],a:b[4]}:(b=D.hsv.exec(c))?{h:b[1],s:b[2],v:b[3]}:(b=D.hex6.exec(c))?{r:parseInt(b[1],16),g:parseInt(b[2],16),b:parseInt(b[3],16),format:N?
"name":"hex"}:(b=D.hex3.exec(c))?{r:parseInt(b[1]+""+b[1],16),g:parseInt(b[2]+""+b[2],16),b:parseInt(b[3]+""+b[3],16),format:N?"name":"hex"}:!1}"object"==typeof c&&(c.hasOwnProperty("r")&&c.hasOwnProperty("g")&&c.hasOwnProperty("b")?(l=255*I(c.r,255),p=255*I(c.g,255),r=255*I(c.b,255),B=!0,y="rgb"):c.hasOwnProperty("h")&&c.hasOwnProperty("s")&&c.hasOwnProperty("v")?(y=c.h,p=c.s,r=c.v,y=6*I(y,360),p=I(p,100),r=I(r,100),l=L.floor(y),B=y-l,y=r*(1-p),b=r*(1-B*p),B=r*(1-(1-B)*p),N=l%6,l=255*[r,b,y,y,B,
r][N],p=255*[B,r,r,b,y,y][N],r=255*[y,y,B,r,r,b][N],B=!0,y="hsv"):c.hasOwnProperty("h")&&(c.hasOwnProperty("s")&&c.hasOwnProperty("l"))&&(l=c.h,y=c.s,r=c.l,p=function(a,b,c){0>c&&(c+=1);1<c&&(c-=1);return c<1/6?a+6*(b-a)*c:0.5>c?b:c<2/3?a+6*(b-a)*(2/3-c):a},l=I(l,360),y=I(y,100),r=I(r,100),0===y?y=r=b=r:(b=0.5>r?r*(1+y):r+y-r*y,B=2*r-b,y=p(B,b,l+1/3),r=p(B,b,l),b=p(B,b,l-1/3)),l=255*y,p=255*r,r=255*b,B=!0,y="hsl"),c.hasOwnProperty("a")&&(a=c.a));l=S(255,P(l,0));p=S(255,P(p,0));r=S(255,P(r,0));1>l&&
(l=H(l));1>p&&(p=H(p));1>r&&(r=H(r));b=B;c=c&&c.format||y;e=l;f=p;q=r;var x=ha(a);return{ok:b,format:c,_tc_id:ca++,alpha:x,toHsv:function(){var a=K(e,f,q);return{h:a.h,s:a.s,v:a.v,a:x}},toHsvString:function(){var a=K(e,f,q),b=H(360*a.h),c=H(100*a.s),a=H(100*a.v);return 1==x?"hsv("+b+", "+c+"%, "+a+"%)":"hsva("+b+", "+c+"%, "+a+"%, "+x+")"},toHsl:function(){var a=U(e,f,q);return{h:a.h,s:a.s,l:a.l,a:x}},toHslString:function(){var a=U(e,f,q),b=H(360*a.h),c=H(100*a.s),a=H(100*a.l);return 1==x?"hsl("+
b+", "+c+"%, "+a+"%)":"hsla("+b+", "+c+"%, "+a+"%, "+x+")"},toHex:function(){return V(e,f,q)},toHexString:function(a){return"#"+V(e,f,q,a)},toRgb:function(){return{r:H(e),g:H(f),b:H(q),a:x}},toRgbString:function(){return 1==x?"rgb("+H(e)+", "+H(f)+", "+H(q)+")":"rgba("+H(e)+", "+H(f)+", "+H(q)+", "+x+")"},toName:function(){return k[V(e,f,q)]||!1},toFilter:function(a,b){var c=V(e,f,q,!0),d=c,k=Math.round(255*ha(x)).toString(16),n=k,w=a&&a.gradientType?"GradientType = 1, ":"";b&&(n=s(b),d=n.toHex(),
n=Math.round(255*ha(n.alpha)).toString(16));return"progid:DXImageTransform.Microsoft.gradient("+w+"startColorstr=#"+j(k)+c+",endColorstr=#"+j(n)+d+")"},toString:function(a){a=a||this.format;var b=!1;"rgb"===a&&(b=this.toRgbString());"hex"===a&&(b=this.toHexString());"hex6"===a&&(b=this.toHexString(!0));"name"===a&&(b=this.toName());"hsl"===a&&(b=this.toHslString());"hsv"===a&&(b=this.toHsvString());return b||this.toHexString(!0)}}},U=function(a,b,c){a=I(a,255);b=I(b,255);c=I(c,255);var e=P(a,b,c),
k=S(a,b,c),f,j=(e+k)/2;if(e==k)f=k=0;else{var D=e-k,k=0.5<j?D/(2-e-k):D/(e+k);switch(e){case a:f=(b-c)/D+(b<c?6:0);break;case b:f=(c-a)/D+2;break;case c:f=(a-b)/D+4}f/=6}return{h:f,s:k,l:j}},K=function(a,b,c){a=I(a,255);b=I(b,255);c=I(c,255);var e=P(a,b,c),k=S(a,b,c),f,j=e-k;if(e==k)f=0;else{switch(e){case a:f=(b-c)/j+(b<c?6:0);break;case b:f=(c-a)/j+2;break;case c:f=(a-b)/j+4}f/=6}return{h:f,s:0===e?0:j/e,v:e}},V=function(a,b,c,e){a=[j(H(a).toString(16)),j(H(b).toString(16)),j(H(c).toString(16))];
return!e&&a[0].charAt(0)==a[0].charAt(1)&&a[1].charAt(0)==a[1].charAt(1)&&a[2].charAt(0)==a[2].charAt(1)?a[0].charAt(0)+a[1].charAt(0)+a[2].charAt(0):a.join("")},I=function(a,b){"string"==typeof a&&(-1!=a.indexOf(".")&&1===ha(a))&&(a="100%");var c="string"===typeof a&&-1!=a.indexOf("%");a=S(b,P(0,ha(a)));c&&(a*=b/100);return 1E-6>L.abs(a-b)?1:1<=a?a%b/ha(b):a},j=function(a){return 1==a.length?"0"+a:""+a},C=/^[\s,#]+/,R=/\s+$/,ca=0,L=Math,H=L.round,S=L.min,P=L.max,fa=L.random,ha=this.parseFloat;s.fromRatio=
...
(function(){function a(b,c,e){if(b===c)return 0!==b||1/b==1/c;if(null==b||null==c)return b===c;b._chain&&(b=b._wrapped);c._chain&&(c=c._wrapped);if(b.isEqual&&j.isFunction(b.isEqual))return b.isEqual(c);if(c.isEqual&&j.isFunction(c.isEqual))return c.isEqual(b);var f=q.call(b);if(f!=q.call(c))return!1;switch(f){case "[object String]":return b==""+c;case "[object Number]":return b!=+b?c!=+c:0==b?1/b==1/c:b==+c;case "[object Date]":case "[object Boolean]":return+b==+c;case "[object RegExp]":return b.source==
c.source&&b.global==c.global&&b.multiline==c.multiline&&b.ignoreCase==c.ignoreCase}if("object"!=typeof b||"object"!=typeof c)return!1;for(var l=e.length;l--;)if(e[l]==b)return!0;e.push(b);var l=0,p=!0;if("[object Array]"==f){if(l=b.length,p=l==c.length)for(;l--&&(p=l in b==l in c&&a(b[l],c[l],e)););}else{if("constructor"in b!="constructor"in c||b.constructor!=c.constructor)return!1;for(var s in b)if(j.has(b,s)&&(l++,!(p=j.has(c,s)&&a(b[s],c[s],e))))break;if(p){for(s in c)if(j.has(c,s)&&!l--)break;
p=!l}}e.pop();return p}var b=this,c=b._,e={},f=Array.prototype,p=Object.prototype,r=f.slice,l=f.unshift,q=p.toString,Q=p.hasOwnProperty,T=f.forEach,W=f.map,y=f.reduce,B=f.reduceRight,N=f.filter,X=f.every,s=f.some,U=f.indexOf,K=f.lastIndexOf,p=Array.isArray,V=Object.keys,I=Function.prototype.bind,j=function(a){return new ia(a)};"undefined"!==typeof exports?("undefined"!==typeof module&&module.exports&&(exports=module.exports=j),exports._=j):b._=j;j.VERSION="1.3.3";var C=j.each=j.forEach=function(a,
b,c){if(null!=a)if(T&&a.forEach===T)a.forEach(b,c);else if(a.length===+a.length)for(var f=0,l=a.length;f<l&&!(f in a&&b.call(c,a[f],f,a)===e);f++);else for(f in a)if(j.has(a,f)&&b.call(c,a[f],f,a)===e)break};j.map=j.collect=function(a,b,c){var e=[];if(null==a)return e;if(W&&a.map===W)return a.map(b,c);C(a,function(a,k,f){e[e.length]=b.call(c,a,k,f)});a.length===+a.length&&(e.length=a.length);return e};j.reduce=j.foldl=j.inject=function(a,b,c,e){var f=2<arguments.length;null==a&&(a=[]);if(y&&a.reduce===
y)return e&&(b=j.bind(b,e)),f?a.reduce(b,c):a.reduce(b);C(a,function(a,k,j){f?c=b.call(e,c,a,k,j):(c=a,f=!0)});if(!f)throw new TypeError("Reduce of empty array with no initial value");return c};j.reduceRight=j.foldr=function(a,b,c,e){var f=2<arguments.length;null==a&&(a=[]);if(B&&a.reduceRight===B)return e&&(b=j.bind(b,e)),f?a.reduceRight(b,c):a.reduceRight(b);var l=j.toArray(a).reverse();e&&!f&&(b=j.bind(b,e));return f?j.reduce(l,b,c,e):j.reduce(l,b)};j.find=j.detect=function(a,b,c){var e;R(a,function(a,
...
var R=j.some=j.any=function(a,b,c){b||(b=j.identity);var f=!1;if(null==a)return f;if(s&&a.some===s)return a.some(b,c);C(a,function(a,k,j){if(f||(f=b.call(c,a,k,j)))return e});return!!f};j.include=j.contains=function(a,b){return null==a?!1:U&&a.indexOf===U?-1!=a.indexOf(b):R(a,function(a){return a===b})};j.invoke=function(a,b){var c=r.call(arguments,2);return j.map(a,function(a){return(j.isFunction(b)?b||a:a[b]).apply(a,c)})};j.pluck=function(a,b){return j.map(a,function(a){return a[b]})};j.max=function(a,
...
function(a,b,c){c||(c=j.identity);for(var e=0,f=a.length;e<f;){var l=e+f>>1;c(a[l])<c(b)?e=l+1:f=l}return e};j.toArray=function(a){return!a?[]:j.isArray(a)||j.isArguments(a)?r.call(a):a.toArray&&j.isFunction(a.toArray)?a.toArray():j.values(a)};j.size=function(a){return j.isArray(a)?a.length:j.keys(a).length};j.first=j.head=j.take=function(a,b,c){return null!=b&&!c?r.call(a,0,b):a[0]};j.initial=function(a,b,c){return r.call(a,0,a.length-(null==b||c?1:b))};j.last=function(a,b,c){return null!=b&&!c?
r.call(a,Math.max(a.length-b,0)):a[a.length-1]};j.rest=j.tail=function(a,b,c){return r.call(a,null==b||c?1:b)};j.compact=function(a){return j.filter(a,function(a){return!!a})};j.flatten=function(a,b){return j.reduce(a,function(a,c){if(j.isArray(c))return a.concat(b?c:j.flatten(c));a[a.length]=c;return a},[])};j.without=function(a){return j.difference(a,r.call(arguments,1))};j.uniq=j.unique=function(a,b,c){c=c?j.map(a,c):a;var e=[];3>a.length&&(b=!0);j.reduce(c,function(c,f,n){if(b?j.last(c)!==f||
!c.length:!j.include(c,f))c.push(f),e.push(a[n]);return c},[]);return e};j.union=function(){return j.uniq(j.flatten(arguments,!0))};j.intersection=j.intersect=function(a){var b=r.call(arguments,1);return j.filter(j.uniq(a),function(a){return j.every(b,function(b){return 0<=j.indexOf(b,a)})})};j.difference=function(a){var b=j.flatten(r.call(arguments,1),!0);return j.filter(a,function(a){return!j.include(b,a)})};j.zip=function(){for(var a=r.call(arguments),b=j.max(j.pluck(a,"length")),c=Array(b),e=
...
a)/c),0),f=0,j=Array(e);f<e;)j[f++]=a,a+=c;return j};var ca=function(){};j.bind=function(a,b){var c,e;if(a.bind===I&&I)return I.apply(a,r.call(arguments,1));if(!j.isFunction(a))throw new TypeError;e=r.call(arguments,2);return c=function(){if(!(this instanceof c))return a.apply(b,e.concat(r.call(arguments)));ca.prototype=a.prototype;var f=new ca,j=a.apply(f,e.concat(r.call(arguments)));return Object(j)===j?j:f}};j.bindAll=function(a){var b=r.call(arguments,1);0==b.length&&(b=j.functions(a));C(b,function(b){a[b]=
j.bind(a[b],a)});return a};j.memoize=function(a,b){var c={};b||(b=j.identity);return function(){var e=b.apply(this,arguments);return j.has(c,e)?c[e]:c[e]=a.apply(this,arguments)}};j.delay=function(a,b){var c=r.call(arguments,2);return setTimeout(function(){return a.apply(null,c)},b)};j.defer=function(a){return j.delay.apply(j,[a,1].concat(r.call(arguments,1)))};j.throttle=function(a,b){var c,e,f,l,q,p,s=j.debounce(function(){q=l=!1},b);return function(){c=this;e=arguments;f||(f=setTimeout(function(){f=
null;q&&a.apply(c,e);s()},b));l?q=!0:p=a.apply(c,e);s();l=!0;return p}};j.debounce=function(a,b,c){var e;return function(){var f=this,j=arguments;c&&!e&&a.apply(f,j);clearTimeout(e);e=setTimeout(function(){e=null;c||a.apply(f,j)},b)}};j.once=function(a){var b=!1,c;return function(){if(b)return c;b=!0;return c=a.apply(this,arguments)}};j.wrap=function(a,b){return function(){var c=[a].concat(r.call(arguments,0));return b.apply(this,c)}};j.compose=function(){var a=arguments;return function(){for(var b=
arguments,c=a.length-1;0<=c;c--)b=[a[c].apply(this,b)];return b[0]}};j.after=function(a,b){return 0>=a?b():function(){if(1>--a)return b.apply(this,arguments)}};j.keys=V||function(a){if(a!==Object(a))throw new TypeError("Invalid object");var b=[],c;for(c in a)j.has(a,c)&&(b[b.length]=c);return b};j.values=function(a){return j.map(a,j.identity)};j.functions=j.methods=function(a){var b=[],c;for(c in a)j.isFunction(a[c])&&b.push(c);return b.sort()};j.extend=function(a){C(r.call(arguments,1),function(b){for(var c in b)a[c]=
b[c]});return a};j.pick=function(a){var b={};C(j.flatten(r.call(arguments,1)),function(c){c in a&&(b[c]=a[c])});return b};j.defaults=function(a){C(r.call(arguments,1),function(b){for(var c in b)null==a[c]&&(a[c]=b[c])});return a};j.clone=function(a){return!j.isObject(a)?a:j.isArray(a)?a.slice():j.extend({},a)};j.tap=function(a,b){b(a);return a};j.isEqual=function(b,c){return a(b,c,[])};j.isEmpty=function(a){if(null==a)return!0;if(j.isArray(a)||j.isString(a))return 0===a.length;for(var b in a)if(j.has(a,
b))return!1;return!0};j.isElement=function(a){return!!(a&&1==a.nodeType)};j.isArray=p||function(a){return"[object Array]"==q.call(a)};j.isObject=function(a){return a===Object(a)};j.isArguments=function(a){return"[object Arguments]"==q.call(a)};j.isArguments(arguments)||(j.isArguments=function(a){return!(!a||!j.has(a,"callee"))});j.isFunction=function(a){return"[object Function]"==q.call(a)};j.isString=function(a){return"[object String]"==q.call(a)};j.isNumber=function(a){return"[object Number]"==
q.call(a)};j.isFinite=function(a){return j.isNumber(a)&&isFinite(a)};j.isNaN=function(a){return a!==a};j.isBoolean=function(a){return!0===a||!1===a||"[object Boolean]"==q.call(a)};j.isDate=function(a){return"[object Date]"==q.call(a)};j.isRegExp=function(a){return"[object RegExp]"==q.call(a)};j.isNull=function(a){return null===a};j.isUndefined=function(a){return void 0===a};j.has=function(a,b){return Q.call(a,b)};j.noConflict=function(){b._=c;return this};j.identity=function(a){return a};j.times=
function(a,b,c){for(var e=0;e<a;e++)b.call(c,e)};j.escape=function(a){return(""+a).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#x27;").replace(/\//g,"&#x2F;")};j.result=function(a,b){if(null==a)return null;var c=a[b];return j.isFunction(c)?c.call(a):c};j.mixin=function(a){C(j.functions(a),function(b){var c=j[b]=a[b];ia.prototype[b]=function(){var a=r.call(arguments);l.call(a,this._wrapped);return Y(c.apply(j,a),this._chain)}})};var L=0;j.uniqueId=
...
(function(){function a(a,b){return"!"!==a[0][0]?'<a href="'+p(b.href)+'"'+(b.title?' title="'+p(b.title)+'"':"")+">"+s.lexer(a[1])+"</a>":'<img src="'+p(b.href)+'" alt="'+p(a[1])+'"'+(b.title?' title="'+p(b.title)+'"':"")+">"}function b(){return K=U.pop()}function c(){switch(K.type){case "space":return"";case "hr":return"<hr>\n";case "heading":return"<h"+K.depth+">"+s.lexer(K.text)+"</h"+K.depth+">\n";case "code":return V.highlight&&(K.code=V.highlight(K.text,K.lang),null!=K.code&&K.code!==K.text&&
...
blockquote:/^( *>[^\n]+(\n[^\n]+)*\n*)+/,list:/^( *)(bull) [^\0]+?(?:hr|\n{2,}(?! )(?!\1bull )\n*|\s*$)/,html:/^ *(?:comment|closed|closing) *(?:\n{2,}|\s*$)/,def:/^ *\[([^\]]+)\]: *([^\s]+)(?: +["(]([^\n]+)[")])? *(?:\n+|$)/,paragraph:/^([^\n]+\n?(?!body))+\n*/,text:/^[^\n]+/,bullet:/(?:[*+-]|\d+\.)/,item:/^( *)(bull) [^\n]*(?:\n(?!\1bull )[^\n]*)*/};y.item=q(y.item,"gm")(/bull/g,y.bullet)();y.list=q(y.list)(/bull/g,y.bullet)("hr",/\n+(?=(?: *[-*_]){3,} *(?:\n+|$))/)();y.html=q(y.html)("comment",
/\x3c!--[^\0]*?--\x3e/)("closed",/<(tag)[^\0]+?<\/\1>/)("closing",/<tag(?:"[^"]*"|'[^']*'|[^'">])*?>/)(/tag/g,l())();var B=y,N;N=y.paragraph.source;var X=[];(function C(a){a=y[a]?y[a].source:a;X.push(a.replace(/(^|[^\[])\^/g,"$1"));return C})("hr")("heading")("lheading")("blockquote")("<"+l())("def");N=RegExp(N.replace("body",X.join("|")));B.paragraph=N;y.normal={fences:y.fences,paragraph:y.paragraph};y.gfm={fences:/^ *(```|~~~) *(\w+)? *\n([^\0]+?)\s*\1 *(?:\n+|$)/,paragraph:/^/};y.gfm.paragraph=
q(y.paragraph)("(?!","(?!"+y.gfm.fences.source.replace(/(^|[^\[])\^/g,"$2")+"|")();y.lexer=function(a){var b=[];b.links={};a=a.replace(/\r\n|\r/g,"\n").replace(/\t/g,"    ");return y.token(a,b,!0)};y.token=function(a,b,c){a=a.replace(/^ +$/gm,"");for(var e,f,l,q,p,s;a;){if(l=y.newline.exec(a))a=a.substring(l[0].length),1<l[0].length&&b.push({type:"space"});if(l=y.code.exec(a))a=a.substring(l[0].length),l=l[0].replace(/^ {4}/gm,""),b.push({type:"code",text:!V.pedantic?l.replace(/\n+$/,""):l});else if(l=
...
b,c),b.push({type:"blockquote_end"});else if(l=y.list.exec(a)){a=a.substring(l[0].length);b.push({type:"list_start",ordered:isFinite(l[2])});l=l[0].match(y.item);e=!1;s=l.length;for(p=0;p<s;p++)q=l[p],f=q.length,q=q.replace(/^ *([*+-]|\d+\.) +/,""),~q.indexOf("\n ")&&(f-=q.length,q=!V.pedantic?q.replace(RegExp("^ {1,"+f+"}","gm"),""):q.replace(/^ {1,4}/gm,"")),f=e||/\n\n(?!\s*$)/.test(q),p!==s-1&&(e="\n"===q[q.length-1],f||(f=e)),b.push({type:f?"loose_item_start":"list_item_start"}),y.token(q,b),
b.push({type:"list_item_end"});b.push({type:"list_end"})}else if(l=y.html.exec(a))a=a.substring(l[0].length),b.push({type:"html",pre:"pre"===l[1],text:l[0]});else if(c&&(l=y.def.exec(a)))a=a.substring(l[0].length),b.links[l[1].toLowerCase()]={href:l[2],title:l[3]};else if(c&&(l=y.paragraph.exec(a)))a=a.substring(l[0].length),b.push({type:"paragraph",text:l[0]});else if(l=y.text.exec(a))a=a.substring(l[0].length),b.push({type:"text",text:l[0]})}return b};var s={escape:/^\\([\\`*{}\[\]()#+\-.!_>])/,
...
s.link=q(s.link)("inside",s._linkInside)("href",s._linkHref)();s.reflink=q(s.reflink)("inside",s._linkInside)();s.normal={url:s.url,strong:s.strong,em:s.em,text:s.text};s.pedantic={strong:/^__(?=\S)([^\0]*?\S)__(?!_)|^\*\*(?=\S)([^\0]*?\S)\*\*(?!\*)/,em:/^_(?=\S)([^\0]*?\S)_(?!_)|^\*(?=\S)([^\0]*?\S)\*(?!\*)/};s.gfm={url:/^(https?:\/\/[^\s]+[^.,:;"')\]\s])/,text:/^[^\0]+?(?=[\\<!\[_*`]|https?:\/\/| {2,}\n|$)/};s.lexer=function(b){for(var c="",e=U.links,f,l;b;)if(l=s.escape.exec(b))b=b.substring(l[0].length),
c+=l[1];else if(l=s.autolink.exec(b))b=b.substring(l[0].length),"@"===l[2]?(f=":"===l[1][6]?r(l[1].substring(7)):r(l[1]),l=r("mailto:")+f):l=f=p(l[1]),c+='<a href="'+l+'">'+f+"</a>";else if(l=s.url.exec(b))b=b.substring(l[0].length),l=f=p(l[1]),c+='<a href="'+l+'">'+f+"</a>";else if(l=s.tag.exec(b))b=b.substring(l[0].length),c+=V.sanitize?p(l[0]):l[0];else if(l=s.link.exec(b))b=b.substring(l[0].length),c+=a(l,{href:l[2],title:l[3]});else if((l=s.reflink.exec(b))||(l=s.nolink.exec(b)))b=b.substring(l[0].length),
f=(l[2]||l[1]).replace(/\s+/g," "),f=e[f.toLowerCase()],!f||!f.href?(c+=l[0][0],b=l[0].substring(1)+b):c+=a(l,f);else if(l=s.strong.exec(b))b=b.substring(l[0].length),c+="<strong>"+s.lexer(l[2]||l[1])+"</strong>";else if(l=s.em.exec(b))b=b.substring(l[0].length),c+="<em>"+s.lexer(l[2]||l[1])+"</em>";else if(l=s.code.exec(b))b=b.substring(l[0].length),c+="<code>"+p(l[2],!0)+"</code>";else if(l=s.br.exec(b))b=b.substring(l[0].length),c+="<br>";else if(l=s.text.exec(b))b=b.substring(l[0].length),c+=
p(l[0]);return c};var U,K;Q.exec=Q;var V,I;T.options=T.setOptions=function(a){I=a;W(a);return T};T.setOptions({gfm:!0,pedantic:!1,sanitize:!1,highlight:null});T.parser=function(a,b){W(b);return f(a)};T.lexer=function(a,b){W(b);return y.lexer(a)};T.parse=T;"undefined"!==typeof module?module.exports=T:this.marked=T}).call(function(){return this||("undefined"!==typeof window?window:global)}());
function natural_sort(a,b){var c=/(^-?[0-9]+(\.?[0-9]*)[df]?e?[0-9]?$|^0x[0-9a-f]+$|[0-9]+)/gi,e=/(^[ ]*|[ ]*$)/g,f=/(^([\w ]+,?[\w ]+)?[\w ]+,?[\w ]+\d+:\d+(:\d+)?[\w ]?|^\d{1,4}[\/\-]\d{1,4}[\/\-]\d{1,4}|^\w+, \w+ \d+, \d{4})/,p=/^0x[0-9a-f]+$/i,r=/^0/,l=(natural_sort.insensitive&&(""+a).toLowerCase()||""+a).replace(e,"")||"",q=(natural_sort.insensitive&&(""+b).toLowerCase()||""+b).replace(e,"")||"",e=l.replace(c,"\x00$1\x00").replace(/\0$/,"").replace(/^\0/,"").split("\x00"),c=q.replace(c,"\x00$1\x00").replace(/\0$/,
"").replace(/^\0/,"").split("\x00"),l=parseInt(l.match(p))||1!=e.length&&l.match(f)&&Date.parse(l);if(f=parseInt(q.match(p))||l&&q.match(f)&&Date.parse(q)||null){if(l<f)return-1;if(l>f)return 1}l=0;for(q=Math.max(e.length,c.length);l<q;l++){f=!(e[l]||"").match(r)&&parseFloat(e[l])||e[l]||0;p=!(c[l]||"").match(r)&&parseFloat(c[l])||c[l]||0;if(isNaN(f)!==isNaN(p))return isNaN(f)?1:-1;typeof f!==typeof p&&(f+="",p+="");if(f<p)return-1;if(f>p)return 1}return 0}
...
c)return a.remove(b);e.setItem(b,a.serialize(c))},a.get=function(b){return a.deserialize(e.getItem(b))},a.remove=function(a){e.removeItem(a)},a.clear=function(){e.clear()},a.getAll=function(){for(var b={},c=0;c<e.length;++c){var f=e.key(c);b[f]=a.get(f)}return b};else{var r;try{r="globalStorage"in b&&b.globalStorage&&b.globalStorage[b.location.hostname]}catch(l){r=!1}if(r)e=b.globalStorage[b.location.hostname],a.set=function(b,c){if(void 0===c)return a.remove(b);e[b]=a.serialize(c)},a.get=function(b){return a.deserialize(e[b]&&
e[b].value)},a.remove=function(a){delete e[a]},a.clear=function(){for(var a in e)delete e[a]},a.getAll=function(){for(var b={},c=0;c<e.length;++c){var f=e.key(c);b[f]=a.get(f)}return b};else if(c.documentElement.addBehavior){var q,Q;try{Q=new ActiveXObject("htmlfile"),Q.open(),Q.write('<script>document.w=window\x3c/script><iframe src="/favicon.ico"></frame>'),Q.close(),q=Q.w.frames[0].document,e=q.createElement("div")}catch(T){e=c.createElement("div"),q=c.body}var b=function(b){return function(){var c=
Array.prototype.slice.call(arguments,0);c.unshift(e);q.appendChild(e);e.addBehavior("#default#userData");e.load("localStorage");c=b.apply(a,c);q.removeChild(e);return c}},W=/[!"#$%&'()*+,/\\:;<=>?@[\]^`{|}~]/g;a.set=b(function(b,c,e){c=c.replace(W,"___");if(void 0===e)return a.remove(c);b.setAttribute(c,a.serialize(e));b.save("localStorage")});a.get=b(function(b,c){c=c.replace(W,"___");return a.deserialize(b.getAttribute(c))});a.remove=b(function(a,b){b=b.replace(W,"___");a.removeAttribute(b);a.save("localStorage")});
...
(function(){var a=this,b="object"===typeof module?module.exports:this.io={};b.version="0.9.11";b.protocol=1;b.transports=[];b.j=[];b.sockets={};b.connect=function(c,e){var d=b.util.parseUri(c),f,j;a&&a.location&&(d.protocol=d.protocol||a.location.protocol.slice(0,-1),d.host=d.host||(a.document?a.document.domain:a.location.hostname),d.port=d.port||a.location.port);f=b.util.uniqueUri(d);var k={host:d.host,secure:"https"==d.protocol,port:d.port||("https"==d.protocol?443:80),query:d.query||""};b.util.merge(k,
e);if(k["force new connection"]||!b.sockets[f])j=new b.Socket(k);!k["force new connection"]&&j&&(b.sockets[f]=j);j=j||b.sockets[f];return j.of(1<d.path.length?d.path:"")};var c=this,e=("undefined"!=typeof io?io:module.exports).util={},f=/^(?:(?![^:@]+:[^:@\/]*@)([^:\/?#.]+):)?(?:\/\/)?((?:(([^:@]*)(?::([^:@]*))?)?@)?([^:\/?#]*)(?::(\d*))?)(((\/(?:[^?#](?![^?#\/]*\.[^?#\/.]+(?:[?#]|$)))*\/?)?([^?#\/]*))(?:\?([^#]*))?(?:#(.*))?)/,p="source protocol authority userInfo user password host port relative path directory file query anchor".split(" ");
...
(this.$events[a]=[]);W.util.isArray(this.$events[a])||(this.$events[a]=[this.$events[a]]);return this.$events[a]};l.prototype.emit=function(a){if(!this.$events)return!1;var b=this.$events[a];if(!b)return!1;var c=Array.prototype.slice.call(arguments,1);if("function"==typeof b)b.apply(this,c);else if(W.util.isArray(b))for(var b=b.slice(),d=0,e=b.length;d<e;d++)b[d].apply(this,c);else return!1;return!0};(function(a,b){function c(a){return 10>a?"0"+a:a}function d(a){k.lastIndex=0;return k.test(a)?'"'+
a.replace(k,function(a){var b=q[a];return"string"===typeof b?b:"\\u"+("0000"+a.charCodeAt(0).toString(16)).slice(-4)})+'"':'"'+a+'"'}function e(a,b){var h,f,m,j,k=l,q,n=b[a];n instanceof Date&&(n=isFinite(a.valueOf())?a.getUTCFullYear()+"-"+c(a.getUTCMonth()+1)+"-"+c(a.getUTCDate())+"T"+c(a.getUTCHours())+":"+c(a.getUTCMinutes())+":"+c(a.getUTCSeconds())+"Z":null);"function"===typeof p&&(n=p.call(b,a,n));switch(typeof n){case "string":return d(n);case "number":return isFinite(n)?String(n):"null";
case "boolean":case "null":return String(n);case "object":if(!n)return"null";l+=x;q=[];if("[object Array]"===Object.prototype.toString.apply(n)){j=n.length;for(h=0;h<j;h+=1)q[h]=e(h,n)||"null";m=0===q.length?"[]":l?"[\n"+l+q.join(",\n"+l)+"\n"+k+"]":"["+q.join(",")+"]";l=k;return m}if(p&&"object"===typeof p){j=p.length;for(h=0;h<j;h+=1)"string"===typeof p[h]&&(f=p[h],(m=e(f,n))&&q.push(d(f)+(l?": ":":")+m))}else for(f in n)Object.prototype.hasOwnProperty.call(n,f)&&(m=e(f,n))&&q.push(d(f)+(l?": ":
":")+m);m=0===q.length?"{}":l?"{\n"+l+q.join(",\n"+l)+"\n"+k+"}":"{"+q.join(",")+"}";l=k;return m}}if(b&&b.parse)return a.JSON={parse:b.parse,stringify:b.stringify};var f=a.JSON={},j=/[\u0000\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,k=/[\\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,l,x,q={"\b":"\\b","\t":"\\t","\n":"\\n","\f":"\\f","\r":"\\r",'"':'\\"',"\\":"\\\\"},p;
f.stringify=function(a,b,c){var d;x=l="";if("number"===typeof c)for(d=0;d<c;d+=1)x+=" ";else"string"===typeof c&&(x=c);if((p=b)&&"function"!==typeof b&&("object"!==typeof b||"number"!==typeof b.length))throw Error("JSON.stringify");return e("",{"":a})};f.parse=function(a,b){function c(a,d){var e,h,f=a[d];if(f&&"object"===typeof f)for(e in f)Object.prototype.hasOwnProperty.call(f,e)&&(h=c(f,e),void 0!==h?f[e]=h:delete f[e]);return b.call(a,d,f)}var d;a=String(a);j.lastIndex=0;j.test(a)&&(a=a.replace(j,
...
y=("undefined"!=typeof io?io:module.exports).parser={},B=y.packets="disconnect connect heartbeat message json event ack error noop".split(" "),N=y.reasons=["transport not supported","client not handshaken","unauthorized"],X=y.advice=["reconnect"],s=l.JSON,U=l.util.indexOf;y.encodePacket=function(a){var b=U(B,a.type),c=a.id||"",d=a.endpoint||"",e=a.ack,f=null;switch(a.type){case "error":var j=a.reason?U(N,a.reason):"";a=a.advice?U(X,a.advice):"";if(""!==j||""!==a)f=j+(""!==a?"+"+a:"");break;case "message":""!==
...
C,200==j.status)b(j.responseText);else if(403==j.status)c.onError(j.responseText);else c.connecting=!1,!c.reconnecting&&c.onError(j.responseText)};j.send(null)}};l.prototype.getTransport=function(a){a=a||this.transports;for(var b=0,c;c=a[b];b++)if(I.Transport[c]&&I.Transport[c].check(this)&&(!this.isXDomain()||I.Transport[c].xdomainCheck(this)))return new I.Transport[c](this,this.sessionid);return null};l.prototype.connect=function(a){if(this.connecting)return this;var b=this;b.connecting=!0;this.handshake(function(c,
...
b.options["connect timeout"]))})}b.sessionid=c;b.closeTimeout=1E3*e;b.heartbeatTimeout=1E3*d;b.transports||(b.transports=b.origTransports=f?I.util.intersect(f.split(","),b.options.transports):b.options.transports);b.setHeartbeatTimeout();j(b.transports);b.once("connect",function(){clearTimeout(b.connectTimeoutTimer);a&&"function"==typeof a&&a()})});return this};l.prototype.setHeartbeatTimeout=function(){clearTimeout(this.heartbeatTimeoutTimer);if(!this.transport||this.transport.heartbeats()){var a=
...
this.connecting)this.open&&this.of("").packet({type:"disconnect"}),this.onDisconnect("booted");return this};l.prototype.disconnectSync=function(){var a=I.util.request(),b=["http"+(this.options.secure?"s":"")+":/",this.options.host+":"+this.options.port,this.options.resource,I.protocol,"",this.sessionid].join("/")+"/?disconnect=1";a.open("GET",b,!1);a.send(null);this.onDisconnect("booted")};l.prototype.isXDomain=function(){var a=j.location.port||("https:"==j.location.protocol?443:80);return this.options.host!==
...
a;this.name=b};("undefined"!=typeof io?io:module.exports).SocketNamespace=l;R.util.mixin(l,R.EventEmitter);l.prototype.$emit=R.EventEmitter.prototype.emit;l.prototype.of=function(){return this.socket.of.apply(this.socket,arguments)};l.prototype.packet=function(a){a.endpoint=this.name;this.socket.packet(a);this.flags={};return this};l.prototype.send=function(a,b){var c={type:this.flags.json?"json":"message",data:a};"function"==typeof b&&(c.id=++this.ackPackets,c.ack=!0,this.acks[c.id]=b);return this.packet(c)};
l.prototype.emit=function(a){var b=Array.prototype.slice.call(arguments,1),c=b[b.length-1],d={type:"event",name:a};"function"==typeof c&&(d.id=++this.ackPackets,d.ack="data",this.acks[d.id]=c,b=b.slice(0,b.length-1));d.args=b;return this.packet(d)};l.prototype.disconnect=function(){""===this.name?this.socket.disconnect():(this.packet({type:"disconnect"}),this.$emit("disconnect"));return this};l.prototype.onPacket=function(a){function b(){c.packet({type:"ack",args:R.util.toArray(arguments),ackId:a.id})}
...
!0);S.transports.push("flashsocket");if("undefined"!=typeof window){var fa,ha=function(){if(!Ua){try{var a=G.getElementsByTagName("body")[0].appendChild(G.createElement("span"));a.parentNode.removeChild(a)}catch(b){return}Ua=!0;for(var a=d.length,c=0;c<a;c++)d[c]()}},ja=function(a){Ua?a():d[d.length]=a},l=function(a){if(typeof O.addEventListener!=da)O.addEventListener("load",a,!1);else if(typeof G.addEventListener!=da)G.addEventListener("load",a,!1);else if(typeof O.attachEvent!=da){var b=O;b.attachEvent("onload",
...
f.getAttribute("class")&&(e.styleclass=f.getAttribute("class"));f.getAttribute("align")&&(e.align=f.getAttribute("align"));for(var j={},f=f.getElementsByTagName("param"),l=f.length,x=0;x<l;x++)"movie"!=f[x].getAttribute("name").toLowerCase()&&(j[f[x].getAttribute("name")]=f[x].getAttribute("value"));D(e,j,c,d)}else n(f),d&&d(e)}else if(sa(c,!0),d){if((c=Y(c))&&typeof c.SetVariable!=da)e.success=!0,e.ref=c;d(e)}}},Y=function(a){var b=null;if((a=ga(a))&&"OBJECT"==a.nodeName)typeof a.SetVariable!=da?
b=a:(a=a.getElementsByTagName(ta)[0])&&(b=a);return b},k=function(){return!rb&&$a("6.0.65")&&(E.win||E.mac)&&!(E.wk&&312>E.wk)},D=function(a,b,c,d){rb=!0;Ib=d||null;Rb={success:!1,id:c};var e=ga(c);if(e){"OBJECT"==e.nodeName?(jb=w(e),kb=null):(jb=e,kb=c);a.id=x;if(typeof a.width==da||!/%$/.test(a.width)&&310>parseInt(a.width,10))a.width="310";if(typeof a.height==da||!/%$/.test(a.height)&&137>parseInt(a.height,10))a.height="137";G.title=G.title.slice(0,47)+" - Flash Player Installation";d=E.ie&&E.win?
["Active"].concat("").join("X"):"PlugIn";d="MMredirectURL="+O.location.toString().replace(/&/g,"%26")+"&MMplayerType="+d+"&MMdoctitle="+G.title;b.flashvars=typeof b.flashvars!=da?b.flashvars+("&"+d):d;E.ie&&(E.win&&4!=e.readyState)&&(d=G.createElement("div"),c+="SWFObjectNew",d.setAttribute("id",c),e.parentNode.insertBefore(d,e),e.style.display="none",function(){4==e.readyState?e.parentNode.removeChild(e):setTimeout(arguments.callee,10)}());A(a,b,c)}},n=function(a){if(E.ie&&E.win&&4!=a.readyState){var b=
G.createElement("div");a.parentNode.insertBefore(b,a);b.parentNode.replaceChild(w(a),b);a.style.display="none";(function(){4==a.readyState?a.parentNode.removeChild(a):setTimeout(arguments.callee,10)})()}else a.parentNode.replaceChild(w(a),a)},w=function(a){var b=G.createElement("div");if(E.win&&E.ie)b.innerHTML=a.innerHTML;else if(a=a.getElementsByTagName(ta)[0])if(a=a.childNodes)for(var c=a.length,d=0;d<c;d++)!(1==a[d].nodeType&&"PARAM"==a[d].nodeName)&&8!=a[d].nodeType&&b.appendChild(a[d].cloneNode(!0));
...
a.id;d=ga(a.id)}else{k=G.createElement(ta);k.setAttribute("type",ka);for(var l in a)a[l]!=Object.prototype[l]&&("styleclass"==l.toLowerCase()?k.setAttribute("class",a[l]):"classid"!=l.toLowerCase()&&k.setAttribute(l,a[l]));for(f in b)b[f]!=Object.prototype[f]&&"movie"!=f.toLowerCase()&&(a=k,j=f,l=b[f],c=G.createElement("param"),c.setAttribute("name",j),c.setAttribute("value",l),a.appendChild(c));e.parentNode.replaceChild(k,e);d=k}return d},F=function(a){var b=ga(a);b&&"OBJECT"==b.nodeName&&(E.ie&&
...
sa=function(a,b){if(Sb){var c=b?"visible":"hidden";Ua&&ga(a)?ga(a).style.visibility=c:ab("#"+a,"visibility:"+c)}},Ca=function(a){return null!=/[\\\"<>\.;]/.exec(a)&&typeof encodeURIComponent!=da?encodeURIComponent(a):a},da="undefined",ta="object",ka="application/x-shockwave-flash",x="SWFObjectExprInst",O=window,G=document;q=navigator;var Ta=!1,d=[function(){if(Ta){var a=G.getElementsByTagName("body")[0],b=G.createElement(ta);b.setAttribute("type",ka);var c=a.appendChild(b);if(c){var d=0;(function(){if(typeof c.GetVariable!=
da){var e=c.GetVariable("$version");e&&(e=e.split(" ")[1].split(","),E.pv=[parseInt(e[0],10),parseInt(e[1],10),parseInt(e[2],10)])}else if(10>d){d++;setTimeout(arguments.callee,10);return}a.removeChild(b);c=null;ia()})()}else ia()}else ia()}],Da=[],Ba=[],bb=[],jb,kb,Ib,Rb,Ua=!1,rb=!1,Ka,Jb,Sb=!0,E,Q=typeof G.getElementById!=da&&typeof G.getElementsByTagName!=da&&typeof G.createElement!=da,Va=q.userAgent.toLowerCase(),Wa=q.platform.toLowerCase(),ec=Wa?/win/.test(Wa):/win/.test(Va),Wa=Wa?/mac/.test(Wa):
/mac/.test(Va),Va=/webkit/.test(Va)?parseFloat(Va.replace(/^.*webkit\/(\d+(\.\d+)?).*$/,"$1")):!1,lb=!+"\v1",ba=[0,0,0],ea=null;if(typeof q.plugins!=da&&typeof q.plugins["Shockwave Flash"]==ta){if((ea=q.plugins["Shockwave Flash"].description)&&!(typeof q.mimeTypes!=da&&q.mimeTypes[ka]&&!q.mimeTypes[ka].enabledPlugin))Ta=!0,lb=!1,ea=ea.replace(/^.*\s+(\S+\s+\S+$)/,"$1"),ba[0]=parseInt(ea.replace(/^(.*)\..*$/,"$1"),10),ba[1]=parseInt(ea.replace(/^.*\.(.*)\s.*$/,"$1"),10),ba[2]=/[a-zA-Z]/.test(ea)?parseInt(ea.replace(/^.*[a-zA-Z]+(.*)$/,
...
da&&G.addEventListener("DOMContentLoaded",ha,!1),E.ie&&E.win&&(G.attachEvent("onreadystatechange",function(){"complete"==G.readyState&&(G.detachEvent("onreadystatechange",arguments.callee),ha())}),O==top&&function(){if(!Ua){try{G.documentElement.doScroll("left")}catch(a){setTimeout(arguments.callee,0);return}ha()}}()),E.wk&&function(){Ua||(/loaded|complete/.test(G.readyState)?ha():setTimeout(arguments.callee,0))}(),l(ha)));E.ie&&E.win&&window.attachEvent("onunload",function(){for(var a=bb.length,
b=0;b<a;b++)bb[b][0].detachEvent(bb[b][1],bb[b][2]);a=Ba.length;for(b=0;b<a;b++)F(Ba[b]);for(var c in E)E[c]=null;E=null;for(var d in fa)fa[d]=null;fa=null});fa={registerObject:function(a,b,c,d){if(E.w3&&a&&b){var e={};e.id=a;e.swfVersion=b;e.expressInstall=c;e.callbackFn=d;Da[Da.length]=e;sa(a,!1)}else d&&d({success:!1,id:a})},getObjectById:function(a){if(E.w3)return Y(a)},embedSWF:function(a,b,c,d,e,f,j,l,x,q){var p={success:!1,id:b};E.w3&&!(E.wk&&312>E.wk)&&a&&b&&c&&d&&e?(sa(b,!1),ja(function(){c+=
"";d+="";var n={};if(x&&typeof x===ta)for(var s in x)n[s]=x[s];n.data=a;n.width=c;n.height=d;s={};if(l&&typeof l===ta)for(var r in l)s[r]=l[r];if(j&&typeof j===ta)for(var O in j)s.flashvars=typeof s.flashvars!=da?s.flashvars+("&"+O+"="+j[O]):O+"="+j[O];if($a(e))r=A(n,s,b),n.id==b&&sa(b,!0),p.success=!0,p.ref=r;else{if(f&&k()){n.data=f;D(n,s,b,q);return}sa(b,!0)}q&&q(p)})):q&&q(p)},switchOffAutoHideShow:function(){Sb=!1},ua:E,getFlashPlayerVersion:function(){return{major:E.pv[0],minor:E.pv[1],release:E.pv[2]}},
hasFlashPlayerVersion:$a,createSWF:function(a,b,c){if(E.w3)return A(a,b,c)},showExpressInstall:function(a,b,c,d){E.w3&&k()&&D(a,b,c,d)},removeSWF:function(a){E.w3&&F(a)},createCSS:function(a,b,c,d){E.w3&&ab(a,b,c,d)},addDomLoadEvent:ja,addLoadEvent:l,getQueryParamValue:function(a){var b=G.location.search||G.location.hash;if(b){/\?/.test(b)&&(b=b.split("?")[1]);if(null==a)return Ca(b);for(var b=b.split("&"),c=0;c<b.length;c++)if(b[c].substring(0,b[c].indexOf("="))==a)return Ca(b[c].substring(b[c].indexOf("=")+
1))}return""},expressInstallCallback:function(){if(rb){var a=ga(x);a&&jb&&(a.parentNode.replaceChild(jb,a),kb&&(sa(kb,!0),E.ie&&E.win&&(jb.style.display="block")),Ib&&Ib(Rb));rb=!1}}}}if(!("undefined"==typeof window||window.WebSocket)){var oa=window.console;if(!oa||!oa.log||!oa.error)oa={log:function(){},error:function(){}};fa.hasFlashPlayerVersion("10.0.0")?("file:"==location.protocol&&oa.error("WARNING: web-socket-js doesn't work in file:///... URL unless you set Flash Security Settings properly. Open the page via Web server i.e. http://..."),
...
this.index,l;f.className="socketio";f.style.position="absolute";f.style.top="0px";f.style.left="0px";f.style.display="none";f.target=k;f.method="POST";f.setAttribute("accept-charset","utf-8");j.name="d";f.appendChild(j);document.body.appendChild(f);this.form=f;this.area=j}this.form.action=this.prepareUrl()+e;c();this.area.value=wa.JSON.stringify(a);try{this.form.submit()}catch(x){}this.iframe.attachEvent?l.onreadystatechange=function(){"complete"==d.iframe.readyState&&b()}:this.iframe.onload=b;this.socket.setBuffer(!0)};
...
(function(a){function b(a,b,c,e){var d=c.lang();return d[a].call?d[a](c,e):d[a][b]}function c(a,b){return function(c){return l(a.call(this,c),b)}}function e(a){return function(b){b=a.call(this,b);return b+this.lang().ordinal(b)}}function f(a,b,c){this._d=a;this._isUTC=!!b;this._a=a._a||null;this._lang=c||!1}function p(a){var b=this._data={},c=a.years||a.y||0,e=a.months||a.M||0,d=a.weeks||a.w||0,f=a.days||a.d||0,j=a.hours||a.h||0,k=a.minutes||a.m||0,l=a.seconds||a.s||0;a=a.milliseconds||a.ms||0;this._milliseconds=
a+1E3*l+6E4*k+36E5*j;this._days=f+7*d;this._months=e+12*c;b.milliseconds=a%1E3;l+=r(a/1E3);b.seconds=l%60;k+=r(l/60);b.minutes=k%60;j+=r(k/60);b.hours=j%24;f+=r(j/24);f+=7*d;b.days=f%30;e+=r(f/30);b.months=e%12;c+=r(e/12);b.years=c;this._lang=!1}function r(a){return 0>a?Math.ceil(a):Math.floor(a)}function l(a,b){for(var c=a+"";c.length<b;)c="0"+c;return c}function q(a,b,c){var e=b._milliseconds,d=b._days;b=b._months;var f;e&&a._d.setTime(+a+e*c);d&&a.date(a.date()+d*c);b&&(f=a.date(),a.date(1).month(a.month()+
b*c).date(Math.min(f,a.daysInMonth())))}function Q(a){return"[object Array]"===Object.prototype.toString.call(a)}function T(a,b){var c=Math.min(a.length,b.length),e=Math.abs(a.length-b.length),d=0,f;for(f=0;f<c;f++)~~a[f]!==~~b[f]&&d++;return d+e}function W(a,b,c,e){var d,f,j=[];for(d=0;7>d;d++)j[d]=a[d]=null==a[d]?2===d?1:0:a[d];return a[7]=j[7]=b,null!=a[8]&&(j[8]=a[8]),a[3]+=c||0,a[4]+=e||0,f=new Date(0),b?(f.setUTCFullYear(a[0],a[1],a[2]),f.setUTCHours(a[3],a[4],a[5],a[6])):(f.setFullYear(a[0],
a[1],a[2]),f.setHours(a[3],a[4],a[5],a[6])),f._a=j,f}function y(a,b){var c,e,d=[];!b&&H&&(b=require("./lang/"+a));for(c=0;c<S.length;c++)b[S[c]]=b[S[c]]||ca.en[S[c]];for(c=0;12>c;c++)e=j([2E3,c]),d[c]=RegExp("^"+(b.months[c]||b.months(e,""))+"|^"+(b.monthsShort[c]||b.monthsShort(e,"")).replace(".",""),"i");return b.monthsParse=b.monthsParse||d,ca[a]=b,b}function B(a){return(a="string"==typeof a&&a||a&&a._lang||null)?ca[a]||y(a):j}function N(a,b){function c(b){return a.lang().longDateFormat[b]||b}
for(var e=5;e--&&ha.test(b);)b=b.replace(ha,c);if(!Ca[b]){var e=Ca,d=b,f=b,j=f.match(fa),k,l;k=0;for(l=j.length;k<l;k++)ka[j[k]]?j[k]=ka[j[k]]:j[k]=j[k].match(/\[.*\]/)?j[k].replace(/^\[|\]$/g,""):j[k].replace(/\\/g,"");e[d]=function(a){var b="";for(k=0;k<l;k++)b+="function"==typeof j[k].call?j[k].call(a,f):j[k];return b}}return Ca[b](a)}function X(a){switch(a){case "DDDD":return k;case "YYYY":return D;case "S":case "SS":case "SSS":case "DDD":return Y;case "MMM":case "MMMM":case "dd":case "ddd":case "dddd":case "a":case "A":return n;
case "Z":case "ZZ":return w;case "T":return A;case "MM":case "DD":case "YY":case "HH":case "hh":case "mm":case "ss":case "M":case "D":case "d":case "H":case "h":case "m":case "s":return ia;default:return RegExp(a.replace("\\",""))}}function s(a,b){var c=[0,0,1,0,0,0,0],e={tzh:0,tzm:0},d=b.match(fa),f,j;for(f=0;f<d.length;f++)if((j=(X(d[f]).exec(a)||[])[0])&&(a=a.slice(a.indexOf(j)+j.length)),ka[d[f]]){var k=c,l=e,q=void 0,p=void 0;switch(d[f]){case "M":case "MM":k[1]=null==j?0:~~j-1;break;case "MMM":case "MMMM":for(q=
0;12>q;q++)if(B().monthsParse[q].test(j)){k[1]=q;p=!0;break}p||(k[8]=!1);break;case "D":case "DD":case "DDD":case "DDDD":null!=j&&(k[2]=~~j);break;case "YY":k[0]=~~j+(70<~~j?1900:2E3);break;case "YYYY":k[0]=~~Math.abs(j);break;case "a":case "A":l.isPm="pm"===(j+"").toLowerCase();break;case "H":case "HH":case "h":case "hh":k[3]=~~j;break;case "m":case "mm":k[4]=~~j;break;case "s":case "ss":k[5]=~~j;break;case "S":case "SS":case "SSS":k[6]=~~(1E3*("0."+j));break;case "Z":case "ZZ":l.isUTC=!0,(q=(j+
"").match($a))&&q[1]&&(l.tzh=~~q[1]),q&&q[2]&&(l.tzm=~~q[2]),q&&"+"===q[0]&&(l.tzh=-l.tzh,l.tzm=-l.tzm)}null==j&&(k[8]=!1)}return e.isPm&&12>c[3]&&(c[3]+=12),!1===e.isPm&&12===c[3]&&(c[3]=0),W(c,e.isUTC,e.tzh,e.tzm)}function U(a,b,c,e,d){d=d.relativeTime[a];return"function"==typeof d?d(b||1,!!c,a,e):d.replace(/%d/i,b||1)}function K(a,b){j.fn[a]=function(a){var c=this._isUTC?"UTC":"";return null!=a?(this._d["set"+c+b](a),this):this._d["get"+c+b]()}}function V(a){j.duration.fn[a]=function(){return this._data[a]}}
...
12||12},m:function(){return this.minutes()},s:function(){return this.seconds()},S:function(){return~~(this.milliseconds()/100)},SS:function(){return l(~~(this.milliseconds()/10),2)},SSS:function(){return l(this.milliseconds(),3)},Z:function(){var a=-this.zone();return 0>a&&(a=-a),"+"+l(~~(a/60),2)+":"+l(~~a%60,2)},ZZ:function(){var a=-this.zone();return 0>a&&(a=-a),"+"+l(~~(10*a/6),4)}};da.length;)R=da.pop(),ka[R+"o"]=e(ka[R]);for(;ta.length;)R=ta.pop(),ka[R+R]=c(ka[R],2);ka.DDDD=c(ka.DDD,3);j=function(b,
c){if(null===b||""===b)return null;var e;if(j.isMoment(b))e=new f(new Date(+b._d),b._isUTC,b._lang);else{if(c)if(Q(c)){var k=b.match(ja)||[],d,l=99,q,p;for(q=0;q<c.length;q++)p=s(b,c[q]),d=N(new f(p),c[q]).match(ja)||[],d=T(k,d),d<l&&(l=d,e=p)}else e=s(b,c);else if(e=P.exec(b),b===a)e=new Date;else if(e)e=new Date(+e[1]);else if(b instanceof Date)e=b;else if(Q(b))e=W(b);else if("string"==typeof b)if(e="YYYY-MM-DDT",F.exec(b)){for(k=0;4>k;k++)if(ga[k][1].exec(b)){e+=ga[k][0];break}e=w.exec(b)?s(b,
e+" Z"):s(b,e)}else e=new Date(b);else e=new Date(b);e=new f(e)}return e};j.utc=function(a,b){return Q(a)?new f(W(a,!0),!0):("string"==typeof a&&!w.exec(a)&&(a+=" +0000",b&&(b+=" Z")),j(a,b).utc())};j.unix=function(a){return j(1E3*a)};j.duration=function(a,b){var c=j.isDuration(a),e="number"==typeof a,d=c?a._data:e?{}:a,f;return e&&(b?d[b]=a:d.milliseconds=a),f=new p(d),c&&(f._lang=a._lang),f};j.humanizeDuration=function(a,b,c){return j.duration(a,!0===b?null:b).humanize(!0===b?!0:c)};j.version="1.7.2";
j.defaultFormat="YYYY-MM-DDTHH:mm:ssZ";j.lang=function(a,b){var c;if(!a)return L;(b||!ca[a])&&y(a,b);if(ca[a]){for(c=0;c<S.length;c++)j[S[c]]=ca[a][S[c]];j.monthsParse=ca[a].monthsParse;L=a}};j.langData=B;j.isMoment=function(a){return a instanceof f};j.isDuration=function(a){return a instanceof p};j.lang("en",{months:"January February March April May June July August September October November December".split(" "),monthsShort:"Jan Feb Mar Apr May Jun Jul Aug Sep Oct Nov Dec".split(" "),weekdays:"Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" "),
...
this.minutes(),this.seconds(),this.milliseconds(),!!this._isUTC]},isValid:function(){return this._a?null!=this._a[8]?!!this._a[8]:!T(this._a,(this._a[7]?j.utc(this._a):j(this._a)).toArray()):!isNaN(this._d.getTime())},utc:function(){return this._isUTC=!0,this},local:function(){return this._isUTC=!1,this},format:function(a){return N(this,a?a:j.defaultFormat)},add:function(a,b){var c=b?j.duration(+b,a):j.duration(a);return q(this,c,1),this},subtract:function(a,b){var c=b?j.duration(+b,a):j.duration(a);
...
daysInMonth:function(){return j.utc([this.year(),this.month()+1,0]).date()},lang:function(b){return b===a?B(this):(this._lang=b,this)}};for(R=0;R<ab.length;R++)K(ab[R].toLowerCase(),ab[R]);K("year","FullYear");j.duration.fn=p.prototype={weeks:function(){return r(this.days()/7)},valueOf:function(){return this._milliseconds+864E5*this._days+2592E6*this._months},humanize:function(a){var b=+this,c=this.lang().relativeTime,e;e=!a;var d=this.lang(),f=C(Math.abs(b)/1E3),j=C(f/60),k=C(j/60),l=C(k/24),q=C(l/
365),f=45>f&&["s",f]||1===j&&["m"]||45>j&&["mm",j]||1===k&&["h"]||22>k&&["hh",k]||1===l&&["d"]||25>=l&&["dd",l]||45>=l&&["M"]||345>l&&["MM",C(l/30)]||1===q&&["y"]||["yy",q];e=(f[2]=e,f[3]=0<b,f[4]=d,U.apply({},f));b=0>=b?c.past:c.future;return a&&("function"==typeof b?e=b(e):e=b.replace(/%s/i,e)),e},lang:j.fn.lang};for(R in sa)sa.hasOwnProperty(R)&&(I(R,sa[R]),V(R.toLowerCase()));I("Weeks",6048E5);H&&(module.exports=j);"undefined"==typeof ender&&(this.moment=j);"function"==typeof define&&define.amd&&
...
338241895,666307205,773529912,1294757372,1396182291,1695183700,1986661051,2177026350,2456956037,2730485921,2820302411,3259730800,3345764771,3516065817,3600352804,4094571909,275423344,430227734,506948616,659060556,883997877,958139571,1322822218,1537002063,1747873779,1955562222,2024104815,2227730452,2361852424,2428436474,2756734187,3204031479,3329325298],l=[1779033703,3144134277,1013904242,2773480762,1359893119,2600822924,528734635,1541459225],p=Array(64),r,N,X,s,U,K,V,I,j,C,R,ca;a[b>>5]|=128<<24-b%
32;a[(b+64>>9<<4)+15]=b;for(j=0;j<a.length;j+=16){r=l[0];N=l[1];X=l[2];s=l[3];U=l[4];K=l[5];V=l[6];I=l[7];for(C=0;64>C;C++)p[C]=16>C?a[C+j]:c(c(c(e(p[C-2],17)^e(p[C-2],19)^p[C-2]>>>10,p[C-7]),e(p[C-15],7)^e(p[C-15],18)^p[C-15]>>>3),p[C-16]),R=c(c(c(c(I,e(U,6)^e(U,11)^e(U,25)),U&K^~U&V),f[C]),p[C]),ca=c(e(r,2)^e(r,13)^e(r,22),r&N^r&X^N&X),I=V,V=K,K=U,U=c(s,R),s=X,X=N,N=r,r=c(R,ca);l[0]=c(r,l[0]);l[1]=c(N,l[1]);l[2]=c(X,l[2]);l[3]=c(s,l[3]);l[4]=c(U,l[4]);l[5]=c(K,l[5]);l[6]=c(V,l[6]);l[7]=c(I,l[7])}return l},
p=function(a){for(var c=[],e=(1<<b)-1,f=0;f<a.length*b;f+=b)c[f>>5]|=(a.charCodeAt(f/b)&e)<<24-f%32;return c},r=function(a){for(var b="",c=0;c<4*a.length;c++)b+="0123456789abcdef".charAt(a[c>>2]>>8*(3-c%4)+4&15)+"0123456789abcdef".charAt(a[c>>2]>>8*(3-c%4)&15);return b},l=function(b){return b="object"==typeof b?a(b).val():b.toString()};a.extend({sha256:function(a){a=l(a);return r(f(p(a),a.length*b))},sha256hmac:function(a,c){a=l(a);c=l(c);var e,W=a;e=c;var y=p(W);16<y.length&&(y=f(y,W.length*b));
for(var B=Array(16),W=Array(16),N=0;16>N;N++)B[N]=y[N]^909522486,W[N]=y[N]^1549556828;e=f(B.concat(p(e)),512+e.length*b);e=f(W.concat(e),768);return r(e)},sha256config:function(a){b=parseInt(a)||8}});a.fn.sha256=function(b){a.sha256config(b);b=l(a(this).val());b=a.sha256(b);a.sha256config(8);return b}})(jQuery);
...
Space.prototype.getBySpace=function(a){var b=new Space,c;for(c in a.keys){var e=a.keys[c],f=this.values[e];"undefined"!==typeof f&&(!(a.values[e]instanceof Space)||!a.values[e].keys.length?b.set(e,f):f instanceof Space&&b.set(e,f.getBySpace(a.values[e])))}return b};Space.prototype.length=function(){return this.keys.length};
...
var Thumbs={getDimensions:function(a){var b={},c=!1;$(a).contents().find(".scrap").each(function(){var a,f,p,r;c?(a=$(this).position().left,f=a+$(this).outerWidth(),p=$(this).position().top,r=top+$(this).outerHeight(),a<b.left&&(b.left=a),f>b.right&&(b.right=f),p<b.top&&(b.top=p),r>b.bottom&&(b.bottom=r)):(b.left=$(this).position().left,b.right=b.left+$(this).outerWidth(),b.top=$(this).position().top,b.bottom=b.top+$(this).outerHeight(),c=!0)});b.height=b.bottom-b.top;b.width=b.right-b.left;return b},
...
function(a){a.stopPropagation()});var p=$('<div id="nudgepadEditorSaveButton">Send</div>'),r=$('<div id="nudgepadEditorCancelButton">Close</div>'),l=$('<div id="nudgepadEditorButtonContainer"></div>');f.on("click",function(){r.trigger("click")});r.on("click",function(){p.remove();a.remove();f.remove();l.remove();r.remove();e.remove();c.remove();b.remove()});p.on("click",function(){var e=b.val(),f="nudgepad.console";c.is(":checked")&&(f="nudgepad.exec");$.post(f,{command:e},function(c){a.append(">"+
e.replace(/\n/g,"> \n")+"\n");a.append(c+"\n");a.scrollTop($("pre")[0].scrollHeight+"");b.val("");b.focus()},null,function(c){mixpanel.track("I used the console and got an error");a.append(">"+e.replace(/\n/g,"> \n")+"\n");a.append("ERROR\n");a.append(c.responseText+"\n");a.scrollTop($("pre")[0].scrollHeight+"");b.val("");b.focus()})});b.on("enterkey",function(){p.click()});$("body").append(f);$("body").append(c);$("body").append(e);$("body").append(a);$("body").append(b);$("body").append(p);$("body").append(r);
...
nudgepad.getPageDimensions=function(a){a=new Page(a);a._static=!0;var b=$('<iframe class="deleteMe" style="position: fixed; right: 0px; top: 0px;"></iframe>');b.attr("frameborder",0);b.attr("scrolling","no");b.css("width",1);b.css("height",1);$("#nudgepadTemp").append(b);b.contents().find("body").append(a.toHtml());var c={},e=!1;b.contents().find(".scrap").each(function(){var a,b,r,l;e?(a=$(this).position().left,b=a+$(this).outerWidth(),r=$(this).position().top,l=top+$(this).outerHeight(),a<c.left&&
(c.left=a),b>c.right&&(c.right=b),r<c.top&&(c.top=r),l>c.bottom&&(c.bottom=l)):(c.left=$(this).position().left,c.right=c.left+$(this).outerWidth(),c.top=$(this).position().top,c.bottom=c.top+$(this).outerHeight(),e=!0)});c.height=c.bottom-c.top;c.width=c.right-c.left;$(".deleteMe").remove();return c};nudgepad.apps.git=new App("git");nudgepad.apps.git.commit=function(){var a=prompt("Enter your commit message");nudgepad.apps.git.send("git commit -am '"+a+"'")};nudgepad.apps.git.init=function(){nudgepad.apps.git.send("git init")};
...
Grid.prototype.getDelta=function(a){this.eraseSnaplines();var b={},c=[],e=[],f;for(f in a){var p=a[f],r;for(r in this.points)if(this.points.hasOwnProperty(r)){var l=this.points[r],q=l.x-p.x,Q=l.y-p.y;b.x||(b.x=q,b.y=Q);Math.abs(q)<=Math.abs(b.x)&&(b.x=q,c=[p,l]);Math.abs(Q)<=Math.abs(b.y)&&(b.y=Q,e=[p,l])}}a=Math.abs(b.x)<this.radius;f=Math.abs(b.y)<this.radius;a||(b.x=0);f||(b.y=0);a&&(c[0]={x:c[0].x+b.x,y:c[0].y+b.y},this.drawSnapline(c[0],c[1]));f&&(e[0]={x:e[0].x+b.x,y:e[0].y+b.y},this.drawSnapline(e[0],
...
nudgepad.StretchHandle.create=function(a,b,c,e){var f=a.element(),p="fixed"==f.css("position")?"fixed":"absolute",r=("top"==b?"n":"bottom"==b?"s":"")+("left"==c?"w":"right"==c?"e":""),l=$("<div></div>");l.attr("value",a.getPath());l.addClass("handle stretch_handle stretch_handle_"+a.id+" "+a.id+"_handle");l.attr("id","stretch_handle_"+b+c+a.id);l.css({cursor:r+"-resize",position:p,width:"5px",height:"5px",border:"1px solid rgba(0, 0, 0, .5)","background-color":"rgba(255, 255, 255, 0.5)","z-index":"50"});
...
$(this).parent().offset().top,l=nudgepad.StretchHandle.getLength(f,p,r,l,"center"!=c,"middle"!=b),r=a.scrap();"center"!=c&&(r.set("style left",(0<=l.x?f:l.x+f)+"px"),c=a.outerWidth()-a.width(),r.set("style width",Math.abs(l.x)-c+"px"));e?(b=parseFloat(r.get("style width"))/nudgepad.StretchHandle.originalWidth,r.set("style height",Math.round(nudgepad.StretchHandle.originalHeight*b)+"px")):"middle"!=b&&(0<=l.y?r.set("style top",p+"px"):r.set("style top",l.y+p+"px"),b=a.outerHeight()-a.height(),r.set("style height",
Math.abs(l.y)-b+"px"));a.css(r.values.style.values);b="W "+parseFloat(a.css("width"))+"<br> H "+parseFloat(a.css("height"));$("#nudgepadDimensions").css({left:10+a.offset().left+a.outerWidth(),top:-10+a.offset().top+Math.round(a.outerHeight()/2)}).html(b);$(".stretch_handle_"+r.id).trigger("update");return!1};
...
$('<div class="editorOption selectedEditorOption">Block</div>');f.on("tap",function(){$("div").removeClass("selectedEditorOption");$(this).addClass("selectedEditorOption");B.hide();T.hide();p.show();return!1});c.append(f);f=$('<div class="editorOption">Text</div>');f.on("tap",function(){$("div").removeClass("selectedEditorOption");$(this).addClass("selectedEditorOption");p.hide();B.hide();a.get("style")&&B.val(a.get("style"));T.show();return!1});c.append(f);f=$('<div class="editorOption">Code</div>');
f.on("tap",function(){$("div").removeClass("selectedEditorOption");$(this).addClass("selectedEditorOption");p.hide();T.hide();a.get("style")&&B.val(a.get("style"));B.show();return!1});c.append(f);var p=$('<div id="blockContainer"></div>');e.append(p);var r=$(".selection").css("background-color"),c=$('<div class="colorBackground"><input type="text" class="colorPicker"></div>');p.append(c);c=$('<div class="editorButton"><img src="/nudgepad/images/dup_lt.png"></div>');c.on("click",function(){nudgepad.stage.selection.duplicate()});
p.append(c);c=$('<div class="editorButton"><img src="/nudgepad/images/lock_lt.png"></div>');c.on("tap",function(){nudgepad.stage.selection.patch("locked true");N.trigger("click");return!1});p.append(c);var l=$('<select id="nudgepadLinkSelect"></select>'),c=$("<option>No link</option>");c.on("click",function(){nudgepad.stage.selection.patch("href ")});l.append(c);_.each(site.values.pages.values,function(a,b){var c=$('<option value="'+b+'">'+ToProperCase(b)+"</option>");c.on("click",function(){nudgepad.stage.selection.patch("tag a\nhref "+
$(this).attr("value"))});l.append(c)});c=$("<option>New Page</option>");c.on("click",function(){var a=prompt("Enter the name of your new page",nudgepad.pages.nextName(nudgepad.stage.activePage));if(a){a=Permalink(a);nudgepad.stage.selection.patch("tag a\nhref "+a);N.trigger("click");var b=nudgepad.stage.activePage;nudgepad.pages.duplicate(null,a,!0);nudgepad.stage.open(b)}});l.append(c);c=$("<option>External Link</option>");c.on("click",function(){var a=prompt("Enter the url to link to","http://");
...
c.on("tap",function(){a.moveUp();B.val(a.get("style"));return!1});p.append(c);c=$('<div class="editorButton"><img src="/nudgepad/images/down_lt.png" title="Order Down"></div>');c.on("tap",function(){a.moveDown();B.val(a.get("style"));return!1});p.append(c);var q=$('<div class="clear"></div>');p.append(q);c=$('<div class="columnLeft"></div>');p.append(c);f=$('<div class="editorHeader">Curve</div>');c.append(f);f=$('<div id="roundessOne" class="toolButton toolButtonOne">0</div>');f.on("click",function(){nudgepad.stage.selection.cssPreview("border-radius 0px 0px 0px 0px");
...
f=$('<div class="columnLeft"></div>');T.append(f);q=$('<div class="editorHeader">Alignment</div>');f.append(q);q=$('<div class="toolButton toolButtonOne"><img src="/nudgepad/images/left_lt.png"></div>');q.on("click",function(){nudgepad.stage.selection.cssPreview("text-align left");nudgepad.stage.commit();$(".handle").trigger("update");return!1});f.append(q);q=$('<div class="toolButton toolButtonTwo"><img src="/nudgepad/images/center_lt.png"></div>');q.on("click",function(){nudgepad.stage.selection.cssPreview("text-align center");
nudgepad.stage.commit();$(".handle").trigger("update");return!1});f.append(q);q=$('<div class="toolButton toolButtonTwo"><img src="/nudgepad/images/right_lt.png"></div>');q.on("click",function(){nudgepad.stage.selection.cssPreview("text-align right");nudgepad.stage.commit();$(".handle").trigger("update");return!1});f.append(q);q=$('<div class="toolButton toolButtonThree"><img src="/nudgepad/images/justify_lt.png"></div>');q.on("click",function(){nudgepad.stage.selection.cssPreview("text-align justify");
nudgepad.stage.commit();$(".handle").trigger("update");return!1});f.append(q);q=$('<div class="clear"></div>');f.append(q);q=$('<div class="editorHeader">Padding</div>');f.append(q);q=$('<div class="toolButton toolButtonOne">0</div>');q.on("click",function(){nudgepad.stage.selection.cssPreview("padding 0px");nudgepad.stage.commit();$(".handle").trigger("update");return!1});f.append(q);q=$('<div class="toolButton toolButtonTwo">10</div>');q.on("click",function(){nudgepad.stage.selection.cssPreview("padding 10px");
nudgepad.stage.commit();$(".handle").trigger("update");return!1});f.append(q);q=$('<div class="toolButton toolButtonTwo">20</div>');q.on("click",function(){nudgepad.stage.selection.cssPreview("padding 20px");nudgepad.stage.commit();$(".handle").trigger("update");return!1});f.append(q);q=$('<div class="toolButton toolButtonTwo">40</div>');q.on("click",function(){nudgepad.stage.selection.cssPreview("padding 40px");nudgepad.stage.commit();$(".handle").trigger("update");return!1});f.append(q);f=$('<div class="columnRight"></div>');
T.append(f);q=$('<div class="clear"></div>');f.append(q);q=$('<div class="editorHeader">Line Height</div>');f.append(q);q=$('<div id="lineHeightOne" class="toolButton toolButtonOne">100</div>');q.on("click",function(){nudgepad.stage.selection.cssPreview("line-height 100%");return!1});f.append(q);q=$('<div id="lineHeightTwo" class="toolButton toolButtonTwo">140</div>');q.on("click",function(){nudgepad.stage.selection.cssPreview("line-height 140%");return!1});f.append(q);q=$('<div id="lineHeightTwo" class="toolButton toolButtonTwo">180</div>');
q.on("click",function(){nudgepad.stage.selection.cssPreview("line-height 180%");return!1});f.append(q);q=$('<div id="lineHeightThree" class="toolButton toolButtonThree">Mid</div>');q.on("click",function(){var a=$(".selection").css("height");nudgepad.stage.selection.cssPreview("line-height "+a);return!1});f.append(q);q=$('<div class="clear"></div>');f.append(q);q=$('<div class="editorHeader">Style</div>');f.append(q);q=$('<div id="textStyleOne" class="toolButton toolButtonOne">B</div>');q.on("click",
function(){nudgepad.stage.selection.cssPreview("font-weight bold");nudgepad.stage.commit();$(".handle").trigger("update");return!1});f.append(q);q=$('<div id="italics" class="toolButton toolButtonTwo">I</div>');q.on("click",function(){nudgepad.stage.selection.cssPreview("font-style italic");nudgepad.stage.commit();$(".handle").trigger("update");return!1});f.append(q);q=$('<div id="textStyleTwo" class="toolButton toolButtonTwo">U</div>');q.on("click",function(){nudgepad.stage.selection.cssPreview("text-decoration underline");
nudgepad.stage.commit();$(".handle").trigger("update");return!1});f.append(q);q=$('<div id="textStyleThree" class="toolButton toolButtonThree">Auto</div>');q.on("click",function(){nudgepad.stage.selection.cssPreview({"text-decoration":"none","font-weight":"normal","font-style":"normal"});return!1});f.append(q);q=$('<div class="clear"></div>');T.append(q);var B=$('<textarea id="nudgepadStyleEditorCssEditor"></textarea>');a.get("style")&&B.val(a.get("style"));B.on("tap mousedown click slide slidestart slideend mouseup",
function(a){a.stopPropagation()});nudgepad.livePreviewScrap=a;B.on("keyup",nudgepad.livePreviewStart);e.append(B);f=$('<div id="nudgepadStyleEditorBottomBar"></div>');B.append(f);var N=$('<div id="nudgepadStyleEditorSaveButton">Save</div>');N.on("click",function(){nudgepad.stage.commit();$(".handle").trigger("update");e.remove();b.remove()});B.append(N);$("body").append(e);var X;$(".colorPicker").spectrum({color:r,move:function(a){nudgepad.stage.selection.cssPreview("background-color "+a.toHexString());
r=a.toHexString()},change:function(a){$("#basic-log").text("change called: "+a.toHexString());r=a.toHexString()},show:function(){X="background-color "},hide:function(){nudgepad.stage.commit();$(".handle").trigger("update")}});$(".colorBorderPicker").spectrum({color:Q,move:function(a){nudgepad.stage.selection.cssPreview("border-color "+a.toHexString());Q=a.toHexString()},change:function(a){$("#basic-log").text("change called: "+a.toHexString());Q=a.toHexString()},show:function(){X="border-color "},
...
nudgepad.pages.updateTabs=function(){$("#nudgepadTabs").html("");var a=site.get("pages").keys;_.each(a,function(a){var c=$("<span>"+a+"</span>");a===nudgepad.stage.activePage&&c.css("color","white");_.each(nudgepad.openPages,function(e){a===e&&c.addClass("openPage")});c.on("hold",function(){window.open($(this).text(),"published");return!0});c.on("click",function(){mixpanel.track("I clicked a page tab");nudgepad.stage.open($(this).text());return!0});c.attr("value",a);$("#nudgepadTabs").append(c)})};
nudgepad.textPrompt=function(a,b,c,e,f){var p=$('<textarea id="nudgepadEditorTextarea" class="nudgepad"></textarea>');p.val(b);var r=$('<div id="nudgepadEditorModalScreen" class="nudgepad"/>');r.on("tap mousedown click slide slidestart slideend mouseup",function(a){a.stopPropagation()});p.on("tap mousedown click slide slidestart slideend mouseup",function(a){a.stopPropagation()});if(e)p.on("keypress",e);var l=$('<div id="nudgepadEditorSaveButton" class="nudgepad">'+(f||"Save")+"</div>"),q=$('<div id="nudgepadEditorCancelButton" class="nudgepad">Cancel</div>'),
Q=$('<div id="nudgepadEditorButtonContainer" class="nudgepad"></div>');r.on("click",function(){q.trigger("click")});q.on("click",function(){l.remove();p.remove();r.remove();Q.remove();q.remove()});l.on("click",function(){c&&c(p.val());l.remove();p.remove();r.remove();Q.remove();q.remove()});$("body").append(r);$("body").append(p);$("body").append(l);$("body").append(q);$("body").append(Q);p.focus()};
/**
