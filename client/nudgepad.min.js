(function(a,b){function c(g){var a=g.length,u=d.type(g);return d.isWindow(g)?!1:1===g.nodeType&&a?!0:"array"===u||"function"!==u&&(0===a||"number"==typeof a&&0<a&&a-1 in g)}function e(g,a,u,t){if(d.acceptData(g)){var c,h,Sa=d.expando,e="string"==typeof a,l=g.nodeType,f=l?d.cache:g,k=l?g[Sa]:g[Sa]&&Sa;if(k&&f[k]&&(t||f[k].data)||!e||u!==b)return k||(l?g[Sa]=k=Ca.pop()||d.guid++:k=Sa),f[k]||(f[k]={},l||(f[k].toJSON=d.noop)),("object"==typeof a||"function"==typeof a)&&(t?f[k]=d.extend(f[k],a):f[k].data=
d.extend(f[k].data,a)),c=f[k],t||(c.data||(c.data={}),c=c.data),u!==b&&(c[d.camelCase(a)]=u),e?(h=c[a],null==h&&(h=c[d.camelCase(a)])):h=c,h}}function f(g,a,u){if(d.acceptData(g)){var b,c,h,Sa=g.nodeType,e=Sa?d.cache:g,l=Sa?g[d.expando]:d.expando;if(e[l]){if(a&&(h=u?e[l]:e[l].data)){d.isArray(a)?a=a.concat(d.map(a,d.camelCase)):a in h?a=[a]:(a=d.camelCase(a),a=a in h?[a]:a.split(" "));b=0;for(c=a.length;c>b;b++)delete h[a[b]];if(!(u?s:d.isEmptyObject)(h))return}(u||(delete e[l].data,s(e[l])))&&(Sa?
d.cleanData([g],!0):d.support.deleteExpando||e!=e.window?delete e[l]:e[l]=null)}}}function n(g,a,u){if(u===b&&1===g.nodeType){var t="data-"+a.replace(wa,"-$1").toLowerCase();if(u=g.getAttribute(t),"string"==typeof u){try{u="true"===u?!0:"false"===u?!1:"null"===u?null:+u+""===u?+u:Ga.test(u)?d.parseJSON(u):u}catch(c){}d.data(g,a,u)}else u=b}return u}function s(g){for(var a in g)if(("data"!==a||!d.isEmptyObject(g[a]))&&"toJSON"!==a)return!1;return!0}function m(){return!0}function p(){return!1}function Q(g,
a){do g=g[a];while(g&&1!==g.nodeType);return g}function T(g,a,u){if(a=a||0,d.isFunction(a))return d.grep(g,function(g,b){return!!a.call(g,b,g)===u});if(a.nodeType)return d.grep(g,function(g){return g===a===u});if("string"==typeof a){var b=d.grep(g,function(g){return 1===g.nodeType});if(Uc.test(a))return d.filter(a,b,!u);a=d.filter(a,b)}return d.grep(g,function(g){return 0<=d.inArray(g,a)===u})}function W(g){var a=tc.split("|");g=g.createDocumentFragment();if(g.createElement)for(;a.length;)g.createElement(a.pop());
...
d.extend({},h.data))}}function r(g,a){var u,t,c=0,h=typeof g.getElementsByTagName!==A?g.getElementsByTagName(a||"*"):typeof g.querySelectorAll!==A?g.querySelectorAll(a||"*"):b;if(!h){h=[];for(u=g.childNodes||g;null!=(t=u[c]);c++)!a||d.nodeName(t,a)?h.push(t):d.merge(h,r(t,a))}return a===b||a&&d.nodeName(g,a)?d.merge([g],h):h}function U(g){cc.test(g.type)&&(g.defaultChecked=g.checked)}function K(g,a){if(a in g)return a;for(var b=a.charAt(0).toUpperCase()+a.slice(1),d=a,c=uc.length;c--;)if(a=uc[c]+
b,a in g)return a;return d}function V(g,a){return g=a||g,"none"===d.css(g,"display")||!d.contains(g.ownerDocument,g)}function I(g,a){for(var b,t,c,h=[],e=0,l=g.length;l>e;e++)t=g[e],t.style&&(h[e]=d._data(t,"olddisplay"),b=t.style.display,a?(h[e]||"none"!==b||(t.style.display=""),""===t.style.display&&V(t)&&(h[e]=d._data(t,"olddisplay",ca(t.nodeName)))):h[e]||(c=V(t),(b&&"none"!==b||!c)&&d._data(t,"olddisplay",c?b:d.css(t,"display"))));for(e=0;l>e;e++)t=g[e],t.style&&(a&&"none"!==t.style.display&&
...
(b=a,a="*");var t,c=0,h=a.toLowerCase().match(Ba)||[];if(d.isFunction(b))for(;t=h[c++];)"+"===t[0]?(t=t.slice(1)||"*",(g[t]=g[t]||[]).unshift(b)):(g[t]=g[t]||[]).push(b)}}function P(g,a,u,t){function c(l){var f;return h[l]=!0,d.each(g[l]||[],function(g,d){var l=d(a,u,t);return"string"!=typeof l||e||h[l]?e?!(f=l):b:(a.dataTypes.unshift(l),c(l),!1)}),f}var h={},e=g===dc;return c(a.dataTypes[0])||!h["*"]&&c("*")}function fa(g,a){var u,t,c=d.ajaxSettings.flatOptions||{};for(t in a)a[t]!==b&&((c[t]?g:
u||(u={}))[t]=a[t]);return u&&d.extend(!0,g,u),g}function ha(){try{return new a.XMLHttpRequest}catch(g){}}function ja(){return setTimeout(function(){qb=b}),qb=d.now()}function ia(g,a,b){var t,c,h=0,e=Qb.length,l=d.Deferred().always(function(){delete f.elem}),f=function(){if(c)return!1;for(var a=qb||ja(),a=Math.max(0,k.startTime+k.duration-a),b=1-(a/k.duration||0),z=0,u=k.tweens.length;u>z;z++)k.tweens[z].run(b);return l.notifyWith(g,[k,b,a]),1>b&&u?a:(l.resolveWith(g,[k]),!1)},k=l.promise({elem:g,
props:d.extend({},a),opts:d.extend(!0,{specialEasing:{}},b),originalProperties:a,originalOptions:b,startTime:qb||ja(),duration:b.duration,tweens:[],createTween:function(a,b){var z=d.Tween(g,k.opts,a,b,k.opts.specialEasing[a]||k.opts.easing);return k.tweens.push(z),z},stop:function(a){var z=0,b=a?k.tweens.length:0;if(c)return this;for(c=!0;b>z;z++)k.tweens[z].run(1);return a?l.resolveWith(g,[k,a]):l.rejectWith(g,[k,a]),this}});a=k.props;b=k.opts.specialEasing;var v,q,j,x;for(q in a)if(v=d.camelCase(q),
j=b[v],t=a[q],d.isArray(t)&&(j=t[1],t=a[q]=t[0]),q!==v&&(a[v]=t,delete a[q]),x=d.cssHooks[v],x&&"expand"in x)for(q in t=x.expand(t),delete a[v],t)q in a||(a[q]=t[q],b[q]=j);else b[v]=j;for(;e>h;h++)if(t=Qb[h].call(k,g,a,k.opts))return t;var w=k;d.each(a,function(g,a){for(var z=(Hb[g]||[]).concat(Hb["*"]),b=0,u=z.length;u>b&&!z[b].call(w,g,a);b++);});return d.isFunction(k.opts.start)&&k.opts.start.call(g,k),d.fx.timer(d.extend(f,{elem:g,anim:k,queue:k.opts.queue})),k.progress(k.opts.progress).done(k.opts.done,
k.opts.complete).fail(k.opts.fail).always(k.opts.always)}function Y(g,a,b,d,c){return new Y.prototype.init(g,a,b,d,c)}function k(g,a){var b,d={height:g},c=0;for(a=a?1:0;4>c;c+=2-a)b=gb[c],d["margin"+b]=d["padding"+b]=g;return a&&(d.opacity=d.width=g),d}function D(g){return d.isWindow(g)?g:9===g.nodeType?g.defaultView||g.parentWindow:!1}var q,w,A=typeof b,F=a.document,ga=a.location,$a=a.jQuery,ab=a.$,sa={},Ca=[],da=Ca.concat,ta=Ca.push,ka=Ca.slice,x=Ca.indexOf,O=sa.toString,G=sa.hasOwnProperty,Ta=
...
"complete"===F.readyState)&&(Va(),d.ready())},Va=function(){F.addEventListener?(F.removeEventListener("DOMContentLoaded",E,!1),a.removeEventListener("load",E,!1)):(F.detachEvent("onreadystatechange",E),a.detachEvent("onload",E))};d.fn=d.prototype={jquery:"1.9.1",constructor:d,init:function(g,a,u){var t,c;if(!g)return this;if("string"==typeof g){if(t="<"===g.charAt(0)&&">"===g.charAt(g.length-1)&&3<=g.length?[null,g,null]:jb.exec(g),!t||!t[1]&&a)return!a||a.jquery?(a||u).find(g):this.constructor(a).find(g);
if(t[1]){if(a=a instanceof d?a[0]:a,d.merge(this,d.parseHTML(t[1],a&&a.nodeType?a.ownerDocument||a:F,!0)),kb.test(t[1])&&d.isPlainObject(a))for(t in a)d.isFunction(this[t])?this[t](a[t]):this.attr(t,a[t]);return this}if(c=F.getElementById(t[2]),c&&c.parentNode){if(c.id!==t[2])return u.find(g);this.length=1;this[0]=c}return this.context=F,this.selector=g,this}return g.nodeType?(this.context=this[0]=g,this.length=1,this):d.isFunction(g)?u.ready(g):(g.selector!==b&&(this.selector=g.selector,this.context=
...
last:function(){return this.eq(-1)},eq:function(g){var a=this.length;g=+g+(0>g?a:0);return this.pushStack(0<=g&&a>g?[this[g]]:[])},map:function(g){return this.pushStack(d.map(this,function(a,b){return g.call(a,b,a)}))},end:function(){return this.prevObject||this.constructor(null)},push:ta,sort:[].sort,splice:[].splice};d.fn.init.prototype=d.fn;d.extend=d.fn.extend=function(){var g,a,u,t,c,h,e=arguments[0]||{},l=1,k=arguments.length,f=!1;"boolean"==typeof e&&(f=e,e=arguments[1]||{},l=2);"object"==
typeof e||d.isFunction(e)||(e={});for(k===l&&(e=this,--l);k>l;l++)if(null!=(c=arguments[l]))for(t in c)g=e[t],u=c[t],e!==u&&(f&&u&&(d.isPlainObject(u)||(a=d.isArray(u)))?(a?(a=!1,h=g&&d.isArray(g)?g:[]):h=g&&d.isPlainObject(g)?g:{},e[t]=d.extend(f,h,u)):u!==b&&(e[t]=u));return e};d.extend({noConflict:function(g){return a.$===d&&(a.$=ab),g&&a.jQuery===d&&(a.jQuery=$a),d},isReady:!1,readyWait:1,holdReady:function(g){g?d.readyWait++:d.ready(!0)},ready:function(g){if(!0===g?!--d.readyWait:!d.isReady){if(!F.body)return setTimeout(d.ready);
...
d.merge([],t.childNodes))},parseJSON:function(g){return a.JSON&&a.JSON.parse?a.JSON.parse(g):null===g?g:"string"==typeof g&&(g=d.trim(g),g&&Ib.test(g.replace(Ua,"@").replace(rb,"]").replace(Rb,"")))?Function("return "+g)():(d.error("Invalid JSON: "+g),b)},parseXML:function(g){var z,u;if(!g||"string"!=typeof g)return null;try{a.DOMParser?(u=new DOMParser,z=u.parseFromString(g,"text/xml")):(z=new ActiveXObject("Microsoft.XMLDOM"),z.async="false",z.loadXML(g))}catch(t){z=b}return z&&z.documentElement&&
...
merge:function(g,a){var d=a.length,t=g.length,c=0;if("number"==typeof d)for(;d>c;c++)g[t++]=a[c];else for(;a[c]!==b;)g[t++]=a[c++];return g.length=t,g},grep:function(g,a,b){var d,c=[],h=0,e=g.length;for(b=!!b;e>h;h++)d=!!a(g[h],h),b!==d&&c.push(g[h]);return c},map:function(g,a,b){var d,h=0,e=g.length,l=[];if(c(g))for(;e>h;h++)d=a(g[h],h,b),null!=d&&(l[l.length]=d);else for(h in g)d=a(g[h],h,b),null!=d&&(l[l.length]=d);return da.apply([],l)},guid:1,proxy:function(g,a){var u,t,c;return"string"==typeof a&&
(c=g[a],a=g,g=c),d.isFunction(g)?(u=ka.call(arguments,2),t=function(){return g.apply(a||this,u.concat(ka.call(arguments)))},t.guid=g.guid=g.guid||d.guid++,t):b},access:function(g,a,u,t,c,h,e){var l=0,k=g.length,f=null==u;if("object"===d.type(u))for(l in c=!0,u)d.access(g,a,l,u[l],!0,h,e);else if(t!==b&&(c=!0,d.isFunction(t)||(e=!0),f&&(e?(a.call(g,t),a=null):(f=a,a=function(g,a,b){return f.call(d(g),b)})),a))for(;k>l;l++)a(g[l],u,e?t:t.call(g[l],l,a(g[l],u)));return c?g:f?a.call(g):k?a(g[0],u):h},
now:function(){return(new Date).getTime()}});d.ready.promise=function(g){if(!q)if(q=d.Deferred(),"complete"===F.readyState)setTimeout(d.ready);else if(F.addEventListener)F.addEventListener("DOMContentLoaded",E,!1),a.addEventListener("load",E,!1);else{F.attachEvent("onreadystatechange",E);a.attachEvent("onload",E);var b=!1;try{b=null==a.frameElement&&F.documentElement}catch(u){}b&&b.doScroll&&function Tc(){if(!d.isReady){try{b.doScroll("left")}catch(g){return setTimeout(Tc,50)}Va();d.ready()}}()}return q.promise(g)};
d.each("Boolean Number String Function Array Date RegExp Object Error".split(" "),function(g,a){sa["[object "+a+"]"]=a.toLowerCase()});w=d(F);var Wa={};d.Callbacks=function(g){var a;if("string"==typeof g){if(!(a=Wa[g])){a=g;var u=Wa[a]={};a=(d.each(a.match(Ba)||[],function(g,a){u[a]=!0}),u)}}else a=d.extend({},g);g=a;var c,h,e,l,k,f,q=[],v=!g.once&&[],j=function(a){h=g.memory&&a;e=!0;k=f||0;f=0;l=q.length;for(c=!0;q&&l>k;k++)if(!1===q[k].apply(a[0],a[1])&&g.stopOnFalse){h=!1;break}c=!1;q&&(v?v.length&&
j(v.shift()):h?q=[]:x.disable())},x={add:function(){if(q){var a=q.length;(function Yc(a){d.each(a,function(a,b){var z=d.type(b);"function"===z?g.unique&&x.has(b)||q.push(b):b&&b.length&&"string"!==z&&Yc(b)})})(arguments);c?l=q.length:h&&(f=a,j(h))}return this},remove:function(){return q&&d.each(arguments,function(g,a){for(var b;-1<(b=d.inArray(a,q,b));)q.splice(b,1),c&&(l>=b&&l--,k>=b&&k--)}),this},has:function(g){return g?-1<d.inArray(g,q):!(!q||!q.length)},empty:function(){return q=[],this},disable:function(){return q=
v=h=b,this},disabled:function(){return!q},lock:function(){return v=b,h||x.disable(),this},locked:function(){return!v},fireWith:function(g,a){return a=a||[],a=[g,a.slice?a.slice():a],!q||e&&!v||(c?v.push(a):j(a)),this},fire:function(){return x.fireWith(this,arguments),this},fired:function(){return!!e}};return x};d.extend({Deferred:function(g){var a=[["resolve","done",d.Callbacks("once memory"),"resolved"],["reject","fail",d.Callbacks("once memory"),"rejected"],["notify","progress",d.Callbacks("memory")]],
b="pending",c={state:function(){return b},always:function(){return h.done(arguments).fail(arguments),this},then:function(){var g=arguments;return d.Deferred(function(b){d.each(a,function(a,z){var u=z[0],e=d.isFunction(g[a])&&g[a];h[z[1]](function(){var g=e&&e.apply(this,arguments);g&&d.isFunction(g.promise)?g.promise().done(b.resolve).fail(b.reject).progress(b.notify):b[u+"With"](this===c?b.promise():this,e?[g]:arguments)})});g=null}).promise()},promise:function(g){return null!=g?d.extend(g,c):c}},
...
b):--h||e.resolveWith(a,b)}},k,f,q;if(1<c){k=Array(c);f=Array(c);for(q=Array(c);c>a;a++)b[a]&&d.isFunction(b[a].promise)?b[a].promise().done(l(a,q,b)).fail(e.reject).progress(l(a,f,k)):--h}return h||e.resolveWith(q,b),e.promise()}});var ec=d,lb;var ba,ea,M,na,oa,ua,Ha,la,Na,ra,J=F.createElement("div");if(J.setAttribute("className","t"),J.innerHTML="  <link/><table></table><a href='/a'>a</a><input type='checkbox'/>",ea=J.getElementsByTagName("*"),M=J.getElementsByTagName("a")[0],!ea||!M||!ea.length)lb=
...
g.nodeName&&d.noData[g.nodeName.toLowerCase()];return!a||!0!==a&&g.getAttribute("classid")===a}});d.fn.extend({data:function(g,a){var u,c,h=this[0],e=0,l=null;if(g===b){if(this.length&&(l=d.data(h),1===h.nodeType&&!d._data(h,"parsedAttrs"))){for(u=h.attributes;u.length>e;e++)c=u[e].name,c.indexOf("data-")||(c=d.camelCase(c.slice(5)),n(h,c,l[c]));d._data(h,"parsedAttrs",!0)}return l}return"object"==typeof g?this.each(function(){d.data(this,g)}):d.access(this,function(a){return a===b?h?n(h,g,d.data(h,
g)):null:(this.each(function(){d.data(this,g,a)}),b)},null,a,1<arguments.length,null,!0)},removeData:function(g){return this.each(function(){d.removeData(this,g)})}});d.extend({queue:function(g,a,u){var c;return g?(a=(a||"fx")+"queue",c=d._data(g,a),u&&(!c||d.isArray(u)?c=d._data(g,a,d.makeArray(u)):c.push(u)),c||[]):b},dequeue:function(g,a){a=a||"fx";var b=d.queue(g,a),c=b.length,h=b.shift(),e=d._queueHooks(g,a),l=function(){d.dequeue(g,a)};"inprogress"===h&&(h=b.shift(),c--);(e.cur=h)&&("fx"===
a&&b.unshift("inprogress"),delete e.stop,h.call(g,l,e));!c&&e&&e.empty.fire()},_queueHooks:function(g,a){var b=a+"queueHooks";return d._data(g,b)||d._data(g,b,{empty:d.Callbacks("once memory").add(function(){d._removeData(g,a+"queue");d._removeData(g,b)})})}});d.fn.extend({queue:function(g,a){var u=2;return"string"!=typeof g&&(a=g,g="fx",u--),u>arguments.length?d.queue(this[0],g):a===b?this:this.each(function(){var b=d.queue(this,g,a);d._queueHooks(this,g);"fx"===g&&"inprogress"!==b[0]&&d.dequeue(this,
g)})},dequeue:function(g){return this.each(function(){d.dequeue(this,g)})},delay:function(g,a){return g=d.fx?d.fx.speeds[g]||g:g,a=a||"fx",this.queue(a,function(a,b){var d=setTimeout(a,g);b.stop=function(){clearTimeout(d)}})},clearQueue:function(g){return this.queue(g||"fx",[])},promise:function(g,a){var u,c=1,h=d.Deferred(),e=this,l=this.length,k=function(){--c||h.resolveWith(e,[e])};"string"!=typeof g&&(a=g,g=b);for(g=g||"fx";l--;)(u=d._data(e[l],g+"queueHooks"))&&u.empty&&(c++,u.empty.add(k));
...
e+" ")&&(c+=e+" ");b.className=d.trim(c)}return this},removeClass:function(g){var a,b,c,e,l,k=0,f=this.length;a=0===arguments.length||"string"==typeof g&&g;if(d.isFunction(g))return this.each(function(a){d(this).removeClass(g.call(this,a,this.className))});if(a)for(a=(g||"").match(Ba)||[];f>k;k++)if(b=this[k],c=1===b.nodeType&&(b.className?(" "+b.className+" ").replace(h," "):"")){for(l=0;e=a[l++];)for(;0<=c.indexOf(" "+e+" ");)c=c.replace(" "+e+" "," ");b.className=g?d.trim(c):""}return this},toggleClass:function(a,
b){var c=typeof a,h="boolean"==typeof b;return d.isFunction(a)?this.each(function(c){d(this).toggleClass(a.call(this,c,this.className,b),b)}):this.each(function(){if("string"===c)for(var e,l=0,k=d(this),f=b,q=a.match(Ba)||[];e=q[l++];)f=h?f:!k.hasClass(e),k[f?"addClass":"removeClass"](e);else(c===A||"boolean"===c)&&(this.className&&d._data(this,"__className__",this.className),this.className=this.className||!1===a?"":d._data(this,"__className__")||"")})},hasClass:function(a){a=" "+a+" ";for(var b=
0,d=this.length;d>b;b++)if(1===this[b].nodeType&&0<=(" "+this[b].className+" ").replace(h," ").indexOf(a))return!0;return!1},val:function(a){var c,u,h,e=this[0];if(arguments.length)return h=d.isFunction(a),this.each(function(c){var z,e=d(this);1===this.nodeType&&(z=h?a.call(this,c,e.val()):a,null==z?z="":"number"==typeof z?z+="":d.isArray(z)&&(z=d.map(z,function(a){return null==a?"":a+""})),u=d.valHooks[this.type]||d.valHooks[this.nodeName.toLowerCase()],u&&"set"in u&&u.set(this,z,"value")!==b||(this.value=
z))});if(e)return u=d.valHooks[e.type]||d.valHooks[e.nodeName.toLowerCase()],u&&"get"in u&&(c=u.get(e,"value"))!==b?c:(c=e.value,"string"==typeof c?c.replace(l,""):null==c?"":c)}});d.extend({valHooks:{option:{get:function(a){var b=a.attributes.value;return!b||b.specified?a.value:a.text}},select:{get:function(a){for(var b,c=a.options,h=a.selectedIndex,e="select-one"===a.type||0>h,l=e?null:[],k=e?h+1:c.length,f=0>h?k:e?h:0;k>f;f++)if(b=c[f],!(!b.selected&&f!==h||(d.support.optDisabled?b.disabled:null!==
b.getAttribute("disabled"))||b.parentNode.disabled&&d.nodeName(b.parentNode,"optgroup"))){if(a=d(b).val(),e)return a;l.push(a)}return l},set:function(a,b){var c=d.makeArray(b);return d(a).find("option").each(function(){this.selected=0<=d.inArray(d(this).val(),c)}),c.length||(a.selectedIndex=-1),c}}},attr:function(a,c,u){var h,e,l,k=a.nodeType;if(a&&3!==k&&8!==k&&2!==k)return typeof a.getAttribute===A?d.prop(a,c,u):(e=1!==k||!d.isXMLDoc(a),e&&(c=c.toLowerCase(),h=d.attrHooks[c]||(Oa.test(c)?va:xa)),
u===b?h&&e&&"get"in h&&null!==(l=h.get(a,c))?l:(typeof a.getAttribute!==A&&(l=a.getAttribute(c)),null==l?b:l):null!==u?h&&e&&"set"in h&&(l=h.set(a,u,c))!==b?l:(a.setAttribute(c,u+""),u):(d.removeAttr(a,c),b))},removeAttr:function(a,b){var c,h,e=0,l=b&&b.match(Ba);if(l&&1===a.nodeType)for(;c=l[e++];)h=d.propFix[c]||c,Oa.test(c)?!Ea&&Ia.test(c)?a[d.camelCase("default-"+c)]=a[h]=!1:a[h]=!1:d.attr(a,c,""),a.removeAttribute(Ea?c:h)},attrHooks:{type:{set:function(a,b){if(!d.support.radioValue&&"radio"===
b&&d.nodeName(a,"input")){var c=a.value;return a.setAttribute("type",b),c&&(a.value=c),b}}}},propFix:{tabindex:"tabIndex",readonly:"readOnly","for":"htmlFor","class":"className",maxlength:"maxLength",cellspacing:"cellSpacing",cellpadding:"cellPadding",rowspan:"rowSpan",colspan:"colSpan",usemap:"useMap",frameborder:"frameBorder",contenteditable:"contentEditable"},prop:function(a,c,u){var h,e,l,k=a.nodeType;if(a&&3!==k&&8!==k&&2!==k)return l=1!==k||!d.isXMLDoc(a),l&&(c=d.propFix[c]||c,e=d.propHooks[c]),
u!==b?e&&"set"in e&&(h=e.set(a,u,c))!==b?h:a[c]=u:e&&"get"in e&&null!==(h=e.get(a,c))?h:a[c]},propHooks:{tabIndex:{get:function(a){var d=a.getAttributeNode("tabindex");return d&&d.specified?parseInt(d.value,10):v.test(a.nodeName)||Xa.test(a.nodeName)&&a.href?0:b}}}});va={get:function(a,c){var u=d.prop(a,c),h="boolean"==typeof u&&a.getAttribute(c);return(u="boolean"==typeof u?sb&&Ea?null!=h:Ia.test(c)?a[d.camelCase("default-"+c)]:!!h:a.getAttributeNode(c))&&!1!==u.value?c.toLowerCase():b},set:function(a,
b,c){return!1===b?d.removeAttr(a,c):sb&&Ea||!Ia.test(c)?a.setAttribute(!Ea&&d.propFix[c]||c,c):a[d.camelCase("default-"+c)]=a[c]=!0,c}};sb&&Ea||(d.attrHooks.value={get:function(a,c){var u=a.getAttributeNode(c);return d.nodeName(a,"input")?a.defaultValue:u&&u.specified?u.value:b},set:function(a,c,u){return d.nodeName(a,"input")?(a.defaultValue=c,b):xa&&xa.set(a,c,u)}});Ea||(xa=d.valHooks.button={get:function(a,d){var c=a.getAttributeNode(d);return c&&("id"===d||"name"===d||"coords"===d?""!==c.value:
...
d.event={global:{},add:function(a,c,h,t,e){var l,k,f,q,v,j,x,w,D;if(f=d._data(a)){h.handler&&(q=h,h=q.handler,e=q.selector);h.guid||(h.guid=d.guid++);(k=f.events)||(k=f.events={});(v=f.handle)||(v=f.handle=function(a){return typeof d===A||a&&d.event.triggered===a.type?b:d.event.dispatch.apply(v.elem,arguments)},v.elem=a);c=(c||"").match(Ba)||[""];for(f=c.length;f--;)l=Lb.exec(c[f])||[],w=j=l[1],D=(l[2]||"").split(".").sort(),l=d.event.special[w]||{},w=(e?l.delegateType:l.bindType)||w,l=d.event.special[w]||
{},j=d.extend({type:w,origType:j,data:t,handler:h,guid:h.guid,selector:e,needsContext:e&&d.expr.match.needsContext.test(e),namespace:D.join(".")},q),(x=k[w])||(x=k[w]=[],x.delegateCount=0,l.setup&&!1!==l.setup.call(a,t,D,v)||(a.addEventListener?a.addEventListener(w,v,!1):a.attachEvent&&a.attachEvent("on"+w,v))),l.add&&(l.add.call(a,j),j.handler.guid||(j.handler.guid=h.guid)),e?x.splice(x.delegateCount++,0,j):x.push(j),d.event.global[w]=!0;a=null}},remove:function(a,b,c,h,e){var l,k,f,q,v,j,x,w,A,
D,m,p=d.hasData(a)&&d._data(a);if(p&&(j=p.events)){b=(b||"").match(Ba)||[""];for(v=b.length;v--;)if(f=Lb.exec(b[v])||[],A=m=f[1],D=(f[2]||"").split(".").sort(),A){x=d.event.special[A]||{};A=(h?x.delegateType:x.bindType)||A;w=j[A]||[];f=f[2]&&RegExp("(^|\\.)"+D.join("\\.(?:.*\\.|)")+"(\\.|$)");for(q=l=w.length;l--;)k=w[l],!e&&m!==k.origType||c&&c.guid!==k.guid||f&&!f.test(k.namespace)||h&&h!==k.selector&&("**"!==h||!k.selector)||(w.splice(l,1),k.selector&&w.delegateCount--,x.remove&&x.remove.call(a,
k));q&&!w.length&&(x.teardown&&!1!==x.teardown.call(a,D,p.handle)||d.removeEvent(a,A,p.handle),delete j[A])}else for(A in j)d.event.remove(a,A+b[v],c,h,!0);d.isEmptyObject(j)&&(delete p.handle,d._removeData(a,"events"))}},trigger:function(g,c,h,t){var e,l,k,f,q,v,j=[h||F],x=G.call(g,"type")?g.type:g;v=G.call(g,"namespace")?g.namespace.split("."):[];if(k=e=h=h||F,3!==h.nodeType&&8!==h.nodeType&&!Kb.test(x+d.event.triggered)&&(0<=x.indexOf(".")&&(v=x.split("."),x=v.shift(),v.sort()),l=0>x.indexOf(":")&&
"on"+x,g=g[d.expando]?g:new d.Event(x,"object"==typeof g&&g),g.isTrigger=!0,g.namespace=v.join("."),g.namespace_re=g.namespace?RegExp("(^|\\.)"+v.join("\\.(?:.*\\.|)")+"(\\.|$)"):null,g.result=b,g.target||(g.target=h),c=null==c?[g]:d.makeArray(c,[g]),q=d.event.special[x]||{},t||!q.trigger||!1!==q.trigger.apply(h,c))){if(!t&&!q.noBubble&&!d.isWindow(h)){f=q.delegateType||x;for(Kb.test(f+x)||(k=k.parentNode);k;k=k.parentNode)j.push(k),e=k;e===(h.ownerDocument||F)&&j.push(e.defaultView||e.parentWindow||
a)}for(v=0;(k=j[v++])&&!g.isPropagationStopped();)g.type=1<v?f:q.bindType||x,(e=(d._data(k,"events")||{})[g.type]&&d._data(k,"handle"))&&e.apply(k,c),(e=l&&k[l])&&d.acceptData(k)&&e.apply&&!1===e.apply(k,c)&&g.preventDefault();if(g.type=x,!(t||g.isDefaultPrevented()||q._default&&!1!==q._default.apply(h.ownerDocument,c)||"click"===x&&d.nodeName(h,"a")||!d.acceptData(h)||!l||!h[x]||d.isWindow(h))){(e=h[l])&&(h[l]=null);d.event.triggered=x;try{h[x]()}catch(w){}d.event.triggered=b;e&&(h[l]=e)}return g.result}},
dispatch:function(a){a=d.event.fix(a);var c,h,t,e,l,k=[],f=ka.call(arguments);c=(d._data(this,"events")||{})[a.type]||[];var q=d.event.special[a.type]||{};if(f[0]=a,a.delegateTarget=this,!q.preDispatch||!1!==q.preDispatch.call(this,a)){k=d.event.handlers.call(this,a,c);for(c=0;(e=k[c++])&&!a.isPropagationStopped();){a.currentTarget=e.elem;for(l=0;(t=e.handlers[l++])&&!a.isImmediatePropagationStopped();)(!a.namespace_re||a.namespace_re.test(t.namespace))&&(a.handleObj=t,a.data=t.data,h=((d.event.special[t.origType]||
{}).handle||t.handler).apply(e.elem,f),h!==b&&!1===(a.result=h)&&(a.preventDefault(),a.stopPropagation()))}return q.postDispatch&&q.postDispatch.call(this,a),a.result}},handlers:function(a,c){var h,t,e,l,k=[],f=c.delegateCount,q=a.target;if(f&&q.nodeType&&(!a.button||"click"!==a.type))for(;q!=this;q=q.parentNode||this)if(1===q.nodeType&&(!0!==q.disabled||"click"!==a.type)){e=[];for(l=0;f>l;l++)t=c[l],h=t.selector+" ",e[h]===b&&(e[h]=t.needsContext?0<=d(h,this).index(q):d.find(h,this,null,[q]).length),
e[h]&&e.push(t);e.length&&k.push({elem:q,handlers:e})}return c.length>f&&k.push({elem:this,handlers:c.slice(f)}),k},fix:function(a){if(a[d.expando])return a;var b,c,h;b=a.type;var e=a,l=this.fixHooks[b];l||(this.fixHooks[b]=l=Tb.test(b)?this.mouseHooks:Pa.test(b)?this.keyHooks:{});h=l.props?this.props.concat(l.props):this.props;a=new d.Event(e);for(b=h.length;b--;)c=h[b],a[c]=e[c];return a.target||(a.target=e.srcElement||F),3===a.target.nodeType&&(a.target=a.target.parentNode),a.metaKey=!!a.metaKey,
l.filter?l.filter(a,e):a},props:"altKey bubbles cancelable ctrlKey currentTarget eventPhase metaKey relatedTarget shiftKey target timeStamp view which".split(" "),fixHooks:{},keyHooks:{props:["char","charCode","key","keyCode"],filter:function(a,b){return null==a.which&&(a.which=null!=b.charCode?b.charCode:b.keyCode),a}},mouseHooks:{props:"button buttons clientX clientY fromElement offsetX offsetY pageX pageY screenX screenY toElement".split(" "),filter:function(a,c){var d,h,e,l=c.button,k=c.fromElement;
return null==a.pageX&&null!=c.clientX&&(h=a.target.ownerDocument||F,e=h.documentElement,d=h.body,a.pageX=c.clientX+(e&&e.scrollLeft||d&&d.scrollLeft||0)-(e&&e.clientLeft||d&&d.clientLeft||0),a.pageY=c.clientY+(e&&e.scrollTop||d&&d.scrollTop||0)-(e&&e.clientTop||d&&d.clientTop||0)),!a.relatedTarget&&k&&(a.relatedTarget=k===a.target?c.toElement:k),a.which||l===b||(a.which=1&l?1:2&l?3:4&l?2:0),a}},special:{load:{noBubble:!0},click:{trigger:function(){return d.nodeName(this,"input")&&"checkbox"===this.type&&
...
try{return a(b)}catch(c){return!1}finally{}},Z=function(a,b,c,d){var h,e,l,k,f;if((b?b.ownerDocument||b:ob)!==za&&vb(b),b=b||za,c=c||[],!a||"string"!=typeof a)return c;if(1!==(k=b.nodeType)&&9!==k)return[];if(!La&&!d){if(h=Zc.exec(a))if(l=h[1])if(9===k){if(e=b.getElementById(l),!e||!e.parentNode)return c;if(e.id===l)return c.push(e),c}else{if(b.ownerDocument&&(e=b.ownerDocument.getElementById(l))&&Mb(b,e)&&e.id===l)return c.push(e),c}else{if(h[2])return wb.apply(c,xb.call(b.getElementsByTagName(a),
0)),c;if((l=h[3])&&pa.getByClassName&&b.getElementsByClassName)return wb.apply(c,xb.call(b.getElementsByClassName(l),0)),c}if(pa.qsa&&!Qa.test(a)){if(h=!0,e=ma,l=b,f=9===k&&a,1===k&&"object"!==b.nodeName.toLowerCase()){k=Ya(a);(h=b.getAttribute("id"))?e=h.replace($c,"\\$&"):b.setAttribute("id",e);e="[id='"+e+"'] ";for(l=k.length;l--;)k[l]=e+yb(k[l]);l=fc.test(a)&&b.parentNode||b;f=k.join(",")}if(f)try{return wb.apply(c,xb.call(l.querySelectorAll(f),0)),c}catch(q){}finally{h||b.removeAttribute("id")}}}var v;
...
b),l=e.length;l--;)c[h=e[l]]&&(c[h]=!(d[h]=c[h]))})})},Ya=function(a,b){var c,d,h,e,l,k,f;if(l=xc[a+" "])return b?0:l.slice(0);l=a;k=[];for(f=aa.preFilter;l;){(!c||(d=ad.exec(l)))&&(d&&(l=l.slice(d[0].length)||l),k.push(h=[]));c=!1;(d=bd.exec(l))&&(c=d.shift(),h.push({value:c,type:d[0].replace(Ub," ")}),l=l.slice(c.length));for(e in aa.filter)!(d=Vb[e].exec(l))||f[e]&&!(d=f[e](d))||(c=d.shift(),h.push({value:c,type:e,matches:d}),l=l.slice(c.length));if(!c)break}return b?l.length:l?Z.error(a):xc(a,
k).slice(0)},yb=function(a){for(var b=0,c=a.length,d="";c>b;b++)d+=a[b].value;return d},Bb=function(a,b,c){var d=b.dir,h=c&&"parentNode"===d,e=cd++;return b.first?function(b,c,e){for(;b=b[d];)if(1===b.nodeType||h)return a(b,c,e)}:function(b,c,l){var u,z,k,f=Ra+" "+e;if(l)for(;b=b[d];){if((1===b.nodeType||h)&&a(b,c,l))return!0}else for(;b=b[d];)if(1===b.nodeType||h)if(k=b[ma]||(b[ma]={}),(z=k[d])&&z[0]===f){if(!0===(u=z[1])||u===Wb)return!0===u}else if(z=k[d]=[f],z[1]=a(b,c,l)||Wb,!0===z[1])return!0}},
Xb=function(a){return 1<a.length?function(b,c,d){for(var h=a.length;h--;)if(!a[h](b,c,d))return!1;return!0}:a[0]},Nb=function(a,b,c,d,h){for(var e,l=[],k=0,f=a.length,q=null!=b;f>k;k++)(e=a[k])&&(!c||c(e,d,h))&&(l.push(e),q&&b.push(k));return l},eb=function(a,b,c,d,h,e){return d&&!d[ma]&&(d=eb(d)),h&&!h[ma]&&(h=eb(h,e)),ya(function(e,l,k,f){var q,v,j=[],x=[],w=l.length,A;if(!(A=e)){A=b||"*";for(var qa=k.nodeType?[k]:k,D=[],p=0,m=qa.length;m>p;p++)Z(A,qa[p],D);A=D}A=!a||!e&&b?A:Nb(A,j,a,k,f);qa=c?
h||(e?a:w||d)?[]:l:A;if(c&&c(A,qa,k,f),d){q=Nb(qa,x);d(q,[],k,f);for(k=q.length;k--;)(v=q[k])&&(qa[x[k]]=!(A[x[k]]=v))}if(e){if(h||a){if(h){q=[];for(k=qa.length;k--;)(v=qa[k])&&q.push(A[k]=v);h(null,qa=[],q,f)}for(k=qa.length;k--;)(v=qa[k])&&-1<(q=h?hc.call(e,v):j[k])&&(e[q]=!(l[q]=v))}}else qa=Nb(qa===l?qa.splice(w,qa.length):qa),h?h(null,l,qa,f):wb.apply(l,qa)})},ic=function(a){var b,c,d,h=a.length,e=aa.relative[a[0].type];c=e||aa.relative[" "];for(var l=e?1:0,k=Bb(function(a){return a===b},c,!0),
f=Bb(function(a){return-1<hc.call(b,a)},c,!0),q=[function(a,g,c){return!e&&(c||g!==Yb)||((b=g).nodeType?k(a,g,c):f(a,g,c))}];h>l;l++)if(c=aa.relative[a[l].type])q=[Bb(Xb(q),c)];else{if(c=aa.filter[a[l].type].apply(null,a[l].matches),c[ma]){for(d=++l;h>d&&!aa.relative[a[d].type];d++);return eb(1<l&&Xb(q),1<l&&yb(a.slice(0,l-1)).replace(Ub,"$1"),c,d>l&&ic(a.slice(l,d)),h>d&&ic(a=a.slice(d)),h>d&&yb(a))}q.push(c)}return Xb(q)},yc=function(){},Cb,Wb,aa,Zb,zc,gc,Db,Yb,vb,za,Fa,La,Qa,Eb,$b,Mb,jc,ma="sizzle"+
...
-1:1}:function(a,g){var c,d=0;c=a.parentNode;var h=g.parentNode,e=[a],l=[g];if(a===g)return Db=!0,0;if(!c||!h)return a===b?-1:g===b?1:c?-1:h?1:0;if(c===h)return zb(a,g);for(c=a;c=c.parentNode;)e.unshift(c);for(c=g;c=c.parentNode;)l.unshift(c);for(;e[d]===l[d];)d++;return d?zb(e[d],l[d]):e[d]===ob?-1:l[d]===ob?1:0},Db=!1,[0,0].sort(jc),pa.detectDuplicates=Db,za)}else a=za;return a};Z.matches=function(a,b){return Z(a,null,null,b)};Z.matchesSelector=function(a,b){if((a.ownerDocument||a)!==za&&vb(a),
...
a+"([\\x20\\t\\r\\n\\f]|$)"))&&Ac(a,function(a){return b.test(a.className||"undefined"!==typeof a.getAttribute&&a.getAttribute("class")||"")})},ATTR:function(a,b,c){return function(d){d=Z.attr(d,a);return null==d?"!="===b:b?(d+="","="===b?d===c:"!="===b?d!==c:"^="===b?c&&0===d.indexOf(c):"*="===b?c&&-1<d.indexOf(c):"$="===b?c&&d.slice(-c.length)===c:"~="===b?-1<(" "+d+" ").indexOf(c):"|="===b?d===c||d.slice(0,c.length+1)===c+"-":!1):!0}},CHILD:function(a,b,c,d,h){var e="nth"!==a.slice(0,3),l="last"!==
a.slice(-4),k="of-type"===b;return 1===d&&0===h?function(a){return!!a.parentNode}:function(b,c,f){var u,z,q,v,j;c=e!==l?"nextSibling":"previousSibling";var x=b.parentNode,w=k&&b.nodeName.toLowerCase();f=!f&&!k;if(x){if(e){for(;c;){for(z=b;z=z[c];)if(k?z.nodeName.toLowerCase()===w:1===z.nodeType)return!1;j=c="only"===a&&!j&&"nextSibling"}return!0}if(j=[l?x.firstChild:x.lastChild],l&&f){f=x[ma]||(x[ma]={});u=f[a]||[];v=u[0]===Ra&&u[1];q=u[0]===Ra&&u[2];for(z=v&&x.childNodes[v];z=++v&&z&&z[c]||(q=v=
0)||j.pop();)if(1===z.nodeType&&++q&&z===b){f[a]=[Ra,v,q];break}}else if(f&&(u=(b[ma]||(b[ma]={}))[a])&&u[0]===Ra)q=u[1];else for(;(z=++v&&z&&z[c]||(q=v=0)||j.pop())&&(!(k?z.nodeName.toLowerCase()===w:1===z.nodeType)||!++q||!(f&&((z[ma]||(z[ma]={}))[a]=[Ra,q]),z===b)););return q-=h,q===d||0===q%d&&0<=q/d}}},PSEUDO:function(a,b){var c,d=aa.pseudos[a]||aa.setFilters[a.toLowerCase()]||Z.error("unsupported pseudo: "+a);return d[ma]?d(b):1<d.length?(c=[a,a,"",b],aa.setFilters.hasOwnProperty(a.toLowerCase())?
...
j?v.defaultSelected=v.selected=e.defaultSelected:("input"===j||"textarea"===j)&&(v.defaultValue=e.defaultValue)}}}if(b)if(c){f=f||r(a);h=h||r(l);for(k=0;null!=(e=f[k]);k++)X(e,h[k])}else X(a,l);return h=r(l,"script"),0<h.length&&N(h,!q&&r(a,"script")),l},buildFragment:function(a,b,c,h){for(var e,l,k,f,q,v,j,x=a.length,w=W(b),A=[],D=0;x>D;D++)if(l=a[D],l||0===l)if("object"===d.type(l))d.merge(A,l.nodeType?[l]:l);else if(od.test(l)){f=f||w.appendChild(b.createElement("div"));q=(Hc.exec(l)||["",""])[1].toLowerCase();
j=Ja[q]||Ja._default;f.innerHTML=j[1]+l.replace(Gc,"<$1></$2>")+j[2];for(e=j[0];e--;)f=f.lastChild;if(!d.support.leadingWhitespace&&mc.test(l)&&A.push(b.createTextNode(mc.exec(l)[0])),!d.support.tbody)for(e=(l="table"!==q||Ic.test(l)?"<table>"!==j[1]||Ic.test(l)?0:f:f.firstChild)&&l.childNodes.length;e--;)d.nodeName(v=l.childNodes[e],"tbody")&&!v.childNodes.length&&l.removeChild(v);d.merge(A,f.childNodes);for(f.textContent="";f.firstChild;)f.removeChild(f.firstChild);f=w.lastChild}else A.push(b.createTextNode(l));
f&&w.removeChild(f);d.support.appendChecked||d.grep(r(A,"input"),U);for(D=0;l=A[D++];)if((!h||-1===d.inArray(l,h))&&(k=d.contains(l.ownerDocument,l),f=r(w.appendChild(l),"script"),k&&N(f),c))for(e=0;l=f[e++];)Jc.test(l.type||"")&&c.push(l);return w},cleanData:function(a,b){for(var c,h,e,l,k=0,f=d.expando,q=d.cache,v=d.support.deleteExpando,j=d.event.special;null!=(c=a[k]);k++)if((b||d.acceptData(c))&&(e=c[f],l=e&&q[e])){if(l.events)for(h in l.events)j[h]?d.event.remove(c,h):d.removeEvent(c,h,l.handle);
q[e]&&(delete q[e],v?delete c[f]:typeof c.removeAttribute!==A?c.removeAttribute(f):c[f]=null,Ca.push(e))}}});var Gb,hb,ib,oc=/alpha\([^)]*\)/i,sd=/opacity\s*=\s*([^)]*)/,td=/^(top|right|bottom|left)$/,ud=/^(none|table(?!-c[ea]).+)/,Kc=/^margin/,Wc=RegExp("^("+Da+")(.*)$","i"),Pb=RegExp("^("+Da+")(?!px)[a-z%]+$","i"),vd=RegExp("^([+-])=("+Da+")","i"),vc={BODY:"block"},wd={position:"absolute",visibility:"hidden",display:"block"},Lc={letterSpacing:0,fontWeight:400},gb=["Top","Right","Bottom","Left"],
uc=["Webkit","O","Moz","ms"];d.fn.extend({css:function(a,c){return d.access(this,function(a,c,g){var h,e={},l=0;if(d.isArray(c)){h=hb(a);for(g=c.length;g>l;l++)e[c[l]]=d.css(a,c[l],!1,h);return e}return g!==b?d.style(a,c,g):d.css(a,c)},a,c,1<arguments.length)},show:function(){return I(this,!0)},hide:function(){return I(this)},toggle:function(a){var b="boolean"==typeof a;return this.each(function(){(b?a:V(this))?d(this).show():d(this).hide()})}});d.extend({cssHooks:{opacity:{get:function(a,b){if(b){var c=
ib(a,"opacity");return""===c?"1":c}}}},cssNumber:{columnCount:!0,fillOpacity:!0,fontWeight:!0,lineHeight:!0,opacity:!0,orphans:!0,widows:!0,zIndex:!0,zoom:!0},cssProps:{"float":d.support.cssFloat?"cssFloat":"styleFloat"},style:function(a,c,h,e){if(a&&3!==a.nodeType&&8!==a.nodeType&&a.style){var l,k,f,q=d.camelCase(c),v=a.style;if(c=d.cssProps[q]||(d.cssProps[q]=K(v,q)),f=d.cssHooks[c]||d.cssHooks[q],h===b)return f&&"get"in f&&(l=f.get(a,!1,e))!==b?l:v[c];if(k=typeof h,"string"===k&&(l=vd.exec(h))&&
(h=(l[1]+1)*l[2]+parseFloat(d.css(a,c)),k="number"),!(null==h||"number"===k&&isNaN(h)||("number"!==k||d.cssNumber[q]||(h+="px"),d.support.clearCloneStyle||""!==h||0!==c.indexOf("background")||(v[c]="inherit"),f&&"set"in f&&(h=f.set(a,h,e))===b)))try{v[c]=h}catch(j){}}},css:function(a,c,h,e){var l,k,f,q=d.camelCase(c);return c=d.cssProps[q]||(d.cssProps[q]=K(a.style,q)),f=d.cssHooks[c]||d.cssHooks[q],f&&"get"in f&&(k=f.get(a,!0,h)),k===b&&(k=ib(a,c,e)),"normal"===k&&c in Lc&&(k=Lc[c]),""===h||h?(l=
parseFloat(k),!0===h||d.isNumeric(l)?l||0:k):k},swap:function(a,b,c,d){var h,e={};for(h in b)e[h]=a.style[h],a.style[h]=b[h];c=c.apply(a,d||[]);for(h in b)a.style[h]=e[h];return c}});a.getComputedStyle?(hb=function(b){return a.getComputedStyle(b,null)},ib=function(a,c,h){var e,l,k,f=(h=h||hb(a))?h.getPropertyValue(c)||h[c]:b,q=a.style;return h&&(""!==f||d.contains(a.ownerDocument,a)||(f=d.style(a,c)),Pb.test(f)&&Kc.test(c)&&(e=q.width,l=q.minWidth,k=q.maxWidth,q.minWidth=q.maxWidth=q.width=f,f=h.width,
q.width=e,q.minWidth=l,q.maxWidth=k)),f}):F.documentElement.currentStyle&&(hb=function(a){return a.currentStyle},ib=function(a,c,d){var h,e,l;d=(d=d||hb(a))?d[c]:b;var k=a.style;return null==d&&k&&k[c]&&(d=k[c]),Pb.test(d)&&!td.test(c)&&(h=k.left,e=a.runtimeStyle,l=e&&e.left,l&&(e.left=a.currentStyle.left),k.left="fontSize"===c?"1em":d,d=k.pixelLeft+"px",k.left=h,l&&(e.left=l)),""===d?"auto":d});d.each(["height","width"],function(a,c){d.cssHooks[c]={get:function(a,h,g){return h?0===a.offsetWidth&&
ud.test(d.css(a,"display"))?d.swap(a,wd,function(){return R(a,c,g)}):R(a,c,g):b},set:function(a,b,h){var g=h&&hb(a);return j(a,b,h?C(a,c,h,d.support.boxSizing&&"border-box"===d.css(a,"boxSizing",!1,g),g):0)}}});d.support.opacity||(d.cssHooks.opacity={get:function(a,b){return sd.test((b&&a.currentStyle?a.currentStyle.filter:a.style.filter)||"")?0.01*parseFloat(RegExp.$1)+"":b?"1":""},set:function(a,b){var c=a.style,h=a.currentStyle,e=d.isNumeric(b)?"alpha(opacity="+100*b+")":"",l=h&&h.filter||c.filter||
...
Dd=/^\/\//,Oc=/^([\w.+-]+:)(?:\/\/([^\/?#:]*)(?::(\d+)|)|)/,Pc=d.fn.load,Qc={},dc={},Rc="*/".concat("*");try{fb=ga.href}catch(Jd){fb=F.createElement("a"),fb.href="",fb=fb.href}pb=Oc.exec(fb.toLowerCase())||[];d.fn.load=function(a,c,h){if("string"!=typeof a&&Pc)return Pc.apply(this,arguments);var e,l,k,f=this,q=a.indexOf(" ");return 0<=q&&(e=a.slice(q,a.length),a=a.slice(0,q)),d.isFunction(c)?(h=c,c=b):c&&"object"==typeof c&&(k="POST"),0<f.length&&d.ajax({url:a,type:k,dataType:"html",data:c}).done(function(a){l=
...
context:!0}},ajaxSetup:function(a,b){return b?fa(fa(a,d.ajaxSettings),b):fa(d.ajaxSettings,a)},ajaxPrefilter:S(Qc),ajaxTransport:S(dc),ajax:function(a,c){function h(a,c,g,e){var l,x,t,u,z,O=c;if(2!==G){G=2;q&&clearTimeout(q);j=b;f=e||"";n.readyState=0<a?4:0;if(g){u=w;e=n;var r,F,C,s,Oa=u.contents,ga=u.dataTypes,Ta=u.responseFields;for(s in Ta)s in g&&(e[Ta[s]]=g[s]);for(;"*"===ga[0];)ga.shift(),F===b&&(F=u.mimeType||e.getResponseHeader("Content-Type"));if(F)for(s in Oa)if(Oa[s]&&Oa[s].test(F)){ga.unshift(s);
break}if(ga[0]in g)C=ga[0];else{for(s in g){if(!ga[0]||u.converters[s+" "+ga[0]]){C=s;break}r||(r=s)}C=C||r}u=C?(C!==ga[0]&&ga.unshift(C),g[C]):b}if(200<=a&&300>a||304===a)if(w.ifModified&&(z=n.getResponseHeader("Last-Modified"),z&&(d.lastModified[k]=z),z=n.getResponseHeader("etag"),z&&(d.etag[k]=z)),204===a)l=!0,O="nocontent";else if(304===a)l=!0,O="notmodified";else{var B;a:{g=w;l=u;var H,Ia;t={};z=0;O=g.dataTypes.slice();r=O[0];if(g.dataFilter&&(l=g.dataFilter(l,g.dataType)),O[1])for(H in g.converters)t[H.toLowerCase()]=
g.converters[H];for(;x=O[++z];)if("*"!==x){if("*"!==r&&r!==x){if(H=t[r+" "+x]||t["* "+x],!H)for(B in t)if(Ia=B.split(" "),Ia[1]===x&&(H=t[r+" "+Ia[0]]||t["* "+Ia[0]])){!0===H?H=t[B]:!0!==t[B]&&(x=Ia[0],O.splice(z--,0,x));break}if(!0!==H)if(H&&g["throws"])l=H(l);else try{l=H(l)}catch(R){B={state:"parsererror",error:H?R:"No conversion from "+r+" to "+x};break a}}r=x}B={state:"success",data:l}}l=B;O=l.state;x=l.data;t=l.error;l=!t}else t=O,(a||!O)&&(O="error",0>a&&(a=0));n.status=a;n.statusText=(c||
O)+"";l?p.resolveWith(A,[x,O,n]):p.rejectWith(A,[n,O,t]);n.statusCode(Xa);Xa=b;v&&D.trigger(l?"ajaxSuccess":"ajaxError",[n,w,l?x:t]);m.fireWith(A,[n,O]);v&&(D.trigger("ajaxComplete",[n,w]),--d.active||d.event.trigger("ajaxStop"))}}"object"==typeof a&&(c=a,a=b);c=c||{};var e,l,k,f,q,v,j,x,w=d.ajaxSetup({},c),A=w.context||w,D=w.context&&(A.nodeType||A.jquery)?d(A):d.event,p=d.Deferred(),m=d.Callbacks("once memory"),Xa=w.statusCode||{},O={},r={},G=0,F="canceled",n={readyState:0,getResponseHeader:function(a){var b;
...
m.add,n.success=n.done,n.error=n.fail,w.url=((a||w.url||fb)+"").replace(Ad,"").replace(Dd,pb[1]+"//"),w.type=c.method||c.type||w.method||w.type,w.dataTypes=d.trim(w.dataType||"*").toLowerCase().match(Ba)||[""],null==w.crossDomain&&(e=Oc.exec(w.url.toLowerCase()),w.crossDomain=!(!e||e[1]===pb[1]&&e[2]===pb[2]&&(e[3]||("http:"===e[1]?80:443))==(pb[3]||("http:"===pb[1]?80:443)))),w.data&&w.processData&&"string"!=typeof w.data&&(w.data=d.param(w.data,w.traditional)),P(Qc,w,c,n),2===G)return n;(v=w.global)&&
0===d.active++&&d.event.trigger("ajaxStart");w.type=w.type.toUpperCase();w.hasContent=!Cd.test(w.type);k=w.url;w.hasContent||(w.data&&(k=w.url+=(qc.test(k)?"&":"?")+w.data,delete w.data),!1===w.cache&&(w.url=Nc.test(k)?k.replace(Nc,"$1_="+pc++):k+(qc.test(k)?"&":"?")+"_="+pc++));w.ifModified&&(d.lastModified[k]&&n.setRequestHeader("If-Modified-Since",d.lastModified[k]),d.etag[k]&&n.setRequestHeader("If-None-Match",d.etag[k]));(w.data&&w.hasContent&&!1!==w.contentType||c.contentType)&&n.setRequestHeader("Content-Type",
w.contentType);n.setRequestHeader("Accept",w.dataTypes[0]&&w.accepts[w.dataTypes[0]]?w.accepts[w.dataTypes[0]]+("*"!==w.dataTypes[0]?", "+Rc+"; q=0.01":""):w.accepts["*"]);for(l in w.headers)n.setRequestHeader(l,w.headers[l]);if(w.beforeSend&&(!1===w.beforeSend.call(A,n,w)||2===G))return n.abort();F="abort";for(l in{success:1,error:1,complete:1})n[l](w[l]);if(j=P(dc,w,c,n)){n.readyState=1;v&&D.trigger("ajaxSend",[n,w]);w.async&&0<w.timeout&&(q=setTimeout(function(){n.abort("timeout")},w.timeout));
...
c.onload(b,!0)}}}});var Sc=[],rc=/(=)\?(?=&|$)|\?\?/;d.ajaxSetup({jsonp:"callback",jsonpCallback:function(){var a=Sc.pop()||d.expando+"_"+pc++;return this[a]=!0,a}});d.ajaxPrefilter("json jsonp",function(c,h,e){var l,k,f,q=!1!==c.jsonp&&(rc.test(c.url)?"url":"string"==typeof c.data&&!(c.contentType||"").indexOf("application/x-www-form-urlencoded")&&rc.test(c.data)&&"data");return q||"jsonp"===c.dataTypes[0]?(l=c.jsonpCallback=d.isFunction(c.jsonpCallback)?c.jsonpCallback():c.jsonpCallback,q?c[q]=
c[q].replace(rc,"$1"+l):!1!==c.jsonp&&(c.url+=(qc.test(c.url)?"&":"?")+c.jsonp+"="+l),c.converters["script json"]=function(){return f||d.error(l+" was not called"),f[0]},c.dataTypes[0]="json",k=a[l],a[l]=function(){f=arguments},e.always(function(){a[l]=k;c[l]&&(c.jsonpCallback=h.jsonpCallback,Sc.push(l));f&&d.isFunction(k)&&k(f[0]);f=k=b}),"script"):b});var Fb,Ob,Ed=0,sc=a.ActiveXObject&&function(){for(var a in Fb)Fb[a](b,!0)};d.ajaxSettings.xhr=a.ActiveXObject?function(){var b;if(!(b=!this.isLocal&&
ha()))a:{try{b=new a.ActiveXObject("Microsoft.XMLHTTP");break a}catch(c){}b=void 0}return b}:ha;Ob=d.ajaxSettings.xhr();d.support.cors=!!Ob&&"withCredentials"in Ob;(Ob=d.support.ajax=!!Ob)&&d.ajaxTransport(function(c){if(!c.crossDomain||d.support.cors){var h;return{send:function(e,l){var k,f,q=c.xhr();if(c.username?q.open(c.type,c.url,c.async,c.username,c.password):q.open(c.type,c.url,c.async),c.xhrFields)for(f in c.xhrFields)q[f]=c.xhrFields[f];c.mimeType&&q.overrideMimeType&&q.overrideMimeType(c.mimeType);
c.crossDomain||e["X-Requested-With"]||(e["X-Requested-With"]="XMLHttpRequest");try{for(f in e)q.setRequestHeader(f,e[f])}catch(v){}q.send(c.hasContent&&c.data||null);h=function(a,e){var f,v,j,w;try{if(h&&(e||4===q.readyState))if(h=b,k&&(q.onreadystatechange=d.noop,sc&&delete Fb[k]),e)4!==q.readyState&&q.abort();else{w={};f=q.status;v=q.getAllResponseHeaders();"string"==typeof q.responseText&&(w.text=q.responseText);try{j=q.statusText}catch(x){j=""}f||!c.isLocal||c.crossDomain?1223===f&&(f=204):f=
w.text?200:404}}catch(A){e||l(-1,A)}w&&l(f,j,w,v)};c.async?4===q.readyState?setTimeout(h):(k=++Ed,sc&&(Fb||(Fb={},d(a).unload(sc)),Fb[k]=h),q.onreadystatechange=h):h()},abort:function(){h&&h(b,!0)}}}});var qb,bc,Fd=/^(?:toggle|show|hide)$/,Gd=RegExp("^(?:([+-])=|)("+Da+")([a-z%]*)$","i"),Hd=/queueHooks$/,Qb=[function(a,b,c){var h,e,l,k,f,q,v=this,j=a.style,w={},x=[],A=a.nodeType&&V(a);c.queue||(f=d._queueHooks(a,"fx"),null==f.unqueued&&(f.unqueued=0,q=f.empty.fire,f.empty.fire=function(){f.unqueued||
q()}),f.unqueued++,v.always(function(){v.always(function(){f.unqueued--;d.queue(a,"fx").length||f.empty.fire()})}));1===a.nodeType&&("height"in b||"width"in b)&&(c.overflow=[j.overflow,j.overflowX,j.overflowY],"inline"===d.css(a,"display")&&"none"===d.css(a,"float")&&(d.support.inlineBlockNeedsLayout&&"inline"!==ca(a.nodeName)?j.zoom=1:j.display="inline-block"));c.overflow&&(j.overflow="hidden",d.support.shrinkWrapBlocks||v.always(function(){j.overflow=c.overflow[0];j.overflowX=c.overflow[1];j.overflowY=
c.overflow[2]}));for(e in b)if(l=b[e],Fd.exec(l))(delete b[e],h=h||"toggle"===l,l===(A?"hide":"show"))||x.push(e);if(b=x.length){l=d._data(a,"fxshow")||d._data(a,"fxshow",{});"hidden"in l&&(A=l.hidden);h&&(l.hidden=!A);A?d(a).show():v.done(function(){d(a).hide()});v.done(function(){var b;d._removeData(a,"fxshow");for(b in w)d.style(a,b,w[b])});for(e=0;b>e;e++)h=x[e],k=v.createTween(h,A?l[h]:0),w[h]=l[h]||d.style(a,h),h in l||(l[h]=k.start,A&&(k.end=k.start,k.start="width"===h||"height"===h?1:0))}}],
Hb={"*":[function(a,b){var c,h,e=this.createTween(a,b),l=Gd.exec(b),k=e.cur(),f=+k||0,q=1,v=20;if(l){if(c=+l[2],h=l[3]||(d.cssNumber[a]?"":"px"),"px"!==h&&f){f=d.css(e.elem,a,!0)||c||1;do q=q||".5",f/=q,d.style(e.elem,a,f+h);while(q!==(q=e.cur()/k)&&1!==q&&--v)}e.unit=h;e.start=f;e.end=l[1]?f+(l[1]+1)*c:c}return e}]};d.Animation=d.extend(ia,{tweener:function(a,b){d.isFunction(a)?(b=a,a=["*"]):a=a.split(" ");for(var c,h=0,e=a.length;e>h;h++)c=a[h],Hb[c]=Hb[c]||[],Hb[c].unshift(b)},prefilter:function(a,
...
a.outerWidth(),k=a.outerHeight(),f=c.outerHeight(),j=a[0].ownerDocument,D=j.documentElement,p=D.clientWidth+b(j).scrollLeft(),j=D.clientHeight+b(j).scrollTop(),D=c.offset();D.top+=f;D.left-=Math.min(D.left,D.left+e>p&&p>e?Math.abs(D.left+e-p):0);D.top-=Math.min(D.top,D.top+k>j&&j>k?Math.abs(k+f-0):0);return D}function n(){}function s(a){a.stopPropagation()}function m(a,b){var c=Array.prototype.slice,e=c.call(arguments,2);return function(){return a.apply(b,e.concat(c.call(arguments)))}}function p(c,
e,k,f){function j(a){a.stopPropagation&&a.stopPropagation();a.preventDefault&&a.preventDefault();a.returnValue=!1}function D(a){if(r){if(W&&9>document.documentMode&&!a.button)return p();var b=a.originalEvent.touches,d=b?b[0].pageY:a.pageY,b=Math.max(0,Math.min((b?b[0].pageX:a.pageX)-n.left,s)),d=Math.max(0,Math.min(d-n.top,C));x&&j(a);e.apply(c,[b,d,a])}}function p(){r&&(b(m).unbind(O),b(m.body).removeClass("sp-dragging"),f.apply(c,arguments));r=!1}e=e||function(){};k=k||function(){};f=f||function(){};
var m=c.ownerDocument||document,r=!1,n={},C=0,s=0,x="ontouchstart"in a,O={};O.selectstart=j;O.dragstart=j;O[x?"touchmove":"mousemove"]=D;O[x?"touchend":"mouseup"]=p;b(c).bind(x?"touchstart":"mousedown",function(a){if(!(a.which?3==a.which:2==a.button)&&!r&&!1!==k.apply(c,arguments))r=!0,C=b(c).height(),s=b(c).width(),n=b(c).offset(),b(m).bind(O),b(m.body).addClass("sp-dragging"),x||D(a),j(a)})}var Q={beforeShow:n,move:n,change:n,show:n,hide:n,color:!1,flat:!1,showInput:!0,showButtons:!1,clickoutFiresChange:!1,
...
0;d<mb.length;d++)for(var e=0;e<mb[d].length;e++)h=tinycolor(mb[d][e]).toRgbString(),c[h]=!0;for(d=0;d<b.length;d++)h=tinycolor(b[d]).toRgbString(),c.hasOwnProperty(h)||(a.push(b[d]),c[h]=!0)}return a.reverse().slice(0,L.maxSelectionSize)},r=function(){var a=B(),c=b.map(mb,function(b,c){return e(b,a,"sp-palette-row sp-palette-row-"+c)});Ga&&c.push(e(D(),a,"sp-palette-row sp-palette-row-selection"));Tb.html(c.join(""))},n=function(){if(L.showInitial){var a=Za,b=B();Kb.html(e([a,b],b,"sp-palette-row-initial"))}},
C=function(){(0===ea||0===ba||0===na)&&K();l.addClass(wa)},F=function(){l.removeClass(wa)},x=function(){var a=tinycolor(Pa.val());a.ok?d(a):Pa.addClass("sp-validation-error")},O=function(){ja?H():G()},G=function(){if(ja)K();else if(!1!==E.beforeShow(B())){for(var c=0;c<T.length;c++)T[c]&&T[c].hide();ja=!0;b(xa).bind("click.spectrum",H);b(a).bind("resize.spectrum",fa);Aa.addClass("sp-active");l.show();L.showPalette&&r();K();S();Za=B();n();E.show(Za)}},H=function(c){if((!c||!("click"==c.type&&2==c.button))&&
ja&&!U)ja=!1,b(xa).unbind("click.spectrum",H),b(a).unbind("resize.spectrum",fa),Aa.removeClass("sp-active"),l.hide(),tinycolor.equals(B(),Za)||(yb&&"cancel"!==c?X(!0):d(Za,!0)),E.hide(B())},d=function(a,b){if(!tinycolor.equals(a,B())){var c=tinycolor(a),h=c.toHsv();la=h.h;Na=h.s;ra=h.v;J=h.a;S();b||(Ya=Ma||c.format)}},B=function(){return tinycolor.fromRatio({h:la,s:Na,v:ra,a:Math.round(100*J)/100})},R=function(){S();E.move(B())},S=function(){Pa.removeClass("sp-validation-error");I();var a=tinycolor({h:la,
...
c=a;var m=0,n=0,s=0;a=1;var B=!1,y=!1;if("string"==typeof c)a:{c=c.replace(C,"").replace(R,"").toLowerCase();var N=!1;if(ja[c])c=ja[c],N=!0;else if("transparent"==c){c={r:0,g:0,b:0,a:0};break a}c=(b=D.rgb.exec(c))?{r:b[1],g:b[2],b:b[3]}:(b=D.rgba.exec(c))?{r:b[1],g:b[2],b:b[3],a:b[4]}:(b=D.hsl.exec(c))?{h:b[1],s:b[2],l:b[3]}:(b=D.hsla.exec(c))?{h:b[1],s:b[2],l:b[3],a:b[4]}:(b=D.hsv.exec(c))?{h:b[1],s:b[2],v:b[3]}:(b=D.hex6.exec(c))?{r:parseInt(b[1],16),g:parseInt(b[2],16),b:parseInt(b[3],16),format:N?
"name":"hex"}:(b=D.hex3.exec(c))?{r:parseInt(b[1]+""+b[1],16),g:parseInt(b[2]+""+b[2],16),b:parseInt(b[3]+""+b[3],16),format:N?"name":"hex"}:!1}"object"==typeof c&&(c.hasOwnProperty("r")&&c.hasOwnProperty("g")&&c.hasOwnProperty("b")?(m=255*I(c.r,255),n=255*I(c.g,255),s=255*I(c.b,255),B=!0,y="rgb"):c.hasOwnProperty("h")&&c.hasOwnProperty("s")&&c.hasOwnProperty("v")?(y=c.h,n=c.s,s=c.v,y=6*I(y,360),n=I(n,100),s=I(s,100),m=L.floor(y),B=y-m,y=s*(1-n),b=s*(1-B*n),B=s*(1-(1-B)*n),N=m%6,m=255*[s,b,y,y,B,
s][N],n=255*[B,s,s,b,y,y][N],s=255*[y,y,B,s,s,b][N],B=!0,y="hsv"):c.hasOwnProperty("h")&&(c.hasOwnProperty("s")&&c.hasOwnProperty("l"))&&(m=c.h,y=c.s,s=c.l,n=function(a,b,c){0>c&&(c+=1);1<c&&(c-=1);return c<1/6?a+6*(b-a)*c:0.5>c?b:c<2/3?a+6*(b-a)*(2/3-c):a},m=I(m,360),y=I(y,100),s=I(s,100),0===y?y=s=b=s:(b=0.5>s?s*(1+y):s+y-s*y,B=2*s-b,y=n(B,b,m+1/3),s=n(B,b,m),b=n(B,b,m-1/3)),m=255*y,n=255*s,s=255*b,B=!0,y="hsl"),c.hasOwnProperty("a")&&(a=c.a));m=S(255,P(m,0));n=S(255,P(n,0));s=S(255,P(s,0));1>m&&
(m=H(m));1>n&&(n=H(n));1>s&&(s=H(s));b=B;c=c&&c.format||y;e=m;f=n;p=s;var x=ha(a);return{ok:b,format:c,_tc_id:ca++,alpha:x,toHsv:function(){var a=K(e,f,p);return{h:a.h,s:a.s,v:a.v,a:x}},toHsvString:function(){var a=K(e,f,p),b=H(360*a.h),c=H(100*a.s),a=H(100*a.v);return 1==x?"hsv("+b+", "+c+"%, "+a+"%)":"hsva("+b+", "+c+"%, "+a+"%, "+x+")"},toHsl:function(){var a=U(e,f,p);return{h:a.h,s:a.s,l:a.l,a:x}},toHslString:function(){var a=U(e,f,p),b=H(360*a.h),c=H(100*a.s),a=H(100*a.l);return 1==x?"hsl("+
b+", "+c+"%, "+a+"%)":"hsla("+b+", "+c+"%, "+a+"%, "+x+")"},toHex:function(){return V(e,f,p)},toHexString:function(a){return"#"+V(e,f,p,a)},toRgb:function(){return{r:H(e),g:H(f),b:H(p),a:x}},toRgbString:function(){return 1==x?"rgb("+H(e)+", "+H(f)+", "+H(p)+")":"rgba("+H(e)+", "+H(f)+", "+H(p)+", "+x+")"},toName:function(){return k[V(e,f,p)]||!1},toFilter:function(a,b){var c=V(e,f,p,!0),d=c,k=Math.round(255*ha(x)).toString(16),q=k,w=a&&a.gradientType?"GradientType = 1, ":"";b&&(q=r(b),d=q.toHex(),
...
function(a){var b=r(a).toHsl(),c=360*b.h;return[r(a),r({h:(c+72)%360,s:b.s,l:b.l}),r({h:(c+216)%360,s:b.s,l:b.l})]};r.analogous=function(a,b,c){b=b||6;c=c||30;var e=r(a).toHsl();c=360/c;a=[r(a)];e.h*=360;for(e.h=(e.h-(c*b>>1)+720)%360;--b;)e.h=(e.h+c)%360,a.push(r(e));return a};r.monochromatic=function(a,b){b=b||6;for(var c=r(a).toHsv(),e=c.h,k=c.s,c=c.v,f=[],j=1/b;b--;)f.push(r({h:e,s:k,v:c})),c=(c+j)%1;return f};r.readable=function(a,b){var c=r(a).toRgb(),e=r(b).toRgb();return 10404<(e.r-c.r)*(e.r-
...
var R=j.some=j.any=function(a,b,c){b||(b=j.identity);var f=!1;if(null==a)return f;if(r&&a.some===r)return a.some(b,c);C(a,function(a,k,j){if(f||(f=b.call(c,a,k,j)))return e});return!!f};j.include=j.contains=function(a,b){return null==a?!1:U&&a.indexOf===U?-1!=a.indexOf(b):R(a,function(a){return a===b})};j.invoke=function(a,b){var c=s.call(arguments,2);return j.map(a,function(a){return(j.isFunction(b)?b||a:a[b]).apply(a,c)})};j.pluck=function(a,b){return j.map(a,function(a){return a[b]})};j.max=function(a,
...
function(a,b,c){c||(c=j.identity);for(var e=0,f=a.length;e<f;){var m=e+f>>1;c(a[m])<c(b)?e=m+1:f=m}return e};j.toArray=function(a){return!a?[]:j.isArray(a)||j.isArguments(a)?s.call(a):a.toArray&&j.isFunction(a.toArray)?a.toArray():j.values(a)};j.size=function(a){return j.isArray(a)?a.length:j.keys(a).length};j.first=j.head=j.take=function(a,b,c){return null!=b&&!c?s.call(a,0,b):a[0]};j.initial=function(a,b,c){return s.call(a,0,a.length-(null==b||c?1:b))};j.last=function(a,b,c){return null!=b&&!c?
...
function(a,b,c){for(var e=0;e<a;e++)b.call(c,e)};j.escape=function(a){return(""+a).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#x27;").replace(/\//g,"&#x2F;")};j.result=function(a,b){if(null==a)return null;var c=a[b];return j.isFunction(c)?c.call(a):c};j.mixin=function(a){C(j.functions(a),function(b){var c=j[b]=a[b];ia.prototype[b]=function(){var a=s.call(arguments);m.call(a,this._wrapped);return Y(c.apply(j,a),this._chain)}})};var L=0;j.uniqueId=
...
p(y.paragraph)("(?!","(?!"+y.gfm.fences.source.replace(/(^|[^\[])\^/g,"$2")+"|")();y.lexer=function(a){var b=[];b.links={};a=a.replace(/\r\n|\r/g,"\n").replace(/\t/g,"    ");return y.token(a,b,!0)};y.token=function(a,b,c){a=a.replace(/^ +$/gm,"");for(var e,f,m,p,n,r;a;){if(m=y.newline.exec(a))a=a.substring(m[0].length),1<m[0].length&&b.push({type:"space"});if(m=y.code.exec(a))a=a.substring(m[0].length),m=m[0].replace(/^ {4}/gm,""),b.push({type:"code",text:!V.pedantic?m.replace(/\n+$/,""):m});else if(m=
...
b,c),b.push({type:"blockquote_end"});else if(m=y.list.exec(a)){a=a.substring(m[0].length);b.push({type:"list_start",ordered:isFinite(m[2])});m=m[0].match(y.item);e=!1;r=m.length;for(n=0;n<r;n++)p=m[n],f=p.length,p=p.replace(/^ *([*+-]|\d+\.) +/,""),~p.indexOf("\n ")&&(f-=p.length,p=!V.pedantic?p.replace(RegExp("^ {1,"+f+"}","gm"),""):p.replace(/^ {1,4}/gm,"")),f=e||/\n\n(?!\s*$)/.test(p),n!==r-1&&(e="\n"===p[p.length-1],f||(f=e)),b.push({type:f?"loose_item_start":"list_item_start"}),y.token(p,b),
...
r.link=p(r.link)("inside",r._linkInside)("href",r._linkHref)();r.reflink=p(r.reflink)("inside",r._linkInside)();r.normal={url:r.url,strong:r.strong,em:r.em,text:r.text};r.pedantic={strong:/^__(?=\S)([^\0]*?\S)__(?!_)|^\*\*(?=\S)([^\0]*?\S)\*\*(?!\*)/,em:/^_(?=\S)([^\0]*?\S)_(?!_)|^\*(?=\S)([^\0]*?\S)\*(?!\*)/};r.gfm={url:/^(https?:\/\/[^\s]+[^.,:;"')\]\s])/,text:/^[^\0]+?(?=[\\<!\[_*`]|https?:\/\/| {2,}\n|$)/};r.lexer=function(b){for(var c="",e=U.links,f,m;b;)if(m=r.escape.exec(b))b=b.substring(m[0].length),
c+=m[1];else if(m=r.autolink.exec(b))b=b.substring(m[0].length),"@"===m[2]?(f=":"===m[1][6]?s(m[1].substring(7)):s(m[1]),m=s("mailto:")+f):m=f=n(m[1]),c+='<a href="'+m+'">'+f+"</a>";else if(m=r.url.exec(b))b=b.substring(m[0].length),m=f=n(m[1]),c+='<a href="'+m+'">'+f+"</a>";else if(m=r.tag.exec(b))b=b.substring(m[0].length),c+=V.sanitize?n(m[0]):m[0];else if(m=r.link.exec(b))b=b.substring(m[0].length),c+=a(m,{href:m[2],title:m[3]});else if((m=r.reflink.exec(b))||(m=r.nolink.exec(b)))b=b.substring(m[0].length),
f=(m[2]||m[1]).replace(/\s+/g," "),f=e[f.toLowerCase()],!f||!f.href?(c+=m[0][0],b=m[0].substring(1)+b):c+=a(m,f);else if(m=r.strong.exec(b))b=b.substring(m[0].length),c+="<strong>"+r.lexer(m[2]||m[1])+"</strong>";else if(m=r.em.exec(b))b=b.substring(m[0].length),c+="<em>"+r.lexer(m[2]||m[1])+"</em>";else if(m=r.code.exec(b))b=b.substring(m[0].length),c+="<code>"+n(m[2],!0)+"</code>";else if(m=r.br.exec(b))b=b.substring(m[0].length),c+="<br>";else if(m=r.text.exec(b))b=b.substring(m[0].length),c+=
...
c)return a.remove(b);e.setItem(b,a.serialize(c))},a.get=function(b){return a.deserialize(e.getItem(b))},a.remove=function(a){e.removeItem(a)},a.clear=function(){e.clear()},a.getAll=function(){for(var b={},c=0;c<e.length;++c){var f=e.key(c);b[f]=a.get(f)}return b};else{var s;try{s="globalStorage"in b&&b.globalStorage&&b.globalStorage[b.location.hostname]}catch(m){s=!1}if(s)e=b.globalStorage[b.location.hostname],a.set=function(b,c){if(void 0===c)return a.remove(b);e[b]=a.serialize(c)},a.get=function(b){return a.deserialize(e[b]&&
...
a.replace(k,function(a){var b=p[a];return"string"===typeof b?b:"\\u"+("0000"+a.charCodeAt(0).toString(16)).slice(-4)})+'"':'"'+a+'"'}function e(a,b){var h,f,l,j,k=m,p,r=b[a];r instanceof Date&&(r=isFinite(a.valueOf())?a.getUTCFullYear()+"-"+c(a.getUTCMonth()+1)+"-"+c(a.getUTCDate())+"T"+c(a.getUTCHours())+":"+c(a.getUTCMinutes())+":"+c(a.getUTCSeconds())+"Z":null);"function"===typeof n&&(r=n.call(b,a,r));switch(typeof r){case "string":return d(r);case "number":return isFinite(r)?String(r):"null";
case "boolean":case "null":return String(r);case "object":if(!r)return"null";m+=x;p=[];if("[object Array]"===Object.prototype.toString.apply(r)){j=r.length;for(h=0;h<j;h+=1)p[h]=e(h,r)||"null";l=0===p.length?"[]":m?"[\n"+m+p.join(",\n"+m)+"\n"+k+"]":"["+p.join(",")+"]";m=k;return l}if(n&&"object"===typeof n){j=n.length;for(h=0;h<j;h+=1)"string"===typeof n[h]&&(f=n[h],(l=e(f,r))&&p.push(d(f)+(m?": ":":")+l))}else for(f in r)Object.prototype.hasOwnProperty.call(r,f)&&(l=e(f,r))&&p.push(d(f)+(m?": ":
":")+l);l=0===p.length?"{}":m?"{\n"+m+p.join(",\n"+m)+"\n"+k+"}":"{"+p.join(",")+"}";m=k;return l}}if(b&&b.parse)return a.JSON={parse:b.parse,stringify:b.stringify};var f=a.JSON={},j=/[\u0000\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,k=/[\\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,m,x,p={"\b":"\\b","\t":"\\t","\n":"\\n","\f":"\\f","\r":"\\r",'"':'\\"',"\\":"\\\\"},n;
f.stringify=function(a,b,c){var d;x=m="";if("number"===typeof c)for(d=0;d<c;d+=1)x+=" ";else"string"===typeof c&&(x=c);if((n=b)&&"function"!==typeof b&&("object"!==typeof b||"number"!==typeof b.length))throw Error("JSON.stringify");return e("",{"":a})};f.parse=function(a,b){function c(a,d){var e,h,f=a[d];if(f&&"object"===typeof f)for(e in f)Object.prototype.hasOwnProperty.call(f,e)&&(h=c(f,e),void 0!==h?f[e]=h:delete f[e]);return b.call(a,d,f)}var d;a=String(a);j.lastIndex=0;j.test(a)&&(a=a.replace(j,
...
y=("undefined"!=typeof io?io:module.exports).parser={},B=y.packets="disconnect connect heartbeat message json event ack error noop".split(" "),N=y.reasons=["transport not supported","client not handshaken","unauthorized"],X=y.advice=["reconnect"],r=m.JSON,U=m.util.indexOf;y.encodePacket=function(a){var b=U(B,a.type),c=a.id||"",d=a.endpoint||"",e=a.ack,f=null;switch(a.type){case "error":var j=a.reason?U(N,a.reason):"";a=a.advice?U(X,a.advice):"";if(""!==j||""!==a)f=j+(""!==a?"+"+a:"");break;case "message":""!==
...
!0);S.transports.push("flashsocket");if("undefined"!=typeof window){var fa,ha=function(){if(!Ua){try{var a=G.getElementsByTagName("body")[0].appendChild(G.createElement("span"));a.parentNode.removeChild(a)}catch(b){return}Ua=!0;for(var a=d.length,c=0;c<a;c++)d[c]()}},ja=function(a){Ua?a():d[d.length]=a},m=function(a){if(typeof O.addEventListener!=da)O.addEventListener("load",a,!1);else if(typeof G.addEventListener!=da)G.addEventListener("load",a,!1);else if(typeof O.attachEvent!=da){var b=O;b.attachEvent("onload",
...
f.getAttribute("class")&&(e.styleclass=f.getAttribute("class"));f.getAttribute("align")&&(e.align=f.getAttribute("align"));for(var j={},f=f.getElementsByTagName("param"),m=f.length,x=0;x<m;x++)"movie"!=f[x].getAttribute("name").toLowerCase()&&(j[f[x].getAttribute("name")]=f[x].getAttribute("value"));D(e,j,c,d)}else q(f),d&&d(e)}else if(sa(c,!0),d){if((c=Y(c))&&typeof c.SetVariable!=da)e.success=!0,e.ref=c;d(e)}}},Y=function(a){var b=null;if((a=ga(a))&&"OBJECT"==a.nodeName)typeof a.SetVariable!=da?
...
sa=function(a,b){if(Sb){var c=b?"visible":"hidden";Ua&&ga(a)?ga(a).style.visibility=c:ab("#"+a,"visibility:"+c)}},Ca=function(a){return null!=/[\\\"<>\.;]/.exec(a)&&typeof encodeURIComponent!=da?encodeURIComponent(a):a},da="undefined",ta="object",ka="application/x-shockwave-flash",x="SWFObjectExprInst",O=window,G=document;p=navigator;var Ta=!1,d=[function(){if(Ta){var a=G.getElementsByTagName("body")[0],b=G.createElement(ta);b.setAttribute("type",ka);var c=a.appendChild(b);if(c){var d=0;(function(){if(typeof c.GetVariable!=
...
this.index,m;f.className="socketio";f.style.position="absolute";f.style.top="0px";f.style.left="0px";f.style.display="none";f.target=k;f.method="POST";f.setAttribute("accept-charset","utf-8");j.name="d";f.appendChild(j);document.body.appendChild(f);this.form=f;this.area=j}this.form.action=this.prepareUrl()+e;c();this.area.value=wa.JSON.stringify(a);try{this.form.submit()}catch(x){}this.iframe.attachEvent?m.onreadystatechange=function(){"complete"==d.iframe.readyState&&b()}:this.iframe.onload=b;this.socket.setBuffer(!0)};
...
338241895,666307205,773529912,1294757372,1396182291,1695183700,1986661051,2177026350,2456956037,2730485921,2820302411,3259730800,3345764771,3516065817,3600352804,4094571909,275423344,430227734,506948616,659060556,883997877,958139571,1322822218,1537002063,1747873779,1955562222,2024104815,2227730452,2361852424,2428436474,2756734187,3204031479,3329325298],m=[1779033703,3144134277,1013904242,2773480762,1359893119,2600822924,528734635,1541459225],n=Array(64),s,N,X,r,U,K,V,I,j,C,R,ca;a[b>>5]|=128<<24-b%
32;a[(b+64>>9<<4)+15]=b;for(j=0;j<a.length;j+=16){s=m[0];N=m[1];X=m[2];r=m[3];U=m[4];K=m[5];V=m[6];I=m[7];for(C=0;64>C;C++)n[C]=16>C?a[C+j]:c(c(c(e(n[C-2],17)^e(n[C-2],19)^n[C-2]>>>10,n[C-7]),e(n[C-15],7)^e(n[C-15],18)^n[C-15]>>>3),n[C-16]),R=c(c(c(c(I,e(U,6)^e(U,11)^e(U,25)),U&K^~U&V),f[C]),n[C]),ca=c(e(s,2)^e(s,13)^e(s,22),s&N^s&X^N&X),I=V,V=K,K=U,U=c(r,R),r=X,X=N,N=s,s=c(R,ca);m[0]=c(s,m[0]);m[1]=c(N,m[1]);m[2]=c(X,m[2]);m[3]=c(r,m[3]);m[4]=c(U,m[4]);m[5]=c(K,m[5]);m[6]=c(V,m[6]);m[7]=c(I,m[7])}return m},
n=function(a){for(var c=[],e=(1<<b)-1,f=0;f<a.length*b;f+=b)c[f>>5]|=(a.charCodeAt(f/b)&e)<<24-f%32;return c},s=function(a){for(var b="",c=0;c<4*a.length;c++)b+="0123456789abcdef".charAt(a[c>>2]>>8*(3-c%4)+4&15)+"0123456789abcdef".charAt(a[c>>2]>>8*(3-c%4)&15);return b},m=function(b){return b="object"==typeof b?a(b).val():b.toString()};a.extend({sha256:function(a){a=m(a);return s(f(n(a),a.length*b))},sha256hmac:function(a,c){a=m(a);c=m(c);var e,W=a;e=c;var y=n(W);16<y.length&&(y=f(y,W.length*b));
for(var B=Array(16),W=Array(16),N=0;16>N;N++)B[N]=y[N]^909522486,W[N]=y[N]^1549556828;e=f(B.concat(n(e)),512+e.length*b);e=f(W.concat(e),768);return s(e)},sha256config:function(a){b=parseInt(a)||8}});a.fn.sha256=function(b){a.sha256config(b);b=m(a(this).val());b=a.sha256(b);a.sha256config(8);return b}})(jQuery);
...
Scrap.prototype.loop=function(a){if(!this.values.loop||!this.values.scraps)return null;var b=this.values.scraps.toString(),c=this.values.loop;"string"===typeof c&&c.match(/\{\{/)&&(c=Scrap.getPointer(c.replace(/\{|\}/g,""),a));"string"===typeof c&&(c=this.values.loop.split(/ /g));if(!c)return null;c instanceof Space||(c=new Space(c));var e="";c.each(function(c,n){var s={key:c,value:n},m=b.replace(/\{\{([_a-z0-9\.]+)\}\}/gi,function(b,c){var e;return(e=Scrap.getPointer(c,s))?e:Scrap.getPointer(c,a)});
...
nudgepad.getPageDimensions=function(a){a=new Page(a);a._static=!0;var b=$('<iframe class="deleteMe" style="position: fixed; right: 0px; top: 0px;"></iframe>');b.attr("frameborder",0);b.attr("scrolling","no");b.css("width",1);b.css("height",1);$("#nudgepadTemp").append(b);b.contents().find("body").append(a.toHtml());var c={},e=!1;b.contents().find(".scrap").each(function(){var a,b,s,m;e?(a=$(this).position().left,b=a+$(this).outerWidth(),s=$(this).position().top,m=top+$(this).outerHeight(),a<c.left&&
(c.left=a),b>c.right&&(c.right=b),s<c.top&&(c.top=s),m>c.bottom&&(c.bottom=m)):(c.left=$(this).position().left,c.right=c.left+$(this).outerWidth(),c.top=$(this).position().top,c.bottom=c.top+$(this).outerHeight(),e=!0)});c.height=c.bottom-c.top;c.width=c.right-c.left;$(".deleteMe").remove();return c};nudgepad.apps.git=new App("git");nudgepad.apps.git.commit=function(){var a=prompt("Enter your commit message");nudgepad.apps.git.send("git commit -am '"+a+"'")};nudgepad.apps.git.init=function(){nudgepad.apps.git.send("git init")};
...
Grid.prototype.getDelta=function(a){this.eraseSnaplines();var b={},c=[],e=[],f;for(f in a){var n=a[f],s;for(s in this.points)if(this.points.hasOwnProperty(s)){var m=this.points[s],p=m.x-n.x,Q=m.y-n.y;b.x||(b.x=p,b.y=Q);Math.abs(p)<=Math.abs(b.x)&&(b.x=p,c=[n,m]);Math.abs(Q)<=Math.abs(b.y)&&(b.y=Q,e=[n,m])}}a=Math.abs(b.x)<this.radius;f=Math.abs(b.y)<this.radius;a||(b.x=0);f||(b.y=0);a&&(c[0]={x:c[0].x+b.x,y:c[0].y+b.y},this.drawSnapline(c[0],c[1]));f&&(e[0]={x:e[0].x+b.x,y:e[0].y+b.y},this.drawSnapline(e[0],
...
nudgepad.pages.rename=function(a){mixpanel.track("renamed a page");a=Permalink(a);var b=nudgepad.stage.activePage;if(!a.length)return nudgepad.error("Name cannot be blank");if("home"==b)return nudgepad.error("You cannot rename the home page.");if(site.get("pages "+a))return nudgepad.error("A page named "+a+" already exists.");site.set("pages "+a,site.get("pages "+b));site.set("timelines "+a,site.get("timelines "+b));site.delete("pages "+b);site.delete("timelines "+b);nudgepad.pages.updateTabs();var c=
new Space;c.set("pages "+b,"");c.set("timeline "+b,"");c.set("pages "+a,site.get("pages "+a));c.set("timelines "+a,site.get("timelines "+a));nudgepad.emit("patch",c.toString());nudgepad.stage.open(a);return""};nudgepad.pages.renamePrompt=function(){var a=prompt("Enter a new name",nudgepad.stage.activePage);a&&nudgepad.pages.rename(a)};
...
nudgepad.stage.selection.toSpace=function(){var a=new Space;$(".selection").each(function(){var b=$(this).scrap();a.set(b.getPath(),new Space(b.toString()))});return a};nudgepad.on("selection",function(){var a=nudgepad.stage.activePage+" "+nudgepad.cookie.email,b=" ";$(".selection").each(function(){a+=b+".scrap#"+$(this).attr("id");b=","});a+="{box-shadow: 0 0 2px red;cursor: not-allowed;}";nudgepad.emit("workerSelection",a)});Events.shortcut.onfire=function(a){mixpanel.track("used shortcut "+a)};
...
nudgepad.StretchHandle.create=function(a,b,c,e){var f=a.element(),n="fixed"==f.css("position")?"fixed":"absolute",s=("top"==b?"n":"bottom"==b?"s":"")+("left"==c?"w":"right"==c?"e":""),m=$("<div></div>");m.attr("value",a.getPath());m.addClass("handle stretch_handle stretch_handle_"+a.id+" "+a.id+"_handle");m.attr("id","stretch_handle_"+b+c+a.id);m.css({cursor:s+"-resize",position:n,width:"5px",height:"5px",border:"1px solid rgba(0, 0, 0, .5)","background-color":"rgba(255, 255, 255, 0.5)","z-index":"50"});
...
$(this).parent().offset().top,m=nudgepad.StretchHandle.getLength(f,n,s,m,"center"!=c,"middle"!=b),s=a.scrap();"center"!=c&&(s.set("style left",(0<=m.x?f:m.x+f)+"px"),c=a.outerWidth()-a.width(),s.set("style width",Math.abs(m.x)-c+"px"));e?(b=parseFloat(s.get("style width"))/nudgepad.StretchHandle.originalWidth,s.set("style height",Math.round(nudgepad.StretchHandle.originalHeight*b)+"px")):"middle"!=b&&(0<=m.y?s.set("style top",n+"px"):s.set("style top",m.y+n+"px"),b=a.outerHeight()-a.height(),s.set("style height",
Math.abs(m.y)-b+"px"));a.css(s.values.style.values);b="W "+parseFloat(a.css("width"))+"<br> H "+parseFloat(a.css("height"));$("#nudgepadDimensions").css({left:10+a.right(),top:-10+a.middle()}).html(b);$(".stretch_handle_"+s.id).trigger("update");return!1};
...
Q=$('<div id="nudgepadEditorButtonContainer" class="nudgepad"></div>');s.on("click",function(){p.trigger("click")});p.on("click",function(){m.remove();n.remove();s.remove();Q.remove();p.remove()});m.on("click",function(){c&&c(n.val());m.remove();n.remove();s.remove();Q.remove();p.remove()});$("body").append(s);$("body").append(n);$("body").append(m);$("body").append(p);$("body").append(Q);n.focus()};
/**
