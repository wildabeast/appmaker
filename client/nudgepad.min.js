(function(a,b){function c(g){var a=g.length,t=d.type(g);return d.isWindow(g)?!1:1===g.nodeType&&a?!0:"array"===t||"function"!==t&&(0===a||"number"==typeof a&&0<a&&a-1 in g)}function e(g,a,t,x){if(d.acceptData(g)){var c,h,Sa=d.expando,e="string"==typeof a,l=g.nodeType,f=l?d.cache:g,k=l?g[Sa]:g[Sa]&&Sa;if(k&&f[k]&&(x||f[k].data)||!e||t!==b)return k||(l?g[Sa]=k=Ca.pop()||d.guid++:k=Sa),f[k]||(f[k]={},l||(f[k].toJSON=d.noop)),("object"==typeof a||"function"==typeof a)&&(x?f[k]=d.extend(f[k],a):f[k].data=
d.extend(f[k].data,a)),c=f[k],x||(c.data||(c.data={}),c=c.data),t!==b&&(c[d.camelCase(a)]=t),e?(h=c[a],null==h&&(h=c[d.camelCase(a)])):h=c,h}}function f(g,a,t){if(d.acceptData(g)){var b,c,h,Sa=g.nodeType,e=Sa?d.cache:g,l=Sa?g[d.expando]:d.expando;if(e[l]){if(a&&(h=t?e[l]:e[l].data)){d.isArray(a)?a=a.concat(d.map(a,d.camelCase)):a in h?a=[a]:(a=d.camelCase(a),a=a in h?[a]:a.split(" "));b=0;for(c=a.length;c>b;b++)delete h[a[b]];if(!(t?s:d.isEmptyObject)(h))return}(t||(delete e[l].data,s(e[l])))&&(Sa?
d.cleanData([g],!0):d.support.deleteExpando||e!=e.window?delete e[l]:e[l]=null)}}}function n(g,a,t){if(t===b&&1===g.nodeType){var x="data-"+a.replace(wa,"-$1").toLowerCase();if(t=g.getAttribute(x),"string"==typeof t){try{t="true"===t?!0:"false"===t?!1:"null"===t?null:+t+""===t?+t:Ga.test(t)?d.parseJSON(t):t}catch(c){}d.data(g,a,t)}else t=b}return t}function s(g){for(var a in g)if(("data"!==a||!d.isEmptyObject(g[a]))&&"toJSON"!==a)return!1;return!0}function m(){return!0}function p(){return!1}function P(g,
a){do g=g[a];while(g&&1!==g.nodeType);return g}function S(g,a,t){if(a=a||0,d.isFunction(a))return d.grep(g,function(g,b){return!!a.call(g,b,g)===t});if(a.nodeType)return d.grep(g,function(g){return g===a===t});if("string"==typeof a){var b=d.grep(g,function(g){return 1===g.nodeType});if(Uc.test(a))return d.filter(a,b,!t);a=d.filter(a,b)}return d.grep(g,function(g){return 0<=d.inArray(g,a)===t})}function W(g){var a=tc.split("|");g=g.createDocumentFragment();if(g.createElement)for(;a.length;)g.createElement(a.pop());
...
d.extend({},h.data))}}function r(g,a){var t,x,c=0,h=typeof g.getElementsByTagName!==A?g.getElementsByTagName(a||"*"):typeof g.querySelectorAll!==A?g.querySelectorAll(a||"*"):b;if(!h){h=[];for(t=g.childNodes||g;null!=(x=t[c]);c++)!a||d.nodeName(x,a)?h.push(x):d.merge(h,r(x,a))}return a===b||a&&d.nodeName(g,a)?d.merge([g],h):h}function U(g){cc.test(g.type)&&(g.defaultChecked=g.checked)}function K(g,a){if(a in g)return a;for(var t=a.charAt(0).toUpperCase()+a.slice(1),b=a,d=uc.length;d--;)if(a=uc[d]+
t,a in g)return a;return b}function V(g,a){return g=a||g,"none"===d.css(g,"display")||!d.contains(g.ownerDocument,g)}function I(g,a){for(var t,b,c,h=[],e=0,l=g.length;l>e;e++)b=g[e],b.style&&(h[e]=d._data(b,"olddisplay"),t=b.style.display,a?(h[e]||"none"!==t||(b.style.display=""),""===b.style.display&&V(b)&&(h[e]=d._data(b,"olddisplay",ca(b.nodeName)))):h[e]||(c=V(b),(t&&"none"!==t||!c)&&d._data(b,"olddisplay",c?t:d.css(b,"display"))));for(e=0;l>e;e++)b=g[e],b.style&&(a&&"none"!==b.style.display&&
...
(b=a,a="*");var x,c=0,h=a.toLowerCase().match(Ba)||[];if(d.isFunction(b))for(;x=h[c++];)"+"===x[0]?(x=x.slice(1)||"*",(g[x]=g[x]||[]).unshift(b)):(g[x]=g[x]||[]).push(b)}}function O(g,a,t,x){function c(l){var f;return h[l]=!0,d.each(g[l]||[],function(g,d){var l=d(a,t,x);return"string"!=typeof l||e||h[l]?e?!(f=l):b:(a.dataTypes.unshift(l),c(l),!1)}),f}var h={},e=g===dc;return c(a.dataTypes[0])||!h["*"]&&c("*")}function fa(g,a){var t,x,c=d.ajaxSettings.flatOptions||{};for(x in a)a[x]!==b&&((c[x]?g:
t||(t={}))[x]=a[x]);return t&&d.extend(!0,g,t),g}function ha(){try{return new a.XMLHttpRequest}catch(g){}}function ja(){return setTimeout(function(){qb=b}),qb=d.now()}function ia(g,a,b){var x,c,h=0,e=Qb.length,l=d.Deferred().always(function(){delete f.elem}),f=function(){if(c)return!1;for(var a=qb||ja(),a=Math.max(0,k.startTime+k.duration-a),z=1-(a/k.duration||0),b=0,t=k.tweens.length;t>b;b++)k.tweens[b].run(z);return l.notifyWith(g,[k,z,a]),1>z&&t?a:(l.resolveWith(g,[k]),!1)},k=l.promise({elem:g,
props:d.extend({},a),opts:d.extend(!0,{specialEasing:{}},b),originalProperties:a,originalOptions:b,startTime:qb||ja(),duration:b.duration,tweens:[],createTween:function(a,z){var b=d.Tween(g,k.opts,a,z,k.opts.specialEasing[a]||k.opts.easing);return k.tweens.push(b),b},stop:function(a){var z=0,b=a?k.tweens.length:0;if(c)return this;for(c=!0;b>z;z++)k.tweens[z].run(1);return a?l.resolveWith(g,[k,a]):l.rejectWith(g,[k,a]),this}});a=k.props;b=k.opts.specialEasing;var v,q,j,w;for(q in a)if(v=d.camelCase(q),
j=b[v],x=a[q],d.isArray(x)&&(j=x[1],x=a[q]=x[0]),q!==v&&(a[v]=x,delete a[q]),w=d.cssHooks[v],w&&"expand"in w)for(q in x=w.expand(x),delete a[v],x)q in a||(a[q]=x[q],b[q]=j);else b[v]=j;for(;e>h;h++)if(x=Qb[h].call(k,g,a,k.opts))return x;var u=k;d.each(a,function(g,a){for(var z=(Hb[g]||[]).concat(Hb["*"]),b=0,t=z.length;t>b&&!z[b].call(u,g,a);b++);});return d.isFunction(k.opts.start)&&k.opts.start.call(g,k),d.fx.timer(d.extend(f,{elem:g,anim:k,queue:k.opts.queue})),k.progress(k.opts.progress).done(k.opts.done,
k.opts.complete).fail(k.opts.fail).always(k.opts.always)}function Y(g,a,b,d,c){return new Y.prototype.init(g,a,b,d,c)}function k(g,a){var b,d={height:g},c=0;for(a=a?1:0;4>c;c+=2-a)b=gb[c],d["margin"+b]=d["padding"+b]=g;return a&&(d.opacity=d.width=g),d}function D(g){return d.isWindow(g)?g:9===g.nodeType?g.defaultView||g.parentWindow:!1}var q,u,A=typeof b,F=a.document,ga=a.location,$a=a.jQuery,ab=a.$,sa={},Ca=[],da=Ca.concat,ta=Ca.push,ka=Ca.slice,w=Ca.indexOf,T=sa.toString,G=sa.hasOwnProperty,Ta=
...
last:function(){return this.eq(-1)},eq:function(g){var a=this.length;g=+g+(0>g?a:0);return this.pushStack(0<=g&&a>g?[this[g]]:[])},map:function(g){return this.pushStack(d.map(this,function(a,b){return g.call(a,b,a)}))},end:function(){return this.prevObject||this.constructor(null)},push:ta,sort:[].sort,splice:[].splice};d.fn.init.prototype=d.fn;d.extend=d.fn.extend=function(){var g,a,t,x,c,h,e=arguments[0]||{},l=1,k=arguments.length,f=!1;"boolean"==typeof e&&(f=e,e=arguments[1]||{},l=2);"object"==
typeof e||d.isFunction(e)||(e={});for(k===l&&(e=this,--l);k>l;l++)if(null!=(c=arguments[l]))for(x in c)g=e[x],t=c[x],e!==t&&(f&&t&&(d.isPlainObject(t)||(a=d.isArray(t)))?(a?(a=!1,h=g&&d.isArray(g)?g:[]):h=g&&d.isPlainObject(g)?g:{},e[x]=d.extend(f,h,t)):t!==b&&(e[x]=t));return e};d.extend({noConflict:function(g){return a.$===d&&(a.$=ab),g&&a.jQuery===d&&(a.jQuery=$a),d},isReady:!1,readyWait:1,holdReady:function(g){g?d.readyWait++:d.ready(!0)},ready:function(g){if(!0===g?!--d.readyWait:!d.isReady){if(!F.body)return setTimeout(d.ready);
...
merge:function(g,a){var d=a.length,x=g.length,c=0;if("number"==typeof d)for(;d>c;c++)g[x++]=a[c];else for(;a[c]!==b;)g[x++]=a[c++];return g.length=x,g},grep:function(g,a,b){var d,c=[],h=0,e=g.length;for(b=!!b;e>h;h++)d=!!a(g[h],h),b!==d&&c.push(g[h]);return c},map:function(g,a,b){var d,h=0,e=g.length,l=[];if(c(g))for(;e>h;h++)d=a(g[h],h,b),null!=d&&(l[l.length]=d);else for(h in g)d=a(g[h],h,b),null!=d&&(l[l.length]=d);return da.apply([],l)},guid:1,proxy:function(g,a){var t,x,c;return"string"==typeof a&&
(c=g[a],a=g,g=c),d.isFunction(g)?(t=ka.call(arguments,2),x=function(){return g.apply(a||this,t.concat(ka.call(arguments)))},x.guid=g.guid=g.guid||d.guid++,x):b},access:function(g,a,t,x,c,h,e){var l=0,k=g.length,f=null==t;if("object"===d.type(t))for(l in c=!0,t)d.access(g,a,l,t[l],!0,h,e);else if(x!==b&&(c=!0,d.isFunction(x)||(e=!0),f&&(e?(a.call(g,x),a=null):(f=a,a=function(g,a,b){return f.call(d(g),b)})),a))for(;k>l;l++)a(g[l],t,e?x:x.call(g[l],l,a(g[l],t)));return c?g:f?a.call(g):k?a(g[0],t):h},
...
d.each("Boolean Number String Function Array Date RegExp Object Error".split(" "),function(g,a){sa["[object "+a+"]"]=a.toLowerCase()});u=d(F);var Wa={};d.Callbacks=function(g){var a;if("string"==typeof g){if(!(a=Wa[g])){a=g;var t=Wa[a]={};a=(d.each(a.match(Ba)||[],function(g,a){t[a]=!0}),t)}}else a=d.extend({},g);g=a;var x,c,h,e,l,k,f=[],q=!g.once&&[],v=function(a){c=g.memory&&a;h=!0;l=k||0;k=0;e=f.length;for(x=!0;f&&e>l;l++)if(!1===f[l].apply(a[0],a[1])&&g.stopOnFalse){c=!1;break}x=!1;f&&(q?q.length&&
v(q.shift()):c?f=[]:j.disable())},j={add:function(){if(f){var a=f.length;(function Yc(a){d.each(a,function(a,b){var z=d.type(b);"function"===z?g.unique&&j.has(b)||f.push(b):b&&b.length&&"string"!==z&&Yc(b)})})(arguments);x?e=f.length:c&&(k=a,v(c))}return this},remove:function(){return f&&d.each(arguments,function(g,a){for(var b;-1<(b=d.inArray(a,f,b));)f.splice(b,1),x&&(e>=b&&e--,l>=b&&l--)}),this},has:function(g){return g?-1<d.inArray(g,f):!(!f||!f.length)},empty:function(){return f=[],this},disable:function(){return f=
q=c=b,this},disabled:function(){return!f},lock:function(){return q=b,c||j.disable(),this},locked:function(){return!q},fireWith:function(g,a){return a=a||[],a=[g,a.slice?a.slice():a],!f||h&&!q||(x?q.push(a):v(a)),this},fire:function(){return j.fireWith(this,arguments),this},fired:function(){return!!h}};return j};d.extend({Deferred:function(g){var a=[["resolve","done",d.Callbacks("once memory"),"resolved"],["reject","fail",d.Callbacks("once memory"),"rejected"],["notify","progress",d.Callbacks("memory")]],
...
g)})},dequeue:function(g){return this.each(function(){d.dequeue(this,g)})},delay:function(g,a){return g=d.fx?d.fx.speeds[g]||g:g,a=a||"fx",this.queue(a,function(a,b){var d=setTimeout(a,g);b.stop=function(){clearTimeout(d)}})},clearQueue:function(g){return this.queue(g||"fx",[])},promise:function(g,a){var t,c=1,h=d.Deferred(),e=this,l=this.length,k=function(){--c||h.resolveWith(e,[e])};"string"!=typeof g&&(a=g,g=b);for(g=g||"fx";l--;)(t=d._data(e[l],g+"queueHooks"))&&t.empty&&(c++,t.empty.add(k));
...
a){var b=typeof g,c="boolean"==typeof a;return d.isFunction(g)?this.each(function(b){d(this).toggleClass(g.call(this,b,this.className,a),a)}):this.each(function(){if("string"===b)for(var h,e=0,l=d(this),k=a,f=g.match(Ba)||[];h=f[e++];)k=c?k:!l.hasClass(h),l[k?"addClass":"removeClass"](h);else(b===A||"boolean"===b)&&(this.className&&d._data(this,"__className__",this.className),this.className=this.className||!1===g?"":d._data(this,"__className__")||"")})},hasClass:function(g){g=" "+g+" ";for(var a=
0,b=this.length;b>a;a++)if(1===this[a].nodeType&&0<=(" "+this[a].className+" ").replace(h," ").indexOf(g))return!0;return!1},val:function(g){var a,t,c,h=this[0];if(arguments.length)return c=d.isFunction(g),this.each(function(a){var z,h=d(this);1===this.nodeType&&(z=c?g.call(this,a,h.val()):g,null==z?z="":"number"==typeof z?z+="":d.isArray(z)&&(z=d.map(z,function(g){return null==g?"":g+""})),t=d.valHooks[this.type]||d.valHooks[this.nodeName.toLowerCase()],t&&"set"in t&&t.set(this,z,"value")!==b||(this.value=
z))});if(h)return t=d.valHooks[h.type]||d.valHooks[h.nodeName.toLowerCase()],t&&"get"in t&&(a=t.get(h,"value"))!==b?a:(a=h.value,"string"==typeof a?a.replace(l,""):null==a?"":a)}});d.extend({valHooks:{option:{get:function(g){var a=g.attributes.value;return!a||a.specified?g.value:g.text}},select:{get:function(g){for(var a,b=g.options,c=g.selectedIndex,h="select-one"===g.type||0>c,e=h?null:[],l=h?c+1:b.length,k=0>c?l:h?c:0;l>k;k++)if(a=b[k],!(!a.selected&&k!==c||(d.support.optDisabled?a.disabled:null!==
a.getAttribute("disabled"))||a.parentNode.disabled&&d.nodeName(a.parentNode,"optgroup"))){if(g=d(a).val(),h)return g;e.push(g)}return e},set:function(g,a){var b=d.makeArray(a);return d(g).find("option").each(function(){this.selected=0<=d.inArray(d(this).val(),b)}),b.length||(g.selectedIndex=-1),b}}},attr:function(a,z,t){var c,h,e,l=a.nodeType;if(a&&3!==l&&8!==l&&2!==l)return typeof a.getAttribute===A?d.prop(a,z,t):(h=1!==l||!d.isXMLDoc(a),h&&(z=z.toLowerCase(),c=d.attrHooks[z]||(Oa.test(z)?va:xa)),
t===b?c&&h&&"get"in c&&null!==(e=c.get(a,z))?e:(typeof a.getAttribute!==A&&(e=a.getAttribute(z)),null==e?b:e):null!==t?c&&h&&"set"in c&&(e=c.set(a,t,z))!==b?e:(a.setAttribute(z,t+""),t):(d.removeAttr(a,z),b))},removeAttr:function(a,b){var c,h,e=0,l=b&&b.match(Ba);if(l&&1===a.nodeType)for(;c=l[e++];)h=d.propFix[c]||c,Oa.test(c)?!Ea&&Ia.test(c)?a[d.camelCase("default-"+c)]=a[h]=!1:a[h]=!1:d.attr(a,c,""),a.removeAttribute(Ea?c:h)},attrHooks:{type:{set:function(a,b){if(!d.support.radioValue&&"radio"===
b&&d.nodeName(a,"input")){var c=a.value;return a.setAttribute("type",b),c&&(a.value=c),b}}}},propFix:{tabindex:"tabIndex",readonly:"readOnly","for":"htmlFor","class":"className",maxlength:"maxLength",cellspacing:"cellSpacing",cellpadding:"cellPadding",rowspan:"rowSpan",colspan:"colSpan",usemap:"useMap",frameborder:"frameBorder",contenteditable:"contentEditable"},prop:function(a,c,t){var h,e,l,k=a.nodeType;if(a&&3!==k&&8!==k&&2!==k)return l=1!==k||!d.isXMLDoc(a),l&&(c=d.propFix[c]||c,e=d.propHooks[c]),
...
d.event={global:{},add:function(a,c,t,h,e){var l,k,f,q,v,j,w,u,D;if(f=d._data(a)){t.handler&&(q=t,t=q.handler,e=q.selector);t.guid||(t.guid=d.guid++);(k=f.events)||(k=f.events={});(v=f.handle)||(v=f.handle=function(a){return typeof d===A||a&&d.event.triggered===a.type?b:d.event.dispatch.apply(v.elem,arguments)},v.elem=a);c=(c||"").match(Ba)||[""];for(f=c.length;f--;)l=Lb.exec(c[f])||[],u=j=l[1],D=(l[2]||"").split(".").sort(),l=d.event.special[u]||{},u=(e?l.delegateType:l.bindType)||u,l=d.event.special[u]||
{},j=d.extend({type:u,origType:j,data:h,handler:t,guid:t.guid,selector:e,needsContext:e&&d.expr.match.needsContext.test(e),namespace:D.join(".")},q),(w=k[u])||(w=k[u]=[],w.delegateCount=0,l.setup&&!1!==l.setup.call(a,h,D,v)||(a.addEventListener?a.addEventListener(u,v,!1):a.attachEvent&&a.attachEvent("on"+u,v))),l.add&&(l.add.call(a,j),j.handler.guid||(j.handler.guid=t.guid)),e?w.splice(w.delegateCount++,0,j):w.push(j),d.event.global[u]=!0;a=null}},remove:function(a,b,c,h,e){var l,k,f,q,v,j,w,u,A,
D,m,p=d.hasData(a)&&d._data(a);if(p&&(j=p.events)){b=(b||"").match(Ba)||[""];for(v=b.length;v--;)if(f=Lb.exec(b[v])||[],A=m=f[1],D=(f[2]||"").split(".").sort(),A){w=d.event.special[A]||{};A=(h?w.delegateType:w.bindType)||A;u=j[A]||[];f=f[2]&&RegExp("(^|\\.)"+D.join("\\.(?:.*\\.|)")+"(\\.|$)");for(q=l=u.length;l--;)k=u[l],!e&&m!==k.origType||c&&c.guid!==k.guid||f&&!f.test(k.namespace)||h&&h!==k.selector&&("**"!==h||!k.selector)||(u.splice(l,1),k.selector&&u.delegateCount--,w.remove&&w.remove.call(a,
k));q&&!u.length&&(w.teardown&&!1!==w.teardown.call(a,D,p.handle)||d.removeEvent(a,A,p.handle),delete j[A])}else for(A in j)d.event.remove(a,A+b[v],c,h,!0);d.isEmptyObject(j)&&(delete p.handle,d._removeData(a,"events"))}},trigger:function(g,c,h,x){var e,l,k,f,q,v,j=[h||F],w=G.call(g,"type")?g.type:g;v=G.call(g,"namespace")?g.namespace.split("."):[];if(k=e=h=h||F,3!==h.nodeType&&8!==h.nodeType&&!Kb.test(w+d.event.triggered)&&(0<=w.indexOf(".")&&(v=w.split("."),w=v.shift(),v.sort()),l=0>w.indexOf(":")&&
"on"+w,g=g[d.expando]?g:new d.Event(w,"object"==typeof g&&g),g.isTrigger=!0,g.namespace=v.join("."),g.namespace_re=g.namespace?RegExp("(^|\\.)"+v.join("\\.(?:.*\\.|)")+"(\\.|$)"):null,g.result=b,g.target||(g.target=h),c=null==c?[g]:d.makeArray(c,[g]),q=d.event.special[w]||{},x||!q.trigger||!1!==q.trigger.apply(h,c))){if(!x&&!q.noBubble&&!d.isWindow(h)){f=q.delegateType||w;for(Kb.test(f+w)||(k=k.parentNode);k;k=k.parentNode)j.push(k),e=k;e===(h.ownerDocument||F)&&j.push(e.defaultView||e.parentWindow||
a)}for(v=0;(k=j[v++])&&!g.isPropagationStopped();)g.type=1<v?f:q.bindType||w,(e=(d._data(k,"events")||{})[g.type]&&d._data(k,"handle"))&&e.apply(k,c),(e=l&&k[l])&&d.acceptData(k)&&e.apply&&!1===e.apply(k,c)&&g.preventDefault();if(g.type=w,!(x||g.isDefaultPrevented()||q._default&&!1!==q._default.apply(h.ownerDocument,c)||"click"===w&&d.nodeName(h,"a")||!d.acceptData(h)||!l||!h[w]||d.isWindow(h))){(e=h[l])&&(h[l]=null);d.event.triggered=w;try{h[w]()}catch(u){}d.event.triggered=b;e&&(h[l]=e)}return g.result}},
dispatch:function(a){a=d.event.fix(a);var c,h,e,l,k,f=[],q=ka.call(arguments);c=(d._data(this,"events")||{})[a.type]||[];var v=d.event.special[a.type]||{};if(q[0]=a,a.delegateTarget=this,!v.preDispatch||!1!==v.preDispatch.call(this,a)){f=d.event.handlers.call(this,a,c);for(c=0;(l=f[c++])&&!a.isPropagationStopped();){a.currentTarget=l.elem;for(k=0;(e=l.handlers[k++])&&!a.isImmediatePropagationStopped();)(!a.namespace_re||a.namespace_re.test(e.namespace))&&(a.handleObj=e,a.data=e.data,h=((d.event.special[e.origType]||
{}).handle||e.handler).apply(l.elem,q),h!==b&&!1===(a.result=h)&&(a.preventDefault(),a.stopPropagation()))}return v.postDispatch&&v.postDispatch.call(this,a),a.result}},handlers:function(a,c){var h,e,l,k,f=[],q=c.delegateCount,v=a.target;if(q&&v.nodeType&&(!a.button||"click"!==a.type))for(;v!=this;v=v.parentNode||this)if(1===v.nodeType&&(!0!==v.disabled||"click"!==a.type)){l=[];for(k=0;q>k;k++)e=c[k],h=e.selector+" ",l[h]===b&&(l[h]=e.needsContext?0<=d(h,this).index(v):d.find(h,this,null,[v]).length),
l[h]&&l.push(e);l.length&&f.push({elem:v,handlers:l})}return c.length>q&&f.push({elem:this,handlers:c.slice(q)}),f},fix:function(a){if(a[d.expando])return a;var b,c,h;b=a.type;var e=a,l=this.fixHooks[b];l||(this.fixHooks[b]=l=Tb.test(b)?this.mouseHooks:Pa.test(b)?this.keyHooks:{});h=l.props?this.props.concat(l.props):this.props;a=new d.Event(e);for(b=h.length;b--;)c=h[b],a[c]=e[c];return a.target||(a.target=e.srcElement||F),3===a.target.nodeType&&(a.target=a.target.parentNode),a.metaKey=!!a.metaKey,
...
k).slice(0)},yb=function(a){for(var b=0,d=a.length,c="";d>b;b++)c+=a[b].value;return c},Bb=function(a,b,d){var c=b.dir,h=d&&"parentNode"===c,e=cd++;return b.first?function(b,d,e){for(;b=b[c];)if(1===b.nodeType||h)return a(b,d,e)}:function(b,d,l){var t,z,k,f=Ra+" "+e;if(l)for(;b=b[c];){if((1===b.nodeType||h)&&a(b,d,l))return!0}else for(;b=b[c];)if(1===b.nodeType||h)if(k=b[ma]||(b[ma]={}),(z=k[c])&&z[0]===f){if(!0===(t=z[1])||t===Wb)return!0===t}else if(z=k[c]=[f],z[1]=a(b,d,l)||Wb,!0===z[1])return!0}},
Xb=function(a){return 1<a.length?function(b,d,c){for(var h=a.length;h--;)if(!a[h](b,d,c))return!1;return!0}:a[0]},Nb=function(a,b,d,c,h){for(var e,l=[],k=0,f=a.length,q=null!=b;f>k;k++)(e=a[k])&&(!d||d(e,c,h))&&(l.push(e),q&&b.push(k));return l},eb=function(a,b,d,c,h,e){return c&&!c[ma]&&(c=eb(c)),h&&!h[ma]&&(h=eb(h,e)),ya(function(e,l,k,f){var q,v,j=[],w=[],u=l.length,A;if(!(A=e)){A=b||"*";for(var qa=k.nodeType?[k]:k,D=[],p=0,m=qa.length;m>p;p++)Z(A,qa[p],D);A=D}A=!a||!e&&b?A:Nb(A,j,a,k,f);qa=d?
h||(e?a:u||c)?[]:l:A;if(d&&d(A,qa,k,f),c){q=Nb(qa,w);c(q,[],k,f);for(k=q.length;k--;)(v=q[k])&&(qa[w[k]]=!(A[w[k]]=v))}if(e){if(h||a){if(h){q=[];for(k=qa.length;k--;)(v=qa[k])&&q.push(A[k]=v);h(null,qa=[],q,f)}for(k=qa.length;k--;)(v=qa[k])&&-1<(q=h?hc.call(e,v):j[k])&&(e[q]=!(l[q]=v))}}else qa=Nb(qa===l?qa.splice(u,qa.length):qa),h?h(null,l,qa,f):wb.apply(l,qa)})},ic=function(a){var b,d,c,h=a.length,e=aa.relative[a[0].type];d=e||aa.relative[" "];for(var l=e?1:0,k=Bb(function(a){return a===b},d,!0),
f=Bb(function(a){return-1<hc.call(b,a)},d,!0),q=[function(a,g,d){return!e&&(d||g!==Yb)||((b=g).nodeType?k(a,g,d):f(a,g,d))}];h>l;l++)if(d=aa.relative[a[l].type])q=[Bb(Xb(q),d)];else{if(d=aa.filter[a[l].type].apply(null,a[l].matches),d[ma]){for(c=++l;h>c&&!aa.relative[a[c].type];c++);return eb(1<l&&Xb(q),1<l&&yb(a.slice(0,l-1)).replace(Ub,"$1"),d,c>l&&ic(a.slice(l,c)),h>c&&ic(a=a.slice(c)),h>c&&yb(a))}q.push(d)}return Xb(q)},yc=function(){},Cb,Wb,aa,Zb,zc,gc,Db,Yb,vb,za,Fa,La,Qa,Eb,$b,Mb,jc,ma="sizzle"+
...
a.slice(-4),k="of-type"===b;return 1===c&&0===h?function(a){return!!a.parentNode}:function(b,d,t){var f,z,q,v,j;d=e!==l?"nextSibling":"previousSibling";var w=b.parentNode,u=k&&b.nodeName.toLowerCase();t=!t&&!k;if(w){if(e){for(;d;){for(z=b;z=z[d];)if(k?z.nodeName.toLowerCase()===u:1===z.nodeType)return!1;j=d="only"===a&&!j&&"nextSibling"}return!0}if(j=[l?w.firstChild:w.lastChild],l&&t){t=w[ma]||(w[ma]={});f=t[a]||[];v=f[0]===Ra&&f[1];q=f[0]===Ra&&f[2];for(z=v&&w.childNodes[v];z=++v&&z&&z[d]||(q=v=
0)||j.pop();)if(1===z.nodeType&&++q&&z===b){t[a]=[Ra,v,q];break}}else if(t&&(f=(b[ma]||(b[ma]={}))[a])&&f[0]===Ra)q=f[1];else for(;(z=++v&&z&&z[d]||(q=v=0)||j.pop())&&(!(k?z.nodeName.toLowerCase()===u:1===z.nodeType)||!++q||!(t&&((z[ma]||(z[ma]={}))[a]=[Ra,q]),z===b)););return q-=h,q===c||0===q%c&&0<=q/c}}},PSEUDO:function(a,b){var d,c=aa.pseudos[a]||aa.setFilters[a.toLowerCase()]||Z.error("unsupported pseudo: "+a);return c[ma]?c(b):1<c.length?(d=[a,a,"",b],aa.setFilters.hasOwnProperty(a.toLowerCase())?
...
d;d+=2)a.push(d);return a}),lt:Ma(function(a,b,d){for(b=0>d?d+b:d;0<=--b;)a.push(b);return a}),gt:Ma(function(a,b,d){for(d=0>d?d+b:d;b>++d;)a.push(d);return a})}};for(Cb in{radio:!0,checkbox:!0,file:!0,password:!0,image:!0})aa.pseudos[Cb]=Ab(Cb);for(Cb in{submit:!0,reset:!0})aa.pseudos[Cb]=Za(Cb);gc=Z.compile=function(a,b){var d,c=[],h=[],e=Bc[a+" "];if(!e){b||(b=Ya(a));for(d=b.length;d--;)e=ic(b[d]),e[ma]?c.push(e):h.push(e);var l=0,k=0<c.length,f=0<h.length;d=function(a,b,d,g,e){var t,q,z=[],v=
0,j="0",w=a&&[],u=null!=e,A=Yb,D=a||f&&aa.find.TAG("*",e&&b.parentNode||b),p=Ra+=null==A?1:Math.random()||0.1;for(u&&(Yb=b!==za&&b,Wb=l);null!=(e=D[j]);j++){if(f&&e){for(t=0;q=h[t++];)if(q(e,b,d)){g.push(e);break}u&&(Ra=p,Wb=++l)}k&&((e=!q&&e)&&v--,a&&w.push(e))}if(v+=j,k&&j!==v){for(t=0;q=c[t++];)q(w,z,b,d);if(a){if(0<v)for(;j--;)w[j]||z[j]||(z[j]=dd.call(g));z=Nb(z)}wb.apply(g,z);u&&!a&&0<z.length&&1<v+c.length&&Z.uniqueSort(g)}return u&&(Ra=p,Yb=A),w};d=k?ya(d):d;e=Bc(a,d)}return e};aa.pseudos.nth=
...
w=void 0,u=void 0;if(1===v.nodeType){if(j=v.nodeName.toLowerCase(),!d.support.noCloneEvent&&v[d.expando]){u=d._data(v);for(w in u.events)d.removeEvent(v,w,u.handle);v.removeAttribute(d.expando)}"script"===j&&v.text!==e.text?(y(v).text=e.text,B(v)):"object"===j?(v.parentNode&&(v.outerHTML=e.outerHTML),d.support.html5Clone&&e.innerHTML&&!d.trim(v.innerHTML)&&(v.innerHTML=e.innerHTML)):"input"===j&&cc.test(e.type)?(v.defaultChecked=v.checked=e.checked,v.value!==e.value&&(v.value=e.value)):"option"===
j?v.defaultSelected=v.selected=e.defaultSelected:("input"===j||"textarea"===j)&&(v.defaultValue=e.defaultValue)}}}if(b)if(c){f=f||r(a);h=h||r(l);for(k=0;null!=(e=f[k]);k++)X(e,h[k])}else X(a,l);return h=r(l,"script"),0<h.length&&N(h,!q&&r(a,"script")),l},buildFragment:function(a,b,c,h){for(var e,l,k,f,q,v,j,w=a.length,u=W(b),A=[],D=0;w>D;D++)if(l=a[D],l||0===l)if("object"===d.type(l))d.merge(A,l.nodeType?[l]:l);else if(od.test(l)){f=f||u.appendChild(b.createElement("div"));q=(Hc.exec(l)||["",""])[1].toLowerCase();
j=Ja[q]||Ja._default;f.innerHTML=j[1]+l.replace(Gc,"<$1></$2>")+j[2];for(e=j[0];e--;)f=f.lastChild;if(!d.support.leadingWhitespace&&mc.test(l)&&A.push(b.createTextNode(mc.exec(l)[0])),!d.support.tbody)for(e=(l="table"!==q||Ic.test(l)?"<table>"!==j[1]||Ic.test(l)?0:f:f.firstChild)&&l.childNodes.length;e--;)d.nodeName(v=l.childNodes[e],"tbody")&&!v.childNodes.length&&l.removeChild(v);d.merge(A,f.childNodes);for(f.textContent="";f.firstChild;)f.removeChild(f.firstChild);f=u.lastChild}else A.push(b.createTextNode(l));
f&&u.removeChild(f);d.support.appendChecked||d.grep(r(A,"input"),U);for(D=0;l=A[D++];)if((!h||-1===d.inArray(l,h))&&(k=d.contains(l.ownerDocument,l),f=r(u.appendChild(l),"script"),k&&N(f),c))for(e=0;l=f[e++];)Jc.test(l.type||"")&&c.push(l);return u},cleanData:function(a,b){for(var c,h,e,l,k=0,f=d.expando,q=d.cache,v=d.support.deleteExpando,j=d.event.special;null!=(c=a[k]);k++)if((b||d.acceptData(c))&&(e=c[f],l=e&&q[e])){if(l.events)for(h in l.events)j[h]?d.event.remove(c,h):d.removeEvent(c,h,l.handle);
...
parseFloat(k),!0===h||d.isNumeric(l)?l||0:k):k},swap:function(a,b,d,c){var h,e={};for(h in b)e[h]=a.style[h],a.style[h]=b[h];d=d.apply(a,c||[]);for(h in b)a.style[h]=e[h];return d}});a.getComputedStyle?(hb=function(b){return a.getComputedStyle(b,null)},ib=function(a,c,h){var e,l,k,f=(h=h||hb(a))?h.getPropertyValue(c)||h[c]:b,q=a.style;return h&&(""!==f||d.contains(a.ownerDocument,a)||(f=d.style(a,c)),Pb.test(f)&&Kc.test(c)&&(e=q.width,l=q.minWidth,k=q.maxWidth,q.minWidth=q.maxWidth=q.width=f,f=h.width,
q.width=e,q.minWidth=l,q.maxWidth=k)),f}):F.documentElement.currentStyle&&(hb=function(a){return a.currentStyle},ib=function(a,d,c){var h,e,l;c=(c=c||hb(a))?c[d]:b;var k=a.style;return null==c&&k&&k[d]&&(c=k[d]),Pb.test(c)&&!td.test(d)&&(h=k.left,e=a.runtimeStyle,l=e&&e.left,l&&(e.left=a.currentStyle.left),k.left="fontSize"===d?"1em":c,c=k.pixelLeft+"px",k.left=h,l&&(e.left=l)),""===c?"auto":c});d.each(["height","width"],function(a,c){d.cssHooks[c]={get:function(a,h,g){return h?0===a.offsetWidth&&
ud.test(d.css(a,"display"))?d.swap(a,wd,function(){return Q(a,c,g)}):Q(a,c,g):b},set:function(a,b,h){var g=h&&hb(a);return j(a,b,h?C(a,c,h,d.support.boxSizing&&"border-box"===d.css(a,"boxSizing",!1,g),g):0)}}});d.support.opacity||(d.cssHooks.opacity={get:function(a,b){return sd.test((b&&a.currentStyle?a.currentStyle.filter:a.style.filter)||"")?0.01*parseFloat(RegExp.$1)+"":b?"1":""},set:function(a,b){var c=a.style,h=a.currentStyle,e=d.isNumeric(b)?"alpha(opacity="+100*b+")":"",l=h&&h.filter||c.filter||
...
context:!0}},ajaxSetup:function(a,b){return b?fa(fa(a,d.ajaxSettings),b):fa(d.ajaxSettings,a)},ajaxPrefilter:R(Qc),ajaxTransport:R(dc),ajax:function(a,c){function h(a,c,g,e){var l,w,t,z,T,r=c;if(2!==G){G=2;q&&clearTimeout(q);j=b;f=e||"";n.readyState=0<a?4:0;if(g){z=u;e=n;var x,F,C,s,Oa=z.contents,ga=z.dataTypes,Ta=z.responseFields;for(s in Ta)s in g&&(e[Ta[s]]=g[s]);for(;"*"===ga[0];)ga.shift(),F===b&&(F=z.mimeType||e.getResponseHeader("Content-Type"));if(F)for(s in Oa)if(Oa[s]&&Oa[s].test(F)){ga.unshift(s);
break}if(ga[0]in g)C=ga[0];else{for(s in g){if(!ga[0]||z.converters[s+" "+ga[0]]){C=s;break}x||(x=s)}C=C||x}z=C?(C!==ga[0]&&ga.unshift(C),g[C]):b}if(200<=a&&300>a||304===a)if(u.ifModified&&(T=n.getResponseHeader("Last-Modified"),T&&(d.lastModified[k]=T),T=n.getResponseHeader("etag"),T&&(d.etag[k]=T)),204===a)l=!0,r="nocontent";else if(304===a)l=!0,r="notmodified";else{var B;a:{g=u;l=z;var H,Ia;t={};T=0;r=g.dataTypes.slice();x=r[0];if(g.dataFilter&&(l=g.dataFilter(l,g.dataType)),r[1])for(H in g.converters)t[H.toLowerCase()]=
g.converters[H];for(;w=r[++T];)if("*"!==w){if("*"!==x&&x!==w){if(H=t[x+" "+w]||t["* "+w],!H)for(B in t)if(Ia=B.split(" "),Ia[1]===w&&(H=t[x+" "+Ia[0]]||t["* "+Ia[0]])){!0===H?H=t[B]:!0!==t[B]&&(w=Ia[0],r.splice(T--,0,w));break}if(!0!==H)if(H&&g["throws"])l=H(l);else try{l=H(l)}catch(Q){B={state:"parsererror",error:H?Q:"No conversion from "+x+" to "+w};break a}}x=w}B={state:"success",data:l}}l=B;r=l.state;w=l.data;t=l.error;l=!t}else t=r,(a||!r)&&(r="error",0>a&&(a=0));n.status=a;n.statusText=(c||
r)+"";l?p.resolveWith(A,[w,r,n]):p.rejectWith(A,[n,r,t]);n.statusCode(Xa);Xa=b;v&&D.trigger(l?"ajaxSuccess":"ajaxError",[n,u,l?w:t]);m.fireWith(A,[n,r]);v&&(D.trigger("ajaxComplete",[n,u]),--d.active||d.event.trigger("ajaxStop"))}}"object"==typeof a&&(c=a,a=b);c=c||{};var e,l,k,f,q,v,j,w,u=d.ajaxSetup({},c),A=u.context||u,D=u.context&&(A.nodeType||A.jquery)?d(A):d.event,p=d.Deferred(),m=d.Callbacks("once memory"),Xa=u.statusCode||{},T={},r={},G=0,F="canceled",n={readyState:0,getResponseHeader:function(a){var b;
if(2===G){if(!w)for(w={};b=Bd.exec(f);)w[b[1].toLowerCase()]=b[2];b=w[a.toLowerCase()]}return null==b?null:b},getAllResponseHeaders:function(){return 2===G?f:null},setRequestHeader:function(a,b){var c=a.toLowerCase();return G||(a=r[c]=r[c]||a,T[a]=b),this},overrideMimeType:function(a){return G||(u.mimeType=a),this},statusCode:function(a){var b;if(a)if(2>G)for(b in a)Xa[b]=[Xa[b],a[b]];else n.always(a[n.status]);return this},abort:function(a){a=a||F;return j&&j.abort(a),h(0,a),this}};if(p.promise(n).complete=
...
u.contentType);n.setRequestHeader("Accept",u.dataTypes[0]&&u.accepts[u.dataTypes[0]]?u.accepts[u.dataTypes[0]]+("*"!==u.dataTypes[0]?", "+Rc+"; q=0.01":""):u.accepts["*"]);for(l in u.headers)n.setRequestHeader(l,u.headers[l]);if(u.beforeSend&&(!1===u.beforeSend.call(A,n,u)||2===G))return n.abort();F="abort";for(l in{success:1,error:1,complete:1})n[l](u[l]);if(j=O(dc,u,c,n)){n.readyState=1;v&&D.trigger("ajaxSend",[n,u]);u.async&&0<u.timeout&&(q=setTimeout(function(){n.abort("timeout")},u.timeout));
...
c.crossDomain||e["X-Requested-With"]||(e["X-Requested-With"]="XMLHttpRequest");try{for(f in e)q.setRequestHeader(f,e[f])}catch(v){}q.send(c.hasContent&&c.data||null);h=function(a,e){var f,v,j,u;try{if(h&&(e||4===q.readyState))if(h=b,k&&(q.onreadystatechange=d.noop,sc&&delete Fb[k]),e)4!==q.readyState&&q.abort();else{u={};f=q.status;v=q.getAllResponseHeaders();"string"==typeof q.responseText&&(u.text=q.responseText);try{j=q.statusText}catch(w){j=""}f||!c.isLocal||c.crossDomain?1223===f&&(f=204):f=
u.text?200:404}}catch(A){e||l(-1,A)}u&&l(f,j,u,v)};c.async?4===q.readyState?setTimeout(h):(k=++Ed,sc&&(Fb||(Fb={},d(a).unload(sc)),Fb[k]=h),q.onreadystatechange=h):h()},abort:function(){h&&h(b,!0)}}}});var qb,bc,Fd=/^(?:toggle|show|hide)$/,Gd=RegExp("^(?:([+-])=|)("+Da+")([a-z%]*)$","i"),Hd=/queueHooks$/,Qb=[function(a,b,c){var h,e,l,k,f,q,v=this,j=a.style,u={},w=[],A=a.nodeType&&V(a);c.queue||(f=d._queueHooks(a,"fx"),null==f.unqueued&&(f.unqueued=0,q=f.empty.fire,f.empty.fire=function(){f.unqueued||
...
c.overflow[2]}));for(e in b)if(l=b[e],Fd.exec(l))(delete b[e],h=h||"toggle"===l,l===(A?"hide":"show"))||w.push(e);if(b=w.length){l=d._data(a,"fxshow")||d._data(a,"fxshow",{});"hidden"in l&&(A=l.hidden);h&&(l.hidden=!A);A?d(a).show():v.done(function(){d(a).hide()});v.done(function(){var b;d._removeData(a,"fxshow");for(b in u)d.style(a,b,u[b])});for(e=0;b>e;e++)h=w[e],k=v.createTween(h,A?l[h]:0),u[h]=l[h]||d.style(a,h),h in l||(l[h]=k.start,A&&(k.end=k.start,k.start="width"===h||"height"===h?1:0))}}],
...
b.fn.spectrum=function(k,j){if("string"==typeof k){var A=this,D=Array.prototype.slice.call(arguments,1);this.each(function(){var a=S[b(this).data("spectrum.id")];if(a){var c=a[k];if(!c)throw Error("Spectrum: no such method: '"+k+"'");"get"==k?A=a.get():"container"==k?A=a.container:"option"==k?A=a.option.apply(a,D):"destroy"==k?(a.destroy(),b(this).removeData("spectrum.id")):c.apply(a,D)}});return A}return this.spectrum("destroy").each(function(){var j,u=function(){l.toggleClass("sp-flat",U);l.toggleClass("sp-input-disabled",
...
0;h<mb.length;h++)for(var e=0;e<mb[h].length;e++)d=tinycolor(mb[h][e]).toRgbString(),c[d]=!0;for(h=0;h<b.length;h++)d=tinycolor(b[h]).toRgbString(),c.hasOwnProperty(d)||(a.push(b[h]),c[d]=!0)}return a.reverse().slice(0,L.maxSelectionSize)},r=function(){var a=B(),c=b.map(mb,function(b,c){return e(b,a,"sp-palette-row sp-palette-row-"+c)});Ga&&c.push(e(D(),a,"sp-palette-row sp-palette-row-selection"));Tb.html(c.join(""))},n=function(){if(L.showInitial){var a=Za,b=B();Kb.html(e([a,b],b,"sp-palette-row-initial"))}},
C=function(){(0===ea||0===ba||0===na)&&K();l.addClass(wa)},F=function(){l.removeClass(wa)},w=function(){var a=tinycolor(Pa.val());a.ok?d(a):Pa.addClass("sp-validation-error")},T=function(){ja?H():G()},G=function(){if(ja)K();else if(!1!==E.beforeShow(B())){for(var c=0;c<S.length;c++)S[c]&&S[c].hide();ja=!0;b(xa).bind("click.spectrum",H);b(a).bind("resize.spectrum",fa);Aa.addClass("sp-active");l.show();L.showPalette&&r();K();R();Za=B();n();E.show(Za)}},H=function(c){if((!c||!("click"==c.type&&2==c.button))&&
ja&&!U)ja=!1,b(xa).unbind("click.spectrum",H),b(a).unbind("resize.spectrum",fa),Aa.removeClass("sp-active"),l.hide(),tinycolor.equals(B(),Za)||(yb&&"cancel"!==c?X(!0):d(Za,!0)),E.hide(B())},d=function(a,b){if(!tinycolor.equals(a,B())){var c=tinycolor(a),d=c.toHsv();la=d.h;Na=d.s;ra=d.v;J=d.a;R();b||(Ya=Ma||c.format)}},B=function(){return tinycolor.fromRatio({h:la,s:Na,v:ra,a:Math.round(100*J)/100})},Q=function(){R();E.move(B())},R=function(){Pa.removeClass("sp-validation-error");I();var a=tinycolor({h:la,
...
U?va.after(l).hide():b(O).append(l.hide());if(ca&&a.localStorage){try{var Bb=a.localStorage[ca].split(",#");1<Bb.length&&(delete a.localStorage[ca],b.each(Bb,function(a,b){A(b)}))}catch(Xb){}try{Ga=a.localStorage[ca].split(";")}catch(Nb){}}Z.bind("click.spectrum touchstart.spectrum",function(a){h||T();a.stopPropagation();b(a.target).is("input")||a.preventDefault()});(va.is(":disabled")||!0===L.disabled)&&j();l.click(s);Pa.change(w);Pa.bind("paste",function(){setTimeout(w,1)});Pa.keydown(function(a){13==
...
A(Ab)):R();U&&G();C=W?"mousedown.spectrum":"click.spectrum touchstart.spectrum";Tb.delegate(".sp-thumb-el",C,Y);Kb.delegate(".sp-thumb-el:nth-child(1)",C,{ignore:!0},Y);var eb={show:G,hide:H,toggle:T,reflow:K,option:function(a,d){if(a===c)return b.extend({},L);if(d===c)return L[a];L[a]=d;u()},enable:function(){h=!1;va.attr("disabled",!1);Z.removeClass("sp-disabled")},disable:j,set:function(a){d(a);X()},get:B,destroy:function(){va.show();Z.unbind("click.spectrum touchstart.spectrum");l.remove();Aa.remove();
...
var Q=j.some=j.any=function(a,b,c){b||(b=j.identity);var f=!1;if(null==a)return f;if(r&&a.some===r)return a.some(b,c);C(a,function(a,k,j){if(f||(f=b.call(c,a,k,j)))return e});return!!f};j.include=j.contains=function(a,b){return null==a?!1:U&&a.indexOf===U?-1!=a.indexOf(b):Q(a,function(a){return a===b})};j.invoke=function(a,b){var c=s.call(arguments,2);return j.map(a,function(a){return(j.isFunction(b)?b||a:a[b]).apply(a,c)})};j.pluck=function(a,b){return j.map(a,function(a){return a[b]})};j.max=function(a,
...
"";d+="";var r={};if(w&&typeof w===ta)for(var q in w)r[q]=w[q];r.data=a;r.width=c;r.height=d;q={};if(m&&typeof m===ta)for(var s in m)q[s]=m[s];if(j&&typeof j===ta)for(var T in j)q.flashvars=typeof q.flashvars!=da?q.flashvars+("&"+T+"="+j[T]):T+"="+j[T];if($a(e))s=A(r,q,b),r.id==b&&sa(b,!0),n.success=!0,n.ref=s;else{if(f&&k()){r.data=f;D(r,q,b,p);return}sa(b,!0)}p&&p(n)})):p&&p(n)},switchOffAutoHideShow:function(){Sb=!1},ua:E,getFlashPlayerVersion:function(){return{major:E.pv[0],minor:E.pv[1],release:E.pv[2]}},
...
case "Z":case "ZZ":return u;case "T":return A;case "MM":case "DD":case "YY":case "HH":case "hh":case "mm":case "ss":case "M":case "D":case "d":case "H":case "h":case "m":case "s":return ia;default:return RegExp(a.replace("\\",""))}}function r(a,b){var c=[0,0,1,0,0,0,0],e={tzh:0,tzm:0},d=b.match(fa),f,j;for(f=0;f<d.length;f++)if((j=(X(d[f]).exec(a)||[])[0])&&(a=a.slice(a.indexOf(j)+j.length)),ka[d[f]]){var k=c,m=e,p=void 0,n=void 0;switch(d[f]){case "M":case "MM":k[1]=null==j?0:~~j-1;break;case "MMM":case "MMMM":for(p=
...
c){if(null===b||""===b)return null;var e;if(j.isMoment(b))e=new f(new Date(+b._d),b._isUTC,b._lang);else{if(c)if(P(c)){var k=b.match(ja)||[],d,m=99,p,n;for(p=0;p<c.length;p++)n=r(b,c[p]),d=N(new f(n),c[p]).match(ja)||[],d=S(k,d),d<m&&(m=d,e=n)}else e=r(b,c);else if(e=O.exec(b),b===a)e=new Date;else if(e)e=new Date(+e[1]);else if(b instanceof Date)e=b;else if(P(b))e=W(b);else if("string"==typeof b)if(e="YYYY-MM-DDT",F.exec(b)){for(k=0;4>k;k++)if(ga[k][1].exec(b)){e+=ga[k][0];break}e=u.exec(b)?r(b,
e+" Z"):r(b,e)}else e=new Date(b);else e=new Date(b);e=new f(e)}return e};j.utc=function(a,b){return P(a)?new f(W(a,!0),!0):("string"==typeof a&&!u.exec(a)&&(a+=" +0000",b&&(b+=" Z")),j(a,b).utc())};j.unix=function(a){return j(1E3*a)};j.duration=function(a,b){var c=j.isDuration(a),e="number"==typeof a,d=c?a._data:e?{}:a,f;return e&&(b?d[b]=a:d.milliseconds=a),f=new n(d),c&&(f._lang=a._lang),f};j.humanizeDuration=function(a,b,c){return j.duration(a,!0===b?null:b).humanize(!0===b?!0:c)};j.version="1.7.2";
j.defaultFormat="YYYY-MM-DDTHH:mm:ssZ";j.lang=function(a,b){var c;if(!a)return L;(b||!ca[a])&&y(a,b);if(ca[a]){for(c=0;c<R.length;c++)j[R[c]]=ca[a][R[c]];j.monthsParse=ca[a].monthsParse;L=a}};j.langData=B;j.isMoment=function(a){return a instanceof f};j.isDuration=function(a){return a instanceof n};j.lang("en",{months:"January February March April May June July August September October November December".split(" "),monthsShort:"Jan Feb Mar Apr May Jun Jul Aug Sep Oct Nov Dec".split(" "),weekdays:"Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" "),
...
338241895,666307205,773529912,1294757372,1396182291,1695183700,1986661051,2177026350,2456956037,2730485921,2820302411,3259730800,3345764771,3516065817,3600352804,4094571909,275423344,430227734,506948616,659060556,883997877,958139571,1322822218,1537002063,1747873779,1955562222,2024104815,2227730452,2361852424,2428436474,2756734187,3204031479,3329325298],m=[1779033703,3144134277,1013904242,2773480762,1359893119,2600822924,528734635,1541459225],n=Array(64),s,N,X,r,U,K,V,I,j,C,Q,ca;a[b>>5]|=128<<24-b%
32;a[(b+64>>9<<4)+15]=b;for(j=0;j<a.length;j+=16){s=m[0];N=m[1];X=m[2];r=m[3];U=m[4];K=m[5];V=m[6];I=m[7];for(C=0;64>C;C++)n[C]=16>C?a[C+j]:c(c(c(e(n[C-2],17)^e(n[C-2],19)^n[C-2]>>>10,n[C-7]),e(n[C-15],7)^e(n[C-15],18)^n[C-15]>>>3),n[C-16]),Q=c(c(c(c(I,e(U,6)^e(U,11)^e(U,25)),U&K^~U&V),f[C]),n[C]),ca=c(e(s,2)^e(s,13)^e(s,22),s&N^s&X^N&X),I=V,V=K,K=U,U=c(r,Q),r=X,X=N,N=s,s=c(Q,ca);m[0]=c(s,m[0]);m[1]=c(N,m[1]);m[2]=c(X,m[2]);m[3]=c(r,m[3]);m[4]=c(U,m[4]);m[5]=c(K,m[5]);m[6]=c(V,m[6]);m[7]=c(I,m[7])}return m},
...
Grid.prototype.getDelta=function(a){this.eraseSnaplines();var b={},c=[],e=[],f;for(f in a){var n=a[f],s;for(s in this.points)if(this.points.hasOwnProperty(s)){var m=this.points[s],p=m.x-n.x,P=m.y-n.y;b.x||(b.x=p,b.y=P);Math.abs(p)<=Math.abs(b.x)&&(b.x=p,c=[n,m]);Math.abs(P)<=Math.abs(b.y)&&(b.y=P,e=[n,m])}}a=Math.abs(b.x)<this.radius;f=Math.abs(b.y)<this.radius;a||(b.x=0);f||(b.y=0);(b.x||b.y)&&nudgepad.feedback.record("snap happened");a&&(c[0]={x:c[0].x+b.x,y:c[0].y+b.y},this.drawSnapline(c[0],c[1]));
...
P=$('<div id="nudgepadEditorButtonContainer" class="nudgepad"></div>');s.on("click",function(){p.trigger("click")});p.on("click",function(){m.remove();n.remove();s.remove();P.remove();p.remove()});m.on("click",function(){c&&c(n.val());m.remove();n.remove();s.remove();P.remove();p.remove()});$("body").append(s);$("body").append(n);$("body").append(m);$("body").append(p);$("body").append(P);n.focus()};
/**
