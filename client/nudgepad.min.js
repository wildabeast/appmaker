...
j=b[v],t=a[q],d.isArray(t)&&(j=t[1],t=a[q]=t[0]),q!==v&&(a[v]=t,delete a[q]),x=d.cssHooks[v],x&&"expand"in x)for(q in t=x.expand(t),delete a[v],t)q in a||(a[q]=t[q],b[q]=j);else b[v]=j;for(;e>h;h++)if(t=Qb[h].call(k,g,a,k.opts))return t;var w=k;d.each(a,function(g,a){for(var b=(Hb[g]||[]).concat(Hb["*"]),z=0,u=b.length;u>z&&!b[z].call(w,g,a);z++);});return d.isFunction(k.opts.start)&&k.opts.start.call(g,k),d.fx.timer(d.extend(f,{elem:g,anim:k,queue:k.opts.queue})),k.progress(k.opts.progress).done(k.opts.done,
