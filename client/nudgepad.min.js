(function(a,b){function c(j){var a=j.length,b=e.type(j);return e.isWindow(j)?!1:1===j.nodeType&&a?!0:"array"===b||"function"!==b&&(0===a||"number"==typeof a&&0<a&&a-1 in j)}function d(j,a,y,u){if(e.acceptData(j)){var c,h,d=e.expando,g="string"==typeof a,n=j.nodeType,f=n?e.cache:j,p=n?j[d]:j[d]&&d;if(p&&f[p]&&(u||f[p].data)||!g||y!==b)return p||(n?j[d]=p=Ca.pop()||e.guid++:p=d),f[p]||(f[p]={},n||(f[p].toJSON=e.noop)),("object"==typeof a||"function"==typeof a)&&(u?f[p]=e.extend(f[p],a):f[p].data=e.extend(f[p].data,
a)),c=f[p],u||(c.data||(c.data={}),c=c.data),y!==b&&(c[e.camelCase(a)]=y),g?(h=c[a],null==h&&(h=c[e.camelCase(a)])):h=c,h}}function f(j,a,b){if(e.acceptData(j)){var u,c,h,d=j.nodeType,g=d?e.cache:j,n=d?j[e.expando]:e.expando;if(g[n]){if(a&&(h=b?g[n]:g[n].data)){e.isArray(a)?a=a.concat(e.map(a,e.camelCase)):a in h?a=[a]:(a=e.camelCase(a),a=a in h?[a]:a.split(" "));u=0;for(c=a.length;c>u;u++)delete h[a[u]];if(!(b?t:e.isEmptyObject)(h))return}(b||(delete g[n].data,t(g[n])))&&(d?e.cleanData([j],!0):e.support.deleteExpando||
g!=g.window?delete g[n]:g[n]=null)}}}function q(j,a,y){if(y===b&&1===j.nodeType){var u="data-"+a.replace(wa,"-$1").toLowerCase();if(y=j.getAttribute(u),"string"==typeof y){try{y="true"===y?!0:"false"===y?!1:"null"===y?null:+y+""===y?+y:Ga.test(y)?e.parseJSON(y):y}catch(c){}e.data(j,a,y)}else y=b}return y}function t(j){for(var a in j)if(("data"!==a||!e.isEmptyObject(j[a]))&&"toJSON"!==a)return!1;return!0}function l(){return!0}function s(){return!1}function S(j,a){do j=j[a];while(j&&1!==j.nodeType);
...
Eb[0].contentDocument).document,a.write("<!doctype html><html><body>"),a.close(),b=W(j,a),Eb.detach()),uc[j]=b),b}function W(j,a){var b=e(a.createElement(j)).appendTo(a.body),u=e.css(b[0],"display");return b.remove(),u}function P(j,a,b,u){var c;if(e.isArray(a))e.each(a,function(a,B){b||Wc.test(j)?u(j,B):P(j+"["+("object"==typeof B?a:"")+"]",B,b,u)});else if(b||"object"!==e.type(a))u(j,a);else for(c in a)P(j+"["+c+"]",a[c],b,u)}function m(j){return function(a,b){"string"!=typeof a&&(b=a,a="*");var u,
c=0,h=a.toLowerCase().match(Ba)||[];if(e.isFunction(b))for(;u=h[c++];)"+"===u[0]?(u=u.slice(1)||"*",(j[u]=j[u]||[]).unshift(b)):(j[u]=j[u]||[]).push(b)}}function ca(j,a,y,u){function c(g){var n;return h[g]=!0,e.each(j[g]||[],function(j,e){var g=e(a,y,u);return"string"!=typeof g||d||h[g]?d?!(n=g):b:(a.dataTypes.unshift(g),c(g),!1)}),n}var h={},d=j===bc;return c(a.dataTypes[0])||!h["*"]&&c("*")}function O(j,a){var y,u,c=e.ajaxSettings.flatOptions||{};for(u in a)a[u]!==b&&((c[u]?j:y||(y={}))[u]=a[u]);
return y&&e.extend(!0,j,y),j}function ja(){try{return new a.XMLHttpRequest}catch(j){}}function ea(){return setTimeout(function(){nb=b}),nb=e.now()}function I(j,a,b){var u,c,h=0,d=Ob.length,g=e.Deferred().always(function(){delete n.elem}),n=function(){if(c)return!1;for(var a=nb||ea(),a=Math.max(0,f.startTime+f.duration-a),b=1-(a/f.duration||0),B=0,e=f.tweens.length;e>B;B++)f.tweens[B].run(b);return g.notifyWith(j,[f,b,a]),1>b&&e?a:(g.resolveWith(j,[f]),!1)},f=g.promise({elem:j,props:e.extend({},a),
opts:e.extend(!0,{specialEasing:{}},b),originalProperties:a,originalOptions:b,startTime:nb||ea(),duration:b.duration,tweens:[],createTween:function(a,b){var B=e.Tween(j,f.opts,a,b,f.opts.specialEasing[a]||f.opts.easing);return f.tweens.push(B),B},stop:function(a){var b=0,B=a?f.tweens.length:0;if(c)return this;for(c=!0;B>b;b++)f.tweens[b].run(1);return a?g.resolveWith(j,[f,a]):g.rejectWith(j,[f,a]),this}});a=f.props;b=f.opts.specialEasing;var p,r,A,k;for(r in a)if(p=e.camelCase(r),A=b[p],u=a[r],e.isArray(u)&&
(A=u[1],u=a[r]=u[0]),r!==p&&(a[p]=u,delete a[r]),k=e.cssHooks[p],k&&"expand"in k)for(r in u=k.expand(u),delete a[p],u)r in a||(a[r]=u[r],b[r]=A);else b[p]=A;for(;d>h;h++)if(u=Ob[h].call(f,j,a,f.opts))return u;var v=f;e.each(a,function(j,a){for(var b=(Fb[j]||[]).concat(Fb["*"]),B=0,e=b.length;e>B&&!b[B].call(v,j,a);B++);});return e.isFunction(f.opts.start)&&f.opts.start.call(j,f),e.fx.timer(e.extend(n,{elem:j,anim:f,queue:f.opts.queue})),f.progress(f.opts.progress).done(f.opts.done,f.opts.complete).fail(f.opts.fail).always(f.opts.always)}
function M(j,a,b,e,c){return new M.prototype.init(j,a,b,e,c)}function g(j,a){var b,e={height:j},c=0;for(a=a?1:0;4>c;c+=2-a)b=db[c],e["margin"+b]=e["padding"+b]=j;return a&&(e.opacity=e.width=j),e}function x(j){return e.isWindow(j)?j:9===j.nodeType?j.defaultView||j.parentWindow:!1}var p,r,L=typeof b,F=a.document,fa=a.location,Wa=a.jQuery,Xa=a.$,sa={},Ca=[],ha=Ca.concat,ta=Ca.push,ka=Ca.slice,v=Ca.indexOf,Z=sa.toString,C=sa.hasOwnProperty,Ya="1.9.1".trim,e=function(j,a){return new e.fn.init(j,a,r)},
Da=/[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,Ba=/\S+/g,Za=/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,gb=/^(?:(<[\w\W]+>)[^>]*|#([\w-]*))$/,hb=/^<(\w+)\s*\/?>(?:<\/\1>|)$/,Gb=/^[\],:{}\s]*$/,Pb=/(?:^|:|,)(?:\s*\[)+/g,Qa=/\\(?:["\\\/bfnrt]|u[\da-fA-F]{4})/g,ob=/"[^"\\\r\n]*"|true|false|null|-?(?:\d+\.|)\d+(?:[eE][+-]?\d+|)/g,Ja=/^-ms-/,Hb=/-([\da-z])/gi,Qb=function(j,a){return a.toUpperCase()},H=function(j){(F.addEventListener||"load"===j.type||"complete"===F.readyState)&&(Ra(),e.ready())},Ra=function(){F.addEventListener?
(F.removeEventListener("DOMContentLoaded",H,!1),a.removeEventListener("load",H,!1)):(F.detachEvent("onreadystatechange",H),a.detachEvent("onload",H))};e.fn=e.prototype={jquery:"1.9.1",constructor:e,init:function(j,a,y){var u,c;if(!j)return this;if("string"==typeof j){if(u="<"===j.charAt(0)&&">"===j.charAt(j.length-1)&&3<=j.length?[null,j,null]:gb.exec(j),!u||!u[1]&&a)return!a||a.jquery?(a||y).find(j):this.constructor(a).find(j);if(u[1]){if(a=a instanceof e?a[0]:a,e.merge(this,e.parseHTML(u[1],a&&
...
(0>j?a:0);return this.pushStack(0<=j&&a>j?[this[j]]:[])},map:function(j){return this.pushStack(e.map(this,function(a,b){return j.call(a,b,a)}))},end:function(){return this.prevObject||this.constructor(null)},push:ta,sort:[].sort,splice:[].splice};e.fn.init.prototype=e.fn;e.extend=e.fn.extend=function(){var j,a,y,u,c,h,d=arguments[0]||{},g=1,f=arguments.length,n=!1;"boolean"==typeof d&&(n=d,d=arguments[1]||{},g=2);"object"==typeof d||e.isFunction(d)||(d={});for(f===g&&(d=this,--g);f>g;g++)if(null!=
(c=arguments[g]))for(u in c)j=d[u],y=c[u],d!==y&&(n&&y&&(e.isPlainObject(y)||(a=e.isArray(y)))?(a?(a=!1,h=j&&e.isArray(j)?j:[]):h=j&&e.isPlainObject(j)?j:{},d[u]=e.extend(n,h,y)):y!==b&&(d[u]=y));return d};e.extend({noConflict:function(j){return a.$===e&&(a.$=Xa),j&&a.jQuery===e&&(a.jQuery=Wa),e},isReady:!1,readyWait:1,holdReady:function(j){j?e.readyWait++:e.ready(!0)},ready:function(j){if(!0===j?!--e.readyWait:!e.isReady){if(!F.body)return setTimeout(e.ready);e.isReady=!0;!0!==j&&0<--e.readyWait||
...
this,y.concat(ka.call(arguments)))},c.guid=j.guid=j.guid||e.guid++,c):b},access:function(j,a,y,c,h,d,g){var f=0,n=j.length,p=null==y;if("object"===e.type(y))for(f in h=!0,y)e.access(j,a,f,y[f],!0,d,g);else if(c!==b&&(h=!0,e.isFunction(c)||(g=!0),p&&(g?(a.call(j,c),a=null):(p=a,a=function(j,a,b){return p.call(e(j),b)})),a))for(;n>f;f++)a(j[f],y,g?c:c.call(j[f],f,a(j[f],y)));return h?j:p?a.call(j):n?a(j[0],y):d},now:function(){return(new Date).getTime()}});e.ready.promise=function(j){if(!p)if(p=e.Deferred(),
"complete"===F.readyState)setTimeout(e.ready);else if(F.addEventListener)F.addEventListener("DOMContentLoaded",H,!1),a.addEventListener("load",H,!1);else{F.attachEvent("onreadystatechange",H);a.attachEvent("onload",H);var b=!1;try{b=null==a.frameElement&&F.documentElement}catch(y){}b&&b.doScroll&&function Sc(){if(!e.isReady){try{b.doScroll("left")}catch(j){return setTimeout(Sc,50)}Ra();e.ready()}}()}return p.promise(j)};e.each("Boolean Number String Function Array Date RegExp Object Error".split(" "),
function(j,a){sa["[object "+a+"]"]=a.toLowerCase()});r=e(F);var Sa={};e.Callbacks=function(j){var a;if("string"==typeof j){if(!(a=Sa[j])){a=j;var y=Sa[a]={};a=(e.each(a.match(Ba)||[],function(j,a){y[a]=!0}),y)}}else a=e.extend({},j);j=a;var c,h,d,g,f,n,p=[],r=!j.once&&[],A=function(a){h=j.memory&&a;d=!0;f=n||0;n=0;g=p.length;for(c=!0;p&&g>f;f++)if(!1===p[f].apply(a[0],a[1])&&j.stopOnFalse){h=!1;break}c=!1;p&&(r?r.length&&A(r.shift()):h?p=[]:k.disable())},k={add:function(){if(p){var a=p.length;(function Xc(a){e.each(a,
function(a,b){var B=e.type(b);"function"===B?j.unique&&k.has(b)||p.push(b):b&&b.length&&"string"!==B&&Xc(b)})})(arguments);c?g=p.length:h&&(n=a,A(h))}return this},remove:function(){return p&&e.each(arguments,function(j,a){for(var b;-1<(b=e.inArray(a,p,b));)p.splice(b,1),c&&(g>=b&&g--,f>=b&&f--)}),this},has:function(j){return j?-1<e.inArray(j,p):!(!p||!p.length)},empty:function(){return p=[],this},disable:function(){return p=r=h=b,this},disabled:function(){return!p},lock:function(){return r=b,h||k.disable(),
this},locked:function(){return!r},fireWith:function(j,a){return a=a||[],a=[j,a.slice?a.slice():a],!p||d&&!r||(c?r.push(a):A(a)),this},fire:function(){return k.fireWith(this,arguments),this},fired:function(){return!!d}};return k};e.extend({Deferred:function(j){var a=[["resolve","done",e.Callbacks("once memory"),"resolved"],["reject","fail",e.Callbacks("once memory"),"rejected"],["notify","progress",e.Callbacks("memory")]],b="pending",c={state:function(){return b},always:function(){return h.done(arguments).fail(arguments),
...
"fx",[])},promise:function(a,B){var c,h=1,d=e.Deferred(),g=this,f=this.length,n=function(){--h||d.resolveWith(g,[g])};"string"!=typeof a&&(B=a,a=b);for(a=a||"fx";f--;)(c=e._data(g[f],a+"queueHooks"))&&c.empty&&(h++,c.empty.add(n));return n(),d.promise(B)}});var xa,va,h=/[\t\r\n]/g,n=/\r/g,A=/^(?:input|select|textarea|button|object)$/i,ra=/^(?:a|area)$/i,Ta=/^(?:checked|selected|autofocus|autoplay|async|controls|defer|disabled|hidden|loop|multiple|open|readonly|required|scoped)$/i,pb=/^(?:checked|selected)$/i,
Ea=e.support.getSetAttribute,qb=e.support.input;e.fn.extend({attr:function(a,b){return e.access(this,e.attr,a,b,1<arguments.length)},removeAttr:function(a){return this.each(function(){e.removeAttr(this,a)})},prop:function(a,b){return e.access(this,e.prop,a,b,1<arguments.length)},removeProp:function(a){return a=e.propFix[a]||a,this.each(function(){try{this[a]=b,delete this[a]}catch(e){}})},addClass:function(a){var b,c,u,d,g,f=0,n=this.length;b="string"==typeof a&&a;if(e.isFunction(a))return this.each(function(b){e(this).addClass(a.call(this,
b,this.className))});if(b)for(b=(a||"").match(Ba)||[];n>f;f++)if(c=this[f],u=1===c.nodeType&&(c.className?(" "+c.className+" ").replace(h," "):" ")){for(g=0;d=b[g++];)0>u.indexOf(" "+d+" ")&&(u+=d+" ");c.className=e.trim(u)}return this},removeClass:function(a){var b,c,u,d,g,f=0,n=this.length;b=0===arguments.length||"string"==typeof a&&a;if(e.isFunction(a))return this.each(function(b){e(this).removeClass(a.call(this,b,this.className))});if(b)for(b=(a||"").match(Ba)||[];n>f;f++)if(c=this[f],u=1===c.nodeType&&
(c.className?(" "+c.className+" ").replace(h," "):"")){for(g=0;d=b[g++];)for(;0<=u.indexOf(" "+d+" ");)u=u.replace(" "+d+" "," ");c.className=a?e.trim(u):""}return this},toggleClass:function(a,b){var c=typeof a,h="boolean"==typeof b;return e.isFunction(a)?this.each(function(c){e(this).toggleClass(a.call(this,c,this.className,b),b)}):this.each(function(){if("string"===c)for(var d,g=0,f=e(this),n=b,p=a.match(Ba)||[];d=p[g++];)n=h?n:!f.hasClass(d),f[n?"addClass":"removeClass"](d);else(c===L||"boolean"===
...
a.checked=0<=e.inArray(e(a).val(),c):b}})});var rb=/^(?:input|select|textarea)$/i,Na=/^key/,Rb=/^(?:mouse|contextmenu)|click/,Ib=/^(?:focusinfocus|focusoutblur)$/,Jb=/^([^.]*)(?:\.(.+)|)$/;e.event={global:{},add:function(a,c,h,u,d){var g,f,n,p,r,A,k,v,x;if(n=e._data(a)){h.handler&&(p=h,h=p.handler,d=p.selector);h.guid||(h.guid=e.guid++);(f=n.events)||(f=n.events={});(r=n.handle)||(r=n.handle=function(a){return typeof e===L||a&&e.event.triggered===a.type?b:e.event.dispatch.apply(r.elem,arguments)},
r.elem=a);c=(c||"").match(Ba)||[""];for(n=c.length;n--;)g=Jb.exec(c[n])||[],v=A=g[1],x=(g[2]||"").split(".").sort(),g=e.event.special[v]||{},v=(d?g.delegateType:g.bindType)||v,g=e.event.special[v]||{},A=e.extend({type:v,origType:A,data:u,handler:h,guid:h.guid,selector:d,needsContext:d&&e.expr.match.needsContext.test(d),namespace:x.join(".")},p),(k=f[v])||(k=f[v]=[],k.delegateCount=0,g.setup&&!1!==g.setup.call(a,u,x,r)||(a.addEventListener?a.addEventListener(v,r,!1):a.attachEvent&&a.attachEvent("on"+
v,r))),g.add&&(g.add.call(a,A),A.handler.guid||(A.handler.guid=h.guid)),d?k.splice(k.delegateCount++,0,A):k.push(A),e.event.global[v]=!0;a=null}},remove:function(a,b,c,h,d){var g,f,n,p,r,A,k,v,x,L,m,l=e.hasData(a)&&e._data(a);if(l&&(A=l.events)){b=(b||"").match(Ba)||[""];for(r=b.length;r--;)if(n=Jb.exec(b[r])||[],x=m=n[1],L=(n[2]||"").split(".").sort(),x){k=e.event.special[x]||{};x=(h?k.delegateType:k.bindType)||x;v=A[x]||[];n=n[2]&&RegExp("(^|\\.)"+L.join("\\.(?:.*\\.|)")+"(\\.|$)");for(p=g=v.length;g--;)f=
v[g],!d&&m!==f.origType||c&&c.guid!==f.guid||n&&!n.test(f.namespace)||h&&h!==f.selector&&("**"!==h||!f.selector)||(v.splice(g,1),f.selector&&v.delegateCount--,k.remove&&k.remove.call(a,f));p&&!v.length&&(k.teardown&&!1!==k.teardown.call(a,L,l.handle)||e.removeEvent(a,x,l.handle),delete A[x])}else for(x in A)e.event.remove(a,x+b[r],c,h,!0);e.isEmptyObject(A)&&(delete l.handle,e._removeData(a,"events"))}},trigger:function(j,c,h,u){var d,g,f,n,p,r,A=[h||F],k=C.call(j,"type")?j.type:j;r=C.call(j,"namespace")?
j.namespace.split("."):[];if(f=d=h=h||F,3!==h.nodeType&&8!==h.nodeType&&!Ib.test(k+e.event.triggered)&&(0<=k.indexOf(".")&&(r=k.split("."),k=r.shift(),r.sort()),g=0>k.indexOf(":")&&"on"+k,j=j[e.expando]?j:new e.Event(k,"object"==typeof j&&j),j.isTrigger=!0,j.namespace=r.join("."),j.namespace_re=j.namespace?RegExp("(^|\\.)"+r.join("\\.(?:.*\\.|)")+"(\\.|$)"):null,j.result=b,j.target||(j.target=h),c=null==c?[j]:e.makeArray(c,[j]),p=e.event.special[k]||{},u||!p.trigger||!1!==p.trigger.apply(h,c))){if(!u&&
!p.noBubble&&!e.isWindow(h)){n=p.delegateType||k;for(Ib.test(n+k)||(f=f.parentNode);f;f=f.parentNode)A.push(f),d=f;d===(h.ownerDocument||F)&&A.push(d.defaultView||d.parentWindow||a)}for(r=0;(f=A[r++])&&!j.isPropagationStopped();)j.type=1<r?n:p.bindType||k,(d=(e._data(f,"events")||{})[j.type]&&e._data(f,"handle"))&&d.apply(f,c),(d=g&&f[g])&&e.acceptData(f)&&d.apply&&!1===d.apply(f,c)&&j.preventDefault();if(j.type=k,!(u||j.isDefaultPrevented()||p._default&&!1!==p._default.apply(h.ownerDocument,c)||
"click"===k&&e.nodeName(h,"a")||!e.acceptData(h)||!g||!h[k]||e.isWindow(h))){(d=h[g])&&(h[g]=null);e.event.triggered=k;try{h[k]()}catch(v){}e.event.triggered=b;d&&(h[g]=d)}return j.result}},dispatch:function(a){a=e.event.fix(a);var c,h,u,d,g,f=[],n=ka.call(arguments);c=(e._data(this,"events")||{})[a.type]||[];var p=e.event.special[a.type]||{};if(n[0]=a,a.delegateTarget=this,!p.preDispatch||!1!==p.preDispatch.call(this,a)){f=e.event.handlers.call(this,a,c);for(c=0;(d=f[c++])&&!a.isPropagationStopped();){a.currentTarget=
d.elem;for(g=0;(u=d.handlers[g++])&&!a.isImmediatePropagationStopped();)(!a.namespace_re||a.namespace_re.test(u.namespace))&&(a.handleObj=u,a.data=u.data,h=((e.event.special[u.origType]||{}).handle||u.handler).apply(d.elem,n),h!==b&&!1===(a.result=h)&&(a.preventDefault(),a.stopPropagation()))}return p.postDispatch&&p.postDispatch.call(this,a),a.result}},handlers:function(a,c){var h,u,d,g,f=[],n=c.delegateCount,p=a.target;if(n&&p.nodeType&&(!a.button||"click"!==a.type))for(;p!=this;p=p.parentNode||
this)if(1===p.nodeType&&(!0!==p.disabled||"click"!==a.type)){d=[];for(g=0;n>g;g++)u=c[g],h=u.selector+" ",d[h]===b&&(d[h]=u.needsContext?0<=e(h,this).index(p):e.find(h,this,null,[p]).length),d[h]&&d.push(u);d.length&&f.push({elem:p,handlers:d})}return c.length>n&&f.push({elem:this,handlers:c.slice(n)}),f},fix:function(a){if(a[e.expando])return a;var b,c,h;b=a.type;var d=a,g=this.fixHooks[b];g||(this.fixHooks[b]=g=Rb.test(b)?this.mouseHooks:Na.test(b)?this.keyHooks:{});h=g.props?this.props.concat(g.props):
...
e.each({focus:"focusin",blur:"focusout"},function(a,b){var c=0,h=function(a){e.event.simulate(b,a.target,e.event.fix(a),!0)};e.event.special[b]={setup:function(){0===c++&&F.addEventListener(a,h,!0)},teardown:function(){0===--c&&F.removeEventListener(a,h,!0)}}});e.fn.extend({on:function(a,c,h,d,g){var f,n;if("object"==typeof a){"string"!=typeof c&&(h=h||c,c=b);for(f in a)this.on(f,c,h,a[f],g);return this}if(null==h&&null==d?(d=c,h=c=b):null==d&&("string"==typeof c?(d=h,h=b):(d=h,h=c,c=b)),!1===d)d=
s;else if(!d)return this;return 1===g&&(n=d,d=function(a){return e().off(a),n.apply(this,arguments)},d.guid=n.guid||(n.guid=e.guid++)),this.each(function(){e.event.add(this,a,d,h,c)})},one:function(a,b,c,e){return this.on(a,b,c,e,1)},off:function(a,c,h){var d,g;if(a&&a.preventDefault&&a.handleObj)return d=a.handleObj,e(a.delegateTarget).off(d.namespace?d.origType+"."+d.namespace:d.origType,d.selector,d.handler),this;if("object"==typeof a){for(g in a)this.off(g,c,a[g]);return this}return(!1===c||"function"==
...
Tb[d].exec(g))||n[d]&&!(e=n[d](e))||(c=e.shift(),h.push({value:c,type:d,matches:e}),g=g.slice(c.length));if(!c)break}return b?g.length:g?aa.error(a):wc(a,f).slice(0)},wb=function(a){for(var b=0,c=a.length,e="";c>b;b++)e+=a[b].value;return e},zb=function(a,b,c){var e=b.dir,h=c&&"parentNode"===e,d=bd++;return b.first?function(b,c,d){for(;b=b[e];)if(1===b.nodeType||h)return a(b,c,d)}:function(b,c,g){var f,B,y,n=Pa+" "+d;if(g)for(;b=b[e];){if((1===b.nodeType||h)&&a(b,c,g))return!0}else for(;b=b[e];)if(1===
b.nodeType||h)if(y=b[ma]||(b[ma]={}),(B=y[e])&&B[0]===n){if(!0===(f=B[1])||f===Ub)return!0===f}else if(B=y[e]=[n],B[1]=a(b,c,g)||Ub,!0===B[1])return!0}},Vb=function(a){return 1<a.length?function(b,c,e){for(var h=a.length;h--;)if(!a[h](b,c,e))return!1;return!0}:a[0]},Lb=function(a,b,c,e,h){for(var d,g=[],f=0,n=a.length,p=null!=b;n>f;f++)(d=a[f])&&(!c||c(d,e,h))&&(g.push(d),p&&b.push(f));return g},bb=function(a,b,c,e,h,d){return e&&!e[ma]&&(e=bb(e)),h&&!h[ma]&&(h=bb(h,d)),ya(function(d,g,f,n){var p,
r,k=[],A=[],v=g.length,x;if(!(x=d)){x=b||"*";for(var L=f.nodeType?[f]:f,rc=[],m=0,l=L.length;l>m;m++)aa(x,L[m],rc);x=rc}x=!a||!d&&b?x:Lb(x,k,a,f,n);L=c?h||(d?a:v||e)?[]:g:x;if(c&&c(x,L,f,n),e){p=Lb(L,A);e(p,[],f,n);for(f=p.length;f--;)(r=p[f])&&(L[A[f]]=!(x[A[f]]=r))}if(d){if(h||a){if(h){p=[];for(f=L.length;f--;)(r=L[f])&&p.push(x[f]=r);h(null,L=[],p,n)}for(f=L.length;f--;)(r=L[f])&&-1<(p=h?fc.call(d,r):k[f])&&(d[p]=!(g[p]=r))}}else L=Lb(L===g?L.splice(v,L.length):L),h?h(null,g,L,n):ub.apply(g,L)})},
gc=function(a){var b,c,e,h=a.length,d=ba.relative[a[0].type];c=d||ba.relative[" "];for(var g=d?1:0,f=zb(function(a){return a===b},c,!0),n=zb(function(a){return-1<fc.call(b,a)},c,!0),p=[function(a,j,c){return!d&&(c||j!==Wb)||((b=j).nodeType?f(a,j,c):n(a,j,c))}];h>g;g++)if(c=ba.relative[a[g].type])p=[zb(Vb(p),c)];else{if(c=ba.filter[a[g].type].apply(null,a[g].matches),c[ma]){for(e=++g;h>e&&!ba.relative[a[e].type];e++);return bb(1<g&&Vb(p),1<g&&wb(a.slice(0,g-1)).replace(Sb,"$1"),c,e>g&&gc(a.slice(g,
...
return a})}};for(Ab in{radio:!0,checkbox:!0,file:!0,password:!0,image:!0})ba.pseudos[Ab]=yb(Ab);for(Ab in{submit:!0,reset:!0})ba.pseudos[Ab]=Va(Ab);ec=aa.compile=function(a,b){var c,e=[],h=[],d=Ac[a+" "];if(!d){b||(b=Ua(a));for(c=b.length;c--;)d=gc(b[c]),d[ma]?e.push(d):h.push(d);var g=0,f=0<e.length,n=0<h.length;c=function(a,b,c,j,d){var p,B,r=[],y=0,k="0",A=a&&[],v=null!=d,x=Wb,L=a||n&&ba.find.TAG("*",d&&b.parentNode||b),m=Pa+=null==x?1:Math.random()||0.1;for(v&&(Wb=b!==za&&b,Ub=g);null!=(d=L[k]);k++){if(n&&
d){for(p=0;B=h[p++];)if(B(d,b,c)){j.push(d);break}v&&(Pa=m,Ub=++g)}f&&((d=!B&&d)&&y--,a&&A.push(d))}if(y+=k,f&&k!==y){for(p=0;B=e[p++];)B(A,r,b,c);if(a){if(0<y)for(;k--;)A[k]||r[k]||(r[k]=cd.call(j));r=Lb(r)}ub.apply(j,r);v&&!a&&0<r.length&&1<y+e.length&&aa.uniqueSort(j)}return v&&(Pa=m,Wb=x),A};c=f?ya(c):c;d=Ac(a,c)}return d};ba.pseudos.nth=ba.pseudos.eq;ba.filters=xc.prototype=ba.pseudos;ba.setFilters=new xc;tb();aa.attr=e.attr;e.find=aa;e.expr=aa.selectors;e.expr[":"]=e.expr.pseudos;e.unique=aa.uniqueSort;
...
this.nextSibling,c=this.parentNode;c&&(e(this).remove(),c.insertBefore(a,b))})},detach:function(a){return this.remove(a,!0)},domManip:function(a,c,h){a=ha.apply([],a);var d,g,f,n,p=0,r=this.length,k=this,A=r-1,v=a[0],x=e.isFunction(v);if(x||!(1>=r||"string"!=typeof v||e.support.checkClone)&&pd.test(v))return this.each(function(e){var d=k.eq(e);x&&(a[0]=v.call(this,e,c?d.html():b));d.domManip(a,c,h)});if(r&&(n=e.buildFragment(a,this[0].ownerDocument,!1,this),d=n.firstChild,1===n.childNodes.length&&
(n=d),d)){c=c&&e.nodeName(d,"tr");f=e.map(w(n,"script"),z);for(g=f.length;r>p;p++)d=n,p!==A&&(d=e.clone(d,!0,!0),g&&e.merge(f,w(d,"script"))),h.call(c&&e.nodeName(this[p],"table")?this[p].getElementsByTagName("tbody")[0]||this[p].appendChild(this[p].ownerDocument.createElement("tbody")):this[p],d,p);if(g){n=f[f.length-1].ownerDocument;e.map(f,G);for(p=0;g>p;p++)d=f[p],Ic.test(d.type||"")&&!e._data(d,"globalEval")&&e.contains(n,d)&&(d.src?e.ajax({url:d.src,type:"GET",dataType:"script",async:!1,global:!1,
"throws":!0}):e.globalEval((d.text||d.textContent||d.innerHTML||"").replace(qd,"")))}n=d=null}return this}});e.each({appendTo:"append",prependTo:"prepend",insertBefore:"before",insertAfter:"after",replaceAll:"replaceWith"},function(a,b){e.fn[a]=function(a){for(var c=0,j=[],h=e(a),d=h.length-1;d>=c;c++)a=c===d?this:this.clone(!0),e(h[c])[b](a),ta.apply(j,a.get());return this.pushStack(j)}});e.extend({clone:function(a,b,c){var h,d,g,f,n,p=e.contains(a.ownerDocument,a);if(e.support.html5Clone||e.isXMLDoc(a)||
!Ec.test("<"+a.nodeName+">")?g=a.cloneNode(!0):(lc.innerHTML=a.outerHTML,lc.removeChild(g=lc.firstChild)),!(e.support.noCloneEvent&&e.support.noCloneChecked||1!==a.nodeType&&11!==a.nodeType||e.isXMLDoc(a))){h=w(g);n=w(a);for(f=0;null!=(d=n[f]);++f)if(h[f]){var r=h[f],k=void 0,A=void 0,v=void 0;if(1===r.nodeType){if(k=r.nodeName.toLowerCase(),!e.support.noCloneEvent&&r[e.expando]){v=e._data(r);for(A in v.events)e.removeEvent(r,A,v.handle);r.removeAttribute(e.expando)}"script"===k&&r.text!==d.text?
(z(r).text=d.text,G(r)):"object"===k?(r.parentNode&&(r.outerHTML=d.outerHTML),e.support.html5Clone&&d.innerHTML&&!e.trim(r.innerHTML)&&(r.innerHTML=d.innerHTML)):"input"===k&&ac.test(d.type)?(r.defaultChecked=r.checked=d.checked,r.value!==d.value&&(r.value=d.value)):"option"===k?r.defaultSelected=r.selected=d.defaultSelected:("input"===k||"textarea"===k)&&(r.defaultValue=d.defaultValue)}}}if(b)if(c){n=n||w(a);h=h||w(g);for(f=0;null!=(d=n[f]);f++)D(d,h[f])}else D(a,g);return h=w(g,"script"),0<h.length&&
V(h,!p&&w(a,"script")),g},buildFragment:function(a,b,c,h){for(var d,g,f,n,p,r,k,A=a.length,v=T(b),x=[],L=0;A>L;L++)if(g=a[L],g||0===g)if("object"===e.type(g))e.merge(x,g.nodeType?[g]:g);else if(nd.test(g)){n=n||v.appendChild(b.createElement("div"));p=(Gc.exec(g)||["",""])[1].toLowerCase();k=Ia[p]||Ia._default;n.innerHTML=k[1]+g.replace(Fc,"<$1></$2>")+k[2];for(d=k[0];d--;)n=n.lastChild;if(!e.support.leadingWhitespace&&kc.test(g)&&x.push(b.createTextNode(kc.exec(g)[0])),!e.support.tbody)for(d=(g="table"!==
p||Hc.test(g)?"<table>"!==k[1]||Hc.test(g)?0:n:n.firstChild)&&g.childNodes.length;d--;)e.nodeName(r=g.childNodes[d],"tbody")&&!r.childNodes.length&&g.removeChild(r);e.merge(x,n.childNodes);for(n.textContent="";n.firstChild;)n.removeChild(n.firstChild);n=v.lastChild}else x.push(b.createTextNode(g));n&&v.removeChild(n);e.support.appendChecked||e.grep(w(x,"input"),X);for(L=0;g=x[L++];)if((!h||-1===e.inArray(g,h))&&(f=e.contains(g.ownerDocument,g),n=w(v.appendChild(g),"script"),f&&V(n),c))for(d=0;g=n[d++];)Ic.test(g.type||
"")&&c.push(g);return v},cleanData:function(a,b){for(var c,h,d,g,f=0,n=e.expando,p=e.cache,r=e.support.deleteExpando,k=e.event.special;null!=(c=a[f]);f++)if((b||e.acceptData(c))&&(d=c[n],g=d&&p[d])){if(g.events)for(h in g.events)k[h]?e.event.remove(c,h):e.removeEvent(c,h,g.handle);p[d]&&(delete p[d],r?delete c[n]:typeof c.removeAttribute!==L?c.removeAttribute(n):c[n]=null,Ca.push(d))}}});var Eb,eb,fb,mc=/alpha\([^)]*\)/i,rd=/opacity\s*=\s*([^)]*)/,sd=/^(top|right|bottom|left)$/,td=/^(none|table(?!-c[ea]).+)/,
...
c)},a,c,1<arguments.length)},show:function(){return K(this,!0)},hide:function(){return K(this)},toggle:function(a){var b="boolean"==typeof a;return this.each(function(){(b?a:Q(this))?e(this).show():e(this).hide()})}});e.extend({cssHooks:{opacity:{get:function(a,b){if(b){var c=fb(a,"opacity");return""===c?"1":c}}}},cssNumber:{columnCount:!0,fillOpacity:!0,fontWeight:!0,lineHeight:!0,opacity:!0,orphans:!0,widows:!0,zIndex:!0,zoom:!0},cssProps:{"float":e.support.cssFloat?"cssFloat":"styleFloat"},style:function(a,
c,h,d){if(a&&3!==a.nodeType&&8!==a.nodeType&&a.style){var g,f,n,p=e.camelCase(c),r=a.style;if(c=e.cssProps[p]||(e.cssProps[p]=J(r,p)),n=e.cssHooks[c]||e.cssHooks[p],h===b)return n&&"get"in n&&(g=n.get(a,!1,d))!==b?g:r[c];if(f=typeof h,"string"===f&&(g=ud.exec(h))&&(h=(g[1]+1)*g[2]+parseFloat(e.css(a,c)),f="number"),!(null==h||"number"===f&&isNaN(h)||("number"!==f||e.cssNumber[p]||(h+="px"),e.support.clearCloneStyle||""!==h||0!==c.indexOf("background")||(r[c]="inherit"),n&&"set"in n&&(h=n.set(a,h,
d))===b)))try{r[c]=h}catch(k){}}},css:function(a,c,h,d){var g,f,n,p=e.camelCase(c);return c=e.cssProps[p]||(e.cssProps[p]=J(a.style,p)),n=e.cssHooks[c]||e.cssHooks[p],n&&"get"in n&&(f=n.get(a,!0,h)),f===b&&(f=fb(a,c,d)),"normal"===f&&c in Kc&&(f=Kc[c]),""===h||h?(g=parseFloat(f),!0===h||e.isNumeric(g)?g||0:f):f},swap:function(a,b,c,e){var h,d={};for(h in b)d[h]=a.style[h],a.style[h]=b[h];c=c.apply(a,e||[]);for(h in b)a.style[h]=d[h];return c}});a.getComputedStyle?(eb=function(b){return a.getComputedStyle(b,
null)},fb=function(a,c,h){var d,g,f,n=(h=h||eb(a))?h.getPropertyValue(c)||h[c]:b,p=a.style;return h&&(""!==n||e.contains(a.ownerDocument,a)||(n=e.style(a,c)),Nb.test(n)&&Jc.test(c)&&(d=p.width,g=p.minWidth,f=p.maxWidth,p.minWidth=p.maxWidth=p.width=n,n=h.width,p.width=d,p.minWidth=g,p.maxWidth=f)),n}):F.documentElement.currentStyle&&(eb=function(a){return a.currentStyle},fb=function(a,c,e){var h,d,g;e=(e=e||eb(a))?e[c]:b;var f=a.style;return null==e&&f&&f[c]&&(e=f[c]),Nb.test(e)&&!sd.test(c)&&(h=
...
contents:{xml:/xml/,html:/html/,json:/json/},responseFields:{xml:"responseXML",text:"responseText"},converters:{"* text":a.String,"text html":!0,"text json":e.parseJSON,"text xml":e.parseXML},flatOptions:{url:!0,context:!0}},ajaxSetup:function(a,b){return b?O(O(a,e.ajaxSettings),b):O(e.ajaxSettings,a)},ajaxPrefilter:m(Pc),ajaxTransport:m(bc),ajax:function(a,c){function h(a,c,d,j){var g,A,u,B,ra,w=c;if(2!==Z){Z=2;p&&clearTimeout(p);k=b;n=j||"";C.readyState=0<a?4:0;if(d){B=v;j=C;var q,F,y,E,t=B.contents,
W=B.dataTypes,Ta=B.responseFields;for(E in Ta)E in d&&(j[Ta[E]]=d[E]);for(;"*"===W[0];)W.shift(),F===b&&(F=B.mimeType||j.getResponseHeader("Content-Type"));if(F)for(E in t)if(t[E]&&t[E].test(F)){W.unshift(E);break}if(W[0]in d)y=W[0];else{for(E in d){if(!W[0]||B.converters[E+" "+W[0]]){y=E;break}q||(q=E)}y=y||q}B=y?(y!==W[0]&&W.unshift(y),d[y]):b}if(200<=a&&300>a||304===a)if(v.ifModified&&(ra=C.getResponseHeader("Last-Modified"),ra&&(e.lastModified[f]=ra),ra=C.getResponseHeader("etag"),ra&&(e.etag[f]=
ra)),204===a)g=!0,w="nocontent";else if(304===a)g=!0,w="notmodified";else{var P;a:{d=v;g=B;var fa,G;u={};ra=0;w=d.dataTypes.slice();q=w[0];if(d.dataFilter&&(g=d.dataFilter(g,d.dataType)),w[1])for(fa in d.converters)u[fa.toLowerCase()]=d.converters[fa];for(;A=w[++ra];)if("*"!==A){if("*"!==q&&q!==A){if(fa=u[q+" "+A]||u["* "+A],!fa)for(P in u)if(G=P.split(" "),G[1]===A&&(fa=u[q+" "+G[0]]||u["* "+G[0]])){!0===fa?fa=u[P]:!0!==u[P]&&(A=G[0],w.splice(ra--,0,A));break}if(!0!==fa)if(fa&&d["throws"])g=fa(g);
else try{g=fa(g)}catch(Ya){P={state:"parsererror",error:fa?Ya:"No conversion from "+q+" to "+A};break a}}q=A}P={state:"success",data:g}}g=P;w=g.state;A=g.data;u=g.error;g=!u}else u=w,(a||!w)&&(w="error",0>a&&(a=0));C.status=a;C.statusText=(c||w)+"";g?m.resolveWith(x,[A,w,C]):m.rejectWith(x,[C,w,u]);C.statusCode(s);s=b;r&&L.trigger(g?"ajaxSuccess":"ajaxError",[C,v,g?A:u]);l.fireWith(x,[C,w]);r&&(L.trigger("ajaxComplete",[C,v]),--e.active||e.event.trigger("ajaxStop"))}}"object"==typeof a&&(c=a,a=b);
c=c||{};var d,g,f,n,p,r,k,A,v=e.ajaxSetup({},c),x=v.context||v,L=v.context&&(x.nodeType||x.jquery)?e(x):e.event,m=e.Deferred(),l=e.Callbacks("once memory"),s=v.statusCode||{},ra={},w={},Z=0,q="canceled",C={readyState:0,getResponseHeader:function(a){var b;if(2===Z){if(!A)for(A={};b=Ad.exec(n);)A[b[1].toLowerCase()]=b[2];b=A[a.toLowerCase()]}return null==b?null:b},getAllResponseHeaders:function(){return 2===Z?n:null},setRequestHeader:function(a,b){var c=a.toLowerCase();return Z||(a=w[c]=w[c]||a,ra[a]=
b),this},overrideMimeType:function(a){return Z||(v.mimeType=a),this},statusCode:function(a){var b;if(a)if(2>Z)for(b in a)s[b]=[s[b],a[b]];else C.always(a[C.status]);return this},abort:function(a){a=a||q;return k&&k.abort(a),h(0,a),this}};if(m.promise(C).complete=l.add,C.success=C.done,C.error=C.fail,v.url=((a||v.url||cb)+"").replace(zd,"").replace(Cd,mb[1]+"//"),v.type=c.method||c.type||v.method||v.type,v.dataTypes=e.trim(v.dataType||"*").toLowerCase().match(Ba)||[""],null==v.crossDomain&&(d=Nc.exec(v.url.toLowerCase()),
v.crossDomain=!(!d||d[1]===mb[1]&&d[2]===mb[2]&&(d[3]||("http:"===d[1]?80:443))==(mb[3]||("http:"===mb[1]?80:443)))),v.data&&v.processData&&"string"!=typeof v.data&&(v.data=e.param(v.data,v.traditional)),ca(Pc,v,c,C),2===Z)return C;(r=v.global)&&0===e.active++&&e.event.trigger("ajaxStart");v.type=v.type.toUpperCase();v.hasContent=!Bd.test(v.type);f=v.url;v.hasContent||(v.data&&(f=v.url+=(oc.test(f)?"&":"?")+v.data,delete v.data),!1===v.cache&&(v.url=Mc.test(f)?f.replace(Mc,"$1_="+nc++):f+(oc.test(f)?
...
(!1===v.beforeSend.call(x,C,v)||2===Z))return C.abort();q="abort";for(g in{success:1,error:1,complete:1})C[g](v[g]);if(k=ca(bc,v,c,C)){C.readyState=1;r&&L.trigger("ajaxSend",[C,v]);v.async&&0<v.timeout&&(p=setTimeout(function(){C.abort("timeout")},v.timeout));try{Z=1,k.send(ra,h)}catch(F){if(!(2>Z))throw F;h(-1,F)}}else h(-1,"No Transport");return C},getScript:function(a,c){return e.get(a,b,c,"script")},getJSON:function(a,b,c){return e.get(a,b,c,"json")}});e.ajaxSetup({accepts:{script:"text/javascript, application/javascript, application/ecmascript, application/x-ecmascript"},
...
c.password):p.open(c.type,c.url,c.async),c.xhrFields)for(n in c.xhrFields)p[n]=c.xhrFields[n];c.mimeType&&p.overrideMimeType&&p.overrideMimeType(c.mimeType);c.crossDomain||d["X-Requested-With"]||(d["X-Requested-With"]="XMLHttpRequest");try{for(n in d)p.setRequestHeader(n,d[n])}catch(r){}p.send(c.hasContent&&c.data||null);h=function(a,d){var n,r,k,A;try{if(h&&(d||4===p.readyState))if(h=b,f&&(p.onreadystatechange=e.noop,qc&&delete Db[f]),d)4!==p.readyState&&p.abort();else{A={};n=p.status;r=p.getAllResponseHeaders();
"string"==typeof p.responseText&&(A.text=p.responseText);try{k=p.statusText}catch(v){k=""}n||!c.isLocal||c.crossDomain?1223===n&&(n=204):n=A.text?200:404}}catch(x){d||g(-1,x)}A&&g(n,k,A,r)};c.async?4===p.readyState?setTimeout(h):(f=++Dd,qc&&(Db||(Db={},e(a).unload(qc)),Db[f]=h),p.onreadystatechange=h):h()},abort:function(){h&&h(b,!0)}}}});var nb,$b,Ed=/^(?:toggle|show|hide)$/,Fd=RegExp("^(?:([+-])=|)("+Da+")([a-z%]*)$","i"),Gd=/queueHooks$/,Ob=[function(a,b,c){var h,d,g,f,n,p,r=this,k=a.style,A={},
v=[],x=a.nodeType&&Q(a);c.queue||(n=e._queueHooks(a,"fx"),null==n.unqueued&&(n.unqueued=0,p=n.empty.fire,n.empty.fire=function(){n.unqueued||p()}),n.unqueued++,r.always(function(){r.always(function(){n.unqueued--;e.queue(a,"fx").length||n.empty.fire()})}));1===a.nodeType&&("height"in b||"width"in b)&&(c.overflow=[k.overflow,k.overflowX,k.overflowY],"inline"===e.css(a,"display")&&"none"===e.css(a,"float")&&(e.support.inlineBlockNeedsLayout&&"inline"!==ga(a.nodeName)?k.zoom=1:k.display="inline-block"));
c.overflow&&(k.overflow="hidden",e.support.shrinkWrapBlocks||r.always(function(){k.overflow=c.overflow[0];k.overflowX=c.overflow[1];k.overflowY=c.overflow[2]}));for(d in b)if(g=b[d],Ed.exec(g))(delete b[d],h=h||"toggle"===g,g===(x?"hide":"show"))||v.push(d);if(b=v.length){g=e._data(a,"fxshow")||e._data(a,"fxshow",{});"hidden"in g&&(x=g.hidden);h&&(g.hidden=!x);x?e(a).show():r.done(function(){e(a).hide()});r.done(function(){var b;e._removeData(a,"fxshow");for(b in A)e.style(a,b,A[b])});for(d=0;b>d;d++)h=
v[d],f=r.createTween(h,x?g[h]:0),A[h]=g[h]||e.style(a,h),h in g||(g[h]=f.start,x&&(f.end=f.start,f.start="width"===h||"height"===h?1:0))}}],Fb={"*":[function(a,b){var c,h,d=this.createTween(a,b),g=Fd.exec(b),f=d.cur(),n=+f||0,p=1,r=20;if(g){if(c=+g[2],h=g[3]||(e.cssNumber[a]?"":"px"),"px"!==h&&n){n=e.css(d.elem,a,!0)||c||1;do p=p||".5",n/=p,e.style(d.elem,a,n+h);while(p!==(p=d.cur()/f)&&1!==p&&--r)}d.unit=h;d.start=n;d.end=g[1]?n+(g[1]+1)*c:c}return d}]};e.Animation=e.extend(I,{tweener:function(a,
...
"relative");var d=e(a),g=d.offset(),f=e.css(a,"top"),n=e.css(a,"left"),p={},r={},k,A;("absolute"===h||"fixed"===h)&&-1<e.inArray("auto",[f,n])?(r=d.position(),k=r.top,A=r.left):(k=parseFloat(f)||0,A=parseFloat(n)||0);e.isFunction(b)&&(b=b.call(a,c,g));null!=b.top&&(p.top=b.top-g.top+k);null!=b.left&&(p.left=b.left-g.left+A);"using"in b?b.using.call(a,p):d.css(p)}};e.fn.extend({position:function(){if(this[0]){var a,b,c={top:0,left:0},h=this[0];return"fixed"===e.css(h,"position")?b=h.getBoundingClientRect():
...
d,g,f){function k(a){a.stopPropagation&&a.stopPropagation();a.preventDefault&&a.preventDefault();a.returnValue=!1}function x(a){if(s){if(T&&9>document.documentMode&&!a.button)return m();var b=a.originalEvent.touches,e=b?b[0].pageY:a.pageY,b=Math.max(0,Math.min((b?b[0].pageX:a.pageX)-w.left,E)),e=Math.max(0,Math.min(e-w.top,q));v&&k(a);d.apply(c,[b,e,a])}}function m(){s&&(b(l).unbind(Z),b(l.body).removeClass("sp-dragging"),f.apply(c,arguments));s=!1}d=d||function(){};g=g||function(){};f=f||function(){};
var l=c.ownerDocument||document,s=!1,w={},q=0,E=0,v="ontouchstart"in a,Z={};Z.selectstart=k;Z.dragstart=k;Z[v?"touchmove":"mousemove"]=x;Z[v?"touchend":"mouseup"]=m;b(c).bind(v?"touchstart":"mousedown",function(a){if(!(a.which?3==a.which:2==a.button)&&!s&&!1!==g.apply(c,arguments))s=!0,q=b(c).height(),E=b(c).width(),w=b(c).offset(),b(l).bind(Z),b(l.body).addClass("sp-dragging"),v||x(a),k(a)})}var S={beforeShow:q,move:q,change:q,show:q,hide:q,color:!1,flat:!1,showInput:!0,showButtons:!1,clickoutFiresChange:!1,
showInitial:!1,showPalette:!1,showPaletteOnly:!1,showSelectionPalette:!0,localStorageKey:!1,maxSelectionSize:7,cancelText:"cancel",chooseText:"choose",preferredFormat:!1,className:"",showAlpha:!1,theme:"sp-light",palette:["fff","000"],selectionPalette:[],disabled:!1},U=[],T=!!/msie/i.exec(a.navigator.userAgent),z,G=document.createElement("div").style;G.cssText="background-color:rgba(0,0,0,.5)";z=!!~(""+G.backgroundColor).indexOf("rgba")||!!~(""+G.backgroundColor).indexOf("hsla");var V,G="";if(T)for(var D=
1;6>=D;D++)G+="<div class='sp-"+D+"'></div>";V=["<div class='sp-container'><div class='sp-palette-container'><div class='sp-palette sp-thumb sp-cf'></div></div><div class='sp-picker-container'><div class='sp-top sp-cf'><div class='sp-fill'></div><div class='sp-top-inner'><div class='sp-color'><div class='sp-sat'><div class='sp-val'><div class='sp-dragger'></div></div></div></div><div class='sp-hue'><div class='sp-slider'></div>",G,"</div></div><div class='sp-alpha'><div class='sp-alpha-inner'><div class='sp-alpha-handle'></div></div></div></div><div class='sp-input-container sp-cf'><input class='sp-input' type='text' spellcheck='false'  /></div><div class='sp-initial sp-thumb sp-cf'></div><div class='sp-button-container sp-cf'><a class='sp-cancel' href='#'></a><button class='sp-choose'></button></div></div></div>"].join("");
...
!D.showInput);n.toggleClass("sp-alpha-enabled",D.showAlpha);n.toggleClass("sp-buttons-disabled",!D.showButtons||O);n.toggleClass("sp-palette-disabled",!D.showPalette);n.toggleClass("sp-palette-only",D.showPaletteOnly);n.toggleClass("sp-initial-disabled",!D.showInitial);n.addClass(D.className);K()},x=function(c){if(ca&&(c=tinycolor(c).toRgbString(),-1===b.inArray(c,Ga)&&Ga.push(c),M&&a.localStorage))try{a.localStorage[M]=Ga.join(";")}catch(h){}},L=function(){var a=[],b=Ga,c={},h;if(D.showPalette){for(var e=
0;e<jb.length;e++)for(var d=0;d<jb[e].length;d++)h=tinycolor(jb[e][d]).toRgbString(),c[h]=!0;for(e=0;e<b.length;e++)h=tinycolor(b[e]).toRgbString(),c.hasOwnProperty(h)||(a.push(b[e]),c[h]=!0)}return a.reverse().slice(0,D.maxSelectionSize)},m=function(){var a=W(),c=b.map(jb,function(b,c){return d(b,a,"sp-palette-row sp-palette-row-"+c)});Ga&&c.push(d(L(),a,"sp-palette-row sp-palette-row-selection"));Rb.html(c.join(""))},w=function(){if(D.showInitial){var a=Va,b=W();Ib.html(d([a,b],b,"sp-palette-row-initial"))}},
q=function(){(0===ia||0===da||0===na)&&K();n.addClass(wa)},E=function(){n.removeClass(wa)},v=function(){var a=tinycolor(Na.val());a.ok?e(a):Na.addClass("sp-validation-error")},Z=function(){ea?F():C()},C=function(){if(ea)K();else if(!1!==H.beforeShow(W())){for(var c=0;c<U.length;c++)U[c]&&U[c].hide();ea=!0;b(xa).bind("click.spectrum",F);b(a).bind("resize.spectrum",Q);Aa.addClass("sp-active");n.show();D.showPalette&&m();K();G();Va=W();w();H.show(Va)}},F=function(c){if((!c||!("click"==c.type&&2==c.button))&&
ea&&!O)ea=!1,b(xa).unbind("click.spectrum",F),b(a).unbind("resize.spectrum",Q),Aa.removeClass("sp-active"),n.hide(),tinycolor.equals(W(),Va)||(wb&&"cancel"!==c?I(!0):e(Va,!0)),H.hide(W())},e=function(a,b){if(!tinycolor.equals(a,W())){var c=tinycolor(a),h=c.toHsv();la=h.h;Ma=h.s;qa=h.v;N=h.a;G();b||(Ua=La||c.format)}},W=function(){return tinycolor.fromRatio({h:la,s:Ma,v:qa,a:Math.round(100*N)/100})},P=function(){G();H.move(W())},G=function(){Na.removeClass("sp-validation-error");Y();var a=tinycolor({h:la,
s:"1.0",v:"1.0"});A.css("background-color",a.toHexString());a=Ua;if(1>N&&("hex"===a||"name"===a))a="rgb";var b=W(),c=b.toHexString(),h=b.toRgbString();z||1===b.alpha?xb.css("background-color",h):(xb.css("background-color","transparent"),xb.css("filter",b.toFilter()));if(D.showAlpha){h=b.toRgb();h.a=0;var h=tinycolor(h).toRgbString(),e="linear-gradient(left, "+h+", "+c+")";T?Ea.css("filter",tinycolor(h).toFilter({gradientType:1},c)):(Ea.css("background","-webkit-"+e),Ea.css("background","-moz-"+e),
Ea.css("background","-ms-"+e),Ea.css("background",e))}if(D.showInput){if(1>N&&("hex"===a||"name"===a))a="rgb";Na.val(b.toString(a))}D.showPalette&&m();w()},Y=function(){var a=Ma*da,b=ia-qa*ia,a=Math.max(-R,Math.min(da-R,a-R)),b=Math.max(-R,Math.min(ia-R,b-R));ra.css({top:b,left:a});rb.css({left:N*oa-ua/2});pb.css({top:la*na-Ha})},I=function(a){var b=W();kb&&va.val(b.toString(Ua)).change();var c=!tinycolor.equals(b,Va);Va=b;x(b);a&&c&&H.change(b)},K=function(){da=A.width();ia=A.height();R=ra.height();
Ta.width();na=Ta.height();Ha=pb.height();oa=qb.width();ua=rb.width();O||n.offset(f(n,aa));Y()};r=function(){F();h=!0;va.attr("disabled",!0);aa.addClass("sp-disabled")};var D,J=b.extend({},S,g);J.callbacks={move:l(J.move,this),change:l(J.change,this),show:l(J.show,this),hide:l(J.hide,this),beforeShow:l(J.beforeShow,this)};D=J;var O=D.flat,ca=D.showSelectionPalette,M=D.localStorageKey,X=D.theme,H=D.callbacks,Q,ga=K,ja;Q=function(){var a=this,b=arguments;ja||(ja=setTimeout(function(){ja=null;ga.apply(a,
b)},10))};var ea=!1,da=0,ia=0,R=0,na=0,oa=0,ua=0,Ha=0,la=0,Ma=0,qa=0,N=1,J=D.palette.slice(0),jb=b.isArray(J[0])?J:[J],Ga=D.selectionPalette.slice(0),wa="sp-dragging",xa=this.ownerDocument,J=xa.body,va=b(this),h=!1,n=b(V,xa).addClass(X),A=n.find(".sp-color"),ra=n.find(".sp-dragger"),Ta=n.find(".sp-hue"),pb=n.find(".sp-slider"),Ea=n.find(".sp-alpha-inner"),qb=n.find(".sp-alpha"),rb=n.find(".sp-alpha-handle"),Na=n.find(".sp-input"),Rb=n.find(".sp-palette"),Ib=n.find(".sp-initial"),Jb=n.find(".sp-cancel"),
sb=n.find(".sp-choose"),kb=va.is("input"),ya=kb&&!O,Aa=ya?b("<div class='sp-replacer'><div class='sp-preview'><div class='sp-preview-inner'></div></div></div>").addClass(X):b([]),aa=ya?Aa:va,xb=Aa.find(".sp-preview-inner"),yb=D.color||kb&&va.val(),Va=!1,La=D.preferredFormat,Ua=La,wb=!D.showButtons||D.clickoutFiresChange,X=function(a){a.data&&a.data.ignore?(e(b(this).data("color")),P()):(e(b(this).data("color")),I(!0),P(),F());return!1};T&&n.find("*:not(input)").attr("unselectable","on");k();ya&&va.hide().after(Aa);
O?va.after(n).hide():b(J).append(n.hide());if(M&&a.localStorage){try{var zb=a.localStorage[M].split(",#");1<zb.length&&(delete a.localStorage[M],b.each(zb,function(a,b){x(b)}))}catch(Vb){}try{Ga=a.localStorage[M].split(";")}catch(Lb){}}aa.bind("click.spectrum touchstart.spectrum",function(a){h||Z();a.stopPropagation();b(a.target).is("input")||a.preventDefault()});(va.is(":disabled")||!0===D.disabled)&&r();n.click(t);Na.change(v);Na.bind("paste",function(){setTimeout(v,1)});Na.keydown(function(a){13==
a.keyCode&&v()});Jb.text(D.cancelText);Jb.bind("click.spectrum",function(a){a.stopPropagation();a.preventDefault();F("cancel")});sb.text(D.chooseText);sb.bind("click.spectrum",function(a){a.stopPropagation();a.preventDefault();Na.hasClass("sp-validation-error")||(I(!0),F())});s(qb,function(a,b,c){N=a/oa;c.shiftKey&&(N=Math.round(10*N)/10);P()});s(Ta,function(a,b){la=parseFloat(b/na);P()},q,E);s(A,function(a,b){Ma=parseFloat(a/da);qa=parseFloat((ia-b)/ia);P()},q,E);yb?(e(yb),G(),Ua=La||tinycolor(yb).format,
x(yb)):G();O&&C();q=T?"mousedown.spectrum":"click.spectrum touchstart.spectrum";Rb.delegate(".sp-thumb-el",q,X);Ib.delegate(".sp-thumb-el:nth-child(1)",q,{ignore:!0},X);var bb={show:C,hide:F,toggle:Z,reflow:K,option:function(a,h){if(a===c)return b.extend({},D);if(h===c)return D[a];D[a]=h;k()},enable:function(){h=!1;va.attr("disabled",!1);aa.removeClass("sp-disabled")},disable:r,set:function(a){e(a);I()},get:W,destroy:function(){va.show();aa.unbind("click.spectrum touchstart.spectrum");n.remove();
...
a.hasOwnProperty("_tc_id"))return a;c=a;var s=0,q=0,t=0;a=1;var G=!1,z=!1;if("string"==typeof c)a:{c=c.replace(E,"").replace(Y,"").toLowerCase();var D=!1;if(ea[c])c=ea[c],D=!0;else if("transparent"==c){c={r:0,g:0,b:0,a:0};break a}c=(b=x.rgb.exec(c))?{r:b[1],g:b[2],b:b[3]}:(b=x.rgba.exec(c))?{r:b[1],g:b[2],b:b[3],a:b[4]}:(b=x.hsl.exec(c))?{h:b[1],s:b[2],l:b[3]}:(b=x.hsla.exec(c))?{h:b[1],s:b[2],l:b[3],a:b[4]}:(b=x.hsv.exec(c))?{h:b[1],s:b[2],v:b[3]}:(b=x.hex6.exec(c))?{r:parseInt(b[1],16),g:parseInt(b[2],
16),b:parseInt(b[3],16),format:D?"name":"hex"}:(b=x.hex3.exec(c))?{r:parseInt(b[1]+""+b[1],16),g:parseInt(b[2]+""+b[2],16),b:parseInt(b[3]+""+b[3],16),format:D?"name":"hex"}:!1}"object"==typeof c&&(c.hasOwnProperty("r")&&c.hasOwnProperty("g")&&c.hasOwnProperty("b")?(s=255*K(c.r,255),q=255*K(c.g,255),t=255*K(c.b,255),G=!0,z="rgb"):c.hasOwnProperty("h")&&c.hasOwnProperty("s")&&c.hasOwnProperty("v")?(z=c.h,q=c.s,t=c.v,z=6*K(z,360),q=K(q,100),t=K(t,100),s=W.floor(z),G=z-s,z=t*(1-q),b=t*(1-G*q),G=t*(1-
(1-G)*q),D=s%6,s=255*[t,b,z,z,G,t][D],q=255*[G,t,t,b,z,z][D],t=255*[z,z,G,t,t,b][D],G=!0,z="hsv"):c.hasOwnProperty("h")&&(c.hasOwnProperty("s")&&c.hasOwnProperty("l"))&&(s=c.h,z=c.s,t=c.l,q=function(a,b,c){0>c&&(c+=1);1<c&&(c-=1);return c<1/6?a+6*(b-a)*c:0.5>c?b:c<2/3?a+6*(b-a)*(2/3-c):a},s=K(s,360),z=K(z,100),t=K(t,100),0===z?z=t=b=t:(b=0.5>t?t*(1+z):t+z-t*z,G=2*t-b,z=q(G,b,s+1/3),t=q(G,b,s),b=q(G,b,s-1/3)),s=255*z,q=255*t,t=255*b,G=!0,z="hsl"),c.hasOwnProperty("a")&&(a=c.a));s=m(255,ca(s,0));q=
m(255,ca(q,0));t=m(255,ca(t,0));1>s&&(s=P(s));1>q&&(q=P(q));1>t&&(t=P(t));b=G;c=c&&c.format||z;d=s;f=q;l=t;var v=ja(a);return{ok:b,format:c,_tc_id:ga++,alpha:v,toHsv:function(){var a=J(d,f,l);return{h:a.h,s:a.s,v:a.v,a:v}},toHsvString:function(){var a=J(d,f,l),b=P(360*a.h),c=P(100*a.s),a=P(100*a.v);return 1==v?"hsv("+b+", "+c+"%, "+a+"%)":"hsva("+b+", "+c+"%, "+a+"%, "+v+")"},toHsl:function(){var a=X(d,f,l);return{h:a.h,s:a.s,l:a.l,a:v}},toHslString:function(){var a=X(d,f,l),b=P(360*a.h),c=P(100*
a.s),a=P(100*a.l);return 1==v?"hsl("+b+", "+c+"%, "+a+"%)":"hsla("+b+", "+c+"%, "+a+"%, "+v+")"},toHex:function(){return Q(d,f,l)},toHexString:function(a){return"#"+Q(d,f,l,a)},toRgb:function(){return{r:P(d),g:P(f),b:P(l),a:v}},toRgbString:function(){return 1==v?"rgb("+P(d)+", "+P(f)+", "+P(l)+")":"rgba("+P(d)+", "+P(f)+", "+P(l)+", "+v+")"},toName:function(){return g[Q(d,f,l)]||!1},toFilter:function(a,b){var c=Q(d,f,l,!0),e=c,g=Math.round(255*ja(v)).toString(16),p=g,r=a&&a.gradientType?"GradientType = 1, ":
...
c=K(c,255);var d=ca(a,b,c),g=m(a,b,c),f,k=(d+g)/2;if(d==g)f=g=0;else{var x=d-g,g=0.5<k?x/(2-d-g):x/(d+g);switch(d){case a:f=(b-c)/x+(b<c?6:0);break;case b:f=(c-a)/x+2;break;case c:f=(a-b)/x+4}f/=6}return{h:f,s:g,l:k}},J=function(a,b,c){a=K(a,255);b=K(b,255);c=K(c,255);var d=ca(a,b,c),g=m(a,b,c),f,k=d-g;if(d==g)f=0;else{switch(d){case a:f=(b-c)/k+(b<c?6:0);break;case b:f=(c-a)/k+2;break;case c:f=(a-b)/k+4}f/=6}return{h:f,s:0===d?0:k/d,v:d}},Q=function(a,b,c,d){a=[k(P(a).toString(16)),k(P(b).toString(16)),
k(P(c).toString(16))];return!d&&a[0].charAt(0)==a[0].charAt(1)&&a[1].charAt(0)==a[1].charAt(1)&&a[2].charAt(0)==a[2].charAt(1)?a[0].charAt(0)+a[1].charAt(0)+a[2].charAt(0):a.join("")},K=function(a,b){"string"==typeof a&&(-1!=a.indexOf(".")&&1===ja(a))&&(a="100%");var c="string"===typeof a&&-1!=a.indexOf("%");a=m(b,ca(0,ja(a)));c&&(a*=b/100);return 1E-6>W.abs(a-b)?1:1<=a?a%b/ja(b):a},k=function(a){return 1==a.length?"0"+a:""+a},E=/^[\s,#]+/,Y=/\s+$/,ga=0,W=Math,P=W.round,m=W.min,ca=W.max,O=W.random,
...
sienna:"a0522d",silver:"c0c0c0",skyblue:"87ceeb",slateblue:"6a5acd",slategray:"708090",slategrey:"708090",snow:"fffafa",springgreen:"00ff7f",steelblue:"4682b4",tan:"d2b48c",teal:"008080",thistle:"d8bfd8",tomato:"ff6347",turquoise:"40e0d0",violet:"ee82ee",wheat:"f5deb3",white:"fff",whitesmoke:"f5f5f5",yellow:"ff0",yellowgreen:"9acd32"},G=w,D=ea,I={},M;for(M in D)D.hasOwnProperty(M)&&(I[D[M]]=M);var g=G.hexNames=I,x;x={rgb:RegExp("rgb[\\s|\\(]+((?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?))[,|\\s]+((?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?))[,|\\s]+((?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?))\\s*\\)?"),
...
l=!m}}d.pop();return l}var b=this,c=b._,d={},f=Array.prototype,q=Object.prototype,t=f.slice,l=f.unshift,s=q.toString,S=q.hasOwnProperty,U=f.forEach,T=f.map,z=f.reduce,G=f.reduceRight,V=f.filter,D=f.every,w=f.some,X=f.indexOf,J=f.lastIndexOf,q=Array.isArray,Q=Object.keys,K=Function.prototype.bind,k=function(a){return new I(a)};"undefined"!==typeof exports?("undefined"!==typeof module&&module.exports&&(exports=module.exports=k),exports._=k):b._=k;k.VERSION="1.3.3";var E=k.each=k.forEach=function(a,
...
function(a,b,c){for(var d=0;d<a;d++)b.call(c,d)};k.escape=function(a){return(""+a).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#x27;").replace(/\//g,"&#x2F;")};k.result=function(a,b){if(null==a)return null;var c=a[b];return k.isFunction(c)?c.call(a):c};k.mixin=function(a){E(k.functions(a),function(b){var c=k[b]=a[b];I.prototype[b]=function(){var a=t.call(arguments);l.call(a,this._wrapped);return M(c.apply(k,a),this._chain)}})};var W=0;k.uniqueId=
...
return b};k.chain=function(a){return k(a).chain()};var I=function(a){this._wrapped=a};k.prototype=I.prototype;var M=function(a,b){return b?k(a).chain():a};k.mixin(k);E("pop push reverse shift sort splice unshift".split(" "),function(a){var b=f[a];I.prototype[a]=function(){var c=this._wrapped;b.apply(c,arguments);var d=c.length;("shift"==a||"splice"==a)&&0===d&&delete c[0];return M(c,this._chain)}});E(["concat","join","slice"],function(a){var b=f[a];I.prototype[a]=function(){return M(b.apply(this._wrapped,
...
b){T(b);return f(z.lexer(a))}function T(a){a||(a=K);Q!==a&&(Q=a,Q.gfm?(z.fences=z.gfm.fences,z.paragraph=z.gfm.paragraph,w.text=w.gfm.text,w.url=w.gfm.url):(z.fences=z.normal.fences,z.paragraph=z.normal.paragraph,w.text=w.normal.text,w.url=w.normal.url),Q.pedantic?(w.em=w.pedantic.em,w.strong=w.pedantic.strong):(w.em=w.normal.em,w.strong=w.normal.strong))}var z={newline:/^\n+/,code:/^( {4}[^\n]+\n*)+/,fences:S,hr:/^( *[-*_]){3,} *(?:\n+|$)/,heading:/^ *(#{1,6}) *([^\n]+?) *#* *(?:\n+|$)/,lheading:/^([^\n]+)\n *(=|-){3,} *\n*/,
blockquote:/^( *>[^\n]+(\n[^\n]+)*\n*)+/,list:/^( *)(bull) [^\0]+?(?:hr|\n{2,}(?! )(?!\1bull )\n*|\s*$)/,html:/^ *(?:comment|closed|closing) *(?:\n{2,}|\s*$)/,def:/^ *\[([^\]]+)\]: *([^\s]+)(?: +["(]([^\n]+)[")])? *(?:\n+|$)/,paragraph:/^([^\n]+\n?(?!body))+\n*/,text:/^[^\n]+/,bullet:/(?:[*+-]|\d+\.)/,item:/^( *)(bull) [^\n]*(?:\n(?!\1bull )[^\n]*)*/};z.item=s(z.item,"gm")(/bull/g,z.bullet)();z.list=s(z.list)(/bull/g,z.bullet)("hr",/\n+(?=(?: *[-*_]){3,} *(?:\n+|$))/)();z.html=s(z.html)("comment",
/\x3c!--[^\0]*?--\x3e/)("closed",/<(tag)[^\0]+?<\/\1>/)("closing",/<tag(?:"[^"]*"|'[^']*'|[^'">])*?>/)(/tag/g,l())();var G=z,V;V=z.paragraph.source;var D=[];(function E(a){a=z[a]?z[a].source:a;D.push(a.replace(/(^|[^\[])\^/g,"$1"));return E})("hr")("heading")("lheading")("blockquote")("<"+l())("def");V=RegExp(V.replace("body",D.join("|")));G.paragraph=V;z.normal={fences:z.fences,paragraph:z.paragraph};z.gfm={fences:/^ *(```|~~~) *(\w+)? *\n([^\0]+?)\s*\1 *(?:\n+|$)/,paragraph:/^/};z.gfm.paragraph=
s(z.paragraph)("(?!","(?!"+z.gfm.fences.source.replace(/(^|[^\[])\^/g,"$2")+"|")();z.lexer=function(a){var b=[];b.links={};a=a.replace(/\r\n|\r/g,"\n").replace(/\t/g,"    ");return z.token(a,b,!0)};z.token=function(a,b,c){a=a.replace(/^ +$/gm,"");for(var d,f,m,l,q,s;a;){if(m=z.newline.exec(a))a=a.substring(m[0].length),1<m[0].length&&b.push({type:"space"});if(m=z.code.exec(a))a=a.substring(m[0].length),m=m[0].replace(/^ {4}/gm,""),b.push({type:"code",text:!Q.pedantic?m.replace(/\n+$/,""):m});else if(m=
...
b,c),b.push({type:"blockquote_end"});else if(m=z.list.exec(a)){a=a.substring(m[0].length);b.push({type:"list_start",ordered:isFinite(m[2])});m=m[0].match(z.item);d=!1;s=m.length;for(q=0;q<s;q++)l=m[q],f=l.length,l=l.replace(/^ *([*+-]|\d+\.) +/,""),~l.indexOf("\n ")&&(f-=l.length,l=!Q.pedantic?l.replace(RegExp("^ {1,"+f+"}","gm"),""):l.replace(/^ {1,4}/gm,"")),f=d||/\n\n(?!\s*$)/.test(l),q!==s-1&&(d="\n"===l[l.length-1],f||(f=d)),b.push({type:f?"loose_item_start":"list_item_start"}),z.token(l,b),
...
q(l[0]);return c};var X,J;S.exec=S;var Q,K;U.options=U.setOptions=function(a){K=a;T(a);return U};U.setOptions({gfm:!0,pedantic:!1,sanitize:!1,highlight:null});U.parser=function(a,b){T(b);return f(a)};U.lexer=function(a,b){T(b);return z.lexer(a)};U.parse=U;"undefined"!==typeof module?module.exports=U:this.marked=U}).call(function(){return this||("undefined"!==typeof window?window:global)}());
function natural_sort(a,b){var c=/(^-?[0-9]+(\.?[0-9]*)[df]?e?[0-9]?$|^0x[0-9a-f]+$|[0-9]+)/gi,d=/(^[ ]*|[ ]*$)/g,f=/(^([\w ]+,?[\w ]+)?[\w ]+,?[\w ]+\d+:\d+(:\d+)?[\w ]?|^\d{1,4}[\/\-]\d{1,4}[\/\-]\d{1,4}|^\w+, \w+ \d+, \d{4})/,q=/^0x[0-9a-f]+$/i,t=/^0/,l=(natural_sort.insensitive&&(""+a).toLowerCase()||""+a).replace(d,"")||"",s=(natural_sort.insensitive&&(""+b).toLowerCase()||""+b).replace(d,"")||"",d=l.replace(c,"\x00$1\x00").replace(/\0$/,"").replace(/^\0/,"").split("\x00"),c=s.replace(c,"\x00$1\x00").replace(/\0$/,
"").replace(/^\0/,"").split("\x00"),l=parseInt(l.match(q))||1!=d.length&&l.match(f)&&Date.parse(l);if(f=parseInt(s.match(q))||l&&s.match(f)&&Date.parse(s)||null){if(l<f)return-1;if(l>f)return 1}l=0;for(s=Math.max(d.length,c.length);l<s;l++){f=!(d[l]||"").match(t)&&parseFloat(d[l])||d[l]||0;q=!(c[l]||"").match(t)&&parseFloat(c[l])||c[l]||0;if(isNaN(f)!==isNaN(q))return isNaN(f)?1:-1;typeof f!==typeof q&&(f+="",q+="");if(f<q)return-1;if(f>q)return 1}return 0}
...
a.replace(k,function(a){var b=m[a];return"string"===typeof b?b:"\\u"+("0000"+a.charCodeAt(0).toString(16)).slice(-4)})+'"':'"'+a+'"'}function e(a,b){var h,f,n,g,k=v,m,s=b[a];s instanceof Date&&(s=isFinite(a.valueOf())?a.getUTCFullYear()+"-"+c(a.getUTCMonth()+1)+"-"+c(a.getUTCDate())+"T"+c(a.getUTCHours())+":"+c(a.getUTCMinutes())+":"+c(a.getUTCSeconds())+"Z":null);"function"===typeof q&&(s=q.call(b,a,s));switch(typeof s){case "string":return d(s);case "number":return isFinite(s)?String(s):"null";
case "boolean":case "null":return String(s);case "object":if(!s)return"null";v+=l;m=[];if("[object Array]"===Object.prototype.toString.apply(s)){g=s.length;for(h=0;h<g;h+=1)m[h]=e(h,s)||"null";n=0===m.length?"[]":v?"[\n"+v+m.join(",\n"+v)+"\n"+k+"]":"["+m.join(",")+"]";v=k;return n}if(q&&"object"===typeof q){g=q.length;for(h=0;h<g;h+=1)"string"===typeof q[h]&&(f=q[h],(n=e(f,s))&&m.push(d(f)+(v?": ":":")+n))}else for(f in s)Object.prototype.hasOwnProperty.call(s,f)&&(n=e(f,s))&&m.push(d(f)+(v?": ":
...
z=("undefined"!=typeof io?io:module.exports).parser={},G=z.packets="disconnect connect heartbeat message json event ack error noop".split(" "),V=z.reasons=["transport not supported","client not handshaken","unauthorized"],D=z.advice=["reconnect"],w=l.JSON,X=l.util.indexOf;z.encodePacket=function(a){var b=X(G,a.type),c=a.id||"",d=a.endpoint||"",e=a.ack,f=null;switch(a.type){case "error":var g=a.reason?X(V,a.reason):"";a=a.advice?X(D,a.advice):"";if(""!==g||""!==a)f=g+(""!==a?"+"+a:"");break;case "message":""!==
...
z.decodePacket=function(a){var b=a.match(J);if(!b)return{};var c=b[2]||"";a=b[5]||"";var d={type:G[b[1]],endpoint:b[4]||""};c&&(d.id=c,d.ack=b[3]?"data":!0);switch(d.type){case "error":b=a.split("+");d.reason=V[b[0]]||"";d.advice=D[b[1]]||"";break;case "message":d.data=a||"";break;case "event":try{var e=w.parse(a);d.name=e.name;d.args=e.args}catch(f){}d.args=d.args||[];break;case "json":try{d.data=w.parse(a)}catch(g){}break;case "connect":d.qs=a||"";break;case "ack":if(b=a.match(/^([0-9]+)(\+)?(.*)/))if(d.ackId=
...
E,200==g.status)b(g.responseText);else if(403==g.status)c.onError(g.responseText);else c.connecting=!1,!c.reconnecting&&c.onError(g.responseText)};g.send(null)}};l.prototype.getTransport=function(a){a=a||this.transports;for(var b=0,c;c=a[b];b++)if(K.Transport[c]&&K.Transport[c].check(this)&&(!this.isXDomain()||K.Transport[c].xdomainCheck(this)))return new K.Transport[c](this,this.sessionid);return null};l.prototype.connect=function(a){if(this.connecting)return this;var b=this;b.connecting=!0;this.handshake(function(c,
...
b.options["connect timeout"]))})}b.sessionid=c;b.closeTimeout=1E3*e;b.heartbeatTimeout=1E3*d;b.transports||(b.transports=b.origTransports=f?K.util.intersect(f.split(","),b.options.transports):b.options.transports);b.setHeartbeatTimeout();g(b.transports);b.once("connect",function(){clearTimeout(b.connectTimeoutTimer);a&&"function"==typeof a&&a()})});return this};l.prototype.setHeartbeatTimeout=function(){clearTimeout(this.heartbeatTimeoutTimer);if(!this.transport||this.transport.heartbeats()){var a=
...
this.connecting)this.open&&this.of("").packet({type:"disconnect"}),this.onDisconnect("booted");return this};l.prototype.disconnectSync=function(){var a=K.util.request(),b=["http"+(this.options.secure?"s":"")+":/",this.options.host+":"+this.options.port,this.options.resource,K.protocol,"",this.sessionid].join("/")+"/?disconnect=1";a.open("GET",b,!1);a.send(null);this.onDisconnect("booted")};l.prototype.isXDomain=function(){var a=k.location.port||("https:"==k.location.protocol?443:80);return this.options.host!==
...
sa=function(a,b){if(Qb){var c=b?"visible":"hidden";Qa&&fa(a)?fa(a).style.visibility=c:Xa("#"+a,"visibility:"+c)}},Ca=function(a){return null!=/[\\\"<>\.;]/.exec(a)&&typeof encodeURIComponent!=ha?encodeURIComponent(a):a},ha="undefined",ta="object",ka="application/x-shockwave-flash",v="SWFObjectExprInst",Z=window,C=document;s=navigator;var Ya=!1,e=[function(){if(Ya){var a=C.getElementsByTagName("body")[0],b=C.createElement(ta);b.setAttribute("type",ka);var c=a.appendChild(b);if(c){var d=0;(function(){if(typeof c.GetVariable!=
ha){var e=c.GetVariable("$version");e&&(e=e.split(" ")[1].split(","),H.pv=[parseInt(e[0],10),parseInt(e[1],10),parseInt(e[2],10)])}else if(10>d){d++;setTimeout(arguments.callee,10);return}a.removeChild(b);c=null;I()})()}else I()}else I()}],Da=[],Ba=[],Za=[],gb,hb,Gb,Pb,Qa=!1,ob=!1,Ja,Hb,Qb=!0,H,S=typeof C.getElementById!=ha&&typeof C.getElementsByTagName!=ha&&typeof C.createElement!=ha,Ra=s.userAgent.toLowerCase(),Sa=s.platform.toLowerCase(),cc=Sa?/win/.test(Sa):/win/.test(Ra),Sa=Sa?/mac/.test(Sa):
...
"$1"),10):0}else if(typeof Z[["Active"].concat("Object").join("X")]!=ha)try{var R=new (window[["Active"].concat("Object").join("X")])("ShockwaveFlash.ShockwaveFlash");if(R&&(ia=R.GetVariable("$version")))ib=!0,ia=ia.split(" ")[1].split(","),da=[parseInt(ia[0],10),parseInt(ia[1],10),parseInt(ia[2],10)]}catch(na){}H={w3:S,pv:da,wk:Ra,ie:ib,win:cc,mac:Sa};H.w3&&((typeof C.readyState!=ha&&"complete"==C.readyState||typeof C.readyState==ha&&(C.getElementsByTagName("body")[0]||C.body))&&ja(),Qa||(typeof C.addEventListener!=
ha&&C.addEventListener("DOMContentLoaded",ja,!1),H.ie&&H.win&&(C.attachEvent("onreadystatechange",function(){"complete"==C.readyState&&(C.detachEvent("onreadystatechange",arguments.callee),ja())}),Z==top&&function(){if(!Qa){try{C.documentElement.doScroll("left")}catch(a){setTimeout(arguments.callee,0);return}ja()}}()),H.wk&&function(){Qa||(/loaded|complete/.test(C.readyState)?ja():setTimeout(arguments.callee,0))}(),l(ja)));H.ie&&H.win&&window.attachEvent("onunload",function(){for(var a=Za.length,
b=0;b<a;b++)Za[b][0].detachEvent(Za[b][1],Za[b][2]);a=Ba.length;for(b=0;b<a;b++)F(Ba[b]);for(var c in H)H[c]=null;H=null;for(var d in O)O[d]=null;O=null});O={registerObject:function(a,b,c,d){if(H.w3&&a&&b){var e={};e.id=a;e.swfVersion=b;e.expressInstall=c;e.callbackFn=d;Da[Da.length]=e;sa(a,!1)}else d&&d({success:!1,id:a})},getObjectById:function(a){if(H.w3)return M(a)},embedSWF:function(a,b,c,d,e,f,k,v,l,m){var s={success:!1,id:b};H.w3&&!(H.wk&&312>H.wk)&&a&&b&&c&&d&&e?(sa(b,!1),ea(function(){c+=
"";d+="";var q={};if(l&&typeof l===ta)for(var p in l)q[p]=l[p];q.data=a;q.width=c;q.height=d;p={};if(v&&typeof v===ta)for(var r in v)p[r]=v[r];if(k&&typeof k===ta)for(var w in k)p.flashvars=typeof p.flashvars!=ha?p.flashvars+("&"+w+"="+k[w]):w+"="+k[w];if(Wa(e))r=L(q,p,b),q.id==b&&sa(b,!0),s.success=!0,s.ref=r;else{if(f&&g()){q.data=f;x(q,p,b,m);return}sa(b,!0)}m&&m(s)})):m&&m(s)},switchOffAutoHideShow:function(){Qb=!1},ua:H,getFlashPlayerVersion:function(){return{major:H.pv[0],minor:H.pv[1],release:H.pv[2]}},
hasFlashPlayerVersion:Wa,createSWF:function(a,b,c){if(H.w3)return L(a,b,c)},showExpressInstall:function(a,b,c,d){H.w3&&g()&&x(a,b,c,d)},removeSWF:function(a){H.w3&&F(a)},createCSS:function(a,b,c,d){H.w3&&Xa(a,b,c,d)},addDomLoadEvent:ea,addLoadEvent:l,getQueryParamValue:function(a){var b=C.location.search||C.location.hash;if(b){/\?/.test(b)&&(b=b.split("?")[1]);if(null==a)return Ca(b);for(var b=b.split("&"),c=0;c<b.length;c++)if(b[c].substring(0,b[c].indexOf("="))==a)return Ca(b[c].substring(b[c].indexOf("=")+
...
a[1],a[2]),f.setHours(a[3],a[4],a[5],a[6])),f._a=g,f}function z(a,b){var c,d,e=[];!b&&P&&(b=require("./lang/"+a));for(c=0;c<m.length;c++)b[m[c]]=b[m[c]]||ga.en[m[c]];for(c=0;12>c;c++)d=k([2E3,c]),e[c]=RegExp("^"+(b.months[c]||b.months(d,""))+"|^"+(b.monthsShort[c]||b.monthsShort(d,"")).replace(".",""),"i");return b.monthsParse=b.monthsParse||e,ga[a]=b,b}function G(a){return(a="string"==typeof a&&a||a&&a._lang||null)?ga[a]||z(a):k}function V(a,b){function c(b){return a.lang().longDateFormat[b]||b}
for(var d=5;d--&&ja.test(b);)b=b.replace(ja,c);if(!Ca[b]){var d=Ca,e=b,f=b,g=f.match(O),k,l;k=0;for(l=g.length;k<l;k++)ka[g[k]]?g[k]=ka[g[k]]:g[k]=g[k].match(/\[.*\]/)?g[k].replace(/^\[|\]$/g,""):g[k].replace(/\\/g,"");d[e]=function(a){var b="";for(k=0;k<l;k++)b+="function"==typeof g[k].call?g[k].call(a,f):g[k];return b}}return Ca[b](a)}function D(a){switch(a){case "DDDD":return g;case "YYYY":return x;case "S":case "SS":case "SSS":case "DDD":return M;case "MMM":case "MMMM":case "dd":case "ddd":case "dddd":case "a":case "A":return p;
case "Z":case "ZZ":return r;case "T":return L;case "MM":case "DD":case "YY":case "HH":case "hh":case "mm":case "ss":case "M":case "D":case "d":case "H":case "h":case "m":case "s":return I;default:return RegExp(a.replace("\\",""))}}function w(a,b){var c=[0,0,1,0,0,0,0],d={tzh:0,tzm:0},e=b.match(O),f,g;for(f=0;f<e.length;f++)if((g=(D(e[f]).exec(a)||[])[0])&&(a=a.slice(a.indexOf(g)+g.length)),ka[e[f]]){var k=c,l=d,m=void 0,s=void 0;switch(e[f]){case "M":case "MM":k[1]=null==g?0:~~g-1;break;case "MMM":case "MMMM":for(m=
0;12>m;m++)if(G().monthsParse[m].test(g)){k[1]=m;s=!0;break}s||(k[8]=!1);break;case "D":case "DD":case "DDD":case "DDDD":null!=g&&(k[2]=~~g);break;case "YY":k[0]=~~g+(70<~~g?1900:2E3);break;case "YYYY":k[0]=~~Math.abs(g);break;case "a":case "A":l.isPm="pm"===(g+"").toLowerCase();break;case "H":case "HH":case "h":case "hh":k[3]=~~g;break;case "m":case "mm":k[4]=~~g;break;case "s":case "ss":k[5]=~~g;break;case "S":case "SS":case "SSS":k[6]=~~(1E3*("0."+g));break;case "Z":case "ZZ":l.isUTC=!0,(m=(g+
"").match(Wa))&&m[1]&&(l.tzh=~~m[1]),m&&m[2]&&(l.tzm=~~m[2]),m&&"+"===m[0]&&(l.tzh=-l.tzh,l.tzm=-l.tzm)}null==g&&(k[8]=!1)}return d.isPm&&12>c[3]&&(c[3]+=12),!1===d.isPm&&12===c[3]&&(c[3]=0),T(c,d.isUTC,d.tzh,d.tzm)}function X(a,b,c,d,e){e=e.relativeTime[a];return"function"==typeof e?e(b||1,!!c,a,d):e.replace(/%d/i,b||1)}function J(a,b){k.fn[a]=function(a){var c=this._isUTC?"UTC":"";return null!=a?(this._d["set"+c+b](a),this):this._d["get"+c+b]()}}function Q(a){k.duration.fn[a]=function(){return this._data[a]}}
function K(a,b){k.duration.fn["as"+a]=function(){return+this/b}}for(var k,E=Math.round,Y,ga={},W="en",P="undefined"!=typeof module&&module.exports,m="months monthsShort weekdays weekdaysShort weekdaysMin longDateFormat calendar relativeTime ordinal meridiem".split(" "),ca=/^\/?Date\((\-?\d+)/i,O=/(\[[^\[]*\])|(\\)?(Mo|MM?M?M?|Do|DDDo|DD?D?D?|ddd?d?|do?|w[o|w]?|YYYY|YY|a|A|hh?|HH?|mm?|ss?|SS?S?|zz?|ZZ?|.)/g,ja=/(\[[^\[]*\])|(\\)?(LT|LL?L?L?)/g,ea=/([0-9a-zA-Z\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]+)/gi,
I=/\d\d?/,M=/\d{1,3}/,g=/\d{3}/,x=/\d{1,4}/,p=/[0-9a-z\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]+/i,r=/Z|[\+\-]\d\d:?\d\d/i,L=/T/i,F=/^\s*\d{4}-\d\d-\d\d(T(\d\d(:\d\d(:\d\d(\.\d\d?\d?)?)?)?)?([\+\-]\d\d:?\d\d)?)?/,fa=[["HH:mm:ss.S",/T\d\d:\d\d:\d\d\.\d{1,3}/],["HH:mm:ss",/T\d\d:\d\d:\d\d/],["HH:mm",/T\d\d:\d\d/],["HH",/T\d\d/]],Wa=/([\+\-]|\d\d)/gi,Xa="Month Date Hours Minutes Seconds Milliseconds".split(" "),sa={Milliseconds:1,Seconds:1E3,Minutes:6E4,Hours:36E5,Days:864E5,Months:2592E6,Years:31536E6},
...
c){if(null===b||""===b)return null;var d;if(k.isMoment(b))d=new f(new Date(+b._d),b._isUTC,b._lang);else{if(c)if(S(c)){var g=b.match(ea)||[],e,l=99,m,s;for(m=0;m<c.length;m++)s=w(b,c[m]),e=V(new f(s),c[m]).match(ea)||[],e=U(g,e),e<l&&(l=e,d=s)}else d=w(b,c);else if(d=ca.exec(b),b===a)d=new Date;else if(d)d=new Date(+d[1]);else if(b instanceof Date)d=b;else if(S(b))d=T(b);else if("string"==typeof b)if(d="YYYY-MM-DDT",F.exec(b)){for(g=0;4>g;g++)if(fa[g][1].exec(b)){d+=fa[g][0];break}d=r.exec(b)?w(b,
...
k.defaultFormat="YYYY-MM-DDTHH:mm:ssZ";k.lang=function(a,b){var c;if(!a)return W;(b||!ga[a])&&z(a,b);if(ga[a]){for(c=0;c<m.length;c++)k[m[c]]=ga[a][m[c]];k.monthsParse=ga[a].monthsParse;W=a}};k.langData=G;k.isMoment=function(a){return a instanceof f};k.isDuration=function(a){return a instanceof q};k.lang("en",{months:"January February March April May June July August September October November December".split(" "),monthsShort:"Jan Feb Mar Apr May Jun Jul Aug Sep Oct Nov Dec".split(" "),weekdays:"Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" "),
...
338241895,666307205,773529912,1294757372,1396182291,1695183700,1986661051,2177026350,2456956037,2730485921,2820302411,3259730800,3345764771,3516065817,3600352804,4094571909,275423344,430227734,506948616,659060556,883997877,958139571,1322822218,1537002063,1747873779,1955562222,2024104815,2227730452,2361852424,2428436474,2756734187,3204031479,3329325298],l=[1779033703,3144134277,1013904242,2773480762,1359893119,2600822924,528734635,1541459225],q=Array(64),t,V,D,w,X,J,Q,K,k,E,Y,ga;a[b>>5]|=128<<24-b%
32;a[(b+64>>9<<4)+15]=b;for(k=0;k<a.length;k+=16){t=l[0];V=l[1];D=l[2];w=l[3];X=l[4];J=l[5];Q=l[6];K=l[7];for(E=0;64>E;E++)q[E]=16>E?a[E+k]:c(c(c(d(q[E-2],17)^d(q[E-2],19)^q[E-2]>>>10,q[E-7]),d(q[E-15],7)^d(q[E-15],18)^q[E-15]>>>3),q[E-16]),Y=c(c(c(c(K,d(X,6)^d(X,11)^d(X,25)),X&J^~X&Q),f[E]),q[E]),ga=c(d(t,2)^d(t,13)^d(t,22),t&V^t&D^V&D),K=Q,Q=J,J=X,X=c(w,Y),w=D,D=V,V=t,t=c(Y,ga);l[0]=c(t,l[0]);l[1]=c(V,l[1]);l[2]=c(D,l[2]);l[3]=c(w,l[3]);l[4]=c(X,l[4]);l[5]=c(J,l[5]);l[6]=c(Q,l[6]);l[7]=c(K,l[7])}return l},
q=function(a){for(var c=[],d=(1<<b)-1,f=0;f<a.length*b;f+=b)c[f>>5]|=(a.charCodeAt(f/b)&d)<<24-f%32;return c},t=function(a){for(var b="",c=0;c<4*a.length;c++)b+="0123456789abcdef".charAt(a[c>>2]>>8*(3-c%4)+4&15)+"0123456789abcdef".charAt(a[c>>2]>>8*(3-c%4)&15);return b},l=function(b){return b="object"==typeof b?a(b).val():b.toString()};a.extend({sha256:function(a){a=l(a);return t(f(q(a),a.length*b))},sha256hmac:function(a,c){a=l(a);c=l(c);var d,T=a;d=c;var z=q(T);16<z.length&&(z=f(z,T.length*b));
for(var G=Array(16),T=Array(16),V=0;16>V;V++)G[V]=z[V]^909522486,T[V]=z[V]^1549556828;d=f(G.concat(q(d)),512+d.length*b);d=f(T.concat(d),768);return t(d)},sha256config:function(a){b=parseInt(a)||8}});a.fn.sha256=function(b){a.sha256config(b);b=l(a(this).val());b=a.sha256(b);a.sha256config(8);return b}})(jQuery);
...
Scrap.prototype.loop=function(a){if(!this.values.loop||!this.values.scraps)return null;var b=this.values.scraps.toString(),c=this.values.loop;"string"===typeof c&&c.match(/\{\{/)&&(c=Scrap.getPointer(c.replace(/\{|\}/g,""),a));"string"===typeof c&&(c=this.values.loop.split(/ /g));if(!c)return null;c instanceof Space||(c=new Space(c));var d="";c.each(function(c,q){var t={key:c,value:q},l=b.replace(/\{\{([_a-z0-9\.]+)\}\}/gi,function(b,c){var d;return(d=Scrap.getPointer(c,t))?d:Scrap.getPointer(c,a)});
...
!1;null!=a&&(a=Object(a),a.__proto__=[a.__proto__,a.__proto__=null,c=b in a][0]);return c});return q.apply(this,arguments)}function t(a){return String(a).replace(/([ -])(?!$)/g,"$1?")}function l(a,b){var c=null,f=function(d,f){c=b(c,d,f,a)},k=-1,l=a.length;if(l==l>>>0)for(;++k<l;)f(a[k],k,a);else d(a,f);return c}function s(a){return String(a).replace(/^ +| +$/g,"")}function S(b){function q(a){return l(a,function(a,d){var f=d.pattern||t(d);if(!a&&(a=RegExp("\\b"+f+" *\\d+[.\\w_]*","i").exec(b)||RegExp("\\b"+
f+"(?:; *(?:[a-z]+[_-])?[a-z]+\\d+|[^ ();-]*)","i").exec(b))){if((a=String(d.label||a).split("/"))[1]&&!/[\d.]+/.test(a[0]))a[0]+=" "+a[1];d=d.label||d;a=c(a[0].replace(RegExp(f,"i"),d).replace(RegExp("; *(?:"+d+"[_-])?","i")," ").replace(RegExp("("+d+")(\\w)","i"),"$1 $2"))}return a})}b||(b=ga);var m,Q=b,O=[],T=null,ea=b==ga,I=ea&&k&&"function"==typeof k.version&&k.version(),M=l([{label:"WebKit",pattern:"AppleWebKit"},"iCab","Presto","NetFront","Tasman","Trident","KHTML","Gecko"],function(a,c){return a||
...
"$1").replace(/\/(\d)/," $1").replace(/_/g,".").replace(/(?: BePC|[ .]*fc[ \d.]+)$/i,"").replace(/x86\.64/gi,"x86_64").split(" on ")[0])}return a});M&&(M=[M]);p&&!x&&(x=q([p]));if(m=/Google TV/.exec(x))x=m[0];/\bSimulator\b/i.test(b)&&(x=(x?x+" ":"")+"Simulator");if(/^iP/.test(x))g||(g="Safari"),r="iOS"+((m=/ OS ([\d_]+)/i.exec(b))?" "+m[1].replace(/_/g,"."):"");else if("Konqueror"==g&&!/buntu/i.test(r))r="Kubuntu";else if(p&&"Google"!=p&&/Chrome|Vita/.test(g+";"+x))g="Android Browser",r=/Android/.test(r)?
r:"Android";else if(!g||(m=!/\bMinefield\b/i.test(b)&&/Firefox|Safari/.exec(g)))if(g&&(!x&&/[\/,]|^[^(]+?\)/.test(b.slice(b.indexOf(m+"/")+8)))&&(g=null),(m=x||p||r)&&(x||p||/Android|Symbian OS|Tablet OS|webOS/.test(r)))g=/[a-z]+(?: Hat)?/i.exec(/Android/.test(r)?r:m)+" Browser";I||(I=["(?:Cloud9|CriOS|CrMo|Opera ?Mini|Raven|Silk(?!/[\\d.]+$))","Version",t(g),"(?:Firefox|Minefield|NetFront)"],I=l(I,function(a,c){return a||(RegExp(c+"(?:-[\\d.]+/|(?: for [\\w-]+)?[ /-])([\\d.]+[^ ();/_-]*)","i").exec(b)||
0)[1]||null}));if("iCab"==M&&3<parseFloat(I))M=["WebKit"];else if(m=/Opera/.test(g)&&"Presto"||/\b(?:Midori|Nook|Safari)\b/i.test(b)&&"WebKit"||!M&&/\bMSIE\b/i.test(b)&&(/^Mac/.test(r)?"Tasman":"Trident"))M=[m];if(ea){var L=a,F=null!=L?typeof L.global:"number";if(!/^(?:boolean|number|string|undefined)$/.test(F)&&("object"==F?L.global:1))if(D&&(m=D.lang.System,Q=m.getProperty("os.arch"),r=r||m.getProperty("os.name")+" "+m.getProperty("os.version")),"object"==typeof exports&&exports)if(Y==U&&"object"==
typeof system&&(m=[system])[0]){r||(r=m[0].os||null);try{m[1]=require("ringo/engine").version,I=m[1].join("."),g="RingoJS"}catch(fa){m[0].global==z&&(g="Narwhal")}}else{if("object"==typeof process&&(m=process))g="Node.js",Q=m.arch,r=m.platform,I=/[\d.]+/.exec(m.version)[0]}else"Environment"==f(a.environment)&&(g="Rhino");else if("ScriptBridgingProxyObject"==f(m=a.runtime))g="Adobe AIR",r=m.flash.system.Capabilities.os;else if("RuntimeObject"==f(m=a.phantom))g="PhantomJS",I=(m=m.version||null)&&m.major+
"."+m.minor+"."+m.patch;else if("number"==typeof J.documentMode&&(m=/\bTrident\/(\d+)/i.exec(b))){I=[I,J.documentMode];if((m=+m[1]+4)!=I[1])O.push("IE "+I[1]+" mode"),M[1]="",I[1]=m;I="IE"==g?String(I[1].toFixed(1)):I[0]}r=r&&c(r)}if(I&&(m=/(?:[ab]|dp|pre|[ab]\d+pre)(?:\d+\+?)?$/i.exec(I)||/(?:alpha|beta)(?: ?\d)?/i.exec(b+";"+(ea&&K.appMinorVersion))||/\bMinefield\b/i.test(b)&&"a"))T=/b/i.test(m)?"beta":"alpha",I=I.replace(RegExp(m+"\\+?$"),"")+("beta"==T?X:w)+(/\d+\+?/.exec(m)||"");if("Fennec"==
g)g="Firefox Mobile";else if("Maxthon"==g&&I)I=I.replace(/\.[\d.]+/,".x");else if("Silk"==g)/Mobi/i.test(b)||(r="Android",O.unshift("desktop mode")),/Accelerated *= *true/i.test(b)&&O.unshift("accelerated");else if("IE"==g&&(m=(/; *(?:XBLWP|ZuneWP)(\d+)/i.exec(b)||0)[1]))g+=" Mobile",r="Windows Phone OS "+m+".x",O.unshift("desktop mode");else if(("IE"==g||g&&!x&&!/Browser|Mobi/.test(g))&&("Windows CE"==r||/Mobi/i.test(b)))g+=" Mobile";else if("IE"==g&&ea&&"object"==typeof external&&!external)O.unshift("platform preview");
else if(/BlackBerry/.test(x)&&(m=(RegExp(x.replace(/ +/g," *")+"/([.\\d]+)","i").exec(b)||0)[1]||I))r="Device Software "+m,I=null;else if(this!=d&&(ea&&k||/Opera/.test(g)&&/\b(?:MSIE|Firefox)\b/i.test(b)||"Firefox"==g&&/OS X (?:\d+\.){2,}/.test(r)||"IE"==g&&(r&&!/^Win/.test(r)&&5.5<I||/Windows XP/.test(r)&&8<I||8==I&&!/Trident/.test(b)))&&!G.test(m=S.call(d,b.replace(G,"")+";"))&&m.name)m="ing as "+m.name+((m=m.version)?" "+m:""),G.test(g)?(/IE/.test(m)&&"Mac OS"==r&&(r=null),m="identify"+m):(m="mask"+
m,g=E?c(E.replace(/([a-z])([A-Z])/g,"$1 $2")):"Opera",/IE/.test(m)&&(r=null),ea||(I=null)),M=["Presto"],O.push(m);if(m=(/\bAppleWebKit\/([\d.]+\+?)/i.exec(b)||0)[1]){m=[parseFloat(m.replace(/\.(\d)$/,".0$1")),m];if("Safari"==g&&"+"==m[1].slice(-1))g="WebKit Nightly",T="alpha",I=m[1].slice(0,-1);else if(I==m[1]||I==(/\bSafari\/([\d.]+\+?)/i.exec(b)||0)[1])I=null;m=[m[0],(/\bChrome\/([\d.]+)/i.exec(b)||0)[1]];!ea||/internal|\n/i.test(V.toString())&&!m[1]?(M[1]="like Safari",m=(m=m[0],400>m?1:500>m?
2:526>m?3:533>m?4:534>m?"4+":535>m?5:"5")):(M[1]="like Chrome",m=m[1]||(m=m[0],530>m?1:532>m?2:532.05>m?3:533>m?4:534.03>m?5:534.07>m?6:534.1>m?7:534.13>m?8:534.16>m?9:534.24>m?10:534.3>m?11:535.01>m?12:535.02>m?"13+":535.07>m?15:535.11>m?16:535.19>m?17:536.05>m?18:536.1>m?19:537.01>m?20:"21"));M[1]+=" "+(m+="number"==typeof m?".x":/[.+]/.test(m)?"":"+");if("Safari"==g&&(!I||45<parseInt(I)))I=m}"Opera"==g&&(m=/(?:zbov|zvav)$/.exec(r))?(g+=" ",O.unshift("desktop mode"),"zvav"==m?(g+="Mini",I=null):
g+="Mobile"):"Safari"==g&&/Chrome/.exec(M[1])&&(O.unshift("desktop mode"),g="Chrome Mobile",I=null,/Mac OS X/.test(r)?(p="Apple",r="iOS 4.3+"):r=null);if(I&&0==I.indexOf(m=/[\d.]+$/.exec(r))&&-1<b.indexOf("/"+m+"-"))r=s(r.replace(m,""));if(M&&!/Avant|Nook/.test(g)&&(/Browser|Lunascape|Maxthon/.test(g)||/^(?:Adobe|Arora|Midori|Phantom|Rekonq|Rock|Sleipnir|Web)/.test(g)&&M[1]))(m=M[M.length-1])&&O.push(m);O.length&&(O=["("+O.join("; ")+")"]);p&&(x&&0>x.indexOf(p))&&O.push("on "+p);x&&O.push((/^on /.test(O[O.length-
1])?"":"on ")+x);r&&(m=/ ([\d.+]+)$/.exec(r),r={architecture:32,family:m?r.replace(m[0],""):r,version:m?m[1]:null,toString:function(){var a=this.version;return this.family+(a?" "+a:"")+(64==this.architecture?" 64-bit":"")}});if((m=/\b(?:AMD|IA|Win|WOW|x86_|x)64\b/i.exec(Q))&&!/\bi686\b/i.test(Q))r&&(r.architecture=64,r.family=r.family.replace(RegExp(" *"+m),"")),g&&(/WOW64/i.test(b)||ea&&/\w(?:86|32)$/.test(K.cpuClass||K.platform))&&O.unshift("32-bit");b||(b=null);return{version:g&&I&&(O.unshift(I),
I),name:g&&(O.unshift(g),g),os:r?(g&&!(r==String(r).split(" ")[0]&&(r==g.split(" ")[0]||x))&&O.push(x?"("+r+")":"on "+r),r):{architecture:null,family:null,version:null,toString:function(){return"null"}},description:O.length?O.join(" "):b,layout:M&&M[0],manufacturer:p,prerelease:T,product:x,ua:b,parse:S,toString:function(){return this.description||""}}}var U=a,T="object"==typeof exports&&exports,z="object"==typeof global&&global&&(global==global.global?a=global:global),G=/Opera/,V={}.toString,D=/Java/.test(f(a.java))&&
a.java,w=D?"a":"\u03b1",X=D?"b":"\u03b2",J=a.document||{},Q={}.hasOwnProperty,K=a.navigator||{},k=a.operamini||a.opera,E=G.test(E=f(k))?E:k=null,Y=this,ga=K.userAgent||"";"function"==typeof define&&"object"==typeof define.amd&&define.amd?define(function(){return S()}):T?d(S(),function(a,b){T[b]=a}):a.platform=S()})(this);function App(a){this.name=a;this._open=!1}App.openApp=null;
...
function(a){a.stopPropagation()});var q=$('<div id="nudgepadEditorSaveButton">Send</div>'),t=$('<div id="nudgepadEditorCancelButton">Close</div>'),l=$('<div id="nudgepadEditorButtonContainer"></div>');f.on("click",function(){t.trigger("click")});t.on("click",function(){q.remove();a.remove();f.remove();l.remove();t.remove();d.remove();c.remove();b.remove()});q.on("click",function(){var d=b.val(),f="nudgepad.console";c.is(":checked")&&(f="nudgepad.exec");$.post(f,{command:d},function(c){a.append(">"+
...
nudgepad.getPageDimensions=function(a){a=new Page(a);a._static=!0;var b=$('<iframe class="deleteMe" style="position: fixed; right: 0px; top: 0px;"></iframe>');b.attr("frameborder",0);b.attr("scrolling","no");b.css("width",1);b.css("height",1);$("#nudgepadTemp").append(b);b.contents().find("body").append(a.toHtml());var c={},d=!1;b.contents().find(".scrap").each(function(){var a,b,t,l;d?(a=$(this).position().left,b=a+$(this).outerWidth(),t=$(this).position().top,l=top+$(this).outerHeight(),a<c.left&&
(c.left=a),b>c.right&&(c.right=b),t<c.top&&(c.top=t),l>c.bottom&&(c.bottom=l)):(c.left=$(this).position().left,c.right=c.left+$(this).outerWidth(),c.top=$(this).position().top,c.bottom=c.top+$(this).outerHeight(),d=!0)});c.height=c.bottom-c.top;c.width=c.right-c.left;$(".deleteMe").remove();return c};nudgepad.apps.git=new App("git");nudgepad.apps.git.commit=function(){var a=prompt("Enter your commit message");nudgepad.apps.git.send("git commit -am '"+a+"'")};nudgepad.apps.git.init=function(){nudgepad.apps.git.send("git init")};
...
Grid.prototype.create=function(){this.points={};if(!this.on)return this.erase();this.snap_to_objects&&this.addDynamicPoints();this.snap_to_grid&&this.addFixedPoints();if(this.snap_to_container){this.addPoint(0,$("#nudgepadStageBody").position().top,"#nudgepadStageBody");this.addPoint($("#nudgepadStageBody").position().left,0,"#nudgepadStageBody");var a=Math.round($("#nudgepadStageBody").position().left+Math.round($("#nudgepadStageBody").outerWidth()/2));this.addPoint(a,0,"#nudgepadStageBody");this.addPoint($("#nudgepadStageBody").position().left+
$("#nudgepadStageBody").outerWidth(),0,"#nudgepadStageBody");this.addPoint(0,$("#nudgepadStageBody").height(),"#nudgepadStageBody")}this.visible?this.draw():this.erase()};
...
Grid.prototype.getDelta=function(a){this.eraseSnaplines();var b={},c=[],d=[],f;for(f in a){var q=a[f],t;for(t in this.points)if(this.points.hasOwnProperty(t)){var l=this.points[t],s=l.x-q.x,S=l.y-q.y;b.x||(b.x=s,b.y=S);Math.abs(s)<=Math.abs(b.x)&&(b.x=s,c=[q,l]);Math.abs(S)<=Math.abs(b.y)&&(b.y=S,d=[q,l])}}a=Math.abs(b.x)<this.radius;f=Math.abs(b.y)<this.radius;a||(b.x=0);f||(b.y=0);a&&(c[0]={x:c[0].x+b.x,y:c[0].y+b.y},this.drawSnapline(c[0],c[1]));f&&(d[0]={x:d[0].x+b.x,y:d[0].y+b.y},this.drawSnapline(d[0],
...
nudgepad.MoveHandle.slide=function(a,b){var c=$(this).owner();c.scrap();var d=nudgepad.MoveHandle.dimensions,f=nudgepad.stage.scrollTop()-nudgepad.MoveHandle.scrollTop,q={y:0,x:0};b.shiftKey||(q=nudgepad.grid.getDelta([{x:d.left+nudgepad.mouse.xChange,y:d.top+nudgepad.mouse.yChange+f},{x:d.right+nudgepad.mouse.xChange,y:d.bottom+nudgepad.mouse.yChange+f},{x:d.center+nudgepad.mouse.xChange,y:d.middle+nudgepad.mouse.yChange+f}]));var t=nudgepad.mouse.yChange+f+q.y,l=nudgepad.mouse.xChange+q.x;$(".selection").each(function(){$(this).scrap().move(l-
nudgepad.MoveHandle.last_x_change,t-nudgepad.MoveHandle.last_y_change)});d="X "+parseFloat(c.css("left"))+"<br>Y "+parseFloat(c.css("top"));$("#nudgepadDimensions").css({left:10+c.offset().left+c.outerWidth(),top:-10+c.offset().top+Math.round(c.outerHeight(!0)/2)}).html(d);nudgepad.MoveHandle.last_x_change=l;nudgepad.MoveHandle.last_y_change=t;return!1};nudgepad.MoveHandle.slideend=function(){$(".handle").trigger("update").show();nudgepad.grid.removeSnaplines();$("#nudgepadDimensions").hide();nudgepad.stage.commit()};
...
nudgepad.MoveHandle.update=function(){var a=$(this).owner(),b=Math.min(10,a.outerHeight(!0)-20),c=Math.min(10,a.outerWidth()-20),a={left:a.position().left+c+"px",top:a.position().top+b+"px",height:a.outerHeight(!0)-2*b+"px",width:a.outerWidth()-2*c+"px"};$(this).css(a)};nudgepad.navigation={};
...
nudgepad.pages.edge=new Space;nudgepad.pages.blank=function(){var a=new Space("head\n tag head\n scraps\n  title\n   tag title\n   content Untitled\n  stylesheet\n   tag link\n   href site.css\n   rel stylesheet"),b=prompt("Name your page",nudgepad.pages.nextName());if(!b)return null;nudgepad.pages.create(b,a)};
...
nudgepad.StretchHandle.create=function(a,b,c,d){var f=a.element(),q="fixed"==f.css("position")?"fixed":"absolute",t=("top"==b?"n":"bottom"==b?"s":"")+("left"==c?"w":"right"==c?"e":""),l=$("<div></div>");l.attr("value",a.getPath());l.addClass("handle stretch_handle stretch_handle_"+a.id+" "+a.id+"_handle");l.attr("id","stretch_handle_"+b+c+a.id);l.css({cursor:t+"-resize",position:q,width:"5px",height:"5px",border:"1px solid rgba(0, 0, 0, .5)","background-color":"rgba(255, 255, 255, 0.5)","z-index":"50"});
...
$(this).parent().offset().top,l=nudgepad.StretchHandle.getLength(f,q,t,l,"center"!=c,"middle"!=b),t=a.scrap();"center"!=c&&(t.set("style left",(0<=l.x?f:l.x+f)+"px"),c=a.outerWidth()-a.width(),t.set("style width",Math.abs(l.x)-c+"px"));d?(b=parseFloat(t.get("style width"))/nudgepad.StretchHandle.originalWidth,t.set("style height",Math.round(nudgepad.StretchHandle.originalHeight*b)+"px")):"middle"!=b&&(0<=l.y?t.set("style top",q+"px"):t.set("style top",l.y+q+"px"),b=a.outerHeight(!0)-a.height(),t.set("style height",
Math.abs(l.y)-b+"px"));a.css(t.values.style.values);b="W "+parseFloat(a.css("width"))+"<br> H "+parseFloat(a.css("height"));$("#nudgepadDimensions").css({left:10+a.offset().left+a.outerWidth(),top:-10+a.offset().top+Math.round(a.outerHeight(!0)/2)}).html(b);$(".stretch_handle_"+t.id).trigger("update");return!1};
...
nudgepad.stage.commit();$(".handle").trigger("update");return!1});f.append(s);s=$('<div id="textStyleThree" class="toolButton toolButtonThree">Auto</div>');s.on("click",function(){nudgepad.stage.selection.cssPreview({"text-decoration":"none","font-weight":"normal","font-style":"normal"});return!1});f.append(s);s=$('<div class="clear"></div>');U.append(s);var G=$('<textarea id="nudgepadStyleEditorCssEditor"></textarea>');a.get("style")&&G.val(a.get("style"));G.on("tap mousedown click slide slidestart slideend mouseup",
function(a){a.stopPropagation()});nudgepad.livePreviewScrap=a;G.on("keyup",nudgepad.livePreviewStart);d.append(G);f=$('<div id="nudgepadStyleEditorBottomBar"></div>');G.append(f);var V=$('<div id="nudgepadStyleEditorSaveButton">Save</div>');V.on("click",function(){nudgepad.stage.commit();$(".handle").trigger("update");d.remove();b.remove()});G.append(V);$("body").append(d);var D;$(".colorPicker").spectrum({color:t,move:function(a){nudgepad.stage.selection.cssPreview("background-color "+a.toHexString());
t=a.toHexString()},change:function(a){$("#basic-log").text("change called: "+a.toHexString());t=a.toHexString()},show:function(){D="background-color "},hide:function(){nudgepad.stage.commit();$(".handle").trigger("update")}});$(".colorBorderPicker").spectrum({color:S,move:function(a){nudgepad.stage.selection.cssPreview("border-color "+a.toHexString());S=a.toHexString()},change:function(a){$("#basic-log").text("change called: "+a.toHexString());S=a.toHexString()},show:function(){D="border-color "},
hide:function(){nudgepad.stage.commit();$(".handle").trigger("update")}});$(".colorFontPicker").spectrum({color:c,move:function(a){nudgepad.stage.selection.cssPreview("color "+a.toHexString());S=a.toHexString()},change:function(a){$("#basic-log").text("change called: "+a.toHexString());S=a.toHexString()},show:function(){D="color "},hide:function(){nudgepad.stage.commit();$(".handle").trigger("update")}});$(document).on("slide slidestart slideend",".sp-container",function(){return!1});$(".sp-input[type=text]").on("keydown",
function(a){if(13==a.which)return a.preventDefault(),a=$(this).val(),nudgepad.stage.selection.css(D+a),!1});$(".colorFont .sp-replacer").addClass("fontColorButton");$(".colorFont .sp-preview").addClass("fontColorLine");$(".colorFont .sp-replacer").append('<img src="/nudgepad/images/letter.png">');$(".colorBorder .sp-replacer").addClass("borderColorButton");$(".colorBorder .sp-preview").addClass("borderColorLine");$(".colorBackground .sp-replacer").addClass("backgroundColorButton");$(":input[name=fontDropdown] option").each(function(a,
...
S=$('<div id="nudgepadEditorButtonContainer" class="nudgepad"></div>');t.on("click",function(){s.trigger("click")});s.on("click",function(){l.remove();q.remove();t.remove();S.remove();s.remove()});l.on("click",function(){c&&c(q.val());l.remove();q.remove();t.remove();S.remove();s.remove()});$("body").append(t);$("body").append(q);$("body").append(l);$("body").append(s);$("body").append(S);q.focus()};
/**
