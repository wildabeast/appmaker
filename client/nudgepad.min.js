...
$("body").append(l);b.focus()};nudgepad.contentEditor={};nudgepad.contentEditor.blur=function(){$(this).scrap().set("content",$(this).html());$(this).off("tap mousedown slide slidestart hold slideend",nudgepad.contentEditor.killEvent);$(this).removeAttr("contenteditable");nudgepad.stage.commit();nudgepad.broadcastSelection()};
nudgepad.contentEditor.focus=function(a,b){nudgepad.stage.selection.clear();var c=$(a),e=c.scrap();if(e.isContentEditable())nudgepad.broadcastSelection(e.selector()),c.attr("contenteditable","true"),c.on("tap slide slidestart hold slideend",nudgepad.contentEditor.killEvent),c.on("blur",nudgepad.contentEditor.blur),c.focus(),MoveCursorToEnd(c[0]),b&&document.execCommand("selectAll",!1,null);else{var f="content",q=e.values.tag;if(q&&q.match(/^(list)$/))return nudgepad.stage.selection.clear(),c.selectMe(),
