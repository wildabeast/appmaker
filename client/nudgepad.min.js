...
$("body").append(l);b.focus()};nudgepad.contentEditor={};nudgepad.contentEditor.onblur=function(){$(this).scrap().set("content",$(this).html());$(this).off("tap mousedown slide slidestart hold slideend",nudgepad.contentEditor.killEvent);$(this).removeAttr("contenteditable");$(this).addClass("scrap");nudgepad.stage.commit();nudgepad.broadcastSelection()};
nudgepad.contentEditor.focus=function(a,b){nudgepad.stage.selection.clear();var c=$(a),d=c.scrap();if(d.isContentEditable())nudgepad.broadcastSelection(d.selector()),c.attr("contenteditable","true"),c.addClass("contentEditable").removeClass("scrap"),c.on("tap slide slidestart hold slideend",nudgepad.contentEditor.killEvent),c.on("blur",nudgepad.contentEditor.onblur),c.focus(),MoveCursorToEnd(c[0]),b&&document.execCommand("selectAll",!1,null);else{var f="content",q=d.values.tag;if(q&&q.match(/^(list)$/))return nudgepad.stage.selection.clear(),
