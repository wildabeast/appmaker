...
e+" ")&&(c+=e+" ");b.className=d.trim(c)}return this},removeClass:function(a){var b,c,t,e,l,k=0,f=this.length;b=0===arguments.length||"string"==typeof a&&a;if(d.isFunction(a))return this.each(function(b){d(this).removeClass(a.call(this,b,this.className))});if(b)for(b=(a||"").match(Ba)||[];f>k;k++)if(c=this[k],t=1===c.nodeType&&(c.className?(" "+c.className+" ").replace(h," "):"")){for(l=0;e=b[l++];)for(;0<=t.indexOf(" "+e+" ");)t=t.replace(" "+e+" "," ");c.className=a?d.trim(t):""}return this},toggleClass:function(a,
...
mixpanel.track=function(a){a=Permalink(a);nudgepad.feedback.session[a]=nudgepad.feedback.session[a]?parseFloat(nudgepad.feedback.session[a])+1:1};
...
Events.shortcut.onfire=function(a){mixpanel.track("used shortcut "+a)};
