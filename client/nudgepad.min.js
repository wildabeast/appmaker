(function(a,b){function c(g){var a=g.length,x=d.type(g);return d.isWindow(g)?!1:1===g.nodeType&&a?!0:"array"===x||"function"!==x&&(0===a||"number"==typeof a&&0<a&&a-1 in g)}function e(g,a,x,t){if(d.acceptData(g)){var c,h,Sa=d.expando,e="string"==typeof a,m=g.nodeType,f=m?d.cache:g,k=m?g[Sa]:g[Sa]&&Sa;if(k&&f[k]&&(t||f[k].data)||!e||x!==b)return k||(m?g[Sa]=k=Ca.pop()||d.guid++:k=Sa),f[k]||(f[k]={},m||(f[k].toJSON=d.noop)),("object"==typeof a||"function"==typeof a)&&(t?f[k]=d.extend(f[k],a):f[k].data=
d.extend(f[k].data,a)),c=f[k],t||(c.data||(c.data={}),c=c.data),x!==b&&(c[d.camelCase(a)]=x),e?(h=c[a],null==h&&(h=c[d.camelCase(a)])):h=c,h}}function f(g,a,x){if(d.acceptData(g)){var b,c,h,Sa=g.nodeType,e=Sa?d.cache:g,m=Sa?g[d.expando]:d.expando;if(e[m]){if(a&&(h=x?e[m]:e[m].data)){d.isArray(a)?a=a.concat(d.map(a,d.camelCase)):a in h?a=[a]:(a=d.camelCase(a),a=a in h?[a]:a.split(" "));b=0;for(c=a.length;c>b;b++)delete h[a[b]];if(!(x?r:d.isEmptyObject)(h))return}(x||(delete e[m].data,r(e[m])))&&(Sa?
d.cleanData([g],!0):d.support.deleteExpando||e!=e.window?delete e[m]:e[m]=null)}}}function n(g,a,x){if(x===b&&1===g.nodeType){var t="data-"+a.replace(wa,"-$1").toLowerCase();if(x=g.getAttribute(t),"string"==typeof x){try{x="true"===x?!0:"false"===x?!1:"null"===x?null:+x+""===x?+x:Ga.test(x)?d.parseJSON(x):x}catch(c){}d.data(g,a,x)}else x=b}return x}function r(g){for(var a in g)if(("data"!==a||!d.isEmptyObject(g[a]))&&"toJSON"!==a)return!1;return!0}function l(){return!0}function q(){return!1}function Q(g,
a){do g=g[a];while(g&&1!==g.nodeType);return g}function T(g,a,b){if(a=a||0,d.isFunction(a))return d.grep(g,function(g,d){return!!a.call(g,d,g)===b});if(a.nodeType)return d.grep(g,function(g){return g===a===b});if("string"==typeof a){var t=d.grep(g,function(g){return 1===g.nodeType});if(Uc.test(a))return d.filter(a,t,!b);a=d.filter(a,t)}return d.grep(g,function(g){return 0<=d.inArray(g,a)===b})}function W(g){var a=tc.split("|");g=g.createDocumentFragment();if(g.createElement)for(;a.length;)g.createElement(a.pop());
return g}function y(g){var a=g.getAttributeNode("type");return g.type=(a&&a.specified)+"/"+g.type,g}function B(g){var a=Vc.exec(g.type);return a?g.type=a[1]:g.removeAttribute("type"),g}function N(g,a){for(var b,t=0;null!=(b=g[t]);t++)d._data(b,"globalEval",!a||d._data(a[t],"globalEval"))}function X(g,a){if(1===a.nodeType&&d.hasData(g)){var b,t,c;t=d._data(g);var h=d._data(a,t),e=t.events;if(e)for(b in delete h.handle,h.events={},e){t=0;for(c=e[b].length;c>t;t++)d.event.add(a,b,e[b][t])}h.data&&(h.data=
d.extend({},h.data))}}function s(g,a){var x,t,c=0,h=typeof g.getElementsByTagName!==A?g.getElementsByTagName(a||"*"):typeof g.querySelectorAll!==A?g.querySelectorAll(a||"*"):b;if(!h){h=[];for(x=g.childNodes||g;null!=(t=x[c]);c++)!a||d.nodeName(t,a)?h.push(t):d.merge(h,s(t,a))}return a===b||a&&d.nodeName(g,a)?d.merge([g],h):h}function U(g){cc.test(g.type)&&(g.defaultChecked=g.checked)}function K(g,a){if(a in g)return a;for(var b=a.charAt(0).toUpperCase()+a.slice(1),d=a,c=uc.length;c--;)if(a=uc[c]+
b,a in g)return a;return d}function V(g,a){return g=a||g,"none"===d.css(g,"display")||!d.contains(g.ownerDocument,g)}function I(g,a){for(var b,t,c,h=[],e=0,m=g.length;m>e;e++)t=g[e],t.style&&(h[e]=d._data(t,"olddisplay"),b=t.style.display,a?(h[e]||"none"!==b||(t.style.display=""),""===t.style.display&&V(t)&&(h[e]=d._data(t,"olddisplay",ca(t.nodeName)))):h[e]||(c=V(t),(b&&"none"!==b||!c)&&d._data(t,"olddisplay",c?b:d.css(t,"display"))));for(e=0;m>e;e++)t=g[e],t.style&&(a&&"none"!==t.style.display&&
""!==t.style.display||(t.style.display=a?h[e]||"":"none"));return g}function j(g,a,b){return(g=Wc.exec(a))?Math.max(0,g[1]-(b||0))+(g[2]||"px"):a}function C(g,a,b,t,c){a=b===(t?"border":"content")?4:"width"===a?1:0;for(var h=0;4>a;a+=2)"margin"===b&&(h+=d.css(g,b+gb[a],!0,c)),t?("content"===b&&(h-=d.css(g,"padding"+gb[a],!0,c)),"margin"!==b&&(h-=d.css(g,"border"+gb[a]+"Width",!0,c))):(h+=d.css(g,"padding"+gb[a],!0,c),"padding"!==b&&(h+=d.css(g,"border"+gb[a]+"Width",!0,c)));return h}function R(g,
a,b){var t=!0,c="width"===a?g.offsetWidth:g.offsetHeight,h=hb(g),e=d.support.boxSizing&&"border-box"===d.css(g,"boxSizing",!1,h);if(0>=c||null==c){if(c=ib(g,a,h),(0>c||null==c)&&(c=g.style[a]),Pb.test(c))return c;t=e&&(d.support.boxSizingReliable||c===g.style[a]);c=parseFloat(c)||0}return c+C(g,a,b||(e?"border":"content"),t,h)+"px"}function ca(g){var a=F,b=vc[g];return b||(b=L(g,a),"none"!==b&&b||(Gb=(Gb||d("<iframe frameborder='0' width='0' height='0'/>").css("cssText","display:block !important")).appendTo(a.documentElement),
a=(Gb[0].contentWindow||Gb[0].contentDocument).document,a.write("<!doctype html><html><body>"),a.close(),b=L(g,a),Gb.detach()),vc[g]=b),b}function L(g,a){var b=d(a.createElement(g)).appendTo(a.body),t=d.css(b[0],"display");return b.remove(),t}function H(g,a,b,t){var c;if(d.isArray(a))d.each(a,function(a,z){b||Xc.test(g)?t(g,z):H(g+"["+("object"==typeof z?a:"")+"]",z,b,t)});else if(b||"object"!==d.type(a))t(g,a);else for(c in a)H(g+"["+c+"]",a[c],b,t)}function S(g){return function(a,b){"string"!=typeof a&&
(b=a,a="*");var t,c=0,h=a.toLowerCase().match(Ba)||[];if(d.isFunction(b))for(;t=h[c++];)"+"===t[0]?(t=t.slice(1)||"*",(g[t]=g[t]||[]).unshift(b)):(g[t]=g[t]||[]).push(b)}}function P(g,a,x,t){function c(m){var f;return h[m]=!0,d.each(g[m]||[],function(g,d){var m=d(a,x,t);return"string"!=typeof m||e||h[m]?e?!(f=m):b:(a.dataTypes.unshift(m),c(m),!1)}),f}var h={},e=g===dc;return c(a.dataTypes[0])||!h["*"]&&c("*")}function fa(g,a){var x,t,c=d.ajaxSettings.flatOptions||{};for(t in a)a[t]!==b&&((c[t]?g:
x||(x={}))[t]=a[t]);return x&&d.extend(!0,g,x),g}function ha(){try{return new a.XMLHttpRequest}catch(g){}}function ja(){return setTimeout(function(){qb=b}),qb=d.now()}function ia(g,a,b){var t,c,h=0,e=Qb.length,m=d.Deferred().always(function(){delete f.elem}),f=function(){if(c)return!1;for(var a=qb||ja(),a=Math.max(0,k.startTime+k.duration-a),b=1-(a/k.duration||0),z=0,d=k.tweens.length;d>z;z++)k.tweens[z].run(b);return m.notifyWith(g,[k,b,a]),1>b&&d?a:(m.resolveWith(g,[k]),!1)},k=m.promise({elem:g,
props:d.extend({},a),opts:d.extend(!0,{specialEasing:{}},b),originalProperties:a,originalOptions:b,startTime:qb||ja(),duration:b.duration,tweens:[],createTween:function(a,b){var z=d.Tween(g,k.opts,a,b,k.opts.specialEasing[a]||k.opts.easing);return k.tweens.push(z),z},stop:function(a){var b=0,z=a?k.tweens.length:0;if(c)return this;for(c=!0;z>b;b++)k.tweens[b].run(1);return a?m.resolveWith(g,[k,a]):m.rejectWith(g,[k,a]),this}});a=k.props;b=k.opts.specialEasing;var u,p,j,w;for(p in a)if(u=d.camelCase(p),
j=b[u],t=a[p],d.isArray(t)&&(j=t[1],t=a[p]=t[0]),p!==u&&(a[u]=t,delete a[p]),w=d.cssHooks[u],w&&"expand"in w)for(p in t=w.expand(t),delete a[u],t)p in a||(a[p]=t[p],b[p]=j);else b[u]=j;for(;e>h;h++)if(t=Qb[h].call(k,g,a,k.opts))return t;var v=k;d.each(a,function(g,a){for(var b=(Hb[g]||[]).concat(Hb["*"]),z=0,d=b.length;d>z&&!b[z].call(v,g,a);z++);});return d.isFunction(k.opts.start)&&k.opts.start.call(g,k),d.fx.timer(d.extend(f,{elem:g,anim:k,queue:k.opts.queue})),k.progress(k.opts.progress).done(k.opts.done,
k.opts.complete).fail(k.opts.fail).always(k.opts.always)}function Y(g,a,b,d,c){return new Y.prototype.init(g,a,b,d,c)}function k(g,a){var b,d={height:g},c=0;for(a=a?1:0;4>c;c+=2-a)b=gb[c],d["margin"+b]=d["padding"+b]=g;return a&&(d.opacity=d.width=g),d}function D(g){return d.isWindow(g)?g:9===g.nodeType?g.defaultView||g.parentWindow:!1}var p,v,A=typeof b,F=a.document,ga=a.location,$a=a.jQuery,ab=a.$,sa={},Ca=[],da=Ca.concat,ta=Ca.push,ka=Ca.slice,w=Ca.indexOf,O=sa.toString,G=sa.hasOwnProperty,Ta=
...
"complete"===F.readyState)&&(Va(),d.ready())},Va=function(){F.addEventListener?(F.removeEventListener("DOMContentLoaded",E,!1),a.removeEventListener("load",E,!1)):(F.detachEvent("onreadystatechange",E),a.detachEvent("onload",E))};d.fn=d.prototype={jquery:"1.9.1",constructor:d,init:function(g,a,x){var t,c;if(!g)return this;if("string"==typeof g){if(t="<"===g.charAt(0)&&">"===g.charAt(g.length-1)&&3<=g.length?[null,g,null]:jb.exec(g),!t||!t[1]&&a)return!a||a.jquery?(a||x).find(g):this.constructor(a).find(g);
if(t[1]){if(a=a instanceof d?a[0]:a,d.merge(this,d.parseHTML(t[1],a&&a.nodeType?a.ownerDocument||a:F,!0)),kb.test(t[1])&&d.isPlainObject(a))for(t in a)d.isFunction(this[t])?this[t](a[t]):this.attr(t,a[t]);return this}if(c=F.getElementById(t[2]),c&&c.parentNode){if(c.id!==t[2])return x.find(g);this.length=1;this[0]=c}return this.context=F,this.selector=g,this}return g.nodeType?(this.context=this[0]=g,this.length=1,this):d.isFunction(g)?x.ready(g):(g.selector!==b&&(this.selector=g.selector,this.context=
...
last:function(){return this.eq(-1)},eq:function(g){var a=this.length;g=+g+(0>g?a:0);return this.pushStack(0<=g&&a>g?[this[g]]:[])},map:function(g){return this.pushStack(d.map(this,function(a,b){return g.call(a,b,a)}))},end:function(){return this.prevObject||this.constructor(null)},push:ta,sort:[].sort,splice:[].splice};d.fn.init.prototype=d.fn;d.extend=d.fn.extend=function(){var g,a,x,t,c,h,e=arguments[0]||{},m=1,k=arguments.length,f=!1;"boolean"==typeof e&&(f=e,e=arguments[1]||{},m=2);"object"==
typeof e||d.isFunction(e)||(e={});for(k===m&&(e=this,--m);k>m;m++)if(null!=(c=arguments[m]))for(t in c)g=e[t],x=c[t],e!==x&&(f&&x&&(d.isPlainObject(x)||(a=d.isArray(x)))?(a?(a=!1,h=g&&d.isArray(g)?g:[]):h=g&&d.isPlainObject(g)?g:{},e[t]=d.extend(f,h,x)):x!==b&&(e[t]=x));return e};d.extend({noConflict:function(g){return a.$===d&&(a.$=ab),g&&a.jQuery===d&&(a.jQuery=$a),d},isReady:!1,readyWait:1,holdReady:function(g){g?d.readyWait++:d.ready(!0)},ready:function(g){if(!0===g?!--d.readyWait:!d.isReady){if(!F.body)return setTimeout(d.ready);
d.isReady=!0;!0!==g&&0<--d.readyWait||(p.resolveWith(F,[d]),d.fn.trigger&&d(F).trigger("ready").off("ready"))}},isFunction:function(g){return"function"===d.type(g)},isArray:Array.isArray||function(g){return"array"===d.type(g)},isWindow:function(g){return null!=g&&g==g.window},isNumeric:function(g){return!isNaN(parseFloat(g))&&isFinite(g)},type:function(g){return null==g?g+"":"object"==typeof g||"function"==typeof g?sa[O.call(g)]||"object":typeof g},isPlainObject:function(g){if(!g||"object"!==d.type(g)||
g.nodeType||d.isWindow(g))return!1;try{if(g.constructor&&!G.call(g,"constructor")&&!G.call(g.constructor.prototype,"isPrototypeOf"))return!1}catch(a){return!1}for(var x in g);return x===b||G.call(g,x)},isEmptyObject:function(g){for(var a in g)return!1;return!0},error:function(g){throw Error(g);},parseHTML:function(g,a,b){if(!g||"string"!=typeof g)return null;"boolean"==typeof a&&(b=a,a=!1);a=a||F;var t=kb.exec(g);b=!b&&[];return t?[a.createElement(t[1])]:(t=d.buildFragment([g],a,b),b&&d(b).remove(),
d.merge([],t.childNodes))},parseJSON:function(g){return a.JSON&&a.JSON.parse?a.JSON.parse(g):null===g?g:"string"==typeof g&&(g=d.trim(g),g&&Ib.test(g.replace(Ua,"@").replace(rb,"]").replace(Rb,"")))?Function("return "+g)():(d.error("Invalid JSON: "+g),b)},parseXML:function(g){var z,x;if(!g||"string"!=typeof g)return null;try{a.DOMParser?(x=new DOMParser,z=x.parseFromString(g,"text/xml")):(z=new ActiveXObject("Microsoft.XMLDOM"),z.async="false",z.loadXML(g))}catch(t){z=b}return z&&z.documentElement&&
...
merge:function(g,a){var d=a.length,t=g.length,c=0;if("number"==typeof d)for(;d>c;c++)g[t++]=a[c];else for(;a[c]!==b;)g[t++]=a[c++];return g.length=t,g},grep:function(g,a,b){var d,c=[],h=0,e=g.length;for(b=!!b;e>h;h++)d=!!a(g[h],h),b!==d&&c.push(g[h]);return c},map:function(g,a,b){var d,h=0,e=g.length,m=[];if(c(g))for(;e>h;h++)d=a(g[h],h,b),null!=d&&(m[m.length]=d);else for(h in g)d=a(g[h],h,b),null!=d&&(m[m.length]=d);return da.apply([],m)},guid:1,proxy:function(g,a){var x,c,h;return"string"==typeof a&&
(h=g[a],a=g,g=h),d.isFunction(g)?(x=ka.call(arguments,2),c=function(){return g.apply(a||this,x.concat(ka.call(arguments)))},c.guid=g.guid=g.guid||d.guid++,c):b},access:function(g,a,x,c,h,e,m){var k=0,f=g.length,p=null==x;if("object"===d.type(x))for(k in h=!0,x)d.access(g,a,k,x[k],!0,e,m);else if(c!==b&&(h=!0,d.isFunction(c)||(m=!0),p&&(m?(a.call(g,c),a=null):(p=a,a=function(g,a,b){return p.call(d(g),b)})),a))for(;f>k;k++)a(g[k],x,m?c:c.call(g[k],k,a(g[k],x)));return h?g:p?a.call(g):f?a(g[0],x):e},
now:function(){return(new Date).getTime()}});d.ready.promise=function(g){if(!p)if(p=d.Deferred(),"complete"===F.readyState)setTimeout(d.ready);else if(F.addEventListener)F.addEventListener("DOMContentLoaded",E,!1),a.addEventListener("load",E,!1);else{F.attachEvent("onreadystatechange",E);a.attachEvent("onload",E);var b=!1;try{b=null==a.frameElement&&F.documentElement}catch(x){}b&&b.doScroll&&function Tc(){if(!d.isReady){try{b.doScroll("left")}catch(g){return setTimeout(Tc,50)}Va();d.ready()}}()}return p.promise(g)};
d.each("Boolean Number String Function Array Date RegExp Object Error".split(" "),function(g,a){sa["[object "+a+"]"]=a.toLowerCase()});v=d(F);var Wa={};d.Callbacks=function(g){var a;if("string"==typeof g){if(!(a=Wa[g])){a=g;var x=Wa[a]={};a=(d.each(a.match(Ba)||[],function(g,a){x[a]=!0}),x)}}else a=d.extend({},g);g=a;var c,h,e,m,k,f,p=[],u=!g.once&&[],j=function(a){h=g.memory&&a;e=!0;k=f||0;f=0;m=p.length;for(c=!0;p&&m>k;k++)if(!1===p[k].apply(a[0],a[1])&&g.stopOnFalse){h=!1;break}c=!1;p&&(u?u.length&&
j(u.shift()):h?p=[]:w.disable())},w={add:function(){if(p){var a=p.length;(function Yc(a){d.each(a,function(a,b){var z=d.type(b);"function"===z?g.unique&&w.has(b)||p.push(b):b&&b.length&&"string"!==z&&Yc(b)})})(arguments);c?m=p.length:h&&(f=a,j(h))}return this},remove:function(){return p&&d.each(arguments,function(g,a){for(var b;-1<(b=d.inArray(a,p,b));)p.splice(b,1),c&&(m>=b&&m--,k>=b&&k--)}),this},has:function(g){return g?-1<d.inArray(g,p):!(!p||!p.length)},empty:function(){return p=[],this},disable:function(){return p=
u=h=b,this},disabled:function(){return!p},lock:function(){return u=b,h||w.disable(),this},locked:function(){return!u},fireWith:function(g,a){return a=a||[],a=[g,a.slice?a.slice():a],!p||e&&!u||(c?u.push(a):j(a)),this},fire:function(){return w.fireWith(this,arguments),this},fired:function(){return!!e}};return w};d.extend({Deferred:function(g){var a=[["resolve","done",d.Callbacks("once memory"),"resolved"],["reject","fail",d.Callbacks("once memory"),"rejected"],["notify","progress",d.Callbacks("memory")]],
b="pending",c={state:function(){return b},always:function(){return h.done(arguments).fail(arguments),this},then:function(){var g=arguments;return d.Deferred(function(b){d.each(a,function(a,z){var x=z[0],e=d.isFunction(g[a])&&g[a];h[z[1]](function(){var g=e&&e.apply(this,arguments);g&&d.isFunction(g.promise)?g.promise().done(b.resolve).fail(b.reject).progress(b.notify):b[x+"With"](this===c?b.promise():this,e?[g]:arguments)})});g=null}).promise()},promise:function(g){return null!=g?d.extend(g,c):c}},
...
b):--h||e.resolveWith(a,b)}},k,f,p;if(1<c){k=Array(c);f=Array(c);for(p=Array(c);c>a;a++)b[a]&&d.isFunction(b[a].promise)?b[a].promise().done(m(a,p,b)).fail(e.reject).progress(m(a,f,k)):--h}return h||e.resolveWith(p,b),e.promise()}});var ec=d,lb;var ba,ea,M,na,oa,ua,Ha,la,Na,ra,J=F.createElement("div");if(J.setAttribute("className","t"),J.innerHTML="  <link/><table></table><a href='/a'>a</a><input type='checkbox'/>",ea=J.getElementsByTagName("*"),M=J.getElementsByTagName("a")[0],!ea||!M||!ea.length)lb=
...
g.nodeName&&d.noData[g.nodeName.toLowerCase()];return!a||!0!==a&&g.getAttribute("classid")===a}});d.fn.extend({data:function(g,a){var x,c,h=this[0],e=0,m=null;if(g===b){if(this.length&&(m=d.data(h),1===h.nodeType&&!d._data(h,"parsedAttrs"))){for(x=h.attributes;x.length>e;e++)c=x[e].name,c.indexOf("data-")||(c=d.camelCase(c.slice(5)),n(h,c,m[c]));d._data(h,"parsedAttrs",!0)}return m}return"object"==typeof g?this.each(function(){d.data(this,g)}):d.access(this,function(a){return a===b?h?n(h,g,d.data(h,
g)):null:(this.each(function(){d.data(this,g,a)}),b)},null,a,1<arguments.length,null,!0)},removeData:function(g){return this.each(function(){d.removeData(this,g)})}});d.extend({queue:function(g,a,x){var c;return g?(a=(a||"fx")+"queue",c=d._data(g,a),x&&(!c||d.isArray(x)?c=d._data(g,a,d.makeArray(x)):c.push(x)),c||[]):b},dequeue:function(g,a){a=a||"fx";var b=d.queue(g,a),c=b.length,h=b.shift(),e=d._queueHooks(g,a),m=function(){d.dequeue(g,a)};"inprogress"===h&&(h=b.shift(),c--);(e.cur=h)&&("fx"===
a&&b.unshift("inprogress"),delete e.stop,h.call(g,m,e));!c&&e&&e.empty.fire()},_queueHooks:function(g,a){var b=a+"queueHooks";return d._data(g,b)||d._data(g,b,{empty:d.Callbacks("once memory").add(function(){d._removeData(g,a+"queue");d._removeData(g,b)})})}});d.fn.extend({queue:function(g,a){var c=2;return"string"!=typeof g&&(a=g,g="fx",c--),c>arguments.length?d.queue(this[0],g):a===b?this:this.each(function(){var b=d.queue(this,g,a);d._queueHooks(this,g);"fx"===g&&"inprogress"!==b[0]&&d.dequeue(this,
g)})},dequeue:function(g){return this.each(function(){d.dequeue(this,g)})},delay:function(g,a){return g=d.fx?d.fx.speeds[g]||g:g,a=a||"fx",this.queue(a,function(a,b){var d=setTimeout(a,g);b.stop=function(){clearTimeout(d)}})},clearQueue:function(g){return this.queue(g||"fx",[])},promise:function(g,a){var c,h=1,e=d.Deferred(),m=this,k=this.length,f=function(){--h||e.resolveWith(m,[m])};"string"!=typeof g&&(a=g,g=b);for(g=g||"fx";k--;)(c=d._data(m[k],g+"queueHooks"))&&c.empty&&(h++,c.empty.add(f));
return f(),e.promise(a)}});var xa,va,h=/[\t\r\n]/g,m=/\r/g,u=/^(?:input|select|textarea|button|object)$/i,Xa=/^(?:a|area)$/i,Oa=/^(?:checked|selected|autofocus|autoplay|async|controls|defer|disabled|hidden|loop|multiple|open|readonly|required|scoped)$/i,Ia=/^(?:checked|selected)$/i,Ea=d.support.getSetAttribute,sb=d.support.input;d.fn.extend({attr:function(g,a){return d.access(this,d.attr,g,a,1<arguments.length)},removeAttr:function(g){return this.each(function(){d.removeAttr(this,g)})},prop:function(g,
a){return d.access(this,d.prop,g,a,1<arguments.length)},removeProp:function(a){return a=d.propFix[a]||a,this.each(function(){try{this[a]=b,delete this[a]}catch(d){}})},addClass:function(a){var b,c,t,e,m,k=0,f=this.length;b="string"==typeof a&&a;if(d.isFunction(a))return this.each(function(b){d(this).addClass(a.call(this,b,this.className))});if(b)for(b=(a||"").match(Ba)||[];f>k;k++)if(c=this[k],t=1===c.nodeType&&(c.className?(" "+c.className+" ").replace(h," "):" ")){for(m=0;e=b[m++];)0>t.indexOf(" "+
e+" ")&&(t+=e+" ");c.className=d.trim(t)}return this},removeClass:function(a){var b,c,t,e,m,k=0,f=this.length;b=0===arguments.length||"string"==typeof a&&a;if(d.isFunction(a))return this.each(function(b){d(this).removeClass(a.call(this,b,this.className))});if(b)for(b=(a||"").match(Ba)||[];f>k;k++)if(c=this[k],t=1===c.nodeType&&(c.className?(" "+c.className+" ").replace(h," "):"")){for(m=0;e=b[m++];)for(;0<=t.indexOf(" "+e+" ");)t=t.replace(" "+e+" "," ");c.className=a?d.trim(t):""}return this},toggleClass:function(a,
b){var c=typeof a,h="boolean"==typeof b;return d.isFunction(a)?this.each(function(c){d(this).toggleClass(a.call(this,c,this.className,b),b)}):this.each(function(){if("string"===c)for(var e,m=0,k=d(this),f=b,p=a.match(Ba)||[];e=p[m++];)f=h?f:!k.hasClass(e),k[f?"addClass":"removeClass"](e);else(c===A||"boolean"===c)&&(this.className&&d._data(this,"__className__",this.className),this.className=this.className||!1===a?"":d._data(this,"__className__")||"")})},hasClass:function(a){a=" "+a+" ";for(var b=
0,d=this.length;d>b;b++)if(1===this[b].nodeType&&0<=(" "+this[b].className+" ").replace(h," ").indexOf(a))return!0;return!1},val:function(a){var c,x,h,e=this[0];if(arguments.length)return h=d.isFunction(a),this.each(function(c){var z,e=d(this);1===this.nodeType&&(z=h?a.call(this,c,e.val()):a,null==z?z="":"number"==typeof z?z+="":d.isArray(z)&&(z=d.map(z,function(a){return null==a?"":a+""})),x=d.valHooks[this.type]||d.valHooks[this.nodeName.toLowerCase()],x&&"set"in x&&x.set(this,z,"value")!==b||(this.value=
z))});if(e)return x=d.valHooks[e.type]||d.valHooks[e.nodeName.toLowerCase()],x&&"get"in x&&(c=x.get(e,"value"))!==b?c:(c=e.value,"string"==typeof c?c.replace(m,""):null==c?"":c)}});d.extend({valHooks:{option:{get:function(a){var b=a.attributes.value;return!b||b.specified?a.value:a.text}},select:{get:function(a){for(var b,c=a.options,h=a.selectedIndex,e="select-one"===a.type||0>h,m=e?null:[],k=e?h+1:c.length,f=0>h?k:e?h:0;k>f;f++)if(b=c[f],!(!b.selected&&f!==h||(d.support.optDisabled?b.disabled:null!==
b.getAttribute("disabled"))||b.parentNode.disabled&&d.nodeName(b.parentNode,"optgroup"))){if(a=d(b).val(),e)return a;m.push(a)}return m},set:function(a,b){var c=d.makeArray(b);return d(a).find("option").each(function(){this.selected=0<=d.inArray(d(this).val(),c)}),c.length||(a.selectedIndex=-1),c}}},attr:function(a,c,x){var h,e,m,k=a.nodeType;if(a&&3!==k&&8!==k&&2!==k)return typeof a.getAttribute===A?d.prop(a,c,x):(e=1!==k||!d.isXMLDoc(a),e&&(c=c.toLowerCase(),h=d.attrHooks[c]||(Oa.test(c)?va:xa)),
x===b?h&&e&&"get"in h&&null!==(m=h.get(a,c))?m:(typeof a.getAttribute!==A&&(m=a.getAttribute(c)),null==m?b:m):null!==x?h&&e&&"set"in h&&(m=h.set(a,x,c))!==b?m:(a.setAttribute(c,x+""),x):(d.removeAttr(a,c),b))},removeAttr:function(a,b){var c,h,e=0,m=b&&b.match(Ba);if(m&&1===a.nodeType)for(;c=m[e++];)h=d.propFix[c]||c,Oa.test(c)?!Ea&&Ia.test(c)?a[d.camelCase("default-"+c)]=a[h]=!1:a[h]=!1:d.attr(a,c,""),a.removeAttribute(Ea?c:h)},attrHooks:{type:{set:function(a,b){if(!d.support.radioValue&&"radio"===
b&&d.nodeName(a,"input")){var c=a.value;return a.setAttribute("type",b),c&&(a.value=c),b}}}},propFix:{tabindex:"tabIndex",readonly:"readOnly","for":"htmlFor","class":"className",maxlength:"maxLength",cellspacing:"cellSpacing",cellpadding:"cellPadding",rowspan:"rowSpan",colspan:"colSpan",usemap:"useMap",frameborder:"frameBorder",contenteditable:"contentEditable"},prop:function(a,c,x){var h,e,m,k=a.nodeType;if(a&&3!==k&&8!==k&&2!==k)return m=1!==k||!d.isXMLDoc(a),m&&(c=d.propFix[c]||c,e=d.propHooks[c]),
x!==b?e&&"set"in e&&(h=e.set(a,x,c))!==b?h:a[c]=x:e&&"get"in e&&null!==(h=e.get(a,c))?h:a[c]},propHooks:{tabIndex:{get:function(a){var d=a.getAttributeNode("tabindex");return d&&d.specified?parseInt(d.value,10):u.test(a.nodeName)||Xa.test(a.nodeName)&&a.href?0:b}}}});va={get:function(a,c){var x=d.prop(a,c),h="boolean"==typeof x&&a.getAttribute(c);return(x="boolean"==typeof x?sb&&Ea?null!=h:Ia.test(c)?a[d.camelCase("default-"+c)]:!!h:a.getAttributeNode(c))&&!1!==x.value?c.toLowerCase():b},set:function(a,
b,c){return!1===b?d.removeAttr(a,c):sb&&Ea||!Ia.test(c)?a.setAttribute(!Ea&&d.propFix[c]||c,c):a[d.camelCase("default-"+c)]=a[c]=!0,c}};sb&&Ea||(d.attrHooks.value={get:function(a,c){var h=a.getAttributeNode(c);return d.nodeName(a,"input")?a.defaultValue:h&&h.specified?h.value:b},set:function(a,c,h){return d.nodeName(a,"input")?(a.defaultValue=c,b):xa&&xa.set(a,c,h)}});Ea||(xa=d.valHooks.button={get:function(a,d){var c=a.getAttributeNode(d);return c&&("id"===d||"name"===d||"coords"===d?""!==c.value:
...
d.event={global:{},add:function(a,c,h,t,e){var m,k,f,p,u,j,w,v,D;if(f=d._data(a)){h.handler&&(p=h,h=p.handler,e=p.selector);h.guid||(h.guid=d.guid++);(k=f.events)||(k=f.events={});(u=f.handle)||(u=f.handle=function(a){return typeof d===A||a&&d.event.triggered===a.type?b:d.event.dispatch.apply(u.elem,arguments)},u.elem=a);c=(c||"").match(Ba)||[""];for(f=c.length;f--;)m=Lb.exec(c[f])||[],v=j=m[1],D=(m[2]||"").split(".").sort(),m=d.event.special[v]||{},v=(e?m.delegateType:m.bindType)||v,m=d.event.special[v]||
{},j=d.extend({type:v,origType:j,data:t,handler:h,guid:h.guid,selector:e,needsContext:e&&d.expr.match.needsContext.test(e),namespace:D.join(".")},p),(w=k[v])||(w=k[v]=[],w.delegateCount=0,m.setup&&!1!==m.setup.call(a,t,D,u)||(a.addEventListener?a.addEventListener(v,u,!1):a.attachEvent&&a.attachEvent("on"+v,u))),m.add&&(m.add.call(a,j),j.handler.guid||(j.handler.guid=h.guid)),e?w.splice(w.delegateCount++,0,j):w.push(j),d.event.global[v]=!0;a=null}},remove:function(a,b,c,h,e){var m,k,f,p,u,j,w,v,A,
D,l,q=d.hasData(a)&&d._data(a);if(q&&(j=q.events)){b=(b||"").match(Ba)||[""];for(u=b.length;u--;)if(f=Lb.exec(b[u])||[],A=l=f[1],D=(f[2]||"").split(".").sort(),A){w=d.event.special[A]||{};A=(h?w.delegateType:w.bindType)||A;v=j[A]||[];f=f[2]&&RegExp("(^|\\.)"+D.join("\\.(?:.*\\.|)")+"(\\.|$)");for(p=m=v.length;m--;)k=v[m],!e&&l!==k.origType||c&&c.guid!==k.guid||f&&!f.test(k.namespace)||h&&h!==k.selector&&("**"!==h||!k.selector)||(v.splice(m,1),k.selector&&v.delegateCount--,w.remove&&w.remove.call(a,
k));p&&!v.length&&(w.teardown&&!1!==w.teardown.call(a,D,q.handle)||d.removeEvent(a,A,q.handle),delete j[A])}else for(A in j)d.event.remove(a,A+b[u],c,h,!0);d.isEmptyObject(j)&&(delete q.handle,d._removeData(a,"events"))}},trigger:function(g,c,h,t){var e,m,k,f,p,u,j=[h||F],w=G.call(g,"type")?g.type:g;u=G.call(g,"namespace")?g.namespace.split("."):[];if(k=e=h=h||F,3!==h.nodeType&&8!==h.nodeType&&!Kb.test(w+d.event.triggered)&&(0<=w.indexOf(".")&&(u=w.split("."),w=u.shift(),u.sort()),m=0>w.indexOf(":")&&
"on"+w,g=g[d.expando]?g:new d.Event(w,"object"==typeof g&&g),g.isTrigger=!0,g.namespace=u.join("."),g.namespace_re=g.namespace?RegExp("(^|\\.)"+u.join("\\.(?:.*\\.|)")+"(\\.|$)"):null,g.result=b,g.target||(g.target=h),c=null==c?[g]:d.makeArray(c,[g]),p=d.event.special[w]||{},t||!p.trigger||!1!==p.trigger.apply(h,c))){if(!t&&!p.noBubble&&!d.isWindow(h)){f=p.delegateType||w;for(Kb.test(f+w)||(k=k.parentNode);k;k=k.parentNode)j.push(k),e=k;e===(h.ownerDocument||F)&&j.push(e.defaultView||e.parentWindow||
a)}for(u=0;(k=j[u++])&&!g.isPropagationStopped();)g.type=1<u?f:p.bindType||w,(e=(d._data(k,"events")||{})[g.type]&&d._data(k,"handle"))&&e.apply(k,c),(e=m&&k[m])&&d.acceptData(k)&&e.apply&&!1===e.apply(k,c)&&g.preventDefault();if(g.type=w,!(t||g.isDefaultPrevented()||p._default&&!1!==p._default.apply(h.ownerDocument,c)||"click"===w&&d.nodeName(h,"a")||!d.acceptData(h)||!m||!h[w]||d.isWindow(h))){(e=h[m])&&(h[m]=null);d.event.triggered=w;try{h[w]()}catch(v){}d.event.triggered=b;e&&(h[m]=e)}return g.result}},
dispatch:function(a){a=d.event.fix(a);var c,h,t,e,m,k=[],f=ka.call(arguments);c=(d._data(this,"events")||{})[a.type]||[];var p=d.event.special[a.type]||{};if(f[0]=a,a.delegateTarget=this,!p.preDispatch||!1!==p.preDispatch.call(this,a)){k=d.event.handlers.call(this,a,c);for(c=0;(e=k[c++])&&!a.isPropagationStopped();){a.currentTarget=e.elem;for(m=0;(t=e.handlers[m++])&&!a.isImmediatePropagationStopped();)(!a.namespace_re||a.namespace_re.test(t.namespace))&&(a.handleObj=t,a.data=t.data,h=((d.event.special[t.origType]||
{}).handle||t.handler).apply(e.elem,f),h!==b&&!1===(a.result=h)&&(a.preventDefault(),a.stopPropagation()))}return p.postDispatch&&p.postDispatch.call(this,a),a.result}},handlers:function(a,c){var h,t,e,m,k=[],f=c.delegateCount,p=a.target;if(f&&p.nodeType&&(!a.button||"click"!==a.type))for(;p!=this;p=p.parentNode||this)if(1===p.nodeType&&(!0!==p.disabled||"click"!==a.type)){e=[];for(m=0;f>m;m++)t=c[m],h=t.selector+" ",e[h]===b&&(e[h]=t.needsContext?0<=d(h,this).index(p):d.find(h,this,null,[p]).length),
e[h]&&e.push(t);e.length&&k.push({elem:p,handlers:e})}return c.length>f&&k.push({elem:this,handlers:c.slice(f)}),k},fix:function(a){if(a[d.expando])return a;var b,c,h;b=a.type;var e=a,m=this.fixHooks[b];m||(this.fixHooks[b]=m=Tb.test(b)?this.mouseHooks:Pa.test(b)?this.keyHooks:{});h=m.props?this.props.concat(m.props):this.props;a=new d.Event(e);for(b=h.length;b--;)c=h[b],a[c]=e[c];return a.target||(a.target=e.srcElement||F),3===a.target.nodeType&&(a.target=a.target.parentNode),a.metaKey=!!a.metaKey,
...
k).slice(0)},yb=function(a){for(var b=0,c=a.length,d="";c>b;b++)d+=a[b].value;return d},Bb=function(a,b,c){var d=b.dir,h=c&&"parentNode"===d,e=cd++;return b.first?function(b,c,e){for(;b=b[d];)if(1===b.nodeType||h)return a(b,c,e)}:function(b,c,m){var x,k,z,f=Ra+" "+e;if(m)for(;b=b[d];){if((1===b.nodeType||h)&&a(b,c,m))return!0}else for(;b=b[d];)if(1===b.nodeType||h)if(z=b[ma]||(b[ma]={}),(k=z[d])&&k[0]===f){if(!0===(x=k[1])||x===Wb)return!0===x}else if(k=z[d]=[f],k[1]=a(b,c,m)||Wb,!0===k[1])return!0}},
Xb=function(a){return 1<a.length?function(b,c,d){for(var h=a.length;h--;)if(!a[h](b,c,d))return!1;return!0}:a[0]},Nb=function(a,b,c,d,h){for(var e,m=[],k=0,f=a.length,p=null!=b;f>k;k++)(e=a[k])&&(!c||c(e,d,h))&&(m.push(e),p&&b.push(k));return m},eb=function(a,b,c,d,h,e){return d&&!d[ma]&&(d=eb(d)),h&&!h[ma]&&(h=eb(h,e)),ya(function(e,m,k,f){var p,u,j=[],w=[],v=m.length,A;if(!(A=e)){A=b||"*";for(var qa=k.nodeType?[k]:k,D=[],q=0,l=qa.length;l>q;q++)Z(A,qa[q],D);A=D}A=!a||!e&&b?A:Nb(A,j,a,k,f);qa=c?
h||(e?a:v||d)?[]:m:A;if(c&&c(A,qa,k,f),d){p=Nb(qa,w);d(p,[],k,f);for(k=p.length;k--;)(u=p[k])&&(qa[w[k]]=!(A[w[k]]=u))}if(e){if(h||a){if(h){p=[];for(k=qa.length;k--;)(u=qa[k])&&p.push(A[k]=u);h(null,qa=[],p,f)}for(k=qa.length;k--;)(u=qa[k])&&-1<(p=h?hc.call(e,u):j[k])&&(e[p]=!(m[p]=u))}}else qa=Nb(qa===m?qa.splice(v,qa.length):qa),h?h(null,m,qa,f):wb.apply(m,qa)})},ic=function(a){var b,c,d,h=a.length,e=aa.relative[a[0].type];c=e||aa.relative[" "];for(var m=e?1:0,k=Bb(function(a){return a===b},c,!0),
f=Bb(function(a){return-1<hc.call(b,a)},c,!0),p=[function(a,g,c){return!e&&(c||g!==Yb)||((b=g).nodeType?k(a,g,c):f(a,g,c))}];h>m;m++)if(c=aa.relative[a[m].type])p=[Bb(Xb(p),c)];else{if(c=aa.filter[a[m].type].apply(null,a[m].matches),c[ma]){for(d=++m;h>d&&!aa.relative[a[d].type];d++);return eb(1<m&&Xb(p),1<m&&yb(a.slice(0,m-1)).replace(Ub,"$1"),c,d>m&&ic(a.slice(m,d)),h>d&&ic(a=a.slice(d)),h>d&&yb(a))}p.push(c)}return Xb(p)},yc=function(){},Cb,Wb,aa,Zb,zc,gc,Db,Yb,vb,za,Fa,La,Qa,Eb,$b,Mb,jc,ma="sizzle"+
...
j?u.defaultSelected=u.selected=e.defaultSelected:("input"===j||"textarea"===j)&&(u.defaultValue=e.defaultValue)}}}if(b)if(c){f=f||s(a);h=h||s(m);for(k=0;null!=(e=f[k]);k++)X(e,h[k])}else X(a,m);return h=s(m,"script"),0<h.length&&N(h,!p&&s(a,"script")),m},buildFragment:function(a,b,c,h){for(var e,m,k,f,p,u,j,w=a.length,v=W(b),A=[],D=0;w>D;D++)if(m=a[D],m||0===m)if("object"===d.type(m))d.merge(A,m.nodeType?[m]:m);else if(od.test(m)){f=f||v.appendChild(b.createElement("div"));p=(Hc.exec(m)||["",""])[1].toLowerCase();
j=Ja[p]||Ja._default;f.innerHTML=j[1]+m.replace(Gc,"<$1></$2>")+j[2];for(e=j[0];e--;)f=f.lastChild;if(!d.support.leadingWhitespace&&mc.test(m)&&A.push(b.createTextNode(mc.exec(m)[0])),!d.support.tbody)for(e=(m="table"!==p||Ic.test(m)?"<table>"!==j[1]||Ic.test(m)?0:f:f.firstChild)&&m.childNodes.length;e--;)d.nodeName(u=m.childNodes[e],"tbody")&&!u.childNodes.length&&m.removeChild(u);d.merge(A,f.childNodes);for(f.textContent="";f.firstChild;)f.removeChild(f.firstChild);f=v.lastChild}else A.push(b.createTextNode(m));
f&&v.removeChild(f);d.support.appendChecked||d.grep(s(A,"input"),U);for(D=0;m=A[D++];)if((!h||-1===d.inArray(m,h))&&(k=d.contains(m.ownerDocument,m),f=s(v.appendChild(m),"script"),k&&N(f),c))for(e=0;m=f[e++];)Jc.test(m.type||"")&&c.push(m);return v},cleanData:function(a,b){for(var c,h,e,m,k=0,f=d.expando,p=d.cache,u=d.support.deleteExpando,j=d.event.special;null!=(c=a[k]);k++)if((b||d.acceptData(c))&&(e=c[f],m=e&&p[e])){if(m.events)for(h in m.events)j[h]?d.event.remove(c,h):d.removeEvent(c,h,m.handle);
p[e]&&(delete p[e],u?delete c[f]:typeof c.removeAttribute!==A?c.removeAttribute(f):c[f]=null,Ca.push(e))}}});var Gb,hb,ib,oc=/alpha\([^)]*\)/i,sd=/opacity\s*=\s*([^)]*)/,td=/^(top|right|bottom|left)$/,ud=/^(none|table(?!-c[ea]).+)/,Kc=/^margin/,Wc=RegExp("^("+Da+")(.*)$","i"),Pb=RegExp("^("+Da+")(?!px)[a-z%]+$","i"),vd=RegExp("^([+-])=("+Da+")","i"),vc={BODY:"block"},wd={position:"absolute",visibility:"hidden",display:"block"},Lc={letterSpacing:0,fontWeight:400},gb=["Top","Right","Bottom","Left"],
uc=["Webkit","O","Moz","ms"];d.fn.extend({css:function(a,c){return d.access(this,function(a,c,h){var g,e={},m=0;if(d.isArray(c)){g=hb(a);for(h=c.length;h>m;m++)e[c[m]]=d.css(a,c[m],!1,g);return e}return h!==b?d.style(a,c,h):d.css(a,c)},a,c,1<arguments.length)},show:function(){return I(this,!0)},hide:function(){return I(this)},toggle:function(a){var b="boolean"==typeof a;return this.each(function(){(b?a:V(this))?d(this).show():d(this).hide()})}});d.extend({cssHooks:{opacity:{get:function(a,b){if(b){var c=
ib(a,"opacity");return""===c?"1":c}}}},cssNumber:{columnCount:!0,fillOpacity:!0,fontWeight:!0,lineHeight:!0,opacity:!0,orphans:!0,widows:!0,zIndex:!0,zoom:!0},cssProps:{"float":d.support.cssFloat?"cssFloat":"styleFloat"},style:function(a,c,h,e){if(a&&3!==a.nodeType&&8!==a.nodeType&&a.style){var m,k,f,p=d.camelCase(c),u=a.style;if(c=d.cssProps[p]||(d.cssProps[p]=K(u,p)),f=d.cssHooks[c]||d.cssHooks[p],h===b)return f&&"get"in f&&(m=f.get(a,!1,e))!==b?m:u[c];if(k=typeof h,"string"===k&&(m=vd.exec(h))&&
(h=(m[1]+1)*m[2]+parseFloat(d.css(a,c)),k="number"),!(null==h||"number"===k&&isNaN(h)||("number"!==k||d.cssNumber[p]||(h+="px"),d.support.clearCloneStyle||""!==h||0!==c.indexOf("background")||(u[c]="inherit"),f&&"set"in f&&(h=f.set(a,h,e))===b)))try{u[c]=h}catch(j){}}},css:function(a,c,h,e){var m,k,f,p=d.camelCase(c);return c=d.cssProps[p]||(d.cssProps[p]=K(a.style,p)),f=d.cssHooks[c]||d.cssHooks[p],f&&"get"in f&&(k=f.get(a,!0,h)),k===b&&(k=ib(a,c,e)),"normal"===k&&c in Lc&&(k=Lc[c]),""===h||h?(m=
parseFloat(k),!0===h||d.isNumeric(m)?m||0:k):k},swap:function(a,b,c,d){var h,e={};for(h in b)e[h]=a.style[h],a.style[h]=b[h];c=c.apply(a,d||[]);for(h in b)a.style[h]=e[h];return c}});a.getComputedStyle?(hb=function(b){return a.getComputedStyle(b,null)},ib=function(a,c,h){var e,m,k,f=(h=h||hb(a))?h.getPropertyValue(c)||h[c]:b,p=a.style;return h&&(""!==f||d.contains(a.ownerDocument,a)||(f=d.style(a,c)),Pb.test(f)&&Kc.test(c)&&(e=p.width,m=p.minWidth,k=p.maxWidth,p.minWidth=p.maxWidth=p.width=f,f=h.width,
p.width=e,p.minWidth=m,p.maxWidth=k)),f}):F.documentElement.currentStyle&&(hb=function(a){return a.currentStyle},ib=function(a,c,d){var h,e,m;d=(d=d||hb(a))?d[c]:b;var k=a.style;return null==d&&k&&k[c]&&(d=k[c]),Pb.test(d)&&!td.test(c)&&(h=k.left,e=a.runtimeStyle,m=e&&e.left,m&&(e.left=a.currentStyle.left),k.left="fontSize"===c?"1em":d,d=k.pixelLeft+"px",k.left=h,m&&(e.left=m)),""===d?"auto":d});d.each(["height","width"],function(a,c){d.cssHooks[c]={get:function(a,h,g){return h?0===a.offsetWidth&&
...
Dd=/^\/\//,Oc=/^([\w.+-]+:)(?:\/\/([^\/?#:]*)(?::(\d+)|)|)/,Pc=d.fn.load,Qc={},dc={},Rc="*/".concat("*");try{fb=ga.href}catch(Jd){fb=F.createElement("a"),fb.href="",fb=fb.href}pb=Oc.exec(fb.toLowerCase())||[];d.fn.load=function(a,c,h){if("string"!=typeof a&&Pc)return Pc.apply(this,arguments);var e,m,k,f=this,p=a.indexOf(" ");return 0<=p&&(e=a.slice(p,a.length),a=a.slice(0,p)),d.isFunction(c)?(h=c,c=b):c&&"object"==typeof c&&(k="POST"),0<f.length&&d.ajax({url:a,type:k,dataType:"html",data:c}).done(function(a){m=
...
context:!0}},ajaxSetup:function(a,b){return b?fa(fa(a,d.ajaxSettings),b):fa(d.ajaxSettings,a)},ajaxPrefilter:S(Qc),ajaxTransport:S(dc),ajax:function(a,c){function h(a,c,g,e){var m,w,t,z,x,O=c;if(2!==G){G=2;p&&clearTimeout(p);j=b;f=e||"";n.readyState=0<a?4:0;if(g){z=v;e=n;var s,F,C,r,Oa=z.contents,ga=z.dataTypes,Ta=z.responseFields;for(r in Ta)r in g&&(e[Ta[r]]=g[r]);for(;"*"===ga[0];)ga.shift(),F===b&&(F=z.mimeType||e.getResponseHeader("Content-Type"));if(F)for(r in Oa)if(Oa[r]&&Oa[r].test(F)){ga.unshift(r);
break}if(ga[0]in g)C=ga[0];else{for(r in g){if(!ga[0]||z.converters[r+" "+ga[0]]){C=r;break}s||(s=r)}C=C||s}z=C?(C!==ga[0]&&ga.unshift(C),g[C]):b}if(200<=a&&300>a||304===a)if(v.ifModified&&(x=n.getResponseHeader("Last-Modified"),x&&(d.lastModified[k]=x),x=n.getResponseHeader("etag"),x&&(d.etag[k]=x)),204===a)m=!0,O="nocontent";else if(304===a)m=!0,O="notmodified";else{var B;a:{g=v;m=z;var H,Ia;t={};x=0;O=g.dataTypes.slice();s=O[0];if(g.dataFilter&&(m=g.dataFilter(m,g.dataType)),O[1])for(H in g.converters)t[H.toLowerCase()]=
g.converters[H];for(;w=O[++x];)if("*"!==w){if("*"!==s&&s!==w){if(H=t[s+" "+w]||t["* "+w],!H)for(B in t)if(Ia=B.split(" "),Ia[1]===w&&(H=t[s+" "+Ia[0]]||t["* "+Ia[0]])){!0===H?H=t[B]:!0!==t[B]&&(w=Ia[0],O.splice(x--,0,w));break}if(!0!==H)if(H&&g["throws"])m=H(m);else try{m=H(m)}catch(R){B={state:"parsererror",error:H?R:"No conversion from "+s+" to "+w};break a}}s=w}B={state:"success",data:m}}m=B;O=m.state;w=m.data;t=m.error;m=!t}else t=O,(a||!O)&&(O="error",0>a&&(a=0));n.status=a;n.statusText=(c||
O)+"";m?q.resolveWith(A,[w,O,n]):q.rejectWith(A,[n,O,t]);n.statusCode(Xa);Xa=b;u&&D.trigger(m?"ajaxSuccess":"ajaxError",[n,v,m?w:t]);l.fireWith(A,[n,O]);u&&(D.trigger("ajaxComplete",[n,v]),--d.active||d.event.trigger("ajaxStop"))}}"object"==typeof a&&(c=a,a=b);c=c||{};var e,m,k,f,p,u,j,w,v=d.ajaxSetup({},c),A=v.context||v,D=v.context&&(A.nodeType||A.jquery)?d(A):d.event,q=d.Deferred(),l=d.Callbacks("once memory"),Xa=v.statusCode||{},O={},s={},G=0,F="canceled",n={readyState:0,getResponseHeader:function(a){var b;
if(2===G){if(!w)for(w={};b=Bd.exec(f);)w[b[1].toLowerCase()]=b[2];b=w[a.toLowerCase()]}return null==b?null:b},getAllResponseHeaders:function(){return 2===G?f:null},setRequestHeader:function(a,b){var c=a.toLowerCase();return G||(a=s[c]=s[c]||a,O[a]=b),this},overrideMimeType:function(a){return G||(v.mimeType=a),this},statusCode:function(a){var b;if(a)if(2>G)for(b in a)Xa[b]=[Xa[b],a[b]];else n.always(a[n.status]);return this},abort:function(a){a=a||F;return j&&j.abort(a),h(0,a),this}};if(q.promise(n).complete=
l.add,n.success=n.done,n.error=n.fail,v.url=((a||v.url||fb)+"").replace(Ad,"").replace(Dd,pb[1]+"//"),v.type=c.method||c.type||v.method||v.type,v.dataTypes=d.trim(v.dataType||"*").toLowerCase().match(Ba)||[""],null==v.crossDomain&&(e=Oc.exec(v.url.toLowerCase()),v.crossDomain=!(!e||e[1]===pb[1]&&e[2]===pb[2]&&(e[3]||("http:"===e[1]?80:443))==(pb[3]||("http:"===pb[1]?80:443)))),v.data&&v.processData&&"string"!=typeof v.data&&(v.data=d.param(v.data,v.traditional)),P(Qc,v,c,n),2===G)return n;(u=v.global)&&
0===d.active++&&d.event.trigger("ajaxStart");v.type=v.type.toUpperCase();v.hasContent=!Cd.test(v.type);k=v.url;v.hasContent||(v.data&&(k=v.url+=(qc.test(k)?"&":"?")+v.data,delete v.data),!1===v.cache&&(v.url=Nc.test(k)?k.replace(Nc,"$1_="+pc++):k+(qc.test(k)?"&":"?")+"_="+pc++));v.ifModified&&(d.lastModified[k]&&n.setRequestHeader("If-Modified-Since",d.lastModified[k]),d.etag[k]&&n.setRequestHeader("If-None-Match",d.etag[k]));(v.data&&v.hasContent&&!1!==v.contentType||c.contentType)&&n.setRequestHeader("Content-Type",
v.contentType);n.setRequestHeader("Accept",v.dataTypes[0]&&v.accepts[v.dataTypes[0]]?v.accepts[v.dataTypes[0]]+("*"!==v.dataTypes[0]?", "+Rc+"; q=0.01":""):v.accepts["*"]);for(m in v.headers)n.setRequestHeader(m,v.headers[m]);if(v.beforeSend&&(!1===v.beforeSend.call(A,n,v)||2===G))return n.abort();F="abort";for(m in{success:1,error:1,complete:1})n[m](v[m]);if(j=P(dc,v,c,n)){n.readyState=1;u&&D.trigger("ajaxSend",[n,v]);v.async&&0<v.timeout&&(p=setTimeout(function(){n.abort("timeout")},v.timeout));
...
c.onload(b,!0)}}}});var Sc=[],rc=/(=)\?(?=&|$)|\?\?/;d.ajaxSetup({jsonp:"callback",jsonpCallback:function(){var a=Sc.pop()||d.expando+"_"+pc++;return this[a]=!0,a}});d.ajaxPrefilter("json jsonp",function(c,h,e){var m,k,f,p=!1!==c.jsonp&&(rc.test(c.url)?"url":"string"==typeof c.data&&!(c.contentType||"").indexOf("application/x-www-form-urlencoded")&&rc.test(c.data)&&"data");return p||"jsonp"===c.dataTypes[0]?(m=c.jsonpCallback=d.isFunction(c.jsonpCallback)?c.jsonpCallback():c.jsonpCallback,p?c[p]=
c[p].replace(rc,"$1"+m):!1!==c.jsonp&&(c.url+=(qc.test(c.url)?"&":"?")+c.jsonp+"="+m),c.converters["script json"]=function(){return f||d.error(m+" was not called"),f[0]},c.dataTypes[0]="json",k=a[m],a[m]=function(){f=arguments},e.always(function(){a[m]=k;c[m]&&(c.jsonpCallback=h.jsonpCallback,Sc.push(m));f&&d.isFunction(k)&&k(f[0]);f=k=b}),"script"):b});var Fb,Ob,Ed=0,sc=a.ActiveXObject&&function(){for(var a in Fb)Fb[a](b,!0)};d.ajaxSettings.xhr=a.ActiveXObject?function(){var b;if(!(b=!this.isLocal&&
ha()))a:{try{b=new a.ActiveXObject("Microsoft.XMLHTTP");break a}catch(c){}b=void 0}return b}:ha;Ob=d.ajaxSettings.xhr();d.support.cors=!!Ob&&"withCredentials"in Ob;(Ob=d.support.ajax=!!Ob)&&d.ajaxTransport(function(c){if(!c.crossDomain||d.support.cors){var h;return{send:function(e,m){var k,f,p=c.xhr();if(c.username?p.open(c.type,c.url,c.async,c.username,c.password):p.open(c.type,c.url,c.async),c.xhrFields)for(f in c.xhrFields)p[f]=c.xhrFields[f];c.mimeType&&p.overrideMimeType&&p.overrideMimeType(c.mimeType);
c.crossDomain||e["X-Requested-With"]||(e["X-Requested-With"]="XMLHttpRequest");try{for(f in e)p.setRequestHeader(f,e[f])}catch(u){}p.send(c.hasContent&&c.data||null);h=function(a,e){var f,u,j,v;try{if(h&&(e||4===p.readyState))if(h=b,k&&(p.onreadystatechange=d.noop,sc&&delete Fb[k]),e)4!==p.readyState&&p.abort();else{v={};f=p.status;u=p.getAllResponseHeaders();"string"==typeof p.responseText&&(v.text=p.responseText);try{j=p.statusText}catch(w){j=""}f||!c.isLocal||c.crossDomain?1223===f&&(f=204):f=
v.text?200:404}}catch(A){e||m(-1,A)}v&&m(f,j,v,u)};c.async?4===p.readyState?setTimeout(h):(k=++Ed,sc&&(Fb||(Fb={},d(a).unload(sc)),Fb[k]=h),p.onreadystatechange=h):h()},abort:function(){h&&h(b,!0)}}}});var qb,bc,Fd=/^(?:toggle|show|hide)$/,Gd=RegExp("^(?:([+-])=|)("+Da+")([a-z%]*)$","i"),Hd=/queueHooks$/,Qb=[function(a,b,c){var h,e,m,k,f,p,u=this,j=a.style,v={},w=[],A=a.nodeType&&V(a);c.queue||(f=d._queueHooks(a,"fx"),null==f.unqueued&&(f.unqueued=0,p=f.empty.fire,f.empty.fire=function(){f.unqueued||
p()}),f.unqueued++,u.always(function(){u.always(function(){f.unqueued--;d.queue(a,"fx").length||f.empty.fire()})}));1===a.nodeType&&("height"in b||"width"in b)&&(c.overflow=[j.overflow,j.overflowX,j.overflowY],"inline"===d.css(a,"display")&&"none"===d.css(a,"float")&&(d.support.inlineBlockNeedsLayout&&"inline"!==ca(a.nodeName)?j.zoom=1:j.display="inline-block"));c.overflow&&(j.overflow="hidden",d.support.shrinkWrapBlocks||u.always(function(){j.overflow=c.overflow[0];j.overflowX=c.overflow[1];j.overflowY=
...
Hb={"*":[function(a,b){var c,h,e=this.createTween(a,b),m=Gd.exec(b),k=e.cur(),f=+k||0,p=1,u=20;if(m){if(c=+m[2],h=m[3]||(d.cssNumber[a]?"":"px"),"px"!==h&&f){f=d.css(e.elem,a,!0)||c||1;do p=p||".5",f/=p,d.style(e.elem,a,f+h);while(p!==(p=e.cur()/k)&&1!==p&&--u)}e.unit=h;e.start=f;e.end=m[1]?f+(m[1]+1)*c:c}return e}]};d.Animation=d.extend(ia,{tweener:function(a,b){d.isFunction(a)?(b=a,a=["*"]):a=a.split(" ");for(var c,h=0,e=a.length;e>h;h++)c=a[h],Hb[c]=Hb[c]||[],Hb[c].unshift(b)},prefilter:function(a,
...
a.outerWidth(),k=a.outerHeight(),f=c.outerHeight(),j=a[0].ownerDocument,D=j.documentElement,q=D.clientWidth+b(j).scrollLeft(),j=D.clientHeight+b(j).scrollTop(),D=c.offset();D.top+=f;D.left-=Math.min(D.left,D.left+e>q&&q>e?Math.abs(D.left+e-q):0);D.top-=Math.min(D.top,D.top+k>j&&j>k?Math.abs(k+f-0):0);return D}function n(){}function r(a){a.stopPropagation()}function l(a,b){var c=Array.prototype.slice,e=c.call(arguments,2);return function(){return a.apply(b,e.concat(c.call(arguments)))}}function q(c,
e,k,f){function j(a){a.stopPropagation&&a.stopPropagation();a.preventDefault&&a.preventDefault();a.returnValue=!1}function D(a){if(n){if(W&&9>document.documentMode&&!a.button)return q();var b=a.originalEvent.touches,d=b?b[0].pageY:a.pageY,b=Math.max(0,Math.min((b?b[0].pageX:a.pageX)-s.left,r)),d=Math.max(0,Math.min(d-s.top,C));w&&j(a);e.apply(c,[b,d,a])}}function q(){n&&(b(l).unbind(O),b(l.body).removeClass("sp-dragging"),f.apply(c,arguments));n=!1}e=e||function(){};k=k||function(){};f=f||function(){};
var l=c.ownerDocument||document,n=!1,s={},C=0,r=0,w="ontouchstart"in a,O={};O.selectstart=j;O.dragstart=j;O[w?"touchmove":"mousemove"]=D;O[w?"touchend":"mouseup"]=q;b(c).bind(w?"touchstart":"mousedown",function(a){if(!(a.which?3==a.which:2==a.button)&&!n&&!1!==k.apply(c,arguments))n=!0,C=b(c).height(),r=b(c).width(),s=b(c).offset(),b(l).bind(O),b(l.body).addClass("sp-dragging"),w||D(a),j(a)})}var Q={beforeShow:n,move:n,change:n,show:n,hide:n,color:!1,flat:!1,showInput:!0,showButtons:!1,clickoutFiresChange:!1,
...
0;d<mb.length;d++)for(var e=0;e<mb[d].length;e++)h=tinycolor(mb[d][e]).toRgbString(),c[h]=!0;for(d=0;d<b.length;d++)h=tinycolor(b[d]).toRgbString(),c.hasOwnProperty(h)||(a.push(b[d]),c[h]=!0)}return a.reverse().slice(0,L.maxSelectionSize)},n=function(){var a=B(),c=b.map(mb,function(b,c){return e(b,a,"sp-palette-row sp-palette-row-"+c)});Ga&&c.push(e(D(),a,"sp-palette-row sp-palette-row-selection"));Tb.html(c.join(""))},s=function(){if(L.showInitial){var a=Za,b=B();Kb.html(e([a,b],b,"sp-palette-row-initial"))}},
C=function(){(0===ea||0===ba||0===na)&&K();m.addClass(wa)},F=function(){m.removeClass(wa)},w=function(){var a=tinycolor(Pa.val());a.ok?d(a):Pa.addClass("sp-validation-error")},O=function(){ja?H():G()},G=function(){if(ja)K();else if(!1!==E.beforeShow(B())){for(var c=0;c<T.length;c++)T[c]&&T[c].hide();ja=!0;b(xa).bind("click.spectrum",H);b(a).bind("resize.spectrum",fa);Aa.addClass("sp-active");m.show();L.showPalette&&n();K();S();Za=B();s();E.show(Za)}},H=function(c){if((!c||!("click"==c.type&&2==c.button))&&
...
c=a;var l=0,n=0,r=0;a=1;var B=!1,y=!1;if("string"==typeof c)a:{c=c.replace(C,"").replace(R,"").toLowerCase();var N=!1;if(ja[c])c=ja[c],N=!0;else if("transparent"==c){c={r:0,g:0,b:0,a:0};break a}c=(b=D.rgb.exec(c))?{r:b[1],g:b[2],b:b[3]}:(b=D.rgba.exec(c))?{r:b[1],g:b[2],b:b[3],a:b[4]}:(b=D.hsl.exec(c))?{h:b[1],s:b[2],l:b[3]}:(b=D.hsla.exec(c))?{h:b[1],s:b[2],l:b[3],a:b[4]}:(b=D.hsv.exec(c))?{h:b[1],s:b[2],v:b[3]}:(b=D.hex6.exec(c))?{r:parseInt(b[1],16),g:parseInt(b[2],16),b:parseInt(b[3],16),format:N?
"name":"hex"}:(b=D.hex3.exec(c))?{r:parseInt(b[1]+""+b[1],16),g:parseInt(b[2]+""+b[2],16),b:parseInt(b[3]+""+b[3],16),format:N?"name":"hex"}:!1}"object"==typeof c&&(c.hasOwnProperty("r")&&c.hasOwnProperty("g")&&c.hasOwnProperty("b")?(l=255*I(c.r,255),n=255*I(c.g,255),r=255*I(c.b,255),B=!0,y="rgb"):c.hasOwnProperty("h")&&c.hasOwnProperty("s")&&c.hasOwnProperty("v")?(y=c.h,n=c.s,r=c.v,y=6*I(y,360),n=I(n,100),r=I(r,100),l=L.floor(y),B=y-l,y=r*(1-n),b=r*(1-B*n),B=r*(1-(1-B)*n),N=l%6,l=255*[r,b,y,y,B,
r][N],n=255*[B,r,r,b,y,y][N],r=255*[y,y,B,r,r,b][N],B=!0,y="hsv"):c.hasOwnProperty("h")&&(c.hasOwnProperty("s")&&c.hasOwnProperty("l"))&&(l=c.h,y=c.s,r=c.l,n=function(a,b,c){0>c&&(c+=1);1<c&&(c-=1);return c<1/6?a+6*(b-a)*c:0.5>c?b:c<2/3?a+6*(b-a)*(2/3-c):a},l=I(l,360),y=I(y,100),r=I(r,100),0===y?y=r=b=r:(b=0.5>r?r*(1+y):r+y-r*y,B=2*r-b,y=n(B,b,l+1/3),r=n(B,b,l),b=n(B,b,l-1/3)),l=255*y,n=255*r,r=255*b,B=!0,y="hsl"),c.hasOwnProperty("a")&&(a=c.a));l=S(255,P(l,0));n=S(255,P(n,0));r=S(255,P(r,0));1>l&&
(l=H(l));1>n&&(n=H(n));1>r&&(r=H(r));b=B;c=c&&c.format||y;e=l;f=n;q=r;var w=ha(a);return{ok:b,format:c,_tc_id:ca++,alpha:w,toHsv:function(){var a=K(e,f,q);return{h:a.h,s:a.s,v:a.v,a:w}},toHsvString:function(){var a=K(e,f,q),b=H(360*a.h),c=H(100*a.s),a=H(100*a.v);return 1==w?"hsv("+b+", "+c+"%, "+a+"%)":"hsva("+b+", "+c+"%, "+a+"%, "+w+")"},toHsl:function(){var a=U(e,f,q);return{h:a.h,s:a.s,l:a.l,a:w}},toHslString:function(){var a=U(e,f,q),b=H(360*a.h),c=H(100*a.s),a=H(100*a.l);return 1==w?"hsl("+
b+", "+c+"%, "+a+"%)":"hsla("+b+", "+c+"%, "+a+"%, "+w+")"},toHex:function(){return V(e,f,q)},toHexString:function(a){return"#"+V(e,f,q,a)},toRgb:function(){return{r:H(e),g:H(f),b:H(q),a:w}},toRgbString:function(){return 1==w?"rgb("+H(e)+", "+H(f)+", "+H(q)+")":"rgba("+H(e)+", "+H(f)+", "+H(q)+", "+w+")"},toName:function(){return k[V(e,f,q)]||!1},toFilter:function(a,b){var c=V(e,f,q,!0),d=c,k=Math.round(255*ha(w)).toString(16),p=k,v=a&&a.gradientType?"GradientType = 1, ":"";b&&(p=s(b),d=p.toHex(),
p=Math.round(255*ha(p.alpha)).toString(16));return"progid:DXImageTransform.Microsoft.gradient("+v+"startColorstr=#"+j(k)+c+",endColorstr=#"+j(p)+d+")"},toString:function(a){a=a||this.format;var b=!1;"rgb"===a&&(b=this.toRgbString());"hex"===a&&(b=this.toHexString());"hex6"===a&&(b=this.toHexString(!0));"name"===a&&(b=this.toName());"hsl"===a&&(b=this.toHslString());"hsv"===a&&(b=this.toHsvString());return b||this.toHexString(!0)}}},U=function(a,b,c){a=I(a,255);b=I(b,255);c=I(c,255);var e=P(a,b,c),
...
q(y.paragraph)("(?!","(?!"+y.gfm.fences.source.replace(/(^|[^\[])\^/g,"$2")+"|")();y.lexer=function(a){var b=[];b.links={};a=a.replace(/\r\n|\r/g,"\n").replace(/\t/g,"    ");return y.token(a,b,!0)};y.token=function(a,b,c){a=a.replace(/^ +$/gm,"");for(var e,f,l,n,q,s;a;){if(l=y.newline.exec(a))a=a.substring(l[0].length),1<l[0].length&&b.push({type:"space"});if(l=y.code.exec(a))a=a.substring(l[0].length),l=l[0].replace(/^ {4}/gm,""),b.push({type:"code",text:!V.pedantic?l.replace(/\n+$/,""):l});else if(l=
...
b,c),b.push({type:"blockquote_end"});else if(l=y.list.exec(a)){a=a.substring(l[0].length);b.push({type:"list_start",ordered:isFinite(l[2])});l=l[0].match(y.item);e=!1;s=l.length;for(q=0;q<s;q++)n=l[q],f=n.length,n=n.replace(/^ *([*+-]|\d+\.) +/,""),~n.indexOf("\n ")&&(f-=n.length,n=!V.pedantic?n.replace(RegExp("^ {1,"+f+"}","gm"),""):n.replace(/^ {1,4}/gm,"")),f=e||/\n\n(?!\s*$)/.test(n),q!==s-1&&(e="\n"===n[n.length-1],f||(f=e)),b.push({type:f?"loose_item_start":"list_item_start"}),y.token(n,b),
...
b=0;b<a;b++)bb[b][0].detachEvent(bb[b][1],bb[b][2]);a=Ba.length;for(b=0;b<a;b++)F(Ba[b]);for(var c in E)E[c]=null;E=null;for(var d in fa)fa[d]=null;fa=null});fa={registerObject:function(a,b,c,d){if(E.w3&&a&&b){var e={};e.id=a;e.swfVersion=b;e.expressInstall=c;e.callbackFn=d;Da[Da.length]=e;sa(a,!1)}else d&&d({success:!1,id:a})},getObjectById:function(a){if(E.w3)return Y(a)},embedSWF:function(a,b,c,d,e,f,j,l,w,n){var q={success:!1,id:b};E.w3&&!(E.wk&&312>E.wk)&&a&&b&&c&&d&&e?(sa(b,!1),ja(function(){c+=
"";d+="";var p={};if(w&&typeof w===ta)for(var s in w)p[s]=w[s];p.data=a;p.width=c;p.height=d;s={};if(l&&typeof l===ta)for(var r in l)s[r]=l[r];if(j&&typeof j===ta)for(var O in j)s.flashvars=typeof s.flashvars!=da?s.flashvars+("&"+O+"="+j[O]):O+"="+j[O];if($a(e))r=A(p,s,b),p.id==b&&sa(b,!0),q.success=!0,q.ref=r;else{if(f&&k()){p.data=f;D(p,s,b,n);return}sa(b,!0)}n&&n(q)})):n&&n(q)},switchOffAutoHideShow:function(){Sb=!1},ua:E,getFlashPlayerVersion:function(){return{major:E.pv[0],minor:E.pv[1],release:E.pv[2]}},
...
case "Z":case "ZZ":return v;case "T":return A;case "MM":case "DD":case "YY":case "HH":case "hh":case "mm":case "ss":case "M":case "D":case "d":case "H":case "h":case "m":case "s":return ia;default:return RegExp(a.replace("\\",""))}}function s(a,b){var c=[0,0,1,0,0,0,0],e={tzh:0,tzm:0},d=b.match(fa),f,j;for(f=0;f<d.length;f++)if((j=(X(d[f]).exec(a)||[])[0])&&(a=a.slice(a.indexOf(j)+j.length)),ka[d[f]]){var k=c,l=e,n=void 0,q=void 0;switch(d[f]){case "M":case "MM":k[1]=null==j?0:~~j-1;break;case "MMM":case "MMMM":for(n=
0;12>n;n++)if(B().monthsParse[n].test(j)){k[1]=n;q=!0;break}q||(k[8]=!1);break;case "D":case "DD":case "DDD":case "DDDD":null!=j&&(k[2]=~~j);break;case "YY":k[0]=~~j+(70<~~j?1900:2E3);break;case "YYYY":k[0]=~~Math.abs(j);break;case "a":case "A":l.isPm="pm"===(j+"").toLowerCase();break;case "H":case "HH":case "h":case "hh":k[3]=~~j;break;case "m":case "mm":k[4]=~~j;break;case "s":case "ss":k[5]=~~j;break;case "S":case "SS":case "SSS":k[6]=~~(1E3*("0."+j));break;case "Z":case "ZZ":l.isUTC=!0,(n=(j+
"").match($a))&&n[1]&&(l.tzh=~~n[1]),n&&n[2]&&(l.tzm=~~n[2]),n&&"+"===n[0]&&(l.tzh=-l.tzh,l.tzm=-l.tzm)}null==j&&(k[8]=!1)}return e.isPm&&12>c[3]&&(c[3]+=12),!1===e.isPm&&12===c[3]&&(c[3]=0),W(c,e.isUTC,e.tzh,e.tzm)}function U(a,b,c,e,d){d=d.relativeTime[a];return"function"==typeof d?d(b||1,!!c,a,e):d.replace(/%d/i,b||1)}function K(a,b){j.fn[a]=function(a){var c=this._isUTC?"UTC":"";return null!=a?(this._d["set"+c+b](a),this):this._d["get"+c+b]()}}function V(a){j.duration.fn[a]=function(){return this._data[a]}}
...
c){if(null===b||""===b)return null;var e;if(j.isMoment(b))e=new f(new Date(+b._d),b._isUTC,b._lang);else{if(c)if(Q(c)){var k=b.match(ja)||[],d,l=99,n,q;for(n=0;n<c.length;n++)q=s(b,c[n]),d=N(new f(q),c[n]).match(ja)||[],d=T(k,d),d<l&&(l=d,e=q)}else e=s(b,c);else if(e=P.exec(b),b===a)e=new Date;else if(e)e=new Date(+e[1]);else if(b instanceof Date)e=b;else if(Q(b))e=W(b);else if("string"==typeof b)if(e="YYYY-MM-DDT",F.exec(b)){for(k=0;4>k;k++)if(ga[k][1].exec(b)){e+=ga[k][0];break}e=v.exec(b)?s(b,
e+" Z"):s(b,e)}else e=new Date(b);else e=new Date(b);e=new f(e)}return e};j.utc=function(a,b){return Q(a)?new f(W(a,!0),!0):("string"==typeof a&&!v.exec(a)&&(a+=" +0000",b&&(b+=" Z")),j(a,b).utc())};j.unix=function(a){return j(1E3*a)};j.duration=function(a,b){var c=j.isDuration(a),e="number"==typeof a,d=c?a._data:e?{}:a,f;return e&&(b?d[b]=a:d.milliseconds=a),f=new n(d),c&&(f._lang=a._lang),f};j.humanizeDuration=function(a,b,c){return j.duration(a,!0===b?null:b).humanize(!0===b?!0:c)};j.version="1.7.2";
...
338241895,666307205,773529912,1294757372,1396182291,1695183700,1986661051,2177026350,2456956037,2730485921,2820302411,3259730800,3345764771,3516065817,3600352804,4094571909,275423344,430227734,506948616,659060556,883997877,958139571,1322822218,1537002063,1747873779,1955562222,2024104815,2227730452,2361852424,2428436474,2756734187,3204031479,3329325298],l=[1779033703,3144134277,1013904242,2773480762,1359893119,2600822924,528734635,1541459225],n=Array(64),r,N,X,s,U,K,V,I,j,C,R,ca;a[b>>5]|=128<<24-b%
32;a[(b+64>>9<<4)+15]=b;for(j=0;j<a.length;j+=16){r=l[0];N=l[1];X=l[2];s=l[3];U=l[4];K=l[5];V=l[6];I=l[7];for(C=0;64>C;C++)n[C]=16>C?a[C+j]:c(c(c(e(n[C-2],17)^e(n[C-2],19)^n[C-2]>>>10,n[C-7]),e(n[C-15],7)^e(n[C-15],18)^n[C-15]>>>3),n[C-16]),R=c(c(c(c(I,e(U,6)^e(U,11)^e(U,25)),U&K^~U&V),f[C]),n[C]),ca=c(e(r,2)^e(r,13)^e(r,22),r&N^r&X^N&X),I=V,V=K,K=U,U=c(s,R),s=X,X=N,N=r,r=c(R,ca);l[0]=c(r,l[0]);l[1]=c(N,l[1]);l[2]=c(X,l[2]);l[3]=c(s,l[3]);l[4]=c(U,l[4]);l[5]=c(K,l[5]);l[6]=c(V,l[6]);l[7]=c(I,l[7])}return l},
n=function(a){for(var c=[],e=(1<<b)-1,f=0;f<a.length*b;f+=b)c[f>>5]|=(a.charCodeAt(f/b)&e)<<24-f%32;return c},r=function(a){for(var b="",c=0;c<4*a.length;c++)b+="0123456789abcdef".charAt(a[c>>2]>>8*(3-c%4)+4&15)+"0123456789abcdef".charAt(a[c>>2]>>8*(3-c%4)&15);return b},l=function(b){return b="object"==typeof b?a(b).val():b.toString()};a.extend({sha256:function(a){a=l(a);return r(f(n(a),a.length*b))},sha256hmac:function(a,c){a=l(a);c=l(c);var e,W=a;e=c;var y=n(W);16<y.length&&(y=f(y,W.length*b));
for(var B=Array(16),W=Array(16),N=0;16>N;N++)B[N]=y[N]^909522486,W[N]=y[N]^1549556828;e=f(B.concat(n(e)),512+e.length*b);e=f(W.concat(e),768);return r(e)},sha256config:function(a){b=parseInt(a)||8}});a.fn.sha256=function(b){a.sha256config(b);b=l(a(this).val());b=a.sha256(b);a.sha256config(8);return b}})(jQuery);
...
Element.prototype.html=function(a){this.content+=a};Element.prototype.toHtml=function(){var a="<"+this.tag,b;for(b in this.attrs)this.attrs.hasOwnProperty(b)&&(a+=" "+b+'="'+this.attrs[b]+'"');a+=">"+this.content;return a+="</"+this.tag+">"};
...
Scrap.prototype.loop=function(a){if(!this.values.loop||!this.values.scraps)return null;var b=this.values.scraps.toString(),c=this.values.loop;"string"===typeof c&&c.match(/\{\{/)&&(c=Scrap.getPointer(c.replace(/\{|\}/g,""),a));"string"===typeof c&&(c=this.values.loop.split(/ /g));if(!c)return null;c instanceof Space||(c=new Space(c));var e="";c.each(function(c,n){var r={key:c,value:n},l=b.replace(/\{\{([_a-z0-9\.]+)\}\}/gi,function(b,c){var e;return(e=Scrap.getPointer(c,r))?e:Scrap.getPointer(c,a)});
...
var Thumbs={getDimensions:function(a){var b={},c=!1;$(a).contents().find(".scrap").each(function(){var a,f,n,r;c?(a=$(this).position().left,f=a+$(this).outerWidth(),n=$(this).position().top,r=top+$(this).outerHeight(),a<b.left&&(b.left=a),f>b.right&&(b.right=f),n<b.top&&(b.top=n),r>b.bottom&&(b.bottom=r)):(b.left=$(this).position().left,b.right=b.left+$(this).outerWidth(),b.top=$(this).position().top,b.bottom=b.top+$(this).outerHeight(),c=!0)});b.height=b.bottom-b.top;b.width=b.right-b.left;return b},
...
nudgepad.navigation.openAppFromQueryString();$("#nudgepadLoadingScreen").hide();$(document).on("dragstart","img",function(a){a.preventDefault()});nudgepad.explorer.downloadTimelines();nudgepad.trigger("main");mixpanel.track("I opened NudgePad");nudgepad.query.newSite&&!store.get("opens")&&(store.set("opens",1),mixpanel.track("I created a new website"));nudgepad.updateRoom();a&&a()})},emit:function(a,b){if(nudgepad.isTesting)return null;nudgepad.socket.emit(a,b.toString(),function(a){console.log(a)})},
off:function(){},on:function(a,b){nudgepad.event_handlers[a].push(b)},quit:function(){$(".scrap,.nudgepad").remove()},trigger:function(a,b){for(var c in nudgepad.event_handlers[a])nudgepad.event_handlers[a][c](b)}};nudgepad.apps.account=new App("account");nudgepad.apps.account.onopen=function(){$(".nudgepad#email").val(nudgepad.cookie.email)};
...
function(a){a.stopPropagation()});var n=$('<div id="nudgepadEditorSaveButton">Send</div>'),r=$('<div id="nudgepadEditorCancelButton">Close</div>'),l=$('<div id="nudgepadEditorButtonContainer"></div>');f.on("click",function(){r.trigger("click")});r.on("click",function(){n.remove();a.remove();f.remove();l.remove();r.remove();e.remove();c.remove();b.remove()});n.on("click",function(){var e=b.val(),f="nudgepad.console";c.is(":checked")&&(f="nudgepad.exec");$.post(f,{command:e},function(c){a.append(">"+
e.replace(/\n/g,"> \n")+"\n");a.append(c+"\n");a.scrollTop($("pre")[0].scrollHeight+"");b.val("");b.focus()},null,function(c){mixpanel.track("I used the console and got an error");a.append(">"+e.replace(/\n/g,"> \n")+"\n");a.append("ERROR\n");a.append(c.responseText+"\n");a.scrollTop($("pre")[0].scrollHeight+"");b.val("");b.focus()})});b.on("enterkey",function(){n.click()});$("body").append(f);$("body").append(c);$("body").append(e);$("body").append(a);$("body").append(b);$("body").append(n);$("body").append(r);
...
"content",n=e.values.tag;if(n&&n.match(/^(list)$/))return nudgepad.stage.selection.clear(),c.selectMe(),nudgepad.stage.selection.editSource(),!1;n&&n.match(/^(textarea|input|password)$/)&&(f="placeholder");nudgepad.textPrompt("Editing content for this block",e.values[f],function(a){e.values[f]=a;nudgepad.stage.commit();c.remove();$("#nudgepadStageBody").append(e.toHtml(null,!0));c.selectMe()})}};nudgepad.contentEditor.killEvent=function(){nudgepad.mouse.down.stopPropagation();return!1};
...
Grid.prototype.getDelta=function(a){this.eraseSnaplines();var b={},c=[],e=[],f;for(f in a){var n=a[f],r;for(r in this.points)if(this.points.hasOwnProperty(r)){var l=this.points[r],q=l.x-n.x,Q=l.y-n.y;b.x||(b.x=q,b.y=Q);Math.abs(q)<=Math.abs(b.x)&&(b.x=q,c=[n,l]);Math.abs(Q)<=Math.abs(b.y)&&(b.y=Q,e=[n,l])}}a=Math.abs(b.x)<this.radius;f=Math.abs(b.y)<this.radius;a||(b.x=0);f||(b.y=0);a&&(c[0]={x:c[0].x+b.x,y:c[0].y+b.y},this.drawSnapline(c[0],c[1]));f&&(e[0]={x:e[0].x+b.x,y:e[0].y+b.y},this.drawSnapline(e[0],
...
nudgepad.StretchHandle.create=function(a,b,c,e){var f=a.element(),n="fixed"==f.css("position")?"fixed":"absolute",r=("top"==b?"n":"bottom"==b?"s":"")+("left"==c?"w":"right"==c?"e":""),l=$("<div></div>");l.attr("value",a.getPath());l.addClass("handle stretch_handle stretch_handle_"+a.id+" "+a.id+"_handle");l.attr("id","stretch_handle_"+b+c+a.id);l.css({cursor:r+"-resize",position:n,width:"5px",height:"5px",border:"1px solid rgba(0, 0, 0, .5)","background-color":"rgba(255, 255, 255, 0.5)","z-index":"50"});
...
$(this).parent().offset().top,l=nudgepad.StretchHandle.getLength(f,n,r,l,"center"!=c,"middle"!=b),r=a.scrap();"center"!=c&&(r.set("style left",(0<=l.x?f:l.x+f)+"px"),c=a.outerWidth()-a.width(),r.set("style width",Math.abs(l.x)-c+"px"));e?(b=parseFloat(r.get("style width"))/nudgepad.StretchHandle.originalWidth,r.set("style height",Math.round(nudgepad.StretchHandle.originalHeight*b)+"px")):"middle"!=b&&(0<=l.y?r.set("style top",n+"px"):r.set("style top",l.y+n+"px"),b=a.outerHeight()-a.height(),r.set("style height",
...
f.on("tap",function(){$("div").removeClass("selectedEditorOption");$(this).addClass("selectedEditorOption");n.hide();T.hide();a.get("style")&&B.val(a.get("style"));B.show();return!1});c.append(f);var n=$('<div id="blockContainer"></div>');e.append(n);var r=$(".selection").css("background-color"),c=$('<div class="colorBackground"><input type="text" class="colorPicker"></div>');n.append(c);c=$('<div class="editorButton"><img src="/nudgepad/images/dup_lt.png"></div>');c.on("click",function(){nudgepad.stage.selection.duplicate()});
n.append(c);c=$('<div class="editorButton"><img src="/nudgepad/images/lock_lt.png"></div>');c.on("tap",function(){nudgepad.stage.selection.patch("locked true");N.trigger("click");return!1});n.append(c);var l=$('<select id="nudgepadLinkSelect"></select>'),c=$("<option>No link</option>");c.on("click",function(){nudgepad.stage.selection.patch("href ")});l.append(c);_.each(site.values.pages.values,function(a,b){var c=$('<option value="'+b+'">'+ToProperCase(b)+"</option>");c.on("click",function(){nudgepad.stage.selection.patch("tag a\nhref "+
...
a&&nudgepad.stage.selection.patch("tag a\nhref "+a)});l.append(c);l.css({display:"none",position:"absolute","z-index":"100000"});l.attr("size",l.find("option").length);l.on("click",function(){l.hide();return!1});n.append(l);c=$('<div class="editorButton"><img src="/nudgepad/images/link_lt.png"></div>');c.on("tap",function(){l.css({left:$(this).position().left,top:$(this).position().top});l.show();return!1});n.append(c);c=$('<div class="editorButton"><img src="/nudgepad/images/up_lt.png" title="Order Up"></div>');
c.on("tap",function(){a.moveUp();B.val(a.get("style"));return!1});n.append(c);c=$('<div class="editorButton"><img src="/nudgepad/images/down_lt.png" title="Order Down"></div>');c.on("tap",function(){a.moveDown();B.val(a.get("style"));return!1});n.append(c);var q=$('<div class="clear"></div>');n.append(q);c=$('<div class="columnLeft"></div>');n.append(c);f=$('<div class="editorHeader">Curve</div>');c.append(f);f=$('<div id="roundessOne" class="toolButton toolButtonOne">0</div>');f.on("click",function(){nudgepad.stage.selection.cssPreview("border-radius 0px 0px 0px 0px");
...
nudgepad.textPrompt=function(a,b,c,e,f){var n=$('<textarea id="nudgepadEditorTextarea" class="nudgepad"></textarea>');n.val(b);var r=$('<div id="nudgepadEditorModalScreen" class="nudgepad"/>');r.on("tap mousedown click slide slidestart slideend mouseup",function(a){a.stopPropagation()});n.on("tap mousedown click slide slidestart slideend mouseup",function(a){a.stopPropagation()});if(e)n.on("keypress",e);var l=$('<div id="nudgepadEditorSaveButton" class="nudgepad">'+(f||"Save")+"</div>"),q=$('<div id="nudgepadEditorCancelButton" class="nudgepad">Cancel</div>'),
Q=$('<div id="nudgepadEditorButtonContainer" class="nudgepad"></div>');r.on("click",function(){q.trigger("click")});q.on("click",function(){l.remove();n.remove();r.remove();Q.remove();q.remove()});l.on("click",function(){c&&c(n.val());l.remove();n.remove();r.remove();Q.remove();q.remove()});$("body").append(r);$("body").append(n);$("body").append(l);$("body").append(q);$("body").append(Q);n.focus()};
/**
