...
nudgepad.invite.prompt=function(){var a=prompt("Invite people to edit this site. Add one or more emails, separated by spaces","");if(!a)return!1;$.post("/nudgepad.invite",{emails:a},function(){nudgepad.notify("Invite Sent");mixpanel.track("I invited "+a.match(/ /g).length+" people")})};nudgepad.isIOS=function(){return null!=navigator.userAgent.match(/iPad|iPhone|iPod/i)};
...
console.log(b);Events.slide.target=$("#stretch_handle_bottomright"+b);$("#stretch_handle_bottomright"+b).triggerHandler("mousedown");$("#stretch_handle_bottomright"+b).triggerHandler("slidestart");mixpanel.track("I used the pen tool")};nudgepad.on("main",function(){$(document).on("slidestart",nudgepad.pen.draw)});nudgepad.popup={};nudgepad.popup.openPopup=!1;
