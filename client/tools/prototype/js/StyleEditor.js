Prototype.styleEditor = {}
Prototype.styleEditor.livePreviewScrap = false
Prototype.styleEditor.livePreviewTimeout = false
Prototype.styleEditor.livePreviewStart = function () {
  clearTimeout(Prototype.styleEditor.livePreviewTimeout)
  Prototype.styleEditor.livePreviewTimeout = setTimeout('Prototype.styleEditor.livePreview()', 500)
}
Prototype.styleEditor.livePreview = function () {
  var text_area = $('#PrototypeStyleEditorCssEditor')
  var scrap = Prototype.styleEditor.livePreviewScrap
  scrap.set('style', new Space(text_area.val()))
  scrap.element().attr('style', '').css(scrap.get('style').values)
}

Prototype.styleEditor.edit = function (scrap) {
  
  $('.handle').remove()
  
  // Insert Modal
  var modal_screen = $('<div id="PrototypeStyleEditorModal"/>')
  ...
  // width 295px
  // height 320px
  var styleEditor = $('<div id="PrototypeStyleEditor"></div>')
  ...
  // Insert top bar
  var top_edit_bar = $('<div id="PrototypeStyleEditorTopBar"></div>')
   ...
   */
   ...
   duplicate.on("click", function(){
     Prototype.stage.selection.duplicate();
   })
   ...
   lock.on('tap', function () {
     Prototype.stage.selection.patch('locked true')
     save_button.trigger('click')
     return false
   })
   ...
   noLink.on('click', function () {
     Prototype.stage.selection.patch('href ')
   })
   ...
   _.each(Project.values.pages.values, function (value, name) {
     ...
     link.on('click', function () {
       Prototype.stage.selection.patch('tag a\nhref ' + $(this).attr('value'))
     })
   ...
   newPageLink.on('click', function () {
     var linkUrl = prompt('Enter the name of your new page', Prototype.nextName(Prototype.stage.activePage))
     if (linkUrl) {
       linkUrl = Permalink(linkUrl)
       Prototype.stage.selection.patch('tag a\nhref ' + linkUrl)
       save_button.trigger('click')
       var currentPage = Prototype.stage.activePage
       Prototype.duplicatePage(null, linkUrl, true)
       Prototype.stage.open(currentPage)
     }
   })
  ...
  buttonRoundness1.on('click', function () {
    Prototype.stage.selection.cssPreview('border-radius 0px 0px 0px 0px')
  ...
  buttonRoundness2.on('tap', function () {
    Prototype.stage.selection.cssPreview('border-radius 4px 4px 4px 4px')
    Prototype.stage.commit()
    $('.handle').trigger('update')
    return false
  })
  ...
  buttonRoundness3.on('tap', function () {
    Prototype.stage.selection.cssPreview('border-radius 10px 10px 10px 10px')
    Prototype.stage.commit()
    $('.handle').trigger('update')
    return false
  })
  ...
  buttonRoundness4.on('tap', function () {
    Prototype.stage.selection.cssPreview('border-radius 50px 50px 50px 50px')
    Prototype.stage.commit()
    $('.handle').trigger('update')
    return false
  })
  ...
  buttonBorder2.on('tap', function () {
    Prototype.stage.selection.cssPreview('border none')
    Prototype.stage.commit()
    $('.handle').trigger('update')
    return false
  })
  ...
  buttonBorder3.on('tap', function () {
    Prototype.stage.selection.cssPreview('border 1px solid ' + currentBorderColor)
    Prototype.stage.commit()
    $('.handle').trigger('update')
    return false
  })
  ...
  buttonBorder4.on('tap', function () {
    Prototype.stage.selection.cssPreview('border 5px solid ' + currentBorderColor)
    Prototype.stage.commit()
    $('.handle').trigger('update')
    return false
  })
  ...
  buttonOpacity1.on('tap', function () {
    Prototype.stage.selection.cssPreview('opacity 1')
    Prototype.stage.commit()
    $('.handle').trigger('update')
    return false
  })
  ...
  buttonOpacity2.on('tap', function () {
    Prototype.stage.selection.cssPreview('opacity .8')
    Prototype.stage.commit()
    $('.handle').trigger('update')
    return false
  })
  ...
  buttonOpacity3.on('tap', function () {
    Prototype.stage.selection.cssPreview('opacity .5')
    Prototype.stage.commit()
    $('.handle').trigger('update')
    return false
  })
  ...
  buttonOpacity4.on('tap', function () {
    Prototype.stage.selection.cssPreview('opacity .2')
    Prototype.stage.commit()
    $('.handle').trigger('update')
    return false
  })
  ...
  buttonShadow1.on('tap', function () {
    Prototype.stage.selection.cssPreview('box-shadow none')
    Prototype.stage.commit()
    $('.handle').trigger('update')
    return false
  })
  ...
  buttonShadow2.on('tap', function () {
    Prototype.stage.selection.cssPreview('box-shadow 0px 1px 3px rgba(0,0,0,.6)')
    Prototype.stage.commit()
    $('.handle').trigger('update')
    return false
  })
  ...
  buttonShadow3.on('tap', function () {
    Prototype.stage.selection.cssPreview('box-shadow inset 0px 1px 3px rgba(0,0,0,.6)')
    Prototype.stage.commit()
    $('.handle').trigger('update')
    return false
  })
  ...
  buttonShadow4.on('tap', function () {
    Prototype.stage.selection.cssPreview('box-shadow 0px 0px 0px 4px rgba(0,0,0,.2)')
    Prototype.stage.commit()
    $('.handle').trigger('update')
    return false
  })
  ...
  // Insert text editor
  var textEditorContainer = $('<div id="PrototypeStyleEditorTextEditor"></div>')
  ...
  buttonFontFamily.on('change', function () {
    ...
    Prototype.stage.selection.cssPreview('font-family ' + currentFont)
    Prototype.stage.commit()
    $('.handle').trigger('update')
    return false
  })
  ...
  buttonFontSize.on('change', function () {
    ...
    Prototype.stage.selection.cssPreview('font-size ' + currentFontSize + 'px')
    Prototype.stage.commit()
    $('.handle').trigger('update')
    return false
  })
  ...
  buttonResize.on('click', function () {
    Prototype.stage.selection.cssPreview({
    "width" : "auto",
    "height" : "auto"
    })
    Prototype.stage.commit()
  ...
  buttonAlignment1.on('click', function () {
    Prototype.stage.selection.cssPreview('text-align left')
    Prototype.stage.commit()
    $('.handle').trigger('update')
    return false
  })
  ...
  buttonAlignment2.on('click', function () {
    Prototype.stage.selection.cssPreview('text-align center')
    Prototype.stage.commit()
    $('.handle').trigger('update')
    return false
  })
  ...
  buttonAlignment3.on('click', function () {
    Prototype.stage.selection.cssPreview('text-align right')
    Prototype.stage.commit()
    $('.handle').trigger('update')
    return false
  })
  ...
  buttonAlignment4.on('click', function () {
    Prototype.stage.selection.cssPreview('text-align justify')
    Prototype.stage.commit()
    $('.handle').trigger('update')
    return false
  })
  ...
  buttonPadding1.on('click', function () {
    Prototype.stage.selection.cssPreview('padding 0px')
    Prototype.stage.commit()
    $('.handle').trigger('update')
    return false
  })
  ...
  buttonPadding2.on('click', function () {
    Prototype.stage.selection.cssPreview('padding 10px')
    Prototype.stage.commit()
    $('.handle').trigger('update')
    return false
  })
  ...
  buttonPadding3.on('click', function () {
    Prototype.stage.selection.cssPreview('padding 20px')
    Prototype.stage.commit()
    $('.handle').trigger('update')
    return false
  })
  ...
  buttonPadding4.on('click', function () {
    Prototype.stage.selection.cssPreview('padding 40px')
    Prototype.stage.commit()
    $('.handle').trigger('update')
    return false
  })
  ...
  buttonLineHeight1.on('click', function () {
    Prototype.stage.selection.cssPreview('line-height 100%')
    return false
  })
  ...
  buttonLineHeight2.on('click', function () {
    Prototype.stage.selection.cssPreview('line-height 140%')
    return false
  })
  ...
  buttonLineHeight3.on('click', function () {
    Prototype.stage.selection.cssPreview('line-height 180%')
    return false
  })
  ...
  buttonLineHeight4.on('click', function () {
    ...
    Prototype.stage.selection.cssPreview('line-height ' + currentHeight)
    return false
  })
  ...
  buttonTextStyle1.on('click', function () {
    Prototype.stage.selection.cssPreview('font-weight bold')
    Prototype.stage.commit()
    $('.handle').trigger('update')
    return false
  })
  ...
  buttonTextStyle2.on('click', function () {
    Prototype.stage.selection.cssPreview('font-style italic')
    Prototype.stage.commit()
    $('.handle').trigger('update')
    return false
  })
  ...
  buttonTextStyle3.on('click', function () {
    Prototype.stage.selection.cssPreview('text-decoration underline')
    Prototype.stage.commit()
    $('.handle').trigger('update')
    return false
  })
  ...
  // Insert text_area
  var text_area = $('<textarea id="PrototypeStyleEditorCssEditor"></textarea>')
  if (scrap.get('style'))
    text_area.val(scrap.get('style'))
  text_area.on('tap mousedown click slide slidestart slideend mouseup', function (event) {
    event.stopPropagation()
  })
  Prototype.styleEditor.livePreviewScrap = scrap
  text_area.on('keyup', Prototype.styleEditor.livePreviewStart)
  
  styleEditor.append(text_area)
  
  // Insert bottom bar
  var button_container = $('<div id="PrototypeStyleEditorBottomBar"></div>')
  text_area.append(button_container)
  
  // Insert save button
  var save_button = $('<div id="PrototypeStyleEditorSaveButton">Save</div>')
  ...
  $(".colorPicker").spectrum({
      color: currentColor,
      move: function(color) {
        Prototype.stage.selection.cssPreview('background-color ' + color.toHexString());
  ...
  $(".colorBorderPicker").spectrum({
      ...
      move: function(color) {
        Prototype.stage.selection.cssPreview('border-color ' + color.toHexString());
  ...
  $(".colorFontPicker").spectrum({
      ...
      move: function(color) {
        Prototype.stage.selection.cssPreview('color ' + color.toHexString());
        currentBorderColor = color.toHexString();
      },
      change: function(color) {
          $("#basic-log").text("change called: " + color.toHexString());
  ...
  $('.sp-input[type=text]').on('keydown', function(e) {
      if (e.which == 13) {
          ...
          Prototype.stage.selection.css(colorType + inputColor);
          return false
      }
  });
 ...
 // scroll to reveal the styleEditor
  var difference = styleEditor.position().top + styleEditor.outerHeight() - Prototype.stage.height()
  if (difference > 0) {
    $('#PrototypeStage').scrollTop($('#PrototypeStage').scrollTop() + difference)
  ...
  if (difference > 0) {
    $('#PrototypeStage').scrollLeft($('#PrototypeStage').scrollLeft() + difference)
