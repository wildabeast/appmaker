...
d=a.$el.get(0).contentWindow.document.body.scrollHeight;var f=a.$el.get(0).contentWindow.document.location.pathname.substring(window.location.pathname.lastIndexOf("/")+1).toLowerCase();c.Log("page height : "+d+"px || page name : "+f);d<=a.options.minimumHeight&&-1==a.options.exceptPrototype.indexOf(f)?g():d>a.options.minimumHeight&&-1==a.options.exceptPrototype.indexOf(f)&&(a.$el.height(d+a.options.heightOffset).css("height",d+a.options.heightOffset),a.options.visibilitybeforeload&&!(b.browser.msie&&7==b.browser.version)&&
...
resizeWaitTime:50,minimumHeight:200,defaultHeight:1E3,heightOffset:0,exceptPrototype:"",debugMode:!1,visibilitybeforeload:!1,blockCrossDomain:!1,externalHeightName:"bodyHeight"};b.fn.iframeHeight=function(e){return this.each(function(){new b.iframeHeight(this,e)})}})(jQuery);