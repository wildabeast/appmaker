...
$.cssToSpace = function (css) {
  ...
  */
  ...
  rules.each(function (index, rule) {
    ...
    rule.get('declarations').each(function (decIndex, devValue) {
      var property = devValue.get('property')
      var propertyValue = devValue.get('value')
      concise.set(selector + ' ' + property, propertyValue)
    })
  })
